...
public class e
{
  ...
  public void a(Context paramContext, String paramString)
  {
    try
    {
      ...
      localIntent.putExtra("android.intent.extra.TEXT", paramContext.getString(R.string.td_share_text, new Object[] { paramString, "https://goo.gl/SWC7G2" }));
      paramContext.startActivity(localIntent);
      return;
    }
    catch (ActivityNotFoundException paramString)
    {
      g.a(paramContext, "EmailUtils-4", paramString, false);
