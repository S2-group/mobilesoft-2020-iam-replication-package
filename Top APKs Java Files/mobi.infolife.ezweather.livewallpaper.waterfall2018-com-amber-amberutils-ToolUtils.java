...
public class ToolUtils
{
  ...
  public static PackageInfo getPackageInfo(Context paramContext)
  {
    ...
    try
    {
      paramContext = localPackageManager.getPackageInfo(paramContext.getPackageName(), 1);
      return paramContext;
    }
    catch (PackageManager.NameNotFoundException paramContext)
    {
      ...
      try
      {
        ...
        if ((paramContext != null) && (paramContext.size() != 0))
        {
          ...
          do
          {
            ...
            bool = paramString.equals(((ActivityManager.RunningServiceInfo)paramContext.next()).service.getClassName());
          } while (!bool);
          return true;
        }
      }
