...
public class zw
{
  public static int a()
  {
    try
    {
      int i = ve.a.getPackageManager().getPackageInfo(ve.a.getPackageName(), 0).versionCode;
      return i;
    }
    catch (Exception localException)
    {
      zb.a("Get Version Code Error!!!", localException);
    }
    return -1;
  }
  ...
  public static boolean a(Context paramContext, String paramString)
  {
    ...
    {
      zb.b(paramString + " - permission: " + bool);
      return bool;
    }
  }
  ...
  public static boolean b()
  {
    ...
    if (ve.a.checkCallingOrSelfPermission("android.permission.ACCESS_NETWORK_STATE") == 0)
    {
      localNetworkInfo = ((ConnectivityManager)ve.a.getSystemService("connectivity")).getActiveNetworkInfo();
  ...
  {
    paramString = (vr)vn.b.get(paramString);
    return (paramString != null) && (c(paramString.b));
  }
  
  public static String c()
  {
    switch (a(ve.a.getApplicationContext()))
    {
    default: 
      return "";
    case 1: 
  ...
  public static boolean c(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramString = ve.a.getPackageManager().getPackageInfo(paramString, 0);
        if (paramString == null) {
          continue;
        }
        return true;
  ...
  public static int d(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        zb.a("Get Meta_Data Info error:", paramString);
      }
    }
    return -1;
  }
  ...
  {
    return (ve.a.getResources().getConfiguration().screenLayout & 0xF) >= 3;
  }
