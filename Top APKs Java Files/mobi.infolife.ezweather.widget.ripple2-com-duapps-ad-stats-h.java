...
public class h
{
  ...
  public void b(Context paramContext)
  {
    ...
    //   75: astore_3
    //   76: aload 5
    //   78: invokestatic 190	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   81: ifne +16 -> 97
    //   84: aload 4
    //   86: astore_3
    //   87: aload 6
    //   89: aload 5
    //   91: invokeinterface 196 2 0
    //   96: pop
    //   97: aload 4
    //   99: ifnull +20 -> 119
    //   102: aload 4
    ...
    //   126: ifle +337 -> 463
    //   129: new 183	java/util/ArrayList
    //   132: dup
    //   133: invokespecial 184	java/util/ArrayList:<init>	()V
    //   136: astore_3
    //   137: aload_1
    //   138: invokevirtual 204	android/content/Context:getPackageManager	()Landroid/content/pm/PackageManager;
    //   141: astore_1
    //   142: aload_1
    //   143: ifnull +168 -> 311
    //   146: aload_1
    //   147: sipush 256
    //   150: invokevirtual 210	android/content/pm/PackageManager:getInstalledPackages	(I)Ljava/util/List;
    //   153: astore_1
    //   154: aload 6
    //   156: invokeinterface 214 1 0
    //   161: astore 4
    //   163: aload 4
    //   165: invokeinterface 219 1 0
    //   170: ifeq +141 -> 311
    //   173: aload 4
    //   175: invokeinterface 223 1 0
    //   180: checkcast 50	java/lang/String
    //   183: astore 5
    //   185: aload_1
    //   186: invokeinterface 214 1 0
    //   191: astore 6
    //   193: aload 6
    //   195: invokeinterface 219 1 0
    //   200: ifeq -37 -> 163
    //   203: aload 6
    //   205: invokeinterface 223 1 0
    //   210: checkcast 225	android/content/pm/PackageInfo
    //   213: astore 7
    //   215: aload 7
    //   217: ifnull -24 -> 193
    //   220: aload 7
    //   222: getfield 228	android/content/pm/PackageInfo:packageName	Ljava/lang/String;
    //   225: aload 5
    //   227: invokevirtual 231	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   230: ifeq -37 -> 193
    //   233: aload_3
    //   234: aload 5
    ...
    //   335: aload_3
    //   336: iload_2
    //   337: invokeinterface 237 2 0
    //   342: checkcast 50	java/lang/String
    //   345: astore 4
    //   347: iload_2
    //   348: ifne +40 -> 388
    //   351: new 239	java/lang/StringBuilder
    //   354: dup
    //   355: invokespecial 240	java/lang/StringBuilder:<init>	()V
    //   358: aload_1
    //   359: invokevirtual 244	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   362: ldc -10
    //   364: invokevirtual 244	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   367: aload 4
    //   369: invokevirtual 244	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   372: ldc -10
    //   374: invokevirtual 244	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   377: invokevirtual 250	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   380: astore_1
    //   381: iload_2
    //   382: iconst_1
    //   383: iadd
    //   384: istore_2
    //   385: goto -60 -> 325
    //   388: new 239	java/lang/StringBuilder
    //   391: dup
    //   392: invokespecial 240	java/lang/StringBuilder:<init>	()V
    //   395: aload_1
    //   396: invokevirtual 244	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   399: ldc -4
    //   401: invokevirtual 244	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   404: aload 4
    //   406: invokevirtual 244	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   409: ldc -10
    //   411: invokevirtual 244	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   414: invokevirtual 250	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   417: astore_1
    //   418: goto -37 -> 381
    //   421: new 239	java/lang/StringBuilder
    //   424: dup
    //   425: invokespecial 240	java/lang/StringBuilder:<init>	()V
    //   428: aload_1
    //   429: invokevirtual 244	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   432: ldc -2
    //   434: invokevirtual 244	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
