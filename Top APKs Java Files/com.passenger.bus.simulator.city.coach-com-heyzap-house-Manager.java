...
public class Manager
{
  ...
  private static b c;
  private static AtomicReference<k> d = new AtomicReference();
  ...
  private Manager(com.heyzap.internal.d paramD, String paramString)
  {
    ...
    b = new DisplayCache();
    c = new b(com.heyzap.a.c.d.a(), new File(Utils.h(paramD.a)), Long.valueOf(30000000L));
  }
  ...
  public static k start(com.heyzap.internal.d paramD, String paramString)
  {
    if (d.compareAndSet(null, k.a()))
    {
      if (paramD.a == null) {
    ...
    for (;;)
    {
      ...
      e.a(paramString, (k)d.get(), com.heyzap.a.c.d.a());
      ((k)d.get()).a(new Runnable()
      {
        public final void run()
        {
