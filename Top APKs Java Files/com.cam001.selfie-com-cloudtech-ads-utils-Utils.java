...
public class Utils
{
  ...
  private static ArrayList<String> a(String[] paramArrayOfString)
  {
    ...
    //   7: astore_1
    //   8: invokestatic 81	java/lang/Runtime:getRuntime	()Ljava/lang/Runtime;
    //   11: aload_0
    //   12: invokevirtual 85	java/lang/Runtime:exec	([Ljava/lang/String;)Ljava/lang/Process;
    //   15: astore_0
    //   16: new 87	java/io/BufferedWriter
    //   19: dup
    //   20: new 89	java/io/OutputStreamWriter
    //   23: dup
    //   24: aload_0
    //   25: invokevirtual 95	java/lang/Process:getOutputStream	()Ljava/io/OutputStream;
    //   28: invokespecial 98	java/io/OutputStreamWriter:<init>	(Ljava/io/OutputStream;)V
    //   31: invokespecial 101	java/io/BufferedWriter:<init>	(Ljava/io/Writer;)V
    //   34: pop
    //   35: new 103	java/io/BufferedReader
    //   38: dup
    //   39: new 105	java/io/InputStreamReader
    //   42: dup
    //   43: aload_0
    //   44: invokevirtual 109	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   47: invokespecial 112	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   50: invokespecial 115	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   53: astore_0
    //   54: aload_0
    //   55: invokevirtual 119	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   58: astore_2
    //   59: aload_2
    //   60: ifnull +31 -> 91
    //   63: ldc 121
    //   65: ldc 123
    //   67: aload_2
    //   68: invokestatic 129	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   71: invokevirtual 133	java/lang/String:concat	(Ljava/lang/String;)Ljava/lang/String;
    //   74: invokestatic 139	com/cloudtech/ads/utils/YeLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   77: aload_1
    //   78: aload_2
    //   79: invokevirtual 143	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   82: pop
    //   83: goto -29 -> 54
    //   86: astore_0
    //   87: aload_0
    ...
    //   93: ldc -108
    //   95: aload_1
    //   96: invokestatic 129	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   99: invokevirtual 133	java/lang/String:concat	(Ljava/lang/String;)Ljava/lang/String;
    //   102: invokestatic 139	com/cloudtech/ads/utils/YeLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   105: aload_1
    //   106: areturn
    //   107: aconst_null
    //   108: areturn
  ...
  {
    // Byte code:
    //   0: getstatic 640	com/cloudtech/ads/utils/Utils:h	Ljava/lang/String;
    //   3: invokestatic 404	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   6: ifeq +86 -> 92
    //   9: aconst_null
    //   10: astore_3
    //   11: aconst_null
    //   12: astore_1
    //   13: new 642	android/webkit/WebView
    //   16: dup
    //   17: aload_0
    //   18: invokespecial 644	android/webkit/WebView:<init>	(Landroid/content/Context;)V
    //   21: astore_0
    //   22: aload_0
    //   23: invokevirtual 648	android/webkit/WebView:getSettings	()Landroid/webkit/WebSettings;
    //   26: invokevirtual 653	android/webkit/WebSettings:getUserAgentString	()Ljava/lang/String;
    //   29: invokevirtual 657	java/lang/String:getBytes	()[B
    //   32: iconst_0
    //   33: invokestatic 661	android/util/Base64:encodeToString	([BI)Ljava/lang/String;
    //   36: putstatic 640	com/cloudtech/ads/utils/Utils:h	Ljava/lang/String;
    //   39: aload_0
    //   40: invokevirtual 664	android/webkit/WebView:destroy	()V
    //   43: goto +49 -> 92
    //   46: astore_1
    //   47: goto +35 -> 82
    //   50: astore_2
    ...
    //   66: astore_1
    //   67: aload_2
    //   68: invokevirtual 146	java/lang/Exception:printStackTrace	()V
    //   71: aload_0
    //   72: ifnull +20 -> 92
    //   75: aload_0
    //   76: invokevirtual 664	android/webkit/WebView:destroy	()V
    //   79: goto +13 -> 92
    //   82: aload_0
    //   83: ifnull +7 -> 90
    //   86: aload_0
    //   87: invokevirtual 664	android/webkit/WebView:destroy	()V
    //   90: aload_1
    //   91: athrow
    //   92: getstatic 640	com/cloudtech/ads/utils/Utils:h	Ljava/lang/String;
    //   95: areturn
    // Local variable table:
    //   start	length	slot	name	signature
