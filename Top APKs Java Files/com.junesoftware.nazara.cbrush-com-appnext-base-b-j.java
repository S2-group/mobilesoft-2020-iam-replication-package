...
import com.appnext.base.services.cnjs;
...
public class j
{
  ...
  public static void a(Context paramContext, Class paramClass, long paramLong, com.appnext.base.a.b.c paramC)
  {
    if ((paramContext != null) && (paramC != null))
    {
      ...
      for (long l = 86400000L;; l = d(paramC.aS(), paramC.aT())) {
        break;
      }
      if (l == -1L) {
        return;
      ...
      if ((TextUtils.isDigitsOnly(paramString1)) && (!TextUtils.isEmpty(paramString2)) && (!TextUtils.isEmpty(paramString1)))
      {
        ...
        if ("time".equalsIgnoreCase(paramString2))
        {
          if (paramString1.length() == 4) {
            return a(Integer.parseInt(paramString1.substring(0, 2)), Integer.parseInt(paramString1.substring(2, 4)));
          }
        }
        else
        {
  ...
  public static void i(Context paramContext)
  {
    ...
    paramContext = new JobInfo.Builder(0, new ComponentName(paramContext, cnjs.class));
    paramContext.addTriggerContentUri(new JobInfo.TriggerContentUri(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, 1));
    paramContext.addTriggerContentUri(new JobInfo.TriggerContentUri(MediaStore.Video.Media.EXTERNAL_CONTENT_URI, 1));
