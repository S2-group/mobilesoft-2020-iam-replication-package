...
public class k
{
  ...
  {
    return c(paramInt1, paramInt2) + (kc.nextInt(paramInt3 + paramInt4) - paramInt3) * 1000L;
  }
  ...
  public static Object a(String paramString, c.a paramA)
  {
    try
    {
      paramString = com.appnext.base.a.a.aD().aG().ab(paramString);
      if ((paramString == null) || (paramString.isEmpty())) {
        break label120;
      }
      paramString = ((com.appnext.base.a.b.b)paramString.get(0)).aN();
  ...
  public static void a(Context paramContext, Class paramClass, long paramLong, com.appnext.base.a.b.c paramC)
  {
    ...
    for (;;)
    {
      ...
      for (l = 86400000L; l != -1L; l = g(paramC.aQ(), paramC.aR()))
      {
  ...
  {
    return i.bY().getLong(paramString + "_lastupdate", 0L);
  }
  ...
  public static boolean h(String paramString1, String paramString2)
  {
    ...
    Object localObject = e.bS().av(paramString1);
    if ((localObject == null) || ("off".equalsIgnoreCase(((com.appnext.base.a.b.c)localObject).aP()))) {
      return true;
    }
    String str2 = c.bQ() + "/data";
    HashMap localHashMap = new HashMap();
    String str1 = com.appnext.core.f.v(d.getContext());
    localObject = str1;
    if (TextUtils.isEmpty(str1)) {
      localObject = i.bY().getString("google_ads_id", "");
    }
  ...
  {
    com.appnext.base.a.a.aD().aG().b(new com.appnext.base.a.b.b(paramString1, paramString2, new Date()));
  }
