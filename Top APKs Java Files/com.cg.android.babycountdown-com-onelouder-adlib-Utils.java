...
class Utils
{
  ...
  public static String getCarrier(Context paramContext)
  {
    ...
    try
    {
      ...
      {
        str1 = str2;
        str2 = localTelephonyManager.getNetworkOperatorName();
        paramContext = str2;
        if (str2 == null)
        {
          str1 = str2;
  ...
  public static String getCountry(Context paramContext)
  {
    ...
    try
    {
      String str1 = paramContext.getResources().getConfiguration().locale.getCountry();
      String str2;
      if (str1 != null)
      {
        str2 = str1;
      ...
      else
      {
        ...
        {
          localObject = str1;
          str2 = paramContext.getNetworkCountryIso();
        }
      }
      return str2;
    }
