...
class bg
{
  ...
  public String a(String paramString)
  {
    ...
    //   17: astore_2
    //   18: aload_0
    //   19: invokespecial 53	io/branch/referral/bg:r	()Z
    //   22: ifne +125 -> 147
    //   25: aload_0
    //   26: getfield 15	io/branch/referral/bg:a	Landroid/content/Context;
  ...
  public int b(boolean paramBoolean)
  {
    ...
    String str = d();
    if ("bnc_no_value".equals(((ai)localObject).e()))
    {
      if (paramBoolean) {
        ((ai)localObject).a(str);
      }
      ...
      else
      {
        try
        {
          ...
          for (localObject = null;; localObject = ((CharSequence)localObject).toString())
          {
            ...
            if (localObject != null)
            {
              localJSONObject.put(ae.I.a(), localObject);
              localObject = a((String)localObject);
              if (!((String)localObject).equals("bnc_no_value")) {
                localJSONObject.put(ae.H.a(), localObject);
              }
            }
