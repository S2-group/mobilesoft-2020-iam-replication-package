...
public class __G
{
  private static final String a = "__G";
  ...
  private ArrayList<String> a(Context paramContext)
  {
    ...
    {
      D7P.e(a, "Using fallback package getter");
      paramContext.printStackTrace();
    }
    return a();
  }
  
  public void a(Context paramContext, MB paramMB)
  {
    ...
    Object localObject2 = localClientConfig.al();
    Object localObject1 = localObject2;
    if (localObject2 == null) {
      localObject1 = new HW();
    }
    localObject2 = new ArrayList();
    Object localObject4 = paramMB.b().iterator();
    Object localObject5;
    while (((Iterator)localObject4).hasNext())
    {
      ...
      while (localIterator.hasNext()) {
        if (((String)localIterator.next()).equalsIgnoreCase(((S0C)localObject5).a()))
        {
          i = 1;
          break label154;
        }
      ...
      i = 0;
      label154:
      if ((i == 0) && (!((S0C)localObject5).a().equals(paramContext.getPackageName()))) {
        ((ArrayList)localObject2).add(((S0C)localObject5).a());
      }
    }
    if (l1 == 0L) {}
    for (;;)
    {
      ...
      D7P.a(a, "over maxtimeout, cant determine dead clients");
      localClientConfig.b(l3);
      if ((paramMB != null) && (paramMB.b() != null))
      {
        localObject3 = paramMB.b().iterator();
        while (((Iterator)localObject3).hasNext()) {
          ((S0C)((Iterator)localObject3).next()).a(l3);
        }
        localClientConfig.a(paramMB);
      }
    }
    int i = 1;
    label284:
    ...
    {
      localClientConfig.b(l3);
      paramMB = paramMB.b().iterator();
      while (paramMB.hasNext())
      {
        localObject3 = (S0C)paramMB.next();
        if ((!((S0C)localObject3).a().equals(paramContext.getPackageName())) && (((S0C)localObject3).d() != 0L) && (l3 - ((S0C)localObject3).d() > l1))
        {
          ((ArrayList)localObject2).add(((S0C)localObject3).a());
          localObject4 = a;
          localObject5 = new StringBuilder("Client timeout -  pack.getId()");
          ((StringBuilder)localObject5).append(((S0C)localObject3).a());
          ...
          ((StringBuilder)localObject5).append(((S0C)localObject3).d());
          ((StringBuilder)localObject5).append(", MAX_TIMEOUT: ");
          ((StringBuilder)localObject5).append(l1);
          D7P.e((String)localObject4, ((StringBuilder)localObject5).toString());
        }
      }
    }
    if (((ArrayList)localObject2).size() != ((HW)localObject1).a().size()) {}
    do
    {
      i = 1;
      break;
      paramContext = new ArrayList((Collection)localObject2);
      paramContext.removeAll(((HW)localObject1).a());
    } while (paramContext.size() != 0);
    i = 0;
    if (i != 0)
    {
      ((HW)localObject1).a((ArrayList)localObject2);
      ((HW)localObject1).a(((HW)localObject1).b() + 1);
      localClientConfig.a((HW)localObject1);
    }
  }
}
