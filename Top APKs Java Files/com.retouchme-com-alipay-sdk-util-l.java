...
public final class l
{
  ...
  public static WebView a(Activity paramActivity, String paramString1, String paramString2)
  {
    ...
    paramString2.setUserAgentString(paramString2.getUserAgentString() + f(localContext));
  ...
  private static a a(Context paramContext, String paramString)
  {
    for (;;)
    {
      ...
      catch (Throwable localThrowable)
      {
        ...
        com.alipay.sdk.app.statistic.a.a("auth", "GetPackageInfoEx", localThrowable);
        if (a(null)) {
          break label155;
        }
        try
        ...
        {
          com.alipay.sdk.app.statistic.a.a("auth", "GetInstalledPackagesEx", paramContext);
