...
public class a
{
  ...
  public final void a(b paramB)
  {
    ...
    new Thread(new a.1(this, paramB)).start();
  }
  ...
  public final void b(b paramB)
  {
    ...
    //   9: aload_0
    //   10: getfield 106	com/mobvista/msdk/base/c/a:f	Ljava/lang/String;
    ...
    //   23: aload 4
    //   25: invokevirtual 122	java/util/concurrent/CopyOnWriteArraySet:size	()I
    //   28: ifne +16 -> 44
    //   31: aload_1
    //   32: ifnull +9 -> 41
    //   35: aload_1
    ...
    //   42: monitorexit
    //   43: return
    //   44: new 53	java/util/concurrent/CopyOnWriteArraySet
    //   47: dup
    //   48: invokespecial 54	java/util/concurrent/CopyOnWriteArraySet:<init>	()V
    //   51: astore 4
    //   53: getstatic 56	com/mobvista/msdk/base/c/a:i	Ljava/util/concurrent/CopyOnWriteArraySet;
    //   56: invokevirtual 126	java/util/concurrent/CopyOnWriteArraySet:iterator	()Ljava/util/Iterator;
    //   59: astore 5
    //   61: aload 5
    //   63: ifnull +143 -> 206
    //   66: aload 5
    //   68: invokeinterface 132 1 0
    //   73: istore_3
    //   74: iload_3
    //   75: ifeq +131 -> 206
    //   78: aload 5
    //   80: invokeinterface 136 1 0
    //   85: checkcast 138	com/mobvista/msdk/base/entity/e
    //   88: astore 6
    //   90: getstatic 51	com/mobvista/msdk/base/c/a:b	Ljava/util/List;
    //   93: ifnull -27 -> 66
    //   96: getstatic 51	com/mobvista/msdk/base/c/a:b	Ljava/util/List;
    ...
    //   113: istore_2
    //   114: iload_2
    //   115: getstatic 51	com/mobvista/msdk/base/c/a:b	Ljava/util/List;
    //   118: invokeinterface 218 1 0
    //   123: if_icmpge -57 -> 66
    //   126: getstatic 51	com/mobvista/msdk/base/c/a:b	Ljava/util/List;
    //   129: iload_2
    //   130: invokeinterface 222 2 0
    //   135: checkcast 175	java/lang/String
    //   138: astore 7
    //   140: aload 6
    ...
    //   163: aload 7
    //   165: aload 8
    //   167: invokevirtual 178	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   170: ifeq +11 -> 181
    //   173: aload 4
    //   175: aload 6
    ...
    //   188: astore 6
    //   190: aload 6
    //   192: invokevirtual 103	java/lang/Exception:printStackTrace	()V
    //   195: getstatic 44	com/mobvista/msdk/base/c/a:a	Ljava/lang/String;
    //   198: ldc -29
    //   200: invokestatic 229	com/mobvista/msdk/base/utils/g:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   203: goto -137 -> 66
    //   206: getstatic 56	com/mobvista/msdk/base/c/a:i	Ljava/util/concurrent/CopyOnWriteArraySet;
    //   209: ifnull +9 -> 218
    //   212: getstatic 56	com/mobvista/msdk/base/c/a:i	Ljava/util/concurrent/CopyOnWriteArraySet;
    //   215: invokevirtual 232	java/util/concurrent/CopyOnWriteArraySet:clear	()V
    //   218: aload 4
    //   220: invokevirtual 122	java/util/concurrent/CopyOnWriteArraySet:size	()I
    //   223: ifle +12 -> 235
    //   226: getstatic 56	com/mobvista/msdk/base/c/a:i	Ljava/util/concurrent/CopyOnWriteArraySet;
    //   229: aload 4
    //   231: invokevirtual 236	java/util/concurrent/CopyOnWriteArraySet:addAll	(Ljava/util/Collection;)Z
    //   234: pop
    //   235: aload_0
    //   236: getfield 63	com/mobvista/msdk/base/c/a:d	Landroid/content/Context;
    //   239: invokestatic 212	com/mobvista/msdk/base/utils/k:a	(Landroid/content/Context;)Lcom/mobvista/msdk/base/utils/k;
    //   242: getstatic 56	com/mobvista/msdk/base/c/a:i	Ljava/util/concurrent/CopyOnWriteArraySet;
