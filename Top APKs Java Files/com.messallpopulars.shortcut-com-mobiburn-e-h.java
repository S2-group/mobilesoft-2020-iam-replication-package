...
public class h
{
    ...
    while (localIterator.hasNext())
    {
      ...
      if (paramArrayList != null)
      {
        ...
        for (;;)
        {
          ...
          break;
          if ((paramArrayList instanceof com.mobiburn.d.b)) {
            paramArrayList = ((com.mobiburn.d.b)paramArrayList).a();
  ...
  public static JSONArray h(Context paramContext)
    throws JSONException
  {
    return new JSONArray(g.a(paramContext).j());
  }
  
  /* Error */
  public static ArrayList<com.mobiburn.d.b> i(Context paramContext)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_2
    ...
    //   6: invokevirtual 428	com/mobiburn/e/g:l	()Z
    //   9: ifeq +5 -> 14
    //   12: aconst_null
    //   13: areturn
  ...
  public static ArrayList<com.mobiburn.d.g> j(Context paramContext)
  {
    ...
    Object localObject = com.mobiburn.b.a().d;
  ...
  public static final class a
  {
    public static String a(String paramString)
    {
      ...
      {
        a.a("Error getting MAC address" + paramString.toString());
      }
      return null;
    }
