  ...
  extends BillingActivity
{
  ...
  {
    paramContext = paramContext.getResources().getString(2131230872);
  ...
  {
    super.onStart();
    FlurryAgent.onStartSession(getApplicationContext(), getString(2131230894));
