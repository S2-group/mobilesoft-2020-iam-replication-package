...
class ag
{
  ...
  public String a(String paramString)
  {
    ...
    //   11: astore_2
    //   12: aload_0
    //   13: invokespecial 86	io/branch/referral/ag:l	()Z
    //   16: ifne +112 -> 128
    //   19: aload_0
    //   20: getfield 29	io/branch/referral/ag:c	Landroid/content/Context;
    ...
    //   83: aload_2
    //   84: astore_3
    //   85: new 128	io/branch/referral/b
    //   88: dup
    //   89: invokespecial 129	io/branch/referral/b:<init>	()V
    //   92: aload 5
    //   94: invokevirtual 132	io/branch/referral/b:a	([B)Ljava/lang/String;
    //   97: astore 5
    //   99: aload 5
    //   101: astore_3
    //   102: aload_2
  ...
  {
    Object localObject = m.a(this.c);
    String str = d();
    if ("bnc_no_value".equals(((m)localObject).e()))
    {
      if (paramBoolean) {
        ((m)localObject).a(str);
      }
    ...
    protected Void a(final Void... paramVarArgs)
    {
      ...
      new Thread(new Runnable()
      {
        public void run()
        {
          ...
          Object localObject = ag.this.k();
          ag.this.a(localObject);
          ag.this.b(localObject);
