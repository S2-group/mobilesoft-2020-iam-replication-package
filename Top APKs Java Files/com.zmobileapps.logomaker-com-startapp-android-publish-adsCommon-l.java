...
public class l
{
  ...
  private static volatile Pair<a, String> d;
  private static volatile Pair<a, String> e;
    ...
    try
    {
      ...
      else if (paramBoolean)
      {
        try
        {
          ...
          ((StringBuilder)localObject).append("simpleToken : [");
          ((StringBuilder)localObject).append(d);
          ((StringBuilder)localObject).append("]");
          com.startapp.common.a.g.a("SimpleToken", 3, ((StringBuilder)localObject).toString());
          localObject = new StringBuilder();
          ((StringBuilder)localObject).append("simpleToken2 : [");
