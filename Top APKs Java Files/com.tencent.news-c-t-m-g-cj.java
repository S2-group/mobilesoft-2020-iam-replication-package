...
public class cj
{
  ...
  private String o()
  {
    ...
    //   7: ldc_w 309
    //   10: ldc -48
    //   12: invokeinterface 314 3 0
    //   17: astore 4
    //   19: aload 4
    //   21: astore_3
    //   22: aload_3
    //   23: invokestatic 320	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   26: ifne +5 -> 31
    //   29: aload_3
    //   30: areturn
    //   31: invokestatic 326	java/net/NetworkInterface:getNetworkInterfaces	()Ljava/util/Enumeration;
    //   34: astore 5
    //   36: aload_3
    //   37: astore 4
    //   39: aload 4
    //   41: astore_3
    //   42: aload 5
    //   44: invokeinterface 332 1 0
    //   49: ifeq +203 -> 252
    //   52: aload 4
    //   54: astore_3
    //   55: aload 5
    //   57: invokeinterface 336 1 0
    //   62: checkcast 322	java/net/NetworkInterface
    //   65: astore 6
    //   67: aload 6
    //   69: ifnull -30 -> 39
    //   72: aload 4
    //   74: astore_3
    //   75: aload 6
    //   77: invokevirtual 339	java/net/NetworkInterface:getName	()Ljava/lang/String;
    //   80: ldc_w 341
    //   83: invokevirtual 344	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   86: ifeq -47 -> 39
    //   89: aload 4
    //   91: astore_3
    //   92: aload 6
    //   94: invokevirtual 348	java/net/NetworkInterface:getHardwareAddress	()[B
    //   97: astore 6
    //   99: aload 6
    //   101: ifnull -62 -> 39
    //   104: aload 4
    ...
    //   113: aload 4
    //   115: astore_3
    //   116: new 267	java/lang/StringBuilder
    //   119: dup
    //   120: invokespecial 268	java/lang/StringBuilder:<init>	()V
    //   123: astore 7
    //   125: aload 4
    //   127: astore_3
    //   128: aload 6
    ...
    //   155: iload_1
    //   156: baload
    //   157: invokestatic 356	java/lang/Byte:valueOf	(B)Ljava/lang/Byte;
    //   160: aastore
    //   161: invokestatic 360	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   164: invokevirtual 277	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   167: pop
    //   168: iload_1
    //   169: iconst_1
    //   170: iadd
    ...
    //   177: astore_3
    //   178: aload 7
    //   180: invokevirtual 364	java/lang/StringBuilder:length	()I
    //   183: ifle +19 -> 202
    //   186: aload 4
    //   188: astore_3
    //   189: aload 7
    //   191: aload 7
    //   193: invokevirtual 364	java/lang/StringBuilder:length	()I
    //   196: iconst_1
    //   197: isub
    //   198: invokevirtual 368	java/lang/StringBuilder:deleteCharAt	(I)Ljava/lang/StringBuilder;
    //   201: pop
    //   202: aload 4
    //   204: astore_3
    //   205: aload 7
    //   207: invokevirtual 285	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   210: astore 4
    //   212: aload 4
    //   214: astore_3
    //   215: aload_0
    //   216: getfield 115	c/t/m/g/cj:k	Landroid/content/SharedPreferences;
    //   219: invokeinterface 372 1 0
    //   224: ldc_w 309
    //   227: aload 4
    //   229: invokeinterface 377 3 0
    //   234: invokeinterface 380 1 0
    //   239: goto -200 -> 39
    //   242: astore 4
    //   244: aload 4
    //   246: invokevirtual 381	java/lang/Throwable:toString	()Ljava/lang/String;
    //   249: pop
    //   250: aload_3
    //   251: areturn
    //   252: aload 4
  ...
  public final void b(Object paramObject)
  {
    ...
    while (paramObject.hasNext()) {
      localList.remove((dz)paramObject.next());
    }
    label119:
  }
  ...
  public final void c(@Nullable Object paramObject)
  {
    ...
    //   8: return
    //   9: aload_0
    //   10: getfield 451	c/t/m/g/cj:n	Ljava/util/List;
    //   13: astore_3
    //   14: aload_3
    //   15: ifnull -9 -> 6
    //   18: aload_3
    //   19: invokeinterface 460 1 0
    //   24: astore_3
    //   25: aload_3
    //   26: invokeinterface 465 1 0
    //   31: ifeq -25 -> 6
    //   34: aload_3
    //   35: invokeinterface 468 1 0
    //   40: checkcast 470	c/t/m/g/dz
    //   43: astore 4
    //   45: aload_1
    //   46: invokevirtual 477	java/lang/Object:getClass	()Ljava/lang/Class;
    //   49: aload 4
    //   51: getfield 521	c/t/m/g/dz:a	Ljava/lang/Class;
    //   54: invokevirtual 524	java/lang/Object:equals	(Ljava/lang/Object;)Z
    //   57: istore_2
    //   58: iload_2
    //   59: ifeq -34 -> 25
    //   62: aload 4
    //   64: getfield 527	c/t/m/g/dz:b	Ljava/lang/reflect/Method;
    //   67: aload 4
    //   69: getfield 473	c/t/m/g/dz:c	Ljava/lang/Object;
    //   72: iconst_1
    ...
    //   78: aload_1
    //   79: aastore
    //   80: invokevirtual 531	java/lang/reflect/Method:invoke	(Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;
    //   83: pop
    //   84: goto -59 -> 25
    //   87: astore 4
    //   89: goto -64 -> 25
      ...
      try
      {
        ...
        if (localObject1 != null)
        {
          ...
          try
          {
            ...
            ((StringBuilder)localObject1).append("os:").append(Build.MODEL).append(" ").append(Build.VERSION.RELEASE).append(" ").append(localCk.a()).append(" net:").append(localCk.k).append(" ").append(localCk.l).append(" app:").append(localPackageInfo.versionCode).append(" ").append(localPackageInfo.versionName).append(" sdk: ").append(localCk.d()).append(" ").append(localCk.e());
