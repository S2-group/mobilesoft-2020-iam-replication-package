...
import com.threatmetrix.TrustDefenderMobile.d;
...
public class TapjoyConnectCore
{
  ...
  private void checkAdvertisingID()
  {
    // Byte code:
    //   0: ldc_w 369
    //   3: invokestatic 375	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   6: astore_1
    //   7: ldc 22
    //   9: new 263	java/lang/StringBuilder
    //   12: dup
    //   13: ldc_w 377
    //   16: invokespecial 268	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   19: aload_1
    //   20: invokevirtual 276	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   23: invokevirtual 280	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   26: invokestatic 286	com/tapjoy/TapjoyLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   29: getstatic 101	com/tapjoy/TapjoyConnectCore:context	Landroid/content/Context;
    //   32: invokevirtual 255	android/content/Context:getPackageManager	()Landroid/content/pm/PackageManager;
    //   35: getstatic 101	com/tapjoy/TapjoyConnectCore:context	Landroid/content/Context;
    //   38: invokevirtual 380	android/content/Context:getPackageName	()Ljava/lang/String;
    //   41: sipush 128
    //   44: invokevirtual 386	android/content/pm/PackageManager:getApplicationInfo	(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    //   47: getfield 392	android/content/pm/ApplicationInfo:metaData	Landroid/os/Bundle;
    //   50: ldc_w 394
    //   53: invokevirtual 400	android/os/Bundle:getInt	(Ljava/lang/String;)I
    //   56: pop
    //   57: return
    //   58: astore_1
    //   59: new 234	com/tapjoy/TapjoyIntegrationException
    //   62: dup
    //   63: ldc_w 402
    //   66: invokespecial 403	com/tapjoy/TapjoyIntegrationException:<init>	(Ljava/lang/String;)V
    //   69: athrow
    //   70: astore_1
    //   71: new 234	com/tapjoy/TapjoyIntegrationException
    //   74: dup
    //   75: ldc_w 405
    //   78: invokespecial 403	com/tapjoy/TapjoyIntegrationException:<init>	(Ljava/lang/String;)V
    //   81: athrow
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	82	0	this	TapjoyConnectCore
    //   6	14	1	localClass	Class
    //   58	1	1	localException1	Exception
    //   70	1	1	localException2	Exception
    // Exception table:
    //   from	to	target	type
    //   0	29	58	java/lang/Exception
    //   29	57	70	java/lang/Exception
  }
  ...
  private void determineInstallID()
  {
    ...
    String str = ((SharedPreferences)localObject).getString("tapjoyInstallId", "");
    installID = str;
    if ((str == null) || (installID.length() == 0)) {}
    try
    {
  ...
  public static void setUserID(String paramString)
  {
    ...
    new Thread(new Runnable()
    {
      public final void run()
      {
        ...
        {
          TapjoyConnectCore.handleConnectResponse(localTapjoyHttpURLResponse.response);
  ...
  {
    TapjoyLog.i("TapjoyConnect", "Initializing Threatmetrix: " + TrustDefenderMobile.a);
    this.profile = new TrustDefenderMobile();
    try
    {
      this.profile.a(new d()
      {
        public void complete()
        {
          try
          {
            if (TapjoyConnectCore.this.profile.b() == TrustDefenderMobile.THMStatusCode.b)
            {
              TapjoyConnectCore.access$102(TapjoyConnectCore.this.profile.a());
              return;
            }
  ...
  public String getSerial()
  {
    ...
    //   3: invokestatic 375	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   6: ldc_w 1506
    //   9: invokevirtual 1510	java/lang/Class:getDeclaredField	(Ljava/lang/String;)Ljava/lang/reflect/Field;
    //   12: astore_1
    //   13: aload_1
    //   14: invokevirtual 1515	java/lang/reflect/Field:isAccessible	()Z
    //   17: ifne +8 -> 25
    //   20: aload_1
    //   21: iconst_1
    //   22: invokevirtual 1518	java/lang/reflect/Field:setAccessible	(Z)V
    //   25: aload_1
    //   26: ldc_w 1117
    //   29: invokevirtual 1519	java/lang/reflect/Field:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   32: invokevirtual 621	java/lang/Object:toString	()Ljava/lang/String;
    //   35: astore_1
    //   36: ldc 22
    //   38: new 263	java/lang/StringBuilder
    //   41: dup
    //   42: ldc_w 1521
    //   45: invokespecial 268	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   48: aload_1
    //   49: invokevirtual 300	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   52: invokevirtual 280	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   55: invokestatic 286	com/tapjoy/TapjoyLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   58: aload_1
    //   59: areturn
    //   60: astore_2
    //   61: aconst_null
    ...
    //   63: ldc 22
    //   65: aload_2
    //   66: invokevirtual 489	java/lang/Exception:toString	()Ljava/lang/String;
    //   69: invokestatic 491	com/tapjoy/TapjoyLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   72: aload_1
    //   73: areturn
    //   74: astore_2
    //   75: goto -12 -> 63
