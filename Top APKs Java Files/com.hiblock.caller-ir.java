...
public final class ir
{
  ...
  public ir(Context paramContext)
  {
    this.a = new ir.a(paramContext);
  }
  ...
  {
    private final ir.b a;
    private final ir.c b;
    
    public a(Context paramContext)
    {
      super();
      this.a = new ir.b(paramContext);
      this.b = new ir.c(paramContext.getResources());
    }
