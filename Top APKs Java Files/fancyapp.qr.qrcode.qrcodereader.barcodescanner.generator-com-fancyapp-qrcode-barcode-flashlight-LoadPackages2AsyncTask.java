package com.fancyapp.qrcode.barcode.flashlight;
  ...
  extends AsyncTask<Object, Object, List<AppInfo>>
{
  ...
  {
    paramList = new ArrayAdapter(this.activity, 2131296257, 2131165202, paramList)
    {
      public View getView(int paramAnonymousInt, View paramAnonymousView, ViewGroup paramAnonymousViewGroup)
      {
        ...
        if (paramAnonymousViewGroup != null) {
          ((ImageView)paramAnonymousView.findViewById(2131165201)).setImageDrawable(paramAnonymousViewGroup);
        }
