...
class MethodProxies
{
    ...
    extends MethodProxy
  {
    ...
    public Object call(Object paramObject, Method paramMethod, Object... paramVarArgs)
    {
      if ((paramVarArgs.length == 2) && ((paramVarArgs[0] instanceof String)) && ((paramVarArgs[1] instanceof String)))
      {
        paramObject = (String)paramVarArgs[0];
        paramMethod = (String)paramVarArgs[1];
        if (TextUtils.equals(paramObject, paramMethod)) {
          return Integer.valueOf(0);
        }
        return Integer.valueOf(VPackageManager.get().checkSignatures(paramObject, paramMethod));
      }
    ...
    extends MethodProxy
  {
    ...
    public Object call(Object paramObject, Method paramMethod, Object... paramVarArgs)
    {
      int i = MethodParameterUtils.getIndex(paramVarArgs, String.class);
      if (i >= 0)
      {
        if (isAppPkg((String)paramVarArgs[i])) {
    ...
    extends MethodProxy
  {
    ...
    {
      int i = ((Integer)paramVarArgs[0]).intValue();
      if ((i == Process.myUid()) || (i == getRealUid()) || (i == VirtualCore.get().getSystemUid())) {
        paramMethod = VPackageManager.get().getPackagesForUid(VClient.get().getVUid());
      }
      do
      {
        return paramMethod;
        ...
        paramVarArgs = VPackageManager.get().getPackagesForUid(i);
        paramObject = null;
        try
        {
          paramMethod = VirtualCore.get().getUnHookPackageManager().getPackagesForUid(i);
          paramObject = paramMethod;
        }
        ...
        paramMethod = paramVarArgs;
      } while (paramObject == null);
      if (paramVarArgs == null) {
        return paramObject;
      }
      paramMethod = new ArrayList();
      paramMethod.addAll(Arrays.asList(paramVarArgs));
      paramMethod.addAll(Arrays.asList(paramObject));
      return paramMethod.toArray(new String[0]);
    }
    ...
    extends MethodProxy
  {
    ...
    public Object call(Object paramObject, Method paramMethod, Object... paramVarArgs)
    {
      ...
      paramObject = paramMethod.invoke(paramObject, paramVarArgs);
      if ((localList.size() == 0) && (paramObject != null))
      {
        if (bool) {
        ...
        while (paramObject != null)
        {
          ...
          for (;;)
          {
            if (paramMethod.hasNext())
            {
              ...
              if ((paramVarArgs == null) || (paramVarArgs.activityInfo == null))
              {
                paramMethod.remove();
                continue;
    ...
    extends MethodProxy
  {
    ...
    public Object call(Object paramObject, Method paramMethod, Object... paramVarArgs)
    {
      ...
      if (localObject2 == null)
      {
        ...
        {
          localObject1 = paramObject;
          if (!isVisiblePackage(paramObject.activityInfo.applicationInfo)) {}
        }
      }
      return localObject1;
    }
    ...
    extends MethodProxy
  {
    ...
    public Object call(Object paramObject, Method paramMethod, Object... paramVarArgs)
    {
      ...
      if (localObject2 == null)
      {
        ...
        {
          localObject1 = paramObject;
          if (!isVisiblePackage(paramObject.serviceInfo.applicationInfo)) {}
        }
      }
      return localObject1;
    }
    ...
    extends MethodProxy
  {
    ...
    public Object call(Object paramObject, Method paramMethod, Object... paramVarArgs)
    {
      ...
      paramObject = VirtualCore.getPM().getPackagesForUid(i);
      paramMethod = VirtualCore.getPM().getPackagesForUid(j);
