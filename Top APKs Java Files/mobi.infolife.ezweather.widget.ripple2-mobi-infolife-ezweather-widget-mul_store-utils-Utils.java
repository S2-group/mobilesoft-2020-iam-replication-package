...
import mobi.infolife.ezweather.widget.mul_store.R.string;
...
public class Utils
{
  ...
  public static int getInstalledLWPForStore(Context paramContext)
  {
    int i = 0;
    paramContext = getInstalledAppList(paramContext, 8192);
    if (paramContext == null) {
      return 0;
    }
    paramContext = paramContext.iterator();
    while (paramContext.hasNext()) {
      if (((PackageInfo)paramContext.next()).packageName.contains("mobi.infolife.ezweather.livewallpaper")) {
        i += 1;
      }
    }
    return i;
  ...
  public static ArrayList<ItemData> getInstalledLockersForStore(Context paramContext)
  {
    ...
    ArrayList localArrayList = new ArrayList();
    PackageManager localPackageManager = paramContext.getPackageManager();
    Object localObject2 = getInstalledAppList(paramContext, 8192);
