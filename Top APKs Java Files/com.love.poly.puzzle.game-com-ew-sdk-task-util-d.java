...
public class d
{
  ...
  public static String a(Context paramContext, com.ew.sdk.task.b.c paramC, String paramString, boolean paramBoolean)
  {
    if (paramContext != null)
    {
      ...
      try
      {
        ...
        {
          paramContext = paramString;
          paramC = paramString.replace("$PKGNAME", paramC.getAppStore());
        }
        else
        {
          paramContext = paramString;
          paramC = paramString.replace("$PKGNAME", paramC.getTargetPkgName());
        }
        paramContext = paramC;
  ...
  public static void a(com.ew.sdk.task.b.a paramA, JSONObject paramJSONObject)
  {
    if (paramA != null)
    {
      if (paramJSONObject == null) {
  ...
  {
    long l = com.ew.sdk.task.d.a.a().b("markNowDateKey");
    boolean bool = false;
    if (l <= 0L) {
      return false;
    }
