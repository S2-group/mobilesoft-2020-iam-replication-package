...
class ApplicationInfoGatherer
{
    ...
    throws InterruptedException
  {
    ...
    //   0: aconst_null
    //   1: astore_2
    //   2: invokestatic 71	com/threatmetrix/TrustDefenderMobile/NativeGatherer:getInstance	()Lcom/threatmetrix/TrustDefenderMobile/NativeGatherer;
    //   5: invokevirtual 75	com/threatmetrix/TrustDefenderMobile/NativeGatherer:isAvailable	()Z
    //   8: ifeq +11 -> 19
    //   11: invokestatic 71	com/threatmetrix/TrustDefenderMobile/NativeGatherer:getInstance	()Lcom/threatmetrix/TrustDefenderMobile/NativeGatherer;
    //   14: aload_0
    //   15: invokevirtual 78	com/threatmetrix/TrustDefenderMobile/NativeGatherer:hashFile	(Ljava/lang/String;)Ljava/lang/String;
    //   18: areturn
    //   19: getstatic 16	com/threatmetrix/TrustDefenderMobile/ApplicationInfoGatherer:TAG	Ljava/lang/String;
    //   22: ldc 80
    //   24: invokestatic 54	android/util/Log:d	(Ljava/lang/String;Ljava/lang/String;)I
    //   27: pop
    //   28: ldc 82
    //   30: invokestatic 87	java/security/MessageDigest:getInstance	(Ljava/lang/String;)Ljava/security/MessageDigest;
    //   33: astore 4
    //   35: new 89	java/io/FileInputStream
    //   38: dup
    //   39: aload_0
    ...
    //   50: aload_3
    //   51: aload_0
    //   52: invokevirtual 98	java/io/InputStream:read	([B)I
    //   55: istore_1
    //   56: iload_1
    //   57: ifle +85 -> 142
    //   60: aload 4
    ...
    //   63: iconst_0
    //   64: iload_1
    //   65: invokevirtual 102	java/security/MessageDigest:update	([BII)V
    //   68: goto -18 -> 50
    //   71: astore_0
    //   72: getstatic 16	com/threatmetrix/TrustDefenderMobile/ApplicationInfoGatherer:TAG	Ljava/lang/String;
    //   75: ldc 104
    //   77: aload_0
    //   78: invokestatic 108	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   81: pop
    //   82: aload_3
    //   83: invokevirtual 111	java/io/InputStream:close	()V
    //   86: aload_2
    //   87: astore_0
    //   88: getstatic 16	com/threatmetrix/TrustDefenderMobile/ApplicationInfoGatherer:TAG	Ljava/lang/String;
    //   91: new 37	java/lang/StringBuilder
    //   94: dup
    //   95: invokespecial 38	java/lang/StringBuilder:<init>	()V
    //   98: ldc 113
    ...
    //   107: invokevirtual 48	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   110: invokestatic 54	android/util/Log:d	(Ljava/lang/String;Ljava/lang/String;)I
    //   113: pop
    //   114: aload_0
    //   115: areturn
    //   116: astore_0
    ...
    //   120: ldc 115
    //   122: aload_0
    //   123: invokestatic 108	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   126: pop
    //   127: aconst_null
    //   128: areturn
    //   129: astore_0
    ...
    //   133: ldc 117
    //   135: aload_0
    //   136: invokestatic 108	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   139: pop
    //   140: aconst_null
    //   141: areturn
    //   142: ldc 119
    ...
    //   148: dup
    //   149: iconst_0
    //   150: new 121	java/math/BigInteger
    //   153: dup
    //   154: iconst_1
    //   155: aload 4
    //   157: invokevirtual 125	java/security/MessageDigest:digest	()[B
    //   160: invokespecial 128	java/math/BigInteger:<init>	(I[B)V
    //   163: bipush 16
    //   165: invokevirtual 131	java/math/BigInteger:toString	(I)Ljava/lang/String;
    //   168: aastore
    //   169: invokestatic 137	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   172: bipush 32
    //   174: bipush 48
    //   176: invokevirtual 141	java/lang/String:replace	(CC)Ljava/lang/String;
    //   179: astore_0
    //   180: aload_3
    ...
    //   217: astore_0
    //   218: aload_3
    //   219: invokevirtual 111	java/io/InputStream:close	()V
    //   222: aload_0
    //   223: athrow
    //   224: astore_2
