...
public class YLR
{
  private static final String a = YLR.class.getSimpleName();
  private final Context b;
  private final com.p3group.insight.b c;
  private boolean d;
  private boolean e = false;
  
  public YLR(Context paramContext)
  {
    this.b = paramContext;
  ...
  public void a()
  {
    ...
    this.d = true;
    new OZ((byte)0).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new Long[] { Long.valueOf(l) });
  }
    ...
    extends AsyncTask
  {
    ...
    private InstalledAppsResult a(Long... paramVarArgs)
    {
      ...
      localInstalledAppsResult.DeviceInfo = DeviceController.getDeviceInfo(YLR.a(YLR.this));
      localInstalledAppsResult.TimestampSnapshot = c.a(paramVarArgs[0].longValue());
      localInstalledAppsResult.HostAppPackageName = YLR.a(YLR.this).getPackageName();
      ArrayList localArrayList1 = new ArrayList();
      PackageManager localPackageManager = YLR.a(YLR.this).getPackageManager();
      int i;
      label199:
      Object localObject1;
      ...
      try
      {
        paramVarArgs = localPackageManager.getClass().getMethod("getPackageSizeInfo", new Class[] { String.class, OZ.class });
        if (YLR.a(YLR.this).checkCallingOrSelfPermission("android.permission.GET_PACKAGE_SIZE") == 0)
        {
          i = 1;
          HashMap localHashMap = new HashMap();
          if ((Build.VERSION.SDK_INT < 23) || (((AppOpsManager)YLR.a(YLR.this).getSystemService("appops")).checkOpNoThrow("android:get_usage_stats", Process.myUid(), YLR.a(YLR.this).getPackageName()) != 0)) {
            break label890;
          }
          localHashMap = a();
      ...
      catch (NoSuchMethodException paramVarArgs)
      {
        ...
        for (;;)
        {
          Log.e(YLR.b(), "IA: " + paramVarArgs.getMessage());
          paramVarArgs = null;
          continue;
          i = 0;
          continue;
      ...
      for (;;)
      {
        ...
        catch (PackageManager.NameNotFoundException localNameNotFoundException)
        {
          try
          {
            paramVarArgs.invoke(localPackageManager, new Object[] { localInstalledApp.PackageName, new OZ.OZ()
            {
    ...
    private HashMap a()
    {
      ...
      Object localObject1 = (NetworkStatsManager)YLR.a(YLR.this).getSystemService(NetworkStatsManager.class);
      Object localObject2;
      label238:
      do
      {
        for (;;)
        {
          ...
          {
            Log.d(YLR.b(), "getUidBytesForAndroidM: " + localException.getMessage());
            return localHashMap;
          }
        ...
        localObject1 = ((NetworkStatsManager)localObject1).querySummary(0, ((TelephonyManager)YLR.a(YLR.this).getSystemService("phone")).getSubscriberId(), l, System.currentTimeMillis());
