package com.medicsshield.bloodpressure.checker.diary.bp.info.chart.log.tracker.history.evaluation.control.calculator.journal.activites;
...
import com.medicsshield.bloodpressure.checker.diary.bp.info.chart.log.tracker.history.evaluation.control.calculator.journal.fragment.DataFragment;
import com.medicsshield.bloodpressure.checker.diary.bp.info.chart.log.tracker.history.evaluation.control.calculator.journal.fragment.HistoryFragment;
import com.medicsshield.bloodpressure.checker.diary.bp.info.chart.log.tracker.history.evaluation.control.calculator.journal.utils.c;
...
{
  public static ArrayList<com.medicsshield.bloodpressure.checker.diary.bp.info.chart.log.tracker.history.evaluation.control.calculator.journal.model.a> p;
  static String q = "http://mmmmmmmm.com/mmm.xml";
  public static Animation s;
  private HistoryFragment A;
  private FragmentTransaction B;
  private String C;
  com.medicsshield.bloodpressure.checker.diary.bp.info.chart.log.tracker.history.evaluation.control.calculator.journal.utils.a n;
  boolean o;
  ...
  public void exit()
  {
    ...
    if ((p != null) && (p.size() >= 4))
    {
      localTextView1.setText(((com.medicsshield.bloodpressure.checker.diary.bp.info.chart.log.tracker.history.evaluation.control.calculator.journal.model.a)p.get(0)).getAppName());
      localTextView2.setText(((com.medicsshield.bloodpressure.checker.diary.bp.info.chart.log.tracker.history.evaluation.control.calculator.journal.model.a)p.get(1)).getAppName());
      localTextView3.setText(((com.medicsshield.bloodpressure.checker.diary.bp.info.chart.log.tracker.history.evaluation.control.calculator.journal.model.a)p.get(2)).getAppName());
      localTextView4.setText(((com.medicsshield.bloodpressure.checker.diary.bp.info.chart.log.tracker.history.evaluation.control.calculator.journal.model.a)p.get(3)).getAppName());
    }
    if ((p != null) && (p.size() >= 4))
    {
      e.with(getApplicationContext()).load(((com.medicsshield.bloodpressure.checker.diary.bp.info.chart.log.tracker.history.evaluation.control.calculator.journal.model.a)p.get(0)).getImgUrl().toString()).placeholder(2131165290).error(2131165290).into((ImageView)localObject1);
      e.with(getApplicationContext()).load(((com.medicsshield.bloodpressure.checker.diary.bp.info.chart.log.tracker.history.evaluation.control.calculator.journal.model.a)p.get(1)).getImgUrl().toString()).placeholder(2131165290).error(2131165290).into((ImageView)localObject2);
      e.with(getApplicationContext()).load(((com.medicsshield.bloodpressure.checker.diary.bp.info.chart.log.tracker.history.evaluation.control.calculator.journal.model.a)p.get(2)).getImgUrl().toString()).placeholder(2131165290).error(2131165290).into(localImageView1);
      e.with(getApplicationContext()).load(((com.medicsshield.bloodpressure.checker.diary.bp.info.chart.log.tracker.history.evaluation.control.calculator.journal.model.a)p.get(3)).getImgUrl().toString()).placeholder(2131165290).error(2131165290).into(localImageView2);
      ((ImageView)localObject1).startAnimation(s);
      ((ImageView)localObject2).startAnimation(s);
      localImageView1.startAnimation(s);
      localImageView2.startAnimation(s);
      ...
      ((ImageView)localObject1).setOnClickListener(new View.OnClickListener()
      {
        public void onClick(View paramAnonymousView)
        {
          if ((MainActivity.p != null) && (MainActivity.p.size() >= 1)) {
            MainActivity.this.startActivity(new Intent("android.intent.action.VIEW", Uri.parse(((com.medicsshield.bloodpressure.checker.diary.bp.info.chart.log.tracker.history.evaluation.control.calculator.journal.model.a)MainActivity.p.get(0)).getAppUrl())));
          }
        }
      });
      ((ImageView)localObject2).setOnClickListener(new View.OnClickListener()
      {
        public void onClick(View paramAnonymousView)
        {
          if ((MainActivity.p != null) && (MainActivity.p.size() >= 2)) {
            MainActivity.this.startActivity(new Intent("android.intent.action.VIEW", Uri.parse(((com.medicsshield.bloodpressure.checker.diary.bp.info.chart.log.tracker.history.evaluation.control.calculator.journal.model.a)MainActivity.p.get(1)).getAppUrl())));
          }
        }
      });
      localImageView1.setOnClickListener(new View.OnClickListener()
      {
        public void onClick(View paramAnonymousView)
        {
          if ((MainActivity.p != null) && (MainActivity.p.size() >= 3)) {
            MainActivity.this.startActivity(new Intent("android.intent.action.VIEW", Uri.parse(((com.medicsshield.bloodpressure.checker.diary.bp.info.chart.log.tracker.history.evaluation.control.calculator.journal.model.a)MainActivity.p.get(2)).getAppUrl())));
          }
        }
      });
      localImageView2.setOnClickListener(new View.OnClickListener()
      {
        public void onClick(View paramAnonymousView)
        {
          if ((MainActivity.p != null) && (MainActivity.p.size() >= 4)) {
            MainActivity.this.startActivity(new Intent("android.intent.action.VIEW", Uri.parse(((com.medicsshield.bloodpressure.checker.diary.bp.info.chart.log.tracker.history.evaluation.control.calculator.journal.model.a)MainActivity.p.get(3)).getAppUrl())));
          }
        }
      });
    }
  ...
  public ArrayList<com.medicsshield.bloodpressure.checker.diary.bp.info.chart.log.tracker.history.evaluation.control.calculator.journal.model.a> loadUndowloadedApp(ArrayList<com.medicsshield.bloodpressure.checker.diary.bp.info.chart.log.tracker.history.evaluation.control.calculator.journal.model.a> paramArrayList)
  {
    ArrayList localArrayList = new ArrayList();
    if (paramArrayList.size() > 0)
    {
      ...
      {
        String str = ((com.medicsshield.bloodpressure.checker.diary.bp.info.chart.log.tracker.history.evaluation.control.calculator.journal.model.a)paramArrayList.get(i)).getAppUrl().split("=")[1];
        StringBuilder localStringBuilder = new StringBuilder();
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.n = new com.medicsshield.bloodpressure.checker.diary.bp.info.chart.log.tracker.history.evaluation.control.calculator.journal.utils.a(this);
      ...
      public void onResponse(String paramAnonymousString)
      {
        try
        {
          ...
          while (i < paramAnonymousString.getLength())
          {
            ...
            com.medicsshield.bloodpressure.checker.diary.bp.info.chart.log.tracker.history.evaluation.control.calculator.journal.model.a localA = new com.medicsshield.bloodpressure.checker.diary.bp.info.chart.log.tracker.history.evaluation.control.calculator.journal.model.a();
