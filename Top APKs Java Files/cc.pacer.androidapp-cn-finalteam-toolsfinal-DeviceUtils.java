...
public class DeviceUtils
{
  ...
  public boolean isSoftKeyAvail(Activity paramActivity)
  {
    boolean[] arrayOfBoolean = new boolean[1];
    arrayOfBoolean[0] = false;
    paramActivity = paramActivity.getWindow().getDecorView().findViewById(16908290);
    paramActivity.getViewTreeObserver().addOnGlobalLayoutListener(new DeviceUtils.1(this, paramActivity, arrayOfBoolean));
