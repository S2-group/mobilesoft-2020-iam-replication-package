...
public class MVSDKContext
{
  ...
  public void contrastDiff(MVSDKContext.b paramB)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 58	com/mobvista/msdk/base/controller/MVSDKContext:c	Landroid/content/Context;
    //   6: invokestatic 145	com/mobvista/msdk/base/utils/b:a	(Landroid/content/Context;)Lcom/mobvista/msdk/base/utils/b;
    //   9: aload_0
    //   10: getfield 121	com/mobvista/msdk/base/controller/MVSDKContext:e	Ljava/lang/String;
    //   13: invokevirtual 153	com/mobvista/msdk/base/utils/b:a	(Ljava/lang/String;)Ljava/util/concurrent/CopyOnWriteArraySet;
    //   16: putstatic 51	com/mobvista/msdk/base/controller/MVSDKContext:h	Ljava/util/concurrent/CopyOnWriteArraySet;
    //   19: getstatic 51	com/mobvista/msdk/base/controller/MVSDKContext:h	Ljava/util/concurrent/CopyOnWriteArraySet;
    //   22: ifnull +12 -> 34
    //   25: getstatic 51	com/mobvista/msdk/base/controller/MVSDKContext:h	Ljava/util/concurrent/CopyOnWriteArraySet;
    //   28: invokevirtual 140	java/util/concurrent/CopyOnWriteArraySet:size	()I
    //   31: ifne +16 -> 47
    //   34: aload_1
    //   35: ifnull +9 -> 44
    //   38: aload_1
    //   39: invokeinterface 155 1 0
    //   44: aload_0
    //   45: monitorexit
    //   46: return
    //   47: new 48	java/util/concurrent/CopyOnWriteArraySet
    //   50: dup
    //   51: invokespecial 49	java/util/concurrent/CopyOnWriteArraySet:<init>	()V
    //   54: astore 4
    //   56: getstatic 51	com/mobvista/msdk/base/controller/MVSDKContext:h	Ljava/util/concurrent/CopyOnWriteArraySet;
    //   59: invokevirtual 159	java/util/concurrent/CopyOnWriteArraySet:iterator	()Ljava/util/Iterator;
    //   62: astore 5
    //   64: aload 5
    //   66: ifnull +143 -> 209
    //   69: aload 5
    ...
    //   88: checkcast 171	com/mobvista/msdk/base/entity/InstallApp
    //   91: astore 6
    //   93: getstatic 46	com/mobvista/msdk/base/controller/MVSDKContext:packageInfoList	Ljava/util/List;
    //   96: ifnull -27 -> 69
    //   99: getstatic 46	com/mobvista/msdk/base/controller/MVSDKContext:packageInfoList	Ljava/util/List;
    ...
    //   116: istore_2
    //   117: iload_2
    //   118: getstatic 46	com/mobvista/msdk/base/controller/MVSDKContext:packageInfoList	Ljava/util/List;
    //   121: invokeinterface 174 1 0
    //   126: if_icmpge -57 -> 69
    //   129: getstatic 46	com/mobvista/msdk/base/controller/MVSDKContext:packageInfoList	Ljava/util/List;
    //   132: iload_2
    //   133: invokeinterface 178 2 0
    //   138: checkcast 75	java/lang/String
    //   141: astore 7
    //   143: aload 6
    //   145: invokevirtual 181	com/mobvista/msdk/base/entity/InstallApp:getPackageName	()Ljava/lang/String;
    //   148: astore 8
    //   150: aload 7
    //   152: invokestatic 187	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   155: ifne +29 -> 184
    //   158: aload 8
    //   160: invokestatic 187	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   163: ifne +21 -> 184
    //   166: aload 7
    //   168: aload 8
    //   170: invokevirtual 85	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   173: ifeq +11 -> 184
    //   176: aload 4
    //   178: aload 6
    //   180: invokevirtual 190	java/util/concurrent/CopyOnWriteArraySet:add	(Ljava/lang/Object;)Z
    //   183: pop
    //   184: iload_2
    //   185: iconst_1
    //   186: iadd
    ...
    //   191: astore 6
    //   193: aload 6
    //   195: invokevirtual 110	java/lang/Exception:printStackTrace	()V
    //   198: getstatic 39	com/mobvista/msdk/base/controller/MVSDKContext:a	Ljava/lang/String;
    //   201: ldc -64
    //   203: invokestatic 194	com/mobvista/msdk/base/utils/CommonLogUtil:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   206: goto -137 -> 69
    //   209: getstatic 51	com/mobvista/msdk/base/controller/MVSDKContext:h	Ljava/util/concurrent/CopyOnWriteArraySet;
    //   212: ifnull +9 -> 221
    //   215: getstatic 51	com/mobvista/msdk/base/controller/MVSDKContext:h	Ljava/util/concurrent/CopyOnWriteArraySet;
    //   218: invokevirtual 197	java/util/concurrent/CopyOnWriteArraySet:clear	()V
    //   221: aload 4
    //   223: invokevirtual 140	java/util/concurrent/CopyOnWriteArraySet:size	()I
    //   226: ifle +12 -> 238
    //   229: getstatic 51	com/mobvista/msdk/base/controller/MVSDKContext:h	Ljava/util/concurrent/CopyOnWriteArraySet;
    //   232: aload 4
    //   234: invokevirtual 201	java/util/concurrent/CopyOnWriteArraySet:addAll	(Ljava/util/Collection;)Z
    //   237: pop
    //   238: aload_0
    //   239: getfield 58	com/mobvista/msdk/base/controller/MVSDKContext:c	Landroid/content/Context;
    //   242: invokestatic 145	com/mobvista/msdk/base/utils/b:a	(Landroid/content/Context;)Lcom/mobvista/msdk/base/utils/b;
    //   245: getstatic 51	com/mobvista/msdk/base/controller/MVSDKContext:h	Ljava/util/concurrent/CopyOnWriteArraySet;
    //   248: invokevirtual 148	com/mobvista/msdk/base/utils/b:a	(Ljava/util/Set;)V
    //   251: aload_1
    //   252: ifnull -208 -> 44
    //   255: aload_1
    //   256: invokeinterface 155 1 0
    //   261: goto -217 -> 44
    //   264: astore_1
    //   265: aload_0
    //   266: monitorexit
