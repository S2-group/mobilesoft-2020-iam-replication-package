...
public class e
{
  ...
  public static String a()
  {
    try
    {
      String str = TpnsSecurity.generateLocalSocketServieName(l.e());
      return str;
    }
  ...
  private static boolean a(Context paramContext, String paramString, long paramLong, boolean paramBoolean)
  {
    ...
    //   4: istore 9
    //   6: aload_0
    //   7: invokevirtual 158	android/content/Context:getPackageManager	()Landroid/content/pm/PackageManager;
    //   10: astore 11
    //   12: aload 11
    //   14: aload_1
    //   15: iconst_0
    //   16: invokevirtual 258	android/content/pm/PackageManager:getPackageInfo	(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    //   19: pop
    //   20: iconst_1
    //   21: istore 7
    //   23: iload 7
    ...
    //   32: aload_0
    //   33: aload_1
    //   34: invokestatic 262	com/tencent/android/tpush/service/d/e:b	(Landroid/content/Context;Ljava/lang/String;)Z
    //   37: ifne -14 -> 23
    //   40: iload 9
    //   42: istore 7
    //   44: aload_0
    //   45: aload_1
    //   46: invokestatic 264	com/tencent/android/tpush/service/d/e:c	(Landroid/content/Context;Ljava/lang/String;)Z
    //   49: ifne -26 -> 23
    //   52: iload 8
    //   54: istore 7
    //   56: iload 4
    ...
    //   67: ifnull +85 -> 152
    //   70: aload_0
    //   71: invokeinterface 181 1 0
    //   76: astore_0
    //   77: aload_0
    //   78: invokeinterface 187 1 0
    //   83: ifeq +69 -> 152
    //   86: aload_0
    ...
    //   115: iconst_0
    //   116: invokevirtual 258	android/content/pm/PackageManager:getPackageInfo	(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    //   119: pop
    //   120: iconst_1
    //   121: istore 4
    //   123: iload 4
    ...
    //   133: ldc_w 278
    //   136: aload 10
    //   138: invokestatic 63	com/tencent/android/tpush/a/a:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   141: iload 8
    //   143: istore 7
    //   145: goto -122 -> 23
    //   148: astore_1
  ...
  public static boolean a(Context paramContext, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      paramBoolean = Settings.System.putString(paramContext.getContentResolver(), d(paramString1), paramString2);
      return paramBoolean;
    }
    catch (Exception paramContext)
    {
  ...
  public static long b(String paramString)
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        arrayOfLong[2] = 0L;
        arrayOfLong[0] = 0L;
        com.tencent.android.tpush.a.a.c("TPush", "service Util@@parseIpAddress(" + paramString + ")", localException);
      }
    }
  }
  ...
  public static String c(String paramString)
  {
    if (l.e() != null) {
      try
      {
        paramString = TpnsSecurity.getEncryptAPKSignature(l.e().createPackageContext(paramString, 0));
        return paramString;
      }
  ...
  public static ApplicationInfo n(Context paramContext)
  {
    try
    {
  ...
  private static Map o(Context paramContext)
  {
