...
import com.virus.cleaner.antivirus.entity.AppProcessInfo;
import com.virus.cleaner.antivirus.utils.d.b;
import com.virus.cleaner.antivirus.utils.d.c;
import java.io.File;
...
public class e
{
  ...
  private d b;
  private com.virus.cleaner.antivirus.utils.d c;
  private c d;
  ...
  public e(Context paramContext)
  {
    ...
    this.c = new com.virus.cleaner.antivirus.utils.d(paramContext, new e(null));
  ...
  public void a(List<com.virus.cleaner.antivirus.entity.a> paramList, f paramF)
  {
    ...
    {
      com.virus.cleaner.antivirus.entity.a localA = (com.virus.cleaner.antivirus.entity.a)paramList.next();
  ...
  public void b(List<com.common.utils.junk.e.a> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      localAppProcessInfo.a = localA.e();
      localAppProcessInfo.b = localA.a();
      localAppProcessInfo.f = localA.d();
  ...
  public void c(List<com.common.utils.junk.h.a> paramList)
  {
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ...
      while (paramList.hasNext())
      {
        ...
        try
        {
          localObject = new File(((com.common.utils.junk.h.a)localObject).a());
  ...
  public void e(List<com.common.utils.junk.file.a> paramList)
  {
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ...
      while (paramList.hasNext())
      {
        ...
        try
        {
          localObject = new File(((com.common.utils.junk.file.a)localObject).a());
          if (!((File)localObject).isFile()) {
            break label74;
          }
          k.e((File)localObject);
  ...
  public void f(List<com.common.utils.junk.f.a.a> paramList)
  {
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ...
      while (paramList.hasNext())
      {
        Object localObject1 = ((com.common.utils.junk.f.a.a)paramList.next()).b();
              ...
              com.common.utils.junk.g.b.a(localContext).a(localApplicationInfo.packageName, new com.common.utils.junk.g.b.a()
              {
                public void a(com.common.utils.junk.g.a arg1)
                {
                  synchronized (localArrayList)
                  {
                    ...
                    if ((???.d() > 0L) && (!com.common.utils.a.f.a(localApplicationInfo.packageName)))
                    {
                      e.b(e.this).sendMessage(e.b(e.this).obtainMessage(2, Long.valueOf(???.d())));
                      localArrayList.add(???);
                    }
