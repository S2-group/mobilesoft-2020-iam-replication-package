...
public class u
{
  ...
  {
    return Globals.z.getString("OsUpgradeHistory", "");
  }
  ...
  public static File[] b(Context paramContext)
  {
    ...
    try
    {
      ...
      if (((File)localObject2).isDirectory()) {
        paramContext = ((File)localObject2).listFiles(i.c(".xml"));
      }
      return paramContext;
    }
    catch (PackageManager.NameNotFoundException paramContext)
    {
      g.f(new Object[] { paramContext });
    }
    return null;
  }
  ...
  private static boolean f()
  {
    ...
    //   2: aconst_null
    //   3: astore_2
    //   4: invokestatic 217	java/lang/Runtime:getRuntime	()Ljava/lang/Runtime;
    //   7: iconst_2
    //   8: anewarray 145	java/lang/String
    //   11: dup
    //   12: iconst_0
    //   13: ldc -37
    //   15: aastore
    ...
    //   18: ldc -35
    //   20: aastore
    //   21: invokevirtual 225	java/lang/Runtime:exec	([Ljava/lang/String;)Ljava/lang/Process;
    //   24: astore_1
    //   25: aload_1
    //   26: astore_2
    //   27: new 227	java/io/BufferedReader
    //   30: dup
    //   31: new 229	java/io/InputStreamReader
    //   34: dup
    //   35: aload_1
    //   36: invokevirtual 235	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   39: invokespecial 238	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   42: invokespecial 241	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   45: invokevirtual 244	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   48: astore_3
    //   49: aload_3
    //   50: ifnull +13 -> 63
    //   53: aload_1
    //   54: ifnull +7 -> 61
    //   57: aload_1
    //   58: invokevirtual 247	java/lang/Process:destroy	()V
    //   61: iload_0
    //   62: ireturn
    //   63: iconst_0
    //   64: istore_0
    ...
    //   72: ifnull +7 -> 79
    //   75: aload_1
    //   76: invokevirtual 247	java/lang/Process:destroy	()V
    //   79: iconst_0
    //   80: ireturn
    //   81: astore_1
    //   82: aload_2
    //   83: ifnull +7 -> 90
    //   86: aload_2
    //   87: invokevirtual 247	java/lang/Process:destroy	()V
    //   90: aload_1
    //   91: athrow
    //   92: astore_2
    //   93: goto -22 -> 71
