...
class bj
{
  ...
  public String a(String paramString)
  {
    ...
    //   11: astore_2
    //   12: aload_0
    //   13: invokespecial 51	io/branch/referral/bj:m	()Z
    //   16: ifne +112 -> 128
    //   19: aload_0
    //   20: getfield 15	io/branch/referral/bj:a	Landroid/content/Context;
    ...
    //   83: aload_2
    //   84: astore_3
    //   85: new 94	io/branch/referral/c
    //   88: dup
    //   89: invokespecial 95	io/branch/referral/c:<init>	()V
    //   92: aload 5
    //   94: invokevirtual 98	io/branch/referral/c:a	([B)Ljava/lang/String;
    //   97: astore 5
    //   99: aload 5
    //   101: astore_3
    //   102: aload_2
  ...
  {
    Object localObject = al.a(this.a);
    String str = d();
    if ("bnc_no_value".equals(((al)localObject).e()))
    {
      if (paramBoolean) {
        ((al)localObject).a(str);
      }
      ...
      else
      {
        try
        {
          ...
          for (localObject = null;; localObject = ((CharSequence)localObject).toString())
          {
            ...
            if (localObject != null)
            {
              localJSONObject.put(ah.I.a(), localObject);
              localObject = a((String)localObject);
              if (!((String)localObject).equals("bnc_no_value")) {
                localJSONObject.put(ah.H.a(), localObject);
              }
            }
