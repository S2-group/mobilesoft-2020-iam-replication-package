  ...
  implements Runnable
{
  ...
  private static boolean ʻ(ˆـ[][][] paramArrayOfˆـ, ˆـ paramˆـ)
  {
    int k = paramˆـ.ᵎ;
    if (paramˆـ.ᴵ == -101L)
    {
      if (paramArrayOfˆـ[Launcher.ʼ][paramˆـ.ᵔ][0] != null)
      {
        Log.e("Launcher.Model", "Error loading shortcut into hotseat " + paramˆـ + " into position (" + paramˆـ.ᵎ + ":" + paramˆـ.ᵔ + "," + paramˆـ.ᵢ + ") occupied by " + paramArrayOfˆـ[Launcher.ʼ][paramˆـ.ᵔ][0]);
        return false;
      }
      paramArrayOfˆـ[Launcher.ʼ][paramˆـ.ᵔ][0] = paramˆـ;
      return true;
    }
    if (paramˆـ.ᴵ != -100L) {
      return true;
    ...
    int i = paramˆـ.ᵔ;
    int j;
    while (i < paramˆـ.ᵔ + paramˆـ.ⁱ)
    {
      j = paramˆـ.ᵢ;
      while (j < paramˆـ.ᵢ + paramˆـ.ﹳ)
      {
        if (paramArrayOfˆـ[k][i][j] != null)
        {
          Log.e("Launcher.Model", "Error loading shortcut " + paramˆـ + " into cell (" + k + "-" + paramˆـ.ᵎ + ":" + i + "," + j + ") occupied by " + paramArrayOfˆـ[k][i][j]);
          return false;
        }
        j += 1;
      }
  ...
  private void ʽ()
  {
    ...
    //   14: invokestatic 281	com/cyou/cma/clauncher/ˋי:ˊ	(Lcom/cyou/cma/clauncher/ˋי;)Lcom/cyou/cma/clauncher/ˆˈ;
    //   17: getstatic 286	com/cyou/cma/ʻ/ʻ:ʻ	Lcom/cyou/cma/ʻ/ʻ;
    //   20: invokevirtual 291	com/cyou/cma/clauncher/ˆˈ:ʻ	(Lcom/cyou/cma/ʻ/ʻ;)V
    ...
    //   60: istore 23
    //   62: getstatic 309	com/cyou/cma/clauncher/ˋי:ʾ	Ljava/util/ArrayList;
    //   65: invokevirtual 314	java/util/ArrayList:clear	()V
    //   68: getstatic 316	com/cyou/cma/clauncher/ˋי:ʿ	Ljava/util/ArrayList;
    //   71: invokevirtual 314	java/util/ArrayList:clear	()V
    //   74: getstatic 319	com/cyou/cma/clauncher/ˋי:ˈ	Ljava/util/HashMap;
    //   77: invokevirtual 322	java/util/HashMap:clear	()V
    //   80: getstatic 324	com/cyou/cma/clauncher/ˋי:ʽ	Ljava/util/HashMap;
    //   83: invokevirtual 322	java/util/HashMap:clear	()V
    //   86: getstatic 327	com/cyou/cma/clauncher/ˋי:ˉ	Ljava/util/HashMap;
    //   89: invokevirtual 322	java/util/HashMap:clear	()V
    ...
    //   136: dup
    //   137: iconst_2
    //   138: invokestatic 341	com/cyou/cma/clauncher/ˋי:ˎ	()I
    //   141: iconst_1
    //   142: iadd
    //   143: iastore
    //   144: invokestatic 347	java/lang/reflect/Array:newInstance	(Ljava/lang/Class;[I)Ljava/lang/Object;
    //   147: checkcast 349	[[[Lcom/cyou/cma/clauncher/ˆـ;
    //   150: astore 32
    //   152: aload 27
    //   154: ldc_w 351
    ...
    //   371: istore 17
    //   373: aload_0
    //   374: getfield 391	com/cyou/cma/clauncher/ˎˑ:ʿ	Z
    //   377: ifne +1193 -> 1570
    //   380: aload 27
    ...
    //   500: iload_3
    //   501: aload 33
    //   503: invokevirtual 409	com/cyou/cma/clauncher/ˋי:ʻ	(Landroid/content/pm/PackageManager;Landroid/content/Intent;Landroid/content/Context;Landroid/database/Cursor;IIILjava/lang/String;)Lcom/cyou/cma/clauncher/ـʽ;
    //   506: astore 25
    //   508: aload 25
    //   510: aload 34
    //   512: putfield 414	com/cyou/cma/clauncher/ـʽ:ʼ	Landroid/content/Intent;
    //   515: aload 25
    //   517: ifnull +371 -> 888
    //   520: aload 25
    //   522: aload 27
    ...
    //   601: aload 32
    //   603: aload 25
    //   605: invokestatic 428	com/cyou/cma/clauncher/ˎˑ:ʻ	([[[Lcom/cyou/cma/clauncher/ˆـ;Lcom/cyou/cma/clauncher/ˆـ;)Z
    //   608: ifeq -235 -> 373
    //   611: iload 18
    //   613: tableswitch	default:+1048->1661, -101:+263->876, -100:+263->876
    //   636: getstatic 319	com/cyou/cma/clauncher/ˋי:ˈ	Ljava/util/HashMap;
    //   639: iload 18
    //   641: i2l
    //   642: invokestatic 431	com/cyou/cma/clauncher/ˋי:ʻ	(Ljava/util/HashMap;J)Lcom/cyou/cma/clauncher/ʿˏ;
    //   645: aload 25
    //   647: invokevirtual 436	com/cyou/cma/clauncher/ʿˏ:ʾ	(Lcom/cyou/cma/clauncher/ˆـ;)V
    //   650: getstatic 324	com/cyou/cma/clauncher/ˋי:ʽ	Ljava/util/HashMap;
    //   653: aload 25
    ...
    //   671: getstatic 327	com/cyou/cma/clauncher/ˋי:ˉ	Ljava/util/HashMap;
    //   674: aload 25
    //   676: aload 27
    //   678: iload 5
    ...
    //   854: aload 25
    //   856: aload 34
    //   858: putfield 414	com/cyou/cma/clauncher/ـʽ:ʼ	Landroid/content/Intent;
    //   861: goto -346 -> 515
    //   864: astore 25
    //   866: aload 27
    ...
    //   873: aload 25
    //   875: athrow
    //   876: getstatic 309	com/cyou/cma/clauncher/ˋי:ʾ	Ljava/util/ArrayList;
    //   879: aload 25
    ...
    //   952: lstore 21
    //   954: getstatic 319	com/cyou/cma/clauncher/ˋי:ˈ	Ljava/util/HashMap;
    //   957: lload 21
    //   959: invokestatic 431	com/cyou/cma/clauncher/ˋי:ʻ	(Ljava/util/HashMap;J)Lcom/cyou/cma/clauncher/ʿˏ;
    //   962: astore 25
    //   964: aload 25
    //   966: aload 27
    //   968: iload_3
    //   969: invokeinterface 402 2 0
    //   974: putfield 505	com/cyou/cma/clauncher/ʿˏ:ˎ	Ljava/lang/CharSequence;
    //   977: aload 25
    //   979: lload 21
    //   981: putfield 506	com/cyou/cma/clauncher/ʿˏ:ٴ	J
    //   984: aload 27
    //   986: iload 8
    ...
    //   997: iload 18
    //   999: i2l
    //   1000: putfield 507	com/cyou/cma/clauncher/ʿˏ:ᴵ	J
    //   1003: aload 25
    //   1005: aload 27
    //   1007: iload 11
    //   1009: invokeinterface 398 2 0
    //   1014: putfield 508	com/cyou/cma/clauncher/ʿˏ:ᵎ	I
    //   1017: aload 25
    //   1019: aload 27
    //   1021: iload 12
    //   1023: invokeinterface 398 2 0
    //   1028: putfield 509	com/cyou/cma/clauncher/ʿˏ:ᵔ	I
    //   1031: aload 25
    //   1033: aload 27
    //   1035: iload 13
    //   1037: invokeinterface 398 2 0
    //   1042: putfield 510	com/cyou/cma/clauncher/ʿˏ:ᵢ	I
    //   1045: aload 25
    //   1047: aload 27
    //   1049: iload 16
    //   1051: invokeinterface 402 2 0
    //   1056: putfield 513	com/cyou/cma/clauncher/ʿˏ:ᐧᐧ	Ljava/lang/String;
    //   1059: aload 32
    //   1061: aload 25
    //   1063: invokestatic 428	com/cyou/cma/clauncher/ˎˑ:ʻ	([[[Lcom/cyou/cma/clauncher/ˆـ;Lcom/cyou/cma/clauncher/ˆـ;)Z
    //   1066: ifeq -693 -> 373
    //   1069: iload 18
    //   1071: tableswitch	default:+593->1664, -101:+58->1129, -100:+58->1129
    //   1092: getstatic 324	com/cyou/cma/clauncher/ˋי:ʽ	Ljava/util/HashMap;
    //   1095: aload 25
    //   1097: getfield 506	com/cyou/cma/clauncher/ʿˏ:ٴ	J
    ...
    //   1108: pop
    //   1109: getstatic 319	com/cyou/cma/clauncher/ˋי:ˈ	Ljava/util/HashMap;
    //   1112: aload 25
    //   1114: getfield 506	com/cyou/cma/clauncher/ʿˏ:ٴ	J
    ...
    //   1125: pop
    //   1126: goto -753 -> 373
    //   1129: getstatic 309	com/cyou/cma/clauncher/ˋי:ʾ	Ljava/util/ArrayList;
    //   1132: aload 25
    ...
    //   1238: pop
    //   1239: getstatic 534	com/cyou/cma/clauncher/Launcher:י	Ljava/util/ArrayList;
    //   1242: aload 25
    ...
    //   1258: pop
    //   1259: goto -886 -> 373
    //   1262: new 536	com/cyou/cma/clauncher/ˋˆ
    //   1265: dup
    //   1266: iload 18
    //   1268: invokespecial 539	com/cyou/cma/clauncher/ˋˆ:<init>	(I)V
    //   1271: astore 25
    //   1273: aload 25
    //   1275: lload 21
    //   1277: putfield 540	com/cyou/cma/clauncher/ˋˆ:ٴ	J
    //   1280: aload 25
    //   1282: aload 27
    //   1284: iload 11
    //   1286: invokeinterface 398 2 0
    //   1291: putfield 541	com/cyou/cma/clauncher/ˋˆ:ᵎ	I
    //   1294: aload 25
    //   1296: aload 27
    //   1298: iload 12
    //   1300: invokeinterface 398 2 0
    //   1305: putfield 542	com/cyou/cma/clauncher/ˋˆ:ᵔ	I
    //   1308: aload 25
    //   1310: aload 27
    //   1312: iload 13
    //   1314: invokeinterface 398 2 0
    //   1319: putfield 543	com/cyou/cma/clauncher/ˋˆ:ᵢ	I
    //   1322: aload 25
    //   1324: aload 27
    //   1326: iload 14
    //   1328: invokeinterface 398 2 0
    //   1333: putfield 544	com/cyou/cma/clauncher/ˋˆ:ⁱ	I
    //   1336: aload 25
    //   1338: aload 27
    //   1340: iload 15
    //   1342: invokeinterface 398 2 0
    //   1347: putfield 545	com/cyou/cma/clauncher/ˋˆ:ﹳ	I
    //   1350: aload 27
    //   1352: iload 8
    ...
    //   1398: i2l
    //   1399: putfield 548	com/cyou/cma/clauncher/ˋˆ:ᴵ	J
    //   1402: aload 32
    //   1404: aload 25
    //   1406: invokestatic 428	com/cyou/cma/clauncher/ˎˑ:ʻ	([[[Lcom/cyou/cma/clauncher/ˆـ;Lcom/cyou/cma/clauncher/ˆـ;)Z
    //   1409: ifeq -1036 -> 373
    //   1412: getstatic 324	com/cyou/cma/clauncher/ˋי:ʽ	Ljava/util/HashMap;
    //   1415: aload 25
    //   1417: getfield 540	com/cyou/cma/clauncher/ˋˆ:ٴ	J
    ...
    //   1428: pop
    //   1429: getstatic 316	com/cyou/cma/clauncher/ˋי:ʿ	Ljava/util/ArrayList;
    //   1432: aload 25
    ...
    //   1449: invokestatic 554	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   1452: iconst_0
    //   1453: anewarray 550	java/lang/Class
    //   1456: invokevirtual 558	java/lang/Class:getDeclaredConstructor	([Ljava/lang/Class;)Ljava/lang/reflect/Constructor;
    //   1459: iconst_0
    //   1460: anewarray 4	java/lang/Object
    //   1463: invokevirtual 563	java/lang/reflect/Constructor:newInstance	([Ljava/lang/Object;)Ljava/lang/Object;
    //   1466: checkcast 565	com/cyou/cma/clauncher/ʼˋ
    //   1469: astore 25
    //   1471: aload 25
    //   1473: aload 27
    //   1475: iload_1
    //   1476: invokeinterface 418 2 0
    //   1481: putfield 566	com/cyou/cma/clauncher/ʼˋ:ٴ	J
    //   1484: aload 25
    //   1486: aload 27
    //   1488: iload 12
    //   1490: invokeinterface 398 2 0
    //   1495: putfield 567	com/cyou/cma/clauncher/ʼˋ:ᵔ	I
    //   1498: aload 25
    //   1500: aload 27
    //   1502: iload 13
    //   1504: invokeinterface 398 2 0
    //   1509: putfield 568	com/cyou/cma/clauncher/ʼˋ:ᵢ	I
    //   1512: aload 25
    //   1514: aload 27
    //   1516: iload 11
    //   1518: invokeinterface 398 2 0
    //   1523: putfield 569	com/cyou/cma/clauncher/ʼˋ:ᵎ	I
    //   1526: aload 25
    //   1528: aload 27
    //   1530: iload 8
    //   1532: invokeinterface 398 2 0
    //   1537: i2l
    //   1538: putfield 570	com/cyou/cma/clauncher/ʼˋ:ᴵ	J
    //   1541: getstatic 324	com/cyou/cma/clauncher/ˋי:ʽ	Ljava/util/HashMap;
    //   1544: aload 25
    //   1546: getfield 566	com/cyou/cma/clauncher/ʼˋ:ٴ	J
    ...
    //   1557: pop
    //   1558: getstatic 309	com/cyou/cma/clauncher/ˋי:ʾ	Ljava/util/ArrayList;
    //   1561: aload 25
    ...
    //   1616: monitorenter
    //   1617: aload_0
    //   1618: getfield 391	com/cyou/cma/clauncher/ˎˑ:ʿ	Z
    //   1621: ifeq +10 -> 1631
    //   1624: aload_0
    ...
    //   1635: invokestatic 584	com/cyou/cma/clauncher/ˋי:ʽ	(Lcom/cyou/cma/clauncher/ˋי;)Z
    //   1638: pop
    //   1639: aload_0
    //   1640: monitorexit
    //   1641: aload_0
  ...
  private void ʾ()
  {
    ...
    {
      ˆـ localˆـ = (ˆـ)((Iterator)localObject3).next();
      if (localˆـ.ᴵ == -101L) {
        localArrayList.add(localˆـ);
      } else if (localˆـ.ᵎ == k) {
        ((ArrayList)localObject2).add(localˆـ);
      } else {
        ((ArrayList)localObject1).add(localˆـ);
      }
    }
        ...
        while (localCursor.moveToNext())
        {
          ...
          if (j == 0)
          {
            ...
            if (!ʻٴ.ʻ((String)localObject3, (String)localObject5))
            {
              ...
              ((ʿˏ)localObject3).ʽʽ = 1;
              ((ʿˏ)localObject3).ᐧ = 1;
              ((ʿˏ)localObject3).ᴵ = -200L;
              ((ʿˏ)localObject3).a_();
              ((ʿˏ)localObject3).ʾ((ˆـ)localObject1);
              continue;
          ...
          else if (j == 1)
          {
            ...
            ((ʿˏ)localObject5).ˎ = ((CharSequence)localObject3);
            ((ʿˏ)localObject5).ᴵ = -200L;
            ((ʿˏ)localObject5).ٴ = l2;
            ((ʿˏ)localObject5).ʼʼ = k;
            ((ʿˏ)localObject5).ʽʽ = 1;
            ((ʿˏ)localObject5).ᐧ = 1;
            if (localCursor.getInt(8) == 1) {}
            for (bool = true;; bool = false)
            {
              ((ʿˏ)localObject5).ʿ = bool;
              ((ʿˏ)localObject5).ᐧᐧ = ((String)localObject4);
              if (localMap.containsKey(Long.valueOf(((ʿˏ)localObject5).ٴ))) {
                break;
              }
              localMap.put(Long.valueOf(((ʿˏ)localObject5).ٴ), localObject5);
              break;
            }
          }
        }
  ...
  public final void run()
  {
    ...
    for (;;)
    {
      ...
      synchronized (ˋי.ˆ(this.ʼ))
      {
        ...
        ??? = ˋי.ˉ.keySet().iterator();
        for (;;)
        {
          if (((Iterator)???).hasNext())
          {
            Object localObject2 = ((Iterator)???).next();
            this.ʼ.ʻ(this.ʽ, (ـʽ)localObject2, (byte[])ˋי.ˉ.get(localObject2));
            continue;
            i = 1;
            break;
            j = 10;
