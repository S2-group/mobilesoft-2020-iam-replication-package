...
import com.adeptmobile.adeptsportslibrary.settings.urls.Urls;
import com.adeptmobile.adeptsportslibrary.util.LogUtil;
...
public class UIUtils
{
  ...
  public static boolean shouldShowLeaguePrerollAd(Context paramContext)
  {
    ...
    try
    {
      ...
      if (System.currentTimeMillis() > paramContext.getResources().getInteger(2131492872) * 3600000L + l) {
        return true;
      }
  ...
  public static void showCantPlayVideoDialog(Context paramContext)
  {
    ...
    localBuilder.setIcon(17301543).setMessage(paramContext.getResources().getString(2131230793)).setPositiveButton("Store", new DialogInterface.OnClickListener()
    {
  ...
  {
    AlertDialog.Builder localBuilder = new AlertDialog.Builder(paramContext);
    localBuilder.setTitle(paramContext.getResources().getString(2131230822));
