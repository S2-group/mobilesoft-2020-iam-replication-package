...
public class aj
{
  ...
  static
  {
    ...
    int j = 0;
    Object localObject2 = "\020mHMQ\017a]G`\030w";
    int i = -1;
    ...
    for (;;)
    {
      ...
      case 0: 
        localObject3[i4] = localObject1;
        j = 2;
        localObject2 = "\017aL^g\037aaDg\017p";
        i = 1;
        localObject1 = arrayOfString;
        break;
      case 1: 
      ...
      if (localSet.contains(localApplicationInfo.packageName))
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if (localRunningServiceInfo.service.getPackageName().equals(localApplicationInfo.packageName))
          {
            ...
            try
            {
              localJSONObject2.put(z[4], localRunningServiceInfo.service.getShortClassName());
        ...
        try
        {
          ...
          localJSONObject1.put(z[2], localJSONArray2);
