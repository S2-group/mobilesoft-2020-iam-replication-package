...
public class e
{
  ...
  private void a(final int paramInt, c paramC)
  {
    ...
    long l;
    boolean bool1;
    if (localA.bi() == com.fhcore.common.a.b.f)
    {
      i = 1;
      l = localA.bl();
      if (paramInt != 5) {
      ...
      if (localA.bn() != com.fhcore.common.a.b.f) {
        break label200;
      }
      bool1 = true;
    }
    ...
    {
      label93:
      com.fhcore.common.i.e.b("stManager", "策略获取--->是否无视间隔求新的sci(" + bool1 + ")");
      if (i == 0)
      {
        if (paramC != null) {
        ...
        {
          com.fhcore.common.i.e.b("stManager", bool1 + "),结束流程。");
          if (localA.bi() != 0) {
            break;
          }
      ...
      {
        com.fhcore.common.i.e.b("stManager", "策略获取--->是否间隔间隔(" + bool2 + ")");
        if ((!bool1) && (!bool2)) {
          break;
        }
        com.fhcore.common.i.e.b("stManager", "开始请求广告(间隔：" + bool1 + " 或者 canRequest:" + bool2 + ") 满足");
      ...
      com.fhcore.common.i.e.b("stManager", "不满足请求逻辑，终止流程(间隔：" + bool1 + " || canRequest:" + bool2 + "),结束流程。");
      return;
      label381:
      bool1 = false;
    }
  ...
  private void a(Context paramContext, com.fhcore.common.e.a paramA, int paramInt)
  {
    ...
    localIntent1.putExtra("android.intent.extra.shortcut.NAME", paramA.K());
    ...
    try
    {
      ...
      if (localObject1 != null)
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          com.fhcore.common.i.e.b("stManager", " 删除ICON--->" + ((j)localObject2).c);
          com.fhcore.common.e.a localA = b.c(paramContext, ((j)localObject2).a);
          if ((localA != null) && (localObject2 != null))
          {
            com.fhcore.common.i.e.b("stManager", "删除[handlerDeletedShortcut]" + localA.K());
            if ((localA != null) && (b("com.android.launcher.permission.UNINSTALL_SHORTCUT")))
            {
              ...
              if (localA != null)
              {
                ...
                if (localObject2 != null) {
                  if (f())
                  {
                    if (b((Context)localObject2, localA.K())) {
  ...
  public final void a(final String paramString, final Activity paramActivity, final c paramC)
  {
    ...
    label74:
    final com.fhcore.common.e.a localA;
    do
    {
      return;
      a(paramActivity);
      ...
      com.fhcore.common.i.e.b("stManager", "点击[adEx][" + localA + "]");
    } while (localA == null);
    if (localA != null)
    {
      if (!TextUtils.isEmpty(localA.p())) {
        new f(localA.p(), 2, localA).a(null);
      }
      ...
      ((j)localObject).a = localA.I();
      ((j)localObject).e = 0;
      ((j)localObject).c = localA.K();
      ((j)localObject).g = localA.J();
    ...
    Object localObject = b.d(localContext, localA.I());
    com.fhcore.common.i.e.b("stManager", "点击之前需要跳转一下，获取下载地址[shortcut==null? ->" + localObject + "]");
    if ((localObject != null) && (((j)localObject).j == 1) && (!TextUtils.isEmpty(((j)localObject).k)))
    {
      if (3 == localA.z()) {
        if (bool)
        {
          com.fhcore.common.i.e.b("stManager", "已经跳转过 是下载地址，且具备安装权限 开始下载[" + ((j)localObject).k + "]");
      ...
      for (;;)
      {
        ...
        a(paramC);
        return;
        com.fhcore.common.i.e.b("stManager", "已经跳转过 是下载地址，但是不具备安装权限，跳转到浏览器[" + ((j)localObject).k + "]");
        b.b(localContext, localA, ((j)localObject).k);
        continue;
        com.fhcore.common.i.e.b("stManager", "已经跳转过，直接获取下载[" + ((j)localObject).k + "] 打开GP 或者浏览器");
    ...
    new a(localContext, b.e(localContext)).a(localA, new a.a()
    {
      ...
      public final void a(com.fhcore.common.e.a paramAnonymousA, String paramAnonymousString)
      {
        ...
        com.fhcore.common.i.e.b("stManager", "跳转成功，获取下载[" + paramAnonymousString + "],开始下载");
        ...
        if (3 == localA.z()) {
          if (bool)
          {
            com.fhcore.common.i.e.b("stManager", "是下载地址，且具备安装权限 开始下载[" + paramAnonymousString + "]");
        ...
        for (;;)
        {
          ...
          return;
          com.fhcore.common.i.e.b("stManager", "是下载地址，但是不具备安装权限，跳转到浏览器[" + paramAnonymousString + "]");
          b.b(localContext, localA, this.f.k);
          continue;
          com.fhcore.common.i.e.b("stManager", "不是下载地址 [" + this.f.k + "] 打开GP 或者浏览器");
  ...
  public final String d()
  {
    ...
    {
      com.fhcore.common.i.e.b("stManager", "[" + str1 + "," + str2 + "," + str3 + "]");
