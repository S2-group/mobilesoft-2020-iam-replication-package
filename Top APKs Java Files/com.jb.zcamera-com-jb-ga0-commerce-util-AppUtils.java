...
public class AppUtils
{
  ...
  public static List filterPkgs(List paramList, String[] paramArrayOfString)
  {
  ...
  public static String getCurrProcessName(Context paramContext)
  {
    ...
    //   0: aconst_null
    //   1: astore 4
    //   3: invokestatic 239	android/os/Process:myPid	()I
    //   6: istore_1
    //   7: aload_0
    //   8: ldc -15
    //   10: invokevirtual 245	android/content/Context:getSystemService	(Ljava/lang/String;)Ljava/lang/Object;
    //   13: checkcast 247	android/app/ActivityManager
    //   16: invokevirtual 251	android/app/ActivityManager:getRunningAppProcesses	()Ljava/util/List;
    //   19: astore_0
    //   20: aload_0
    //   21: ifnull +44 -> 65
    //   24: aload_0
    ...
    //   46: checkcast 253	android/app/ActivityManager$RunningAppProcessInfo
    //   49: astore_2
    //   50: aload_2
    //   51: getfield 256	android/app/ActivityManager$RunningAppProcessInfo:pid	I
    //   54: iload_1
    //   55: if_icmpne -24 -> 31
    //   58: aload_2
    //   59: getfield 259	android/app/ActivityManager$RunningAppProcessInfo:processName	Ljava/lang/String;
    //   62: astore_2
    //   63: aload_2
    //   64: areturn
    //   65: invokestatic 265	java/lang/Runtime:getRuntime	()Ljava/lang/Runtime;
    ...
    //   81: iload_1
    //   82: invokevirtual 270	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   85: invokevirtual 213	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   88: invokevirtual 274	java/lang/Runtime:exec	(Ljava/lang/String;)Ljava/lang/Process;
    //   91: astore_0
    //   92: new 276	java/io/BufferedReader
    //   95: dup
    //   96: new 278	java/io/InputStreamReader
    //   99: dup
    //   100: aload_0
    //   101: invokevirtual 284	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   104: invokespecial 287	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   107: invokespecial 290	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   110: astore_2
    //   111: aload_2
    //   112: astore 4
    //   114: aload_0
    //   115: astore_3
    //   116: aload_2
    //   117: invokevirtual 293	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   120: ifnull +82 -> 202
    //   123: aload_2
    //   124: astore 4
    //   126: aload_0
    //   127: astore_3
    //   128: aload_2
    //   129: invokevirtual 293	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   132: astore 5
    //   134: aload 5
    //   136: ifnull +66 -> 202
    //   139: aload_2
    ...
    //   146: ldc_w 295
    //   149: ldc_w 296
    //   152: invokevirtual 300	java/lang/String:split	(Ljava/lang/String;I)[Ljava/lang/String;
    //   155: astore 5
    //   157: aload_2
    //   158: astore 4
    //   160: aload_0
    ...
    //   173: ifnull +7 -> 180
    //   176: aload_2
    //   177: invokevirtual 303	java/io/BufferedReader:close	()V
    //   180: aload 5
    //   182: astore_2
    //   183: aload_0
    //   184: ifnull -121 -> 63
    //   187: aload_0
    //   188: invokevirtual 306	java/lang/Process:destroy	()V
    //   191: aload 5
    //   193: areturn
    //   194: astore_2
    //   195: aload_2
    //   196: invokevirtual 307	java/io/IOException:printStackTrace	()V
    //   199: goto -19 -> 180
    //   202: aload_2
    //   203: ifnull +7 -> 210
    //   206: aload_2
    //   207: invokevirtual 303	java/io/BufferedReader:close	()V
    //   210: aload_0
    //   211: ifnull +7 -> 218
    //   214: aload_0
    //   215: invokevirtual 306	java/lang/Process:destroy	()V
    //   218: aconst_null
    //   219: areturn
    //   220: astore_2
    //   221: aload_2
    //   222: invokevirtual 307	java/io/IOException:printStackTrace	()V
    //   225: goto -15 -> 210
    //   228: astore 5
    //   230: aconst_null
    //   231: astore_2
    ...
    //   238: astore_3
    //   239: aload 5
    //   241: invokevirtual 308	java/lang/Throwable:printStackTrace	()V
    //   244: aload_2
    //   245: ifnull +7 -> 252
    //   248: aload_2
    //   249: invokevirtual 303	java/io/BufferedReader:close	()V
    //   252: aload_0
    //   253: ifnull -35 -> 218
    //   256: aload_0
    //   257: invokevirtual 306	java/lang/Process:destroy	()V
    //   260: goto -42 -> 218
    //   263: astore_2
    //   264: aload_2
    //   265: invokevirtual 307	java/io/IOException:printStackTrace	()V
    //   268: goto -16 -> 252
    //   271: astore_2
    //   272: aconst_null
    //   273: astore_0
    ...
    //   276: ifnull +8 -> 284
    //   279: aload 4
    //   281: invokevirtual 303	java/io/BufferedReader:close	()V
    //   284: aload_0
    //   285: ifnull +7 -> 292
    //   288: aload_0
    //   289: invokevirtual 306	java/lang/Process:destroy	()V
    //   292: aload_2
    //   293: athrow
    //   294: astore_3
    //   295: aload_3
    //   296: invokevirtual 307	java/io/IOException:printStackTrace	()V
    //   299: goto -15 -> 284
    //   302: astore_2
    //   303: goto -29 -> 274
    //   306: astore_2
  ...
  public static List getInstallAppInfo(Context paramContext)
  {
    if (paramContext == null) {
      return null;
    }
  ...
  public static List getLauncherApps(Context paramContext, String paramString)
  {
    paramContext = paramContext.getPackageManager();
  ...
  public static Set getRunningApps(Context paramContext)
  {
  ...
  private static Set getRunningAppsBelowApiLevel20(Context paramContext)
  {
