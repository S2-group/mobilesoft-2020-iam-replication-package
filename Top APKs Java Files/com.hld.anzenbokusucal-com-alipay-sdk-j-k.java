...
public final class k
{
  ...
  private static a a(Context paramContext, String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 238	android/content/Context:getPackageManager	()Landroid/content/pm/PackageManager;
    //   4: aload_1
    //   5: sipush 192
    //   8: invokevirtual 244	android/content/pm/PackageManager:getPackageInfo	(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    //   11: astore_2
    //   12: aload_2
    //   13: invokestatic 247	com/alipay/sdk/j/k:a	(Landroid/content/pm/PackageInfo;)Z
    //   16: ifne +21 -> 37
    //   19: aload_0
    //   20: aload_1
    //   21: invokestatic 251	com/alipay/sdk/j/k:b	(Landroid/content/Context;Ljava/lang/String;)Landroid/content/pm/PackageInfo;
    //   24: astore_0
    //   25: goto +58 -> 83
    //   28: astore_0
    //   29: ldc -3
    //   31: ldc -1
    //   33: aload_0
    //   34: invokestatic 260	com/alipay/sdk/app/a/a:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   37: aload_2
    //   38: astore_0
    //   39: goto +44 -> 83
    //   42: astore_2
    ...
    //   49: ldc_w 262
    //   52: aload_2
    //   53: invokestatic 260	com/alipay/sdk/app/a/a:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   56: aconst_null
    //   57: invokestatic 247	com/alipay/sdk/j/k:a	(Landroid/content/pm/PackageInfo;)Z
    //   60: ifne +21 -> 81
    //   63: aload_0
    //   64: aload_1
    //   65: invokestatic 251	com/alipay/sdk/j/k:b	(Landroid/content/Context;Ljava/lang/String;)Landroid/content/pm/PackageInfo;
    //   68: astore_0
    //   69: goto +14 -> 83
    //   72: astore_0
    //   73: ldc -3
    //   75: ldc -1
    //   77: aload_0
    //   78: invokestatic 260	com/alipay/sdk/app/a/a:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   81: aconst_null
    //   82: astore_0
    //   83: aload_0
    //   84: invokestatic 247	com/alipay/sdk/j/k:a	(Landroid/content/pm/PackageInfo;)Z
    //   87: ifne +5 -> 92
    //   90: aconst_null
    //   91: areturn
    //   92: aload_0
    ...
    //   96: aconst_null
    //   97: areturn
    //   98: new 6	com/alipay/sdk/j/k$a
    //   101: dup
    //   102: invokespecial 263	com/alipay/sdk/j/k$a:<init>	()V
    //   105: astore_1
    //   106: aload_1
    //   107: aload_0
    //   108: getfield 269	android/content/pm/PackageInfo:signatures	[Landroid/content/pm/Signature;
    //   111: putfield 271	com/alipay/sdk/j/k$a:a	[Landroid/content/pm/Signature;
    //   114: aload_1
    //   115: aload_0
    //   116: getfield 274	android/content/pm/PackageInfo:versionCode	I
    //   119: putfield 276	com/alipay/sdk/j/k$a:b	I
    //   122: aload_1
    //   123: areturn
    //   124: aconst_null
    //   125: invokestatic 247	com/alipay/sdk/j/k:a	(Landroid/content/pm/PackageInfo;)Z
    //   128: ifne +21 -> 149
    //   131: aload_0
    //   132: aload_1
    //   133: invokestatic 251	com/alipay/sdk/j/k:b	(Landroid/content/Context;Ljava/lang/String;)Landroid/content/pm/PackageInfo;
    //   136: pop
    //   137: goto +12 -> 149
    //   140: astore_0
    //   141: ldc -3
    //   143: ldc -1
    //   145: aload_0
    //   146: invokestatic 260	com/alipay/sdk/app/a/a:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   149: aload_2
    //   150: athrow
  ...
  public static boolean d(Context paramContext)
  {
    try
    {
      ...
      {
        boolean bool = TextUtils.equals(paramContext, a[1]);
        return bool;
      }
      return true;
    }
