...
public final class RuleUtils
{
  ...
  public static List<MultiConfig> getMultiConfigList(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      if (j < 5)
      {
        ...
        if ((localObject1 != null) && (((MultiConfig)localObject1).priority != -1))
        {
    ...
    try
    {
      ...
      if ((localObject != null) && (!((List)localObject).isEmpty()))
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          if ((localApplicationInfo != null) && (localApplicationInfo.metaData != null) && (!localApplicationInfo.metaData.isEmpty()) && (!TextUtils.equals(localApplicationInfo.packageName, paramContext.getPackageName())) && (localApplicationInfo.metaData.getInt("scenery_dispatcher_version", -1) >= 0)) {
  ...
  public static String getRealFilePath(Context paramContext, Uri paramUri)
  {
    ...
    //   5: areturn
    //   6: aload_1
    //   7: invokevirtual 303	android/net/Uri:getScheme	()Ljava/lang/String;
    //   10: astore_3
    //   11: aload_3
    //   12: ifnonnull +10 -> 22
    //   15: aload_1
    //   16: invokevirtual 306	android/net/Uri:getPath	()Ljava/lang/String;
    //   19: astore_0
    //   20: aload_0
    //   21: areturn
    //   22: ldc_w 308
    //   25: aload_3
    //   26: invokevirtual 310	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   29: ifeq +11 -> 40
    //   32: aload_1
    //   33: invokevirtual 306	android/net/Uri:getPath	()Ljava/lang/String;
    //   36: astore_0
    //   37: goto -17 -> 20
    //   40: ldc_w 312
    //   43: aload_3
    ...
    //   47: ifeq +131 -> 178
    //   50: aload_0
    //   51: invokevirtual 316	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   54: aload_1
    //   55: iconst_1
    ...
    //   66: aconst_null
    //   67: aconst_null
    //   68: invokevirtual 324	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   71: astore_1
    //   72: aload_1
    //   73: ifnull +110 -> 183
    //   76: aload_1
    //   77: astore_0
    //   78: aload_1
    //   79: invokeinterface 329 1 0
    //   84: ifeq +99 -> 183
    //   87: aload_1
    //   88: astore_0
    //   89: aload_1
    //   90: ldc_w 318
    //   93: invokeinterface 333 2 0
    //   98: istore_2
    //   99: iload_2
    //   100: iconst_m1
    ...
    //   135: astore_0
    //   136: aload_3
    //   137: invokevirtual 287	java/lang/Exception:printStackTrace	()V
    //   140: aload_1
    //   141: ifnull +37 -> 178
    //   144: aload_1
    //   145: invokeinterface 340 1 0
    //   150: aconst_null
    //   151: astore_0
    //   152: goto -132 -> 20
    //   155: astore_1
  ...
  public static boolean isFaceImage(Context paramContext, String paramString)
  {
    ...
    ((BitmapFactory.Options)localObject).inSampleSize = DecodeBitmapUtils.computeSampleSize((BitmapFactory.Options)localObject, -1, i * j);
    try
    {
  ...
  private static boolean isPeerSceneryRunOut(Context paramContext, String paramString1, String paramString2)
  {
    ...
    paramString1 = (Boolean)paramContext.mSceneSwitch.get(paramString2);
    if (DEBUG) {
    ...
    paramString1 = (Integer)paramContext.mSceneShowCount.get(paramString2);
    if (DEBUG) {
    ...
    paramString2 = (Integer)paramContext.mSceneHaveShowCount.get(paramString2);
    if (DEBUG) {
    ...
    if (DEBUG) {
      LogHelper.i("scenery", "generalShowCount=" + paramContext.generalShowCount + "; generalHaveShowCount=" + paramContext.generalHaveShowCount);
    }
    return paramContext.generalShowCount <= paramContext.generalHaveShowCount;
  }
  ...
  public static void syncMultiConfig(Context paramContext, List<MultiConfig> paramList)
  {
    ...
    do
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if (localMultiConfig2.generalHaveShowCount > localMultiConfig1.generalHaveShowCount)
        {
          localMultiConfig1.generalHaveShowCount = localMultiConfig2.generalHaveShowCount;
          i = 1;
        }
        if (localMultiConfig2.generalLastShowTime > localMultiConfig1.generalLastShowTime)
        {
          localMultiConfig1.generalLastShowTime = localMultiConfig2.generalLastShowTime;
          i = 1;
        }
        ...
        while (localIterator.hasNext())
        {
          ...
          Object localObject = (Integer)localMultiConfig2.mSceneHaveShowCount.get(str);
          int j;
          int k;
          long l1;
          if (localObject == null)
          {
            j = 0;
            localObject = (Integer)localMultiConfig1.mSceneHaveShowCount.get(str);
            if (localObject != null) {
              break label292;
            }
            k = 0;
            if (j > k)
            {
              localMultiConfig1.mSceneHaveShowCount.put(str, Integer.valueOf(j));
              i = 1;
            }
            localObject = (Long)localMultiConfig2.mSceneLastShowTime.get(str);
            if (localObject != null) {
              break label302;
            }
            l1 = 0L;
            localObject = (Long)localMultiConfig1.mSceneLastShowTime.get(str);
            if (localObject != null) {
              break label312;
            }
          }
          for (long l2 = 0L;; l2 = ((Long)localObject).longValue())
          {
            ...
            localMultiConfig1.mSceneLastShowTime.put(str, Long.valueOf(l1));
            i = 1;
            break;
