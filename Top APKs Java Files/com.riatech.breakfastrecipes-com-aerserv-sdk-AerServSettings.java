...
public class AerServSettings
{
  ...
  {
    Boolean localBoolean = centralLoggingEnabled;
  ...
  {
    Integer localInteger = centralLoggingLineCount;
  ...
  {
    Boolean localBoolean = centralLoggingSendStackTrace;
    if (localBoolean != null) {
      return localBoolean.booleanValue();
    }
    return true;
  ...
  {
    Integer localInteger = step1Timeout;
    int i;
    if (localInteger != null) {
  ...
  {
    Integer localInteger = step2Timeout;
    int i;
    if (localInteger != null) {
      i = localInteger.intValue();
    } else {
  ...
  {
    Integer localInteger = step3Timeout;
    int i;
    if (localInteger != null) {
      i = localInteger.intValue();
    } else {
  ...
  {
    Integer localInteger = step4Timeout;
    int i;
    if (localInteger != null) {
      i = localInteger.intValue();
    } else {
  ...
  {
    readConfig(paramString);
    paramString = isAnalyticsEnabled;
    if (paramString != null) {
