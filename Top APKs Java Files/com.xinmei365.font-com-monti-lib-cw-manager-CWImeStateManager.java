...
public class CWImeStateManager
{
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localCWKeyboardMatch != null)
      {
        ...
        if (!TextUtils.isEmpty(str)) {
          return new Pair(localCWKeyboardMatch, str);
        }
      }
    }
    return null;
  ...
  public CWStateHolder getInstantStateHolder(Context paramContext)
  {
    for (;;)
    {
      ...
      {
        paramContext = (CWKeyboardMatch)((Pair)localObject3).first;
      ...
      else
      {
        ...
        if (localObject4 != null)
        {
          ...
          if (!((List)localObject4).isEmpty())
          {
            ...
            if (localObject4 != null)
            {
              localObject3 = (CWKeyboardMatch)((Pair)localObject4).first;
        ...
        else if ((this.keyboardMatches != null) && (!this.keyboardMatches.isEmpty()))
        {
          ...
          {
            localObject1 = (CWKeyboardMatch)paramContext.first;
            paramContext = new CWStateHolder(1, (String)paramContext.second, ((CWKeyboardMatch)localObject1).type());
          }
          else
          {
