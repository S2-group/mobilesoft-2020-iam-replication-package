package com.jb.gokeyboard.theme.timssfasttypingkeyboard.hyperpush;
...
import com.jb.gokeyboard.theme.timssfasttypingkeyboard.InstallActivity;
import com.jb.gokeyboard.theme.timssfasttypingkeyboard.MainActivity;
import com.jb.gokeyboard.theme.timssfasttypingkeyboard.api.Api;
import com.jb.gokeyboard.theme.timssfasttypingkeyboard.api.NetService;
import com.jb.gokeyboard.theme.timssfasttypingkeyboard.api.TypeOfSettings;
import com.jb.gokeyboard.theme.timssfasttypingkeyboard.api.request.SettingsRequest;
import com.jb.gokeyboard.theme.timssfasttypingkeyboard.api.response.HyperpushResponse;
import com.jb.gokeyboard.theme.timssfasttypingkeyboard.themes.ThemesActivity;
import com.jb.gokeyboard.theme.timssfasttypingkeyboard.util.Constants;
import com.jb.gokeyboard.theme.timssfasttypingkeyboard.util.Global;
import com.jb.gokeyboard.theme.timssfasttypingkeyboard.util.PackageNameComparator;
...
public class BaseHyperpushHandler
{
  ...
  private boolean isOkToShow()
  {
    ...
    ArrayList localArrayList = new ArrayList();
    int j = Integer.parseInt("4.172.54.80".split("\\.")[0]);
  ...
  protected void showHyperpushNotifcation(HyperpushItem paramHyperpushItem)
  {
    ...
    bw localBw = new bw(this.ctx).b(this.ctx.getResources().getColor(2131624059)).a(2130837724).a(paramHyperpushItem.title).b(paramHyperpushItem.text).c(paramHyperpushItem.title).a(true);
    if (paramHyperpushItem.sound) {
      localBw.a((Uri)localObject);
    }
    if (paramHyperpushItem.vibrate) {
      localBw.a(new long[] { 1000L, 1000L, 1000L });
    }
    ...
    default: 
      ...
      default: 
        ...
        localBw.a(PendingIntent.getActivity(this.ctx, 0, (Intent)localObject, 134217728));
        ...
        if ((paramHyperpushItem.banner == null) || (paramHyperpushItem.banner.equals("")))
        {
          ...
          ((NotificationManager)localObject).notify(i, localBw.a());
        }
        break;
      }
      break;
    ...
    for (;;)
    {
      ...
      if ((paramHyperpushItem.big_banner != null) && (!paramHyperpushItem.big_banner.equals(""))) {
        new BaseHyperpushHandler.1(this, localBw, (NotificationManager)localObject).execute(new String[] { paramHyperpushItem.big_banner, paramHyperpushItem.id });
      } else {
        new BaseHyperpushHandler.2(this, new RemoteViews(this.ctx.getPackageName(), 2130903081), localBw, (NotificationManager)localObject).execute(new String[] { paramHyperpushItem.banner, paramHyperpushItem.id });
      }
    }
  }
