  ...
  implements ConfigurationFetcherDelegate
{
  ...
  public void onConfigurationFetched(boolean paramBoolean)
  {
    ...
    {
      this.mDelegate.onConfigurationUpdate(false);
      this.mStartup = false;
    }
  }
  ...
  public void onResume(AppLifeCycleResumeState paramAppLifeCycleResumeState)
  {
    ...
    if ((paramAppLifeCycleResumeState == AppLifeCycleResumeState.NEW_SESSION) || (paramAppLifeCycleResumeState == AppLifeCycleResumeState.RESTART_APP))
    {
  ...
  public void setLanguage(String paramString)
  {
    ...
    if (this.mConnectivity) {
      new Thread(new Runnable()
      {
        public void run()
        {
          BannersConfiguration.this.onResume(AppLifeCycleResumeState.NEW_SESSION);
        }
      }).start();
    }
  }
