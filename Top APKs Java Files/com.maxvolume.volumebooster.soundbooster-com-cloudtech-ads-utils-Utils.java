...
public class Utils
{
  ...
  {
    // Byte code:
    //   0: getstatic 74	com/cloudtech/ads/utils/Utils:h	Ljava/lang/String;
    //   3: invokestatic 80	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   6: ifeq +89 -> 95
    //   9: ldc 82
    //   11: ldc 84
    //   13: invokestatic 89	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;)I
    //   16: pop
    //   17: aconst_null
    //   18: astore 4
    //   20: aconst_null
    //   21: astore_2
    //   22: new 91	android/webkit/WebView
    //   25: dup
    //   26: aload_0
    //   27: invokespecial 94	android/webkit/WebView:<init>	(Landroid/content/Context;)V
    //   30: astore_0
    //   31: aload_0
    //   32: invokevirtual 98	android/webkit/WebView:getSettings	()Landroid/webkit/WebSettings;
    //   35: invokevirtual 104	android/webkit/WebSettings:getUserAgentString	()Ljava/lang/String;
    //   38: putstatic 74	com/cloudtech/ads/utils/Utils:h	Ljava/lang/String;
    //   41: aload_0
    //   42: invokevirtual 107	android/webkit/WebView:destroy	()V
    //   45: goto +50 -> 95
    //   48: astore_3
    //   49: aload_0
    //   50: astore_2
    ...
    //   69: astore_2
    //   70: aload_3
    //   71: invokevirtual 110	java/lang/Exception:printStackTrace	()V
    //   74: aload_0
    //   75: ifnull +20 -> 95
    //   78: aload_0
    //   79: invokevirtual 107	android/webkit/WebView:destroy	()V
    //   82: goto +13 -> 95
    //   85: aload_2
    //   86: ifnull +7 -> 93
    //   89: aload_2
    //   90: invokevirtual 107	android/webkit/WebView:destroy	()V
    //   93: aload_0
    //   94: athrow
    //   95: iload_1
    //   96: ifeq +14 -> 110
    //   99: getstatic 74	com/cloudtech/ads/utils/Utils:h	Ljava/lang/String;
    //   102: invokevirtual 116	java/lang/String:getBytes	()[B
    //   105: iconst_0
    //   106: invokestatic 120	android/util/Base64:encodeToString	([BI)Ljava/lang/String;
    //   109: areturn
    //   110: getstatic 74	com/cloudtech/ads/utils/Utils:h	Ljava/lang/String;
    //   113: areturn
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	114	0	paramContext	Context
    //   0	114	1	paramBoolean	boolean
    //   21	69	2	localContext	Context
    //   48	4	3	localObject1	Object
    //   56	1	3	localException1	Exception
    //   64	7	3	localException2	Exception
    //   18	48	4	localObject2	Object
    // Exception table:
    //   from	to	target	type
    //   31	41	48	finally
    //   31	41	56	java/lang/Exception
    //   22	31	60	finally
    //   70	74	60	finally
    //   22	31	64	java/lang/Exception
  }
  ...
  private static ArrayList<String> a(String[] paramArrayOfString)
  {
    ...
    //   7: astore_1
    //   8: invokestatic 130	java/lang/Runtime:getRuntime	()Ljava/lang/Runtime;
    //   11: aload_0
    //   12: invokevirtual 134	java/lang/Runtime:exec	([Ljava/lang/String;)Ljava/lang/Process;
    //   15: astore_0
    //   16: new 136	java/io/BufferedWriter
    //   19: dup
    //   20: new 138	java/io/OutputStreamWriter
    //   23: dup
    //   24: aload_0
    //   25: invokevirtual 144	java/lang/Process:getOutputStream	()Ljava/io/OutputStream;
    //   28: invokespecial 147	java/io/OutputStreamWriter:<init>	(Ljava/io/OutputStream;)V
    //   31: invokespecial 150	java/io/BufferedWriter:<init>	(Ljava/io/Writer;)V
    //   34: pop
    //   35: new 152	java/io/BufferedReader
    //   38: dup
    //   39: new 154	java/io/InputStreamReader
    //   42: dup
    //   43: aload_0
    //   44: invokevirtual 158	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   47: invokespecial 161	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   50: invokespecial 164	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   53: astore_0
    //   54: aload_0
    //   55: invokevirtual 167	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   58: astore_2
    //   59: aload_2
    //   60: ifnull +31 -> 91
    //   63: ldc -87
    //   65: ldc -85
    //   67: aload_2
    //   68: invokestatic 175	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   71: invokevirtual 179	java/lang/String:concat	(Ljava/lang/String;)Ljava/lang/String;
    //   74: invokestatic 185	com/cloudtech/ads/utils/YeLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   77: aload_1
    //   78: aload_2
    //   79: invokevirtual 189	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   82: pop
    //   83: goto -29 -> 54
    //   86: astore_0
    //   87: aload_0
    //   88: invokevirtual 110	java/lang/Exception:printStackTrace	()V
    //   91: ldc -87
    //   93: ldc -65
    //   95: aload_1
    //   96: invokestatic 175	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   99: invokevirtual 179	java/lang/String:concat	(Ljava/lang/String;)Ljava/lang/String;
    //   102: invokestatic 185	com/cloudtech/ads/utils/YeLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   105: aload_1
    //   106: areturn
    //   107: aconst_null
    //   108: areturn
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	113	0	paramArrayOfString	String[]
    //   7	99	1	localArrayList	ArrayList
    //   58	21	2	str	String
    // Exception table:
    //   from	to	target	type
    //   54	59	86	java/lang/Exception
    //   63	83	86	java/lang/Exception
    //   8	16	109	java/lang/Exception
  }
  ...
  public static List<String> a(List<String> paramList, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1)
    {
      YeLog.d("isNormal::".concat(String.valueOf(paramBoolean2)));
      i = 100;
      if (paramBoolean2)
      {
  ...
  @Keep
  public static File getVideoCacheDir(Context paramContext)
  {
    return new File(paramContext.getExternalCacheDir(), "video-cache");
  }
  ...
  public static int j(Context paramContext)
  {
    ...
    if (!bool)
    {
      ...
      {
        YeLog.i("Utils", "buildTags=".concat(String.valueOf(localObject)));
        j = 1;
      }
      else
      {
      ...
      if ((j == 0) && (!b()) && (!c()))
      {
        ...
        if (localObject != null)
        {
          StringBuilder localStringBuilder = new StringBuilder("execResult=");
