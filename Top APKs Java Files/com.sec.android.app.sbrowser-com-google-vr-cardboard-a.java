...
public class a
{
  ...
  {
    paramContext = new AlertDialog.Builder(paramContext, l.e.GvrDialogTheme);
    paramContext.setMessage(paramInt1).setTitle(l.d.dialog_title_warning).setPositiveButton(paramInt2, paramOnClickListener).setNegativeButton(l.d.cancel_button, new DialogInterface.OnClickListener()
    {
  ...
  public static boolean a(Activity paramActivity, boolean paramBoolean, int paramInt)
  {
    ...
    catch (PackageManager.NameNotFoundException localNameNotFoundException)
    {
      ...
      if (((paramInt & 0x1) != 0) && (a(paramActivity, b(paramActivity)))) {
  ...
  private static boolean a(Context paramContext, int paramInt)
  {
    if (paramInt == -1)
    {
      a(paramContext, l.d.dialog_vr_core_not_installed, l.d.go_to_playstore_button, new DialogInterface.OnClickListener()
      {
        public void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
        {
    ...
    if (paramInt == -2)
    {
      a(paramContext, l.d.dialog_vr_core_not_enabled, l.d.go_to_vr_listeners_settings_button, new DialogInterface.OnClickListener()
      {
        public void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
        {
