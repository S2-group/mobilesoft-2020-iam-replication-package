  ...
  extends Activity
{
  ...
  private final Runnable sendemoff = new Runnable()
  {
    public void run()
    {
      Toast.makeText(applistbup.this, applistbup.this.getResources().getString(2131099739), 1).show();
      ...
      for (;;)
      {
        ...
        {
          localIntent.setComponent(new ComponentName("com.kissta.animalballoonpop", "com.kissta.animalballoonpop.openapp"));
          continue;
  ...
  private void do4plus()
  {
    if (this.installed201)
    {
      ...
      this.apps.set(4, "Doll House Premium");
      label95:
  ...
  {
    LinearLayout localLinearLayout = (LinearLayout)findViewById(2131492987);
    switch (this.focus)
    {
    default: 
      return;
    case 1: 
      if (this.small == 1)
      {
        localLinearLayout.setBackgroundResource(2130837588);
        return;
      }
      if (this.small == 2)
      {
        localLinearLayout.setBackgroundResource(2130837589);
        return;
      }
      if (this.small == 3)
      {
        localLinearLayout.setBackgroundResource(2130837590);
        return;
      }
      localLinearLayout.setBackgroundResource(2130837591);
      return;
    case 2: 
      if (this.small == 1)
      {
        localLinearLayout.setBackgroundResource(2130837593);
        return;
      }
      if (this.small == 2)
      {
        localLinearLayout.setBackgroundResource(2130837594);
        return;
      }
      if (this.small == 3)
      {
        localLinearLayout.setBackgroundResource(2130837595);
        return;
      }
      localLinearLayout.setBackgroundResource(2130837596);
      return;
    }
    if (this.small == 1)
    {
      localLinearLayout.setBackgroundResource(2130837598);
      return;
    }
    if (this.small == 2)
    {
      localLinearLayout.setBackgroundResource(2130837599);
      return;
    }
    if (this.small == 3)
    {
      localLinearLayout.setBackgroundResource(2130837600);
      return;
    }
    localLinearLayout.setBackgroundResource(2130837601);
  }
  ...
  public void onBackPressed()
  {
    ...
    Toast.makeText(this, getResources().getString(2131099733), 1).show();
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    if (this.openthisapp < 101)
    {
      ...
      default: 
        ...
        this.gridview = ((GridView)findViewById(2131492991));
        this.gridview.setSoundEffectsEnabled(false);
        paramBundle = (ImageButton)findViewById(2131492992);
    ...
    {
      displaychangeage();
      ((ImageButton)findViewById(2131492988)).setOnClickListener(new View.OnClickListener()
      {
        public void onClick(View paramAnonymousView)
        {
          if (applistbup.this.focus != 1)
          {
            ...
            paramAnonymousView = (LinearLayout)applistbup.this.findViewById(2131492987);
            if (applistbup.this.small != 1) {
              break label71;
            }
            paramAnonymousView.setBackgroundResource(2130837588);
          }
          for (;;)
          {
            ...
            if (applistbup.this.small == 2) {
              paramAnonymousView.setBackgroundResource(2130837589);
            } else if (applistbup.this.small == 3) {
              paramAnonymousView.setBackgroundResource(2130837590);
            } else {
              paramAnonymousView.setBackgroundResource(2130837591);
            }
          }
        }
      });
      ((ImageButton)findViewById(2131492989)).setOnClickListener(new View.OnClickListener()
      {
        public void onClick(View paramAnonymousView)
        {
          if (applistbup.this.focus != 2)
          {
            ...
            paramAnonymousView.setBackgroundResource(2130837593);
          }
          for (;;)
          {
            ...
            label71:
            if (applistbup.this.small == 2) {
              paramAnonymousView.setBackgroundResource(2130837594);
            } else if (applistbup.this.small == 3) {
              paramAnonymousView.setBackgroundResource(2130837595);
            } else {
              paramAnonymousView.setBackgroundResource(2130837596);
            }
          }
        }
      });
      ((ImageButton)findViewById(2131492990)).setOnClickListener(new View.OnClickListener()
      {
        public void onClick(View paramAnonymousView)
        {
          if (applistbup.this.focus != 3)
          {
            ...
            paramAnonymousView.setBackgroundResource(2130837598);
          }
          for (;;)
          {
            ...
            label71:
            if (applistbup.this.small == 2) {
              paramAnonymousView.setBackgroundResource(2130837599);
            } else if (applistbup.this.small == 3) {
              paramAnonymousView.setBackgroundResource(2130837600);
            } else {
              paramAnonymousView.setBackgroundResource(2130837601);
            }
          }
        }
      });
  ...
  public void onWindowFocusChanged(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      this.myHandler.postDelayed(this.playmusic, 600L);
      return;
    }
    Playsound2.stop();
    this.myHandler.removeCallbacks(this.playmusic);
