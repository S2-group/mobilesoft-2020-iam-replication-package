...
class SystemObserver
{
  ...
  public String getURIScheme(String paramString)
  {
    ...
    //   6: astore_2
    //   7: aload_0
    //   8: invokespecial 319	io/branch/referral/SystemObserver:isLowOnMemory	()Z
    //   11: ifne +167 -> 178
    //   14: aload_0
    ...
    //   26: aload_1
    //   27: iconst_0
    //   28: invokevirtual 323	android/content/pm/PackageManager:getApplicationInfo	(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    //   31: getfield 229	android/content/pm/ApplicationInfo:publicSourceDir	Ljava/lang/String;
    //   34: astore_1
    //   35: aconst_null
    //   36: astore 9
    //   38: aconst_null
    ...
    //   57: aconst_null
    //   58: astore 5
    //   60: new 325	java/util/jar/JarFile
    //   63: dup
    //   64: aload_1
    //   65: invokespecial 328	java/util/jar/JarFile:<init>	(Ljava/lang/String;)V
    //   68: astore_1
    //   69: aload 11
    //   71: astore_2
    //   72: aload 10
    ...
    //   80: aload_1
    //   81: ldc_w 330
    //   84: invokevirtual 334	java/util/jar/JarFile:getEntry	(Ljava/lang/String;)Ljava/util/zip/ZipEntry;
    //   87: invokevirtual 338	java/util/jar/JarFile:getInputStream	(Ljava/util/zip/ZipEntry;)Ljava/io/InputStream;
    //   90: astore 4
    //   92: aload 4
    //   94: astore_2
    //   95: aload 4
    ...
    //   100: astore 5
    //   102: aload 4
    //   104: invokevirtual 343	java/io/InputStream:available	()I
    //   107: newarray byte
    //   109: astore 7
    //   111: aload 4
    //   113: astore_2
    ...
    //   121: aload 4
    //   123: aload 7
    //   125: invokevirtual 347	java/io/InputStream:read	([B)I
    //   128: pop
    //   129: aload 4
    //   131: astore_2
    //   132: aload 4
    ...
    //   135: aload 4
    //   137: astore 5
    //   139: new 349	io/branch/referral/ApkParser
    //   142: dup
    //   143: invokespecial 350	io/branch/referral/ApkParser:<init>	()V
    //   146: aload 7
    //   148: invokevirtual 354	io/branch/referral/ApkParser:decompressXML	([B)Ljava/lang/String;
    //   151: astore 7
    //   153: aload 7
    //   155: astore_2
    //   156: aload 4
    ...
    //   162: astore_3
    //   163: aload 4
    //   165: invokevirtual 357	java/io/InputStream:close	()V
    //   168: aload_1
    //   169: ifnull +146 -> 315
    //   172: aload_2
    //   173: astore_3
    //   174: aload_1
    //   175: invokevirtual 358	java/util/jar/JarFile:close	()V
    //   178: aload_2
    //   179: areturn
    //   180: astore_1
    //   181: aload_2
    ...
    //   194: astore_3
    //   195: aload 5
    //   197: invokevirtual 357	java/io/InputStream:close	()V
    //   200: aload 6
    //   202: astore_2
    //   203: aload_1
    //   204: ifnull -26 -> 178
    ...
    //   209: astore_3
    //   210: aload_1
    //   211: invokevirtual 358	java/util/jar/JarFile:close	()V
    //   214: ldc 8
    //   216: areturn
    //   217: astore_1
    //   218: aload 9
    ...
    //   229: astore_3
    //   230: aload_2
    //   231: invokevirtual 357	java/io/InputStream:close	()V
    //   234: aload 6
    //   236: astore_2
    //   237: aload_1
    //   238: ifnull -60 -> 178
    ...
    //   243: astore_3
    //   244: aload_1
    //   245: invokevirtual 358	java/util/jar/JarFile:close	()V
    //   248: ldc 8
    //   250: areturn
    //   251: astore_1
    //   252: aload_2
    ...
    //   258: astore_3
    //   259: aload_2
    //   260: invokevirtual 357	java/io/InputStream:close	()V
    //   263: aload 4
    //   265: ifnull +11 -> 276
    //   268: aload 6
    //   270: astore_3
    //   271: aload 4
    //   273: invokevirtual 358	java/util/jar/JarFile:close	()V
    //   276: aload 6
    //   278: astore_3
    //   279: aload_1
    //   280: athrow
