...
public class DeviceUtils
{
  ...
  public static void callPhone(Context paramContext, String paramString)
  {
    ...
    localStringBuilder.append("tel:");
    localStringBuilder.append(paramString);
    paramContext.startActivity(new Intent("android.intent.action.CALL", Uri.parse(localStringBuilder.toString())));
  }
  ...
  public static void sendSms(Context paramContext, String paramString1, String paramString2)
  {
    ...
    localObject = new Intent("android.intent.action.SENDTO", Uri.parse(localStringBuilder.toString()));
