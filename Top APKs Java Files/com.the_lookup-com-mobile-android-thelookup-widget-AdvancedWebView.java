package com.mobile.android.thelookup.widget;
...
import com.mobile.android.thelookup.util.Utils;
import java.io.File;
  ...
  extends WebView
{
  ...
  @SuppressLint({"NewApi"})
  public static boolean handleDownload(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    if (Build.VERSION.SDK_INT >= 9)
    {
      ...
      paramString1.setMimeType(paramString3);
    ...
    catch (SecurityException paramString3)
    {
      for (;;) {}
    }
    ...
    paramString2.enqueue(paramString1);
    return true;
    Utils.openAppSettings(paramContext, "com.android.providers.downloads");
    return false;
  ...
  protected void init(final Context paramContext)
  {
    if (isInEditMode()) {
      return;
    }
    ...
    if (Build.VERSION.SDK_INT < 19) {
      ((WebSettings)localObject).setDatabasePath(str);
    }
    ...
    super.setWebViewClient(new WebViewClient()
    {
      ...
      public void onReceivedError(WebView paramAnonymousWebView, int paramAnonymousInt, String paramAnonymousString1, String paramAnonymousString2)
      {
        ...
        Log.d("AdvancedWebView", localStringBuilder.toString());
        if (AdvancedWebView.this.mListener != null) {
      ...
      @SuppressLint({"NewApi"})
      public void onUnhandledInputEvent(WebView paramAnonymousWebView, InputEvent paramAnonymousInputEvent)
      {
        if (Build.VERSION.SDK_INT >= 21) {
          paramAnonymousWebView = AdvancedWebView.this.mCustomWebViewClient;
        }
      }
      ...
      public boolean shouldOverrideUrlLoading(WebView paramAnonymousWebView, String paramAnonymousString)
      {
        ...
        Log.d("AdvancedWebView", ((StringBuilder)localObject).toString());
        localObject = Uri.parse(paramAnonymousString).getHost();
        if (localObject != null)
        {
          if ((((String)localObject).contains("play.google.com")) || (((String)localObject).contains("youtube")))
          {
            i = 0;
            break label120;
          }
          ...
          if ((paramAnonymousString.startsWith("telephone")) || (paramAnonymousString.startsWith("mailto")) || (paramAnonymousString.startsWith("tel")) || (paramAnonymousString.startsWith("geo"))) {
            break label118;
          }
        }
        int i = 1;
        ...
        if (i == 0)
        {
          localObject = new Intent("android.intent.action.VIEW", Uri.parse(paramAnonymousString));
          try
          {
        ...
        catch (MalformedURLException paramAnonymousWebView)
        {
    ...
    super.setWebChromeClient(new WebChromeClient()
    {
      ...
      {
        if (AdvancedWebView.this.mListener != null) {
          AdvancedWebView.this.mListener.onProgressChanged(paramAnonymousWebView, paramAnonymousInt);
        }
        if (AdvancedWebView.this.mCustomWebChromeClient != null) {
        ...
        paramAnonymousWebView.append("onProgressChanged: ");
        paramAnonymousWebView.append(paramAnonymousInt);
        Log.d("AdvancedWebView", paramAnonymousWebView.toString());
      }
  ...
  public void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if (paramInt1 == this.mRequestCodeFilePicker) {
      if (paramInt2 == -1)
      {
        ...
        localObject = this.mFileUploadCallbackFirst;
        if (localObject != null)
        {
          ((ValueCallback)localObject).onReceiveValue(paramIntent.getData());
    ...
    return;
    paramIntent = this.mFileUploadCallbackFirst;
    if (paramIntent != null)
    {
      paramIntent.onReceiveValue(null);
      this.mFileUploadCallbackFirst = null;
      return;
    }
    paramIntent = this.mFileUploadCallbackSecond;
    if (paramIntent != null)
    {
      paramIntent.onReceiveValue(null);
      this.mFileUploadCallbackSecond = null;
  ...
  protected void onScrollChanged(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    this.mListener.onScroll(paramInt1, paramInt2, paramInt3, paramInt4);
  }
  ...
  protected void openFileInput(ValueCallback<Uri> paramValueCallback, ValueCallback<Uri[]> paramValueCallback1, boolean paramBoolean)
  {
    ...
    paramValueCallback1 = this.mFragment;
    if ((paramValueCallback1 != null) && (paramValueCallback1.get() != null) && (Build.VERSION.SDK_INT >= 11))
    {
    ...
    paramValueCallback1 = this.mActivity;
    if ((paramValueCallback1 != null) && (paramValueCallback1.get() != null)) {
  ...
  protected void setGeolocationDatabasePath()
  {
    ...
    if ((localObject != null) && (((WeakReference)localObject).get() != null) && (Build.VERSION.SDK_INT >= 11) && (((Fragment)this.mFragment.get()).getActivity() != null))
    {
      localObject = ((Fragment)this.mFragment.get()).getActivity();
    }
    else
    {
    ...
    getSettings().setGeolocationDatabasePath(((Activity)localObject).getFilesDir().getPath());
    return;
  }
  ...
  public static class Browsers
  {
    ...
    {
      Object localObject = mAlternativePackage;
      if (localObject != null) {
        return localObject;
      }
      localObject = Arrays.asList(AdvancedWebView.ALTERNATIVE_BROWSERS);
      ...
      while (paramContext.hasNext())
      {
        ...
        if ((localApplicationInfo.enabled) && (((List)localObject).contains(localApplicationInfo.packageName)))
        {
