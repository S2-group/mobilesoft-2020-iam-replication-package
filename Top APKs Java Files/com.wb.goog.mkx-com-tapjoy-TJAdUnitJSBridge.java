...
public class TJAdUnitJSBridge
{
  ...
  public void alert(JSONObject paramJSONObject, final String paramString)
  {
    ...
    //   11: aload_1
    //   12: invokevirtual 167	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   15: invokevirtual 171	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   18: invokestatic 173	com/tapjoy/TapjoyLog:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   21: ldc -81
    //   23: astore 6
    //   25: aload_1
    //   26: ldc -79
    //   28: invokevirtual 183	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   31: astore 5
    //   33: aload 5
    //   35: astore 6
    //   37: aload_1
    //   38: ldc -71
    //   40: invokevirtual 183	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   43: astore 7
    //   45: aload 7
    //   47: astore 6
    //   49: aload_1
    //   50: ldc -69
    //   52: invokevirtual 191	org/json/JSONObject:getJSONArray	(Ljava/lang/String;)Lorg/json/JSONArray;
    //   55: astore_1
    //   56: new 193	android/app/AlertDialog$Builder
    //   59: dup
    //   60: aload_0
    //   61: getfield 88	com/tapjoy/TJAdUnitJSBridge:c	Landroid/content/Context;
    //   64: invokespecial 196	android/app/AlertDialog$Builder:<init>	(Landroid/content/Context;)V
    //   67: aload 5
    //   69: invokevirtual 200	android/app/AlertDialog$Builder:setTitle	(Ljava/lang/CharSequence;)Landroid/app/AlertDialog$Builder;
    //   72: aload 6
    //   74: invokevirtual 203	android/app/AlertDialog$Builder:setMessage	(Ljava/lang/CharSequence;)Landroid/app/AlertDialog$Builder;
    //   77: invokevirtual 207	android/app/AlertDialog$Builder:create	()Landroid/app/AlertDialog;
    //   80: astore 5
    //   82: aload_1
    //   83: ifnull +10 -> 93
    //   86: aload_1
    //   87: invokevirtual 213	org/json/JSONArray:length	()I
    //   90: ifne +56 -> 146
    //   93: aload_0
    //   94: aload_2
    //   95: iconst_1
    ...
    //   99: dup
    //   100: iconst_0
    //   101: getstatic 219	java/lang/Boolean:FALSE	Ljava/lang/Boolean;
    //   104: aastore
    //   105: invokevirtual 223	com/tapjoy/TJAdUnitJSBridge:invokeJSCallback	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   108: return
    //   109: astore_1
    //   110: ldc -81
    //   112: astore 7
    ...
    //   128: dup
    //   129: iconst_0
    //   130: getstatic 219	java/lang/Boolean:FALSE	Ljava/lang/Boolean;
    //   133: aastore
    //   134: invokevirtual 223	com/tapjoy/TJAdUnitJSBridge:invokeJSCallback	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   137: aload_1
    //   138: invokevirtual 226	java/lang/Exception:printStackTrace	()V
    //   141: aconst_null
    //   142: astore_1
    //   143: goto -87 -> 56
    //   146: new 228	java/util/ArrayList
    //   149: dup
    //   150: invokespecial 229	java/util/ArrayList:<init>	()V
    //   153: astore 6
    //   155: iconst_0
    //   156: istore 4
    //   158: iload 4
    //   160: aload_1
    //   161: invokevirtual 213	org/json/JSONArray:length	()I
    ...
    //   196: aload_1
    //   197: iload 4
    //   199: invokevirtual 232	org/json/JSONArray:getString	(I)Ljava/lang/String;
    //   202: invokevirtual 236	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   205: pop
    //   206: aload 5
    //   208: iload_3
    //   209: aload 6
    //   211: iload 4
    //   213: invokevirtual 240	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   216: checkcast 242	java/lang/CharSequence
    //   219: new 12	com/tapjoy/TJAdUnitJSBridge$3
    //   222: dup
    //   223: aload_0
    //   224: aload_2
    //   225: invokespecial 245	com/tapjoy/TJAdUnitJSBridge$3:<init>	(Lcom/tapjoy/TJAdUnitJSBridge;Ljava/lang/String;)V
    //   228: invokevirtual 251	android/app/AlertDialog:setButton	(ILjava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)V
    //   231: iload 4
    //   233: iconst_1
    //   234: iadd
    //   235: istore 4
    ...
    //   252: astore 7
    //   254: aload 7
    //   256: invokevirtual 226	java/lang/Exception:printStackTrace	()V
    //   259: goto -53 -> 206
    //   262: aload 5
    //   264: iconst_0
    //   265: invokevirtual 255	android/app/AlertDialog:setCancelable	(Z)V
    //   268: aload 5
    //   270: iconst_0
    //   271: invokevirtual 258	android/app/AlertDialog:setCanceledOnTouchOutside	(Z)V
    //   274: aload 5
    //   276: invokevirtual 261	android/app/AlertDialog:show	()V
    //   279: return
    //   280: astore_1
    //   281: goto -159 -> 122
  ...
  public void present(JSONObject paramJSONObject, String paramString)
  {
    // Byte code:
    //   0: iconst_0
    //   1: invokestatic 385	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   4: astore_3
    //   5: aload_1
    //   6: ldc_w 657
    //   9: invokevirtual 183	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   12: invokestatic 549	java/lang/Boolean:valueOf	(Ljava/lang/String;)Ljava/lang/Boolean;
    //   15: astore 5
    //   17: aload_1
    //   18: ldc_w 659
    //   21: invokevirtual 183	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   24: invokestatic 549	java/lang/Boolean:valueOf	(Ljava/lang/String;)Ljava/lang/Boolean;
    //   27: astore 4
    //   29: aload 4
    //   31: astore_3
    //   32: aload_0
    //   33: aload_1
    //   34: ldc_w 660
    //   37: invokevirtual 183	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   40: invokestatic 549	java/lang/Boolean:valueOf	(Ljava/lang/String;)Ljava/lang/Boolean;
    ...
    //   58: invokespecial 663	com/tapjoy/TJAdUnitJSBridge$a:<init>	(Lcom/tapjoy/TJAdUnitJSBridge;Landroid/webkit/WebView;)V
    //   61: iconst_2
    //   62: anewarray 215	java/lang/Boolean
    //   65: dup
    //   66: iconst_0
    //   67: aload 5
    //   69: aastore
    ...
    //   72: aload_3
    //   73: aastore
    //   74: invokevirtual 667	com/tapjoy/TJAdUnitJSBridge$a:execute	([Ljava/lang/Object;)Landroid/os/AsyncTask;
    //   77: pop
    //   78: aload_0
    //   79: aload_2
    //   80: iconst_1
    ...
    //   84: dup
    //   85: iconst_0
    //   86: getstatic 346	java/lang/Boolean:TRUE	Ljava/lang/Boolean;
    //   89: aastore
    //   90: invokevirtual 223	com/tapjoy/TJAdUnitJSBridge:invokeJSCallback	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   93: return
    //   94: astore_1
    //   95: aload_0
    //   96: aload_2
    ...
    //   101: dup
    //   102: iconst_0
    //   103: getstatic 219	java/lang/Boolean:FALSE	Ljava/lang/Boolean;
    //   106: aastore
    //   107: invokevirtual 223	com/tapjoy/TJAdUnitJSBridge:invokeJSCallback	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   110: aload_1
    //   111: invokevirtual 226	java/lang/Exception:printStackTrace	()V
    //   114: return
    //   115: astore_1
    //   116: goto -67 -> 49
    //   119: astore 4
