...
public class TapjoyConnectCore
{
  ...
  public TapjoyConnectCore(Context paramContext)
  {
    ...
    catch (TapjoyIntegrationException paramContext)
    {
      do
      {
        new StringBuilder("IntegrationException: ").append(paramContext.getMessage()).toString();
    ...
    catch (TapjoyException paramContext)
    {
      do
      {
        new StringBuilder("TapjoyException: ").append(paramContext.getMessage()).toString();
      } while (connectNotifier == null);
      connectNotifier.connectFail();
    }
  }
  ...
  private static Map<String, String> getParamsWithoutAppID()
  {
    ...
    for (;;)
    {
      ...
      TapjoyUtil.safePut(localHashMap, "library_revision", "82573da", true);
  ...
  public void doProfileAsync()
  {
    ...
    try
    {
      this.profile.a(new og()
      {
        public void complete()
        {
          try
          {
            if (TapjoyConnectCore.this.profile.b() == TrustDefenderMobile.THMStatusCode.THM_OK)
            {
  ...
  public String getSerial()
  {
    // Byte code:
    //   0: ldc_w 1437
    //   3: invokestatic 393	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   6: ldc_w 1439
    //   9: invokevirtual 1443	java/lang/Class:getDeclaredField	(Ljava/lang/String;)Ljava/lang/reflect/Field;
    //   12: astore_1
    //   13: aload_1
    //   14: invokevirtual 1448	java/lang/reflect/Field:isAccessible	()Z
    //   17: ifne +8 -> 25
    //   20: aload_1
    //   21: iconst_1
    //   22: invokevirtual 1451	java/lang/reflect/Field:setAccessible	(Z)V
    //   25: aload_1
    //   26: ldc_w 1089
    //   29: invokevirtual 1452	java/lang/reflect/Field:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   32: invokevirtual 616	java/lang/Object:toString	()Ljava/lang/String;
    //   35: astore_1
    //   36: ldc 29
    //   38: new 264	java/lang/StringBuilder
    //   41: dup
    //   42: ldc_w 1454
    //   45: invokespecial 269	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   48: aload_1
    //   49: invokevirtual 301	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   52: invokevirtual 281	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   55: invokestatic 287	com/tapjoy/TapjoyLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   58: aload_1
    //   59: areturn
    //   60: astore_2
    //   61: aconst_null
    ...
    //   63: ldc 29
    //   65: aload_2
    //   66: invokevirtual 481	java/lang/Exception:toString	()Ljava/lang/String;
    //   69: invokestatic 484	com/tapjoy/TapjoyLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   72: aload_1
    //   73: areturn
    //   74: astore_2
    //   75: goto -12 -> 63
