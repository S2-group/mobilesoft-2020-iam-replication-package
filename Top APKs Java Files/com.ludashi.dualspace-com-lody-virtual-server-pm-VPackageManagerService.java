  ...
  extends IPackageManager.Stub
{
  ...
  private final Map mOutSidePackages;
  ...
  public VPackageManagerService()
  {
    ...
    this.mOutSidePackages = new HashMap();
    this.mPackageMonitor = new VPackageManagerService.4(this);
    localObject = new Intent();
    ((Intent)localObject).setClassName(VirtualCore.get().getHostPkg(), VASettings.RESOLVER_ACTIVITY);
  ...
  {
    paramVPackage = PackageParserEx.generatePackageInfo(paramVPackage, updateFlagsNought(paramInt1), paramPackageSetting.firstInstallTime, paramPackageSetting.lastUpdateTime, paramPackageSetting.readUserState(paramInt2), paramInt2, paramPackageSetting.notCopyApk);
  ...
  void analyzePackageLocked(VPackage paramVPackage)
  {
    ...
    while (i < j)
    {
      localObject = (VPackage.ActivityComponent)paramVPackage.activities.get(i);
      if (((VPackage.ActivityComponent)localObject).info.processName == null) {
        ((VPackage.ActivityComponent)localObject).info.processName = ((VPackage.ActivityComponent)localObject).info.packageName;
      }
      this.mActivities.addActivity((VPackage.ActivityComponent)localObject, "activity");
      i += 1;
    }
    ...
    while (i < j)
    {
      localObject = (VPackage.ServiceComponent)paramVPackage.services.get(i);
      if (((VPackage.ServiceComponent)localObject).info.processName == null) {
        ((VPackage.ServiceComponent)localObject).info.processName = ((VPackage.ServiceComponent)localObject).info.packageName;
      }
      this.mServices.addService((VPackage.ServiceComponent)localObject);
      i += 1;
    }
    ...
    while (i < j)
    {
      localObject = (VPackage.ActivityComponent)paramVPackage.receivers.get(i);
      if (((VPackage.ActivityComponent)localObject).info.processName == null) {
        ((VPackage.ActivityComponent)localObject).info.processName = ((VPackage.ActivityComponent)localObject).info.packageName;
      }
      this.mReceivers.addActivity((VPackage.ActivityComponent)localObject, "receiver");
      i += 1;
    }
    ...
    while (i < m)
    {
      localObject = (VPackage.ProviderComponent)paramVPackage.providers.get(i);
      if (((VPackage.ProviderComponent)localObject).info.processName == null) {
        ((VPackage.ProviderComponent)localObject).info.processName = ((VPackage.ProviderComponent)localObject).info.packageName;
      }
      if (Build.VERSION.SDK_INT >= 19) {
        this.mProviders.addProvider((VPackage.ProviderComponent)localObject);
      }
      ...
      while (j < n)
      {
        ...
        if (!this.mProvidersByAuthority.containsKey(str)) {
          this.mProvidersByAuthority.put(str, localObject);
        }
        j += 1;
      }
      this.mProvidersByComponent.put(((VPackage.ProviderComponent)localObject).getComponentName(), localObject);
      i += 1;
    }
    ...
    while (i < j)
    {
      localObject = (VPackage.PermissionComponent)paramVPackage.permissions.get(i);
      this.mPermissions.put(((VPackage.PermissionComponent)localObject).className, localObject);
      i += 1;
    }
    ...
    while (i < j)
    {
      localObject = (VPackage.PermissionGroupComponent)paramVPackage.permissionGroups.get(i);
      this.mPermissionGroups.put(((VPackage.PermissionGroupComponent)localObject).className, localObject);
      i += 1;
    }
  }
  ...
  public int checkSignatures(String paramString1, String paramString2)
  {
    ...
    //   0: aload_1
    //   1: aload_2
    //   2: invokestatic 432	android/text/TextUtils:equals	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z
    //   5: ifeq +5 -> 10
    //   8: iconst_0
    //   9: ireturn
    //   10: aload_0
    ...
    //   12: bipush 64
    //   14: iconst_0
    //   15: invokevirtual 436	com/lody/virtual/server/pm/VPackageManagerService:getPackageInfo	(Ljava/lang/String;II)Landroid/content/pm/PackageInfo;
    //   18: astore 5
    //   20: aload_0
    //   21: aload_2
    //   22: bipush 64
    //   24: iconst_0
    //   25: invokevirtual 436	com/lody/virtual/server/pm/VPackageManagerService:getPackageInfo	(Ljava/lang/String;II)Landroid/content/pm/PackageInfo;
    //   28: astore 4
    //   30: aload 5
    //   32: astore_3
    //   33: aload 5
    ...
    //   44: aload_1
    //   45: bipush 64
    //   47: invokevirtual 439	android/content/pm/PackageManager:getPackageInfo	(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    //   50: astore_3
    //   51: aload 4
    //   53: astore_1
    //   54: aload 4
    ...
    //   65: aload_2
    //   66: bipush 64
    //   68: invokevirtual 439	android/content/pm/PackageManager:getPackageInfo	(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    //   71: astore_1
    //   72: aload_3
    //   73: getfield 445	android/content/pm/PackageInfo:signatures	[Landroid/content/pm/Signature;
    //   76: aload_1
    //   77: getfield 445	android/content/pm/PackageInfo:signatures	[Landroid/content/pm/Signature;
    //   80: invokestatic 451	com/lody/virtual/helper/utils/SignaturesUtils:compareSignatures	([Landroid/content/pm/Signature;[Landroid/content/pm/Signature;)I
    //   83: ireturn
    //   84: astore_1
    //   85: bipush -4
    //   87: ireturn
  ...
  public ActivityInfo getActivityInfo(ComponentName paramComponentName, int paramInt1, int paramInt2)
  {
    ...
    synchronized (this.mPackages)
    {
      ...
      if (localObject != null)
      {
        ...
        if (paramComponentName != null)
        {
          paramComponentName = PackageParserEx.generateActivityInfo(paramComponentName, paramInt1, ((PackageSetting)localObject).readUserState(paramInt2), paramInt2, ((PackageSetting)localObject).notCopyApk);
  ...
  public ApplicationInfo getApplicationInfo(String paramString, int paramInt1, int paramInt2)
  {
    ...
    synchronized (this.mPackages)
    {
      ...
      if (paramString != null)
      {
        PackageSetting localPackageSetting = (PackageSetting)paramString.mExtras;
        paramString = PackageParserEx.generateApplicationInfo(paramString, paramInt1, localPackageSetting.readUserState(paramInt2), paramInt2, localPackageSetting.notCopyApk);
        return paramString;
      }
      return null;
    }
  ...
  public VParceledListSlice getInstalledApplications(int paramInt1, int paramInt2)
  {
    ...
    synchronized (this.mPackages)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        PackageSetting localPackageSetting = (PackageSetting)((VPackage)localObject).mExtras;
        localObject = PackageParserEx.generateApplicationInfo((VPackage)localObject, paramInt1, localPackageSetting.readUserState(paramInt2), paramInt2, localPackageSetting.notCopyApk);
        if (localObject != null) {
  ...
  public ApplicationInfo getOutSideApplicationInfo(String paramString, boolean paramBoolean)
  {
    ??? = null;
    if (!paramBoolean) {
      synchronized (this.mOutSidePackages)
      {
        localObject2 = (ApplicationInfo)this.mOutSidePackages.get(paramString);
        ??? = localObject2;
    ...
    try
    {
      localObject2 = VirtualCore.get().getUnHookPackageManager().getApplicationInfo(paramString, 0);
      ??? = localObject2;
    }
    ...
    Object localObject2 = this.mOutSidePackages;
    if (??? == null) {}
    for (;;)
    {
      try
      {
        this.mOutSidePackages.put(paramString, ???);
        return ???;
      }
      finally {}
      this.mOutSidePackages.remove(paramString);
    }
  }
  ...
  public String[] getPackagesForUid(int paramInt)
  {
    ...
    try
    {
      ...
      arrayOfString = (String[])localObject.toArray(new String[localObject.size()]);
    }
    finally {}
  ...
  public ProviderInfo getProviderInfo(ComponentName paramComponentName, int paramInt1, int paramInt2)
  {
    ...
    synchronized (this.mPackages)
    {
      ...
      if (localObject != null)
      {
        ...
        if (paramComponentName != null)
        {
          paramComponentName = PackageParserEx.generateProviderInfo(paramComponentName, paramInt1, ((PackageSetting)localObject).readUserState(paramInt2), paramInt2, ((PackageSetting)localObject).notCopyApk);
          ComponentFixer.fixComponentInfo((PackageSetting)localObject, paramComponentName, paramInt2);
          return paramComponentName;
        }
      }
  ...
  public ServiceInfo getServiceInfo(ComponentName paramComponentName, int paramInt1, int paramInt2)
  {
    ...
    synchronized (this.mPackages)
    {
      ...
      if (localObject != null)
      {
        ...
        if (paramComponentName != null)
        {
          paramComponentName = PackageParserEx.generateServiceInfo(paramComponentName, paramInt1, ((PackageSetting)localObject).readUserState(paramInt2), paramInt2, ((PackageSetting)localObject).notCopyApk);
          ComponentFixer.fixComponentInfo((PackageSetting)localObject, paramComponentName, paramInt2);
          return paramComponentName;
        }
      }
    ...
    synchronized (this.mPackages)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((!localProviderComponent.info.multiprocess) && ((paramString == null) || ((localPackageSetting.appId == VUserHandle.getAppId(paramInt1)) && (localProviderComponent.info.processName.equals(paramString))))) {
          localArrayList.add(PackageParserEx.generateProviderInfo(localProviderComponent, paramInt2, localPackageSetting.readUserState(i), i, localPackageSetting.notCopyApk));
        }
      }
    }
  ...
  public ProviderInfo resolveContentProvider(String paramString, int paramInt1, int paramInt2)
  {
    ...
    synchronized (this.mPackages)
    {
      ...
      if (paramString != null)
      {
        PackageSetting localPackageSetting = (PackageSetting)paramString.owner.mExtras;
        paramString = PackageParserEx.generateProviderInfo(paramString, paramInt1, localPackageSetting.readUserState(paramInt2), paramInt2, localPackageSetting.notCopyApk);
        if (paramString != null)
        {
    ...
    extends IntentResolver
  {
    ...
    protected final ResolveInfo newResult(VPackage.ActivityIntentInfo paramActivityIntentInfo, int paramInt1, int paramInt2)
    {
      ...
      localObject = PackageParserEx.generateActivityInfo(localActivityComponent, this.mFlags, ((PackageSetting)localObject).readUserState(paramInt2), paramInt2, ((PackageSetting)localObject).notCopyApk);
      if (localObject == null) {
        return null;
      }
    ...
    extends IntentResolver
  {
    ...
    protected final ResolveInfo newResult(VPackage.ServiceIntentInfo paramServiceIntentInfo, int paramInt1, int paramInt2)
    {
      ...
      localObject = PackageParserEx.generateServiceInfo(localServiceComponent, this.mFlags, ((PackageSetting)localObject).readUserState(paramInt2), paramInt2, ((PackageSetting)localObject).notCopyApk);
      if (localObject == null) {
        return null;
      }
      ResolveInfo localResolveInfo = new ResolveInfo();
