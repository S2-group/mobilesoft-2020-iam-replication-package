...
public class aa
{
  ...
  private aa(c paramC)
  {
    ...
    if (this.d == null) {}
    while ((j.a) && ((this.a == null) || ((this.a instanceof com.appodeal.ads.utils.ad))) && ((this.d.equals("stats")) || (this.d.equals("show")) || (this.d.equals("click")) || (this.d.equals("finish")) || (this.d.equals("install")))) {
      return;
    }
  ...
  private JSONObject b(SharedPreferences paramSharedPreferences)
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 296	com/appodeal/ads/aa:r	Lorg/json/JSONObject;
    //   6: ifnull +12 -> 18
    //   9: getstatic 296	com/appodeal/ads/aa:r	Lorg/json/JSONObject;
    ...
    //   25: putstatic 296	com/appodeal/ads/aa:r	Lorg/json/JSONObject;
    //   28: aload_0
    //   29: getfield 77	com/appodeal/ads/aa:b	Landroid/content/Context;
    ...
    //   87: astore 4
    //   89: aload 6
    //   91: ifnonnull +749 -> 840
    //   94: aload_0
    //   95: getfield 87	com/appodeal/ads/aa:d	Ljava/lang/String;
    //   98: ldc -73
    ...
    //   161: astore 4
    //   163: aload_0
    //   164: getfield 77	com/appodeal/ads/aa:b	Landroid/content/Context;
    ...
    //   296: astore_1
    //   297: aload_1
    //   298: ifnonnull +539 -> 837
    //   301: aload_0
    //   302: getfield 77	com/appodeal/ads/aa:b	Landroid/content/Context;
    //   305: invokestatic 370	com/appodeal/ads/bd:l	(Landroid/content/Context;)Ljava/lang/String;
    //   308: astore_1
    //   309: getstatic 296	com/appodeal/ads/aa:r	Lorg/json/JSONObject;
    //   312: ldc_w 372
    //   315: aload 8
    //   317: invokevirtual 376	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   320: pop
    //   321: getstatic 296	com/appodeal/ads/aa:r	Lorg/json/JSONObject;
    //   324: ldc_w 378
    ...
    //   333: pop
    //   334: getstatic 296	com/appodeal/ads/aa:r	Lorg/json/JSONObject;
    //   337: ldc_w 385
    ...
    //   346: pop
    //   347: getstatic 296	com/appodeal/ads/aa:r	Lorg/json/JSONObject;
    //   350: ldc_w 393
    //   353: ldc_w 395
    //   356: invokevirtual 376	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   359: pop
    //   360: aload_0
    //   361: getfield 77	com/appodeal/ads/aa:b	Landroid/content/Context;
    //   364: invokevirtual 398	android/content/Context:getPackageName	()Ljava/lang/String;
    //   367: astore 4
    //   369: getstatic 296	com/appodeal/ads/aa:r	Lorg/json/JSONObject;
    //   372: ldc_w 400
    //   375: aload 4
    ...
    //   389: astore 5
    //   391: getstatic 296	com/appodeal/ads/aa:r	Lorg/json/JSONObject;
    //   394: ldc_w 408
    //   397: aload 5
    ...
    //   405: pop
    //   406: getstatic 296	com/appodeal/ads/aa:r	Lorg/json/JSONObject;
    //   409: ldc_w 415
    //   412: aload 5
    ...
    //   420: pop
    //   421: getstatic 296	com/appodeal/ads/aa:r	Lorg/json/JSONObject;
    //   424: ldc_w 420
    //   427: aload 5
    ...
    //   448: astore 5
    //   450: getstatic 296	com/appodeal/ads/aa:r	Lorg/json/JSONObject;
    //   453: ldc_w 434
    //   456: aload 5
    ...
    //   468: ifnull +16 -> 484
    //   471: getstatic 296	com/appodeal/ads/aa:r	Lorg/json/JSONObject;
    //   474: ldc_w 443
    ...
    //   487: ifnull +16 -> 503
    //   490: getstatic 296	com/appodeal/ads/aa:r	Lorg/json/JSONObject;
    //   493: ldc_w 446
    ...
    //   502: pop
    //   503: getstatic 296	com/appodeal/ads/aa:r	Lorg/json/JSONObject;
    //   506: ldc_w 448
    //   509: aload_1
    //   510: invokevirtual 376	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   513: pop
    //   514: getstatic 296	com/appodeal/ads/aa:r	Lorg/json/JSONObject;
    //   517: ldc_w 450
    //   520: aload_3
    //   521: invokevirtual 376	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   524: pop
    //   525: aload_0
    //   526: getfield 77	com/appodeal/ads/aa:b	Landroid/content/Context;
    //   529: invokestatic 453	com/appodeal/ads/bd:f	(Landroid/content/Context;)Landroid/util/Pair;
    //   532: astore_1
    //   533: getstatic 296	com/appodeal/ads/aa:r	Lorg/json/JSONObject;
    //   536: ldc_w 455
    //   539: aload_1
    ...
    //   546: pop
    //   547: getstatic 296	com/appodeal/ads/aa:r	Lorg/json/JSONObject;
    //   550: ldc_w 463
    //   553: aload_1
    ...
    //   560: pop
    //   561: getstatic 296	com/appodeal/ads/aa:r	Lorg/json/JSONObject;
    //   564: ldc_w 468
    //   567: aload_0
    //   568: getfield 77	com/appodeal/ads/aa:b	Landroid/content/Context;
    //   571: invokestatic 471	com/appodeal/ads/bd:i	(Landroid/content/Context;)F
    //   574: f2d
    //   575: invokevirtual 474	org/json/JSONObject:put	(Ljava/lang/String;D)Lorg/json/JSONObject;
    //   578: pop
    //   579: aload_0
    //   580: getfield 77	com/appodeal/ads/aa:b	Landroid/content/Context;
    //   583: invokestatic 477	com/appodeal/ads/bd:n	(Landroid/content/Context;)Z
    //   586: ifeq +222 -> 808
    //   589: getstatic 296	com/appodeal/ads/aa:r	Lorg/json/JSONObject;
    //   592: ldc_w 479
    //   595: ldc_w 481
    ...
    //   614: ldc_w 490
    //   617: astore_1
    //   618: getstatic 296	com/appodeal/ads/aa:r	Lorg/json/JSONObject;
    //   621: ldc_w 492
    //   624: aload_1
    ...
    //   643: ldc_w 497
    //   646: astore_1
    //   647: getstatic 296	com/appodeal/ads/aa:r	Lorg/json/JSONObject;
    //   650: ldc_w 499
    //   653: aload_1
    //   654: invokevirtual 376	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   657: pop
    //   658: getstatic 296	com/appodeal/ads/aa:r	Lorg/json/JSONObject;
    //   661: ldc_w 501
    ...
    //   670: pop
    //   671: getstatic 296	com/appodeal/ads/aa:r	Lorg/json/JSONObject;
    //   674: ldc_w 503
    //   677: invokestatic 505	com/appodeal/ads/bd:a	()Z
    //   680: invokevirtual 508	org/json/JSONObject:put	(Ljava/lang/String;Z)Lorg/json/JSONObject;
    //   683: pop
    //   684: getstatic 296	com/appodeal/ads/aa:r	Lorg/json/JSONObject;
    //   687: ldc_w 510
    //   690: aload_0
    //   691: getfield 77	com/appodeal/ads/aa:b	Landroid/content/Context;
    //   694: invokestatic 512	com/appodeal/ads/bd:t	(Landroid/content/Context;)Ljava/lang/String;
    //   697: invokevirtual 376	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   700: pop
    //   701: getstatic 296	com/appodeal/ads/aa:r	Lorg/json/JSONObject;
    //   704: ldc_w 514
    //   707: iconst_1
    ...
    //   713: ldc_w 516
    //   716: aastore
    //   717: invokestatic 519	com/appodeal/ads/bd:b	([Ljava/lang/String;)Z
    //   720: invokevirtual 508	org/json/JSONObject:put	(Ljava/lang/String;Z)Lorg/json/JSONObject;
    //   723: pop
    //   724: new 249	org/json/JSONObject
    //   727: dup
    //   728: invokespecial 298	org/json/JSONObject:<init>	()V
    //   731: astore_1
    //   732: getstatic 296	com/appodeal/ads/aa:r	Lorg/json/JSONObject;
    //   735: invokevirtual 523	org/json/JSONObject:keys	()Ljava/util/Iterator;
    //   738: astore_3
    //   739: aload_3
    //   740: invokeinterface 528 1 0
    //   745: ifeq +87 -> 832
    //   748: aload_3
    //   749: invokeinterface 532 1 0
    //   754: checkcast 171	java/lang/String
    //   757: astore 4
    //   759: aload_1
    //   760: aload 4
    //   762: getstatic 296	com/appodeal/ads/aa:r	Lorg/json/JSONObject;
    //   765: aload 4
    //   767: invokevirtual 536	org/json/JSONObject:get	(Ljava/lang/String;)Ljava/lang/Object;
    //   770: invokevirtual 376	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   773: pop
    //   774: goto -35 -> 739
    //   777: astore_1
    //   778: ldc 2
    ...
    //   790: astore_1
    //   791: aload_1
    //   792: invokestatic 282	com/appodeal/ads/Appodeal:a	(Ljava/lang/Throwable;)V
    //   795: goto +45 -> 840
    //   798: astore 5
    //   800: aload 5
    //   802: invokestatic 282	com/appodeal/ads/Appodeal:a	(Ljava/lang/Throwable;)V
    //   805: goto -340 -> 465
    //   808: getstatic 296	com/appodeal/ads/aa:r	Lorg/json/JSONObject;
    //   811: ldc_w 479
    //   814: ldc_w 540
    //   817: invokevirtual 376	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   820: pop
    //   821: goto -219 -> 602
    //   824: astore_1
    //   825: aload_1
    //   826: invokestatic 282	com/appodeal/ads/Appodeal:a	(Ljava/lang/Throwable;)V
    //   829: goto -171 -> 658
    //   832: ldc 2
    //   834: monitorexit
    //   835: aload_1
    ...
    //   0	856	0	this	aa
    //   0	856	1	paramSharedPreferences	SharedPreferences
    //   103	9	2	bool	boolean
    //   81	765	3	localObject1	Object
    //   87	754	4	str1	String
    //   83	374	5	localObject2	Object
    //   798	46	5	localNameNotFoundException	android.content.pm.PackageManager.NameNotFoundException
    ...
    //   825	829	777	finally
    //   832	835	777	finally
    //   122	129	790	java/lang/Exception
    //   136	156	790	java/lang/Exception
    //   163	172	790	java/lang/Exception
    //   179	186	790	java/lang/Exception
    //   193	201	790	java/lang/Exception
    //   212	219	790	java/lang/Exception
    //   226	238	790	java/lang/Exception
    //   245	256	790	java/lang/Exception
    //   263	269	790	java/lang/Exception
    //   276	294	790	java/lang/Exception
    //   381	465	798	android/content/pm/PackageManager$NameNotFoundException
    //   629	637	824	java/lang/Exception
    //   647	658	824	java/lang/Exception
  }
      ...
      catch (Exception localException2)
      {
        try
        {
          for (;;)
          {
            ...
            if ((!j.l) && (j.k) && (this.z) && (((Calendar)localObject1).getTimeInMillis() < System.currentTimeMillis()))
            {
              j.l = true;
              try
              {
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      ...
      //   1: astore 4
      //   3: aload_0
      //   4: getfield 15	com/appodeal/ads/aa$b:a	Lcom/appodeal/ads/aa;
      //   7: getfield 32	com/appodeal/ads/aa:b	Landroid/content/Context;
      //   10: ldc 34
      //   12: iconst_0
      //   13: invokevirtual 40	android/content/Context:getSharedPreferences	(Ljava/lang/String;I)Landroid/content/SharedPreferences;
      //   16: astore_2
      //   17: aload_0
      //   18: getfield 15	com/appodeal/ads/aa$b:a	Lcom/appodeal/ads/aa;
      //   21: aload_2
      //   22: invokevirtual 43	com/appodeal/ads/aa:a	(Landroid/content/SharedPreferences;)Lorg/json/JSONObject;
      //   25: astore_2
      //   26: aload_2
      //   27: ifnonnull +16 -> 43
      //   30: aload_0
      //   31: getfield 15	com/appodeal/ads/aa$b:a	Lcom/appodeal/ads/aa;
      //   34: invokestatic 46	com/appodeal/ads/aa:a	(Lcom/appodeal/ads/aa;)Landroid/os/Handler;
      //   37: iconst_0
      //   38: invokevirtual 52	android/os/Handler:sendEmptyMessage	(I)Z
      //   41: pop
      //   42: return
      //   43: aload_0
      //   44: getfield 15	com/appodeal/ads/aa$b:a	Lcom/appodeal/ads/aa;
      //   47: invokevirtual 55	com/appodeal/ads/aa:b	()Ljava/net/URL;
      //   50: astore 5
      //   52: aload_0
      //   53: getfield 15	com/appodeal/ads/aa$b:a	Lcom/appodeal/ads/aa;
      //   56: getfield 32	com/appodeal/ads/aa:b	Landroid/content/Context;
      //   59: ldc 57
      //   61: iconst_0
      ...
      //   90: aload_0
      //   91: getfield 15	com/appodeal/ads/aa$b:a	Lcom/appodeal/ads/aa;
      //   94: invokestatic 80	com/appodeal/ads/aa:b	(Lcom/appodeal/ads/aa;)Ljavax/net/ssl/SSLSocketFactory;
      //   97: invokevirtual 84	javax/net/ssl/HttpsURLConnection:setSSLSocketFactory	(Ljavax/net/ssl/SSLSocketFactory;)V
      //   100: aload_0
      //   101: getfield 15	com/appodeal/ads/aa$b:a	Lcom/appodeal/ads/aa;
      //   104: getfield 88	com/appodeal/ads/aa:A	Z
      //   107: ifeq +458 -> 565
      //   110: aload 6
      //   112: aload_0
      //   113: getfield 15	com/appodeal/ads/aa$b:a	Lcom/appodeal/ads/aa;
      //   116: getfield 92	com/appodeal/ads/aa:d	Ljava/lang/String;
      ...
      //   221: aload_2
      //   222: invokestatic 164	com/appodeal/ads/bd:a	(Ljava/io/OutputStream;Ljava/lang/String;)V
      //   225: aload_3
      //   226: invokevirtual 168	java/net/URLConnection:getInputStream	()Ljava/io/InputStream;
      //   229: invokestatic 171	com/appodeal/ads/bd:a	(Ljava/io/InputStream;)Ljava/lang/String;
      //   232: astore 5
      //   234: aload 4
      //   236: astore_2
      //   237: aload 5
      ...
      //   263: ifne +23 -> 286
      //   266: aload_0
      //   267: getfield 15	com/appodeal/ads/aa$b:a	Lcom/appodeal/ads/aa;
      //   270: getfield 92	com/appodeal/ads/aa:d	Ljava/lang/String;
      //   273: ldc -77
      ...
      //   308: aload_0
      //   309: getfield 15	com/appodeal/ads/aa$b:a	Lcom/appodeal/ads/aa;
      //   312: getfield 88	com/appodeal/ads/aa:A	Z
      //   315: ifeq +479 -> 794
      //   318: aload 6
      //   320: aload_0
      //   321: getfield 15	com/appodeal/ads/aa$b:a	Lcom/appodeal/ads/aa;
      //   324: getfield 92	com/appodeal/ads/aa:d	Ljava/lang/String;
      //   327: invokeinterface 98 2 0
      //   332: ifeq +462 -> 794
      //   335: aload_0
      //   336: getfield 15	com/appodeal/ads/aa$b:a	Lcom/appodeal/ads/aa;
      //   339: aload 6
      //   341: aload_0
      //   342: getfield 15	com/appodeal/ads/aa$b:a	Lcom/appodeal/ads/aa;
      //   345: getfield 92	com/appodeal/ads/aa:d	Ljava/lang/String;
      //   348: invokevirtual 185	com/appodeal/ads/aa:a	(Landroid/content/SharedPreferences;Ljava/lang/String;)Z
      //   351: ifeq +443 -> 794
      ...
      //   366: aload 6
      //   368: aload_0
      //   369: getfield 15	com/appodeal/ads/aa$b:a	Lcom/appodeal/ads/aa;
      //   372: getfield 92	com/appodeal/ads/aa:d	Ljava/lang/String;
      //   375: ldc -57
      ...
      //   391: astore_2
      //   392: aload_0
      //   393: getfield 15	com/appodeal/ads/aa$b:a	Lcom/appodeal/ads/aa;
      //   396: getfield 88	com/appodeal/ads/aa:A	Z
      //   399: ifeq +442 -> 841
      //   402: aload_3
      ...
      //   409: aload_0
      //   410: getfield 15	com/appodeal/ads/aa$b:a	Lcom/appodeal/ads/aa;
      //   413: getfield 88	com/appodeal/ads/aa:A	Z
      //   416: ifeq +105 -> 521
      //   419: aload_0
      //   420: getfield 15	com/appodeal/ads/aa$b:a	Lcom/appodeal/ads/aa;
      //   423: getfield 32	com/appodeal/ads/aa:b	Landroid/content/Context;
      //   426: aload_2
      //   427: ldc -41
      ...
      //   435: aload_0
      //   436: getfield 15	com/appodeal/ads/aa$b:a	Lcom/appodeal/ads/aa;
      //   439: getfield 32	com/appodeal/ads/aa:b	Landroid/content/Context;
      //   442: aload_2
      //   443: ldc -30
      ...
      //   460: invokestatic 238	com/appodeal/ads/h:a	(Landroid/content/Context;Lorg/json/JSONObject;ZZ)V
      //   463: aload_0
      //   464: getfield 15	com/appodeal/ads/aa$b:a	Lcom/appodeal/ads/aa;
      //   467: aload 6
      //   469: aload_2
      //   470: ldc -16
      //   472: ldc -15
      ...
      //   477: aload_0
      //   478: getfield 15	com/appodeal/ads/aa$b:a	Lcom/appodeal/ads/aa;
      //   481: getfield 92	com/appodeal/ads/aa:d	Ljava/lang/String;
      //   484: invokevirtual 248	com/appodeal/ads/aa:a	(Landroid/content/SharedPreferences;ILjava/lang/String;)V
      //   487: aload_0
      //   488: getfield 15	com/appodeal/ads/aa$b:a	Lcom/appodeal/ads/aa;
      //   491: aload_2
      //   492: invokestatic 251	com/appodeal/ads/aa:a	(Lcom/appodeal/ads/aa;Lorg/json/JSONObject;)V
      //   495: aload_2
      //   496: ldc -3
      ...
      //   521: aload_0
      //   522: getfield 15	com/appodeal/ads/aa$b:a	Lcom/appodeal/ads/aa;
      //   525: invokestatic 46	com/appodeal/ads/aa:a	(Lcom/appodeal/ads/aa;)Landroid/os/Handler;
      //   528: iconst_1
      //   529: aload_2
      //   530: invokevirtual 277	android/os/Handler:obtainMessage	(ILjava/lang/Object;)Landroid/os/Message;
      //   533: astore_2
      //   534: aload_0
      //   535: getfield 15	com/appodeal/ads/aa$b:a	Lcom/appodeal/ads/aa;
      //   538: invokestatic 46	com/appodeal/ads/aa:a	(Lcom/appodeal/ads/aa;)Landroid/os/Handler;
      //   541: aload_2
      ...
      //   552: aload_0
      //   553: getfield 15	com/appodeal/ads/aa$b:a	Lcom/appodeal/ads/aa;
      //   556: invokestatic 46	com/appodeal/ads/aa:a	(Lcom/appodeal/ads/aa;)Landroid/os/Handler;
      //   559: iconst_0
      ...
      //   616: ifeq +119 -> 735
      //   619: aload_0
      //   620: getfield 15	com/appodeal/ads/aa$b:a	Lcom/appodeal/ads/aa;
      //   623: invokestatic 46	com/appodeal/ads/aa:a	(Lcom/appodeal/ads/aa;)Landroid/os/Handler;
      //   626: iconst_0
      ...
      //   791: goto -108 -> 683
      //   794: aload_0
      //   795: getfield 15	com/appodeal/ads/aa$b:a	Lcom/appodeal/ads/aa;
      //   798: invokestatic 46	com/appodeal/ads/aa:a	(Lcom/appodeal/ads/aa;)Landroid/os/Handler;
      //   801: iconst_0
      ...
      //   813: getfield 88	com/appodeal/ads/aa:A	Z
      //   816: ifeq -433 -> 383
      //   819: aload_0
      //   820: getfield 15	com/appodeal/ads/aa$b:a	Lcom/appodeal/ads/aa;
      //   823: aload 6
      //   825: aload_0
      //   826: getfield 15	com/appodeal/ads/aa$b:a	Lcom/appodeal/ads/aa;
      //   829: getfield 92	com/appodeal/ads/aa:d	Ljava/lang/String;
      //   832: aload_2
      //   833: invokevirtual 294	com/appodeal/ads/aa:a	(Landroid/content/SharedPreferences;Ljava/lang/String;Ljava/lang/String;)V
      //   836: aload_2
      //   837: astore_3
      //   838: goto -455 -> 383
      //   841: aload_3
      ...
      //   853: aload_0
      //   854: getfield 15	com/appodeal/ads/aa$b:a	Lcom/appodeal/ads/aa;
      //   857: invokestatic 46	com/appodeal/ads/aa:a	(Lcom/appodeal/ads/aa;)Landroid/os/Handler;
      //   860: iconst_0
