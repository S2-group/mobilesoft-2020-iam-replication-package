...
public class d
{
  ...
  public static int a(com.magic.lib.task.b.a paramA, com.magic.lib.task.b.b paramB)
  {
    try
    {
  ...
  public static long a(b.a paramA)
  {
    ...
    for (;;)
    {
      ...
      {
        com.magic.lib.a.e.c("TaskTools getNowTime is error:" + paramA.getMessage());
      }
      if (paramA == b.a.HOURS) {
        str = "yyyyMMddHH";
  ...
  public static List<com.magic.lib.task.b.a> a(List<com.magic.lib.task.b.a> paramList)
  {
  ...
  private static Map<String, Integer> a(Map<String, Integer> paramMap, String paramString1, String paramString2)
  {
    ...
    //   74: aload 5
    //   76: ldc_w 317
    //   79: invokestatic 323	com/magic/lib/task/util/d:a	(Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;)Ljava/util/Map;
    //   82: astore_1
    //   83: goto +35 -> 118
    //   86: aload_0
    //   87: aload 5
    //   89: invokestatic 325	com/magic/lib/task/util/d:b	(Ljava/util/Map;Ljava/lang/String;)Ljava/util/Map;
    //   92: astore_1
    //   93: goto +25 -> 118
    //   96: astore_1
    //   97: aload_1
    //   98: invokevirtual 129	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   101: invokestatic 327	com/magic/lib/a/e:b	(Ljava/lang/String;)V
    //   104: aload_1
  ...
  {
    long l = com.magic.lib.task.d.a.a().a("markNowDateKey");
    if (l <= 0L) {}
    while (a(b.a.DATE) == l) {
      return false;
    }
  ...
  public static boolean a(com.magic.lib.task.b.a paramA)
  {
  ...
  public static long b(String paramString)
  {
    ...
    {
      com.magic.lib.a.e.c("TaskTools NumberFormatException,parseLong");
    }
    return 0L;
  }
  
  public static com.magic.lib.task.b.b b(com.magic.lib.task.b.a paramA)
  {
    if (paramA != null) {
      try
      {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        try
        {
          ...
          {
            str = com.magic.lib.a.f.a().toLowerCase();
            if (!str.equals("tw"))
            {
              localObject1 = localObject2;
              if (!str.equals("hk")) {}
  ...
  public static Map<String, com.magic.lib.task.b.a> b(List<com.magic.lib.task.b.a> paramList)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      {
        com.magic.lib.task.b.a localA = (com.magic.lib.task.b.a)paramList.next();
  ...
  private static Map<String, Integer> b(Map<String, Integer> paramMap, String paramString)
  {
    ...
    {
      com.magic.lib.a.e.b(paramString.getMessage());
      paramString.printStackTrace();
    }
    return paramMap;
  }
  ...
  public static boolean b(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      {
        com.magic.lib.a.e.c("TaskTools isPortrait NullPointerException:" + paramContext.getMessage());
      }
    }
    return true;
  }
  ...
  public static Map<String, Integer> c(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramContext)
      {
        ...
        com.magic.lib.a.e.b(paramContext.getMessage());
        paramContext.printStackTrace();
        return localObject1;
      }
  ...
  public static boolean c(@NonNull com.magic.lib.task.b.a paramA)
  {
    c localC = paramA.getTaskState();
    com.magic.lib.a.e.b("TaskTools task state:" + localC + " taskId:" + paramA.getId());
    return (c.COMPLETED.equals(localC)) || (c.CLOSE.equals(localC));
  }
  
  public static com.magic.lib.task.b.b d(com.magic.lib.task.b.a paramA)
  {
  ...
  public static int e(com.magic.lib.task.b.a paramA)
  {
    try
    {
      ...
      {
        int i = R.style.magic_task_full_dialog;
        return i;
      }
    }
    catch (NullPointerException paramA)
  ...
  public static String f(com.magic.lib.task.b.a paramA)
  {
    try
    {
  ...
  public static boolean g(com.magic.lib.task.b.a paramA)
  {
    return a(h(paramA));
  }
  
  public static String h(com.magic.lib.task.b.a paramA)
  {
    if (paramA != null)
    {
  ...
  {
    com.magic.lib.a.e.b("Task_PeiQiPig " + paramString);
  }
    ...
    try
    {
      if ((!TextUtils.isEmpty(paramString)) && (com.magic.lib.task.d.c.a().c().b(paramString)))
      {
        ...
        for (;;)
        {
          ...
          paramString = b.C + q.a(paramString);
          return paramString;
          i += 1;
        }
      }
  ...
  public static boolean j(com.magic.lib.task.b.a paramA)
  {
    try
    {
      List localList = com.magic.lib.task.d.b.a().d();
      boolean bool = c(com.magic.lib.task.d.b.a().a(localList, paramA.getId()));
      if (bool) {
        return true;
      }
    }
