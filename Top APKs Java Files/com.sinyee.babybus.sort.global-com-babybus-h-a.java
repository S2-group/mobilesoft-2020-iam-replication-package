...
public class a
{
  ...
  {
    com.babybus.g.a.jdMethod_do().jdMethod_do("638B09EBED74EC990B04258AB7E0DA8F", jdMethod_new(paramInt));
  }
  
  public static void jdMethod_do(int paramInt, String paramString)
  {
    com.babybus.g.a.jdMethod_do().jdMethod_do("792C32929B70085C8C82D9C6183B7120", jdMethod_new(paramInt), paramString);
  }
  ...
  public static void jdMethod_for(int paramInt)
  {
    ...
    com.babybus.g.a.jdMethod_do().jdMethod_do("7801865ED51C26915AD95DBF252DE4D0", jdMethod_new(paramInt));
  }
  ...
  {
    com.babybus.g.a.jdMethod_do().jdMethod_do("1412D5C906AC3C4A0B8F0C8DE2CB92E8", jdMethod_new(paramInt));
  }
  ...
  public static void jdMethod_if(int paramInt, String paramString)
  {
    ...
    com.babybus.g.a.jdMethod_do().jdMethod_do("5E36BB93D5ABD0C078B6609FE341FF91", jdMethod_new(paramInt), paramString);
  }
  ...
  public static void jdMethod_int(int paramInt)
  {
    ...
    com.babybus.g.a.jdMethod_do().jdMethod_do("966B60711E1BBFBE56CCA8C2D814EE3A", jdMethod_new(paramInt));
  }
    ...
    try
    {
      if ((!TextUtils.isEmpty(paramString1)) && (!TextUtils.isEmpty(paramString2)) && (!jdMethod_static(paramString2)))
      {
        ...
        if (paramString2.length == 3)
        {
          ...
          com.babybus.g.a.jdMethod_do().jdMethod_if(paramString1, localStringBuilder, paramString2);
          return;
        }
