...
import com.garagemusicc.bandband.utility.ImageCaptureHelper;
import java.io.File;
  ...
  extends WebView
{
    ...
    if (paramInt1 == this.mRequestCodeFilePicker)
    {
      ...
      if (paramIntent != null)
      {
        ...
        if (localObject1 == null) {
          paramIntent = this.mImageCaptureHelper.getCapturedImageUri();
        }
        this.mFileUploadCallbackFirst.onReceiveValue(paramIntent);
      ...
      do
      {
        do
        {
          try
          {
            ...
            localObject1 = new Uri[] { paramIntent };
          }
          ...
          paramIntent = (Intent)localObject1;
          if (localObject1 == null) {
            paramIntent = this.mImageCaptureHelper.getCapturedImageUris();
          }
          this.mFileUploadCallbackSecond.onReceiveValue(paramIntent);
          this.mFileUploadCallbackSecond = null;
          return;
          localObject1 = arrayOfUri;
          localObject2 = localObject3;
        } while (Build.VERSION.SDK_INT < 16);
        localObject1 = arrayOfUri;
        localObject2 = localObject3;
      } while (paramIntent.getClipData() == null);
      localObject2 = localObject3;
      paramInt2 = paramIntent.getClipData().getItemCount();
      localObject2 = localObject3;
      arrayOfUri = new Uri[paramInt2];
      paramInt1 = 0;
      for (;;)
      {
        localObject1 = arrayOfUri;
        ...
        localObject2 = arrayOfUri;
        arrayOfUri[paramInt1] = paramIntent.getClipData().getItemAt(paramInt1).getUri();
        paramInt1 += 1;
      }
      if (this.mFileUploadCallbackFirst != null)
      {
  ...
  protected void openFileInput(ValueCallback<Uri> paramValueCallback, ValueCallback<Uri[]> paramValueCallback1, boolean paramBoolean)
  {
    ...
    paramValueCallback = Intent.createChooser(paramValueCallback, getFileUploadPromptLabel());
    this.mImageCaptureHelper.setupChooserIntent(paramValueCallback);
    if ((this.mFragment != null) && (this.mFragment.get() != null) && (Build.VERSION.SDK_INT >= 11)) {
      ((Fragment)this.mFragment.get()).startActivityForResult(paramValueCallback, this.mRequestCodeFilePicker);
    }
    while ((this.mActivity == null) || (this.mActivity.get() == null)) {
      return;
    }
    ((Activity)this.mActivity.get()).startActivityForResult(paramValueCallback, this.mRequestCodeFilePicker);
  }
