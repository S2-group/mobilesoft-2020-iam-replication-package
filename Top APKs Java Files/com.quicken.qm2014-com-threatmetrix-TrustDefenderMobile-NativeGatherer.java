...
class NativeGatherer
{
    ...
    throws InterruptedException
  {
    try
    {
      ...
      {
        localStringBuilder.append(str).append(" Found ").append(this.m_gathererHelper.m_packagesFound);
    ...
    throws InterruptedException
  {
    try
    {
      if (this.m_gathererHelper.m_available)
      {
        localObject1 = this.m_gathererHelper.findAllProcs();
        if (!Thread.interrupted()) {
          return localObject1;
        }
        localObject1 = TAG;
    ...
    throws InterruptedException
  {
    try
    {
      if (this.m_gathererHelper.m_available)
      {
        localObject1 = this.m_gathererHelper.findInstalledProcs();
        if (!Thread.interrupted()) {
          return localObject1;
        }
        localObject1 = TAG;
    ...
    throws InterruptedException
  {
    try
    {
      if (this.m_gathererHelper.m_available)
      {
        localObject1 = this.m_gathererHelper.findRunningProcs();
        if (!Thread.interrupted()) {
          return localObject1;
        }
        localObject1 = TAG;
    ...
    throws InterruptedException
  {
    try
    {
      if (this.m_gathererHelper.m_available)
      {
        str1 = this.m_gathererHelper.getRandomString(32);
        if (!Thread.interrupted()) {
          return str1;
        }
        str1 = TAG;
  ...
  private class NativeGathererHelper
  {
    ...
    final boolean init(Context paramContext)
    {
      ...
      //   98: dup
      //   99: ldc -113
      //   101: invokespecial 145	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
      //   104: aload_0
      //   105: getfield 49	com/threatmetrix/TrustDefenderMobile/NativeGatherer$NativeGathererHelper:m_packagesFound	I
      //   108: invokevirtual 149	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
      //   111: pop
      //   112: aload_0
      //   113: getfield 62	com/threatmetrix/TrustDefenderMobile/NativeGatherer$NativeGathererHelper:m_initLock	Ljava/util/concurrent/locks/Lock;
      //   116: invokeinterface 107 1 0
      //   121: aload_0
      //   122: getfield 47	com/threatmetrix/TrustDefenderMobile/NativeGatherer$NativeGathererHelper:m_available	Z
      //   125: ireturn
      //   126: astore_1
      //   127: aload_0
      //   128: iconst_0
      //   129: putfield 47	com/threatmetrix/TrustDefenderMobile/NativeGatherer$NativeGathererHelper:m_available	Z
      //   132: goto -42 -> 90
      //   135: astore_1
      //   136: aload_0
      //   137: getfield 62	com/threatmetrix/TrustDefenderMobile/NativeGatherer$NativeGathererHelper:m_initLock	Ljava/util/concurrent/locks/Lock;
      //   140: invokeinterface 107 1 0
      //   145: aload_1
      //   146: athrow
      //   147: astore_1
      //   148: aload_0
      //   149: getfield 45	com/threatmetrix/TrustDefenderMobile/NativeGatherer$NativeGathererHelper:TAG	Ljava/lang/String;
      //   152: ldc -105
      //   154: aload_1
      //   155: invokestatic 157	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
      //   158: pop
      //   159: goto -69 -> 90
