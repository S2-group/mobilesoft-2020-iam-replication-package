...
import com.startapp.common.h.a;
...
public class l
{
  ...
  public static void a(Context paramContext, boolean paramBoolean)
  {
    ...
    if (((d == null) || (e == null)) && (paramBoolean)) {
      ...
      {
        g(paramContext);
        d = new Pair(a.a, com.startapp.common.g.a(a(a)));
        e = new Pair(a.b, com.startapp.common.g.a(a(b)));
      ...
      catch (Exception localException)
      {
        ...
        f.a(paramContext, com.startapp.android.publish.adsCommon.f.d.b, "initSimpleToken", localException.getMessage(), "");
      }
    }
  }
  ...
  public static void c(Context paramContext)
  {
    ...
    try
    {
      ...
      {
        com.startapp.common.h.a(h.a.b, new Runnable()
        {
          public void run()
          {
            l.b(this.a);
        ...
        try
        {
          ...
          if (Build.VERSION.SDK_INT >= 9)
          {
            ...
            if (localIterator.hasNext())
            {
              ...
              if (!((PackageInfo)localObject).packageName.equals(a.b)) {
                continue;
              }
