...
public final class AppUtils
{
  ...
  public static String getAppSignatureSHA1(@NonNull String paramString)
  {
    if (paramString != null)
    {
  ...
  public static boolean installAppSilent(File paramFile, String paramString)
  {
    ...
    paramFile = ShellUtils.execCmd(localStringBuilder.toString(), bool);
  ...
  {
    Object localObject = (ActivityManager)Utils.getApp().getSystemService("activity");
    if (localObject == null) {
      return false;
    }
  ...
  public static boolean uninstallAppSilent(String paramString, boolean paramBoolean)
  {
    ...
    paramString = ShellUtils.execCmd(localStringBuilder.toString(), bool, true);
