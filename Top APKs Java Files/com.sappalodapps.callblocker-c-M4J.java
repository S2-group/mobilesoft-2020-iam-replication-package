...
public class M4J
{
  ...
  private ArrayList<String> a(Context paramContext)
  {
    ...
    {
      Z0S.e(a, "Using fallback package getter");
      paramContext.printStackTrace();
    }
    return a();
  }
  
  public void a(Context paramContext, KI1 paramKI1)
  {
    ...
    if (localObject2 == null) {
      localObject1 = new P9Y();
    }
    localObject2 = new ArrayList();
    Object localObject4 = paramKI1.b().iterator();
    Object localObject5;
    while (((Iterator)localObject4).hasNext())
    {
      localObject5 = (C82)((Iterator)localObject4).next();
      Iterator localIterator = ((ArrayList)localObject3).iterator();
      while (localIterator.hasNext()) {
        if (((String)localIterator.next()).equalsIgnoreCase(((C82)localObject5).a()))
        {
          i = 1;
          break label154;
        }
      ...
      i = 0;
      label154:
      if ((i == 0) && (!((C82)localObject5).a().equals(paramContext.getPackageName()))) {
        ((ArrayList)localObject2).add(((C82)localObject5).a());
      }
    }
    if (l1 == 0L) {}
    for (;;)
    {
      ...
      Z0S.a(a, "over maxtimeout, cant determine dead clients");
      localClientConfig.b(l3);
      if ((paramKI1 != null) && (paramKI1.b() != null))
      {
        localObject3 = paramKI1.b().iterator();
        while (((Iterator)localObject3).hasNext()) {
          ((C82)((Iterator)localObject3).next()).a(l3);
        }
        localClientConfig.a(paramKI1);
      }
    }
    int i = 1;
    label284:
    ...
    {
      localClientConfig.b(l3);
      paramKI1 = paramKI1.b().iterator();
      while (paramKI1.hasNext())
      {
        localObject3 = (C82)paramKI1.next();
        if ((!((C82)localObject3).a().equals(paramContext.getPackageName())) && (((C82)localObject3).d() != 0L) && (l3 - ((C82)localObject3).d() > l1))
        {
          ((ArrayList)localObject2).add(((C82)localObject3).a());
          localObject4 = a;
          localObject5 = new StringBuilder("Client timeout -  pack.getId()");
          ((StringBuilder)localObject5).append(((C82)localObject3).a());
          ...
          ((StringBuilder)localObject5).append(((C82)localObject3).d());
          ((StringBuilder)localObject5).append(", MAX_TIMEOUT: ");
          ((StringBuilder)localObject5).append(l1);
          Z0S.e((String)localObject4, ((StringBuilder)localObject5).toString());
        }
      }
    }
    if (((ArrayList)localObject2).size() != ((P9Y)localObject1).a().size()) {}
    do
    {
      i = 1;
      break;
      paramContext = new ArrayList((Collection)localObject2);
      paramContext.removeAll(((P9Y)localObject1).a());
    } while (paramContext.size() != 0);
    i = 0;
    if (i != 0)
    {
      ((P9Y)localObject1).a((ArrayList)localObject2);
      ((P9Y)localObject1).a(((P9Y)localObject1).b() + 1);
      localClientConfig.a((P9Y)localObject1);
    }
  }
}
