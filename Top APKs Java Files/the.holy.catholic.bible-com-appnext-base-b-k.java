...
public final class k
{
  ...
  private static final long kD = 1000L;
  private static final long kE = 60000L;
  private static final long kF = 3600000L;
  private static final long kG = 86400000L;
  ...
  public static long a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    return localCalendar.getTimeInMillis() + (kI.nextInt(120) - 60) * 1000L;
  }
  ...
  public static Object a(String paramString, c.a paramA)
  {
    try
    {
      paramString = com.appnext.base.a.a.aO().aR().af(paramString);
      if ((paramString != null) && (!paramString.isEmpty()))
      {
        paramString = b(((com.appnext.base.a.b.b)paramString.get(0)).ba(), paramA);
        return paramString;
      }
    }
  ...
  public static void a(Context paramContext, Class paramClass, long paramLong, com.appnext.base.a.b.c paramC)
  {
    if (paramContext != null)
    {
      ...
      long l;
      if ("time".equalsIgnoreCase(paramC.be())) {
        l = 86400000L;
      } else {
        l = j(paramC.bd(), paramC.be());
      }
      if (l == -1L) {
        return;
      }
      ...
      int i = paramC.bh().hashCode();
      String.valueOf(paramC.bh());
  ...
  public static String aH(String paramString)
  {
    ...
    return i.cF().getString(paramString, null);
  }
  ...
  public static boolean b(String paramString, Map<String, String> paramMap)
  {
    ...
    {
      if ("off".equalsIgnoreCase(((com.appnext.base.a.b.c)localObject1).bc())) {
        return true;
      }
      if (paramMap.isEmpty()) {
        return true;
      ...
      if (TextUtils.isEmpty((CharSequence)localObject3)) {
        localObject1 = i.cF().getString("google_ads_id", "");
      }
  ...
  {
    com.appnext.base.a.a.aO().aR().b(new com.appnext.base.a.b.b(paramString1, paramString2, paramA.getType()));
  }
      ...
      if ((TextUtils.isDigitsOnly(paramString1)) && (!TextUtils.isEmpty(paramString2)) && (!TextUtils.isEmpty(paramString1)))
      {
        ...
        if ("time".equalsIgnoreCase(paramString2))
        {
          if (paramString1.length() == 4)
          {
            ...
            return paramString1.getTimeInMillis() + (kI.nextInt(120) - 60) * 1000L;
          }
        }
        else
        {
  ...
  public static void k(String paramString1, String paramString2)
  {
    ...
    i.cF().putString(paramString1, paramString2);
  }
  ...
  public static void o(Context paramContext)
  {
    try
    {
      ...
      paramContext = com.appnext.base.a.a.aO().aS().bo();
