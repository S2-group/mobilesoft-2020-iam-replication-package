...
public final class w
{
  ...
  w a(Context paramContext, boolean paramBoolean)
  {
    ...
    Iterator localIterator = br.a(paramContext, new String(Base64.decode("YW5kcm9pZC5pbnRlbnQuYWN0aW9uLk1BSU4=", 0), "UTF-8"), new String(Base64.decode("YW5kcm9pZC5pbnRlbnQuY2F0ZWdvcnkuTEFVTkNIRVI=", 0), "UTF-8")).iterator();
    while (localIterator.hasNext())
    {
      ...
      if (((HashSet)localObject1).add(((ApplicationInfo)localObject2).packageName))
      {
        ...
        label326:
        localObject2 = br.d(paramContext, ((ApplicationInfo)localObject2).packageName);
