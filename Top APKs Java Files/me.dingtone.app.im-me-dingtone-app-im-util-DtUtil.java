...
import com.dingtone.adlibrary.utils.NetUtils;
...
import me.dingtone.app.im.i.a.b;
import me.dingtone.app.im.i.a.g;
import me.dingtone.app.im.i.a.n;
...
public class DtUtil
{
  ...
  public static void Download(Context paramContext, String paramString1, String paramString2)
  {
    for (;;)
    {
      try
      {
        ...
        paramString1.setDestinationUri(bl.a(paramContext, new File(paramString2)));
        switch (getDownloadStatus(paramContext, ao.a().C()))
        {
        case 3: 
        case 5: 
        case 6: 
        case 7: 
          ...
          if (ao.a().C() != -1L) {
            localDownloadManager.remove(new long[] { ao.a().C() });
          }
  ...
  public static void checkAndGetUserAgent()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((ao.a().cL() == null) || ("".equals(ao.a().cL())))
      {
        String str = getUserAgent(DTApplication.h());
        ao.a().al(str);
      }
      return;
    }
  ...
  {
    String str = ((TelephonyManager)DTApplication.h().getSystemService("phone")).getSimCountryIso();
    DTLog.i("DtUtil", "uae vpn has checkSupportCallVpnBySimCard isoCountryCode = " + str);
    ArrayList localArrayList = me.dingtone.app.im.manager.g.c().ae();
  ...
  {
    return NetUtils.checkVPN(DTApplication.h().getApplicationContext());
  }
  ...
  public static int getADCountryCode()
  {
    ...
    {
      if (ao.a().cx() != 0) {
        return (short)ao.a().cx();
      }
      Object localObject = b.a().e();
      if (((ArrayList)localObject).size() == 1)
      {
        localObject = dy.c((String)((ArrayList)localObject).get(0));
        if (localObject != null) {
          return Integer.valueOf((String)localObject).intValue();
        }
      }
      if ((ao.a().aU() > 0) && (!"".equals(ao.a().aX()))) {
        return ao.a().aU();
      }
      String str2 = do.n();
      String str1 = "";
      ...
      if (str2 != null)
      {
        localObject = str1;
        if (!str2.isEmpty()) {
          localObject = dy.c(str2.toUpperCase());
        }
      }
      ...
      {
        localObject = dy.c(((String)localObject).toUpperCase());
        if (localObject != null) {
          return Short.parseShort((String)localObject);
        }
      }
      localObject = DTApplication.h().getResources().getConfiguration().locale.getCountry();
      if ((localObject != null) && (!((String)localObject).isEmpty()))
      {
        localObject = dy.c(((String)localObject).toUpperCase());
        if (localObject != null)
  ...
  public static String getAdCountryIso()
  {
    ...
    else
    {
      ...
      if (str != null)
      {
        ...
        if (!str.isEmpty())
        {
          DTLog.i("DtUtil", "getISOCode...mainCountryCode :" + ao.a().aU());
          localObject2 = dy.d(getCountryCodeByPhoneNumber(str));
        }
      }
    }
    if (localObject2 != null)
  ...
  {
    return getAppVersionName() + "." + "15034";
  }
  ...
  {
    String str2 = ao.a().ay();
    String str3 = ao.a().ab(7);
    String str1 = str3 + str2;
    if ((str3 == null) || ("".equals(str3))) {
      str1 = ao.a().aa(7) + str2;
    }
    return DTApplication.h().getApplicationContext().getString(a.n.conference_call_share_invite_attendees, new Object[] { paramString1, paramString2, em.a(new Date(1000L * paramLong), false), paramString3, paramString4, str1 });
  }
  
  public static String getCNLinkUrlWithInviteKey(int paramInt)
  {
    String str2 = ao.a().ay();
    String str3 = ao.a().ab(paramInt);
    DTLog.i("DtUtil", "getCNLinkUrlWithInviteKey inviteKey = " + str2 + " inviteUrl " + str3);
    String str1 = str3 + str2;
    if ((str3 == null) || ("".equals(str3))) {
      str1 = ao.a().aa(paramInt) + str2;
    }
  ...
  {
    Object localObject2 = ao.a().ab(paramInt);
    Object localObject1;
    if (localObject2 != null)
    {
      localObject1 = localObject2;
  ...
  public static String getCNQQShareContentWithInviteKey()
  {
    ...
    return DTApplication.h().getApplicationContext().getString(a.n.share_usingdingtone_cnqq, new Object[] { str });
  }
  ...
  public static String getCNQQShareContentWithoutInviteKey()
  {
    ...
    return DTApplication.h().getApplicationContext().getString(a.n.share_usingdingtone_cnqq, new Object[] { str1 });
  }
  ...
  public static String getCNShareContentWithInviteKey()
  {
    ...
    return DTApplication.h().getApplicationContext().getString(a.n.share_usingdingtone, new Object[] { str });
  }
  ...
  public static String getCNShareContentWithoutInviteKey()
  {
    ...
    return DTApplication.h().getApplicationContext().getString(a.n.share_usingdingtone, new Object[] { str1 });
  }
  ...
  public static String getCNWeChatShareContentWithInviteKey(boolean paramBoolean)
  {
    ...
    String str2 = DTApplication.h().getApplicationContext().getString(a.n.share_usingdingtone_cnwechat, new Object[] { str3 });
    String str1 = str2;
    if (paramBoolean)
    {
      str1 = str2;
      if (1 == me.dingtone.app.im.manager.g.c().G())
      {
        str1 = cc.d();
        DTLog.i("DtUtil", "getCNWeChatShareContentWithInviteKey rewardInviteCode=" + str1);
        str1 = DTApplication.h().getApplicationContext().getString(a.n.share_usingdingtone_cnwechat_with_code, new Object[] { str1, str3 });
      }
    }
    return str1;
  }
  ...
  public static String getCNWeChatShareContentWithoutInviteKey()
  {
    ...
    DTLog.d("DtUtil", "getShareContentWithInviteKey inviteKey=" + str);
    return DTApplication.h().getApplicationContext().getString(a.n.share_usingdingtone_cnwechat, new Object[] { str });
  }
  ...
  public static int getCallLogCount(Context paramContext)
  {
    // Byte code:
    //   0: ldc_w 966
    //   3: invokestatic 969	me/dingtone/app/im/util/q:a	(Ljava/lang/String;)Z
    //   6: ifeq +5 -> 11
    //   9: iconst_0
    //   10: ireturn
    //   11: aload_0
    //   12: invokevirtual 973	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   15: getstatic 979	android/provider/CallLog$Calls:CONTENT_URI	Landroid/net/Uri;
    //   18: aconst_null
    //   19: aconst_null
    //   20: aconst_null
    //   21: aconst_null
    //   22: invokevirtual 985	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   25: astore_0
    //   26: aload_0
    //   27: ifnull +61 -> 88
    //   30: aload_0
    //   31: invokeinterface 990 1 0
    //   36: istore_1
    //   37: aload_0
    //   38: invokeinterface 993 1 0
    //   43: iload_1
    //   44: ireturn
    //   45: astore_0
    //   46: iconst_0
  ...
  public static String[] getCatalogForSideBar(bx paramBx)
  {
    ...
    for (;;)
    {
      ...
      if (k < j)
      {
        ...
        localObject1 = localObject2;
        if (((String)localObject2).equals(DTApplication.h().getResources().getString(a.n.catalog_name_favorites))) {
          localObject1 = "✩";
        }
        if ((!((String)localObject1).equals(DTApplication.h().getResources().getString(a.n.group))) && (!((String)localObject1).equals(DTApplication.h().getResources().getString(a.n.broadcast_list))) && (!((String)localObject1).equals("G20")))
        {
          localObject2 = localObject1;
          if (!((String)localObject1).equals(DTApplication.h().getResources().getString(a.n.conference_call_selected))) {}
        }
        else
        {
          localObject2 = "";
  ...
  public static String[] getCatalogForSideBarFromThreadLocal(bx paramBx)
  {
    ...
    if (((paramBx instanceof y)) && (((y)paramBx).a() != null)) {
      j -= 1;
    }
    for (;;)
    {
  ...
  private static String getCategorySharePostContent(int paramInt, boolean paramBoolean, String paramString)
  {
    String str;
    Object localObject;
    if (!org.apache.commons.lang.d.a(paramString))
    {
      str = ao.a().ay();
      localObject = "";
      if (paramString.equals(me.dingtone.app.im.u.a.bx))
      {
        localObject = me.dingtone.app.im.invite.e.d(paramInt);
        if (org.apache.commons.lang.d.a((String)localObject)) {
          break label249;
        }
      }
    }
    label249:
    for (paramString = (String)localObject + str;; paramString = "")
    {
      localObject = new int[12];
      localObject[0] = a.n.top_point_Invite_text_0;
      localObject[1] = a.n.top_point_Invite_text_1;
      localObject[2] = a.n.top_point_Invite_text_2;
      localObject[3] = a.n.top_point_Invite_text_3;
      localObject[4] = a.n.top_point_Invite_text_4;
      localObject[5] = a.n.top_point_Invite_text_5;
      localObject[6] = a.n.top_point_Invite_text_6;
      localObject[7] = a.n.top_point_Invite_text_7;
      localObject[8] = a.n.top_point_Invite_text_8;
      localObject[9] = a.n.top_point_Invite_text_9;
      localObject[10] = a.n.top_point_Invite_text_10;
      localObject[11] = a.n.top_point_Invite_text_11;
      paramInt = localObject[new Random().nextInt(localObject.length)];
      localObject = DTApplication.h().getApplicationContext().getString(paramInt);
      paramString = (String)localObject + " " + paramString + " ";
      DTLog.d("DtUtil", "Wallet, getCategorySharePostContent: " + paramString);
      return paramString;
      if (!paramString.equals(me.dingtone.app.im.u.a.by)) {
        break;
      }
      localObject = me.dingtone.app.im.invite.e.c(paramInt);
      break;
      return "";
    }
  }
  ...
  public static String getCountryIsoIfVpnConnected()
  {
    ...
    else
    {
      ...
      if (localObject3 != null)
      {
        ...
        {
          DTLog.i("DtUtil", "getISOCode...mainCountryCode :" + ao.a().aU());
          localObject2 = dy.d(getCountryCodeByPhoneNumber((String)localObject3));
        }
      }
    }
    if (localObject2 != null)
  ...
  public static void getDeviceInfo(Context paramContext)
  {
    String str = do.q();
    ao.a().F(str);
    paramContext = String.format("%s_%s_%s", new Object[] { ds.a(paramContext), Build.MANUFACTURER, Build.MODEL });
  ...
  public static String getFormatedPhoneNumber(String paramString)
  {
    ...
    if ("99999999999".equals(paramString)) {
      return DTApplication.h().getString(a.n.unknown_phone_number);
    }
  ...
  public static AdvertisingIdClient.Info getGADInfo()
  {
    ...
    try
    {
      AdvertisingIdClient.Info localInfo = AdvertisingIdClient.getAdvertisingIdInfo(DTApplication.h().getApplicationContext());
      return localInfo;
    }
  ...
  public static ArrayList<String> getInstallAppName(String[] paramArrayOfString)
  {
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      for (;;)
      {
        ...
        {
          localObject2 = ((PackageInfo)localObject2).applicationInfo.loadLabel(DTApplication.h().getPackageManager()).toString();
  ...
  {
    String str1 = ao.a().aa(paramInt);
    String str2 = ao.a().ab(paramInt);
    Locale localLocale = em.a();
  ...
  {
    return ao.a().cS() * 1000 + System.currentTimeMillis();
  }
  ...
  public static String getLocaleInfo()
  {
    try
    {
      String str1 = DTApplication.h().getApplicationContext().getResources().getConfiguration().locale.getLanguage();
  ...
  public static String getLotteryWinShareKey(int paramInt1, int paramInt2)
  {
    ...
    return DTApplication.h().getApplicationContext().getString(a.n.lottery_won_super_cool, new Object[] { "" + paramInt1, str });
  }
  ...
  private static List<PackageInfo> getPkgInfoList()
  {
    if ((pkgInfoList == null) || (pkgInfoList.size() == 0)) {
      pkgInfoList = DTApplication.h().getPackageManager().getInstalledPackages(0);
    }
    return pkgInfoList;
  }
  ...
  public static String getSharePostContent(int paramInt, boolean paramBoolean, String paramString)
  {
    if (!org.apache.commons.lang.d.a(paramString)) {
      return getCategorySharePostContent(paramInt, paramBoolean, paramString);
    }
    paramString = ao.a().ay();
    String str1 = ao.a().aa(paramInt);
    String str2 = str1 + paramString + " ";
    DTLog.d("DtUtil", "getSharePostContent shareLink=" + str2);
    paramString = DTApplication.h().getResources().getStringArray(a.b.invite_fb_content);
    switch (paramInt)
    {
    }
    for (;;)
    {
      str1 = String.format(paramString[new Random().nextInt(paramString.length)], new Object[] { ao.a().aN() });
      paramString = str1;
      if (paramBoolean)
      {
        paramString = str1;
        ...
        {
          paramString = cc.d();
          paramString = DTApplication.h().getResources().getString(a.n.invite_code_suffix, new Object[] { paramString });
          paramString = str1 + paramString.substring(1, paramString.length());
        }
      }
      paramString = paramString + " " + str2 + " ";
      DTLog.d("DtUtil", "getSharePostContent: " + paramString);
      return paramString;
      paramString = DTApplication.h().getResources().getStringArray(a.b.invite_content_for_phone);
      continue;
      paramString = DTApplication.h().getResources().getStringArray(a.b.invite_content_for_phone_and_message);
    }
  }
  ...
  public static String getTitleByUsersWithSplit(ArrayList<Long> paramArrayList, String paramString)
  {
    ...
    Object localObject = ei.d((Long)localIterator.next());
    if (paramArrayList == null) {}
  ...
  public static String getTitleOfSubUsersOfGroupWithSplit(ArrayList<String> paramArrayList, String paramString, long paramLong)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (((String)localObject).equals(ao.a().aM()))
      {
        str1 = DTApplication.h().getString(a.n.you);
      }
      else
      {
        String str2 = ei.c(Long.valueOf((String)localObject));
        localObject = str2;
        if ("".equals(str2)) {
          localObject = DTApplication.h().getString(a.n.unknown);
        }
        if (paramArrayList == null) {}
        for (;;)
        {
  ...
  {
    int i = 0;
    String str3 = dn.b(Arrays.asList(DTApplication.h().getApplicationContext().getResources().getStringArray(a.b.share_usingdingtone_twitter)));
    String str4 = ao.a().aa(6);
    DTLog.i("DtUtil", "getTwitterPostContent inviteKey=" + str4);
    ArrayList localArrayList = new ArrayList();
    String str2 = "";
    AppInviteConfig localAppInviteConfig = me.dingtone.app.im.manager.g.c().K();
    String str1 = str2;
    int j;
    if (localAppInviteConfig != null)
    {
      str1 = str2;
      if (dn.a(localAppInviteConfig.twitterHashTag) > 0)
      {
        int k = dn.a(localAppInviteConfig.twitterHashTag);
        if (k >= 2)
        {
    ...
    for (;;)
    {
      ...
      DTLog.d("DtUtil", "getTwitterPostContent tag list:" + dn.d(localArrayList));
  ...
  {
    String str = (String)cd.b(DTApplication.h().getApplicationContext(), "sp_user_agent_file", "sp_user_agent_key", "");
    long l = ((Long)cd.b(DTApplication.h().getApplicationContext(), "sp_user_agent_file", "sp_user_agent_save_time", Long.valueOf(0L))).longValue();
    ...
    if ((TextUtils.isEmpty(str)) || (getDurationDay(l) > 7L)) {
      try
      {
        ...
        if (Build.VERSION.SDK_INT >= 17)
        {
          ...
          cd.a(DTApplication.h().getApplicationContext(), "sp_user_agent_file", "sp_user_agent_key", paramContext);
          cd.a(DTApplication.h().getApplicationContext(), "sp_user_agent_file", "sp_user_agent_save_time", Long.valueOf(System.currentTimeMillis()));
          return paramContext;
        }
        ...
        cd.a(DTApplication.h().getApplicationContext(), "sp_user_agent_file", "sp_user_agent_key", str);
        cd.a(DTApplication.h().getApplicationContext(), "sp_user_agent_file", "sp_user_agent_save_time", Long.valueOf(System.currentTimeMillis()));
        return str;
      }
      catch (Throwable paramContext)
  ...
  public static int getWeekCallLogCount(Context paramContext)
  {
    ...
    //   1: istore_1
    //   2: ldc_w 966
    //   5: invokestatic 969	me/dingtone/app/im/util/q:a	(Ljava/lang/String;)Z
    //   8: ifeq +5 -> 13
    //   11: iconst_0
    //   12: ireturn
    ...
    //   20: invokevirtual 1485	java/lang/Long:longValue	()J
    //   23: lstore 5
    //   25: aload_0
    //   26: invokevirtual 973	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   29: getstatic 979	android/provider/CallLog$Calls:CONTENT_URI	Landroid/net/Uri;
    //   32: aconst_null
    //   33: ldc_w 1746
    //   36: iconst_1
    ...
    //   49: invokestatic 1749	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   52: aastore
    //   53: aconst_null
    //   54: invokevirtual 985	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   57: astore_0
    //   58: aload_0
    //   59: ifnull +93 -> 152
    //   62: aload_0
    //   63: invokeinterface 990 1 0
    //   68: istore_2
    //   69: iload_2
    //   70: istore_1
    //   71: aload_0
    //   72: invokeinterface 993 1 0
    //   77: iload_1
    //   78: ireturn
    //   79: astore_0
    //   80: aconst_null
  ...
  public static int getWeekSMSCount(Context paramContext)
  {
    ...
    //   37: invokevirtual 1485	java/lang/Long:longValue	()J
    //   40: lstore 5
    //   42: aload_0
    //   43: invokevirtual 973	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   46: aload 7
    //   48: aconst_null
    //   49: ldc_w 1746
    //   52: iconst_1
    ...
    //   65: invokestatic 1749	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   68: aastore
    //   69: aconst_null
    //   70: invokevirtual 985	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   73: astore 7
    //   75: aload 7
    //   77: astore_0
    //   78: aload 7
    //   80: invokeinterface 990 1 0
    //   85: istore_2
    //   86: iload_2
    //   87: istore_1
    //   88: aload 7
  ...
  public static String getWhatsAppShareContentWithInviteKey(boolean paramBoolean)
  {
    ...
    localObject[0] = a.n.twitter_share_templete_1;
    localObject[1] = a.n.twitter_share_templete_2;
    localObject[2] = a.n.twitter_share_templete_3;
    localObject[3] = a.n.twitter_share_templete_4;
    localObject[4] = a.n.twitter_share_templete_5;
    localObject[5] = a.n.twitter_share_templete_6;
    localObject[6] = a.n.twitter_share_templete_7;
    localObject[7] = a.n.twitter_share_templete_8;
    localObject[8] = a.n.twitter_share_templete_9;
    int i = new Random().nextInt(localObject.length);
    String str1 = DTApplication.h().getApplicationContext().getString(a.n.app_name);
    str1 = DTApplication.h().getApplicationContext().getString(localObject[i], new Object[] { str1, str2 });
    localObject = str1;
    if (paramBoolean)
    {
      localObject = str1;
      if (1 == me.dingtone.app.im.manager.g.c().G())
      {
        ...
        localObject = DTApplication.h().getApplicationContext().getString(a.n.invite_whatsapp_content_with_code, new Object[] { str2, localObject });
      }
    }
    return localObject;
  }
  ...
  public static void installApp(Context paramContext, String paramString)
  {
    ...
    try
    {
      ...
      if (localFile.exists())
      {
        paramContext.startActivity(bl.a(paramContext, localFile, localIntent, "application/vnd.android.package-archive"));
        return;
      }
    }
    catch (Exception paramContext)
    ...
    ao.a().g(-1L);
    Download(paramContext, ao.a().H(), paramString);
  }
  ...
  {
    return (getCountryCodeByPhoneNumber(ao.a().ai()).equals("86")) && (!ao.a().ah());
  }
  ...
  {
    return DTApplication.h().o() instanceof MessageChatActivity;
  }
  
  public static boolean isCurrentBindActivity()
  {
    return ((DTApplication.h().o() instanceof LinkSecondPhoneActivity)) || ((DTApplication.h().o() instanceof LinkEmailAddressActivity));
  }
    ...
    for (Object localObject = getAuthorityFromPermission(paramContext);; localObject = "")
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        try
        {
          ...
          paramContext = localContentResolver.query((Uri)localObject, null, "title=?", new String[] { paramContext.getResources().getString(a.n.app_name) }, null);
          if (paramContext == null) {
            break label173;
          }
  ...
  public static boolean isUAEuser(boolean paramBoolean)
  {
    try
    {
      ...
      if ((ao.a().aU() > 0) && (!"".equals(ao.a().aX())) && (ao.a().aU() == 971)) {
        return true;
      }
      Object localObject = do.n();
  ...
  public static void preSaveCountryCode()
  {
    ...
    try
    {
      if ((ao.a().aX() != null) && (!"".equals(ao.a().aX())))
      {
        localObject = getCountryCodeByPhoneNumber(ao.a().aX());
        localEditor.putString((String)localObject, (String)localObject);
      }
      if ((ao.a().bw() != null) && (!"".equals(ao.a().bw())))
      {
        localObject = getCountryCodeByPhoneNumber(ao.a().bw());
        localEditor.putString((String)localObject, (String)localObject);
      }
      String str2 = do.n();
      String str1 = "";
      ...
      if (ao.a().cx() != 0) {
        localEditor.putString(String.valueOf(ao.a().cx()), String.valueOf(ao.a().cx()));
      }
      str1 = ao.a().bx();
      if ((!"".equals(str1)) && (dy.c(str1.toUpperCase()) != null)) {
        localEditor.putString((String)localObject, (String)localObject);
      }
      localObject = DTApplication.h().getResources().getConfiguration().locale.getCountry();
      int i = j;
  ...
  {
    ActivityManager localActivityManager = (ActivityManager)DTApplication.h().getSystemService("activity");
  ...
  public static void showDownloadDialog(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    q.a(paramContext, paramString2, paramString1, null, paramContext.getResources().getString(a.n.update_dialog_btn_download), new DtUtil.1(paramString3, paramContext));
  }
  ...
  public static void suspendPrivateNumberWhenNotBind(Context paramContext)
  {
    ...
    long l2;
    if ((ao.a().w() == l.c) && (AppConnectionManager.a().d().booleanValue()) && (ev.g() == 2))
    {
      l1 = ao.a().cS() * 1000;
      long l3 = System.currentTimeMillis() + l1;
      DTLog.i("DtUtil", "suspendPrivateNumberWhenNotBind current:" + em.e(l3));
      ...
      if (localObject != null)
      {
        ...
        if (((Iterator)localObject).hasNext())
        {
          ...
          if (l2 >= 86400000L)
          {
            ...
            DTLog.d("DtUtil", "suspendPrivateNumberWhenNotBind suspend privateNumber:" + localPrivatePhoneItemOfMine.getPhoneNumber() + " gainTime:" + em.e(localPrivatePhoneItemOfMine.getGainTime()));
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (l1 > l2)
        {
          ...
          if (i != 0)
          {
            DTLog.i("DtUtil", "suspendPrivateNumberWhenNotBind  createAlarm privatePhoneNumber:" + str + " alarTime:" + em.e(l1));
