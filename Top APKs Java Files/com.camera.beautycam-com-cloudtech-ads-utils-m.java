...
public final class m
{
  ...
  {
    return ContextHolder.getContext().getResources().getDrawable(paramInt);
  }
  ...
  {
    return (int)TypedValue.applyDimension(1, paramInt, ContextHolder.getContext().getResources().getDisplayMetrics());
  }
  ...
  public static String d(Context paramContext)
  {
    ...
    //   3: ifnull +12 -> 15
    //   6: ldc_w 308
    //   9: invokestatic 199	com/cloudtech/ads/utils/m:b	(Ljava/lang/String;)Z
    //   12: ifeq +32 -> 44
    //   15: ldc_w 310
    //   18: iconst_1
    ...
    //   24: ldc_w 308
    //   27: aastore
    //   28: invokestatic 71	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   31: invokestatic 77	com/cloudtech/ads/utils/YeLog:e	(Ljava/lang/String;)V
    //   34: iconst_0
    //   35: istore_1
    //   36: iload_1
    //   37: ifne +26 -> 63
    ...
    //   44: aload_0
    //   45: ldc_w 308
    //   48: invokestatic 315	android/os/Process:myPid	()I
    //   51: invokestatic 318	android/os/Process:myUid	()I
    //   54: invokevirtual 322	android/content/Context:checkPermission	(Ljava/lang/String;II)I
    //   57: ifne -23 -> 34
    //   60: goto -24 -> 36
    //   63: aload_0
    //   64: ldc_w 324
    //   67: invokevirtual 250	android/content/Context:getSystemService	(Ljava/lang/String;)Ljava/lang/Object;
    //   70: checkcast 326	android/telephony/TelephonyManager
    //   73: astore_2
    //   74: aload_2
    //   75: ifnull +62 -> 137
    //   78: aload_2
    //   79: invokevirtual 329	android/telephony/TelephonyManager:getDeviceId	()Ljava/lang/String;
    //   82: astore_2
    //   83: aload_2
    //   84: astore_3
    //   85: aload_2
    //   86: invokestatic 335	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   89: ifeq -47 -> 42
    //   92: aload_0
    //   93: invokevirtual 55	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   96: ldc 57
    //   98: invokestatic 63	android/provider/Settings$Secure:getString	(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;
    //   101: astore_0
    //   102: aload_0
    //   103: areturn
    //   104: astore_0
    ...
    //   111: dup
    //   112: ldc_w 337
    //   115: invokespecial 111	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   118: aload_0
    //   119: invokevirtual 243	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   128: invokestatic 77	com/cloudtech/ads/utils/YeLog:e	(Ljava/lang/String;)V
    //   131: aload_2
    //   132: areturn
    //   133: astore_0
    //   134: goto -26 -> 108
