...
public class y
{
  ...
  public static File[] b(Context paramContext)
  {
    ...
    try
    {
      ...
      if (((File)localObject2).isDirectory()) {
        paramContext = ((File)localObject2).listFiles(l.c(".xml"));
      }
      return paramContext;
    }
    catch (PackageManager.NameNotFoundException paramContext)
    {
      i.e(new Object[] { paramContext });
    }
    return null;
  }
  ...
  public static void c()
  {
    ...
    SharedPreferences localSharedPreferences = Globals.L();
  ...
  {
    return Globals.L().getString("OsUpgradeHistory", "");
  }
  ...
  private static boolean h()
  {
    ...
    //   5: iconst_2
    //   6: anewarray 151	java/lang/String
    //   9: dup
    //   10: iconst_0
    //   11: ldc_w 262
    //   14: aastore
