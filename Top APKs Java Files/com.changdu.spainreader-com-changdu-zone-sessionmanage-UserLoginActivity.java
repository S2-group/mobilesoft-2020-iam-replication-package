  ...
  implements a
{
  ...
  private void a()
  {
    this.j = ((NavigationBar)findViewById(2131231857));
    this.j.setTitle(getString(2131559538));
    this.j.setUpLeftListener(this.C);
    if (getResources().getBoolean(2130968595))
    {
      this.j.setUpRightView(null, getString(2131559919), getResources().getDrawable(2131165501), 2131034192, new r(this));
  ...
  private void c()
  {
    ...
    localEditText.setBackgroundResource(2131166684);
    localEditText.setText("");
    localEditText.setInputType(32);
    localEditText.setMaxLines(1);
    localEditText.setTextColor(getResources().getColor(2131034246));
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.x = ((Button)findViewById(2131231762));
    this.x.setOnClickListener(this.H);
    this.B = ((RelativeLayout)findViewById(2131232600));
    this.A = ((FrameLayout)findViewById(2131232599));
    this.k.a(this.A, new q(this));
    if ((getResources().getBoolean(2130968601)) && (com.changdu.share.q.a())) {
      i1 = 1;
    } else {
      i1 = 0;
    }
