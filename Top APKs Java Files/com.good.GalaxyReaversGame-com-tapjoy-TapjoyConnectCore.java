...
public class TapjoyConnectCore
{
  ...
  private static boolean a(String paramString, boolean paramBoolean)
  {
    ...
    //   362: aload 8
    //   364: astore 9
    //   366: invokestatic 918	com/tapjoy/internal/hi:a	()Lcom/tapjoy/internal/hi;
    ...
    //   380: aload 11
    //   382: aload 17
    //   384: invokevirtual 923	com/tapjoy/internal/hi:a	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   387: aload 8
    //   389: astore 9
    //   391: aload 10
  ...
  public void doProfileAsync()
  {
    ...
    try
    {
      ...
      localFh.c = new fk()
      {
        public final void a(ga paramAnonymousGa)
        {
          if (paramAnonymousGa.b == gn.b) {
            TapjoyConnectCore.a(paramAnonymousGa.a);
          }
          for (;;)
          {
            paramAnonymousGa = TapjoyConnectCore.a(TapjoyConnectCore.this);
            paramAnonymousGa.a();
            paramAnonymousGa.t.a();
            paramAnonymousGa.d.a(paramAnonymousGa.g);
            if (paramAnonymousGa.e != null)
            {
              paramAnonymousGa.e.a(go.b);
              paramAnonymousGa.e = null;
            }
            if (paramAnonymousGa.r != null) {
              paramAnonymousGa.r.a(false);
            }
            gd.b();
            paramAnonymousGa = paramAnonymousGa.d;
            paramAnonymousGa.a.writeLock().lock();
            try
            {
              paramAnonymousGa.b = false;
              paramAnonymousGa.c = false;
              paramAnonymousGa.f = false;
              paramAnonymousGa.e = false;
              paramAnonymousGa.d = false;
              return;
            }
            finally
            {
              paramAnonymousGa.a.writeLock().unlock();
            }
            TapjoyLog.d("TapjoyConnect", "Error retrieving Threatmetrix session ID. Status=" + paramAnonymousGa.b);
          }
        }
      };
      if (localFh.i == null) {
