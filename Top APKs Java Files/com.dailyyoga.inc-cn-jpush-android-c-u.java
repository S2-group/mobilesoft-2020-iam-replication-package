  ...
  public static JSONArray a(Context paramContext)
  {
    ...
    try
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        ((JSONObject)localObject3).put(z[3], ((m)localObject2).a);
        ((JSONObject)localObject3).put(z[0], ((m)localObject2).b);
        ((JSONObject)localObject3).put(z[2], ((m)localObject2).c);
