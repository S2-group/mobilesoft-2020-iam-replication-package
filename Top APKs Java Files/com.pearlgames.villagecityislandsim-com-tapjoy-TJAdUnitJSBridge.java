...
public class TJAdUnitJSBridge
{
  ...
  public void displayVideo(JSONObject paramJSONObject, String paramString)
  {
    ...
    //   0: ldc -41
    //   2: astore_3
    //   3: new 480	java/util/HashMap
    //   6: dup
    //   7: invokespecial 481	java/util/HashMap:<init>	()V
    //   10: astore 5
    //   12: aload_1
    //   13: ldc_w 483
    //   16: invokevirtual 487	org/json/JSONObject:getJSONObject	(Ljava/lang/String;)Lorg/json/JSONObject;
    //   19: astore 4
    //   21: aload 4
    //   23: ifnull +96 -> 119
    //   26: aload 4
    //   28: invokevirtual 490	org/json/JSONObject:keys	()Ljava/util/Iterator;
    //   31: astore 6
    //   33: aload 6
    ...
    //   59: aload 4
    //   61: aload 7
    //   63: invokevirtual 223	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   66: invokevirtual 494	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   69: pop
    //   70: goto -37 -> 33
    //   73: astore 8
    //   75: ldc 30
    //   77: new 160	java/lang/StringBuilder
    //   80: dup
    //   81: invokespecial 161	java/lang/StringBuilder:<init>	()V
    //   84: ldc_w 496
    //   87: invokevirtual 167	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   90: aload 4
    //   92: aload 7
    //   94: invokevirtual 223	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   97: invokevirtual 167	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   100: invokevirtual 171	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   103: invokestatic 80	com/tapjoy/TapjoyLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   106: goto -73 -> 33
    //   109: astore 4
    //   111: ldc 30
    //   113: ldc_w 498
    //   116: invokestatic 80	com/tapjoy/TapjoyLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   119: aload_1
    //   120: ldc_w 500
    //   123: invokevirtual 223	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   126: astore 4
    //   128: aload 4
    //   130: astore_3
    //   131: aload_1
    //   132: ldc_w 299
    //   135: invokevirtual 223	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   138: astore_1
    //   139: new 428	android/content/Intent
    //   142: dup
    //   143: aload_0
    //   144: getfield 82	com/tapjoy/TJAdUnitJSBridge:context	Landroid/content/Context;
    //   147: ldc_w 502
    //   150: invokespecial 431	android/content/Intent:<init>	(Landroid/content/Context;Ljava/lang/Class;)V
    //   153: astore 4
    //   155: invokestatic 313	com/tapjoy/TapjoyCache:getInstance	()Lcom/tapjoy/TapjoyCache;
    //   158: ifnull +31 -> 189
    //   161: invokestatic 313	com/tapjoy/TapjoyCache:getInstance	()Lcom/tapjoy/TapjoyCache;
    //   164: aload_1
    //   165: invokevirtual 506	com/tapjoy/TapjoyCache:getCachedDataForURL	(Ljava/lang/String;)Lcom/tapjoy/TapjoyCachedAssetData;
    //   168: astore 6
    //   170: aload 6
    //   172: ifnull +17 -> 189
    //   175: aload 4
    //   177: ldc_w 508
    //   180: aload 6
    //   182: invokevirtual 513	com/tapjoy/TapjoyCachedAssetData:getLocalFilePath	()Ljava/lang/String;
    //   185: invokevirtual 445	android/content/Intent:putExtra	(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    //   188: pop
    //   189: aload 4
    //   191: ldc_w 515
    //   194: aload_1
    //   195: invokevirtual 445	android/content/Intent:putExtra	(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    //   198: pop
    //   199: aload 4
    //   201: ldc_w 517
    //   204: aload_3
    //   205: invokevirtual 445	android/content/Intent:putExtra	(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    //   208: pop
    //   209: aload 4
    //   211: ldc_w 519
    //   214: iconst_1
    //   215: invokevirtual 522	android/content/Intent:putExtra	(Ljava/lang/String;Z)Landroid/content/Intent;
    //   218: pop
    //   219: aload 4
    //   221: ldc_w 454
    //   224: aload_2
    //   225: invokevirtual 445	android/content/Intent:putExtra	(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    //   228: pop
    //   229: aload 4
    //   231: ldc_w 524
    //   234: aload 5
    //   236: invokevirtual 437	android/content/Intent:putExtra	(Ljava/lang/String;Ljava/io/Serializable;)Landroid/content/Intent;
    //   239: pop
    //   240: aload_0
    //   241: getfield 82	com/tapjoy/TJAdUnitJSBridge:context	Landroid/content/Context;
    //   244: checkcast 393	android/app/Activity
    //   247: aload 4
    //   249: iconst_0
    //   250: invokevirtual 458	android/app/Activity:startActivityForResult	(Landroid/content/Intent;I)V
    //   253: return
    //   254: astore 4
    //   256: ldc 30
    //   258: ldc_w 526
    //   261: invokestatic 326	com/tapjoy/TapjoyLog:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   264: goto -133 -> 131
    //   267: astore_1
    //   268: aload_0
    //   269: aload_2
    ...
    //   274: dup
    //   275: iconst_0
    //   276: getstatic 259	java/lang/Boolean:FALSE	Ljava/lang/Boolean;
    //   279: aastore
    //   280: invokevirtual 263	com/tapjoy/TJAdUnitJSBridge:invokeJSCallback	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   283: aload_1
    //   284: invokevirtual 192	java/lang/Exception:printStackTrace	()V
    //   287: return
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	288	0	this	TJAdUnitJSBridge
    //   0	288	1	paramJSONObject	JSONObject
    //   0	288	2	paramString	String
    //   2	203	3	localObject1	Object
    //   19	72	4	localJSONObject	JSONObject
    //   109	1	4	localException1	Exception
    //   126	122	4	localObject2	Object
    //   254	1	4	localException2	Exception
    //   10	225	5	localHashMap	HashMap
    //   31	150	6	localObject3	Object
    //   53	40	7	str	String
    ...
    //   119	128	254	java/lang/Exception
    //   131	170	267	java/lang/Exception
    //   175	189	267	java/lang/Exception
    //   189	253	267	java/lang/Exception
  }
  ...
  public void share(JSONObject paramJSONObject, String paramString)
  {
    ...
    //   32: dup
    //   33: ldc_w 732
    //   36: invokespecial 733	android/content/Intent:<init>	(Ljava/lang/String;)V
    //   39: astore 11
    //   41: aload_1
    //   42: ldc_w 735
    ...
    //   71: aload_0
    //   72: aload 5
    //   74: invokespecial 739	com/tapjoy/TJAdUnitJSBridge:downloadFileFromURL	(Ljava/lang/String;)Ljava/io/File;
    //   77: astore 9
    //   79: aload 7
    //   81: astore 6
    //   83: aload 9
    ...
    //   101: aload 9
    //   103: invokevirtual 744	java/io/File:getAbsolutePath	()Ljava/lang/String;
    ...
    //   181: aload 11
    //   183: ldc_w 752
    //   186: invokevirtual 755	android/content/Intent:setType	(Ljava/lang/String;)Landroid/content/Intent;
    //   189: pop
    //   190: aload 11
    //   192: ldc_w 757
    //   195: aload 6
    //   197: invokestatic 470	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   200: invokevirtual 760	android/content/Intent:putExtra	(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;
    //   203: pop
    //   204: aload_0
    ...
    //   211: aload 11
    //   213: iconst_0
    //   214: invokevirtual 764	android/content/pm/PackageManager:queryIntentActivities	(Landroid/content/Intent;I)Ljava/util/List;
    ...
    //   241: checkcast 766	android/content/pm/ResolveInfo
    //   244: astore 5
    //   246: aload 5
    //   248: getfield 770	android/content/pm/ResolveInfo:activityInfo	Landroid/content/pm/ActivityInfo;
    //   251: getfield 773	android/content/pm/ActivityInfo:packageName	Ljava/lang/String;
    //   254: getstatic 779	java/util/Locale:ENGLISH	Ljava/util/Locale;
    //   257: invokevirtual 783	java/lang/String:toLowerCase	(Ljava/util/Locale;)Ljava/lang/String;
    //   260: aload 10
    //   262: invokevirtual 787	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   265: ifne +25 -> 290
    //   268: aload 5
    //   270: getfield 770	android/content/pm/ResolveInfo:activityInfo	Landroid/content/pm/ActivityInfo;
    //   273: getfield 790	android/content/pm/ActivityInfo:name	Ljava/lang/String;
    //   276: getstatic 779	java/util/Locale:ENGLISH	Ljava/util/Locale;
    //   279: invokevirtual 783	java/lang/String:toLowerCase	(Ljava/util/Locale;)Ljava/lang/String;
    //   282: aload 10
    //   284: invokevirtual 787	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   287: ifeq -64 -> 223
    //   290: aload 11
    //   292: aload 5
    //   294: getfield 770	android/content/pm/ResolveInfo:activityInfo	Landroid/content/pm/ActivityInfo;
    //   297: getfield 773	android/content/pm/ActivityInfo:packageName	Ljava/lang/String;
    //   300: invokevirtual 793	android/content/Intent:setPackage	(Ljava/lang/String;)Landroid/content/Intent;
    //   303: pop
    //   304: iconst_1
    //   305: istore_3
    //   306: iload_3
    ...
    //   375: aload 11
    //   377: ldc_w 799
    //   380: invokevirtual 755	android/content/Intent:setType	(Ljava/lang/String;)Landroid/content/Intent;
    //   383: pop
    //   384: goto -180 -> 204
    //   387: aload 10
    //   389: ldc_w 801
    ...
    //   398: aload 11
    //   400: ldc_w 803
    //   403: invokevirtual 755	android/content/Intent:setType	(Ljava/lang/String;)Landroid/content/Intent;
    //   406: pop
    //   407: aload 5
    //   409: ifnull -205 -> 204
    //   412: aload 6
    ...
    //   427: invokevirtual 760	android/content/Intent:putExtra	(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;
    //   430: pop
    //   431: goto -227 -> 204
    //   434: aload_0
    //   435: iconst_1
    ...
    //   444: aload 11
    //   446: ldc_w 805
    //   449: invokestatic 809	android/content/Intent:createChooser	(Landroid/content/Intent;Ljava/lang/CharSequence;)Landroid/content/Intent;
    //   452: astore_1
    //   453: aload_0
