...
public class i
{
  ...
  {
    Object localObject = sCurProcessName;
    ...
    try
    {
      ...
      while (paramContext.hasNext())
      {
        ...
        if (((ActivityManager.RunningAppProcessInfo)localObject).pid == i)
        {
          ...
          sCurProcessName = ((ActivityManager.RunningAppProcessInfo)localObject).processName;
          paramContext = sCurProcessName;
          return paramContext;
        }
      }
    }
  ...
  private static String getCurProcessNameFromProc()
  {
    ...
    //   0: aconst_null
    //   1: astore_3
    //   2: new 384	java/io/BufferedReader
    //   5: dup
    //   6: new 386	java/io/InputStreamReader
    //   9: dup
    //   10: new 388	java/io/FileInputStream
    //   13: dup
    ...
    //   27: invokestatic 359	android/os/Process:myPid	()I
    //   30: invokevirtual 393	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   33: ldc_w 395
    ...
    //   42: invokespecial 396	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   45: ldc_w 398
    //   48: invokespecial 401	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;Ljava/lang/String;)V
    //   51: invokespecial 404	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   54: astore_1
    //   55: new 86	java/lang/StringBuilder
    //   58: dup
    //   59: invokespecial 87	java/lang/StringBuilder:<init>	()V
    //   62: astore_2
    //   63: aload_1
    //   64: invokevirtual 407	java/io/BufferedReader:read	()I
    //   67: istore_0
    //   68: iload_0
    //   69: ifle +28 -> 97
    //   72: aload_2
    //   73: iload_0
    //   74: i2c
    //   75: invokevirtual 410	java/lang/StringBuilder:append	(C)Ljava/lang/StringBuilder;
    //   78: pop
    //   79: goto -16 -> 63
    //   82: astore_2
    //   83: aload_3
    ...
    //   86: ifnull +9 -> 95
    //   89: aload_1
    //   90: invokevirtual 413	java/io/BufferedReader:close	()V
    //   93: aload_3
    //   94: astore_2
    //   95: aload_2
    //   96: areturn
    //   97: invokestatic 261	com/bytedance/common/utility/Logger:debug	()Z
    //   100: ifeq +32 -> 132
    //   103: ldc_w 374
    //   106: new 86	java/lang/StringBuilder
    //   109: dup
    //   110: invokespecial 87	java/lang/StringBuilder:<init>	()V
    //   113: ldc_w 415
    //   116: invokevirtual 93	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   119: aload_2
    //   120: invokevirtual 100	java/lang/StringBuilder:toString	()Ljava/lang/String;
    ...
    //   129: invokestatic 272	com/bytedance/common/utility/Logger:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   132: aload_2
    ...
    //   142: ifnull -47 -> 95
    //   145: aload_1
    //   146: invokevirtual 413	java/io/BufferedReader:close	()V
    //   149: aload_3
    //   150: areturn
    //   151: astore_1
    //   152: aload_3
    ...
    //   158: ifnull +7 -> 165
    //   161: aload_1
    //   162: invokevirtual 413	java/io/BufferedReader:close	()V
    //   165: aload_2
    //   166: athrow
    //   167: astore_1
    //   168: aconst_null
    ...
    //   67	7	0	i	int
    //   54	92	1	localBufferedReader	java.io.BufferedReader
    //   151	1	1	localException1	Exception
    //   156	6	1	localObject1	Object
    //   167	1	1	localException2	Exception
    //   170	1	1	localException3	Exception
    //   178	1	1	localThrowable1	Throwable
    //   180	1	1	localObject2	Object
    //   62	11	2	localStringBuilder	StringBuilder
    //   82	1	2	localThrowable2	Throwable
    //   84	57	2	localObject3	Object
    //   154	12	2	localObject4	Object
    //   174	1	2	localObject5	Object
    //   1	152	3	localObject6	Object
    // Exception table:
    //   from	to	target	type
    //   55	63	82	java/lang/Throwable
    //   63	68	82	java/lang/Throwable
    //   72	79	82	java/lang/Throwable
    //   97	132	82	java/lang/Throwable
    //   132	137	82	java/lang/Throwable
    //   145	149	151	java/lang/Exception
    //   2	55	154	finally
    //   89	93	167	java/lang/Exception
    //   161	165	170	java/lang/Exception
    //   55	63	174	finally
    //   63	68	174	finally
    //   72	79	174	finally
    //   97	132	174	finally
    //   132	137	174	finally
    //   2	55	178	java/lang/Throwable
  }
  ...
  {
    return j.a("ro.build.version.emui");
  }
  ...
  private static String getSystemProperty(String paramString)
  {
    ...
    //   0: aconst_null
    //   1: astore_1
    //   2: getstatic 37	com/ss/android/common/util/i:systemProperty	Ljava/lang/String;
    //   5: invokestatic 233	com/bytedance/common/utility/StringUtils:isEmpty	(Ljava/lang/String;)Z
    //   8: ifne +9 -> 17
    //   11: getstatic 37	com/ss/android/common/util/i:systemProperty	Ljava/lang/String;
    //   14: astore_0
    //   15: aload_0
    //   16: areturn
    //   17: new 384	java/io/BufferedReader
    //   20: dup
    //   21: new 386	java/io/InputStreamReader
    //   24: dup
    //   25: invokestatic 596	java/lang/Runtime:getRuntime	()Ljava/lang/Runtime;
    ...
    //   48: invokevirtual 602	java/lang/Runtime:exec	(Ljava/lang/String;)Ljava/lang/Process;
    //   51: invokevirtual 608	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   54: invokespecial 611	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   57: sipush 1024
    //   60: invokespecial 614	java/io/BufferedReader:<init>	(Ljava/io/Reader;I)V
    //   63: astore_3
    //   64: aload_3
    //   65: astore_2
    //   66: aload_3
    //   67: invokevirtual 617	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   70: astore_1
    //   71: aload_3
    //   72: astore_2
    //   73: aload_3
    //   74: invokevirtual 413	java/io/BufferedReader:close	()V
    //   77: aload_3
    //   78: astore_2
    //   79: aload_1
    //   80: putstatic 37	com/ss/android/common/util/i:systemProperty	Ljava/lang/String;
    //   83: aload_1
    //   84: astore_0
    //   85: aload_3
    //   86: ifnull -71 -> 15
    ...
    //   98: ldc_w 619
    //   101: aload_0
    //   102: invokestatic 623	com/bytedance/common/utility/Logger:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   105: aload_1
    //   106: areturn
    //   107: astore 4
    //   109: aconst_null
    ...
    //   114: astore_2
    //   115: ldc 84
    //   117: new 86	java/lang/StringBuilder
    //   120: dup
    //   121: invokespecial 87	java/lang/StringBuilder:<init>	()V
    //   124: ldc_w 625
    ...
    //   137: aload 4
    //   139: invokestatic 623	com/bytedance/common/utility/Logger:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   142: aload_1
    //   143: astore_0
    //   144: aload_3
    //   145: ifnull -130 -> 15
    //   148: aload_3
    //   149: invokevirtual 413	java/io/BufferedReader:close	()V
    //   152: aload_1
    //   153: areturn
    //   154: astore_0
    //   155: ldc 84
    //   157: ldc_w 619
    //   160: aload_0
    //   161: invokestatic 623	com/bytedance/common/utility/Logger:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   164: aload_1
    //   165: areturn
    //   166: astore_0
    //   167: aload_1
    //   168: ifnull +7 -> 175
    //   171: aload_1
    //   172: invokevirtual 413	java/io/BufferedReader:close	()V
    //   175: aload_0
    //   176: athrow
    //   177: astore_1
    //   178: ldc 84
    //   180: ldc_w 619
    //   183: aload_1
    //   184: invokestatic 623	com/bytedance/common/utility/Logger:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   187: goto -12 -> 175
    //   190: astore_0
    //   191: aload_2
    //   192: astore_1
    ...
    //   1	171	1	str	String
    //   177	7	1	localIOException	java.io.IOException
    //   192	8	1	localObject	Object
    //   65	127	2	localBufferedReader1	java.io.BufferedReader
    //   63	86	3	localBufferedReader2	java.io.BufferedReader
    //   107	31	4	localThrowable1	Throwable
    //   196	1	4	localThrowable2	Throwable
    //   203	1	4	localThrowable3	Throwable
    // Exception table:
    //   from	to	target	type
    //   89	93	95	java/io/IOException
    //   17	64	107	java/lang/Throwable
    ...
    //   79	83	190	finally
    //   115	142	190	finally
    //   66	71	196	java/lang/Throwable
    //   73	77	203	java/lang/Throwable
    //   79	83	203	java/lang/Throwable
  }
  ...
  {
    sCanSetStatusBar = paramBoolean;
  }
  
  private static void setFlymeStatusBarDarkMode(boolean paramBoolean, Window paramWindow)
  {
    try
    {
  ...
  private static void setMiuiStatusBarDarkMode(boolean paramBoolean, Window paramWindow)
  {
    int i = 0;
    try
    {
  ...
  public static void trySetStatusBar(Context paramContext, Window paramWindow, int paramInt, boolean paramBoolean)
  {
    ...
    if (isMiui()) {
      if (paramBoolean) {
        setMiuiStatusBarDarkMode(false, paramWindow);
      }
    }
    for (;;)
    {
      ...
      return;
      setMiuiStatusBarDarkMode(true, paramWindow);
      continue;
      if (isFlyme())
      {
        if (paramBoolean) {
          setFlymeStatusBarDarkMode(false, paramWindow);
        } else {
          setFlymeStatusBarDarkMode(true, paramWindow);
        }
      }
      else
      {
