...
public final class al
{
  ...
  private boolean a(CellLocation paramCellLocation)
  {
    ...
    for (;;)
    {
      ...
      if (paramCellLocation.getCid() >= 268435455)
      {
        ...
        try
        {
          if ((ai.b(paramCellLocation, "getSystemId", new Object[0]) <= 0) || (ai.b(paramCellLocation, "getNetworkId", new Object[0]) < 0)) {
            break;
          }
  ...
  private static CellLocation b(List paramList)
  {
      ...
      if (localObject5 != null)
      {
        for (;;)
        {
          ...
          try
          {
            ...
            localObject5 = ai.a(localObject4, "getCellIdentity", new Object[0]);
            if (localObject5 != null) {
              continue;
            }
          }
    ...
    for (;;)
    {
      ...
      try
      {
        i3 = ai.b(localObject5, "getSystemId", new Object[0]);
        i4 = ai.b(localObject5, "getNetworkId", new Object[0]);
        int i5 = ai.b(localObject5, "getBasestationId", new Object[0]);
        int i6 = ai.b(localObject5, "getLongitude", new Object[0]);
        ((CdmaCellLocation)localObject4).setCellLocationData(i5, ai.b(localObject5, "getLatitude", new Object[0]), i6, i3, i4);
      ...
      if (i1 == 3)
      {
        i3 = ai.b(localObject5, "getTac", new Object[0]);
        i4 = ai.b(localObject5, "getCi", new Object[0]);
      ...
      i3 = ai.b(localObject5, "getLac", new Object[0]);
      i4 = ai.b(localObject5, "getCid", new Object[0]);
      localObject4 = new GsmCellLocation();
      localObject1 = localObject4;
      ((GsmCellLocation)localObject4).setLacAndCid(i3, i4);
      paramList = localObject2;
