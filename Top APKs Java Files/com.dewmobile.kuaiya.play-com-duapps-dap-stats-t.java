...
public class t
{
  ...
  public static t a(Context paramContext)
  {
    ...
    {
      if (b == null) {
        b = new t(paramContext.getApplicationContext());
      }
      paramContext = b;
      return paramContext;
    }
  ...
  private void b()
  {
    ...
    try
    {
      this.a.getContentResolver().delete(DuAdMbjCacheProvider.a(this.a, 1), "ts<?", new String[] { String.valueOf(l - 86400000L) });
      return;
    }
    catch (Exception localException)
    {
      g.a("ToolboxCacheMgr", "dumpTimeOutDatas() exception: ", localException);
      return;
    }
    catch (Throwable localThrowable)
    {
      g.a("ToolboxCacheMgr", "dumpTimeOutDatas() exception: ", localThrowable);
    }
  }
  ...
  {
    // Byte code:
    //   0: new 74	com/duapps/dap/base/v
    //   3: dup
    //   4: invokespecial 75	com/duapps/dap/base/v:<init>	()V
    //   7: astore 6
    //   9: aload 6
    //   11: aload_1
    //   12: putfield 78	com/duapps/dap/base/v:a	Ljava/lang/String;
    //   15: aload 6
    //   17: iconst_0
    //   18: putfield 82	com/duapps/dap/base/v:c	I
    //   21: invokestatic 37	java/lang/System:currentTimeMillis	()J
    //   24: lstore_2
    //   25: aload_0
    //   26: getfield 15	com/duapps/dap/stats/t:a	Landroid/content/Context;
    //   29: invokevirtual 41	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   32: aload_0
    //   33: getfield 15	com/duapps/dap/stats/t:a	Landroid/content/Context;
    //   36: iconst_1
    //   37: invokestatic 46	com/duapps/dap/stats/cp/DuAdMbjCacheProvider:a	(Landroid/content/Context;I)Landroid/net/Uri;
    //   40: iconst_4
    ...
    //   84: aastore
    //   85: ldc 94
    //   87: invokevirtual 98	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   90: astore 4
    //   92: aload 4
    //   94: ifnull +80 -> 174
    //   97: aload 4
    ...
    //   123: putfield 78	com/duapps/dap/base/v:a	Ljava/lang/String;
    //   126: aload 4
    //   128: astore_1
    //   129: aload 6
    //   131: aload 4
    //   133: iconst_1
    //   134: invokeinterface 108 2 0
    //   139: putfield 110	com/duapps/dap/base/v:b	Ljava/lang/String;
    //   142: aload 4
    //   144: astore_1
    //   145: aload 6
    //   147: aload 4
    //   149: iconst_2
    //   150: invokeinterface 108 2 0
    //   155: putfield 113	com/duapps/dap/base/v:d	Ljava/lang/String;
    //   158: aload 4
    //   160: astore_1
    //   161: aload 6
    //   163: aload 4
    ...
    //   171: putfield 82	com/duapps/dap/base/v:c	I
    //   174: aload 4
    //   176: ifnull +20 -> 196
    //   179: aload 4
    ...
    //   209: ldc 125
    //   211: aload 5
    //   213: invokestatic 71	com/duapps/dap/base/g:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   216: aload 4
    //   218: ifnull -22 -> 196
    //   221: aload 4
  ...
  public void a()
  {
    ...
    try
    {
      this.a.getContentResolver().delete(DuAdMbjCacheProvider.a(this.a, 7), "ts<?", new String[] { String.valueOf(l2 - l1) });
      return;
    }
    catch (Exception localException)
    {
      g.a("ToolboxCacheMgr", "removePreparseCacheTimeOutDatas exception: ", localException);
      return;
    }
    catch (Throwable localThrowable)
    {
      g.a("ToolboxCacheMgr", "removePreparseCacheTimeOutDatas del exception: ", localThrowable);
    }
  }
  ...
  public void a(v paramV)
  {
    ...
    localContentValues.put("_url", paramV.a);
    localContentValues.put("pkg", paramV.b);
    localContentValues.put("p_url", paramV.d);
    localContentValues.put("type", Integer.valueOf(paramV.c));
    localContentValues.put("ts", Long.valueOf(paramV.e));
    paramV = paramV.a;
    try
    {
      if (this.a.getContentResolver().update(DuAdMbjCacheProvider.a(this.a, 1), localContentValues, "_url = ?", new String[] { paramV }) <= 0) {
        this.a.getContentResolver().insert(DuAdMbjCacheProvider.a(this.a, 1), localContentValues);
      }
      b();
      return;
    }
    ...
    {
      g.a("ToolboxCacheMgr", "saveParseResult() exception: ", paramV);
      return;
    }
  ...
  public int b(String paramString)
  {
    ...
    //   3: lstore_3
    //   4: aload_0
    //   5: getfield 15	com/duapps/dap/stats/t:a	Landroid/content/Context;
    //   8: invokevirtual 41	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   11: aload_0
    //   12: getfield 15	com/duapps/dap/stats/t:a	Landroid/content/Context;
    //   15: iconst_1
    //   16: invokestatic 46	com/duapps/dap/stats/cp/DuAdMbjCacheProvider:a	(Landroid/content/Context;I)Landroid/net/Uri;
    //   19: iconst_1
    ...
    //   48: aastore
    //   49: ldc 94
    //   51: invokevirtual 98	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   54: astore 5
    //   56: aload 5
    //   58: ifnull +131 -> 189
    //   61: aload 5
    ...
    //   120: ldc -74
    //   122: aload 6
    //   124: invokestatic 71	com/duapps/dap/base/g:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   127: aload 5
    //   129: ifnull +58 -> 187
    //   132: aload 5
  ...
  public void b(Context paramContext)
  {
    ...
    //   7: astore 6
    //   9: aload_0
    //   10: getfield 15	com/duapps/dap/stats/t:a	Landroid/content/Context;
    //   13: invokevirtual 41	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   16: aload_0
    //   17: getfield 15	com/duapps/dap/stats/t:a	Landroid/content/Context;
    //   20: bipush 7
    //   22: invokestatic 46	com/duapps/dap/stats/cp/DuAdMbjCacheProvider:a	(Landroid/content/Context;I)Landroid/net/Uri;
    //   25: iconst_1
    ...
    //   35: aconst_null
    //   36: aconst_null
    //   37: invokevirtual 98	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   40: astore 4
    //   42: aload 4
    //   44: ifnull +53 -> 97
    //   47: aload 4
    ...
    //   255: ldc 125
    //   257: aload 5
    //   259: invokestatic 71	com/duapps/dap/base/g:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   262: aload 4
    //   264: ifnull -145 -> 119
    //   267: aload 4
    ...
    //   440: astore_1
    //   441: aload_0
    //   442: getfield 15	com/duapps/dap/stats/t:a	Landroid/content/Context;
    //   445: invokevirtual 41	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   448: aload_0
    //   449: getfield 15	com/duapps/dap/stats/t:a	Landroid/content/Context;
    //   452: bipush 7
    //   454: invokestatic 46	com/duapps/dap/stats/cp/DuAdMbjCacheProvider:a	(Landroid/content/Context;I)Landroid/net/Uri;
    //   457: aload_1
    //   458: aconst_null
    ...
    //   467: ldc_w 257
    //   470: aload_1
    //   471: invokestatic 71	com/duapps/dap/base/g:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   474: return
    //   475: astore_1
    //   476: ldc 64
    //   478: ldc_w 259
    //   481: aload_1
    //   482: invokestatic 71	com/duapps/dap/base/g:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   485: return
    //   486: astore_1
    //   487: goto -197 -> 290
    //   490: astore 5
  ...
  public void b(v paramV)
  {
    ...
    try
    {
      if (this.a.getContentResolver().update(DuAdMbjCacheProvider.a(this.a, 7), localContentValues, "_url = ?", new String[] { paramV }) <= 0) {
        this.a.getContentResolver().insert(DuAdMbjCacheProvider.a(this.a, 7), localContentValues);
      }
      return;
    }
    catch (Exception paramV)
  ...
  public int c(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 15	com/duapps/dap/stats/t:a	Landroid/content/Context;
    //   4: invokestatic 131	com/duapps/dap/base/ac:y	(Landroid/content/Context;)J
    //   7: lstore_3
    //   8: invokestatic 37	java/lang/System:currentTimeMillis	()J
    //   11: lstore 5
    //   13: aload_0
    //   14: getfield 15	com/duapps/dap/stats/t:a	Landroid/content/Context;
    //   17: invokevirtual 41	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   20: aload_0
    //   21: getfield 15	com/duapps/dap/stats/t:a	Landroid/content/Context;
    //   24: bipush 7
    //   26: invokestatic 46	com/duapps/dap/stats/cp/DuAdMbjCacheProvider:a	(Landroid/content/Context;I)Landroid/net/Uri;
    //   29: iconst_1
    ...
    //   58: aastore
    //   59: ldc 94
    //   61: invokevirtual 98	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   64: astore 7
    //   66: aload 7
    //   68: ifnull +131 -> 199
    //   71: aload 7
    ...
    //   130: ldc -74
    //   132: aload 8
    //   134: invokestatic 71	com/duapps/dap/base/g:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   137: aload 7
    //   139: ifnull +58 -> 197
    //   142: aload 7
  ...
  public v d(String paramString)
  {
    ...
    //   9: aload 8
    //   11: aload_1
    //   12: putfield 110	com/duapps/dap/base/v:b	Ljava/lang/String;
    //   15: aload 8
    //   17: iconst_0
    //   18: putfield 82	com/duapps/dap/base/v:c	I
    //   21: aload_0
    //   22: getfield 15	com/duapps/dap/stats/t:a	Landroid/content/Context;
    //   25: invokestatic 131	com/duapps/dap/base/ac:y	(Landroid/content/Context;)J
    //   28: lstore_2
    //   29: invokestatic 37	java/lang/System:currentTimeMillis	()J
    //   32: lstore 4
    //   34: aload_0
    //   35: getfield 15	com/duapps/dap/stats/t:a	Landroid/content/Context;
    //   38: invokevirtual 41	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   41: aload_0
    //   42: getfield 15	com/duapps/dap/stats/t:a	Landroid/content/Context;
    //   45: bipush 7
    //   47: invokestatic 46	com/duapps/dap/stats/cp/DuAdMbjCacheProvider:a	(Landroid/content/Context;I)Landroid/net/Uri;
    //   50: iconst_4
    ...
    //   94: aastore
    //   95: ldc 94
    //   97: invokevirtual 98	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   100: astore 6
    //   102: aload 6
    //   104: ifnull +80 -> 184
    //   107: aload 6
    ...
    //   133: putfield 78	com/duapps/dap/base/v:a	Ljava/lang/String;
    //   136: aload 6
    //   138: astore_1
    //   139: aload 8
    //   141: aload 6
    //   143: iconst_1
    //   144: invokeinterface 108 2 0
    //   149: putfield 110	com/duapps/dap/base/v:b	Ljava/lang/String;
    //   152: aload 6
    //   154: astore_1
    //   155: aload 8
    //   157: aload 6
    //   159: iconst_2
    //   160: invokeinterface 108 2 0
    //   165: putfield 113	com/duapps/dap/base/v:d	Ljava/lang/String;
    //   168: aload 6
    //   170: astore_1
    //   171: aload 8
    //   173: aload 6
    ...
    //   181: putfield 82	com/duapps/dap/base/v:c	I
    //   184: aload 6
    //   186: ifnull +20 -> 206
    //   189: aload 6
    ...
    //   219: ldc 125
    //   221: aload 7
    //   223: invokestatic 71	com/duapps/dap/base/g:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   226: aload 6
    //   228: ifnull -22 -> 206
    //   231: aload 6
