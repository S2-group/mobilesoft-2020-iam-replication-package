...
public abstract class OfferProvider
{
  ...
  {
    (List)new Gson().a(paramString, new TypeToken() {}.getType());
  }
  ...
  protected String getCountryCode()
  {
    try
    {
      JSONResponse localJSONResponse1 = (JSONResponse)f.a(AdManager.getAdManagerCallback().getActivity(), "jsonResponse", JSONResponse.class);
  ...
  {
    new Gson().a(paramList, new TypeToken() {}.getType());
  }
    ...
    implements NonObfuscatable
  {
    ...
    private void cacheImg(byte[] paramArrayOfByte)
    {
      ...
      //   89: goto -45 -> 44
      //   92: astore_1
      //   93: invokestatic 93	com/outfit7/talkingfriends/offers/OfferProvider:a	()Ljava/lang/String;
      //   96: pop
      ...
      //   116: athrow
      //   117: astore_1
      //   118: invokestatic 93	com/outfit7/talkingfriends/offers/OfferProvider:a	()Ljava/lang/String;
      //   121: pop
    ...
    private byte[] downloadBitmap()
    {
      ...
      //   207: areturn
      //   208: astore_2
      //   209: invokestatic 93	com/outfit7/talkingfriends/offers/OfferProvider:a	()Ljava/lang/String;
      //   212: pop
    ...
    private byte[] getCachedImg()
    {
      ...
      //   207: aload 6
      //   209: astore 5
      //   211: invokestatic 93	com/outfit7/talkingfriends/offers/OfferProvider:a	()Ljava/lang/String;
      //   214: pop
      ...
      //   240: aload 5
      //   242: astore 6
      //   244: invokestatic 93	com/outfit7/talkingfriends/offers/OfferProvider:a	()Ljava/lang/String;
      //   247: pop
      //   248: aload 5
      //   250: astore 6
