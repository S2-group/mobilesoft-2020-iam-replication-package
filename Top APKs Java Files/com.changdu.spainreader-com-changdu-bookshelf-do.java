...
public class do
{
  ...
  public static Intent a(Context paramContext, boolean paramBoolean)
  {
    ...
    localIntent.putExtra("android.intent.extra.shortcut.ICON_RESOURCE", Intent.ShortcutIconResource.fromContext(paramContext, 2131166150));
    return localIntent;
  }
  ...
  {
    String str = paramContext.getString(2131558810);
    if (paramFile != null)
    {
  ...
  public static ArrayList<dc.a> a(ArrayList<dc.a> paramArrayList, String paramString)
  {
    ...
    a(paramString.replace(br.v, com.changdu.changdulib.e.c.b.f()), localArrayList1, localArrayList2);
  ...
  public static void a(Context paramContext)
  {
    ...
    localIntent1.putExtra("android.intent.extra.shortcut.NAME", paramContext.getString(2131558481));
  ...
  public static void a(Context paramContext, File paramFile)
  {
    ...
    Toast.makeText(paramContext, 2131558960, 0).show();
  }
  ...
  {
    // Byte code:
    //   0: invokestatic 586	com/changdu/setting/bo:V	()Lcom/changdu/setting/bo;
    //   3: invokevirtual 841	com/changdu/setting/bo:t	()I
    //   6: istore_3
    //   7: aconst_null
    //   8: astore 5
    //   10: aconst_null
    ...
    //   13: aload_0
    //   14: iload_3
    //   15: invokestatic 846	com/changdu/browser/filebrowser/ad:a	(Ljava/lang/String;I)Lcom/changdu/browser/a/e;
    //   18: astore_0
    //   19: aload_1
    //   20: ifnull +18 -> 38
    //   23: aload_1
    //   24: invokevirtual 580	java/util/ArrayList:isEmpty	()Z
    //   27: ifne +11 -> 38
    //   30: aload_1
    //   31: aload_0
    //   32: invokestatic 852	java/util/Collections:sort	(Ljava/util/List;Ljava/util/Comparator;)V
    //   35: goto +3 -> 38
    //   38: aload_2
    //   39: ifnull +15 -> 54
    //   42: aload_2
    //   43: invokevirtual 580	java/util/ArrayList:isEmpty	()Z
    //   46: ifne +8 -> 54
    //   49: aload_2
    //   50: aload_0
    //   51: invokestatic 852	java/util/Collections:sort	(Ljava/util/List;Ljava/util/Comparator;)V
    //   54: aload_0
    //   55: ifnull +38 -> 93
    //   58: aload_0
    //   59: invokeinterface 856 1 0
    //   64: return
    //   65: astore_1
    //   66: aload 4
    //   68: astore_0
    ...
    //   84: ifnull +9 -> 93
    //   87: aload_0
    //   88: invokeinterface 856 1 0
    //   93: return
    //   94: aload_0
    //   95: ifnull +9 -> 104
    //   98: aload_0
    //   99: invokeinterface 856 1 0
    //   104: aload_1
    //   105: athrow
    //   106: astore_1
    //   107: goto -13 -> 94
  ...
  public static void a(ArrayList<dc.a> paramArrayList)
  {
    ...
    while (i < paramArrayList.size())
    {
      ...
      {
        String str = localA.m;
        if ((localA.d()) && (br.v.equals(localA.g)))
        {
          Object localObject = b(br.v, localA.m, localE);
          if (!str.equals(localObject))
          {
            localA.m = ((String)localObject);
            paramArrayList.set(i, localA);
            localObject = new StringBuilder();
            ((StringBuilder)localObject).append(br.v);
  ...
  public static void b(ArrayList<File> paramArrayList)
  {
    ...
    //   64: aload_2
    //   65: ldc_w 1227
    //   68: invokevirtual 1045	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   71: ifeq +13 -> 84
    //   74: aload_3
      ...
      try
      {
        if (paramArrayList.size() > 0)
        {
          ...
          if (i < paramArrayList.size())
          {
            ...
            if (localA.f().getName().split("\\.")[0].equals(ApplicationInit.h.getString(2131558481)))
            {
  ...
  public static boolean c(Context paramContext)
  {
    ...
    boolean bool2 = false;
    paramContext = paramContext.getString(2131558481);
  ...
  public static String j(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokestatic 1310	com/changdu/bookshelf/do:i	(Ljava/lang/String;)Z
    //   4: istore_1
    //   5: aconst_null
    //   6: astore_3
    //   7: iload_1
    ...
    //   13: aload_0
    //   14: ldc_w 1011
    //   17: invokestatic 1312	com/changdu/bookshelf/do:c	(Ljava/lang/String;Ljava/lang/String;)Z
    //   20: ifeq +299 -> 319
    //   23: aload_0
    ...
    //   97: ifne +704 -> 801
    //   100: invokestatic 1316	com/changdu/changdulib/parser/ndb/l:b	()V
    //   103: aload_0
    //   104: invokestatic 1319	com/changdu/changdulib/parser/ndb/l:a	(Ljava/lang/String;)Lcom/changdu/changdulib/parser/ndb/l;
    //   107: astore_2
    //   108: aload_2
    //   109: ifnull +208 -> 317
    //   112: aload_2
    //   113: invokevirtual 1321	com/changdu/changdulib/parser/ndb/l:v	()Z
    //   116: ifne +5 -> 121
    //   119: aconst_null
    //   120: areturn
    //   121: aload_2
    //   122: invokevirtual 1322	com/changdu/changdulib/parser/ndb/l:u	()I
    //   125: iconst_1
    //   126: if_icmpne +58 -> 184
    //   129: aload_2
    //   130: invokevirtual 1325	com/changdu/changdulib/parser/ndb/l:a	()Lcom/changdu/changdulib/parser/ndb/a/n;
    //   133: astore 5
    //   135: aload_3
    //   136: astore_2
    //   137: aload 5
    //   139: ifnull +662 -> 801
    //   142: aload 5
    //   144: invokevirtual 1330	com/changdu/changdulib/parser/ndb/a/n:p	()Ljava/lang/String;
    //   147: astore_2
    ...
    //   185: bipush 109
    //   187: sipush 150
    //   190: invokevirtual 1333	com/changdu/changdulib/parser/ndb/l:a	(II)Landroid/graphics/drawable/Drawable;
    //   193: astore 5
    //   195: aload_3
    //   196: astore_2
    //   197: aload 5
    ...
    //   319: aload_0
    //   320: ldc_w 1335
    //   323: invokestatic 1312	com/changdu/bookshelf/do:c	(Ljava/lang/String;Ljava/lang/String;)Z
    //   326: ifeq +130 -> 456
    //   329: aload_0
    ...
    //   354: aload_2
    //   355: aload 5
    //   357: invokevirtual 1338	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   360: pop
    //   361: aload_2
    //   362: ldc_w 1209
    ...
    //   401: ifne +400 -> 801
    //   404: new 1340	com/changdu/changdulib/parser/b/g
    //   407: dup
    //   408: invokespecial 1341	com/changdu/changdulib/parser/b/g:<init>	()V
    //   411: astore_2
    //   412: aload_2
    //   413: aload_0
    //   414: invokevirtual 1342	com/changdu/changdulib/parser/b/g:a	(Ljava/lang/String;)Z
    //   417: pop
    //   418: aload_2
    //   419: aload 4
    //   421: ldc_w 1303
    //   424: ldc_w 473
    //   427: invokevirtual 566	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   430: invokevirtual 1343	com/changdu/changdulib/parser/b/g:b	(Ljava/lang/String;)Z
    //   433: istore_1
    //   434: aload 4
    //   436: astore_2
    //   437: iload_1
    ...
    //   456: aload_0
    //   457: ldc_w 1345
    //   460: invokestatic 1312	com/changdu/bookshelf/do:c	(Ljava/lang/String;Ljava/lang/String;)Z
    //   463: ifeq +128 -> 591
    //   466: aload_0
    ...
    //   545: iconst_0
    //   546: invokestatic 1350	com/changdu/bookread/epub/h:a	(Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    //   549: astore_2
    //   550: aload_2
    //   551: ifnull +37 -> 588
    ...
    //   591: aload_0
    //   592: ldc_w 436
    //   595: invokestatic 1312	com/changdu/bookshelf/do:c	(Ljava/lang/String;Ljava/lang/String;)Z
    //   598: ifeq +97 -> 695
    //   601: aload_0
    ...
    //   680: aload_0
    //   681: aload 4
    //   683: invokestatic 1351	com/changdu/bookread/a/a:a	(Ljava/lang/String;Ljava/lang/String;)Z
    //   686: ifeq +115 -> 801
    //   689: aload 4
    //   691: astore_2
    //   692: goto +109 -> 801
    ...
    //   697: aload_0
    //   698: ldc_w 1353
    //   701: invokestatic 1312	com/changdu/bookshelf/do:c	(Ljava/lang/String;Ljava/lang/String;)Z
    //   704: ifeq +97 -> 801
    //   707: aload_0
    ...
    //   790: aload_0
    //   791: aload_3
    //   792: invokestatic 1355	com/changdu/bookshelf/do:a	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   795: astore_2
    //   796: goto +5 -> 801
    //   799: aconst_null
    //   800: areturn
    ...
    //   860: ifne +21 -> 881
    //   863: new 712	java/io/FileOutputStream
    //   866: dup
    //   867: aload_0
    //   868: invokespecial 715	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   871: invokevirtual 733	java/io/FileOutputStream:close	()V
    //   874: aload_2
    //   875: areturn
    //   876: astore_0
    //   877: aload_0
