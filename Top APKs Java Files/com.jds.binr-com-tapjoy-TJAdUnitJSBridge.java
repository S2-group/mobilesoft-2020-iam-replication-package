  ...
  implements TJWebViewJSInterfaceListener
{
  ...
  public void alert(JSONObject paramJSONObject, final String paramString)
  {
    ...
    //   5: dup
    //   6: ldc -59
    //   8: invokespecial 200	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   11: aload_1
    //   12: invokevirtual 204	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   15: invokevirtual 208	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   18: invokestatic 210	com/tapjoy/TapjoyLog:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   21: ldc -44
    //   23: astore 6
    //   25: aload_1
    //   26: ldc -42
    //   28: invokevirtual 220	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   31: astore 5
    //   33: aload 5
    //   35: astore 6
    //   37: aload_1
    //   38: ldc -34
    //   40: invokevirtual 220	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   43: astore 7
    //   45: aload 7
    //   47: astore 6
    //   49: aload_1
    //   50: ldc -32
    //   52: invokevirtual 228	org/json/JSONObject:getJSONArray	(Ljava/lang/String;)Lorg/json/JSONArray;
    //   55: astore_1
    //   56: aload_0
    //   57: getfield 186	com/tapjoy/TJAdUnitJSBridge:g	Lcom/tapjoy/TJAdUnitActivity;
    //   60: astore 7
    //   62: aload 7
    //   64: ifnull +224 -> 288
    //   67: new 230	android/app/AlertDialog$Builder
    //   70: dup
    //   71: aload 7
    //   73: invokespecial 233	android/app/AlertDialog$Builder:<init>	(Landroid/content/Context;)V
    //   76: aload 5
    //   78: invokevirtual 237	android/app/AlertDialog$Builder:setTitle	(Ljava/lang/CharSequence;)Landroid/app/AlertDialog$Builder;
    //   81: aload 6
    //   83: invokevirtual 240	android/app/AlertDialog$Builder:setMessage	(Ljava/lang/CharSequence;)Landroid/app/AlertDialog$Builder;
    //   86: invokevirtual 244	android/app/AlertDialog$Builder:create	()Landroid/app/AlertDialog;
    //   89: astore 5
    //   91: aload_1
    //   92: ifnull +10 -> 102
    //   95: aload_1
    //   96: invokevirtual 250	org/json/JSONArray:length	()I
    //   99: ifne +56 -> 155
    //   102: aload_0
    //   103: aload_2
    //   104: iconst_1
    ...
    //   108: dup
    //   109: iconst_0
    //   110: getstatic 256	java/lang/Boolean:FALSE	Ljava/lang/Boolean;
    //   113: aastore
    //   114: invokevirtual 260	com/tapjoy/TJAdUnitJSBridge:invokeJSCallback	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   117: return
    //   118: astore_1
    //   119: ldc -44
    //   121: astore 7
    ...
    //   137: dup
    //   138: iconst_0
    //   139: getstatic 256	java/lang/Boolean:FALSE	Ljava/lang/Boolean;
    //   142: aastore
    //   143: invokevirtual 260	com/tapjoy/TJAdUnitJSBridge:invokeJSCallback	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   146: aload_1
    //   147: invokevirtual 263	java/lang/Exception:printStackTrace	()V
    //   150: aconst_null
    //   151: astore_1
    //   152: goto -96 -> 56
    //   155: new 265	java/util/ArrayList
    //   158: dup
    //   159: invokespecial 266	java/util/ArrayList:<init>	()V
    //   162: astore 6
    //   164: iconst_0
    //   165: istore 4
    //   167: iload 4
    //   169: aload_1
    //   170: invokevirtual 250	org/json/JSONArray:length	()I
    ...
    //   204: aload_1
    //   205: iload 4
    //   207: invokevirtual 269	org/json/JSONArray:getString	(I)Ljava/lang/String;
    ...
    //   217: aload 6
    //   219: iload 4
    //   221: invokevirtual 277	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   224: checkcast 279	java/lang/CharSequence
    //   227: new 8	com/tapjoy/TJAdUnitJSBridge$1
    //   230: dup
    //   231: aload_0
    //   232: aload_2
    //   233: invokespecial 282	com/tapjoy/TJAdUnitJSBridge$1:<init>	(Lcom/tapjoy/TJAdUnitJSBridge;Ljava/lang/String;)V
    //   236: invokevirtual 288	android/app/AlertDialog:setButton	(ILjava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)V
    //   239: iload 4
    //   241: iconst_1
    //   242: iadd
    //   243: istore 4
    ...
    //   260: astore 7
    //   262: aload 7
    //   264: invokevirtual 263	java/lang/Exception:printStackTrace	()V
    //   267: goto -53 -> 214
    //   270: aload 5
    //   272: iconst_0
    //   273: invokevirtual 291	android/app/AlertDialog:setCancelable	(Z)V
    //   276: aload 5
    //   278: iconst_0
    //   279: invokevirtual 294	android/app/AlertDialog:setCanceledOnTouchOutside	(Z)V
    //   282: aload 5
    //   284: invokevirtual 297	android/app/AlertDialog:show	()V
    //   287: return
    //   288: ldc 116
    //   290: ldc_w 299
    //   293: invokestatic 210	com/tapjoy/TapjoyLog:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   296: return
    //   297: astore_1
    //   298: goto -167 -> 131
  ...
  public void present(JSONObject paramJSONObject, String paramString)
  {
    // Byte code:
    //   0: iconst_0
    //   1: invokestatic 319	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   4: astore_3
    //   5: aload_1
    //   6: ldc_w 933
    //   9: invokevirtual 220	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   12: invokestatic 936	java/lang/Boolean:valueOf	(Ljava/lang/String;)Ljava/lang/Boolean;
    //   15: astore 5
    //   17: aload_1
    //   18: ldc_w 938
    //   21: invokevirtual 220	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   24: invokestatic 936	java/lang/Boolean:valueOf	(Ljava/lang/String;)Ljava/lang/Boolean;
    //   27: astore 4
    //   29: aload 4
    //   31: astore_3
    //   32: aload_0
    ...
    //   40: invokestatic 936	java/lang/Boolean:valueOf	(Ljava/lang/String;)Ljava/lang/Boolean;
    //   43: invokevirtual 942	java/lang/Boolean:booleanValue	()Z
    ...
    //   58: invokespecial 945	com/tapjoy/TJAdUnitJSBridge$a:<init>	(Lcom/tapjoy/TJAdUnitJSBridge;Landroid/webkit/WebView;)V
    //   61: iconst_2
    //   62: anewarray 252	java/lang/Boolean
    //   65: dup
    //   66: iconst_0
    //   67: aload 5
    //   69: aastore
    ...
    //   72: aload_3
    //   73: aastore
    //   74: invokevirtual 949	com/tapjoy/TJAdUnitJSBridge$a:execute	([Ljava/lang/Object;)Landroid/os/AsyncTask;
    //   77: pop
    //   78: aload_0
    //   79: aload_2
    //   80: iconst_1
    ...
    //   84: dup
    //   85: iconst_0
    //   86: getstatic 414	java/lang/Boolean:TRUE	Ljava/lang/Boolean;
    //   89: aastore
    //   90: invokevirtual 260	com/tapjoy/TJAdUnitJSBridge:invokeJSCallback	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   93: return
    //   94: astore_1
    //   95: aload_0
    //   96: aload_2
    ...
    //   101: dup
    //   102: iconst_0
    //   103: getstatic 256	java/lang/Boolean:FALSE	Ljava/lang/Boolean;
    //   106: aastore
    //   107: invokevirtual 260	com/tapjoy/TJAdUnitJSBridge:invokeJSCallback	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   110: aload_1
    //   111: invokevirtual 263	java/lang/Exception:printStackTrace	()V
    //   114: return
    //   115: astore_1
    //   116: goto -67 -> 49
    //   119: astore 4
