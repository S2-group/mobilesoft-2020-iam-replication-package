  ...
  extends AsyncTask<Object, Object, List<a>>
{
  ...
  {
    paramList = new ArrayAdapter(this.c, 2131296256, 2131165232, paramList)
    {
      public View getView(int paramAnonymousInt, View paramAnonymousView, ViewGroup paramAnonymousViewGroup)
      {
        ...
        if (paramAnonymousViewGroup != null) {
          ((ImageView)paramAnonymousView.findViewById(2131165231)).setImageDrawable(paramAnonymousViewGroup);
        }
