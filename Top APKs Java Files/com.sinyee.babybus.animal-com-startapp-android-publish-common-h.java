...
public class h
{
  ...
  private static void b(List<PackageInfo> paramList)
  {
    if (Build.VERSION.SDK_INT >= 9) {
      Collections.sort(paramList, new h.1());
    }
  }
  ...
  public static Pair<String, String> c(Context paramContext)
  {
    ...
    try
    {
      if ((q.a()) || (!com.startapp.android.publish.adsCommon.adinformation.a.b().a().g().a(paramContext)))
      {
  ...
  {
    if ((q.a()) || (com.startapp.android.publish.adsCommon.adinformation.a.b().a().g().b(paramContext)))
    {
