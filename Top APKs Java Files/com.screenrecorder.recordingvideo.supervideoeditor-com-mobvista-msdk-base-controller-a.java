...
public class a
{
  ...
  public final List<String> m()
  {
    try
    {
      ...
      m = 0;
      localList2 = ((PackageManager)localObject).getInstalledPackages(0);
    }
    catch (Exception localException)
    {
      for (;;)
    ...
    {
      if ((((PackageInfo)localList2.get(m)).applicationInfo.flags & 0x1) <= 0) {
        localObject = b;
      }
      for (localPackageInfo = (PackageInfo)localList2.get(m);; localPackageInfo = (PackageInfo)localList2.get(m))
      {
        ((List)localObject).add(localPackageInfo.packageName);
        break;
        if ((localList1 == null) || (localList1.size() <= 0) || (!localList1.contains(((PackageInfo)localList2.get(m)).packageName))) {
          break;
        }
        localObject = b;
      }
  ...
  public final class a
  {
    ...
    public final a a(Context paramContext)
    {
      ...
      //   29: pop
      //   30: new 11	com/mobvista/msdk/base/controller/a$a$b
      //   33: dup
      //   34: aload_0
      //   35: iconst_0
      //   36: invokespecial 60	com/mobvista/msdk/base/controller/a$a$b:<init>	(Lcom/mobvista/msdk/base/controller/a$a;B)V
      //   39: astore_2
      ...
      //   64: ifeq +54 -> 118
      //   67: new 14	com/mobvista/msdk/base/controller/a$a$c
      //   70: dup
      //   71: aload_0
      //   72: aload_2
      //   73: invokevirtual 78	com/mobvista/msdk/base/controller/a$a$b:a	()Landroid/os/IBinder;
      //   76: invokespecial 81	com/mobvista/msdk/base/controller/a$a$c:<init>	(Lcom/mobvista/msdk/base/controller/a$a;Landroid/os/IBinder;)V
      //   79: astore_3
      //   80: new 9	com/mobvista/msdk/base/controller/a$a$a
      //   83: dup
      //   84: aload_0
      //   85: aload_3
      //   86: invokevirtual 84	com/mobvista/msdk/base/controller/a$a$c:a	()Ljava/lang/String;
      //   89: aload_3
      //   90: invokevirtual 87	com/mobvista/msdk/base/controller/a$a$c:b	()Z
      //   93: invokespecial 90	com/mobvista/msdk/base/controller/a$a$a:<init>	(Lcom/mobvista/msdk/base/controller/a$a;Ljava/lang/String;Z)V
      //   96: astore_3
      //   97: aload_1
      //   98: aload_2
