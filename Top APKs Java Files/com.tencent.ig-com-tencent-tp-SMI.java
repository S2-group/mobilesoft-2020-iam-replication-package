  ...
  implements d
{
  ...
  public String a(Context paramContext)
  {
    ...
    if (!n.a(paramContext, "android.permission.READ_PHONE_STATE"))
    {
      b = "NO_PERMISSION_MANIFEST";
      return b;
    }
    if (!n.b(paramContext, "android.permission.READ_PHONE_STATE"))
    {
  ...
  public String e(Context paramContext)
  {
    ...
    if ((Build.VERSION.SDK_INT >= 23) && (!n.b(paramContext, "android.permission.READ_PHONE_STATE")))
    {
  ...
  public String l(Context paramContext)
  {
    ...
    try
    {
      ...
      paramContext = v.a(localPackageInfo.signatures[0].toByteArray()) + "(" + paramContext + ")";
      return paramContext;
    }
    catch (Throwable paramContext) {}
    return null;
