  ...
  extends Activity
{
  ...
  public int getNewNum(ArrayList<GiftEntity> paramArrayList)
  {
    ...
    if (paramArrayList != null)
    {
      ...
      for (;;)
      {
        ...
        int k = j;
        if (!localSharedPreferences.getBoolean(((GiftEntity)paramArrayList.get(i)).getPackageName(), false)) {
          k = j + 1;
        }
        i += 1;
        j = k;
  ...
  public String getPDAServerData(String paramString)
  {
    DefaultHttpClient localDefaultHttpClient = new DefaultHttpClient();
    try
    {
      paramString = localDefaultHttpClient.execute(new HttpPost(new URI(paramString)));
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    if (!AppWallConfig.isFirstTimeInApp(this))
    {
      ...
      localNetMusicXmlParseTask.execute(new String[] { localObject + str });
    ...
    if (paramArrayList != null)
    {
      ...
      for (;;)
      {
        ...
        if (!isAvilible(this, ((GiftEntity)paramArrayList.get(i)).getPackageName())) {
          ((ArrayList)localObject).add((GiftEntity)paramArrayList.get(i));
        }
        i += 1;
        break;
        label220:
