...
public final class apd
{
  ...
  static aov a(Context paramContext)
  {
    if (a != null) {
      return a;
    }
    String str2 = apa.a(paramContext);
    String str1;
    if (str2 != null)
    {
      str1 = str2;
    ...
    try
    {
      a = (aov)new Gson().fromJson(str1, aov.class);
      return a;
    }
  ...
  private static String d(Context paramContext)
  {
    ...
    //   19: astore_2
    //   20: aload_0
    //   21: invokevirtual 178	android/content/Context:getAssets	()Landroid/content/res/AssetManager;
    //   24: getstatic 107	com/apd:b	Ljava/lang/String;
    //   27: invokevirtual 184	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   30: astore_0
    //   31: aload_0
    //   32: aload 5
    //   34: invokevirtual 190	java/io/InputStream:read	([B)I
    //   37: istore_1
    //   38: iload_1
    //   39: iconst_m1
    //   40: if_icmpeq +15 -> 55
    ...
    //   47: iconst_0
    //   48: iload_1
    //   49: invokevirtual 194	java/io/ByteArrayOutputStream:write	([BII)V
    //   52: goto -21 -> 31
    //   55: aload 4
    //   57: ldc 61
    //   59: invokevirtual 197	java/io/ByteArrayOutputStream:toString	(Ljava/lang/String;)Ljava/lang/String;
    //   62: astore_2
    //   63: aload 4
    //   65: invokevirtual 200	java/io/ByteArrayOutputStream:close	()V
    //   68: aload_0
    //   69: ifnull +14 -> 83
    //   72: aload_0
    //   73: invokevirtual 201	java/io/InputStream:close	()V
    //   76: aload_2
    //   77: areturn
    //   78: astore_0
    //   79: aload_0
    ...
    //   107: astore_2
    //   108: aload_3
    //   109: invokevirtual 204	java/io/IOException:printStackTrace	()V
    //   112: aload 4
    //   114: invokevirtual 200	java/io/ByteArrayOutputStream:close	()V
    //   117: aload_0
    //   118: ifnull +15 -> 133
    //   121: aload_0
    //   122: invokevirtual 201	java/io/InputStream:close	()V
    //   125: goto +8 -> 133
    //   128: astore_0
    //   129: aload_0
    ...
    //   135: areturn
    //   136: aload 4
    //   138: invokevirtual 200	java/io/ByteArrayOutputStream:close	()V
    //   141: aload_0
    //   142: ifnull +15 -> 157
    //   145: aload_0
    //   146: invokevirtual 201	java/io/InputStream:close	()V
    //   149: goto +8 -> 157
    //   152: astore_0
    //   153: aload_0
    //   154: invokevirtual 204	java/io/IOException:printStackTrace	()V
    //   157: aload_2
    //   158: athrow
