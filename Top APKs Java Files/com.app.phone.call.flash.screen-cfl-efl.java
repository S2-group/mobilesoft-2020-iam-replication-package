...
public final class efl
{
  public static <T extends HSAppRunningInfo> List<T> a(Class<T> paramClass, HSAppFilter paramHSAppFilter)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject2 = ((HSAppRunningInfo)paramHSAppFilter.next()).getPidArray();
      ...
      if (Build.VERSION.SDK_INT >= 21) {
        paramClass = d(paramClass, (HSAppFilter)localObject1);
      } else {
        paramClass = c(paramClass, (HSAppFilter)localObject1);
      }
    }
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      j = localHSAppRunningInfo.getPidArray().length;
      ...
      if (j > 0)
      {
        ...
        if (i < j)
        {
          k = localHSAppRunningInfo.getPidArray()[i];
      ...
      localHSAppRunningInfo.setPidMemoryWeightArray(paramHSAppFilter);
    }
    return paramClass;
  }
  ...
  private static <T extends HSAppRunningInfo> List<T> b(Class<T> paramClass, HSAppFilter paramHSAppFilter)
  {
    ...
    paramClass = AppInfoProvider.a(paramClass, new HSAppFilter().ignoreMustExcludeList());
    Object localObject1 = ecl.i().getPackageManager().getInstalledPackages(128);
    Object localObject2 = paramClass.iterator();
    while (((Iterator)localObject2).hasNext())
    {
      HSAppRunningInfo localHSAppRunningInfo = (HSAppRunningInfo)((Iterator)localObject2).next();
    ...
    try
    {
      localObject2 = een.a(Uri.parse("content://" + ecl.i().getPackageName() + ".recent_app/"), "METHOD_GET_RECENT_APP_LIST", null).getStringArrayList("EXTRA_RECENT_APP_LIST");
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        dpi.a(localException);
      }
    }
    paramHSAppFilter.excludeSystem();
    paramClass = paramClass.iterator();
    while (paramClass.hasNext())
    {
      localObject2 = (HSAppRunningInfo)paramClass.next();
      ((HSAppRunningInfo)localObject2).setPidArray(new int[0]);
      ((HSAppRunningInfo)localObject2).setIsMusicPlayer(efm.a((HSAppRunningInfo)localObject2));
      ((HSAppRunningInfo)localObject2).setIsRecentApp(((Set)localObject1).contains(((HSAppRunningInfo)localObject2).getPackageName()));
      if (paramHSAppFilter.apply((HSAppFilter.a)localObject2)) {
  ...
  {
    ArrayList localArrayList = new ArrayList();
    Object localObject1 = (ActivityManager)ecl.i().getSystemService("activity");
    ...
    try
    {
      localObject3 = een.a(Uri.parse("content://" + ecl.i().getPackageName() + ".recent_app/"), "METHOD_GET_RECENT_APP_LIST", null).getStringArrayList("EXTRA_RECENT_APP_LIST");
        ...
        if (localObject5 != null)
        {
          ...
          while (((Iterator)localObject6).hasNext())
          {
            ...
            if (localRunningAppProcessInfo.processName.equalsIgnoreCase((String)localObject4)) {
              ((HSAppRunningInfo)localObject5).setMainPid(localRunningAppProcessInfo.pid);
            }
            localSparseIntArray.put(localRunningAppProcessInfo.pid, localRunningAppProcessInfo.pid);
            ((HSAppRunningInfo)localObject5).serviceCompList.add(localRunningAppProcessInfo.importanceReasonComponent);
          }
          ((HSAppRunningInfo)localObject5).setPidArray(efp.a(localSparseIntArray));
          ((HSAppRunningInfo)localObject5).setIsMusicPlayer(efm.a((HSAppRunningInfo)localObject5));
          ((HSAppRunningInfo)localObject5).setIsRecentApp(((Set)localObject2).contains(((HSAppRunningInfo)localObject5).getPackageName()));
          if (paramHSAppFilter.apply((HSAppFilter.a)localObject5)) {
            localArrayList.add(localObject5);
          }
        }
      }
    }
    Object localObject3 = AppInfoProvider.a(paramClass, new HSAppFilter().ignoreMustExcludeList());
  ...
  private static <T extends HSAppRunningInfo> List<T> d(Class<T> paramClass, HSAppFilter paramHSAppFilter)
  {
    ...
    for (;;)
    {
      ...
      if (((Iterator)localObject4).hasNext())
      {
        ...
        if ((localHSAppRunningInfo == null) || (efm.a(localHSAppRunningInfo, localArrayList))) {
          continue;
        }
      ...
      try
      {
        if (paramClass.process.equalsIgnoreCase((String)localObject5)) {
          localHSAppRunningInfo.setMainPid(paramClass.pid);
        }
        localSparseIntArray.put(paramClass.pid, paramClass.pid);
        localHSAppRunningInfo.serviceCompList.add(paramClass.service);
      }
      catch (Exception paramClass)
      {
        dpi.a(paramClass);
        break label404;
        localHSAppRunningInfo.setPidArray(efp.a(localSparseIntArray));
        localHSAppRunningInfo.setIsMusicPlayer(efm.a(localHSAppRunningInfo));
        localHSAppRunningInfo.setIsRecentApp(((Set)localObject2).contains(localHSAppRunningInfo.getPackageName()));
        if (!paramHSAppFilter.apply(localHSAppRunningInfo)) {
          continue;
        }
        ...
        {
          paramClass = efq.a().iterator();
          while (paramClass.hasNext())
          {
            localObject1 = (AndroidAppProcess)paramClass.next();
            localObject4 = (HSAppRunningInfo)localException.get(((AndroidAppProcess)localObject1).getPackageName());
            if (localObject4 != null)
            {
              if (((AndroidAppProcess)localObject1).name.equalsIgnoreCase(((HSAppRunningInfo)localObject4).getPackageName())) {
                ((HSAppRunningInfo)localObject4).setMainPid(((AndroidAppProcess)localObject1).pid);
              }
              localObject5 = efp.a(((HSAppRunningInfo)localObject4).getPidArray());
              ((SparseIntArray)localObject5).put(((AndroidAppProcess)localObject1).pid, ((AndroidAppProcess)localObject1).pid);
              ((HSAppRunningInfo)localObject4).setPidArray(efp.a((SparseIntArray)localObject5));
              ((HSAppRunningInfo)localObject4).setIsMusicPlayer(efm.a((HSAppRunningInfo)localObject4));
              ((HSAppRunningInfo)localObject4).setIsRecentApp(((Set)localObject2).contains(((HSAppRunningInfo)localObject4).getPackageName()));
              if (paramHSAppFilter.apply((HSAppFilter.a)localObject4))
              {
