...
import com.sticker.gif.crazy.launcher.dwz;
import com.sticker.gif.crazy.launcher.eeh;
import com.sticker.gif.crazy.launcher.egr;
import com.sticker.gif.crazy.launcher.eu;
...
public class SUtils
{
  ...
  public static byte[] b(Context paramContext, String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 97	android/content/Context:getAssets	()Landroid/content/res/AssetManager;
    //   4: aload_1
    //   5: invokevirtual 103	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   8: astore_1
    //   9: aload_1
    //   10: astore_3
    //   11: aload_1
    //   12: invokevirtual 109	java/io/InputStream:available	()I
    //   15: newarray byte
    //   17: astore_0
    //   18: aload_1
    //   19: astore_3
    //   20: aload_1
    //   21: aload_0
    //   22: invokevirtual 113	java/io/InputStream:read	([B)I
    //   25: istore_2
    //   26: iload_2
    //   27: iconst_m1
    //   28: if_icmpne -10 -> 18
    ...
    //   34: ifnull +9 -> 43
    //   37: aload_1
    //   38: invokevirtual 116	java/io/InputStream:close	()V
    //   41: aload_0
    //   42: astore_3
    //   43: aload_3
    //   44: areturn
    //   45: astore_1
    //   46: aload_1
    //   47: invokestatic 89	com/sticker/gif/crazy/launcher/dwz:aux	(Ljava/lang/Throwable;)V
    //   50: aload_0
    //   51: areturn
    //   52: astore 4
    //   54: aconst_null
    ...
    //   59: astore_3
    //   60: aload 4
    //   62: invokestatic 89	com/sticker/gif/crazy/launcher/dwz:aux	(Ljava/lang/Throwable;)V
    //   65: aload_0
    //   66: astore_3
    //   67: aload_1
    //   68: ifnull -25 -> 43
    //   71: aload_1
    //   72: invokevirtual 116	java/io/InputStream:close	()V
    //   75: aload_0
    //   76: areturn
    //   77: astore_1
    //   78: aload_1
    //   79: invokestatic 89	com/sticker/gif/crazy/launcher/dwz:aux	(Ljava/lang/Throwable;)V
    //   82: aload_0
    //   83: areturn
    //   84: astore_0
    //   85: aconst_null
    ...
    //   97: astore_1
    //   98: aload_1
    //   99: invokestatic 89	com/sticker/gif/crazy/launcher/dwz:aux	(Ljava/lang/Throwable;)V
    //   102: goto -7 -> 95
    //   105: astore_0
    //   106: goto -19 -> 87
    //   109: astore 4
  ...
  public static HashSet<String> c()
  {
    ...
    try
    {
      localObject2 = eeh.aux().getPackageManager().getInstalledPackages(128);
  ...
  {
    return eu.checkSelfPermission(paramContext, "android.permission.WRITE_EXTERNAL_STORAGE") == 0;
  }
}
