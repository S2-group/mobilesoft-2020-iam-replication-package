...
public class TapjoyConnectCore
{
  ...
  public TapjoyConnectCore(Context paramContext)
  {
    ...
    //   23: invokestatic 277	com/tapjoy/internal/gi:a	()Lcom/tapjoy/internal/gi;
    //   26: aload_1
    //   27: invokevirtual 279	com/tapjoy/internal/gi:a	(Landroid/content/Context;)V
    //   30: invokestatic 284	com/tapjoy/internal/ge:a	()Lcom/tapjoy/internal/ge;
    //   33: aload_1
    //   34: invokevirtual 285	com/tapjoy/internal/ge:a	(Landroid/content/Context;)V
    ...
    //   141: invokestatic 348	com/tapjoy/internal/ju:c	(Ljava/lang/String;)Z
    //   144: ifeq +7 -> 151
    //   147: aload_0
    ...
    //   850: getstatic 624	com/tapjoy/internal/fw:b	Lcom/tapjoy/internal/fw$a;
    //   853: getstatic 630	java/lang/Boolean:FALSE	Ljava/lang/Boolean;
    //   856: invokevirtual 636	com/tapjoy/internal/fw$a:notifyObservers	(Ljava/lang/Object;)V
    //   859: return
    //   860: astore_1
    //   861: ldc_w 536
    ...
    //   914: getstatic 624	com/tapjoy/internal/fw:b	Lcom/tapjoy/internal/fw$a;
    //   917: getstatic 630	java/lang/Boolean:FALSE	Ljava/lang/Boolean;
    //   920: invokevirtual 636	com/tapjoy/internal/fw$a:notifyObservers	(Ljava/lang/Object;)V
    //   923: return
    //   924: astore_1
    //   925: ldc_w 536
  ...
  private static boolean a(String paramString, boolean paramBoolean)
  {
    ...
    //   1: astore 7
    //   3: aload_0
    //   4: invokestatic 803	com/tapjoy/internal/bq:b	(Ljava/lang/String;)Lcom/tapjoy/internal/bq;
    //   7: astore 6
    //   9: aload 6
    //   11: astore 7
    //   13: aload 6
    //   15: invokevirtual 806	com/tapjoy/internal/bq:d	()Ljava/util/Map;
    //   18: astore 10
    //   20: aload 6
    //   22: astore 7
    //   24: aload 10
    ...
    //   37: invokestatic 813	com/tapjoy/internal/ju:a	(Ljava/lang/String;)Ljava/lang/String;
    //   40: astore 8
    //   42: aload 6
    //   44: astore 7
    //   46: aload 10
    ...
    //   59: invokestatic 813	com/tapjoy/internal/ju:a	(Ljava/lang/String;)Ljava/lang/String;
    //   62: astore 13
    //   64: aload 6
    //   66: astore 7
    //   68: aload 10
    ...
    //   81: invokestatic 813	com/tapjoy/internal/ju:a	(Ljava/lang/String;)Ljava/lang/String;
    //   84: astore 14
    //   86: aload 6
    //   88: astore 7
    //   90: aload 10
    ...
    //   103: invokestatic 813	com/tapjoy/internal/ju:a	(Ljava/lang/String;)Ljava/lang/String;
    //   106: astore 15
    //   108: aload 6
    //   110: astore 7
    //   112: aload 10
    ...
    //   125: invokestatic 813	com/tapjoy/internal/ju:a	(Ljava/lang/String;)Ljava/lang/String;
    //   128: astore 12
    //   130: aload 6
    //   132: astore 7
    //   134: aload 10
    ...
    //   146: aload 6
    //   148: astore 7
    //   150: new 825	com/tapjoy/internal/fs
    //   153: dup
    //   154: aload 14
    //   156: invokespecial 826	com/tapjoy/internal/fs:<init>	(Ljava/lang/String;)V
    //   159: astore 16
    //   161: aload 6
    //   163: astore 7
    //   165: aload 16
    //   167: getfield 829	com/tapjoy/internal/fs:a	Lcom/tapjoy/internal/fs$a;
    //   170: getstatic 834	com/tapjoy/internal/fs$a:RPC_ANALYTICS	Lcom/tapjoy/internal/fs$a;
    ...
    //   211: aload_0
    //   212: invokestatic 845	com/tapjoy/internal/kd:a	(Ljava/io/Closeable;)V
    //   215: iconst_0
    //   216: ireturn
    //   217: aload 6
    //   219: astore 7
    //   221: aload 16
    //   223: getfield 847	com/tapjoy/internal/fs:b	Ljava/lang/String;
    //   226: astore 9
    //   228: aload 6
    //   230: astore 7
    //   232: aload 9
    ...
    //   311: astore 7
    //   313: aload 16
    //   315: getfield 861	com/tapjoy/internal/fs:c	Ljava/lang/String;
    //   318: astore 16
    //   320: aload 8
    ...
    //   329: aload 6
    //   331: astore 7
    //   333: invokestatic 866	com/tapjoy/internal/hd:a	()Lcom/tapjoy/internal/hd;
    ...
    //   347: aload 9
    //   349: aload 16
    //   351: invokevirtual 871	com/tapjoy/internal/hd:a	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   354: aload 6
    //   356: astore 7
    //   358: aload 8
    ...
    //   509: aload 6
    //   511: invokestatic 845	com/tapjoy/internal/kd:a	(Ljava/io/Closeable;)V
    //   514: goto -299 -> 215
    //   517: aload 6
    //   519: astore 7
    //   521: aload 8
    ...
    //   542: astore 7
    //   544: aload 6
    //   546: invokevirtual 889	com/tapjoy/internal/bq:close	()V
    //   549: iload_1
    //   550: ifne +108 -> 658
    //   553: aload 11
    //   555: instanceof 364
    ...
    //   589: invokestatic 284	com/tapjoy/internal/ge:a	()Lcom/tapjoy/internal/ge;
    //   592: astore_0
    //   593: aload 10
    //   595: ldc_w 906
    ...
    //   612: ifeq +114 -> 726
    //   615: aload_0
    //   616: getfield 909	com/tapjoy/internal/ge:a	Lcom/tapjoy/internal/gc;
    //   619: aload 6
    //   621: checkcast 810	java/util/Map
    //   624: invokevirtual 914	com/tapjoy/internal/gc:a	(Ljava/util/Map;)V
    //   627: aload 6
    //   629: invokestatic 919	com/tapjoy/internal/bk:a	(Ljava/lang/Object;)Ljava/lang/String;
    //   632: astore 6
    //   634: aload_0
    //   635: invokevirtual 922	com/tapjoy/internal/ge:c	()Landroid/content/SharedPreferences;
    ...
    //   658: aconst_null
    //   659: invokestatic 845	com/tapjoy/internal/kd:a	(Ljava/io/Closeable;)V
    //   662: iconst_1
    //   663: ireturn
    //   664: astore 6
    //   666: lconst_0
    ...
    //   712: ldc2_w 933
    //   715: lmul
    //   716: invokestatic 938	com/tapjoy/internal/w:b	()J
    //   719: ladd
    ...
    //   731: aload_0
    //   732: getfield 909	com/tapjoy/internal/ge:a	Lcom/tapjoy/internal/gc;
    //   735: aconst_null
    //   736: invokevirtual 914	com/tapjoy/internal/gc:a	(Ljava/util/Map;)V
    //   739: aload_0
    //   740: invokevirtual 922	com/tapjoy/internal/ge:c	()Landroid/content/SharedPreferences;
    ...
    //   773: astore 6
    //   775: aload 6
    //   777: invokestatic 845	com/tapjoy/internal/kd:a	(Ljava/io/Closeable;)V
    //   780: aload_0
    //   781: athrow
    //   782: astore_0
    //   783: aload 7
  ...
  private static boolean c(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokestatic 803	com/tapjoy/internal/bq:b	(Ljava/lang/String;)Lcom/tapjoy/internal/bq;
    //   4: astore_1
    //   5: aload_1
    //   6: astore_0
    //   7: aload_1
    //   8: invokevirtual 950	com/tapjoy/internal/bq:a	()Z
    //   11: ifeq +32 -> 43
    //   14: aload_1
    //   15: astore_0
    //   16: aload_1
    //   17: invokevirtual 952	com/tapjoy/internal/bq:s	()V
    //   20: aload_1
    //   21: astore_0
    //   22: ldc_w 536
    //   25: ldc_w 954
    ...
    //   32: astore_0
    //   33: aload_1
    //   34: invokevirtual 889	com/tapjoy/internal/bq:close	()V
    //   37: aconst_null
    //   38: invokestatic 845	com/tapjoy/internal/kd:a	(Ljava/io/Closeable;)V
    //   41: iconst_1
    //   42: ireturn
    //   43: aload_1
    //   44: astore_0
    //   45: aload_1
    //   46: invokevirtual 889	com/tapjoy/internal/bq:close	()V
    //   49: aconst_null
    //   50: invokestatic 845	com/tapjoy/internal/kd:a	(Ljava/io/Closeable;)V
    //   53: ldc_w 536
    ...
    //   89: aload_1
    //   90: invokestatic 845	com/tapjoy/internal/kd:a	(Ljava/io/Closeable;)V
    //   93: goto -40 -> 53
    //   96: astore_2
    //   97: aconst_null
    //   98: astore_1
    ...
    //   111: aload_1
    //   112: invokestatic 845	com/tapjoy/internal/kd:a	(Ljava/io/Closeable;)V
    //   115: goto -62 -> 53
    //   118: astore_1
    //   119: aconst_null
    //   120: astore_0
    //   121: aload_0
    //   122: invokestatic 845	com/tapjoy/internal/kd:a	(Ljava/io/Closeable;)V
    //   125: aload_1
    //   126: athrow
    //   127: astore_1
    //   128: goto -7 -> 121
  ...
  private void j()
  {
    ...
    //   13: getfield 1512	android/content/pm/PackageInfo:activities	[Landroid/content/pm/ActivityInfo;
    ...
    //   46: checkcast 1514	android/content/pm/ActivityInfo
    //   49: astore_3
    //   50: getstatic 152	com/tapjoy/TapjoyConnectCore:m	Ljava/util/Vector;
    //   53: aload_3
    //   54: getfield 1517	android/content/pm/ActivityInfo:name	Ljava/lang/String;
    //   57: invokevirtual 1518	java/util/Vector:contains	(Ljava/lang/Object;)Z
    //   60: ifeq -29 -> 31
    //   63: getstatic 152	com/tapjoy/TapjoyConnectCore:m	Ljava/util/Vector;
    //   66: aload_3
    //   67: getfield 1517	android/content/pm/ActivityInfo:name	Ljava/lang/String;
    //   70: invokevirtual 1521	java/util/Vector:indexOf	(Ljava/lang/Object;)I
    //   73: istore_1
    //   74: getstatic 152	com/tapjoy/TapjoyConnectCore:m	Ljava/util/Vector;
    //   77: iload_1
    //   78: invokevirtual 1524	java/util/Vector:get	(I)Ljava/lang/Object;
    //   81: checkcast 364	java/lang/String
    //   84: invokestatic 1530	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   87: pop
    ...
    //   95: astore 4
    //   97: aload_3
    //   98: getfield 1533	android/content/pm/ActivityInfo:configChanges	I
    //   101: sipush 128
    //   104: iand
    //   105: sipush 128
    ...
    //   119: pop
    //   120: aload_3
    //   121: getfield 1533	android/content/pm/ActivityInfo:configChanges	I
    //   124: bipush 32
    //   126: iand
    //   127: bipush 32
    ...
    //   140: pop
    //   141: aload 4
    //   143: invokevirtual 1538	java/util/Vector:size	()I
    //   146: ifeq +149 -> 295
    //   149: aload 4
    //   151: invokevirtual 1538	java/util/Vector:size	()I
    //   154: iconst_1
    ...
    //   169: aload 4
    //   171: invokevirtual 1539	java/util/Vector:toString	()Ljava/lang/String;
    ...
    //   186: iload_1
    //   187: invokevirtual 1524	java/util/Vector:get	(I)Ljava/lang/Object;
    ...
    //   199: invokespecial 1542	com/tapjoy/TapjoyIntegrationException:<init>	(Ljava/lang/String;)V
    //   202: athrow
    //   203: astore_2
    ...
    //   221: iload_1
    //   222: invokevirtual 1524	java/util/Vector:get	(I)Ljava/lang/Object;
    ...
    //   234: invokespecial 1542	com/tapjoy/TapjoyIntegrationException:<init>	(Ljava/lang/String;)V
    //   237: athrow
    //   238: astore_2
    //   239: new 259	com/tapjoy/TapjoyIntegrationException
    //   242: dup
    //   243: ldc_w 1546
    //   246: invokespecial 1542	com/tapjoy/TapjoyIntegrationException:<init>	(Ljava/lang/String;)V
    //   249: athrow
    ...
    //   261: aload 4
    //   263: invokevirtual 1539	java/util/Vector:toString	()Ljava/lang/String;
    ...
    //   278: iload_1
    //   279: invokevirtual 1524	java/util/Vector:get	(I)Ljava/lang/Object;
    ...
    //   291: invokespecial 1542	com/tapjoy/TapjoyIntegrationException:<init>	(Ljava/lang/String;)V
    //   294: athrow
    //   295: getstatic 400	android/os/Build$VERSION:SDK_INT	I
    //   298: bipush 13
    //   300: if_icmplt +49 -> 349
    //   303: aload_3
    //   304: getfield 1533	android/content/pm/ActivityInfo:configChanges	I
    //   307: sipush 1024
    //   310: iand
    //   311: sipush 1024
    ...
    //   333: iload_1
    //   334: invokevirtual 1524	java/util/Vector:get	(I)Ljava/lang/Object;
    ...
    //   357: aload_3
    //   358: getfield 1517	android/content/pm/ActivityInfo:name	Ljava/lang/String;
    //   361: ldc_w 1552
    //   364: invokevirtual 658	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   367: ifeq +51 -> 418
    //   370: aload_3
    //   371: getfield 1553	android/content/pm/ActivityInfo:flags	I
    //   374: sipush 512
    //   377: iand
    //   378: sipush 512
    ...
    //   401: iload_1
    //   402: invokevirtual 1524	java/util/Vector:get	(I)Ljava/lang/Object;
    ...
    //   414: invokespecial 1542	com/tapjoy/TapjoyIntegrationException:<init>	(Ljava/lang/String;)V
    //   417: athrow
    //   418: getstatic 152	com/tapjoy/TapjoyConnectCore:m	Ljava/util/Vector;
    //   421: iload_1
    //   422: invokevirtual 1557	java/util/Vector:remove	(I)Ljava/lang/Object;
    //   425: pop
    //   426: goto -395 -> 31
    //   429: getstatic 152	com/tapjoy/TapjoyConnectCore:m	Ljava/util/Vector;
    //   432: invokevirtual 1538	java/util/Vector:size	()I
    //   435: ifeq +103 -> 538
    //   438: getstatic 152	com/tapjoy/TapjoyConnectCore:m	Ljava/util/Vector;
    //   441: invokevirtual 1538	java/util/Vector:size	()I
    //   444: iconst_1
    ...
    //   465: invokevirtual 1538	java/util/Vector:size	()I
    ...
    //   480: invokevirtual 1539	java/util/Vector:toString	()Ljava/lang/String;
    ...
    //   489: invokespecial 1542	com/tapjoy/TapjoyIntegrationException:<init>	(Ljava/lang/String;)V
    //   492: athrow
    ...
    //   510: invokevirtual 1538	java/util/Vector:size	()I
    ...
    //   525: invokevirtual 1539	java/util/Vector:toString	()Ljava/lang/String;
    ...
    //   534: invokespecial 1542	com/tapjoy/TapjoyIntegrationException:<init>	(Ljava/lang/String;)V
    //   537: athrow
    //   538: invokestatic 1565	com/tapjoy/TapjoyConnectCore:k	()V
    //   541: ldc_w 1567
    //   544: invokestatic 1530	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   547: astore_2
    //   548: aload_2
    //   549: ldc_w 1569
    //   552: iconst_1
    //   553: anewarray 1526	java/lang/Class
    //   556: dup
    //   557: iconst_0
    //   558: ldc_w 626
    //   561: aastore
    //   562: invokevirtual 1573	java/lang/Class:getMethod	(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
    //   565: pop
    //   566: ldc_w 1575
    //   569: invokestatic 1578	com/tapjoy/TapjoyUtil:getResource	(Ljava/lang/String;)Ljava/lang/Object;
    ...
    //   586: invokestatic 1584	com/tapjoy/TapjoyUtil:copyTextFromJarIntoString	(Ljava/lang/String;Landroid/content/Context;)Ljava/lang/String;
    //   589: astore_2
    //   590: aload_2
    ...
    //   626: astore_3
    //   627: aload_3
    //   628: invokevirtual 1593	java/io/InputStream:available	()I
    //   631: newarray byte
    //   633: astore 4
    //   635: aload_3
    //   636: aload 4
    //   638: invokevirtual 1597	java/io/InputStream:read	([B)I
    //   641: pop
    //   642: new 364	java/lang/String
    //   645: dup
    //   646: aload 4
    //   648: invokespecial 1600	java/lang/String:<init>	([B)V
    //   651: astore_3
    //   652: ldc_w 1575
    //   655: aload_3
    //   656: invokestatic 1604	com/tapjoy/TapjoyUtil:setResource	(Ljava/lang/String;Ljava/lang/Object;)V
    //   659: aload_3
    //   660: astore_2
    //   661: aload_2
    ...
    //   668: dup
    //   669: ldc_w 1606
    //   672: invokespecial 1542	com/tapjoy/TapjoyIntegrationException:<init>	(Ljava/lang/String;)V
    //   675: athrow
    //   676: astore_2
    //   677: new 259	com/tapjoy/TapjoyIntegrationException
    //   680: dup
    //   681: ldc_w 1608
    //   684: invokespecial 1542	com/tapjoy/TapjoyIntegrationException:<init>	(Ljava/lang/String;)V
    //   687: athrow
    //   688: astore_2
    //   689: new 259	com/tapjoy/TapjoyIntegrationException
    //   692: dup
    //   693: ldc_w 1610
    //   696: invokespecial 1542	com/tapjoy/TapjoyIntegrationException:<init>	(Ljava/lang/String;)V
    //   699: athrow
    //   700: ldc_w 578
    ...
    //   738: invokevirtual 1615	com/tapjoy/TapjoyGpsHelper:checkGooglePlayIntegration	()V
    //   741: return
    //   742: astore_3
    //   743: goto -82 -> 661
    //   746: astore_2
  ...
  private static String n()
  {
    ...
    try
    {
      String str = TapjoyUtil.SHA256(System.currentTimeMillis() / 1000L + v);
      localObject = str;
      Z = System.currentTimeMillis();
      return str;
    }
