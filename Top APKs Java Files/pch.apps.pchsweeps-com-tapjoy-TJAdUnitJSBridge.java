...
public class TJAdUnitJSBridge
{
        ...
        catch (Exception localException)
        {
          for (;;)
          {
            ...
            catch (Exception paramAnonymousString)
            {
              ...
              TJAdUnitJSBridge.this.invokeJSCallback(localObject2, new Object[] { Boolean.FALSE });
            }
  ...
  public void displayVideo(JSONObject paramJSONObject, String paramString)
  {
    ...
    //   0: ldc -48
    //   2: astore_3
    //   3: new 433	java/util/HashMap
    //   6: dup
    //   7: invokespecial 434	java/util/HashMap:<init>	()V
    //   10: astore 5
    //   12: aload_1
    //   13: ldc_w 436
    //   16: invokevirtual 440	org/json/JSONObject:getJSONObject	(Ljava/lang/String;)Lorg/json/JSONObject;
    //   19: astore 4
    //   21: aload 4
    //   23: ifnull +96 -> 119
    //   26: aload 4
    //   28: invokevirtual 443	org/json/JSONObject:keys	()Ljava/util/Iterator;
    //   31: astore 6
    //   33: aload 6
    //   35: invokeinterface 309 1 0
    //   40: ifeq +79 -> 119
    //   43: aload 6
    //   45: invokeinterface 313 1 0
    //   50: checkcast 134	java/lang/String
    //   53: astore 7
    //   55: aload 5
    //   57: aload 7
    //   59: aload 4
    //   61: aload 7
    //   63: invokevirtual 216	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   66: invokevirtual 447	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   69: pop
    //   70: goto -37 -> 33
    //   73: astore 8
    //   75: ldc 28
    ...
    //   90: aload 4
    //   92: aload 7
    //   94: invokevirtual 216	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   103: invokestatic 77	com/tapjoy/TapjoyLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   106: goto -73 -> 33
    //   109: astore 4
    //   111: ldc 28
    //   113: ldc_w 451
    //   116: invokestatic 77	com/tapjoy/TapjoyLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   119: aload_1
    //   120: ldc_w 453
    //   123: invokevirtual 216	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   126: astore 4
    //   128: aload 4
    //   130: astore_3
    //   131: aload_1
    //   132: ldc_w 415
    //   135: invokevirtual 216	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   138: astore_1
    //   139: new 379	android/content/Intent
    //   142: dup
    //   143: aload_0
    //   144: getfield 79	com/tapjoy/TJAdUnitJSBridge:context	Landroid/content/Context;
    //   147: ldc_w 455
    //   150: invokespecial 382	android/content/Intent:<init>	(Landroid/content/Context;Ljava/lang/Class;)V
    //   153: astore 4
    //   155: aload 4
    //   157: ldc_w 457
    //   160: aload_1
    //   161: invokevirtual 396	android/content/Intent:putExtra	(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    //   164: pop
    //   165: aload 4
    //   167: ldc_w 459
    //   170: aload_3
    //   171: invokevirtual 396	android/content/Intent:putExtra	(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    //   174: pop
    //   175: aload 4
    //   177: ldc_w 461
    //   180: iconst_1
    //   181: invokevirtual 464	android/content/Intent:putExtra	(Ljava/lang/String;Z)Landroid/content/Intent;
    //   184: pop
    //   185: aload 4
    //   187: ldc_w 405
    //   190: aload_2
    //   191: invokevirtual 396	android/content/Intent:putExtra	(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    //   194: pop
    //   195: aload 4
    //   197: ldc_w 466
    //   200: aload 5
    //   202: invokevirtual 388	android/content/Intent:putExtra	(Ljava/lang/String;Ljava/io/Serializable;)Landroid/content/Intent;
    //   205: pop
    //   206: aload_0
    //   207: getfield 79	com/tapjoy/TJAdUnitJSBridge:context	Landroid/content/Context;
    //   210: checkcast 341	android/app/Activity
    //   213: aload 4
    //   215: iconst_0
    //   216: invokevirtual 409	android/app/Activity:startActivityForResult	(Landroid/content/Intent;I)V
    //   219: return
    //   220: astore 4
    //   222: ldc 28
    //   224: ldc_w 468
    //   227: invokestatic 361	com/tapjoy/TapjoyLog:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   230: goto -99 -> 131
    //   233: astore_1
    //   234: aload_0
    //   235: aload_2
    ...
    //   240: dup
    //   241: iconst_0
    //   242: getstatic 252	java/lang/Boolean:FALSE	Ljava/lang/Boolean;
    //   245: aastore
    //   246: invokevirtual 256	com/tapjoy/TJAdUnitJSBridge:invokeJSCallback	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   249: aload_1
    //   250: invokevirtual 185	java/lang/Exception:printStackTrace	()V
    //   253: return
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	254	0	this	TJAdUnitJSBridge
    //   0	254	1	paramJSONObject	JSONObject
    //   0	254	2	paramString	String
    //   2	169	3	localObject1	Object
    //   19	72	4	localJSONObject	JSONObject
    //   109	1	4	localException1	Exception
    //   126	88	4	localObject2	Object
    //   220	1	4	localException2	Exception
    //   10	191	5	localHashMap	HashMap
    //   31	13	6	localIterator	Iterator
    //   53	40	7	str	String
    //   73	1	8	localException3	Exception
    // Exception table:
    //   from	to	target	type
    //   55	70	73	java/lang/Exception
    //   12	21	109	java/lang/Exception
    //   26	33	109	java/lang/Exception
    //   33	55	109	java/lang/Exception
    //   75	106	109	java/lang/Exception
    //   119	128	220	java/lang/Exception
    //   131	219	233	java/lang/Exception
  }
  ...
  public void present(JSONObject paramJSONObject, String paramString)
  {
    // Byte code:
    //   0: iconst_0
    //   1: invokestatic 542	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   4: astore_3
    //   5: aload_1
    //   6: ldc_w 544
    //   9: invokevirtual 216	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   12: invokestatic 487	java/lang/Boolean:valueOf	(Ljava/lang/String;)Ljava/lang/Boolean;
    //   15: astore 5
    //   17: aload_1
    //   18: ldc_w 546
    //   21: invokevirtual 216	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   24: invokestatic 487	java/lang/Boolean:valueOf	(Ljava/lang/String;)Ljava/lang/Boolean;
    //   27: astore 4
    //   29: aload 4
    //   31: astore_3
    //   32: aload_0
    ...
    //   40: invokestatic 487	java/lang/Boolean:valueOf	(Ljava/lang/String;)Ljava/lang/Boolean;
    //   43: invokevirtual 490	java/lang/Boolean:booleanValue	()Z
    ...
    //   58: invokespecial 550	com/tapjoy/TJAdUnitJSBridge$ShowWebView:<init>	(Lcom/tapjoy/TJAdUnitJSBridge;Landroid/webkit/WebView;)V
    //   61: iconst_2
    ...
    //   72: aload_3
    //   73: aastore
    //   74: invokevirtual 554	com/tapjoy/TJAdUnitJSBridge$ShowWebView:execute	([Ljava/lang/Object;)Landroid/os/AsyncTask;
    //   77: pop
    //   78: aload_0
    //   79: aload_2
    //   80: iconst_1
  ...
  public void share(JSONObject paramJSONObject, String paramString)
  {
    ...
    //   32: dup
    //   33: ldc_w 636
    //   36: invokespecial 637	android/content/Intent:<init>	(Ljava/lang/String;)V
    //   39: astore 11
    //   41: aload_1
    //   42: ldc_w 639
    ...
    //   71: aload_0
    //   72: aload 5
    //   74: invokespecial 643	com/tapjoy/TJAdUnitJSBridge:downloadFileFromURL	(Ljava/lang/String;)Ljava/io/File;
    //   77: astore 9
    //   79: aload 7
    //   81: astore 6
    //   83: aload 9
    ...
    //   101: aload 9
    //   103: invokevirtual 648	java/io/File:getAbsolutePath	()Ljava/lang/String;
    ...
    //   181: aload 11
    //   183: ldc_w 656
    //   186: invokevirtual 659	android/content/Intent:setType	(Ljava/lang/String;)Landroid/content/Intent;
    //   189: pop
    //   190: aload 11
    //   192: ldc_w 661
    //   195: aload 6
    //   197: invokestatic 423	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   200: invokevirtual 664	android/content/Intent:putExtra	(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;
    //   203: pop
    //   204: aload_0
    ...
    //   211: aload 11
    //   213: iconst_0
    //   214: invokevirtual 668	android/content/pm/PackageManager:queryIntentActivities	(Landroid/content/Intent;I)Ljava/util/List;
    ...
    //   241: checkcast 670	android/content/pm/ResolveInfo
    //   244: astore 5
    //   246: aload 5
    //   248: getfield 674	android/content/pm/ResolveInfo:activityInfo	Landroid/content/pm/ActivityInfo;
    //   251: getfield 677	android/content/pm/ActivityInfo:packageName	Ljava/lang/String;
    //   254: getstatic 683	java/util/Locale:ENGLISH	Ljava/util/Locale;
    //   257: invokevirtual 687	java/lang/String:toLowerCase	(Ljava/util/Locale;)Ljava/lang/String;
    //   260: aload 10
    //   262: invokevirtual 691	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   265: ifne +25 -> 290
    //   268: aload 5
    //   270: getfield 674	android/content/pm/ResolveInfo:activityInfo	Landroid/content/pm/ActivityInfo;
    //   273: getfield 694	android/content/pm/ActivityInfo:name	Ljava/lang/String;
    //   276: getstatic 683	java/util/Locale:ENGLISH	Ljava/util/Locale;
    //   279: invokevirtual 687	java/lang/String:toLowerCase	(Ljava/util/Locale;)Ljava/lang/String;
    //   282: aload 10
    //   284: invokevirtual 691	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   287: ifeq -64 -> 223
    //   290: aload 11
    //   292: aload 5
    //   294: getfield 674	android/content/pm/ResolveInfo:activityInfo	Landroid/content/pm/ActivityInfo;
    //   297: getfield 677	android/content/pm/ActivityInfo:packageName	Ljava/lang/String;
    //   300: invokevirtual 697	android/content/Intent:setPackage	(Ljava/lang/String;)Landroid/content/Intent;
    //   303: pop
    //   304: iconst_1
    //   305: istore_3
    //   306: iload_3
    ...
    //   375: aload 11
    //   377: ldc_w 703
    //   380: invokevirtual 659	android/content/Intent:setType	(Ljava/lang/String;)Landroid/content/Intent;
    //   383: pop
    //   384: goto -180 -> 204
    //   387: aload 10
    //   389: ldc_w 705
    ...
    //   398: aload 11
    //   400: ldc_w 707
    //   403: invokevirtual 659	android/content/Intent:setType	(Ljava/lang/String;)Landroid/content/Intent;
    //   406: pop
    //   407: aload 5
    //   409: ifnull -205 -> 204
    //   412: aload 6
    ...
    //   427: invokevirtual 664	android/content/Intent:putExtra	(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;
    //   430: pop
    //   431: goto -227 -> 204
    //   434: aload_0
    //   435: iconst_1
    ...
    //   444: aload 11
    //   446: ldc_w 709
    //   449: invokestatic 713	android/content/Intent:createChooser	(Landroid/content/Intent;Ljava/lang/CharSequence;)Landroid/content/Intent;
    //   452: astore_1
    //   453: aload_0
