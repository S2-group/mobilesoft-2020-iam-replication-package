...
public class Playrix
{
  ...
  private static GLSurfaceViewV17.Scale2D mResolutionScale;
  private static WindowManager winMgr;
  
  static
  {
    advertisingId = null;
    mResolutionScale = new GLSurfaceViewV17.Scale2D();
  }
  ...
  public static String findMatchedPackages(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    //   14: astore_0
    //   15: getstatic 132	com/playrix/lib/Playrix:mContext	Landroid/app/Application;
    //   18: ifnonnull +13 -> 31
    //   21: ldc -30
    ...
    //   30: areturn
    //   31: getstatic 132	com/playrix/lib/Playrix:mContext	Landroid/app/Application;
  ...
  public static Locale getDeviceLocale()
  {
    ...
    if (Build.VERSION.SDK_INT >= 24) {
      b.a(localConfiguration.getLocales());
    } else {
      b.a(new Locale[] { localConfiguration.locale });
    }
    return b.b();
  }
  ...
  public static void useExternalCache()
  {
    ...
    if ((str != null) && (str.equals("mounted")) && (mContext.getExternalCacheDir() != null)) {
