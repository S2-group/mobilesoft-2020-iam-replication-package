  ...
  extends PackageManager
{
  ...
  public List<ApplicationInfo> a(int paramInt)
  {
    ...
    //   1: astore 4
    //   3: aload_0
    //   4: getfield 49	com/lbe/doubleagent/utility/e:c	Landroid/content/pm/PackageManager;
    //   7: iload_1
    //   8: invokevirtual 202	android/content/pm/PackageManager:getInstalledApplications	(I)Ljava/util/List;
    //   11: astore 5
    //   13: aload 5
    //   15: astore 4
    //   17: iconst_0
    ...
    //   25: iload_3
    //   26: aload_0
    //   27: getfield 41	com/lbe/doubleagent/utility/e:a	[I
    //   30: arraylength
    //   31: if_icmpge +47 -> 78
    //   34: iload_2
    //   35: ifeq +43 -> 78
    //   38: aload_0
    //   39: getfield 41	com/lbe/doubleagent/utility/e:a	[I
    //   42: iload_3
    //   43: iaload
    //   44: i2l
    //   45: invokestatic 208	java/lang/Thread:sleep	(J)V
    //   48: aload_0
    //   49: getfield 49	com/lbe/doubleagent/utility/e:c	Landroid/content/pm/PackageManager;
    //   52: iload_1
    //   53: invokevirtual 202	android/content/pm/PackageManager:getInstalledApplications	(I)Ljava/util/List;
    //   56: astore 5
    //   58: aload 5
    //   60: astore 4
    //   62: iconst_0
    ...
    //   79: ifeq +13 -> 92
    //   82: aload_0
    //   83: getfield 49	com/lbe/doubleagent/utility/e:c	Landroid/content/pm/PackageManager;
    //   86: iload_1
    //   87: invokevirtual 202	android/content/pm/PackageManager:getInstalledApplications	(I)Ljava/util/List;
    //   90: astore 4
    //   92: aload 4
    //   94: areturn
    //   95: astore 5
  ...
  public List<PackageInfo> a(int paramInt1, int paramInt2)
  {
  ...
  public List<ResolveInfo> a(int paramInt1, Intent paramIntent, int paramInt2)
  {
    try
    {
  ...
  public void a(PackageInfo paramPackageInfo, String paramString, boolean paramBoolean)
  {
    if (paramBoolean)
    {
      d();
  ...
  public List<PackageInfo> b(int paramInt)
  {
    ...
    //   4: getfield 49	com/lbe/doubleagent/utility/e:c	Landroid/content/pm/PackageManager;
    //   7: iload_1
    //   8: invokevirtual 253	android/content/pm/PackageManager:getInstalledPackages	(I)Ljava/util/List;
    //   11: astore 5
    //   13: aload 5
    //   15: astore 4
    //   17: iconst_0
    ...
    //   49: getfield 49	com/lbe/doubleagent/utility/e:c	Landroid/content/pm/PackageManager;
    //   52: iload_1
    //   53: invokevirtual 253	android/content/pm/PackageManager:getInstalledPackages	(I)Ljava/util/List;
    //   56: astore 5
    //   58: aload 5
    //   60: astore 4
    //   62: iconst_0
    ...
    //   83: getfield 49	com/lbe/doubleagent/utility/e:c	Landroid/content/pm/PackageManager;
    //   86: iload_1
    //   87: invokevirtual 253	android/content/pm/PackageManager:getInstalledPackages	(I)Ljava/util/List;
    //   90: astore 4
    //   92: aload 4
    //   94: areturn
    //   95: astore 5
  ...
  public List<ApplicationInfo> b(int paramInt1, int paramInt2)
  {
  ...
  public List<PackageInfo> getInstalledPackages(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      localObject2.addAll(b(paramInt));
      if (h != null) {
