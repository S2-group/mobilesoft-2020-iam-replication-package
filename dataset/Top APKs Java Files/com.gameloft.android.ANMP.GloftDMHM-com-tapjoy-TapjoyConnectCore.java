...
public class TapjoyConnectCore
{
  ...
  private void obtainScreenInformation()
  {
    try
    {
      if (Build.VERSION.SDK_INT > 3)
      {
        ...
        deviceScreenDensity = localTapjoyDisplayMetricsUtil.getScreenDensity();
  ...
  private void resolveJSBridgeMethods()
  {
    // Byte code:
    //   0: ldc_w 1093
    //   3: invokestatic 320	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   6: astore_1
    //   7: aload_1
    //   8: ldc_w 1095
    //   11: iconst_0
    //   12: anewarray 316	java/lang/Class
    //   15: invokevirtual 1099	java/lang/Class:getMethod	(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
    //   18: pop
    //   19: return
    //   20: astore_1
    //   21: new 344	com/tapjoy/TapjoyIntegrationException
    //   24: dup
    //   25: ldc_w 1101
    //   28: invokespecial 349	com/tapjoy/TapjoyIntegrationException:<init>	(Ljava/lang/String;)V
    //   31: athrow
    //   32: astore_1
    //   33: new 344	com/tapjoy/TapjoyIntegrationException
    //   36: dup
    //   37: ldc_w 1103
    //   40: invokespecial 349	com/tapjoy/TapjoyIntegrationException:<init>	(Ljava/lang/String;)V
    //   43: athrow
  ...
  public String getSerial()
  {
    ...
    //   3: invokestatic 320	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   6: ldc_w 1304
    //   9: invokevirtual 1308	java/lang/Class:getDeclaredField	(Ljava/lang/String;)Ljava/lang/reflect/Field;
    //   12: astore_1
    //   13: aload_1
    //   14: invokevirtual 1313	java/lang/reflect/Field:isAccessible	()Z
    //   17: ifne +8 -> 25
    //   20: aload_1
    //   21: iconst_1
    //   22: invokevirtual 1316	java/lang/reflect/Field:setAccessible	(Z)V
    //   25: aload_1
    //   26: ldc_w 983
    //   29: invokevirtual 1317	java/lang/reflect/Field:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   32: invokevirtual 1318	java/lang/Object:toString	()Ljava/lang/String;
    //   35: astore_1
    //   36: ldc 8
    //   38: new 217	java/lang/StringBuilder
    //   41: dup
    //   42: ldc_w 1320
    //   45: invokespecial 222	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   48: aload_1
    ...
    //   55: invokestatic 240	com/tapjoy/TapjoyLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   58: aload_1
    //   59: areturn
    //   60: astore_2
    //   61: aconst_null
    ...
    //   63: ldc 8
    //   65: aload_2
    //   66: invokevirtual 417	java/lang/Exception:toString	()Ljava/lang/String;
    //   69: invokestatic 420	com/tapjoy/TapjoyLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   72: aload_1
    //   73: areturn
    //   74: astore_2
    //   75: goto -12 -> 63
