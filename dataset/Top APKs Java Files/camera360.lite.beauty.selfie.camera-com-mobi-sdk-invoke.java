...
public class invoke
{
  ...
  public static BridgeModel jdMethod_do(Context paramContext)
  {
    ...
    localBridgeModel.flagParames = au.jdMethod_do(paramContext, "c_fp", 32);
  ...
  public static <T> T jdMethod_do(Context paramContext, String paramString)
  {
    ...
    //   72: invokestatic 186	com/mobi/sdk/x:do	(Ljava/lang/Object;)V
    //   75: aload 6
    //   77: astore_0
    //   78: goto -65 -> 13
    //   81: astore_0
    ...
    //   135: invokestatic 186	com/mobi/sdk/x:do	(Ljava/lang/Object;)V
    //   138: aload 6
    //   140: astore_0
    //   141: goto -128 -> 13
    ...
    //   205: invokestatic 186	com/mobi/sdk/x:do	(Ljava/lang/Object;)V
    //   208: aload 5
    //   210: astore_0
    //   211: goto -198 -> 13
    //   214: astore 5
    ...
    //   240: invokestatic 186	com/mobi/sdk/x:do	(Ljava/lang/Object;)V
    //   243: aload 6
    //   245: astore_0
    //   246: aload_1
    //   247: ifnull -234 -> 13
    ...
    //   280: invokestatic 186	com/mobi/sdk/x:do	(Ljava/lang/Object;)V
    //   283: aload 6
    //   285: astore_0
    //   286: goto -273 -> 13
    //   289: astore 5
    ...
    //   315: invokestatic 186	com/mobi/sdk/x:do	(Ljava/lang/Object;)V
    //   318: aload 6
    //   320: astore_0
    //   321: aload_1
    //   322: ifnull -309 -> 13
    ...
    //   355: invokestatic 186	com/mobi/sdk/x:do	(Ljava/lang/Object;)V
    //   358: aload 6
    //   360: astore_0
    //   361: goto -348 -> 13
    //   364: astore 5
    ...
    //   390: invokestatic 186	com/mobi/sdk/x:do	(Ljava/lang/Object;)V
    //   393: aload 6
    //   395: astore_0
    //   396: aload_1
    //   397: ifnull -384 -> 13
    ...
    //   430: invokestatic 186	com/mobi/sdk/x:do	(Ljava/lang/Object;)V
    //   433: aload 6
    //   435: astore_0
    //   436: goto -423 -> 13
    //   439: astore 5
    ...
    //   465: invokestatic 186	com/mobi/sdk/x:do	(Ljava/lang/Object;)V
    //   468: aload 6
    //   470: astore_0
    //   471: aload_1
    //   472: ifnull -459 -> 13
    ...
    //   505: invokestatic 186	com/mobi/sdk/x:do	(Ljava/lang/Object;)V
    //   508: aload 6
    //   510: astore_0
    //   511: goto -498 -> 13
    //   514: astore_1
    ...
    //   547: invokestatic 186	com/mobi/sdk/x:do	(Ljava/lang/Object;)V
    //   550: goto -25 -> 525
    //   553: astore_1
    //   554: goto -37 -> 517
    //   557: astore 5
  ...
  public static Object jdMethod_do(BridgeModel paramBridgeModel, String paramString1, String paramString2)
  {
    ...
    try
    {
      x.jdMethod_if(" reflex -------------- " + paramBridgeModel.className + " :::: " + paramBridgeModel.actionName + "   " + paramBridgeModel.putName + " ::::" + paramBridgeModel.flagName + ":::::" + paramBridgeModel.flagParames + " ---- " + paramBridgeModel.setName);
  ...
  public static String jdMethod_do(Context paramContext)
  {
    ...
    try
    {
      ...
      localObject = str;
      au.jdMethod_do(paramContext, "android_id", str);
      return str;
    }
    catch (Exception paramContext) {}
    return localObject;
  ...
  public static String jdMethod_do(Context paramContext, String paramString1, String paramString2)
  {
    ...
    return jdMethod_for(au.jdMethod_do(paramContext, paramString1, paramString2));
  }
    ...
    try
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localObject instanceof String))
        {
          ...
          x.jdMethod_if("key::::::" + (String)localObject + "::::::::::" + str);
  ...
  public static JSONObject jdMethod_do(Context paramContext)
  {
    ...
    try
    {
      localJSONObject.put("app_pkg", aq.jdField_do_of_type_JavaLangString);
      localJSONObject.put("app_version", aq.jdField_if_of_type_JavaLangString);
      ...
      localJSONObject.put("gaid", case.jdMethod_do(au.jdMethod_do(paramContext, "android_adid", "")));
      localJSONObject.put("os_version", Build.VERSION.RELEASE);
      localJSONObject.put("country", Locale.getDefault().getCountry());
      localJSONObject.put("kernel_version", au.jdMethod_do(paramContext, "kernel_version", ""));
  ...
  public static void jdMethod_do(Context paramContext, BridgeModel paramBridgeModel)
  {
    ...
    au.jdMethod_do(paramContext, "c_fp", paramBridgeModel.flagParames);
  ...
  public static <T> void jdMethod_do(Context paramContext, String paramString, T paramT)
  {
    ...
    //   13: aconst_null
    //   14: astore 4
    //   16: new 581	java/io/ObjectOutputStream
    //   19: dup
    //   20: new 583	java/io/FileOutputStream
    //   23: dup
    //   24: aload_0
    //   25: aload_1
    //   26: invokevirtual 157	android/content/Context:getFileStreamPath	(Ljava/lang/String;)Ljava/io/File;
    //   29: invokespecial 584	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   32: invokespecial 587	java/io/ObjectOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   35: astore_0
    //   36: aload_0
    //   37: astore_1
    //   38: aload_0
    //   39: aload_2
    //   40: invokevirtual 590	java/io/ObjectOutputStream:writeObject	(Ljava/lang/Object;)V
    //   43: aload_0
    //   44: ifnull -37 -> 7
    //   47: aload_0
    //   48: invokevirtual 591	java/io/ObjectOutputStream:close	()V
    //   51: goto -44 -> 7
    //   54: astore_0
    ...
    //   75: invokestatic 186	com/mobi/sdk/x:do	(Ljava/lang/Object;)V
    //   78: goto -71 -> 7
    //   81: astore_0
    //   82: ldc 2
    //   84: monitorexit
    ...
    //   112: invokestatic 186	com/mobi/sdk/x:do	(Ljava/lang/Object;)V
    //   115: aload_0
    //   116: ifnull -109 -> 7
    //   119: aload_0
    //   120: invokevirtual 591	java/io/ObjectOutputStream:close	()V
    //   123: goto -116 -> 7
    //   126: astore_0
    ...
    //   147: invokestatic 186	com/mobi/sdk/x:do	(Ljava/lang/Object;)V
    //   150: goto -143 -> 7
    //   153: astore_1
    //   154: aload 4
    //   156: astore_0
    ...
    //   179: invokestatic 186	com/mobi/sdk/x:do	(Ljava/lang/Object;)V
    //   182: aload_0
    //   183: ifnull -176 -> 7
    //   186: aload_0
    //   187: invokevirtual 591	java/io/ObjectOutputStream:close	()V
    //   190: goto -183 -> 7
    //   193: astore_0
    ...
    //   214: invokestatic 186	com/mobi/sdk/x:do	(Ljava/lang/Object;)V
    //   217: goto -210 -> 7
    //   220: astore_0
    //   221: aload_3
    //   222: ifnull +7 -> 229
    //   225: aload_3
    //   226: invokevirtual 591	java/io/ObjectOutputStream:close	()V
    //   229: aload_0
    //   230: athrow
    //   231: astore_1
    ...
    //   252: invokestatic 186	com/mobi/sdk/x:do	(Ljava/lang/Object;)V
    //   255: goto -26 -> 229
    //   258: astore_0
    //   259: aload_1
    //   260: astore_3
  ...
  public static void jdMethod_do(Context paramContext, String paramString1, String paramString2)
  {
    ...
    au.jdMethod_do(paramContext, paramString1, jdMethod_if(paramString2));
  }
  ...
  public static void jdMethod_do(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    au.jdMethod_do(paramContext, "tid_" + paramString1, paramString2);
    au.jdMethod_do(paramContext, "clk_time_" + paramString1, paramString3);
  }
  ...
  public static void jdMethod_do(Context paramContext, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localJSONObject.put("GoogleAdvertiserID", case.jdMethod_do(au.jdMethod_do(paramContext, "android_adid", "")));
          localJSONObject.put("android_id", case.jdMethod_do(au.jdMethod_do(paramContext, "android_id", "")));
          ...
          localJSONObject.put("app_version_code", aq.goto);
          ...
          localJSONObject.put("art", au.jdMethod_do(paramContext, "art", ""));
  ...
  public static boolean jdMethod_do(Context paramContext, int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        x.jdMethod_if((String)localObject);
        if ((localHotServerAdEntity != null) && (!TextUtils.isEmpty(localHotServerAdEntity.getRv())))
        {
          ...
          localObject = new z();
          ((z)localObject).jdField_do_of_type_JavaLangString = jdMethod_if(paramString);
          ((z)localObject).jdField_do_of_type_Int = paramInt;
          ((z)localObject).jdField_for = localHotServerAdEntity.getRv();
          ((z)localObject).jdField_if_of_type_Int = 1;
          ((z)localObject).jdField_new = "";
          ((z)localObject).jdField_if_of_type_JavaLangString = localHotServerAdEntity.getClick_temp();
          ((z)localObject).jdField_int = localHotServerAdEntity.getCreate_time();
          array.jdMethod_do(paramContext).jdMethod_do((z)localObject);
          return true;
        }
      }
      catch (Exception paramContext)
  ...
  public static String jdMethod_for(Context paramContext, String paramString)
  {
    ...
    return au.jdMethod_do(paramContext, "clk_time_" + paramString, "");
  }
  ...
  {
    String str = au.jdMethod_do(paramContext, "user_agent", "");
  ...
  public static String jdMethod_if(Context paramContext, String paramString)
  {
    ...
    x.jdMethod_if("getAppVersion --------------  " + paramString);
    try
    {
  ...
  {
    if (TextUtils.isEmpty(aq.try)) {
      aq.try = au.jdMethod_do(paramContext, "ad", "");
    }
    if (TextUtils.isEmpty(aq.byte)) {
      aq.byte = au.jdMethod_do(paramContext, "clk", "");
    }
    if (TextUtils.isEmpty(aq.case)) {
      aq.case = au.jdMethod_do(paramContext, "php", "");
    }
    if (TextUtils.isEmpty(aq.else)) {
      aq.else = au.jdMethod_do(paramContext, "ins", "");
    }
    return (!TextUtils.isEmpty(aq.try)) && (!TextUtils.isEmpty(aq.byte)) && (!TextUtils.isEmpty(aq.case));
  }
