...
public class k
{
  ...
  private static final long kC = 60000L;
  private static final long kD = 3600000L;
  private static final long kE = 86400000L;
  ...
  {
    return c(paramInt1, paramInt2) + (kF.nextInt(paramInt3 + paramInt4) - paramInt3) * 1000L;
  }
  ...
  public static Object a(String paramString, c.a paramA)
  {
    try
    {
      paramString = com.appnext.base.a.a.aM().aP().ad(paramString);
  ...
  {
    return i.cy().getLong(paramString + "_lastupdate", 0L);
  }
  ...
  public static String aG(String paramString)
  {
    ...
    return i.cy().getString(paramString, null);
  }
  ...
  {
    Object localObject = e.cs().av(paramString);
    if ((localObject == null) || ("off".equalsIgnoreCase(((com.appnext.base.a.b.c)localObject).ba()))) {
      return true;
    }
    if (paramMap.isEmpty()) {
      return true;
    }
    String str2 = c.cp() + "/data";
    HashMap localHashMap = new HashMap();
    String str1 = g.u(d.getContext());
    localObject = str1;
    if (TextUtils.isEmpty(str1)) {
      localObject = i.cy().getString("google_ads_id", "");
    }
  ...
  public static void j(String paramString1, String paramString2)
  {
    ...
    i.cy().putString(paramString1, paramString2);
  }
