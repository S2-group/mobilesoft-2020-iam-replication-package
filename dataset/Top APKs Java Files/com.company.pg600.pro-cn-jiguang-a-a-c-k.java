...
public class k
{
  ...
  private static Set<String> a(ActivityManager paramActivityManager)
  {
    ...
    for (;;)
    {
      if (!paramActivityManager.hasNext()) {
        return localHashSet;
      }
  ...
  private static JSONArray a(ActivityManager paramActivityManager, PackageManager paramPackageManager)
  {
    ...
    for (;;)
    {
      ...
      {
        c.a(a, "getRunningApps error:" + paramActivityManager.getMessage());
        return localJSONArray1;
      }
      ActivityManager.RunningServiceInfo localRunningServiceInfo;
      if (localRunningServiceInfo.service.getPackageName().equals(localJSONException1.packageName))
      {
