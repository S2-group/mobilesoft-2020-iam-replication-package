...
public class y
{
  ...
  private y(c paramC)
  {
    ...
    {
      paramC = this.a;
      if (((paramC == null) || ((paramC instanceof ad))) && ((this.d.equals("stats")) || (this.d.equals("show")) || (this.d.equals("click")) || (this.d.equals("finish")) || (this.d.equals("install")))) {
        return;
      }
    }
    ...
    for (;;)
    {
      try
      {
        ...
        if ((r == null) || (r.length() == 0))
        {
          ...
          String str4 = paramSharedPreferences.getString("appKey", null);
          if (str4 == null) {
            return null;
          }
          String str2 = paramSharedPreferences.getString("advertisingId", null);
          String str3 = paramSharedPreferences.getString("advertisingTracking", null);
          localObject3 = str3;
          ...
          if (str2 == null)
          {
            ...
            if (!bool)
            {
              ...
              try
              {
                ...
                localObject3 = str3;
                str1 = str2;
                localObject1 = AdvertisingIdClient.getAdvertisingIdInfo(this.b);
                localObject3 = str3;
                str1 = str2;
                str2 = ((AdvertisingIdClient.Info)localObject1).getId();
                localObject3 = str3;
                str1 = str2;
                if (!((AdvertisingIdClient.Info)localObject1).isLimitAdTrackingEnabled()) {
                  break label842;
                }
                localObject1 = "0";
                ...
                localObject3 = localObject1;
                str1 = str2;
                paramSharedPreferences.putString("advertisingTracking", (String)localObject1);
                localObject3 = localObject1;
                str1 = str2;
          ...
          if (localObject1 == null) {
            paramSharedPreferences = az.l(this.b);
          }
          r.put("app_key", str4);
          ...
          try
          {
            localObject1 = localPackageManager.getPackageInfo(str1, 0);
            ...
            localObject1 = localPackageManager.getApplicationInfo(str1, 0);
          ...
          try
          {
            localObject2 = localPackageManager.getInstallerPackageName(str1);
          ...
          r.put("rooted", az.a());
          r.put("webview_version", az.t(this.b));
          r.put("multidex", az.b(new String[] { "android.support.multidex.MultiDex" }));
        }
  ...
  JSONObject a(SharedPreferences paramSharedPreferences)
  {
    ...
    try
    {
      ...
      Object localObject1 = az.b(this.b);
    ...
    if ((!h.l) && (h.k) && (this.z) && (((Calendar)localObject2).getTimeInMillis() < System.currentTimeMillis()))
    {
      h.l = true;
      try
      {
    ...
    if (this.h != null)
    {
      ...
      for (String str1 = this.h.a().toString();; str1 = this.h.d())
      {
        ...
        if (this.d.equals("show"))
        {
          ...
          paramSharedPreferences = "bidder_id";
        }
        else
        {
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      // Byte code:
      //   0: aload_0
      //   1: getfield 15	com/appodeal/ads/y$b:a	Lcom/appodeal/ads/y;
      //   4: getfield 32	com/appodeal/ads/y:b	Landroid/content/Context;
      //   7: ldc 34
      //   9: iconst_0
      //   10: invokevirtual 40	android/content/Context:getSharedPreferences	(Ljava/lang/String;I)Landroid/content/SharedPreferences;
      //   13: astore_2
      //   14: aload_0
      //   15: getfield 15	com/appodeal/ads/y$b:a	Lcom/appodeal/ads/y;
      //   18: aload_2
      //   19: invokevirtual 43	com/appodeal/ads/y:a	(Landroid/content/SharedPreferences;)Lorg/json/JSONObject;
      //   22: astore_2
      //   23: aload_2
      //   24: ifnonnull +16 -> 40
      //   27: aload_0
      //   28: getfield 15	com/appodeal/ads/y$b:a	Lcom/appodeal/ads/y;
      //   31: invokestatic 46	com/appodeal/ads/y:a	(Lcom/appodeal/ads/y;)Landroid/os/Handler;
      //   34: iconst_0
      //   35: invokevirtual 52	android/os/Handler:sendEmptyMessage	(I)Z
      //   38: pop
      //   39: return
      //   40: aload_0
      //   41: getfield 15	com/appodeal/ads/y$b:a	Lcom/appodeal/ads/y;
      //   44: invokevirtual 55	com/appodeal/ads/y:b	()Ljava/net/URL;
      //   47: astore 9
      //   49: aload_0
      //   50: getfield 15	com/appodeal/ads/y$b:a	Lcom/appodeal/ads/y;
      //   53: getfield 32	com/appodeal/ads/y:b	Landroid/content/Context;
      //   56: ldc 57
      //   58: iconst_0
      ...
      //   107: aload_0
      //   108: getfield 15	com/appodeal/ads/y$b:a	Lcom/appodeal/ads/y;
      //   111: invokestatic 80	com/appodeal/ads/y:b	(Lcom/appodeal/ads/y;)Ljavax/net/ssl/SSLSocketFactory;
      //   114: invokevirtual 84	javax/net/ssl/HttpsURLConnection:setSSLSocketFactory	(Ljavax/net/ssl/SSLSocketFactory;)V
      //   117: aload 4
      //   119: astore_3
      //   120: aload_0
      //   121: getfield 15	com/appodeal/ads/y$b:a	Lcom/appodeal/ads/y;
      //   124: getfield 88	com/appodeal/ads/y:A	Z
      //   127: ifeq +48 -> 175
      //   130: aload 4
      //   132: astore_3
      //   133: aload 10
      //   135: aload_0
      //   136: getfield 15	com/appodeal/ads/y$b:a	Lcom/appodeal/ads/y;
      //   139: getfield 92	com/appodeal/ads/y:d	Ljava/lang/String;
      ...
      //   320: aload_2
      //   321: invokestatic 169	com/appodeal/ads/az:a	(Ljava/io/OutputStream;Ljava/lang/String;)V
      //   324: aload 4
      //   326: astore_3
      //   327: aload 4
      //   329: invokevirtual 173	java/net/URLConnection:getInputStream	()Ljava/io/InputStream;
      //   332: invokestatic 176	com/appodeal/ads/az:a	(Ljava/io/InputStream;)Ljava/lang/String;
      //   335: astore 9
      //   337: aload 5
      //   339: astore_2
      //   340: aload 9
      ...
      //   377: astore_3
      //   378: aload_0
      //   379: getfield 15	com/appodeal/ads/y$b:a	Lcom/appodeal/ads/y;
      //   382: getfield 92	com/appodeal/ads/y:d	Ljava/lang/String;
      //   385: ldc -72
      ...
      //   600: aload_0
      //   601: getfield 15	com/appodeal/ads/y$b:a	Lcom/appodeal/ads/y;
      //   604: getfield 88	com/appodeal/ads/y:A	Z
      //   607: ifeq +71 -> 678
      //   610: aload 10
      //   612: aload_0
      //   613: getfield 15	com/appodeal/ads/y$b:a	Lcom/appodeal/ads/y;
      //   616: getfield 92	com/appodeal/ads/y:d	Ljava/lang/String;
      //   619: invokeinterface 98 2 0
      //   624: ifeq +54 -> 678
      //   627: aload_0
      //   628: getfield 15	com/appodeal/ads/y$b:a	Lcom/appodeal/ads/y;
      //   631: aload 10
      //   633: aload_0
      //   634: getfield 15	com/appodeal/ads/y$b:a	Lcom/appodeal/ads/y;
      //   637: getfield 92	com/appodeal/ads/y:d	Ljava/lang/String;
      //   640: invokevirtual 200	com/appodeal/ads/y:a	(Landroid/content/SharedPreferences;Ljava/lang/String;)Z
      //   643: ifeq +35 -> 678
      ...
      //   658: aload 10
      //   660: aload_0
      //   661: getfield 15	com/appodeal/ads/y$b:a	Lcom/appodeal/ads/y;
      //   664: getfield 92	com/appodeal/ads/y:d	Ljava/lang/String;
      //   667: ldc -47
      //   669: invokeinterface 213 3 0
      //   674: astore_2
      //   675: goto +47 -> 722
      //   678: aload_0
      //   679: getfield 15	com/appodeal/ads/y$b:a	Lcom/appodeal/ads/y;
      //   682: invokestatic 46	com/appodeal/ads/y:a	(Lcom/appodeal/ads/y;)Landroid/os/Handler;
      //   685: iconst_0
      ...
      //   692: astore_2
      //   693: aload_0
      //   694: getfield 15	com/appodeal/ads/y$b:a	Lcom/appodeal/ads/y;
      //   697: getfield 88	com/appodeal/ads/y:A	Z
      //   700: ifeq +22 -> 722
      //   703: aload_0
      //   704: getfield 15	com/appodeal/ads/y$b:a	Lcom/appodeal/ads/y;
      //   707: aload 10
      //   709: aload_0
      //   710: getfield 15	com/appodeal/ads/y$b:a	Lcom/appodeal/ads/y;
      //   713: getfield 92	com/appodeal/ads/y:d	Ljava/lang/String;
      //   716: aload_3
      //   717: invokevirtual 216	com/appodeal/ads/y:a	(Landroid/content/SharedPreferences;Ljava/lang/String;Ljava/lang/String;)V
      //   720: aload_3
      //   721: astore_2
      ...
      //   730: astore_3
      //   731: aload_0
      //   732: getfield 15	com/appodeal/ads/y$b:a	Lcom/appodeal/ads/y;
      //   735: getfield 88	com/appodeal/ads/y:A	Z
      //   738: ifeq +13 -> 751
      //   741: aload_2
      ...
      //   755: aload_0
      //   756: getfield 15	com/appodeal/ads/y$b:a	Lcom/appodeal/ads/y;
      //   759: getfield 88	com/appodeal/ads/y:A	Z
      //   762: ifeq +115 -> 877
      //   765: aload_0
      //   766: getfield 15	com/appodeal/ads/y$b:a	Lcom/appodeal/ads/y;
      //   769: getfield 32	com/appodeal/ads/y:b	Landroid/content/Context;
      //   772: aload_3
      //   773: ldc -26
      ...
      //   781: aload_0
      //   782: getfield 15	com/appodeal/ads/y$b:a	Lcom/appodeal/ads/y;
      //   785: getfield 32	com/appodeal/ads/y:b	Landroid/content/Context;
      //   788: aload_3
      //   789: ldc -15
      ...
      //   806: invokestatic 253	com/appodeal/ads/f:a	(Landroid/content/Context;Lorg/json/JSONObject;ZZ)V
      //   809: aload_0
      ...
      //   824: aload_0
      //   825: getfield 15	com/appodeal/ads/y$b:a	Lcom/appodeal/ads/y;
      //   828: getfield 92	com/appodeal/ads/y:d	Ljava/lang/String;
      //   831: invokevirtual 263	com/appodeal/ads/y:a	(Landroid/content/SharedPreferences;ILjava/lang/String;)V
      //   834: aload_0
      //   835: getfield 15	com/appodeal/ads/y$b:a	Lcom/appodeal/ads/y;
      //   838: aload_3
      //   839: invokestatic 266	com/appodeal/ads/y:a	(Lcom/appodeal/ads/y;Lorg/json/JSONObject;)V
      //   842: aload_3
      //   843: ldc_w 268
      ...
      //   877: aload_0
      //   878: getfield 15	com/appodeal/ads/y$b:a	Lcom/appodeal/ads/y;
      //   881: invokestatic 46	com/appodeal/ads/y:a	(Lcom/appodeal/ads/y;)Landroid/os/Handler;
      //   884: iconst_1
      //   885: aload_3
      //   886: invokevirtual 292	android/os/Handler:obtainMessage	(ILjava/lang/Object;)Landroid/os/Message;
      //   889: astore_2
      //   890: aload_0
      //   891: getfield 15	com/appodeal/ads/y$b:a	Lcom/appodeal/ads/y;
      //   894: invokestatic 46	com/appodeal/ads/y:a	(Lcom/appodeal/ads/y;)Landroid/os/Handler;
      //   897: aload_2
      ...
      //   908: aload_0
      //   909: getfield 15	com/appodeal/ads/y$b:a	Lcom/appodeal/ads/y;
      //   912: invokestatic 46	com/appodeal/ads/y:a	(Lcom/appodeal/ads/y;)Landroid/os/Handler;
      //   915: iconst_0
      ...
      //   922: astore_3
      //   923: aload_0
      //   924: getfield 15	com/appodeal/ads/y$b:a	Lcom/appodeal/ads/y;
      //   927: invokestatic 46	com/appodeal/ads/y:a	(Lcom/appodeal/ads/y;)Landroid/os/Handler;
      //   930: iconst_0
      ...
      //   984: ifeq +20 -> 1004
      //   987: aload_3
      //   988: checkcast 189	java/net/HttpURLConnection
      //   991: invokevirtual 190	java/net/HttpURLConnection:disconnect	()V
      //   994: goto +10 -> 1004
      //   997: aload_3
      //   998: checkcast 77	javax/net/ssl/HttpsURLConnection
      //   1001: invokevirtual 187	javax/net/ssl/HttpsURLConnection:disconnect	()V
      //   1004: aload_2
      //   1005: athrow
      //   1006: astore_2
      //   1007: aload_2
      ...
      //   1011: aload_0
      //   1012: getfield 15	com/appodeal/ads/y$b:a	Lcom/appodeal/ads/y;
      //   1015: invokestatic 46	com/appodeal/ads/y:a	(Lcom/appodeal/ads/y;)Landroid/os/Handler;
      //   1018: iconst_0
      ...
      //   973	994	1006	java/lang/Exception
      //   997	1004	1006	java/lang/Exception
