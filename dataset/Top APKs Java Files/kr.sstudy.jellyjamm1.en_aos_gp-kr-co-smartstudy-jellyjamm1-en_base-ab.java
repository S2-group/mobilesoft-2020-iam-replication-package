package kr.co.smartstudy.jellyjamm1.en_base;
...
import kr.co.smartstudy.halib.k;
...
public class ab
{
  ...
  {
    return a.getSharedPreferences("bodlebookiap_pref", 0).getInt(paramString, paramInt);
  }
  ...
  public static void a(Context paramContext)
  {
    ...
    if ((b.Y != null) && (!b.Y.equals(""))) {
      localConfiguration.locale = new Locale(b.Y, localConfiguration.locale.getCountry(), localConfiguration.locale.getVariant());
    }
    if ((d.b.booleanValue()) && ((localConfiguration.screenLayout & 0xF) < 4))
    {
  ...
  {
    k localK = k.a(l.a(), a.getResources(), paramInt2, false, true);
    paramView = (ImageView)paramView.findViewById(paramInt1);
    paramView.setImageDrawable(localK);
