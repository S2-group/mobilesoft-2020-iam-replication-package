    ...
    d.a().execute(new Runnable()
    {
      public final void run()
      {
        ...
        if (Utils.a())
        {
          ...
          ((StringBuilder)localObject1).append(j.a());
        }
        for (Object localObject2 = "gtc/amazon.json";; localObject2 = "gtc/android.json")
        {
        ...
        localObject2 = this.a.getSharedPreferences("com.heyzap.sdk.ads", 0);
        long l = ((SharedPreferences)localObject2).getLong("last_checked_packages", 0L);
        System.currentTimeMillis();
        if ((!Utils.isDebug(this.a).booleanValue()) && (!Utils.a(Long.valueOf(l), j.b()).booleanValue())) {
          return;
        }
        a.a(this.a, (String)localObject1, new com.heyzap.c.j(), new g()
        {
          public final void onSuccess(int paramAnonymous2Int, Header[] paramAnonymous2ArrayOfHeader, JSONObject paramAnonymous2JSONObject)
          {
            for (;;)
            {
              try
              {
                ...
                paramAnonymous2ArrayOfHeader = this.a.edit();
