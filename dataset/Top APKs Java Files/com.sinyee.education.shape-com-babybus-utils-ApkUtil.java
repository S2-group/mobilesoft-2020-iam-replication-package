...
public class ApkUtil
{
  ...
  public static void launchApp(String paramString, boolean paramBoolean)
  {
    ...
    localObject = (ResolveInfo)App.get().getApplicationContext().getPackageManager().queryIntentActivities((Intent)localObject, 0).iterator().next();
    if (localObject != null)
    {
      ...
      App.get().getApplicationContext().startActivity(localIntent);
    }
    if (paramBoolean) {
      App.get().exit();
    }
