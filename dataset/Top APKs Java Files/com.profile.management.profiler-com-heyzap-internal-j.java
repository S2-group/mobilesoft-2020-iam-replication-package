  ...
  public static void a(Context paramContext)
  {
    d.a().execute(new Runnable()
    {
      public final void run()
      {
        ...
        a.a(this.a, str, new com.heyzap.a.j(), new g()
        {
          public final void onSuccess(int paramAnonymous2Int, Header[] paramAnonymous2ArrayOfHeader, JSONObject paramAnonymous2JSONObject)
          {
            ...
            for (;;)
            {
              ...
              else
              {
                if (i != 0)
                {
                  localObject1 = new com.heyzap.a.j();
                  ((com.heyzap.a.j)localObject1).a("version", paramAnonymous2ArrayOfHeader);
                  ((com.heyzap.a.j)localObject1).a("data", Base64.encodeToString(paramAnonymous2JSONObject, 2));
                  a.d(j.1.this.a, j.a() + "aip", (com.heyzap.a.j)localObject1, new g()
                  {
