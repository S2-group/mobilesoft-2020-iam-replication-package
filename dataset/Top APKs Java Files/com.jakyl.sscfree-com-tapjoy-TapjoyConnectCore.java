...
public class TapjoyConnectCore
{
  ...
  private void checkAdvertisingID()
  {
    // Byte code:
    //   0: ldc_w 375
    //   3: invokestatic 381	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   6: astore_1
    //   7: ldc 28
    //   9: new 269	java/lang/StringBuilder
    //   12: dup
    //   13: ldc_w 383
    //   16: invokespecial 274	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   19: aload_1
    //   20: invokevirtual 282	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   23: invokevirtual 286	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   26: invokestatic 292	com/tapjoy/TapjoyLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   29: getstatic 107	com/tapjoy/TapjoyConnectCore:context	Landroid/content/Context;
    //   32: invokevirtual 261	android/content/Context:getPackageManager	()Landroid/content/pm/PackageManager;
    //   35: getstatic 107	com/tapjoy/TapjoyConnectCore:context	Landroid/content/Context;
    //   38: invokevirtual 386	android/content/Context:getPackageName	()Ljava/lang/String;
    //   41: sipush 128
    //   44: invokevirtual 392	android/content/pm/PackageManager:getApplicationInfo	(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    //   47: getfield 398	android/content/pm/ApplicationInfo:metaData	Landroid/os/Bundle;
    //   50: ldc_w 400
    //   53: invokevirtual 406	android/os/Bundle:getInt	(Ljava/lang/String;)I
    //   56: pop
    //   57: return
    //   58: astore_1
    //   59: new 240	com/tapjoy/TapjoyIntegrationException
    //   62: dup
    //   63: ldc_w 408
    //   66: invokespecial 409	com/tapjoy/TapjoyIntegrationException:<init>	(Ljava/lang/String;)V
    //   69: athrow
    //   70: astore_1
    //   71: new 240	com/tapjoy/TapjoyIntegrationException
    //   74: dup
    //   75: ldc_w 411
    //   78: invokespecial 409	com/tapjoy/TapjoyIntegrationException:<init>	(Ljava/lang/String;)V
    //   81: athrow
  ...
  {
    TapjoyLog.i("TapjoyConnect", "Initializing Threatmetrix: " + amj.a);
    this.profile = new amj();
    try
    {
      this.profile.a(new amd()
      {
        public void complete()
        {
          try
          {
            if (TapjoyConnectCore.this.profile.c() == amj.a.b)
            {
              TapjoyConnectCore.access$102(TapjoyConnectCore.this.profile.b());
              return;
            }
      ...
      this.profile.a();
      this.profile.a(context, "rrx68giz", "h.online-metrix.net", "http://content-js.tapjoy.com");
      return;
    }
    ...
    new Thread(new Runnable()
    {
      public void run()
      {
        for (;;)
        {
          try
          {
            Object localObject = Class.forName("bo");
  ...
  public String getSerial()
  {
    ...
    //   3: invokestatic 381	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   6: ldc_w 1508
    //   9: invokevirtual 1512	java/lang/Class:getDeclaredField	(Ljava/lang/String;)Ljava/lang/reflect/Field;
    //   12: astore_1
    //   13: aload_1
    //   14: invokevirtual 1517	java/lang/reflect/Field:isAccessible	()Z
    //   17: ifne +8 -> 25
    //   20: aload_1
    //   21: iconst_1
    //   22: invokevirtual 1520	java/lang/reflect/Field:setAccessible	(Z)V
    //   25: aload_1
    //   26: ldc_w 1123
    //   29: invokevirtual 1521	java/lang/reflect/Field:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   32: invokevirtual 627	java/lang/Object:toString	()Ljava/lang/String;
    //   35: astore_1
    //   36: ldc 28
    //   38: new 269	java/lang/StringBuilder
    //   41: dup
    //   42: ldc_w 1523
    //   45: invokespecial 274	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   48: aload_1
    //   49: invokevirtual 306	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   52: invokevirtual 286	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   55: invokestatic 292	com/tapjoy/TapjoyLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   58: aload_1
    //   59: areturn
    //   60: astore_2
    //   61: aconst_null
    ...
    //   63: ldc 28
    //   65: aload_2
    //   66: invokevirtual 495	java/lang/Exception:toString	()Ljava/lang/String;
    //   69: invokestatic 497	com/tapjoy/TapjoyLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   72: aload_1
    //   73: areturn
    //   74: astore_2
    //   75: goto -12 -> 63
