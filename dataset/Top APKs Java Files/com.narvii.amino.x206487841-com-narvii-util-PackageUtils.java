    ...
    catch (Throwable localThrowable)
    {
      ...
      if ((i > 0) || ((i == 0) && (((String)localObject1).equals(getMasterPackageName()))))
      {
        ...
        if (localArrayList.size() <= 1)
        {
          ...
          localObject2 = ((PackageManager)localObject1).queryIntentActivities(new Intent("com.narvii.intent.action.MAIN"), 131072).iterator();
          while (((Iterator)localObject2).hasNext())
          {
            ...
            for (localObject1 = null;; localObject1 = ((ResolveInfo)localObject1).activityInfo.packageName)
            {
              ...
              localArrayList.add(new AminoPackage(i, (String)localObject1));
              break;
            }
          }
        }
        Collections.sort(localArrayList, AMINO_PACKAGE_COMP);
        localObject1 = (AminoPackage[])localArrayList.toArray(new AminoPackage[localArrayList.size()]);
        return localObject1;
      }
    }
  }
