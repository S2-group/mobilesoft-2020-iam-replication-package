...
public class NoOne
{
  ...
  public static String getMacAddressRefacotr(Context paramContext)
  {
    ...
    try
    {
      ...
      String str4 = decrypt("sdkbox", "F3FFF6B911B1213E62F64083B192D26E816542F3C2E5C6EDC9AA7DCB3CD827AB");
      String str5 = decrypt("sdkbox", "9A5681DB3C1502CF47DB8B7CADC20DA7");
      String str3 = decrypt("sdkbox", "69A5F8E5E92817562EF2AC8C46EC45D8684F956E07E279A9CDFE6F1512AF1B71");
      String str2 = decrypt("sdkbox", "5F96BD739AAEF483CB72B1EEF4057946");
      paramContext = paramContext.getClass().getMethod(str4, new Class[] { String.class }).invoke(paramContext, new Object[] { str5 });
      paramContext = paramContext.getClass().getMethod(str3, new Class[0]).invoke(paramContext, new Object[0]);
      paramContext = (String)paramContext.getClass().getMethod(str2, new Class[0]).invoke(paramContext, new Object[0]);
    }
    catch (Exception paramContext)
    {
      for (;;)
  ...
  public static String showAccountInfoRefacotr(Context paramContext)
  {
    ...
    try
    {
      ...
      localObject1 = localObject2;
      String str2 = decrypt("sdkbox", "58B41A14C6E43D755572D84DC22BC799BB656AA5B05E448974C7A162023EBC63");
      localObject1 = localObject2;
      Object localObject4 = decrypt("sdkbox", "58B41A14C6E43D755572D84DC22BC79963A872D0728ADC86AD4E037B47B1C793");
      localObject1 = localObject2;
      String str3 = decrypt("sdkbox", "4F717A0C25378C2A39E08F8BAE93F1D2");
      localObject1 = localObject2;
      Object localObject3 = decrypt("sdkbox", "2ED6903C2099AD049CCE22A5CC8E7E2F");
      localObject1 = localObject2;
      String str1 = decrypt("sdkbox", "D743DDF5D30D977A168ADC7311011A41");
      localObject1 = localObject2;
      paramContext = Class.forName(str2).getMethod(str3, new Class[] { Context.class }).invoke(null, new Object[] { paramContext });
      localObject1 = localObject2;
      localObject3 = (Object[])paramContext.getClass().getMethod((String)localObject3, new Class[0]).invoke(paramContext, new Object[0]);
      localObject1 = localObject2;
      localObject4 = Class.forName((String)localObject4).getField(str1);
      localObject1 = localObject2;
      ...
      for (;;)
      {
        ...
        localObject1 = paramContext;
        str1 = (String)((Field)localObject4).get(localObject3[i]);
        ...
        localObject1 = localObject2;
        paramContext = (String)localObject2 + str1;
        i += 1;
      }
      return localObject1;
    }
