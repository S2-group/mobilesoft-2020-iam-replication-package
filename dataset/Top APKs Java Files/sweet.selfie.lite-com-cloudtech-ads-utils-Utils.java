...
public class Utils
{
  ...
  public static String a(Context paramContext)
  {
    ...
    //   3: ifnull +11 -> 14
    //   6: ldc 99
    //   8: invokestatic 102	com/cloudtech/ads/utils/Utils:b	(Ljava/lang/String;)Z
    //   11: ifeq +30 -> 41
    //   14: ldc 104
    //   16: iconst_1
    ...
    //   28: invokestatic 115	com/cloudtech/ads/utils/YeLog:e	(Ljava/lang/String;)V
    //   31: iconst_0
    //   32: istore_1
    //   33: iload_1
    //   34: ifne +25 -> 59
    ...
    //   41: aload_0
    //   42: ldc 99
    //   44: invokestatic 121	android/os/Process:myPid	()I
    //   47: invokestatic 124	android/os/Process:myUid	()I
    //   50: invokevirtual 128	android/content/Context:checkPermission	(Ljava/lang/String;II)I
    //   53: ifne -22 -> 31
    //   56: goto -23 -> 33
    //   59: aload_0
    //   60: ldc -126
    //   62: invokevirtual 134	android/content/Context:getSystemService	(Ljava/lang/String;)Ljava/lang/Object;
    //   65: checkcast 136	android/telephony/TelephonyManager
    //   68: astore_2
    //   69: aload_2
    //   70: ifnull +61 -> 131
    //   73: aload_2
    //   74: invokevirtual 140	android/telephony/TelephonyManager:getDeviceId	()Ljava/lang/String;
    //   77: astore_2
    //   78: aload_2
    //   79: astore_3
    //   80: aload_2
    //   81: invokestatic 146	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   84: ifeq -45 -> 39
    //   87: aload_0
    //   88: invokevirtual 150	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   91: ldc -104
    //   93: invokestatic 158	android/provider/Settings$Secure:getString	(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;
    //   96: astore_0
    //   97: aload_0
    //   98: areturn
    //   99: astore_0
    //   100: ldc 19
    //   102: astore_2
    //   103: new 160	java/lang/StringBuilder
    //   106: dup
    //   107: ldc -94
    //   109: invokespecial 164	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   112: aload_0
    //   113: invokevirtual 167	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   116: invokevirtual 171	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   119: invokevirtual 174	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   122: invokestatic 115	com/cloudtech/ads/utils/YeLog:e	(Ljava/lang/String;)V
    //   125: aload_2
    //   126: areturn
    //   127: astore_0
    //   128: goto -25 -> 103
  ...
  private static ArrayList<String> a(String[] paramArrayOfString)
  {
    ...
    //   8: ldc -75
    //   10: ldc -73
    //   12: invokestatic 187	com/cloudtech/ads/utils/YeLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   15: invokestatic 193	java/lang/Runtime:getRuntime	()Ljava/lang/Runtime;
    //   18: aload_0
    //   19: invokevirtual 197	java/lang/Runtime:exec	([Ljava/lang/String;)Ljava/lang/Process;
    //   22: astore_0
    //   23: new 199	java/io/BufferedWriter
    //   26: dup
    //   27: new 201	java/io/OutputStreamWriter
    //   30: dup
    //   31: aload_0
    //   32: invokevirtual 207	java/lang/Process:getOutputStream	()Ljava/io/OutputStream;
    //   35: invokespecial 210	java/io/OutputStreamWriter:<init>	(Ljava/io/OutputStream;)V
    //   38: invokespecial 213	java/io/BufferedWriter:<init>	(Ljava/io/Writer;)V
    //   41: pop
    //   42: new 215	java/io/BufferedReader
    //   45: dup
    //   46: new 217	java/io/InputStreamReader
    //   49: dup
    //   50: aload_0
    //   51: invokevirtual 221	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    ...
    //   60: astore_0
    //   61: aload_0
    //   62: invokevirtual 230	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   65: astore_2
    //   66: aload_2
    //   67: ifnull +38 -> 105
    //   70: ldc -75
    ...
    //   88: invokestatic 187	com/cloudtech/ads/utils/YeLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   91: aload_1
    //   92: aload_2
    //   93: invokevirtual 236	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   96: pop
    //   97: goto -36 -> 61
    //   100: astore_0
    //   101: aload_0
    //   102: invokevirtual 239	java/lang/Exception:printStackTrace	()V
    //   105: ldc -75
    //   107: new 160	java/lang/StringBuilder
    //   110: dup
    //   111: ldc -15
    //   113: invokespecial 164	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   116: aload_1
    //   117: invokevirtual 244	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   120: invokevirtual 174	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   123: invokestatic 187	com/cloudtech/ads/utils/YeLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   126: aload_1
    //   127: areturn
    //   128: astore_0
    //   129: aconst_null
  ...
  {
    // Byte code:
    //   0: getstatic 655	com/cloudtech/ads/utils/Utils:h	Ljava/lang/String;
    //   3: invokestatic 146	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   6: ifeq +35 -> 41
    //   9: new 657	android/webkit/WebView
    //   12: dup
    //   13: aload_0
    //   14: invokespecial 659	android/webkit/WebView:<init>	(Landroid/content/Context;)V
    //   17: astore_1
    //   18: aload_1
    //   19: astore_0
    //   20: aload_1
    //   21: invokevirtual 663	android/webkit/WebView:getSettings	()Landroid/webkit/WebSettings;
    //   24: invokevirtual 668	android/webkit/WebSettings:getUserAgentString	()Ljava/lang/String;
    //   27: invokevirtual 672	java/lang/String:getBytes	()[B
    //   30: iconst_0
    //   31: invokestatic 676	android/util/Base64:encodeToString	([BI)Ljava/lang/String;
    //   34: putstatic 655	com/cloudtech/ads/utils/Utils:h	Ljava/lang/String;
    //   37: aload_1
    //   38: invokevirtual 679	android/webkit/WebView:destroy	()V
    //   41: getstatic 655	com/cloudtech/ads/utils/Utils:h	Ljava/lang/String;
    //   44: areturn
    //   45: astore_2
    //   46: aconst_null
    //   47: astore_1
    ...
    //   49: astore_0
    //   50: aload_2
    //   51: invokevirtual 239	java/lang/Exception:printStackTrace	()V
    //   54: aload_1
    //   55: ifnull -14 -> 41
    //   58: aload_1
    //   59: invokevirtual 679	android/webkit/WebView:destroy	()V
    //   62: goto -21 -> 41
    //   65: astore_1
    //   66: aconst_null
    //   67: astore_0
    ...
    //   69: ifnull +7 -> 76
    //   72: aload_0
    //   73: invokevirtual 679	android/webkit/WebView:destroy	()V
    //   76: aload_1
    //   77: athrow
    //   78: astore_1
    //   79: goto -11 -> 68
