  ...
  extends cn.sharesdk.framework.e
{
  ...
  private void b(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, PlatformActionListener paramPlatformActionListener)
  {
    for (;;)
    {
      ...
      if (i != 0)
      {
        ...
        paramString2 = new com.mob.tools.b.g().a(paramString1);
    ...
    if ((paramBoolean1) && (a()))
    {
      ...
      if (!TextUtils.isEmpty(paramString4))
      {
        ...
        if (((File)localObject2).exists())
        {
          ...
          {
            localObject2 = new File(j.e(this.a.getContext(), "images"), System.currentTimeMillis() + ((File)localObject2).getName()).getAbsolutePath();
            localObject1 = paramString4;
            if (j.a(paramString4, (String)localObject2)) {
  ...
  public HashMap<String, Object> c(String paramString)
  {
    ...
    if (localObject1 != null)
    {
      paramString = localObject2;
      if (((String)localObject1).length() > 0) {
        paramString = new com.mob.tools.b.g().a((String)localObject1);
      }
    }
    return paramString;
  }
  ...
  public HashMap<String, Object> e(String paramString)
  {
    ...
    if (localObject2 != null)
    {
      ...
      if (((String)localObject2).length() > 0) {
        paramString = new com.mob.tools.b.g().a((String)localObject2);
      }
    }
    return paramString;
  }
