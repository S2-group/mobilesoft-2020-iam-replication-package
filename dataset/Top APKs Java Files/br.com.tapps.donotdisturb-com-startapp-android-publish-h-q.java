...
public class q
{
  ...
  {
    k.a("SimpleToken", 3, "createSimpleToken entered");
    paramContext = new a().a(b(paramContext));
    k.a("SimpleToken", 3, "simpleToken : [" + paramContext + "]");
    return paramContext;
  }
  ...
  private static List<PackageInfo> c(Context paramContext)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (!localPackageInfo.packageName.equals(d.i)) {
          continue;
        }
      }
      catch (RuntimeException localRuntimeException)
      {
        k.a("SimpleToken", 6, "Could not complete getInstalledPackages", localRuntimeException);
        return paramContext;
      }
      a = true;
    }
