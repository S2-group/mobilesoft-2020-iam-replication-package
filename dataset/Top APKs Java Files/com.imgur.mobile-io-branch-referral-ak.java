...
class ak
{
  ...
  public String a(String paramString)
  {
    ...
    //   17: astore_2
    //   18: aload_0
    //   19: invokespecial 53	io/branch/referral/ak:r	()Z
    //   22: ifne +125 -> 147
    //   25: aload_0
    //   26: getfield 15	io/branch/referral/ak:a	Landroid/content/Context;
  ...
  {
    Object localObject = n.a(this.a);
    String str = d();
    if ("bnc_no_value".equals(((n)localObject).e()))
    {
      if (paramBoolean) {
        ((n)localObject).a(str);
      }
      ...
      else
      {
        try
        {
          ...
          for (localObject = null;; localObject = ((CharSequence)localObject).toString())
          {
            ...
            if (localObject != null)
            {
              localJSONObject.put(l.a.I.a(), localObject);
              localObject = a((String)localObject);
              if (!((String)localObject).equals("bnc_no_value")) {
                localJSONObject.put(l.a.H.a(), localObject);
              }
            }
