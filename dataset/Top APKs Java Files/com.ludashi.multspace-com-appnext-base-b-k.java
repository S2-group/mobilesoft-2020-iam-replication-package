...
public class k
{
  ...
  {
    Object localObject = e.bS().av(paramString);
    ...
    catch (Throwable localThrowable)
    {
      ...
      l.k(paramString, "-------Sending to server data for key = " + paramString + " ----------");
      ...
      try
      {
        paramMap = com.appnext.core.f.a(str2, localHashMap, false, 15000);
        l.k(paramString, "result send data: " + paramMap);
        return true;
      }
  ...
  public static List l(Context paramContext)
  {
