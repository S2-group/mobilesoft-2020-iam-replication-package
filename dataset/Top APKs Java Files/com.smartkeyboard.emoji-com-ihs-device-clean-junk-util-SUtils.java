...
import com.smartkeyboard.emoji.clf;
import com.smartkeyboard.emoji.cqa;
import com.smartkeyboard.emoji.csu;
import com.smartkeyboard.emoji.eu;
...
public class SUtils
{
  ...
  public static byte[] b(Context paramContext, String paramString)
  {
    ...
    //   45: astore_1
    //   46: aload_1
    //   47: invokestatic 88	com/smartkeyboard/emoji/clf:a	(Ljava/lang/Throwable;)V
    //   50: aload_0
    //   51: areturn
    //   52: astore 4
    //   54: aconst_null
    ...
    //   59: astore_3
    //   60: aload 4
    //   62: invokestatic 88	com/smartkeyboard/emoji/clf:a	(Ljava/lang/Throwable;)V
    //   65: aload_0
    //   66: astore_3
    //   67: aload_1
    //   68: ifnull -25 -> 43
    ...
    //   77: astore_1
    //   78: aload_1
    //   79: invokestatic 88	com/smartkeyboard/emoji/clf:a	(Ljava/lang/Throwable;)V
    //   82: aload_0
    //   83: areturn
    //   84: astore_0
    //   85: aconst_null
    ...
    //   97: astore_1
    //   98: aload_1
    //   99: invokestatic 88	com/smartkeyboard/emoji/clf:a	(Ljava/lang/Throwable;)V
    //   102: goto -7 -> 95
    //   105: astore_0
    //   106: goto -19 -> 87
    //   109: astore 4
  ...
  public static HashSet<String> c()
  {
    ...
    try
    {
      localObject2 = cqa.a().getPackageManager().getInstalledPackages(128);
  ...
  {
    return eu.a(paramContext, "android.permission.WRITE_EXTERNAL_STORAGE") == 0;
  }
}
