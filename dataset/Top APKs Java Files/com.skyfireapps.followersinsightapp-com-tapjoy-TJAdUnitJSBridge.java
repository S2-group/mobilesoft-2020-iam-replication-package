...
public class TJAdUnitJSBridge
{
  ...
  public TJAdUnitJSBridge(Context paramContext, WebView paramWebView, TJPlacementData paramTJPlacementData)
  {
    ...
    this.a = new TJWebViewJSInterface(this.d, new TJAdUnitJSBridge.1(this));
      ...
      if (m < paramJSONObject.length())
      {
        ...
        try
        {
          for (;;)
          {
            ...
            ((AlertDialog)localObject1).setButton(k, (CharSequence)((ArrayList)localObject2).get(m), new TJAdUnitJSBridge.2(this, paramString));
            m += 1;
            break;
            k = -2;
            continue;
  ...
  public void displayRichMedia(JSONObject paramJSONObject, String paramString)
  {
    ...
    catch (Exception localException1)
    {
      ...
      catch (Exception localException2)
      {
        ...
        if (bool)
        {
          ((Activity)this.c).runOnUiThread(new TJAdUnitJSBridge.3(this, paramJSONObject));
          return;
        }
  ...
  public void getLocation(JSONObject paramJSONObject, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.h == null) {
          this.h = new TJAdUnitJSBridge.4(this);
        }
        if (bool) {
  ...
  {
    ((Activity)this.c).runOnUiThread(new TJAdUnitJSBridge.5(this, paramJSONObject, paramString));
  }
  ...
  public void present(JSONObject paramJSONObject, String paramString)
  {
    // Byte code:
    //   0: iconst_0
    //   1: invokestatic 518	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   4: astore_3
    //   5: aload_1
    //   6: ldc_w 653
    //   9: invokevirtual 194	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   12: invokestatic 595	java/lang/Boolean:valueOf	(Ljava/lang/String;)Ljava/lang/Boolean;
    //   15: astore 5
    //   17: aload_1
    //   18: ldc_w 655
    //   21: invokevirtual 194	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   24: invokestatic 595	java/lang/Boolean:valueOf	(Ljava/lang/String;)Ljava/lang/Boolean;
    //   27: astore 4
    //   29: aload 4
    //   31: astore_3
    //   32: aload_0
    ...
    //   40: invokestatic 595	java/lang/Boolean:valueOf	(Ljava/lang/String;)Ljava/lang/Boolean;
    //   43: invokevirtual 598	java/lang/Boolean:booleanValue	()Z
    //   46: putfield 48	com/tapjoy/TJAdUnitJSBridge:customClose	Z
    //   49: new 658	com/tapjoy/TJAdUnitJSBridge$a
    //   52: dup
    //   53: aload_0
    //   54: aload_0
    //   55: getfield 67	com/tapjoy/TJAdUnitJSBridge:d	Landroid/webkit/WebView;
    //   58: invokespecial 661	com/tapjoy/TJAdUnitJSBridge$a:<init>	(Lcom/tapjoy/TJAdUnitJSBridge;Landroid/webkit/WebView;)V
    //   61: iconst_2
    //   62: anewarray 226	java/lang/Boolean
    //   65: dup
    //   66: iconst_0
    //   67: aload 5
    //   69: aastore
    ...
    //   72: aload_3
    //   73: aastore
    //   74: invokevirtual 665	com/tapjoy/TJAdUnitJSBridge$a:execute	([Ljava/lang/Object;)Landroid/os/AsyncTask;
    //   77: pop
    //   78: aload_0
    //   79: aload_2
    //   80: iconst_1
    ...
    //   84: dup
    //   85: iconst_0
    //   86: getstatic 344	java/lang/Boolean:TRUE	Ljava/lang/Boolean;
    //   89: aastore
    //   90: invokevirtual 234	com/tapjoy/TJAdUnitJSBridge:invokeJSCallback	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   93: return
    //   94: astore_1
    //   95: aload_0
    //   96: aload_2
    ...
    //   101: dup
    //   102: iconst_0
    //   103: getstatic 230	java/lang/Boolean:FALSE	Ljava/lang/Boolean;
    //   106: aastore
    //   107: invokevirtual 234	com/tapjoy/TJAdUnitJSBridge:invokeJSCallback	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   110: aload_1
    //   111: invokevirtual 152	java/lang/Exception:printStackTrace	()V
    //   114: return
    //   115: astore_1
    //   116: goto -67 -> 49
    //   119: astore 4
  ...
  public void setCloseButtonVisible(JSONObject paramJSONObject, String paramString)
  {
    ...
    try
    {
      ...
      ((Activity)this.c).runOnUiThread(new TJAdUnitJSBridge.6(this, bool));
      invokeJSCallback(paramString, new Object[] { Boolean.TRUE });
      return;
    }
    catch (Exception paramJSONObject)
