  ...
  implements agl.b
{
  ...
  {
    String str = this.r.getString("clock_application", "");
    int i = 0;
    if (!"".equals(str)) {
      try
      {
    ...
    try
    {
      ...
      if ((this.q == null) || (this.q.isEmpty())) {
        runOnUiThread(new Runnable()
        {
          ...
          {
            Toast.makeText(ChooseClockSettings.a(ChooseClockSettings.this), 2131689512, 1).show();
          }
        });
      }
      localObject = this.q;
  ...
  public final void b(int paramInt)
  {
    try
    {
      ...
      this.r.edit().putString("clock_application", localA.c).apply();
      return;
    }
    catch (Throwable localThrowable)
    {
