...
final class bd
{
  private static Map<String, String> a(Context paramContext)
  {
    for (;;)
    {
      ...
      {
        o.e("PackageGatherer", new Object[] { "Unable to get packages", paramContext });
        return null;
      }
    }
    return paramContext;
  ...
  public static void a(Context paramContext, ap paramAp)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (((Iterator)localObject2).hasNext())
        {
          ...
          try
          {
            ...
            ((List)localObject1).add(new aa("process_" + i, localJSONObject.toString()));
            o.a("PackageGatherer", new Object[] { "Running process: " + ((ActivityManager.RunningAppProcessInfo)localObject3).processName + ": " + localJSONObject });
            i += 1;
          }
          catch (JSONException localJSONException2)
          {
            o.a("PackageGatherer", new Object[] { "Error saving running package list" });
            continue;
          }
        }
        paramAp.a("running_tasks", localArrayList, true);
      }
      catch (SecurityException paramContext)
      {
        o.e("PackageGatherer", new Object[] { "SecurityException: Do you have the right permission?", paramContext });
        return;
        paramAp.a("running_apps", (List)localObject1, true);
        ...
        if (((Iterator)localObject1).hasNext())
        {
          ...
          try
          {
            ...
            localArrayList.add(new aa("task_" + i, ((JSONObject)localObject2).toString()));
            o.a("PackageGatherer", new Object[] { "Running task: " + (String)localObject3 + ": " + paramContext });
            i += 1;
          }
      ...
      {
        o.e("PackageGatherer", new Object[] { "Error, unable to get package data", paramContext });
        return;
      }
      return;
      label461:
  ...
  public static void b(Context paramContext, ap paramAp)
  {
    try
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        localArrayList.add(new aa(str, (String)localMap.get(str)));
      }
      paramAp.a("packages", localArrayList, true);
    }
    catch (Exception paramContext)
    {
      o.e("PackageGatherer", new Object[] { "Unable to log packages", paramContext });
      return;
    }
