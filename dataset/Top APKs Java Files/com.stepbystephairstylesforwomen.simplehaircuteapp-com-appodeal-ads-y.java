...
public class y
{
  ...
  private y(c paramC)
  {
    ...
    if ((h.a) && ((this.a == null) || ((this.a instanceof ad))) && ((this.d.equals("stats")) || (this.d.equals("show")) || (this.d.equals("click")) || (this.d.equals("finish")) || (this.d.equals("install")))) {
      return;
    }
    ...
    for (;;)
    {
      try
      {
        if ((r == null) || (r.length() == 0))
        {
          ...
          if (!f.h) {
            r.put("model", String.format("%s %s", new Object[] { Build.MANUFACTURER, Build.MODEL }));
          }
        }
