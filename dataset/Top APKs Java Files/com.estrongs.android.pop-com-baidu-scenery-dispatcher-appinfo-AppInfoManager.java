...
public class AppInfoManager
{
  ...
  private static AppInfo buildTrashAppInfo(PackageInfo paramPackageInfo, PackageManager paramPackageManager)
  {
    ...
    localAppInfo.setPkgName(paramPackageInfo.packageName);
    localAppInfo.setAppName(paramPackageInfo.applicationInfo.loadLabel(paramPackageManager).toString());
    localAppInfo.setInstallTime(paramPackageInfo.firstInstallTime);
    return localAppInfo;
  }
  ...
  {
    String str = SceneryLibrary.getAppContext().getResources().getConfiguration().locale.toString();
    if (DEBUG) {
