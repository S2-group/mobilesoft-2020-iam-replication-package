...
public class kk
{
  public static int a()
  {
    try
    {
      int i = hn.a.getPackageManager().getPackageInfo(hn.a.getPackageName(), 0).versionCode;
      return i;
    }
    catch (Exception localException)
    {
      jl.a("Get Version Code Error!!!", localException);
    }
    return -1;
  }
  ...
  {
    paramString = gu.a().f(paramString);
  ...
  public static boolean b()
  {
    ...
    if (hn.a.checkCallingOrSelfPermission("android.permission.ACCESS_NETWORK_STATE") == 0)
    {
      localNetworkInfo = ((ConnectivityManager)hn.a.getSystemService("connectivity")).getActiveNetworkInfo();
  ...
  public static boolean b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramString = hn.a.getPackageManager().getPackageInfo(paramString, 0);
        if (paramString == null) {
          continue;
        }
        return true;
  ...
  public static int c(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        jl.a("Get Meta_Data Info error:", paramString);
      }
    }
    return -1;
  }
  ...
  public static String c()
  {
    ...
    switch (((TelephonyManager)hn.a.getSystemService("phone")).getNetworkType())
    {
    case 13: 
    default: 
      return "4g";
  ...
  {
    return (hn.a.getResources().getConfiguration().screenLayout & 0xF) >= 3;
  }
  
  private static int e()
  {
    Object localObject = (ConnectivityManager)hn.a.getSystemService("connectivity");
    if (localObject == null) {
      return -1;
    }
