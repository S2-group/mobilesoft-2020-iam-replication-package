...
public class DeviceStatus
{
  ...
  public static String getOrGenerateOnceUniqueIdentifier(Context paramContext)
  {
    ...
    //   6: invokestatic 367	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   9: ifne +12 -> 21
    ...
    //   22: ldc_w 369
    //   25: iconst_0
    //   26: invokevirtual 373	android/content/Context:getSharedPreferences	(Ljava/lang/String;I)Landroid/content/SharedPreferences;
    //   29: astore_0
    //   30: aload_0
    //   31: ldc_w 375
    //   34: iconst_1
    //   35: invokeinterface 381 3 0
    //   40: ifeq +57 -> 97
    //   43: aload_0
    //   44: ldc_w 383
    //   47: ldc 110
    ...
    //   54: astore_1
    //   55: aload_1
    //   56: invokestatic 367	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   59: ifeq +45 -> 104
    //   62: invokestatic 393	java/util/UUID:randomUUID	()Ljava/util/UUID;
    //   65: invokevirtual 394	java/util/UUID:toString	()Ljava/lang/String;
    //   68: putstatic 10	com/ironsource/environment/DeviceStatus:uniqueId	Ljava/lang/String;
    //   71: aload_0
    //   72: invokeinterface 398 1 0
    //   77: astore_0
    //   78: aload_0
    //   79: ldc_w 383
    //   82: getstatic 10	com/ironsource/environment/DeviceStatus:uniqueId	Ljava/lang/String;
    //   85: invokeinterface 404 3 0
    //   90: pop
    //   91: aload_0
    //   92: invokeinterface 407 1 0
