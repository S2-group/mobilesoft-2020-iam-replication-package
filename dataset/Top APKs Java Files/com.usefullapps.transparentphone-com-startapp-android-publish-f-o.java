...
public class o
{
  ...
  {
    i.a("SimpleToken", 3, "createSimpleToken entered");
    paramContext = new a().a(b(paramContext));
    i.a("SimpleToken", 3, "simpleToken : [" + paramContext + "]");
    return paramContext;
  }
  ...
  private static List<PackageInfo> c(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      {
        i.a("SimpleToken", 6, "Could not complete getInstalledPackages", localRuntimeException);
        return paramContext;
      }
      a = true;
    }
