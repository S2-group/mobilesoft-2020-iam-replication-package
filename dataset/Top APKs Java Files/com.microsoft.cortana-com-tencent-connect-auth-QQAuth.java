...
public class QQAuth
{
  ...
  {
    y localY = paramFragment.getActivity();
    f.c("openSDK_LOG.QQAuth", "-->login activity: " + localY);
    return a(localY, paramFragment, paramString1, paramIUiListener, paramString2);
  }
