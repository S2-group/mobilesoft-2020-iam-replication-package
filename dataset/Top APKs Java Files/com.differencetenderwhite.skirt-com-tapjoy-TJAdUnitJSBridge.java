...
public class TJAdUnitJSBridge
{
  ...
  public void alert(JSONObject paramJSONObject, String paramString)
  {
    ...
    //   5: dup
    //   6: ldc -121
    //   8: invokespecial 138	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   11: aload_1
    //   12: invokevirtual 142	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   15: invokevirtual 146	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   18: invokestatic 148	com/tapjoy/TapjoyLog:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   21: ldc -106
    //   23: astore 6
    //   25: aload_1
    //   26: ldc -104
    //   28: invokevirtual 158	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   31: astore 5
    //   33: aload 5
    //   35: astore 6
    //   37: aload_1
    //   38: ldc -96
    //   40: invokevirtual 158	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   43: astore 7
    //   45: aload 7
    //   47: astore 6
    //   49: aload_1
    //   50: ldc -94
    //   52: invokevirtual 166	org/json/JSONObject:getJSONArray	(Ljava/lang/String;)Lorg/json/JSONArray;
    //   55: astore_1
    //   56: new 168	android/app/AlertDialog$Builder
    //   59: dup
    //   60: aload_0
    //   61: getfield 61	com/tapjoy/TJAdUnitJSBridge:c	Landroid/content/Context;
    //   64: invokespecial 171	android/app/AlertDialog$Builder:<init>	(Landroid/content/Context;)V
    //   67: aload 5
    //   69: invokevirtual 175	android/app/AlertDialog$Builder:setTitle	(Ljava/lang/CharSequence;)Landroid/app/AlertDialog$Builder;
    //   72: aload 6
    //   74: invokevirtual 178	android/app/AlertDialog$Builder:setMessage	(Ljava/lang/CharSequence;)Landroid/app/AlertDialog$Builder;
    //   77: invokevirtual 182	android/app/AlertDialog$Builder:create	()Landroid/app/AlertDialog;
    //   80: astore 5
    //   82: aload_1
    //   83: ifnull +10 -> 93
    //   86: aload_1
    //   87: invokevirtual 188	org/json/JSONArray:length	()I
    //   90: ifne +56 -> 146
    //   93: aload_0
    //   94: aload_2
    //   95: iconst_1
    ...
    //   99: dup
    //   100: iconst_0
    //   101: getstatic 194	java/lang/Boolean:FALSE	Ljava/lang/Boolean;
    //   104: aastore
    //   105: invokevirtual 198	com/tapjoy/TJAdUnitJSBridge:invokeJSCallback	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   108: return
    //   109: astore_1
    //   110: ldc -106
    //   112: astore 7
    ...
    //   128: dup
    //   129: iconst_0
    //   130: getstatic 194	java/lang/Boolean:FALSE	Ljava/lang/Boolean;
    //   133: aastore
    //   134: invokevirtual 198	com/tapjoy/TJAdUnitJSBridge:invokeJSCallback	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   137: aload_1
    //   138: invokevirtual 201	java/lang/Exception:printStackTrace	()V
    //   141: aconst_null
    //   142: astore_1
    //   143: goto -87 -> 56
    //   146: new 203	java/util/ArrayList
    //   149: dup
    //   150: invokespecial 204	java/util/ArrayList:<init>	()V
    //   153: astore 6
    //   155: iconst_0
    //   156: istore 4
    //   158: iload 4
    //   160: aload_1
    //   161: invokevirtual 188	org/json/JSONArray:length	()I
    ...
    //   196: aload_1
    //   197: iload 4
    //   199: invokevirtual 207	org/json/JSONArray:getString	(I)Ljava/lang/String;
    //   202: invokevirtual 211	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   205: pop
    //   206: aload 5
    //   208: iload_3
    //   209: aload 6
    //   211: iload 4
    //   213: invokevirtual 215	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   216: checkcast 217	java/lang/CharSequence
    //   219: new 219	com/tapjoy/TJAdUnitJSBridge$3
    //   222: dup
    //   223: aload_0
    //   224: aload_2
    //   225: invokespecial 222	com/tapjoy/TJAdUnitJSBridge$3:<init>	(Lcom/tapjoy/TJAdUnitJSBridge;Ljava/lang/String;)V
    //   228: invokevirtual 228	android/app/AlertDialog:setButton	(ILjava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)V
    //   231: iload 4
    //   233: iconst_1
    //   234: iadd
    //   235: istore 4
    ...
    //   252: astore 7
    //   254: aload 7
    //   256: invokevirtual 201	java/lang/Exception:printStackTrace	()V
    //   259: goto -53 -> 206
    //   262: aload 5
    //   264: iconst_0
    //   265: invokevirtual 232	android/app/AlertDialog:setCancelable	(Z)V
    //   268: aload 5
    //   270: iconst_0
    //   271: invokevirtual 235	android/app/AlertDialog:setCanceledOnTouchOutside	(Z)V
    //   274: aload 5
    //   276: invokevirtual 238	android/app/AlertDialog:show	()V
    //   279: return
    //   280: astore_1
    //   281: goto -159 -> 122
  ...
  public void present(JSONObject paramJSONObject, String paramString)
  {
    // Byte code:
    //   0: iconst_0
    //   1: invokestatic 364	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   4: astore_3
    //   5: aload_1
    //   6: ldc_w 644
    //   9: invokevirtual 158	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   12: invokestatic 532	java/lang/Boolean:valueOf	(Ljava/lang/String;)Ljava/lang/Boolean;
    //   15: astore 5
    //   17: aload_1
    //   18: ldc_w 646
    //   21: invokevirtual 158	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   24: invokestatic 532	java/lang/Boolean:valueOf	(Ljava/lang/String;)Ljava/lang/Boolean;
    //   27: astore 4
    //   29: aload 4
    //   31: astore_3
    //   32: aload_0
    //   33: aload_1
    //   34: ldc_w 647
    //   37: invokevirtual 158	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   40: invokestatic 532	java/lang/Boolean:valueOf	(Ljava/lang/String;)Ljava/lang/Boolean;
    //   43: invokevirtual 535	java/lang/Boolean:booleanValue	()Z
    //   46: putfield 48	com/tapjoy/TJAdUnitJSBridge:customClose	Z
    //   49: new 649	com/tapjoy/TJAdUnitJSBridge$a
    //   52: dup
    //   53: aload_0
    //   54: aload_0
    //   55: getfield 63	com/tapjoy/TJAdUnitJSBridge:e	Landroid/webkit/WebView;
    //   58: invokespecial 652	com/tapjoy/TJAdUnitJSBridge$a:<init>	(Lcom/tapjoy/TJAdUnitJSBridge;Landroid/webkit/WebView;)V
    //   61: iconst_2
    //   62: anewarray 190	java/lang/Boolean
    //   65: dup
    //   66: iconst_0
    //   67: aload 5
    //   69: aastore
    ...
    //   72: aload_3
    //   73: aastore
    //   74: invokevirtual 656	com/tapjoy/TJAdUnitJSBridge$a:execute	([Ljava/lang/Object;)Landroid/os/AsyncTask;
    //   77: pop
    //   78: aload_0
    //   79: aload_2
    //   80: iconst_1
    ...
    //   84: dup
    //   85: iconst_0
    //   86: getstatic 323	java/lang/Boolean:TRUE	Ljava/lang/Boolean;
    //   89: aastore
    //   90: invokevirtual 198	com/tapjoy/TJAdUnitJSBridge:invokeJSCallback	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   93: return
    //   94: astore_1
    //   95: aload_0
    //   96: aload_2
    ...
    //   101: dup
    //   102: iconst_0
    //   103: getstatic 194	java/lang/Boolean:FALSE	Ljava/lang/Boolean;
    //   106: aastore
    //   107: invokevirtual 198	com/tapjoy/TJAdUnitJSBridge:invokeJSCallback	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   110: aload_1
    //   111: invokevirtual 201	java/lang/Exception:printStackTrace	()V
    //   114: return
    //   115: astore_1
    //   116: goto -67 -> 49
    //   119: astore 4
