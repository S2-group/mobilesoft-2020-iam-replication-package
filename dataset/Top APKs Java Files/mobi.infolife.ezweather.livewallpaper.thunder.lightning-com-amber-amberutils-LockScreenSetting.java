...
public class LockScreenSetting
{
  ...
  public static void checkAndRequestDrawOverlayPermission(Activity paramActivity)
  {
    if ((Build.VERSION.SDK_INT >= 23) && (!canDrawOverlayViews(paramActivity))) {
      paramActivity.startActivityForResult(new Intent("android.settings.action.MANAGE_OVERLAY_PERMISSION", Uri.parse("package:" + paramActivity.getPackageName())), 0);
    }
  }
  ...
  public static void closeLockScreen(Context paramContext)
  {
    ...
    try
    {
      ...
      Log.d(TAG, ((Context)localObject).getPackageName() + ": " + bool);
  ...
  public static boolean hasPassword(Context paramContext)
  {
    ...
    while ((paramContext.equals("")) || (paramContext.equals(ToolUtils.md5("")))) {
      return false;
    }
    return true;
  }
