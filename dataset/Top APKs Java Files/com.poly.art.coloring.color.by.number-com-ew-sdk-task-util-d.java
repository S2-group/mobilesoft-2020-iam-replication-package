...
public class d
{
  ...
  public static int a(com.ew.sdk.task.b.a paramA, com.ew.sdk.task.b.b paramB)
  {
    ...
    {
      ThrowableExtension.printStackTrace(paramA);
    }
    return 0;
  }
  ...
  public static String a(Context paramContext, com.ew.sdk.task.b.c paramC, String paramString, boolean paramBoolean)
  {
    // Byte code:
    //   0: aload_2
    //   1: invokestatic 100	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   4: ifeq +5 -> 9
    //   7: aload_2
    //   8: areturn
    //   9: aload_2
    //   10: astore 4
    //   12: aload_0
    //   13: invokevirtual 237	android/content/Context:getPackageName	()Ljava/lang/String;
    //   16: astore 5
    //   18: aload_2
    //   19: astore 4
    //   21: aload 5
    //   23: invokestatic 100	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   26: ifeq +5 -> 31
    //   29: aload_2
    //   30: areturn
    //   31: aload_2
    ...
    //   35: ldc -17
    //   37: aload_1
    //   38: invokevirtual 242	com/ew/sdk/task/b/c:getTargetId	()Ljava/lang/String;
    //   41: invokevirtual 248	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   44: astore_0
    //   45: iload_3
    //   46: ifeq +19 -> 65
    //   49: aload_0
    //   50: ldc -6
    //   52: aload_1
    //   53: invokevirtual 253	com/ew/sdk/task/b/c:getAppStore	()Ljava/lang/String;
    //   56: invokevirtual 248	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   59: astore_1
    //   60: aload_1
    //   61: astore_0
    //   62: goto +42 -> 104
    ...
    //   66: ldc -6
    //   68: aload_1
    //   69: invokevirtual 256	com/ew/sdk/task/b/c:getTargetPkgName	()Ljava/lang/String;
    //   72: invokevirtual 248	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   75: astore_1
    //   76: aload_1
    //   77: astore_0
    //   78: goto +26 -> 104
    ...
    //   85: ldc_w 258
    //   88: aload 5
    //   90: invokevirtual 248	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   93: astore_0
    //   94: aload_0
    //   95: areturn
    //   96: astore_0
    //   97: aload_0
    //   98: invokestatic 39	com/google/devtools/build/android/desugar/runtime/ThrowableExtension:printStackTrace	(Ljava/lang/Throwable;)V
    //   101: aload 4
    //   103: areturn
    //   104: goto -23 -> 81
    //   107: astore_1
  ...
  public static boolean a(com.ew.sdk.task.b.c paramC, String paramString)
  {
    ...
    {
      ThrowableExtension.printStackTrace(paramC);
    }
    return false;
  }
  ...
  public static String b()
  {
    ...
    try
    {
      ...
      ThrowableExtension.printStackTrace(localException3);
    }
