...
{
  public static final int ADD_PACKAGE_CANNOT_ERASE_FILE_RESULT = 32;
  ...
  public static final int ADD_PACKAGE_MISSING_SYN_RESULT = 16;
  ...
  private native int addpackagethirdparty(String paramString1, String paramString2, int paramInt);
  ...
  private native boolean deletepackagethirdparty(String paramString);
  ...
  public final int addThirdPartyOfflineMapPackage(String paramString1, String paramString2)
  {
    if (SKMaps.getInstance().isSKMapsInitialized())
    {
      if ((paramString1 != null) && (paramString2 != null))
      {
        SKLogging.writeLog("SKPackageManager", "@addOfflinePackageThirdParty " + paramString1 + " " + paramString2 + ", getlocalmapversionthirdparty() = " + SKVersioningManager.getInstance().getLocalMapVersionThirdParty(), 0);
        int i = addpackagethirdparty(paramString1, paramString2, SKVersioningManager.getInstance().getLocalMapVersionThirdParty());
        SKLogging.writeLog("SKPackageManager", "@addOfflinePackageThirdParty result  " + i, 0);
        return i;
      }
      return -1;
    }
  ...
  public final boolean deleteOfflinePackageThirdParty(String paramString)
  {
    SKLogging.writeLog("SKPackageManager", "@deleteOfflinePackageThirdParty package=   " + paramString, 0);
    if (SKMaps.getInstance().isSKMapsInitialized()) {
      return deletepackagethirdparty(paramString);
    }
    throw new SKMapsInitializationException();
  }
  ...
  public final String getThirdPartyMapJsonURLForVersion(int paramInt)
  {
    if (SKMaps.getInstance().isSKMapsInitialized())
    {
      String str1 = SKMaps.getInstance().getObfuscatedApiKey();
      str1 = "https://" + str1 + "." + "https://cache.sko.fm/ngxmaps/versioned/poldata/".replaceAll("https://", "") + "v1/";
      Object localObject = SKMaps.getInstance().getMapInitSettings();
      String str2 = ((SKMapsInitSettings)localObject).getAppName();
      localObject = ((SKMapsInitSettings)localObject).getAppVersion();
      String str3 = Uri.encode(Build.VERSION.RELEASE);
      return str1 + paramInt + "/Maps.json?appName=" + Uri.encode(str2) + "&appVer=" + (String)localObject + "&osName=android&osVersion=" + str3 + "&uid=" + SKMaps.getInstance().getUserId();
    }
    throw new SKMapsInitializationException();
  }
  
  public final String getThirdPartyMapPackageURLForPackageName(String paramString)
  {
    if (SKMaps.getInstance().isSKMapsInitialized())
    {
      Object localObject = SKMaps.getInstance().getMapInitSettings();
      String str1 = ((SKMapsInitSettings)localObject).getAppName();
      localObject = ((SKMapsInitSettings)localObject).getAppVersion();
      String str2 = Uri.encode(Build.VERSION.RELEASE);
      str1 = "?appName=" + Uri.encode(str1) + "&appVer=" + (String)localObject + "&osName=android&osVersion=" + str2 + "&uid=" + SKMaps.getInstance().getUserId();
      localObject = SKMaps.getInstance().getObfuscatedApiKey();
      int i = SKVersioningManager.getInstance().getLocalMapVersionThirdParty();
      return "https://" + (String)localObject + "." + "https://cache.sko.fm/ngxmaps/versioned/poldata/".replaceAll("https://", "") + "v1/" + i + "/package/" + paramString + str1;
    }
    throw new SKMapsInitializationException();
  }
  
  public final String getThirdPartyMapXMLURLForVersion(int paramInt)
  {
    if (SKMaps.getInstance().isSKMapsInitialized())
    {
      String str1 = SKMaps.getInstance().getObfuscatedApiKey();
      ...
      localObject = ((SKMapsInitSettings)localObject).getAppVersion();
      String str3 = Uri.encode(Build.VERSION.RELEASE);
      return str1 + paramInt + "/Maps.xml?appName=" + Uri.encode(str2) + "&appVer=" + (String)localObject + "&osName=android&osVersion=" + str3 + "&uid=" + SKMaps.getInstance().getUserId();
    }
    throw new SKMapsInitializationException();
  }
  ...
  public final SKPackageURLInfo getURLInfoForPackageWithCode(String paramString, Integer paramInteger, boolean paramBoolean)
  {
    if (SKMaps.getInstance().isSKMapsInitialized())
    {
      ...
      if (paramString != null)
      {
        ...
        {
          paramInteger = "https://" + str1 + "." + "https://cache.sko.fm/ngxmaps/versioned/".replaceAll("https://", "") + paramInteger + "v1/" + localInteger + (String)localObject;
