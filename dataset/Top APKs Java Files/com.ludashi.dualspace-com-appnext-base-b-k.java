...
public final class k
{
  ...
  public static List a(PackageManager paramPackageManager, int paramInt)
  {
  ...
  {
    return i.cG().getLong(paramString + "_lastupdate", 0L);
  }
  ...
  public static void b(String paramString, List paramList)
  {
  ...
  {
    e.cz();
    Object localObject = e.av(paramString);
    if ((localObject == null) || ("off".equalsIgnoreCase(((com.appnext.base.a.b.c)localObject).bd()))) {
      return true;
    }
    if (paramMap.isEmpty()) {
      return true;
    ...
    String str = g.u(d.getContext());
    localObject = str;
    if (TextUtils.isEmpty(str)) {
      localObject = i.cG().getString("google_ads_id", "");
    }
    ...
    catch (Throwable localThrowable)
    {
      ...
      new StringBuilder("------- cky = ").append(paramString).append(" ----------");
      ...
      try
      {
        paramString = g.a("http://apis.appnxt.net:443/data", localHashMap, false, 15000, c.a.HashMap);
        if (paramString != null) {
          new String(paramString, "UTF-8");
        }
        return true;
      }
  ...
  public static void cP()
  {
    ...
    if (localObject != null)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        new StringBuilder("Name : - ").append(localRunningAppProcessInfo.processName).append(" Importance - ").append(localRunningAppProcessInfo.importance).append(" Lru - ").append(localRunningAppProcessInfo.lru).append(" LastTrimLevel - ").append(localRunningAppProcessInfo.lastTrimLevel).append(" ImportanceReasonCode - ").append(localRunningAppProcessInfo.importanceReasonCode).append(" importanceReasonComponent - ").append(localRunningAppProcessInfo.importanceReasonComponent);
      }
    }
  }
    ...
    try
    {
      if ((TextUtils.isDigitsOnly(paramString1)) && (!TextUtils.isEmpty(paramString2)) && (!TextUtils.isEmpty(paramString1)))
      {
        ...
        if ("time".equalsIgnoreCase(paramString2))
        {
          ...
          l1 = paramString1.getTimeInMillis();
          return (kH.nextInt(120) - 60) * 1000L + l1;
        }
  ...
  public static List m(Context paramContext)
  {
