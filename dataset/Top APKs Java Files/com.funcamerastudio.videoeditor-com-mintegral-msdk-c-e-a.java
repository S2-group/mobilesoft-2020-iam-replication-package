package com.mintegral.msdk.c.e;
...
import com.mintegral.msdk.c.f.f;
...
import com.mintegral.msdk.c.h.n;
import com.mintegral.msdk.c.h.q;
...
public class a
{
  ...
  private static a c;
  private static CopyOnWriteArraySet<f> j = new CopyOnWriteArraySet();
  private Context d;
  private String e;
  private String f;
  private String g;
  ...
  public static void e()
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: invokestatic 212	com/mintegral/msdk/c/e/a:d	()Lcom/mintegral/msdk/c/e/a;
    //   6: invokevirtual 214	com/mintegral/msdk/c/e/a:j	()Ljava/lang/String;
    ...
    //   18: pop
    //   19: invokestatic 212	com/mintegral/msdk/c/e/a:d	()Lcom/mintegral/msdk/c/e/a;
    //   22: invokevirtual 214	com/mintegral/msdk/c/e/a:j	()Ljava/lang/String;
    //   25: invokestatic 222	com/mintegral/msdk/b/b:b	(Ljava/lang/String;)Lcom/mintegral/msdk/b/a;
    //   28: astore_1
    //   29: aload_1
    //   30: ifnull +87 -> 117
    //   33: aload_1
    //   34: invokevirtual 227	com/mintegral/msdk/b/a:aH	()Ljava/lang/String;
    //   37: astore_1
    //   38: aload_1
    //   39: invokestatic 151	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   42: ifne +75 -> 117
    //   45: aload_1
    //   46: invokestatic 231	com/mintegral/msdk/c/h/c:c	(Ljava/lang/String;)Ljava/lang/String;
    //   49: astore_1
    //   50: aload_1
    ...
    //   106: istore_0
    //   107: goto -24 -> 83
    //   110: invokestatic 212	com/mintegral/msdk/c/e/a:d	()Lcom/mintegral/msdk/c/e/a;
    //   113: aload_2
    //   114: putfield 58	com/mintegral/msdk/c/e/a:i	Ljava/util/List;
    //   117: ldc 2
    //   119: monitorexit
    //   120: return
    //   121: astore_1
    ...
    try
    {
      if ((j != null) && (j.size() > 0))
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          boolean bool = localArrayList.contains(localF.a());
          if (!bool) {
            try
            {
              localArrayList.add(Long.valueOf(Long.parseLong(localF.a())));
            }
  ...
  public final void a(b paramB)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 61	com/mintegral/msdk/c/e/a:d	Landroid/content/Context;
    //   6: invokestatic 275	com/mintegral/msdk/c/h/n:a	(Landroid/content/Context;)Lcom/mintegral/msdk/c/h/n;
    //   9: aload_0
    //   10: getfield 107	com/mintegral/msdk/c/e/a:f	Ljava/lang/String;
    //   13: invokevirtual 278	com/mintegral/msdk/c/h/n:a	(Ljava/lang/String;)Ljava/util/concurrent/CopyOnWriteArraySet;
    //   16: astore 4
    //   18: aload 4
    //   20: putstatic 52	com/mintegral/msdk/c/e/a:j	Ljava/util/concurrent/CopyOnWriteArraySet;
    //   23: aload 4
    ...
    //   51: astore 4
    //   53: getstatic 52	com/mintegral/msdk/c/e/a:j	Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    //   85: checkcast 249	com/mintegral/msdk/c/f/f
    //   88: astore 6
    //   90: getstatic 47	com/mintegral/msdk/c/e/a:b	Ljava/util/List;
    //   93: ifnull -27 -> 66
    //   96: getstatic 47	com/mintegral/msdk/c/e/a:b	Ljava/util/List;
    ...
    //   113: istore_2
    //   114: iload_2
    //   115: getstatic 47	com/mintegral/msdk/c/e/a:b	Ljava/util/List;
    //   118: invokeinterface 123 1 0
    //   123: if_icmpge -57 -> 66
    //   126: getstatic 47	com/mintegral/msdk/c/e/a:b	Ljava/util/List;
    //   129: iload_2
    //   130: invokeinterface 284 2 0
    //   135: checkcast 145	java/lang/String
    //   138: astore 7
    //   140: aload 6
    //   142: invokevirtual 286	com/mintegral/msdk/c/f/f:b	()Ljava/lang/String;
    //   145: astore 8
    //   147: aload 7
    ...
    //   195: getstatic 74	com/mintegral/msdk/c/e/a:a	Ljava/lang/String;
    //   198: ldc_w 289
    //   201: invokestatic 291	com/mintegral/msdk/c/h/h:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   204: goto -138 -> 66
    //   207: getstatic 52	com/mintegral/msdk/c/e/a:j	Ljava/util/concurrent/CopyOnWriteArraySet;
    //   210: ifnull +9 -> 219
    //   213: getstatic 52	com/mintegral/msdk/c/e/a:j	Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    //   224: ifle +12 -> 236
    //   227: getstatic 52	com/mintegral/msdk/c/e/a:j	Ljava/util/concurrent/CopyOnWriteArraySet;
    //   230: aload 4
    //   232: invokevirtual 298	java/util/concurrent/CopyOnWriteArraySet:addAll	(Ljava/util/Collection;)Z
    //   235: pop
    //   236: aload_0
    //   237: getfield 61	com/mintegral/msdk/c/e/a:d	Landroid/content/Context;
    //   240: invokestatic 275	com/mintegral/msdk/c/h/n:a	(Landroid/content/Context;)Lcom/mintegral/msdk/c/h/n;
    //   243: getstatic 52	com/mintegral/msdk/c/e/a:j	Ljava/util/concurrent/CopyOnWriteArraySet;
    //   246: invokevirtual 301	com/mintegral/msdk/c/h/n:a	(Ljava/util/Set;)V
    //   249: aload_1
    //   250: ifnull +9 -> 259
    //   253: aload_1
  ...
  public final void a(final b paramB, final Handler paramHandler)
  {
    ...
    try
    {
      Object localObject = q.c(this.d, "ga_id", "-1");
      if ((localObject != null) && ((localObject instanceof String)))
      {
        ...
        if ((r.b((String)localObject)) && (!"-1".equals(localObject)))
        {
          ...
          if (com.mintegral.msdk.c.e.a.b.a("authority_device_id")) {
    ...
    new Thread(new Runnable()
    {
      public final void run()
      {
        ...
        catch (Exception localException2)
        {
          for (;;)
          {
            try
            {
              ...
              a.e();
              l.b(a.a(a.this));
              com.mintegral.msdk.b.b.a(a.a(a.this), a.b(a.this));
              a.this.l();
              a.c(a.this);
              a.this.a(paramB);
        ...
        try
        {
          ...
          Object localObject2 = com.mintegral.msdk.b.b.b(a.d().j());
  ...
  public final void a(String paramString)
  {
    try
    {
      ...
      if ((!TextUtils.isEmpty(paramString)) && (this.d != null)) {
        q.b(this.d, "applicationIds", paramString);
      }
      return;
    }
  ...
  public final void c(String paramString)
  {
    try
    {
      this.f = paramString;
      if ((!TextUtils.isEmpty(paramString)) && (this.d != null)) {
        q.b(this.d, "sp_appId", paramString);
      }
      return;
    }
    catch (Exception paramString)
  ...
  public final void d(String paramString)
  {
    try
    {
      this.g = paramString;
      if ((!TextUtils.isEmpty(paramString)) && (this.d != null)) {
        q.b(this.d, "sp_appKey", paramString);
      }
      return;
    }
    catch (Exception paramString)
  ...
  public final String j()
  {
    try
    {
      ...
      if (this.d != null)
      {
        String str = (String)q.c(this.d, "sp_appId", "");
        return str;
      }
    }
    catch (Exception localException)
  ...
  public final String k()
  {
    ...
    if (this.d != null) {
      return (String)q.c(this.d, "sp_appKey", "");
    }
    return null;
  }
  ...
  public final class a
  {
      ...
      throws Exception
    {
      ...
      //   29: pop
      //   30: new 11	com/mintegral/msdk/c/e/a$a$b
      //   33: dup
      //   34: aload_0
      //   35: iconst_0
      //   36: invokespecial 60	com/mintegral/msdk/c/e/a$a$b:<init>	(Lcom/mintegral/msdk/c/e/a$a;B)V
      //   39: astore_2
      ...
      //   64: ifeq +54 -> 118
      //   67: new 14	com/mintegral/msdk/c/e/a$a$c
      //   70: dup
      //   71: aload_0
      //   72: aload_2
      //   73: invokevirtual 78	com/mintegral/msdk/c/e/a$a$b:a	()Landroid/os/IBinder;
      //   76: invokespecial 81	com/mintegral/msdk/c/e/a$a$c:<init>	(Lcom/mintegral/msdk/c/e/a$a;Landroid/os/IBinder;)V
      //   79: astore_3
      //   80: new 9	com/mintegral/msdk/c/e/a$a$a
      //   83: dup
      //   84: aload_0
      //   85: aload_3
      //   86: invokevirtual 84	com/mintegral/msdk/c/e/a$a$c:a	()Ljava/lang/String;
      //   89: aload_3
      //   90: invokevirtual 87	com/mintegral/msdk/c/e/a$a$c:b	()Z
      //   93: invokespecial 90	com/mintegral/msdk/c/e/a$a$a:<init>	(Lcom/mintegral/msdk/c/e/a$a;Ljava/lang/String;Z)V
      //   96: astore_3
      //   97: aload_1
      //   98: aload_2
      ...
      implements IInterface
    {
        ...
        throws android.os.RemoteException
      {
        ...
        //   14: aload_0
        //   15: getfield 24	com/mintegral/msdk/c/e/a$a$c:b	Landroid/os/IBinder;
        //   18: iconst_1
        //   19: aload_1
        //   20: aload_2
        //   21: iconst_0
        ...
        throws android.os.RemoteException
      {
        ...
        //   22: aload_0
        //   23: getfield 24	com/mintegral/msdk/c/e/a$a$c:b	Landroid/os/IBinder;
        //   26: iconst_2
        //   27: aload_3
        //   28: aload 4
        //   30: iconst_0
