...
public class ChooseCameraSettings
  extends agr
  implements agl.b
{
  private String m = "ChooseCameraSettings";
  private Context n;
  ...
  public ChooseCameraSettings() {}
  
  private int a(ArrayList<aiw.a> paramArrayList)
  {
    String str = this.r.getString("camera_application", "");
    int i = 0;
    if (!"".equals(str)) {
      try
      {
    ...
    try
    {
      ...
      if ((this.q == null) || (this.q.isEmpty())) {
        runOnUiThread(new Runnable()
        {
          ...
          {
            Toast.makeText(ChooseCameraSettings.a(ChooseCameraSettings.this), 2131689512, 1).show();
          }
        });
      }
      localObject = this.q;
  ...
  public final void b(int paramInt)
  {
    try
    {
      ...
      this.r.edit().putString("camera_application", localA.c).apply();
      return;
    }
    catch (Throwable localThrowable)
    {
    ...
    extends AsyncTask<Void, Void, ArrayList<aiw.a>>
  {
    ...
    {
      super.onPreExecute();
      this.b = new ahj(ChooseCameraSettings.this);
