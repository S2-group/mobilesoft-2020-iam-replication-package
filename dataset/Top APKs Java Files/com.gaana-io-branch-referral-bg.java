...
class bg
{
  ...
  public String a(String paramString)
  {
    ...
    //   11: astore_2
    //   12: aload_0
    //   13: invokespecial 80	io/branch/referral/bg:l	()Z
    //   16: ifne +112 -> 128
    //   19: aload_0
    //   20: getfield 23	io/branch/referral/bg:c	Landroid/content/Context;
    //   23: invokevirtual 84	android/content/Context:getPackageManager	()Landroid/content/pm/PackageManager;
    //   26: astore_2
    //   27: aload 4
    //   29: astore 5
    //   31: aload_2
    //   32: aload_1
    //   33: iconst_0
    //   34: invokevirtual 90	android/content/pm/PackageManager:getApplicationInfo	(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    //   37: getfield 95	android/content/pm/ApplicationInfo:publicSourceDir	Ljava/lang/String;
    //   40: astore_1
    //   41: new 97	java/util/jar/JarFile
    //   44: dup
    //   45: aload_1
    //   46: invokespecial 100	java/util/jar/JarFile:<init>	(Ljava/lang/String;)V
    //   49: astore_1
    //   50: aload 6
    //   52: astore_3
    //   53: aload_1
    //   54: aload_1
    //   55: ldc 102
    //   57: invokevirtual 106	java/util/jar/JarFile:getEntry	(Ljava/lang/String;)Ljava/util/zip/ZipEntry;
    //   60: invokevirtual 110	java/util/jar/JarFile:getInputStream	(Ljava/util/zip/ZipEntry;)Ljava/io/InputStream;
    //   63: astore_2
    //   64: aload_2
    //   65: astore_3
    //   66: aload_2
    //   67: invokevirtual 116	java/io/InputStream:available	()I
    //   70: newarray byte
    //   72: astore 5
    //   74: aload_2
    //   75: astore_3
    //   76: aload_2
    //   77: aload 5
    //   79: invokevirtual 120	java/io/InputStream:read	([B)I
    //   82: pop
    //   83: aload_2
    //   84: astore_3
    //   85: new 122	io/branch/referral/c
    //   88: dup
    //   89: invokespecial 123	io/branch/referral/c:<init>	()V
    //   92: aload 5
    //   94: invokevirtual 126	io/branch/referral/c:a	([B)Ljava/lang/String;
    //   97: astore 5
    //   99: aload 5
    //   101: astore_3
    //   102: aload_2
    ...
    //   107: astore 5
    //   109: aload_2
    //   110: invokevirtual 129	java/io/InputStream:close	()V
    //   113: aload_3
    //   114: astore_2
    //   115: aload_1
    //   116: ifnull +12 -> 128
    ...
    //   120: astore 5
    //   122: aload_1
    //   123: invokevirtual 130	java/util/jar/JarFile:close	()V
    //   126: aload_3
    //   127: astore_2
    //   128: aload_2
    //   129: areturn
    ...
    //   154: astore 5
    //   156: aload_1
    //   157: invokevirtual 130	java/util/jar/JarFile:close	()V
    //   160: ldc 78
    //   162: areturn
    //   163: astore_1
    //   164: ldc 78
    ...
    //   190: astore 5
    //   192: aload_3
    //   193: invokevirtual 130	java/util/jar/JarFile:close	()V
    //   196: aload 4
    //   198: astore 5
    //   200: aload_1
    //   201: athrow
  ...
  public boolean a(bh paramBh)
  {
    ...
    {
      new bi(this, paramBh).a(new Void[0]);
      return true;
    }
    return false;
  }
  ...
  {
    Object localObject = ak.a(this.c);
    String str = d();
    if ("bnc_no_value".equals(((ak)localObject).e()))
    {
      if (paramBoolean) {
        ((ak)localObject).a(str);
      }
      ...
      else
      {
        try
        {
          ...
          for (localObject = null;; localObject = ((CharSequence)localObject).toString())
          {
            ...
            if (localObject != null)
            {
              localJSONObject.put(Defines.Jsonkey.M.a(), localObject);
              localObject = a((String)localObject);
              if (!((String)localObject).equals("bnc_no_value")) {
                localJSONObject.put(Defines.Jsonkey.L.a(), localObject);
              }
            }
            ...
            localJSONObject.put(Defines.Jsonkey.E.a(), g());
