...
public class jv
{
  ...
  public kd.a a()
  {
    try
    {
      kd.a localA = kd.a(this.a);
      return localA;
    }
    catch (IOException|IllegalStateException|ke|kf localIOException)
    {
      for (;;) {}
    }
    return null;
    ...
    extends ContextWrapper
  {
    ...
    {
      super();
      this.a = new jv.b(paramContext);
      this.b = new jv.c(paramContext.getResources());
    }
