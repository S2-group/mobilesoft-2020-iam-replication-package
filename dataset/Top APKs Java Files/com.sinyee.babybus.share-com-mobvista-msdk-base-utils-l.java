...
public final class l
{
  ...
  public static boolean a(Context paramContext, String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (i < com.mobvista.msdk.base.b.a.b.size())
      {
  ...
  public static List<com.mobvista.msdk.base.entity.j> d()
  {
    ...
    //   241: astore_2
    //   242: invokestatic 177	com/mobvista/msdk/base/b/a:d	()Lcom/mobvista/msdk/base/b/a;
    //   245: invokevirtual 263	com/mobvista/msdk/base/b/a:i	()Landroid/content/Context;
    ...
    //   259: astore_3
    //   260: invokestatic 177	com/mobvista/msdk/base/b/a:d	()Lcom/mobvista/msdk/base/b/a;
    //   263: invokevirtual 336	com/mobvista/msdk/base/b/a:b	()Ljava/util/List;
    //   266: astore 4
    //   268: iconst_0
    //   269: istore_0
    //   270: iload_0
    //   271: aload_3
    //   272: invokeinterface 253 1 0
    //   277: if_icmpge +88 -> 365
    //   280: aload_3
    //   281: iload_0
    //   282: invokeinterface 257 2 0
    //   287: checkcast 338	android/content/pm/PackageInfo
    //   290: astore 6
    //   292: aload 6
    //   294: getfield 342	android/content/pm/PackageInfo:applicationInfo	Landroid/content/pm/ApplicationInfo;
    //   297: getfield 347	android/content/pm/ApplicationInfo:flags	I
    //   300: iconst_1
    //   301: iand
    //   302: ifgt +18 -> 320
    //   305: aload_2
    //   306: aload 6
    //   308: getfield 350	android/content/pm/PackageInfo:packageName	Ljava/lang/String;
    //   311: invokeinterface 276 2 0
    //   316: pop
    //   317: goto +199 -> 516
    //   320: aload 4
    //   322: ifnull +194 -> 516
    //   325: aload 4
    //   327: invokeinterface 253 1 0
    //   332: ifle +184 -> 516
    //   335: aload 4
    //   337: aload 6
    //   339: getfield 350	android/content/pm/PackageInfo:packageName	Ljava/lang/String;
    //   342: invokeinterface 353 2 0
    //   347: ifeq +169 -> 516
    //   350: aload_2
    //   351: aload 6
    //   353: getfield 350	android/content/pm/PackageInfo:packageName	Ljava/lang/String;
    //   356: invokeinterface 276 2 0
    //   361: pop
    //   362: goto +154 -> 516
    //   365: new 255	java/util/ArrayList
    //   368: dup
    //   369: invokespecial 256	java/util/ArrayList:<init>	()V
    //   372: astore_3
    //   373: iload_1
    //   374: istore_0
    //   375: iload_0
    //   376: aload 5
    //   378: invokeinterface 253 1 0
    //   383: if_icmpge +85 -> 468
    //   386: aload 5
    //   388: iload_0
    //   389: invokeinterface 257 2 0
    //   394: checkcast 122	java/lang/String
    //   397: astore 4
    //   399: aload_2
    //   400: aload 4
    //   402: invokeinterface 353 2 0
    //   407: ifeq +116 -> 523
    ...
    //   437: invokestatic 55	com/mobvista/msdk/base/utils/h:b	(Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   456: aload_3
    //   457: aload 6
    //   459: invokeinterface 276 2 0
    //   464: pop
    //   465: goto +58 -> 523
    //   468: ldc 46
    //   470: ldc_w 499
    //   473: invokestatic 55	com/mobvista/msdk/base/utils/h:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   476: aload_3
    //   477: areturn
    //   478: astore 4
    //   480: aload_2
    ...
    //   510: aload_2
    //   511: invokestatic 134	com/mobvista/msdk/base/utils/h:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   514: aconst_null
    //   515: areturn
    //   516: iload_0
    //   517: iconst_1
