...
public class AerServSettings
{
  ...
  private static AtomicBoolean hasUpdatedInformation;
  ...
  static
  {
    ...
    hasUpdatedInformation = new AtomicBoolean(false);
  ...
  public static int getBitmapTimeout()
  {
    ...
    for (int i = bitmapTimeout.intValue();; i = 5000) {
  ...
  private static boolean initAdapterClassByName(final Context paramContext, final String paramString, final JSONArray paramJSONArray)
  {
    try
    {
      Method localMethod = Class.forName(AdapterFactory.getAdapterClassName(paramString)).getMethod("initPartnerSdk", new Class[] { Context.class, JSONArray.class });
      ...
      localMethod.invoke(null, new Object[] { paramContext, paramJSONArray });
      return true;
    }
    catch (Throwable paramContext)
    {
      AerServLog.e(LOG_TAG, "pre-init: Exception initializing " + paramString + " SDK: " + paramContext.getMessage());
    }
    return false;
  }
        ...
        catch (JSONException localJSONException3)
        {
          ...
          catch (JSONException localJSONException3)
          {
            try
            {
              ...
              bitmapTimeout = Integer.valueOf(localJSONObject1.optInt("bitmap", 5000));
  ...
  public static void retrieveAdvertiserInfo(Context paramContext)
  {
    ...
    try
    {
      Object localObject1 = Class.forName("com.google.android.gms.ads.identifier.AdvertisingIdClient").getMethod("getAdvertisingIdInfo", new Class[] { Context.class });
      Object localObject2 = Class.forName("com.google.android.gms.ads.identifier.AdvertisingIdClient$Info");
      Method localMethod = ((Class)localObject2).getMethod("getId", new Class[0]);
      ...
      adid = (String)localMethod.invoke(localObject1, new Object[0]);
      oid = adid;
      isLimitAdTrackingEnabled = ((Boolean)((Method)localObject2).invoke(localObject1, new Object[0])).booleanValue();
      return;
    }
    catch (Exception localException)
    {
  ...
  private static void setApplicationId(Context paramContext)
  {
    ...
    {
      AerServLog.i(LOG_TAG, "pre-init: Exception setting applicatioon ID: " + paramContext.getMessage());
    }
  }
