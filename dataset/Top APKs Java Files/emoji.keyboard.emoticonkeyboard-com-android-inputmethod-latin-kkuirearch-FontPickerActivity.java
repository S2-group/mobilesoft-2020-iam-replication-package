  ...
  extends b
{
  ...
  {
    FragmentBackPressed localFragmentBackPressed = (FragmentBackPressed)getSupportFragmentManager().a("android:switcher:2131755270:" + this.a.getCurrentItem());
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    paramBundle = (Toolbar)findViewById(2131755200);
    a(paramBundle);
    paramBundle.setNavigationIcon(2130837925);
    ...
    if (paramBundle != null) {
      paramBundle.a(2131296767);
    }
    this.a = ((ViewPager)findViewById(2131755270));
    this.a.setAdapter(new a(getSupportFragmentManager()));
    paramBundle = (SlidingTabLayout)findViewById(2131755268);
    paramBundle.setCustomTabView$255f295(2130968801);
    paramBundle.setSelectedIndicatorColors(new int[] { getResources().getColor(2131689877) });
    paramBundle.setDistributeEvenly(true);
    paramBundle.setViewPager(this.a);
    ((FloatingActionButton)findViewById(2131755212)).setOnClickListener(new View.OnClickListener()
    {
      public final void onClick(View paramAnonymousView)
      {
    ...
    extends n
  {
    ...
    public final CharSequence getPageTitle(int paramInt)
    {
      ...
      case 0: 
        return FontPickerActivity.this.getResources().getString(2131296768);
      }
      return FontPickerActivity.this.getResources().getString(2131296769);
    }
  }
}
