...
public class QQAuth
{
  ...
  private int a(Activity paramActivity, r paramR, String paramString1, IUiListener paramIUiListener, String paramString2)
  {
    ...
    for (paramString2 = localApplicationInfo.sourceDir;; paramString2 = null)
    {
      ...
      return this.a.doLogin(paramActivity, paramString1, paramIUiListener, false, paramR);
    }
  }
  ...
  public int login(r paramR, String paramString1, IUiListener paramIUiListener, String paramString2)
  {
    FragmentActivity localFragmentActivity = paramR.j();
    f.c("openSDK_LOG", "-->login activity: " + localFragmentActivity);
    return a(localFragmentActivity, paramR, paramString1, paramIUiListener, paramString2);
  }
