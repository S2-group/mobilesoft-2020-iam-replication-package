...
import com.fhcore.common.i.h.a;
...
public class d
{
          ...
          new Thread(new Runnable()
          {
            public final void run()
            {
              try
              {
                ...
                com.fhcore.common.i.e.c("SDKContext", "adid:" + (String)localObject1);
  ...
  private static void a(Context paramContext, com.fhcore.common.e.a paramA, String paramString, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    localIntent.putExtra("cid", paramA.I());
    localIntent.putExtra("ctitle", paramA.K());
    localIntent.putExtra("cpackage", paramA.J());
    localIntent.putExtra("cicon", paramA.O());
    localIntent.putExtra("tracking_download_start", paramA.D());
    localIntent.putExtra("tracking_download_finish", paramA.E());
    localIntent.putExtra("tracking_download_install", paramA.F());
  ...
  public static void a(g paramG)
  {
    ...
    {
      com.fhcore.common.i.e.c("probe", "click:" + paramG.b() + ", campid:" + paramG.a());
          ...
          for (;;)
          {
            try
            {
              ...
              if (TextUtils.isEmpty((CharSequence)localObject1))
              {
                ...
                localObject2 = com.fhcore.common.g.b.a(d.a().b()).a(d.a().c());
                ...
                if (((Long)((JSONObject)localObject1).get(str)).longValue() >= System.currentTimeMillis() - ((com.fhcore.common.g.a)localObject2).au()) {
                  continue;
                }
      ...
      try
      {
        ...
        if (!bool) {
          try
          {
            ...
            localObject2 = com.fhcore.common.g.b.a(a().g).a(a().c());
            if (localObject2 != null)
            {
              Iterator localIterator = ((JSONObject)localObject1).keys();
  ...
  public final void g()
  {
    ...
    //   61: astore_3
    //   62: getstatic 68	com/fhcore/common/a/d:d	Ljava/util/HashMap;
    ...
    //   97: astore 5
    //   99: getstatic 68	com/fhcore/common/a/d:d	Ljava/util/HashMap;
    //   102: aload 5
    //   104: invokevirtual 242	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   107: checkcast 183	com/fhcore/common/e/g
    //   110: astore 6
    //   112: getstatic 52	com/fhcore/common/a/d:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   115: ifnull -40 -> 75
    //   118: getstatic 52	com/fhcore/common/a/d:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   121: aload 5
    //   123: invokevirtual 209	java/util/concurrent/ConcurrentHashMap:containsKey	(Ljava/lang/Object;)Z
    //   126: ifeq -51 -> 75
    //   129: getstatic 52	com/fhcore/common/a/d:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   132: aload 5
    //   134: invokevirtual 229	java/util/concurrent/ConcurrentHashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   137: checkcast 211	com/fhcore/common/e/h
    //   140: getfield 216	com/fhcore/common/e/h:b	Z
    //   143: ifne -68 -> 75
    //   146: aload 6
    //   148: invokestatic 222	java/lang/System:currentTimeMillis	()J
    //   151: invokevirtual 245	com/fhcore/common/e/g:a	(J)V
    //   154: aload_3
    //   155: aload 5
    //   157: aload 6
    //   159: invokevirtual 205	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   162: pop
    //   163: goto -88 -> 75
    //   166: astore 5
    //   168: aload 5
    //   170: invokevirtual 491	java/lang/Exception:printStackTrace	()V
    //   173: ldc_w 493
    //   176: ldc_w 495
    //   179: invokestatic 497	com/fhcore/common/i/e:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   182: goto -107 -> 75
    //   185: aload_0
    //   186: getfield 99	com/fhcore/common/a/d:g	Landroid/content/Context;
    //   189: invokestatic 379	com/fhcore/common/g/b:a	(Landroid/content/Context;)Lcom/fhcore/common/g/b;
    //   192: aload_0
    //   193: getfield 240	com/fhcore/common/a/d:h	Ljava/lang/String;
    //   196: invokevirtual 384	com/fhcore/common/g/b:a	(Ljava/lang/String;)Lcom/fhcore/common/g/a;
    //   199: astore 4
    //   201: aload 4
    //   203: ifnull +101 -> 304
    //   206: getstatic 68	com/fhcore/common/a/d:d	Ljava/util/HashMap;
    //   209: ifnull +95 -> 304
    //   212: getstatic 68	com/fhcore/common/a/d:d	Ljava/util/HashMap;
    ...
    //   245: astore 6
    //   247: getstatic 68	com/fhcore/common/a/d:d	Ljava/util/HashMap;
    //   250: aload 6
    //   252: invokevirtual 242	java/util/HashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   255: checkcast 183	com/fhcore/common/e/g
    //   258: astore 7
    //   260: aload_3
    //   261: aload 6
    ...
    //   266: ifne -41 -> 225
    //   269: aload 7
    //   271: invokevirtual 499	com/fhcore/common/e/g:c	()J
    //   274: invokestatic 222	java/lang/System:currentTimeMillis	()J
    //   277: aload 4
    //   279: invokevirtual 502	com/fhcore/common/g/a:aw	()J
    //   282: lsub
    //   283: lcmp
    //   284: ifle -59 -> 225
    //   287: aload_3
    //   288: aload 6
    //   290: aload 7
    //   292: invokevirtual 205	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   295: pop
    //   296: goto -71 -> 225
    //   299: astore_3
    //   300: aload_0
    ...
    //   302: aload_3
    //   303: athrow
    //   304: getstatic 68	com/fhcore/common/a/d:d	Ljava/util/HashMap;
    //   307: ifnull +9 -> 316
    //   310: getstatic 68	com/fhcore/common/a/d:d	Ljava/util/HashMap;
    //   313: invokevirtual 505	java/util/HashMap:clear	()V
    //   316: aload_3
    //   317: invokevirtual 267	java/util/HashMap:size	()I
    //   320: ifle +10 -> 330
    //   323: getstatic 68	com/fhcore/common/a/d:d	Ljava/util/HashMap;
    //   326: aload_3
    //   327: invokevirtual 509	java/util/HashMap:putAll	(Ljava/util/Map;)V
    //   330: aload_0
    //   331: getfield 99	com/fhcore/common/a/d:g	Landroid/content/Context;
    //   334: invokestatic 487	com/fhcore/common/a/c:a	(Landroid/content/Context;)Lcom/fhcore/common/a/c;
    //   337: getstatic 68	com/fhcore/common/a/d:d	Ljava/util/HashMap;
    //   340: invokevirtual 513	java/util/HashMap:values	()Ljava/util/Collection;
    //   343: invokevirtual 516	com/fhcore/common/a/c:a	(Ljava/util/Collection;)V
    //   346: goto -295 -> 51
    //   349: astore_3
    //   350: goto -299 -> 51
  ...
  public final void h()
  {
    com.fhcore.common.i.e.c("saveAppInfo-----------------addInstallApp---------------->", " " + d.size());
    try
    {
      if ((d != null) && (d.size() > 0)) {
  ...
  public final class a
  {
      ...
      implements IInterface
    {
      ...
      public final boolean b()
      {
        ...
        //   22: aload_0
        //   23: getfield 24	com/fhcore/common/a/d$a$c:b	Landroid/os/IBinder;
        //   26: iconst_2
        //   27: aload_3
        //   28: aload 4
        //   30: iconst_0
