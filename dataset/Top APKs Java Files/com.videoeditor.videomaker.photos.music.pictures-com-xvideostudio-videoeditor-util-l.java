...
public class l
{
  ...
  public static boolean a(String paramString1, String paramString2, android.os.Handler paramHandler)
  {
    ...
    //   30: lconst_0
    //   31: lstore 6
    //   33: new 468	java/io/FileInputStream
    //   36: dup
    //   37: aload 10
    //   39: invokespecial 469	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   42: astore_0
    //   43: new 312	java/io/FileOutputStream
    //   46: dup
    //   47: aload_1
    //   48: invokespecial 313	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   51: astore 9
    //   53: aload_0
    //   54: astore_1
    //   55: aload 9
    ...
    //   74: aload_0
    //   75: aload 11
    //   77: invokevirtual 472	java/io/InputStream:read	([B)I
    //   80: istore 4
    //   82: iload 4
    //   84: iconst_m1
    ...
    //   151: invokestatic 416	com/xvideostudio/videoeditor/tool/i:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   154: aload_0
    //   155: astore_1
    //   156: aload 9
    //   158: astore 8
    ...
    //   164: iconst_0
    //   165: iload 4
    //   167: invokevirtual 473	java/io/FileOutputStream:write	([BII)V
    //   170: aload_0
    //   171: astore_1
    //   172: aload 9
    //   174: astore 8
    ...
    //   181: lmul
    //   182: aload 10
    //   184: invokevirtual 479	java/io/File:length	()J
    //   187: ldiv
    //   188: l2i
    //   189: istore 5
    //   191: iload_3
    ...
    //   206: aload 9
    //   208: astore 8
    //   210: new 481	android/os/Message
    //   213: dup
    //   214: invokespecial 482	android/os/Message:<init>	()V
    //   217: astore 12
    //   219: aload_0
    //   220: astore_1
    //   221: aload 9
    ...
    //   228: dup
    //   229: invokespecial 483	android/os/Bundle:<init>	()V
    //   232: astore 13
    //   234: aload_0
    //   235: astore_1
    //   236: aload 9
    ...
    //   242: ldc_w 485
    //   245: lload 6
    //   247: invokevirtual 489	android/os/Bundle:putLong	(Ljava/lang/String;J)V
    //   250: aload_0
    //   251: astore_1
    //   252: aload 9
    //   254: astore 8
    ...
    //   258: ldc_w 491
    //   261: aload 10
    //   263: invokevirtual 479	java/io/File:length	()J
    //   266: invokevirtual 489	android/os/Bundle:putLong	(Ljava/lang/String;J)V
    //   269: aload_0
    //   270: astore_1
    //   271: aload 9
    //   273: astore 8
    //   275: aload 12
    //   277: iconst_0
    //   278: putfield 494	android/os/Message:what	I
    //   281: aload_0
    //   282: astore_1
    //   283: aload 9
    //   285: astore 8
    //   287: aload 12
    //   289: aload 13
    //   291: invokevirtual 498	android/os/Message:setData	(Landroid/os/Bundle;)V
    //   294: aload_0
    //   295: astore_1
    //   296: aload 9
    //   298: astore 8
    //   300: aload_2
    //   301: aload 12
    //   303: invokevirtual 504	android/os/Handler:sendMessage	(Landroid/os/Message;)Z
    //   306: pop
    //   307: iload 5
    //   309: istore 4
    //   311: iload 4
    ...
    //   318: ifnull +15 -> 333
    //   321: aload_0
    //   322: invokevirtual 505	java/io/InputStream:close	()V
    //   325: goto +8 -> 333
    //   328: astore_0
    //   329: aload_0
    ...
    //   335: ifnull +20 -> 355
    //   338: aload 9
    //   340: invokevirtual 506	java/io/FileOutputStream:flush	()V
    //   343: aload 9
    //   345: invokevirtual 427	java/io/FileOutputStream:close	()V
    //   348: iconst_1
    //   349: ireturn
    //   350: astore_0
    //   351: aload_0
    ...
    //   408: aconst_null
    //   409: ldc_w 508
    //   412: invokestatic 416	com/xvideostudio/videoeditor/tool/i:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   415: aload_2
    //   416: astore_1
    //   417: aload_0
    //   418: astore 8
    ...
    //   426: ifnull +15 -> 441
    //   429: aload_2
    //   430: invokevirtual 505	java/io/InputStream:close	()V
    //   433: goto +8 -> 441
    //   436: astore_1
    //   437: aload_1
    ...
    //   442: ifnull +18 -> 460
    //   445: aload_0
    //   446: invokevirtual 506	java/io/FileOutputStream:flush	()V
    //   449: aload_0
    //   450: invokevirtual 427	java/io/FileOutputStream:close	()V
    //   453: iconst_0
    //   454: ireturn
    //   455: astore_0
    //   456: aload_0
    ...
    //   466: ifnull +15 -> 481
    //   469: aload_2
    //   470: invokevirtual 505	java/io/InputStream:close	()V
    //   473: goto +8 -> 481
    //   476: astore_1
    //   477: aload_1
    ...
    //   483: ifnull +21 -> 504
    //   486: aload 8
    //   488: invokevirtual 506	java/io/FileOutputStream:flush	()V
    //   491: aload 8
    //   493: invokevirtual 427	java/io/FileOutputStream:close	()V
    //   496: goto +8 -> 504
    //   499: astore_1
    //   500: aload_1
  ...
  public static boolean b(String paramString1, String paramString2)
  {
    ...
    //   26: iconst_0
    //   27: ireturn
    //   28: new 468	java/io/FileInputStream
    //   31: dup
    //   32: aload_0
    //   33: invokespecial 469	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   36: astore 4
    //   38: new 55	java/io/File
    //   41: dup
    //   42: aload_1
    //   43: invokespecial 58	java/io/File:<init>	(Ljava/lang/String;)V
    //   46: invokevirtual 572	java/io/File:getParentFile	()Ljava/io/File;
    //   49: astore_0
    //   50: aload_0
    //   51: invokevirtual 62	java/io/File:exists	()Z
    //   54: ifne +8 -> 62
    //   57: aload_0
    //   58: invokevirtual 515	java/io/File:mkdirs	()Z
    //   61: pop
    //   62: new 312	java/io/FileOutputStream
    //   65: dup
    //   66: aload_1
    //   67: invokespecial 313	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   70: astore_0
    //   71: aload_0
    //   72: astore_1
    //   73: aload 4
    ...
    //   92: aload 4
    //   94: aload 6
    //   96: invokevirtual 472	java/io/InputStream:read	([B)I
    //   99: istore_3
    //   100: iload_3
    //   101: iconst_m1
    ...
    //   130: aload 7
    //   132: iload_2
    //   133: invokevirtual 458	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   136: pop
    //   137: aload_0
    //   138: astore_1
    //   139: aload 4
    ...
    //   163: invokestatic 416	com/xvideostudio/videoeditor/tool/i:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   166: aload_0
    //   167: astore_1
    //   168: aload 4
    //   170: astore 5
    ...
    //   175: iconst_0
    //   176: iload_3
    //   177: invokevirtual 473	java/io/FileOutputStream:write	([BII)V
    //   180: goto -94 -> 86
    //   183: aload 4
    //   185: ifnull +16 -> 201
    //   188: aload 4
    //   190: invokevirtual 505	java/io/InputStream:close	()V
    //   193: goto +8 -> 201
    //   196: astore_1
    //   197: aload_1
    ...
    //   202: ifnull +19 -> 221
    //   205: aload_0
    //   206: invokevirtual 506	java/io/FileOutputStream:flush	()V
    //   209: aload_0
    //   210: invokevirtual 427	java/io/FileOutputStream:close	()V
    //   213: goto +8 -> 221
    //   216: astore_0
    //   217: aload_0
    ...
    //   263: aconst_null
    //   264: ldc_w 508
    //   267: invokestatic 416	com/xvideostudio/videoeditor/tool/i:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   270: aload_0
    //   271: astore_1
    //   272: aload 4
    //   274: astore 5
    ...
    //   283: ifnull +16 -> 299
    //   286: aload 4
    //   288: invokevirtual 505	java/io/InputStream:close	()V
    //   291: goto +8 -> 299
    //   294: astore_1
    //   295: aload_1
    ...
    //   300: ifnull +18 -> 318
    //   303: aload_0
    //   304: invokevirtual 506	java/io/FileOutputStream:flush	()V
    //   307: aload_0
    //   308: invokevirtual 427	java/io/FileOutputStream:close	()V
    //   311: iconst_0
    //   312: ireturn
    //   313: astore_0
    //   314: aload_0
    ...
    //   327: ifnull +18 -> 345
    //   330: aload 4
    //   332: invokevirtual 505	java/io/InputStream:close	()V
    //   335: goto +10 -> 345
    //   338: astore 4
    //   340: aload 4
    ...
    //   346: ifnull +19 -> 365
    //   349: aload_1
    //   350: invokevirtual 506	java/io/FileOutputStream:flush	()V
    //   353: aload_1
    //   354: invokevirtual 427	java/io/FileOutputStream:close	()V
    //   357: goto +8 -> 365
    //   360: astore_1
    //   361: aload_1
