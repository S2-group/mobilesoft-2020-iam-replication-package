  ...
  extends Activity
{
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.exit = ((ImageView)findViewById(2131361883));
    this.webnotice = ((WebView)findViewById(2131361884));
    ...
    this.webnotice.loadUrl("http://api.pororohome.com/event/transfer?appId=kr.co.sing.pororof&market=3");
