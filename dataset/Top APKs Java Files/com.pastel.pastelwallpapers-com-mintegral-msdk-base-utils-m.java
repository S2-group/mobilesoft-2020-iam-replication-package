...
public final class m
{
  ...
  public static double a(Double paramDouble)
  {
    try
    {
      ...
      i.b("CommonUtils", localStringBuilder.toString());
    ...
    throws Exception
  {
    ...
    //   9: astore 8
    //   11: aload_0
    //   12: invokevirtual 145	java/io/File:exists	()Z
    //   15: ifeq +37 -> 52
    //   18: new 147	java/io/FileInputStream
    //   21: dup
    //   22: aload_0
    //   23: invokespecial 150	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   26: astore_0
    //   27: aload_0
    //   28: invokevirtual 154	java/io/FileInputStream:available	()I
    //   31: istore_1
    //   32: iload_1
    //   33: i2l
    //   34: lstore_2
    ...
    //   49: goto +44 -> 93
    //   52: aload_0
    //   53: invokevirtual 157	java/io/File:createNewFile	()Z
    //   56: pop
    //   57: ldc -97
    //   59: ldc -95
    //   61: invokestatic 163	com/mintegral/msdk/base/utils/i:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   64: aload 8
    //   66: astore_0
    //   67: lload_2
    //   68: lstore 4
    ...
    //   83: ifnull +8 -> 91
    //   86: aload 6
    //   88: invokevirtual 166	java/io/FileInputStream:close	()V
    //   91: aload_0
    //   92: athrow
    //   93: lload_2
    //   94: lstore 4
  ...
  public static String a(JSONArray paramJSONArray)
  {
    ...
    int j = ((com.mintegral.msdk.b.a)localObject).ac();
  ...
  public static List<com.mintegral.msdk.base.entity.l> d()
  {
    ...
    //   0: ldc 49
    //   2: ldc_w 445
    //   5: invokestatic 58	com/mintegral/msdk/base/utils/i:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   8: new 260	java/util/ArrayList
    //   11: dup
    //   12: invokespecial 261	java/util/ArrayList:<init>	()V
    //   15: astore 5
    //   17: new 447	java/io/BufferedReader
    //   20: dup
    //   21: new 449	java/io/InputStreamReader
    //   24: dup
    //   25: invokestatic 455	java/lang/Runtime:getRuntime	()Ljava/lang/Runtime;
    //   28: ldc_w 457
    //   31: invokevirtual 461	java/lang/Runtime:exec	(Ljava/lang/String;)Ljava/lang/Process;
    //   34: invokevirtual 467	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   37: invokespecial 470	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   40: sipush 1024
    //   43: invokespecial 473	java/io/BufferedReader:<init>	(Ljava/io/Reader;I)V
    //   46: astore_3
    //   47: aload_3
    //   48: astore_2
    //   49: aload_3
    //   50: invokevirtual 476	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   53: astore 4
    //   55: aload 4
    //   57: ifnull +125 -> 182
    //   60: aload_3
    ...
    //   62: aload 4
    //   64: ldc_w 478
    //   67: invokevirtual 481	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   70: ifeq -23 -> 47
    //   73: aload_3
    //   74: astore_2
    //   75: aload 4
    //   77: ldc_w 483
    //   80: invokevirtual 487	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   83: astore 6
    //   85: aload 6
    //   87: ifnull -40 -> 47
    //   90: aload_3
    ...
    //   176: invokestatic 163	com/mintegral/msdk/base/utils/i:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   179: goto -132 -> 47
    //   182: aload_3
    //   183: invokevirtual 492	java/io/BufferedReader:close	()V
    //   186: goto +48 -> 234
    //   189: astore_2
    //   190: aload_2
    ...
    //   220: ifnull +14 -> 234
    //   223: aload_3
    //   224: invokevirtual 492	java/io/BufferedReader:close	()V
    //   227: goto +7 -> 234
    //   230: astore_2
    //   231: goto -41 -> 190
    //   234: new 260	java/util/ArrayList
    //   237: dup
    //   238: invokespecial 261	java/util/ArrayList:<init>	()V
    //   241: astore_2
    //   242: invokestatic 181	com/mintegral/msdk/base/controller/a:d	()Lcom/mintegral/msdk/base/controller/a;
    //   245: invokevirtual 268	com/mintegral/msdk/base/controller/a:i	()Landroid/content/Context;
    //   248: invokevirtual 331	android/content/Context:getPackageManager	()Landroid/content/pm/PackageManager;
    //   251: astore_3
    //   252: iconst_0
    //   253: istore_1
    //   254: aload_3
    //   255: iconst_0
    //   256: invokevirtual 339	android/content/pm/PackageManager:getInstalledPackages	(I)Ljava/util/List;
    //   259: astore_3
    //   260: invokestatic 181	com/mintegral/msdk/base/controller/a:d	()Lcom/mintegral/msdk/base/controller/a;
    //   263: invokevirtual 342	com/mintegral/msdk/base/controller/a:b	()Ljava/util/List;
    //   266: astore 4
    //   268: iconst_0
    //   269: istore_0
    //   270: iload_0
    //   271: aload_3
    //   272: invokeinterface 258 1 0
    //   277: if_icmpge +88 -> 365
    //   280: aload_3
    //   281: iload_0
    //   282: invokeinterface 262 2 0
    //   287: checkcast 344	android/content/pm/PackageInfo
    //   290: astore 6
    //   292: aload 6
    //   294: getfield 348	android/content/pm/PackageInfo:applicationInfo	Landroid/content/pm/ApplicationInfo;
    //   297: getfield 353	android/content/pm/ApplicationInfo:flags	I
    //   300: iconst_1
    //   301: iand
    //   302: ifgt +18 -> 320
    //   305: aload_2
    //   306: aload 6
    //   308: getfield 356	android/content/pm/PackageInfo:packageName	Ljava/lang/String;
    //   311: invokeinterface 284 2 0
    //   316: pop
    //   317: goto +199 -> 516
    //   320: aload 4
    //   322: ifnull +194 -> 516
    //   325: aload 4
    //   327: invokeinterface 258 1 0
    //   332: ifle +184 -> 516
    //   335: aload 4
    //   337: aload 6
    //   339: getfield 356	android/content/pm/PackageInfo:packageName	Ljava/lang/String;
    //   342: invokeinterface 359 2 0
    //   347: ifeq +169 -> 516
    //   350: aload_2
    //   351: aload 6
    //   353: getfield 356	android/content/pm/PackageInfo:packageName	Ljava/lang/String;
    //   356: invokeinterface 284 2 0
    //   361: pop
    //   362: goto +154 -> 516
    //   365: new 260	java/util/ArrayList
    //   368: dup
    //   369: invokespecial 261	java/util/ArrayList:<init>	()V
    //   372: astore_3
    //   373: iload_1
    //   374: istore_0
    //   375: iload_0
    //   376: aload 5
    //   378: invokeinterface 258 1 0
    //   383: if_icmpge +85 -> 468
    //   386: aload 5
    //   388: iload_0
    //   389: invokeinterface 262 2 0
    //   394: checkcast 126	java/lang/String
    //   397: astore 4
    //   399: aload_2
    //   400: aload 4
    //   402: invokeinterface 359 2 0
    //   407: ifeq +116 -> 523
    ...
    //   437: invokestatic 58	com/mintegral/msdk/base/utils/i:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   440: new 496	com/mintegral/msdk/base/entity/l
    //   443: dup
    //   444: invokespecial 497	com/mintegral/msdk/base/entity/l:<init>	()V
    //   447: astore 6
    //   449: aload 6
    //   451: aload 4
    //   453: putfield 499	com/mintegral/msdk/base/entity/l:a	Ljava/lang/String;
    //   456: aload_3
    //   457: aload 6
    //   459: invokeinterface 284 2 0
    //   464: pop
    //   465: goto +58 -> 523
    //   468: ldc 49
    //   470: ldc_w 501
    //   473: invokestatic 58	com/mintegral/msdk/base/utils/i:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   476: aload_3
    //   477: areturn
    //   478: astore 4
    //   480: aload_2
    ...
    //   486: ifnull +15 -> 501
    //   489: aload_3
    //   490: invokevirtual 492	java/io/BufferedReader:close	()V
    //   493: goto +8 -> 501
    //   496: astore_3
    //   497: aload_3
    ...
    //   504: ldc 49
    //   506: aload_2
    //   507: invokevirtual 135	java/lang/Throwable:getMessage	()Ljava/lang/String;
    //   510: aload_2
    //   511: invokestatic 138	com/mintegral/msdk/base/utils/i:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   514: aconst_null
    //   515: areturn
    //   516: iload_0
    //   517: iconst_1
  ...
  public static int i(Context paramContext)
  {
    ...
    try
    {
      int i = p(paramContext).heightPixels;
      return i;
    }
    catch (Exception paramContext)
    {
  ...
  public static int j(Context paramContext)
  {
    ...
    try
    {
      int i = p(paramContext).widthPixels;
      return i;
    }
    catch (Exception paramContext)
    {
  ...
  private static DisplayMetrics p(Context paramContext)
  {
    if (paramContext == null) {
      return null;
    }
