...
public class e
{
  ...
  public void a(Context paramContext, String paramString)
  {
    try
    {
      ...
      localIntent.putExtra("android.intent.extra.SUBJECT", paramContext.getString(R.string.td_share_title));
      localIntent.putExtra("android.intent.extra.TEXT", paramContext.getString(R.string.td_share_text, new Object[] { paramString, "https://play.google.com/store/apps/details?id=com.popularapp.thirtydayfitnesschallenge" }));
