  ...
  public static HashMap<String, String> e(Context paramContext)
  {
    ...
    for (;;)
    {
      synchronized (g)
      {
        ...
        Object localObject3 = ((ConnectivityManager)paramContext.getSystemService("connectivity")).getActiveNetworkInfo();
        ??? = null;
        localObject1 = ???;
        if (localObject3 != null)
        {
          m = ((NetworkInfo)localObject3).getType();
          n = ((NetworkInfo)localObject3).getSubtype();
          if (m == 1)
          {
            localObject1 = "wifi";
          }
