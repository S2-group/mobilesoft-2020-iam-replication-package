    ...
    try
    {
      ...
      while (localContext != null)
      {
        ...
        for (;;)
        {
          ...
          localObject1 = new Utils(localContext);
          localObject2 = DeviceEvents.getPendingEvents(localContext);
          if (localObject2 == null) {
            break label982;
          }
          localObject3 = localUserSettings.getDeviceEventsUrl();
          localObject4 = new JSONObject();
          ((JSONObject)localObject4).put("de", ((DeviceEventData)localObject2).getData());
          localUserSettings.load(UserSettingsResponse.unserialize(((Utils)localObject1).postUrl((String)localObject3, (JSONObject)localObject4, localContext, 2000, 30000, false)));
          localUserSettings.saveToDisk(localContext);
          if (localObject2 == null) {
            break label982;
          }
          ((DeviceEventData)localObject2).deleteFiles();
          return;
