...
class fs
{
  ...
  class a
  {
    ...
    private final String f = ge.a(a.class);
    ...
    {
      // Byte code:
      //   0: getstatic 29	com/tapjoy/internal/fs$a:d	Z
      //   3: ifne +15 -> 18
      //   6: aload_1
      //   7: ifnonnull +11 -> 18
      ...
      //   17: athrow
      //   18: aload_0
      //   19: getfield 45	com/tapjoy/internal/fs$a:a	Z
      //   22: ifeq +8 -> 30
      //   25: aload_0
      //   26: getfield 45	com/tapjoy/internal/fs$a:a	Z
      //   29: ireturn
      //   30: aload_0
      //   31: getfield 60	com/tapjoy/internal/fs$a:g	Ljava/util/concurrent/locks/Lock;
      //   34: invokeinterface 79 1 0
      //   39: aload_0
      //   40: getfield 45	com/tapjoy/internal/fs$a:a	Z
      //   43: ifeq +19 -> 62
      //   46: aload_0
      //   47: getfield 45	com/tapjoy/internal/fs$a:a	Z
      //   50: istore_2
      //   51: aload_0
      //   52: getfield 60	com/tapjoy/internal/fs$a:g	Ljava/util/concurrent/locks/Lock;
      ...
      //   75: aload_0
      //   76: aload_0
      //   77: getstatic 107	com/tapjoy/internal/gp:a	Ljava/lang/Integer;
      //   80: invokevirtual 113	java/lang/Integer:intValue	()I
      //   83: aload_1
      //   84: invokespecial 115	com/tapjoy/internal/fs$a:a	(ILjava/lang/String;)Z
      //   87: putfield 45	com/tapjoy/internal/fs$a:a	Z
      //   90: new 117	java/lang/StringBuilder
      //   93: dup
      //   94: ldc 119
      //   96: invokespecial 121	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
      //   99: aload_0
      //   100: getfield 47	com/tapjoy/internal/fs$a:b	I
      //   103: invokevirtual 125	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
      //   106: pop
      //   107: aload_0
      //   108: getfield 60	com/tapjoy/internal/fs$a:g	Ljava/util/concurrent/locks/Lock;
      //   111: invokeinterface 82 1 0
      //   116: aload_0
      //   117: getfield 45	com/tapjoy/internal/fs$a:a	Z
      //   120: ireturn
      //   121: astore_1
      //   122: aload_0
      //   123: iconst_0
      //   124: putfield 45	com/tapjoy/internal/fs$a:a	Z
      //   127: goto -37 -> 90
      //   130: astore_1
      //   131: aload_0
      //   132: getfield 60	com/tapjoy/internal/fs$a:g	Ljava/util/concurrent/locks/Lock;
      //   135: invokeinterface 82 1 0
      //   140: aload_1
      //   141: athrow
      //   142: astore_1
      //   143: aload_0
      //   144: getfield 43	com/tapjoy/internal/fs$a:f	Ljava/lang/String;
      //   147: ldc 127
      //   149: aload_1
