  ...
  extends BaseBo
{
  ...
  public static void copyAssets(String paramString1, String paramString2, String paramString3)
  {
    ...
    //   3: dup
    //   4: aload_1
    //   5: invokespecial 95	java/io/File:<init>	(Ljava/lang/String;)V
    //   8: astore 7
    //   10: aload 7
    //   12: invokevirtual 99	java/io/File:exists	()Z
    //   15: ifne +19 -> 34
    //   18: aload 7
    //   20: invokevirtual 102	java/io/File:mkdirs	()Z
    //   23: ifne +11 -> 34
    //   26: ldc 104
    //   28: ldc 106
    //   30: invokestatic 112	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;)I
    //   33: pop
    //   34: aconst_null
    //   35: astore_1
    //   36: aconst_null
    ...
    //   45: aload 6
    //   47: astore_3
    //   48: getstatic 116	com/babybus/bbmodule/system/jni/plugin/manager/SystemBo:activity	Landroid/support/v4/app/FragmentActivity;
    //   51: invokevirtual 122	android/support/v4/app/FragmentActivity:getResources	()Landroid/content/res/Resources;
    //   54: invokevirtual 128	android/content/res/Resources:getAssets	()Landroid/content/res/AssetManager;
    //   57: aload_0
    //   58: invokevirtual 134	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   61: astore_0
    //   62: aload_0
    //   63: astore 4
    //   65: aload_0
    ...
    //   67: aload 6
    //   69: astore_3
    //   70: new 136	java/io/FileOutputStream
    //   73: dup
    //   74: new 92	java/io/File
    //   77: dup
    //   78: aload 7
    //   80: aload_2
    //   81: invokespecial 139	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   84: invokespecial 142	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   87: astore_2
    //   88: aload_0
    //   89: aload_2
    //   90: invokestatic 148	org/apache/commons/io/IOUtils:copy	(Ljava/io/InputStream;Ljava/io/OutputStream;)I
    //   93: pop
    //   94: aload_0
    //   95: invokevirtual 153	java/io/InputStream:close	()V
    //   98: aload_2
    //   99: invokevirtual 156	java/io/OutputStream:close	()V
    //   102: aload_0
    //   103: ifnull +7 -> 110
    //   106: aload_0
    //   107: invokevirtual 153	java/io/InputStream:close	()V
    //   110: aload_2
    //   111: ifnull +102 -> 213
    //   114: aload_2
    //   115: invokevirtual 156	java/io/OutputStream:close	()V
    //   118: return
    //   119: astore_2
    //   120: aload 5
    //   122: astore_0
    ...
    //   127: astore_3
    //   128: aload_2
    //   129: invokevirtual 159	java/io/IOException:printStackTrace	()V
    //   132: aload 4
    //   134: ifnull +8 -> 142
    //   137: aload 4
    //   139: invokevirtual 153	java/io/InputStream:close	()V
    //   142: aload_0
    //   143: ifnull -25 -> 118
    //   146: aload_0
    //   147: invokevirtual 156	java/io/OutputStream:close	()V
    //   150: return
    //   151: astore_0
    //   152: aload_0
    //   153: invokevirtual 159	java/io/IOException:printStackTrace	()V
    //   156: return
    //   157: astore_1
    //   158: aload_1
    //   159: invokevirtual 159	java/io/IOException:printStackTrace	()V
    //   162: goto -20 -> 142
    //   165: astore_0
    //   166: aload_1
    //   167: ifnull +7 -> 174
    //   170: aload_1
    //   171: invokevirtual 153	java/io/InputStream:close	()V
    //   174: aload_3
    //   175: ifnull +7 -> 182
    //   178: aload_3
    //   179: invokevirtual 156	java/io/OutputStream:close	()V
    //   182: aload_0
    //   183: athrow
    //   184: astore_1
    //   185: aload_1
    //   186: invokevirtual 159	java/io/IOException:printStackTrace	()V
    //   189: goto -15 -> 174
    //   192: astore_1
    //   193: aload_1
    ...
    //   200: astore_0
    //   201: aload_0
    //   202: invokevirtual 159	java/io/IOException:printStackTrace	()V
    //   205: goto -95 -> 110
    //   208: astore_0
    //   209: aload_0
    //   210: invokevirtual 159	java/io/IOException:printStackTrace	()V
    //   213: return
    //   214: astore 4
    //   216: aload_0
    //   217: astore_1
  ...
  public static void launchMarket(String paramString)
  {
    // Byte code:
    //   0: ldc_w 724
    //   3: getstatic 285	android/os/Build:BRAND	Ljava/lang/String;
    //   6: invokevirtual 470	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   9: ifeq +8 -> 17
    //   12: aload_0
    //   13: invokestatic 727	com/babybus/bbmodule/system/jni/plugin/manager/SystemBo:launchMarketLenovo	(Ljava/lang/String;)V
    //   16: return
    //   17: invokestatic 729	com/babybus/bbmodule/system/jni/plugin/manager/SystemBo:isMarketInstalledAmazon	()Z
    //   20: ifeq +45 -> 65
    //   23: new 731	android/content/Intent
    //   26: dup
    //   27: ldc_w 733
    //   30: new 170	java/lang/StringBuilder
    //   33: dup
    //   34: ldc_w 735
    //   37: invokespecial 171	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   40: aload_0
    //   41: invokevirtual 738	java/lang/String:trim	()Ljava/lang/String;
    //   44: invokevirtual 175	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   47: invokevirtual 179	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   50: invokestatic 744	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   53: invokespecial 747	android/content/Intent:<init>	(Ljava/lang/String;Landroid/net/Uri;)V
    //   56: astore_1
    //   57: getstatic 116	com/babybus/bbmodule/system/jni/plugin/manager/SystemBo:activity	Landroid/support/v4/app/FragmentActivity;
    //   60: aload_1
    //   61: invokevirtual 751	android/support/v4/app/FragmentActivity:startActivity	(Landroid/content/Intent;)V
    //   64: return
    //   65: aload_0
    //   66: invokestatic 754	com/babybus/bbmodule/system/jni/plugin/manager/SystemBo:launchMarketDefault	(Ljava/lang/String;)V
    //   69: return
    //   70: astore_1
    //   71: aload_0
    //   72: invokestatic 754	com/babybus/bbmodule/system/jni/plugin/manager/SystemBo:launchMarketDefault	(Ljava/lang/String;)V
    //   75: return
    //   76: astore_1
    //   77: goto -6 -> 71
    // Local variable table:
