  ...
  extends AsyncTask<Object, Object, List<AppInfo>>
{
  ...
  protected List<AppInfo> a(Object... paramVarArgs)
  {
  ...
  protected void a(final List<AppInfo> paramList)
  {
    paramList = new ArrayAdapter(this.c, R.layout.app_picker_list_item, R.id.app_picker_list_item_label, paramList)
    {
      public View getView(int paramAnonymousInt, View paramAnonymousView, ViewGroup paramAnonymousViewGroup)
      {
        paramAnonymousView = super.getView(paramAnonymousInt, paramAnonymousView, paramAnonymousViewGroup);
        paramAnonymousViewGroup = ((AppInfo)paramList.get(paramAnonymousInt)).b();
