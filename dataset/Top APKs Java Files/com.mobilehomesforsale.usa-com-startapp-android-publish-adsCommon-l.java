...
public class l
{
  ...
  public static void a(Context paramContext)
  {
    ...
    paramContext.registerReceiver(new l.1(), localIntentFilter);
    MetaData.getInstance().addMetaDataListener(new l.2(paramContext));
  }
  ...
  private static void a(PackageInfo paramPackageInfo, PackageManager paramPackageManager, Set<String> paramSet)
  {
    ...
    {
      com.startapp.common.a.h.a("SimpleToken", 6, "addToPackagesFromInstallers - can't add app to list " + paramPackageInfo.getMessage());
    }
  }
  ...
  public static void c(Context paramContext)
  {
    ...
    if (!f) {
      g.a(g.a.b, new l.3(paramContext));
    }
  }
  ...
  private static void c(List<PackageInfo> paramList)
  {
    if (Build.VERSION.SDK_INT >= 9) {
      Collections.sort(paramList, new l.4());
    }
  }
