...
public class ZSystemInfo
{
  ...
  {
    ZSystemInfo localZSystemInfo = new ZSystemInfo(ServiceLocator.instance().getActivity());
    ServiceLocator.instance().set(ZSystemInfo.class, localZSystemInfo);
  }
  ...
  public static String getLocaleStatic()
  {
    ...
    do
    {
      ...
      localObject = str1;
    } while (!str2.equals("tw"));
    return "zh-hant";
  }
  
  public static Object getServiceInstance()
  {
    return ServiceLocator.instance().get(ZSystemInfo.class);
  }
  ...
  {
    return NotificationManagerCompat.from(this.m_activity.getApplicationContext()).areNotificationsEnabled();
  }
  
  public String getAdvertisingId()
  {
    long l = System.currentTimeMillis();
    if (((this.m_cachedAdvertisingId == null) || (this.m_cachedAdvertisingId.isEmpty())) && (l - this.lastRequestTime > 5000L))
    {
      this.lastRequestTime = l;
      this.m_activity.runOnUiThread(new ZSystemInfo.1(this));
    }
  ...
  {
    String str = null;
    Object localObject = (TelephonyManager)this.m_activity.getSystemService("phone");
    if (localObject != null) {
  ...
  public String getCarrierName()
  {
    ...
    Object localObject = (TelephonyManager)this.m_activity.getSystemService("phone");
    if (localObject != null) {
      str = ((TelephonyManager)localObject).getSimOperatorName();
    }
    localObject = str;
    if (str == null) {
      localObject = "";
  ...
  public float getDensityMagic()
  {
    ...
    return (localDisplayMetrics.xdpi + localDisplayMetrics.ydpi) / 2.0F / 2.54F;
  }
  ...
  public String[] getInstalledApps(ArrayList paramArrayList)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localPackageInfo.packageName.startsWith("com.zapp")) {
  ...
  {
    new ZSystemInfo.AdvertisingIdTask(this, null).execute(new Void[0]);
  }
