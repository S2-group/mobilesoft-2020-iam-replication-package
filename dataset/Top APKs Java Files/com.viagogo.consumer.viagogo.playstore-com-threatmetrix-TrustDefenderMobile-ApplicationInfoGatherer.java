...
class ApplicationInfoGatherer
{
  ...
  {
    // Byte code:
    //   0: getstatic 67	com/threatmetrix/TrustDefenderMobile/NativeGatherer:INSTANCE	Lcom/threatmetrix/TrustDefenderMobile/NativeGatherer;
    //   3: invokevirtual 71	com/threatmetrix/TrustDefenderMobile/NativeGatherer:isAvailable	()Z
    //   6: ifeq +11 -> 17
    //   9: getstatic 67	com/threatmetrix/TrustDefenderMobile/NativeGatherer:INSTANCE	Lcom/threatmetrix/TrustDefenderMobile/NativeGatherer;
    //   12: aload_0
    //   13: invokevirtual 74	com/threatmetrix/TrustDefenderMobile/NativeGatherer:hashFile	(Ljava/lang/String;)Ljava/lang/String;
    //   16: areturn
    //   17: getstatic 16	com/threatmetrix/TrustDefenderMobile/ApplicationInfoGatherer:TAG	Ljava/lang/String;
    //   20: ldc 76
    //   22: invokestatic 51	android/util/Log:d	(Ljava/lang/String;Ljava/lang/String;)I
    //   25: pop
    //   26: ldc 78
    //   28: invokestatic 84	java/security/MessageDigest:getInstance	(Ljava/lang/String;)Ljava/security/MessageDigest;
    //   31: astore_2
    //   32: new 86	java/io/FileInputStream
    //   35: dup
    //   36: aload_0
    //   37: invokespecial 89	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   40: astore_3
    //   41: aconst_null
    //   42: astore_0
    //   43: sipush 8192
    ...
    //   50: aload_3
    //   51: aload 4
    //   53: invokevirtual 95	java/io/InputStream:read	([B)I
    //   56: istore_1
    //   57: iload_1
    //   58: ifle +83 -> 141
    //   61: aload_2
    ...
    //   64: iconst_0
    //   65: iload_1
    //   66: invokevirtual 99	java/security/MessageDigest:update	([BII)V
    //   69: goto -19 -> 50
    //   72: astore_2
    //   73: getstatic 16	com/threatmetrix/TrustDefenderMobile/ApplicationInfoGatherer:TAG	Ljava/lang/String;
    //   76: ldc 101
    //   78: aload_2
    //   79: invokestatic 105	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   82: pop
    //   83: aload_3
    //   84: invokevirtual 108	java/io/InputStream:close	()V
    ...
    //   93: dup
    //   94: invokespecial 36	java/lang/StringBuilder:<init>	()V
    //   97: ldc 110
    ...
    //   106: invokevirtual 45	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   109: invokestatic 51	android/util/Log:d	(Ljava/lang/String;Ljava/lang/String;)I
    //   112: pop
    //   113: aload_0
    //   114: areturn
    //   115: astore_0
    ...
    //   119: ldc 112
    //   121: aload_0
    //   122: invokestatic 105	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   125: pop
    //   126: aconst_null
    //   127: areturn
    //   128: astore_0
    ...
    //   132: ldc 114
    //   134: aload_0
    //   135: invokestatic 105	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   138: pop
    //   139: aconst_null
    //   140: areturn
    //   141: ldc 116
    ...
    //   147: dup
    //   148: iconst_0
    //   149: new 118	java/math/BigInteger
    //   152: dup
    //   153: iconst_1
    //   154: aload_2
    //   155: invokevirtual 122	java/security/MessageDigest:digest	()[B
    //   158: invokespecial 125	java/math/BigInteger:<init>	(I[B)V
    //   161: bipush 16
    //   163: invokevirtual 128	java/math/BigInteger:toString	(I)Ljava/lang/String;
    //   166: aastore
    //   167: invokestatic 134	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   170: bipush 32
    //   172: bipush 48
    //   174: invokevirtual 138	java/lang/String:replace	(CC)Ljava/lang/String;
    //   177: astore_2
    //   178: aload_2
    //   179: astore_0
    //   180: aload_3
    ...
    //   215: astore_0
    //   216: aload_3
    //   217: invokevirtual 108	java/io/InputStream:close	()V
    //   220: aload_0
    //   221: athrow
    //   222: astore_2
    ...
    //   226: ldc -116
    //   228: aload_2
    //   229: invokestatic 105	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   232: pop
    //   233: goto -13 -> 220
