...
public final class l
{
  ...
  public static double a(Double paramDouble)
  {
    ...
    {
      com.google.a.a.a.a.a.a.a(paramDouble);
    }
    return 0.0D;
  }
    ...
    throws Exception
  {
    ...
    //   3: astore 6
    //   5: aload_0
    //   6: invokevirtual 148	java/io/File:exists	()Z
    //   9: ifeq +37 -> 46
    //   12: new 150	java/io/FileInputStream
    //   15: dup
    //   16: aload_0
    //   17: invokespecial 153	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   20: astore_0
    //   21: aload_0
    //   22: invokevirtual 157	java/io/FileInputStream:available	()I
    //   25: istore_1
    //   26: iload_1
    //   27: i2l
    //   28: lstore_2
    ...
    //   33: ifnull +10 -> 43
    //   36: aload_0
    //   37: invokevirtual 160	java/io/FileInputStream:close	()V
    //   40: lload_2
    //   41: lstore 4
    //   43: lload 4
    //   45: lreturn
    //   46: aload_0
    //   47: invokevirtual 163	java/io/File:createNewFile	()Z
    //   50: pop
    //   51: ldc -91
    //   53: ldc -89
    //   55: invokestatic 169	com/mobvista/msdk/base/utils/h:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   58: aconst_null
    //   59: astore_0
    //   60: goto -31 -> 29
    //   63: astore_0
    ...
    //   70: ifnull -27 -> 43
    //   73: aload_0
    //   74: invokevirtual 160	java/io/FileInputStream:close	()V
    //   77: lconst_0
    //   78: lreturn
    //   79: astore_0
    //   80: lconst_0
    ...
    //   85: ifnull +8 -> 93
    //   88: aload 6
    //   90: invokevirtual 160	java/io/FileInputStream:close	()V
    //   93: aload_0
    //   94: athrow
    //   95: astore_0
    //   96: lload_2
      ...
      for (;;)
      {
        if (i < j) {
          ...
          catch (JSONException localJSONException)
          {
            for (;;)
            {
              com.google.a.a.a.a.a.a.a(localJSONException);
            }
          }
        }
      }
  ...
  public static void a(View paramView)
  {
    ...
    for (;;)
    {
      ...
      {
        com.google.a.a.a.a.a.a.a(paramView);
      }
    }
  }
  ...
  public static void a(ImageView paramImageView)
  {
    ...
    com.google.a.a.a.a.a.a.a(paramImageView);
  }
  ...
  public static boolean a(Context paramContext, String paramString)
  {
    ...
    for (;;)
    {
      ...
      int i = 0;
      while (i < com.mobvista.msdk.base.controller.a.b.size())
      {
  ...
  public static boolean a(CampaignEx paramCampaignEx)
  {
    if (paramCampaignEx != null) {
      ...
      {
        com.google.a.a.a.a.a.a.a(paramCampaignEx);
      }
    }
    return false;
  }
  ...
  public static boolean a(String paramString, Context paramContext)
  {
    try
    {
      ...
      {
        h.a("CommonUtils", "Permission " + paramString + " is granted");
        return true;
      }
      h.a("CommonUtils", "Permission " + paramString + " is NOT granted");
      return false;
    }
  ...
  public static List<com.mobvista.msdk.base.entity.j> d()
  {
    ...
    //   2: ldc 39
    //   4: ldc_w 445
    //   7: invokestatic 60	com/mobvista/msdk/base/utils/h:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   10: new 261	java/util/ArrayList
    //   13: dup
    //   14: invokespecial 262	java/util/ArrayList:<init>	()V
    //   17: astore 5
    //   19: new 447	java/io/BufferedReader
    //   22: dup
    //   23: new 449	java/io/InputStreamReader
    //   26: dup
    //   27: invokestatic 455	java/lang/Runtime:getRuntime	()Ljava/lang/Runtime;
    //   30: ldc_w 457
    //   33: invokevirtual 461	java/lang/Runtime:exec	(Ljava/lang/String;)Ljava/lang/Process;
    //   36: invokevirtual 467	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   39: invokespecial 470	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   42: sipush 1024
    //   45: invokespecial 473	java/io/BufferedReader:<init>	(Ljava/io/Reader;I)V
    //   48: astore_3
    //   49: aload_3
    //   50: astore_2
    //   51: aload_3
    //   52: invokevirtual 476	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   55: astore 4
    //   57: aload 4
    //   59: ifnull +207 -> 266
    //   62: aload_3
    ...
    //   64: aload 4
    //   66: ldc_w 478
    //   69: invokevirtual 481	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   72: ifeq -23 -> 49
    //   75: aload_3
    //   76: astore_2
    //   77: aload 4
    //   79: ldc_w 483
    //   82: invokevirtual 487	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   85: astore 6
    //   87: aload 6
    //   89: ifnull -40 -> 49
    //   92: aload_3
    ...
    //   157: invokestatic 169	com/mobvista/msdk/base/utils/h:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   160: goto -111 -> 49
    //   163: astore 4
    //   165: aload_3
    //   166: astore_2
    //   167: aload 4
    //   169: invokestatic 104	com/google/a/a/a/a/a/a:a	(Ljava/lang/Throwable;)V
    //   172: aload_3
    //   173: ifnull +7 -> 180
    //   176: aload_3
    //   177: invokevirtual 492	java/io/BufferedReader:close	()V
    //   180: new 261	java/util/ArrayList
    //   183: dup
    //   184: invokespecial 262	java/util/ArrayList:<init>	()V
    //   187: astore_2
    //   188: invokestatic 184	com/mobvista/msdk/base/controller/a:d	()Lcom/mobvista/msdk/base/controller/a;
    //   191: invokevirtual 269	com/mobvista/msdk/base/controller/a:i	()Landroid/content/Context;
    //   194: invokevirtual 329	android/content/Context:getPackageManager	()Landroid/content/pm/PackageManager;
    //   197: iconst_0
    //   198: invokevirtual 337	android/content/pm/PackageManager:getInstalledPackages	(I)Ljava/util/List;
    //   201: astore_3
    //   202: invokestatic 184	com/mobvista/msdk/base/controller/a:d	()Lcom/mobvista/msdk/base/controller/a;
    //   205: invokevirtual 340	com/mobvista/msdk/base/controller/a:b	()Ljava/util/List;
    //   208: astore 4
    //   210: iconst_0
    //   211: istore_0
    //   212: iload_0
    ...
    //   222: aload_3
    //   223: iload_0
    //   224: invokeinterface 263 2 0
    //   229: checkcast 342	android/content/pm/PackageInfo
    //   232: astore 6
    //   234: aload 6
    //   236: getfield 346	android/content/pm/PackageInfo:applicationInfo	Landroid/content/pm/ApplicationInfo;
    //   239: getfield 351	android/content/pm/ApplicationInfo:flags	I
    //   242: iconst_1
    //   243: iand
    //   244: ifgt +79 -> 323
    //   247: aload_2
    //   248: aload 6
    //   250: getfield 354	android/content/pm/PackageInfo:packageName	Ljava/lang/String;
    //   253: invokeinterface 282 2 0
    //   258: pop
    //   259: iload_0
    //   260: iconst_1
    //   261: iadd
    ...
    //   263: goto -51 -> 212
    //   266: aload_3
    //   267: invokevirtual 492	java/io/BufferedReader:close	()V
    //   270: goto -90 -> 180
    //   273: astore_2
    //   274: aload_2
    //   275: invokestatic 104	com/google/a/a/a/a/a/a:a	(Ljava/lang/Throwable;)V
    //   278: goto -98 -> 180
    //   281: astore_2
    //   282: ldc 39
    //   284: aload_2
    //   285: invokevirtual 138	java/lang/Throwable:getMessage	()Ljava/lang/String;
    //   288: aload_2
    //   289: invokestatic 141	com/mobvista/msdk/base/utils/h:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   292: aconst_null
    //   293: areturn
    //   294: astore_2
    //   295: aload_2
    //   296: invokestatic 104	com/google/a/a/a/a/a/a:a	(Ljava/lang/Throwable;)V
    //   299: goto -119 -> 180
    //   302: astore_3
    //   303: aconst_null
    //   304: astore_2
    ...
    //   306: ifnull +7 -> 313
    //   309: aload_2
    //   310: invokevirtual 492	java/io/BufferedReader:close	()V
    //   313: aload_3
    //   314: athrow
    //   315: astore_2
    //   316: aload_2
    //   317: invokestatic 104	com/google/a/a/a/a/a/a:a	(Ljava/lang/Throwable;)V
    //   320: goto -7 -> 313
    //   323: aload 4
    //   325: ifnull -66 -> 259
    //   328: aload 4
    //   330: invokeinterface 259 1 0
    //   335: ifle -76 -> 259
    //   338: aload 4
    //   340: aload 6
    //   342: getfield 354	android/content/pm/PackageInfo:packageName	Ljava/lang/String;
    //   345: invokeinterface 357 2 0
    //   350: ifeq -91 -> 259
    //   353: aload_2
    //   354: aload 6
    //   356: getfield 354	android/content/pm/PackageInfo:packageName	Ljava/lang/String;
    //   359: invokeinterface 282 2 0
    //   364: pop
    //   365: goto -106 -> 259
    ...
    //   378: iload_0
    //   379: aload 5
    //   381: invokeinterface 259 1 0
    //   386: if_icmpge +78 -> 464
    //   389: aload 5
    //   391: iload_0
    //   392: invokeinterface 263 2 0
    //   397: checkcast 129	java/lang/String
    //   400: astore 4
    //   402: aload_2
    //   403: aload 4
    //   405: invokeinterface 357 2 0
    //   410: ifeq +75 -> 485
    //   413: ldc 39
    ...
    //   433: invokestatic 60	com/mobvista/msdk/base/utils/h:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   436: new 496	com/mobvista/msdk/base/entity/j
    //   439: dup
    //   440: invokespecial 497	com/mobvista/msdk/base/entity/j:<init>	()V
    //   443: astore 6
    //   445: aload 6
    //   447: aload 4
    //   449: putfield 499	com/mobvista/msdk/base/entity/j:a	Ljava/lang/String;
    //   452: aload_3
    //   453: aload 6
    //   455: invokeinterface 282 2 0
    //   460: pop
    //   461: goto +24 -> 485
    //   464: ldc 39
    //   466: ldc_w 501
    //   469: invokestatic 60	com/mobvista/msdk/base/utils/h:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   472: aload_3
    //   473: areturn
    //   474: astore_3
    //   475: goto -170 -> 305
