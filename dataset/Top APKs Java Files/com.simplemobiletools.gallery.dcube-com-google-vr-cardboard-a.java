...
public class a
{
  ...
  {
    paramContext = new AlertDialog.Builder(paramContext, o.e.GvrDialogTheme);
    paramContext.setMessage(paramInt1).setTitle(o.d.dialog_title_warning).setPositiveButton(paramInt2, paramOnClickListener).setNegativeButton(o.d.cancel_button, new DialogInterface.OnClickListener()
    {
  ...
  private static boolean a(Context paramContext, int paramInt)
  {
    ...
    if (paramInt == -1)
    {
      a(paramContext, o.d.dialog_vr_core_not_installed, o.d.go_to_playstore_button, new DialogInterface.OnClickListener()
      {
        public void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
        {
    ...
    if (paramInt == -2)
    {
      a(paramContext, o.d.dialog_vr_core_not_enabled, o.d.go_to_vr_listeners_settings_button, new DialogInterface.OnClickListener()
      {
        public void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
        {
