  ...
  extends SQLiteOpenHelper
{
  ...
  private f b(int paramInt)
  {
    ...
    //   2: aload_0
    //   3: monitorenter
    //   4: invokestatic 57	com/c/a/i:a	()Landroid/database/sqlite/SQLiteDatabase;
    //   7: astore_3
    //   8: aload_3
    //   9: putstatic 36	com/c/a/i:c	Landroid/database/sqlite/SQLiteDatabase;
    //   12: aload_3
    //   13: ldc 114
    //   15: iconst_3
    ...
    //   77: new 94	com/c/a/f
    //   80: dup
    //   81: invokespecial 138	com/c/a/f:<init>	()V
    //   84: astore 4
    //   86: aload 4
    //   88: aload_3
    //   89: iconst_0
    ...
    //   98: invokevirtual 144	com/c/a/f:b	(I)V
    //   101: aload 4
    //   103: aload_3
    //   104: iconst_1
    //   105: invokeinterface 141 2 0
    //   110: invokevirtual 145	com/c/a/f:a	(Ljava/lang/String;)V
    //   113: aload 4
    //   115: aload_3
    //   116: iconst_2
    //   117: invokeinterface 141 2 0
    //   122: invokestatic 32	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   125: invokevirtual 147	com/c/a/f:a	(I)V
    //   128: aload 4
    //   130: astore_2
    //   131: aload_3
    //   132: ifnull +12 -> 144
  ...
  private k.a c(int paramInt)
  {
    ...
    //   69: invokeinterface 137 1 0
    //   74: ifle +153 -> 227
    //   77: invokestatic 162	com/c/a/k:a	()Lcom/c/a/k;
    //   80: astore_2
    //   81: aload_2
    //   82: invokevirtual 168	java/lang/Object:getClass	()Ljava/lang/Class;
    //   85: pop
    //   86: new 170	com/c/a/k$a
    //   89: dup
    //   90: aload_2
    //   91: invokespecial 173	com/c/a/k$a:<init>	(Lcom/c/a/k;)V
    //   94: astore 4
    //   96: aload 4
    //   98: aload_3
    //   99: iconst_0
    //   100: invokeinterface 177 2 0
    //   105: invokevirtual 178	com/c/a/k$a:a	(I)V
    //   108: aload_3
    //   109: iconst_1
    ...
    //   140: aload 4
    //   142: aload 5
    //   144: invokevirtual 190	com/c/a/k$a:a	(Ljava/util/List;)V
    //   147: aload 4
    //   149: aload_3
    //   150: iconst_2
    //   151: invokeinterface 177 2 0
    //   156: invokevirtual 191	com/c/a/k$a:b	(I)V
    //   159: aload 4
    //   161: astore_2
    //   162: aload_3
    //   163: ifnull +12 -> 175
  ...
  private k.b i()
  {
    ...
    //   0: aload_0
    //   1: monitorenter
    //   2: invokestatic 162	com/c/a/k:a	()Lcom/c/a/k;
    //   5: astore_2
    //   6: aload_2
    //   7: invokevirtual 168	java/lang/Object:getClass	()Ljava/lang/Class;
    //   10: pop
    //   11: new 202	com/c/a/k$b
    //   14: dup
    //   15: aload_2
    //   16: invokespecial 203	com/c/a/k$b:<init>	(Lcom/c/a/k;)V
    //   19: astore_3
    //   20: new 186	java/util/ArrayList
    //   23: dup
    //   24: invokespecial 187	java/util/ArrayList:<init>	()V
    //   27: astore 4
    //   29: invokestatic 57	com/c/a/i:a	()Landroid/database/sqlite/SQLiteDatabase;
    //   32: astore_2
    //   33: aload_2
    //   34: putstatic 36	com/c/a/i:c	Landroid/database/sqlite/SQLiteDatabase;
    //   37: aload_2
    //   38: ldc -103
    //   40: aconst_null
    //   41: aconst_null
    ...
    //   69: ifle +115 -> 184
    //   72: invokestatic 162	com/c/a/k:a	()Lcom/c/a/k;
    //   75: astore 5
    //   77: aload 5
    //   79: invokevirtual 168	java/lang/Object:getClass	()Ljava/lang/Class;
    //   82: pop
    //   83: new 170	com/c/a/k$a
    //   86: dup
    //   87: aload 5
    //   89: invokespecial 173	com/c/a/k$a:<init>	(Lcom/c/a/k;)V
    //   92: astore 5
    //   94: aload 5
    //   96: aload_2
    //   97: iconst_0
    //   98: invokeinterface 177 2 0
    //   103: invokevirtual 178	com/c/a/k$a:a	(I)V
    //   106: aload_2
    //   107: iconst_1
    ...
    //   178: aload_3
    //   179: aload 4
    //   181: invokevirtual 210	com/c/a/k$b:a	(Ljava/util/List;)V
    //   184: aload_2
    //   185: ifnull +9 -> 194
    //   188: aload_2
    //   189: invokeinterface 150 1 0
    //   194: aload_0
    //   195: invokevirtual 213	com/c/a/i:e	()Lcom/c/a/k$b;
    //   198: astore_2
    //   199: aload_3
    //   200: aload_2
    //   201: invokevirtual 215	com/c/a/k$b:a	()Ljava/lang/String;
    //   204: invokevirtual 216	com/c/a/k$b:a	(Ljava/lang/String;)V
    //   207: aload_3
    //   208: aload_2
    //   209: invokevirtual 218	com/c/a/k$b:b	()I
    //   212: invokevirtual 219	com/c/a/k$b:a	(I)V
    //   215: aload_0
    //   216: monitorexit
    //   217: aload_3
    //   218: areturn
  ...
  private int j()
  {
    ...
    //   7: aload 4
    //   9: astore_3
    //   10: invokestatic 57	com/c/a/i:a	()Landroid/database/sqlite/SQLiteDatabase;
    //   13: putstatic 36	com/c/a/i:c	Landroid/database/sqlite/SQLiteDatabase;
    //   16: aload 4
    //   18: astore_3
    //   19: getstatic 36	com/c/a/i:c	Landroid/database/sqlite/SQLiteDatabase;
    //   22: ldc -34
    //   24: aconst_null
  ...
  final void a(int paramInt)
  {
    ...
    //   8: iload_1
    //   9: aload_0
    //   10: invokevirtual 248	com/c/a/i:d	()I
    //   13: if_icmpgt +774 -> 787
    //   16: iload_1
    //   17: ifle +770 -> 787
    //   20: aload_0
    //   21: invokespecial 250	com/c/a/i:i	()Lcom/c/a/k$b;
    //   24: astore 8
    //   26: aload 8
    //   28: ifnull +307 -> 335
    //   31: invokestatic 57	com/c/a/i:a	()Landroid/database/sqlite/SQLiteDatabase;
    //   34: putstatic 36	com/c/a/i:c	Landroid/database/sqlite/SQLiteDatabase;
    //   37: getstatic 36	com/c/a/i:c	Landroid/database/sqlite/SQLiteDatabase;
    //   40: ldc -4
    //   42: aconst_null
    ...
    //   79: invokestatic 65	com/c/a/y:a	(Ljava/lang/String;)V
    //   82: aload 10
    //   84: astore 7
    //   86: aload 9
    ...
    //   96: new 94	com/c/a/f
    //   99: dup
    //   100: invokespecial 138	com/c/a/f:<init>	()V
    //   103: astore 10
    //   105: aload 10
    //   107: aload 9
    //   109: aload 9
    ...
    //   123: invokevirtual 144	com/c/a/f:b	(I)V
    //   126: aload 10
    //   128: aload 9
    //   130: aload 9
    //   132: ldc 110
    ...
    //   144: invokevirtual 147	com/c/a/f:a	(I)V
    //   147: aload 10
    //   149: aload 9
    //   151: aload 9
    //   153: ldc 105
    ...
    //   165: invokevirtual 145	com/c/a/f:a	(Ljava/lang/String;)V
    //   168: aload 6
    //   170: astore 7
    //   172: aload 10
    //   174: invokevirtual 112	com/c/a/f:a	()I
    //   177: ifle +31 -> 208
    //   180: iconst_0
    //   181: istore_2
    //   182: aload 8
    //   184: invokevirtual 260	com/c/a/k$b:c	()Ljava/util/List;
    ...
    //   255: astore 6
    //   257: aload 8
    //   259: invokevirtual 260	com/c/a/k$b:c	()Ljava/util/List;
    ...
    //   276: ifne +289 -> 565
    //   279: aload 6
    //   281: getstatic 275	com/c/a/y:b	Z
    //   284: invokestatic 278	com/c/a/y:a	(Ljava/util/Map;Z)Ljava/util/Map;
    //   287: astore 6
    //   289: invokestatic 57	com/c/a/i:a	()Landroid/database/sqlite/SQLiteDatabase;
    //   292: astore 7
    //   294: aload 7
    //   296: putstatic 36	com/c/a/i:c	Landroid/database/sqlite/SQLiteDatabase;
    //   299: aload 7
    //   301: ldc_w 280
    ...
    //   345: checkcast 170	com/c/a/k$a
    //   348: astore 7
    //   350: aload 7
    //   352: invokevirtual 297	com/c/a/k$a:a	()I
    //   355: istore_3
    //   356: iload_2
    //   357: istore_1
    //   358: aload 10
    //   360: invokevirtual 112	com/c/a/f:a	()I
    //   363: iload_3
    //   364: if_icmpne +27 -> 391
    //   367: aload 7
    //   369: invokevirtual 298	com/c/a/k$a:c	()Ljava/util/List;
    ...
    //   455: aload 7
    //   457: aload 10
    //   459: invokevirtual 112	com/c/a/f:a	()I
    ...
    //   523: aload 10
    //   525: invokevirtual 97	com/c/a/f:c	()I
    ...
    //   536: aload 7
    //   538: aload 10
    //   540: invokevirtual 112	com/c/a/f:a	()I
    ...
    //   572: checkcast 170	com/c/a/k$a
    //   575: astore 9
    //   577: aload 9
    //   579: invokevirtual 297	com/c/a/k$a:a	()I
    //   582: istore_1
    //   583: aload 7
    //   585: iload_1
    ...
    //   597: aload 7
    //   599: aload 9
    //   601: invokevirtual 297	com/c/a/k$a:a	()I
    ...
    //   618: istore_2
    //   619: aload 9
    //   621: invokevirtual 312	com/c/a/k$a:b	()I
    //   624: istore_3
    //   625: iload_2
    //   626: iload_3
    //   627: isub
    ...
    //   678: invokestatic 65	com/c/a/y:a	(Ljava/lang/String;)V
    //   681: aload 6
    //   683: iload_1
    ...
    //   740: invokestatic 65	com/c/a/y:a	(Ljava/lang/String;)V
    ...
    //   763: getstatic 36	com/c/a/i:c	Landroid/database/sqlite/SQLiteDatabase;
    //   766: ldc_w 329
    //   769: aconst_null
    //   770: aload 7
  ...
  final void a(f paramF)
  {
    ...
    //   2: aload_0
    //   3: aload_1
    //   4: invokevirtual 97	com/c/a/f:c	()I
    //   7: invokespecial 344	com/c/a/i:b	(I)Lcom/c/a/f;
    //   10: ifnonnull +67 -> 77
    ...
    //   22: ldc 92
    //   24: aload_1
    //   25: invokevirtual 97	com/c/a/f:c	()I
    ...
    //   57: invokestatic 57	com/c/a/i:a	()Landroid/database/sqlite/SQLiteDatabase;
    //   60: astore_1
    //   61: aload_1
    //   62: putstatic 36	com/c/a/i:c	Landroid/database/sqlite/SQLiteDatabase;
    //   65: aload_1
    //   66: ldc 114
    //   68: aconst_null
    //   69: aload_2
    ...
    //   77: aload_0
    //   78: aload_1
    //   79: invokespecial 346	com/c/a/i:b	(Lcom/c/a/f;)I
    //   82: pop
    //   83: goto -9 -> 74
    //   86: astore_1
    //   87: aload_0
  ...
  final void a(k.a paramA)
  {
    ...
    //   2: aload_0
    //   3: aload_1
    //   4: invokevirtual 297	com/c/a/k$a:a	()I
    //   7: invokespecial 349	com/c/a/i:c	(I)Lcom/c/a/k$a;
    //   10: ifnonnull +89 -> 99
    //   13: new 69	android/content/ContentValues
    //   16: dup
    //   17: invokespecial 71	android/content/ContentValues:<init>	()V
    ...
    //   22: ldc 92
    //   24: aload_1
    //   25: invokevirtual 297	com/c/a/k$a:a	()I
    //   28: invokestatic 100	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   31: invokevirtual 103	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Integer;)V
    ...
    //   45: iload_2
    //   46: aload_1
    //   47: invokevirtual 298	com/c/a/k$a:c	()Ljava/util/List;
    ...
    //   70: ldc -99
    //   72: aload_1
    //   73: invokevirtual 312	com/c/a/k$a:b	()I
    ...
    //   82: invokestatic 57	com/c/a/i:a	()Landroid/database/sqlite/SQLiteDatabase;
    //   85: astore_1
    //   86: aload_1
    //   87: putstatic 36	com/c/a/i:c	Landroid/database/sqlite/SQLiteDatabase;
    //   90: aload_1
    //   91: ldc -103
    //   93: aconst_null
    //   94: aload_3
    ...
    //   102: aload 4
    //   104: aload_1
    //   105: invokevirtual 298	com/c/a/k$a:c	()Ljava/util/List;
    //   108: iload_2
    ...
    //   118: iload_2
    //   119: aload_1
    //   120: invokevirtual 298	com/c/a/k$a:c	()Ljava/util/List;
  ...
  final void a(k.b paramB)
  {
    ...
    //   35: aload_0
    //   36: invokevirtual 213	com/c/a/i:e	()Lcom/c/a/k$b;
    //   39: astore_3
    //   40: aload_3
    //   41: ifnonnull +24 -> 65
    //   44: invokestatic 57	com/c/a/i:a	()Landroid/database/sqlite/SQLiteDatabase;
    //   47: astore_1
    //   48: aload_1
    //   49: putstatic 36	com/c/a/i:c	Landroid/database/sqlite/SQLiteDatabase;
    //   52: aload_1
    //   53: ldc_w 366
    //   56: aconst_null
    //   57: aload_2
    ...
    //   64: return
    //   65: aload_3
    //   66: invokevirtual 215	com/c/a/k$b:a	()Ljava/lang/String;
    //   69: aload_1
    //   70: invokevirtual 215	com/c/a/k$b:a	()Ljava/lang/String;
    //   73: invokevirtual 370	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   76: ifne -14 -> 62
    //   79: invokestatic 57	com/c/a/i:a	()Landroid/database/sqlite/SQLiteDatabase;
    //   82: astore_1
    //   83: aload_1
    //   84: putstatic 36	com/c/a/i:c	Landroid/database/sqlite/SQLiteDatabase;
    //   87: aload_1
    //   88: ldc_w 372
    //   91: invokevirtual 283	android/database/sqlite/SQLiteDatabase:execSQL	(Ljava/lang/String;)V
    //   94: getstatic 36	com/c/a/i:c	Landroid/database/sqlite/SQLiteDatabase;
    //   97: ldc_w 366
    //   100: aload_2
    //   101: aconst_null
    //   102: aconst_null
  ...
  final k.b e()
  {
    ...
    //   45: ifle +99 -> 144
    //   48: invokestatic 162	com/c/a/k:a	()Lcom/c/a/k;
    //   51: astore_1
    //   52: aload_1
    //   53: invokevirtual 168	java/lang/Object:getClass	()Ljava/lang/Class;
    //   56: pop
    //   57: new 202	com/c/a/k$b
    //   60: dup
    //   61: aload_1
    //   62: invokespecial 203	com/c/a/k$b:<init>	(Lcom/c/a/k;)V
    //   65: astore_3
    //   66: aload_3
    //   67: aload_2
    //   68: aload_2
    ...
    //   82: invokevirtual 216	com/c/a/k$b:a	(Ljava/lang/String;)V
    //   85: aload_3
    //   86: aload_2
    //   87: aload_2
    //   88: ldc_w 364
    ...
    //   101: invokevirtual 219	com/c/a/k$b:a	(I)V
    //   104: aload_3
    //   105: astore_1
    //   106: aload_2
    //   107: ifnull +11 -> 118
  ...
  final List<Integer> f()
  {
    ...
    //   14: aload 4
    //   16: astore_3
    //   17: invokestatic 57	com/c/a/i:a	()Landroid/database/sqlite/SQLiteDatabase;
    //   20: astore 6
    //   22: aload 4
    //   24: astore_3
    //   25: aload 6
    //   27: putstatic 36	com/c/a/i:c	Landroid/database/sqlite/SQLiteDatabase;
    //   30: aload 4
    //   32: astore_3
    //   33: aload 6
    //   35: ldc -4
    ...
    //   101: invokestatic 65	com/c/a/y:a	(Ljava/lang/String;)V
    //   104: aload 4
    //   106: astore_3
    //   107: aload 5
    //   109: iload_1
