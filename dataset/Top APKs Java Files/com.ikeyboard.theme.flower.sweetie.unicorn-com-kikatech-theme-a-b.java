...
public class b
{
  ...
  public static List<InputMethodInfo> a(Context paramContext)
  {
  ...
  public static List<PackageInfo> c(Context paramContext)
  {
    ...
    //   5: aload_2
    //   6: iconst_0
    //   7: invokevirtual 111	android/content/pm/PackageManager:getInstalledPackages	(I)Ljava/util/List;
    //   10: astore_0
    //   11: aload_0
    //   12: areturn
    //   13: astore_0
    //   14: aload_0
    //   15: invokevirtual 57	java/lang/Exception:printStackTrace	()V
    ...
    //   89: iconst_1
    //   90: invokevirtual 20	android/content/pm/PackageManager:getPackageInfo	(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    //   104: astore_0
    //   105: aload_2
    //   106: invokevirtual 57	java/lang/Exception:printStackTrace	()V
    //   109: aload_3
    //   110: astore_0
    //   111: aload_1
    //   112: ifnull -101 -> 11
    //   115: aload_1
    //   116: invokevirtual 161	java/io/BufferedReader:close	()V
    //   119: aload_3
    //   120: areturn
    //   121: astore_0
    //   122: aload_0
    ...
    //   129: astore_0
    //   130: aload 4
    //   132: invokevirtual 165	java/lang/Process:waitFor	()I
    //   135: pop
    //   136: aload_3
    //   137: astore_0
    //   138: aload_1
    //   139: ifnull -128 -> 11
    //   142: aload_1
    //   143: invokevirtual 161	java/io/BufferedReader:close	()V
    //   146: aload_3
    //   147: areturn
    //   148: astore_0
    //   149: aload_0
    //   150: invokevirtual 57	java/lang/Exception:printStackTrace	()V
    //   153: aload_3
    //   154: areturn
    //   155: astore_2
    //   156: aload_0
    ...
    //   161: ifnull +7 -> 168
    //   164: aload_1
    //   165: invokevirtual 161	java/io/BufferedReader:close	()V
    //   168: aload_0
    //   169: athrow
    //   170: astore_1
    //   171: aload_1
    //   172: invokevirtual 57	java/lang/Exception:printStackTrace	()V
    //   175: goto -7 -> 168
    //   178: astore_2
    //   179: aload_0
    //   180: astore_1
