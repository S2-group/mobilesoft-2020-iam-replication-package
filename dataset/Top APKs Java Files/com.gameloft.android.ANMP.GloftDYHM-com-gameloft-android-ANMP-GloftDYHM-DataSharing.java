...
public class DataSharing
{
  ...
  public static void LazyInit()
  {
    if (a.isEmpty())
    {
      SUtils.getApplicationContext().getPackageManager().checkPermission("glshare.permission.ACCESS_SHARED_DATA", "com.gameloft.android.ANMP.GloftDYHM");
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if (((PackageInfo)localObject2).providers != null)
        {
          ...
          while (i < j)
          {
            ...
            if ((localObject3 != null) && (localObject3.authority != null) && ((localObject3.authority.contains("com.gameloft")) || (localObject3.authority.contains("jp.gungho")) || (localObject3.authority.contains("jp.gungho.dmk")))) {
  ...
  public static String getSharedValue(String paramString)
  {
    ...
    if (b.containsKey(paramString))
    {
      ...
      new f(paramString, (String)localObject).start();
      return localObject;
    }
    return "";
  }
  ...
  public static void setSharedValue(String paramString1, String paramString2)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      new g(paramString1, paramString2).start();
      return;
    }
  }
}
