...
import com.lock.lib.qr.R.id;
import com.lock.lib.qr.R.layout;
  ...
  extends AsyncTask<Object, Object, List<AppInfo>>
{
  ...
  {
    paramList = new ArrayAdapter(this.activity, R.layout.zx_app_picker_list_item, R.id.app_picker_list_item_label, paramList)
    {
