...
public class AppUtils
{
  ...
  {
    // Byte code:
    //   0: invokestatic 260	android/os/Process:myPid	()I
    //   3: istore_1
    //   4: aload_0
    //   5: ldc_w 262
    //   8: invokevirtual 266	android/content/Context:getSystemService	(Ljava/lang/String;)Ljava/lang/Object;
    //   11: checkcast 268	android/app/ActivityManager
    //   14: invokevirtual 272	android/app/ActivityManager:getRunningAppProcesses	()Ljava/util/List;
    //   17: astore_0
    //   18: aload_0
    //   19: ifnull +42 -> 61
    //   22: aload_0
    ...
    //   44: checkcast 274	android/app/ActivityManager$RunningAppProcessInfo
    //   47: astore_2
    //   48: aload_2
    //   49: getfield 277	android/app/ActivityManager$RunningAppProcessInfo:pid	I
    //   52: iload_1
    //   53: if_icmpne -24 -> 29
    //   56: aload_2
    //   57: getfield 280	android/app/ActivityManager$RunningAppProcessInfo:processName	Ljava/lang/String;
    //   60: areturn
    //   61: aconst_null
    //   62: astore_3
    //   63: invokestatic 286	java/lang/Runtime:getRuntime	()Ljava/lang/Runtime;
    //   66: astore_0
    //   67: new 219	java/lang/StringBuilder
    //   70: dup
    //   71: invokespecial 220	java/lang/StringBuilder:<init>	()V
    //   74: astore_2
    //   75: aload_2
    //   76: ldc_w 288
    //   79: invokevirtual 226	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   82: pop
    //   83: aload_2
    //   84: iload_1
    //   85: invokevirtual 291	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   88: pop
    //   89: aload_0
    //   90: aload_2
    //   91: invokevirtual 229	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   94: invokevirtual 295	java/lang/Runtime:exec	(Ljava/lang/String;)Ljava/lang/Process;
    //   97: astore_0
    //   98: new 297	java/io/BufferedReader
    //   101: dup
    //   102: new 299	java/io/InputStreamReader
    //   105: dup
    //   106: aload_0
    //   107: invokevirtual 305	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   110: invokespecial 308	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   113: invokespecial 311	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   116: astore_2
    //   117: aload_0
    //   118: astore_3
    //   119: aload_2
    //   120: astore 4
    //   122: aload_2
    //   123: invokevirtual 314	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   126: ifnull +79 -> 205
    //   129: aload_0
    //   130: astore_3
    //   131: aload_2
    //   132: astore 4
    //   134: aload_2
    //   135: invokevirtual 314	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   138: astore 5
    //   140: aload 5
    //   142: ifnull +63 -> 205
    //   145: aload_0
    ...
    //   152: ldc_w 316
    //   155: ldc_w 317
    //   158: invokevirtual 321	java/lang/String:split	(Ljava/lang/String;I)[Ljava/lang/String;
    //   161: astore 5
    //   163: aload_0
    //   164: astore_3
    //   165: aload_2
    ...
    //   179: ifnull +15 -> 194
    //   182: aload_2
    //   183: invokevirtual 324	java/io/BufferedReader:close	()V
    //   186: goto +8 -> 194
    //   189: astore_2
    //   190: aload_2
    //   191: invokestatic 176	com/google/a/a/a/a/a/a:a	(Ljava/lang/Throwable;)V
    //   194: aload_0
    //   195: ifnull +7 -> 202
    //   198: aload_0
    //   199: invokevirtual 327	java/lang/Process:destroy	()V
    //   202: aload 5
    //   204: areturn
    //   205: aload_2
    //   206: ifnull +15 -> 221
    //   209: aload_2
    //   210: invokevirtual 324	java/io/BufferedReader:close	()V
    //   213: goto +8 -> 221
    //   216: astore_2
    //   217: aload_2
    //   218: invokestatic 176	com/google/a/a/a/a/a/a:a	(Ljava/lang/Throwable;)V
    //   221: aload_0
    //   222: ifnull +74 -> 296
    //   225: goto +67 -> 292
    //   228: astore 5
    ...
    //   265: astore 4
    //   267: aload 5
    //   269: invokestatic 176	com/google/a/a/a/a/a/a:a	(Ljava/lang/Throwable;)V
    //   272: aload_2
    //   273: ifnull +15 -> 288
    //   276: aload_2
    //   277: invokevirtual 324	java/io/BufferedReader:close	()V
    //   280: goto +8 -> 288
    //   283: astore_2
    //   284: aload_2
    //   285: invokestatic 176	com/google/a/a/a/a/a/a:a	(Ljava/lang/Throwable;)V
    //   288: aload_0
    //   289: ifnull +7 -> 296
    //   292: aload_0
    //   293: invokevirtual 327	java/lang/Process:destroy	()V
    //   296: aconst_null
    //   297: areturn
    //   298: astore_0
    //   299: aload_3
    ...
    //   305: ifnull +15 -> 320
    //   308: aload_3
    //   309: invokevirtual 324	java/io/BufferedReader:close	()V
    //   312: goto +8 -> 320
    //   315: astore_3
    //   316: aload_3
    //   317: invokestatic 176	com/google/a/a/a/a/a/a:a	(Ljava/lang/Throwable;)V
    //   320: aload_2
    //   321: ifnull +7 -> 328
    //   324: aload_2
    //   325: invokevirtual 327	java/lang/Process:destroy	()V
    //   328: aload_0
    //   329: athrow
    // Local variable table:
    //   start	length	slot	name	signature
    ...
    //   3	82	1	i	int
    //   47	136	2	localObject1	Object
    //   189	21	2	localIOException1	java.io.IOException
    //   216	2	2	localIOException2	java.io.IOException
    //   236	41	2	localContext1	Context
    //   283	2	2	localIOException3	java.io.IOException
    //   300	25	2	localObject2	Object
    //   62	247	3	localObject3	Object
    //   315	2	3	localIOException4	java.io.IOException
    //   120	47	4	localObject4	Object
    //   233	5	4	localObject5	Object
    //   265	37	4	localContext2	Context
    //   138	65	5	localObject6	Object
    //   228	1	5	localThrowable1	Throwable
    //   243	1	5	localThrowable2	Throwable
    //   256	12	5	localThrowable3	Throwable
    // Exception table:
    //   from	to	target	type
    //   182	186	189	java/io/IOException
    //   209	213	216	java/io/IOException
    //   122	129	228	java/lang/Throwable
    //   134	140	228	java/lang/Throwable
    //   150	163	228	java/lang/Throwable
    //   168	178	228	java/lang/Throwable
    //   98	117	233	finally
    //   98	117	243	java/lang/Throwable
    //   63	98	250	finally
    //   63	98	256	java/lang/Throwable
