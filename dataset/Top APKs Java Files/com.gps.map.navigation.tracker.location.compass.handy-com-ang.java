...
public final class ang
{
  ...
  static amy a(Context paramContext)
  {
    if (a != null) {
      return a;
    }
    String str2 = and.a(paramContext);
    String str1;
    if (str2 != null)
    {
      str1 = str2;
    ...
    try
    {
      a = (amy)new Gson().fromJson(str1, amy.class);
      return a;
    }
  ...
  private static String d(Context paramContext)
  {
    ...
    //   24: getstatic 98	com/ang:b	Ljava/lang/String;
