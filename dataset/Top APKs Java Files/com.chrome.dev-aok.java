...
public class aok
{
  public static final String a = "aok";
  ...
  {
    paramContext = new AlertDialog.Builder(paramContext, 2132017383);
    paramContext.setMessage(paramInt1).setTitle(2131952302).setPositiveButton(paramInt2, paramOnClickListener).setNegativeButton(2131952071, new aon());
  ...
  private static boolean b(Activity paramActivity, boolean paramBoolean)
  {
    ...
    catch (PackageManager.NameNotFoundException localNameNotFoundException)
    {
      ...
      if (i != 0)
      {
        ...
        {
          if (i == -1) {
            a(paramActivity, 2131952304, 2131952447, new aol(paramActivity));
          }
          for (;;)
          {
            k = 0;
            ...
            a(paramActivity, 2131952303, 2131952448, new aom(paramActivity));
          }
        }
        if (k != 0) {
