...
public final class gz
{
  ...
  {
    return new i(paramP, paramP.a("@file:" + paramString1 + paramString2, new ha(paramString1, paramInt1, paramInt2)), true, true);
  }
  ...
  public static void a(Context paramContext)
  {
    ...
    if ((e.B != null) && (!e.B.equals(""))) {
      localConfiguration.locale = new Locale(e.B, localConfiguration.locale.getCountry(), localConfiguration.locale.getVariant());
    }
