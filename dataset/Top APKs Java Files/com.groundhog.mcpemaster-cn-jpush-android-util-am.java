...
public class am
{
  ...
  static
  {
    ...
    int j = 0;
    Object localObject2 = ">7\023a.6 \036";
    int i = -1;
    ...
    for (;;)
    {
      ...
      case 3: 
        localObject3[i4] = localObject1;
        j = 5;
        localObject2 = "3=\021m\007,1\004g6;'";
        i = 4;
        localObject1 = arrayOfString;
        break;
      case 4: 
    ...
    if (paramString != null)
    {
      ...
      try
      {
        ...
        if (arrayOfByte.length > 30) {
          paramString = str.substring(0, new String(arrayOfByte, 0, 30, z[6]).length());
        }
        return paramString;
      }
  ...
  public static void a(Context paramContext)
  {
    ...
    aj.a(paramContext, localJSONArray);
  }
}
