...
public class ChooseClockSettings
  extends hp
  implements bci.b
{
  ...
  public ChooseClockSettings() {}
  
  private int a(ArrayList<bec.a> paramArrayList)
  {
    int i = 0;
    String str = this.s.getString("clock_application", "");
    if (!"".equals(str)) {
      try
      {
  ...
  private ArrayList<bec.a> g()
  {
    ...
    catch (Throwable localThrowable)
    {
      runOnUiThread(new Runnable()
      {
        ...
        {
          Toast.makeText(ChooseClockSettings.a(ChooseClockSettings.this), 2131230744, 1).show();
        }
      });
      return null;
    }
  ...
  public final void a_(int paramInt)
  {
    try
    {
      ...
      this.s.edit().putString("clock_application", localA.c).apply();
      return;
    }
    catch (Throwable localThrowable)
    {
    ...
    extends AsyncTask<Void, Void, ArrayList<bec.a>>
  {
    ...
    {
      super.onPreExecute();
      this.b = new bcx(ChooseClockSettings.this);
