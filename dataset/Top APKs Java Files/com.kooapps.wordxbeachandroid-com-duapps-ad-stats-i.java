...
public class i
{
  ...
  {
    // Byte code:
    //   0: new 73	com/duapps/ad/base/j
    //   3: dup
    //   4: invokespecial 74	com/duapps/ad/base/j:<init>	()V
    //   7: astore 6
    //   9: aload 6
    //   11: aload_1
    //   12: putfield 77	com/duapps/ad/base/j:a	Ljava/lang/String;
    //   15: aload 6
    //   17: iconst_0
    //   18: putfield 81	com/duapps/ad/base/j:c	I
    ...
    //   126: aload 5
    //   128: aload 7
    //   130: putfield 77	com/duapps/ad/base/j:a	Ljava/lang/String;
    //   133: aload_1
    //   134: astore 4
    //   136: aload 5
    //   138: aload_1
    //   139: iconst_1
    //   140: invokeinterface 107 2 0
    //   145: putfield 109	com/duapps/ad/base/j:b	Ljava/lang/String;
    //   148: aload_1
    //   149: astore 4
    //   151: aload 5
    //   153: aload_1
    //   154: iconst_2
    //   155: invokeinterface 107 2 0
    //   160: putfield 111	com/duapps/ad/base/j:d	Ljava/lang/String;
    //   163: aload_1
    //   164: astore 4
    //   166: aload 5
    //   168: aload_1
    ...
    //   175: putfield 81	com/duapps/ad/base/j:c	I
    //   178: goto +13 -> 191
    //   181: astore 5
    //   183: goto +35 -> 218
    //   186: astore 5
    ...
    //   223: ldc 120
    //   225: aload 5
    //   227: invokestatic 70	com/duapps/ad/base/h:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   230: aload_1
    //   231: ifnull +18 -> 249
    //   234: aload_1
  ...
  public void a(f paramF)
  {
    ...
    ((ContentValues)localObject).put("logid", paramF.l());
    ((ContentValues)localObject).put("adid", Long.valueOf(paramF.b()));
    ((ContentValues)localObject).put("pkg", d.a(paramF.a()));
    ...
    try
    {
      ...
      paramF.append("saveShowTimestamp() update = ");
      paramF.append(i);
      h.c("ToolboxCacheMgr", paramF.toString());
      return;
    }
    catch (Exception paramF)
    {
      ...
      h.c("ToolboxCacheMgr", ((StringBuilder)localObject).toString());
    }
  }
  ...
  public int b(String paramString)
  {
    ...
    //   23: aload_0
    //   24: getfield 15	com/duapps/ad/stats/i:a	Landroid/content/Context;
    //   27: iconst_1
    //   28: invokestatic 45	com/duapps/ad/stats/DuAdCacheProvider:a	(Landroid/content/Context;I)Landroid/net/Uri;
    //   31: iconst_1
    ...
    //   54: ldc2_w 50
    //   57: lsub
    //   58: invokestatic 55	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   61: aastore
    //   62: ldc 93
    //   64: invokevirtual 97	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   67: astore_1
    //   68: iload_3
    //   69: istore_2
    //   70: aload_1
    ...
    //   159: ldc -25
    //   161: aload 8
    //   163: invokestatic 70	com/duapps/ad/base/h:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   166: iload 4
    //   168: istore_3
    //   169: aload_1
    //   170: ifnull +24 -> 194
  ...
  public java.util.List<com.duapps.ad.entity.b> b()
  {
    ...
    //   101: astore 7
    //   103: aload_0
    //   104: getfield 15	com/duapps/ad/stats/i:a	Landroid/content/Context;
    //   107: invokevirtual 40	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   110: aload_0
    //   111: getfield 15	com/duapps/ad/stats/i:a	Landroid/content/Context;
    //   114: bipush 8
    ...
    //   422: invokestatic 223	com/duapps/ad/base/h:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   425: aload 5
    //   427: ifnull +16 -> 443
    //   430: aload 5
  ...
  public void b(Context paramContext)
  {
    ...
    //   18: aload_0
    //   19: getfield 15	com/duapps/ad/stats/i:a	Landroid/content/Context;
    //   22: bipush 7
    ...
    //   135: ldc 120
    //   137: aload 5
    //   139: invokestatic 70	com/duapps/ad/base/h:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   142: aload_3
    //   143: ifnull +18 -> 161
    //   146: aload_3
    ...
    //   458: astore_1
    //   459: aload_0
    //   460: getfield 15	com/duapps/ad/stats/i:a	Landroid/content/Context;
    //   463: invokevirtual 40	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   466: aload_0
    //   467: getfield 15	com/duapps/ad/stats/i:a	Landroid/content/Context;
    //   470: bipush 7
    ...
    //   485: ldc_w 329
    //   488: aload_1
    //   489: invokestatic 70	com/duapps/ad/base/h:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   492: return
    //   493: astore_1
    //   494: ldc 63
    //   496: ldc_w 331
    //   499: aload_1
    //   500: invokestatic 70	com/duapps/ad/base/h:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   503: return
    //   504: astore_1
    //   505: aload 4
    //   507: ifnull +20 -> 527
  ...
  public void b(f paramF)
  {
    ...
    try
    {
      int i = this.a.getContentResolver().update(DuAdCacheProvider.a(this.a, 8), (ContentValues)localObject, "logid=? AND adid = ?", new String[] { str, String.valueOf(l) });
      paramF = new StringBuilder();
      paramF.append("saveClickTimestamp() update = ");
      paramF.append(i);
      h.c("ToolboxCacheMgr", paramF.toString());
      return;
    }
  ...
  public int c(String paramString)
  {
    ...
    //   12: iconst_0
    //   13: istore_3
    //   14: invokestatic 36	java/lang/System:currentTimeMillis	()J
    //   17: lstore 7
    //   19: aconst_null
    //   20: astore 10
    //   22: aconst_null
    ...
    //   33: getfield 15	com/duapps/ad/stats/i:a	Landroid/content/Context;
    //   36: bipush 7
    //   38: invokestatic 45	com/duapps/ad/stats/DuAdCacheProvider:a	(Landroid/content/Context;I)Landroid/net/Uri;
    //   41: iconst_1
    ...
    //   65: lload 5
    //   67: lsub
    //   68: invokestatic 55	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   71: aastore
    //   72: ldc 93
    //   74: invokevirtual 97	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   77: astore_1
    //   78: iload_3
    //   79: istore_2
    //   80: aload_1
    ...
    //   169: ldc -25
    //   171: aload 10
    //   173: invokestatic 70	com/duapps/ad/base/h:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   176: iload 4
    //   178: istore_3
    //   179: aload_1
    //   180: ifnull +24 -> 204
  ...
  public void c()
  {
    ...
    try
    {
      ...
      h.c("ToolboxCacheMgr", localStringBuilder.toString());
      return;
    }
    catch (Throwable localThrowable)
    {
      h.b("ToolboxCacheMgr", "removeInvalidBehaviorData() del exception: ", localThrowable);
      return;
    }
    catch (Exception localException)
    {
      h.b("ToolboxCacheMgr", "removeInvalidBehaviorData() exception: ", localException);
    }
  }
  ...
  public j d(String paramString)
  {
    ...
    //   9: aload 8
    //   11: aload_1
    //   12: putfield 109	com/duapps/ad/base/j:b	Ljava/lang/String;
    //   15: aload 8
    //   17: iconst_0
    //   18: putfield 81	com/duapps/ad/base/j:c	I
    //   21: aload_0
    ...
    //   38: astore 6
    //   40: aload_0
    //   41: getfield 15	com/duapps/ad/stats/i:a	Landroid/content/Context;
    //   44: invokevirtual 40	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   47: aload_0
    //   48: getfield 15	com/duapps/ad/stats/i:a	Landroid/content/Context;
    //   51: bipush 7
    ...
    //   136: aload_1
    //   137: aload 6
    //   139: putfield 77	com/duapps/ad/base/j:a	Ljava/lang/String;
    //   142: aload_1
    //   143: aload 7
    //   145: iconst_1
    //   146: invokeinterface 107 2 0
    //   151: putfield 109	com/duapps/ad/base/j:b	Ljava/lang/String;
    //   154: aload_1
    //   155: aload 7
    //   157: iconst_2
    //   158: invokeinterface 107 2 0
    //   163: putfield 111	com/duapps/ad/base/j:d	Ljava/lang/String;
    //   166: aload_1
    //   167: aload 7
    //   169: iconst_3
    //   170: invokeinterface 115 2 0
    ...
    //   246: ldc 120
    //   248: aload 7
    //   250: invokestatic 70	com/duapps/ad/base/h:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   253: aload_1
    //   254: ifnull +18 -> 272
    //   257: aload_1
