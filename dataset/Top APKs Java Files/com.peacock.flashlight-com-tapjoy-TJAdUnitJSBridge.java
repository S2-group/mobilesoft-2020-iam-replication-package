...
public class TJAdUnitJSBridge
{
  ...
  public void alert(JSONObject paramJSONObject, final String paramString)
  {
    ...
    //   137: aload_1
    //   138: invokestatic 241	com/google/a/a/a/a/a/a:a	(Ljava/lang/Throwable;)V
    //   141: aconst_null
    //   142: astore_1
    //   143: goto -87 -> 56
    //   146: new 243	java/util/ArrayList
    //   149: dup
    //   150: invokespecial 244	java/util/ArrayList:<init>	()V
    //   153: astore 6
    //   155: iconst_0
    //   156: istore 4
    //   158: iload 4
    ...
    //   196: aload_1
    //   197: iload 4
    //   199: invokevirtual 247	org/json/JSONArray:getString	(I)Ljava/lang/String;
    //   202: invokevirtual 251	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   205: pop
    //   206: aload 5
    //   208: iload_3
    //   209: aload 6
    //   211: iload 4
    //   213: invokevirtual 255	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   216: checkcast 257	java/lang/CharSequence
    //   219: new 20	com/tapjoy/TJAdUnitJSBridge$5
    //   222: dup
    //   223: aload_0
    //   224: aload_2
    //   225: invokespecial 260	com/tapjoy/TJAdUnitJSBridge$5:<init>	(Lcom/tapjoy/TJAdUnitJSBridge;Ljava/lang/String;)V
    //   228: invokevirtual 266	android/app/AlertDialog:setButton	(ILjava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)V
    //   231: iload 4
    //   233: iconst_1
    //   234: iadd
    //   235: istore 4
    ...
    //   252: astore 7
    //   254: aload 7
    //   256: invokestatic 241	com/google/a/a/a/a/a/a:a	(Ljava/lang/Throwable;)V
    //   259: goto -53 -> 206
    //   262: aload 5
    //   264: iconst_0
    //   265: invokevirtual 270	android/app/AlertDialog:setCancelable	(Z)V
    //   268: aload 5
    //   270: iconst_0
    //   271: invokevirtual 273	android/app/AlertDialog:setCanceledOnTouchOutside	(Z)V
    //   274: aload 5
    //   276: invokevirtual 276	android/app/AlertDialog:show	()V
    //   279: return
    //   280: astore_1
    //   281: goto -159 -> 122
  ...
  public void displayRichMedia(final JSONObject paramJSONObject, String paramString)
  {
    ...
    catch (Exception localException1)
    {
      ...
      catch (Exception localException2)
      {
        ...
        for (;;)
        {
          com.google.a.a.a.a.a.a.a(localException2);
          str2 = null;
        }
        if (bool)
        {
  ...
  public void initMoatVideoTracker(JSONObject paramJSONObject, String paramString)
  {
    ...
    try
    {
      ...
      this.k = ((d)c.a((TJAdUnitActivity)this.c).a(new e(paramJSONObject)));
      if (this.l == null)
      {
        TapjoyLog.d("TJAdUnitJSBridge", "Initializing MOAT tracking events map");
        this.l = new HashMap();
        this.l.put("firstQuartile", b.a);
        this.l.put("midpoint", b.b);
        this.l.put("thirdQuartile", b.c);
        this.l.put("complete", b.d);
        this.l.put("paused", b.e);
        this.l.put("playing", b.f);
        this.l.put("start", b.g);
        this.l.put("stopped", b.h);
        this.l.put("skipped", b.i);
        this.l.put("volumeChanged", b.j);
        this.l.put("enterFullScreen", b.k);
        this.l.put("exitFullScreen", b.l);
      }
  ...
  public void present(JSONObject paramJSONObject, String paramString)
  {
    // Byte code:
    //   0: iconst_0
    //   1: invokestatic 296	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   4: astore_3
    //   5: aload_1
    //   6: ldc_w 805
    ...
    //   58: invokespecial 811	com/tapjoy/TJAdUnitJSBridge$a:<init>	(Lcom/tapjoy/TJAdUnitJSBridge;Landroid/webkit/WebView;)V
    //   61: iconst_2
    ...
    //   72: aload_3
    //   73: aastore
    //   74: invokevirtual 815	com/tapjoy/TJAdUnitJSBridge$a:execute	([Ljava/lang/Object;)Landroid/os/AsyncTask;
    //   77: pop
    //   78: aload_0
    //   79: aload_2
    //   80: iconst_1
    ...
    //   84: dup
    //   85: iconst_0
    //   86: getstatic 391	java/lang/Boolean:TRUE	Ljava/lang/Boolean;
    //   89: aastore
    ...
    //   110: aload_1
    //   111: invokestatic 241	com/google/a/a/a/a/a/a:a	(Ljava/lang/Throwable;)V
    //   114: return
    //   115: astore_1
    //   116: goto -67 -> 49
    //   119: astore 4
    ...
    try
    {
      ...
      this.m.post(new Runnable()
      {
        public final void run()
        {
          ...
          for (boolean bool = TJAdUnitJSBridge.h(TJAdUnitJSBridge.this).a(localHashMap, this.b, TJAdUnitJSBridge.e(TJAdUnitJSBridge.this));; bool = false)
          {
  ...
  public void triggerMoatVideoEvent(final JSONObject paramJSONObject, String paramString)
  {
    try
    {
      ...
      if (this.l != null) {
        paramJSONObject = (b)this.l.get(str);
      }
      if (paramJSONObject == null)
      {
      ...
      paramJSONObject = new com.b.a.a.a.a(paramJSONObject, Integer.valueOf(n));
      this.m.post(new Runnable()
      {
        public final void run()
        {
          if (TJAdUnitJSBridge.h(TJAdUnitJSBridge.this) != null) {
            TJAdUnitJSBridge.h(TJAdUnitJSBridge.this).a(paramJSONObject);
          }
        }
      });
      invokeJSCallback(paramString, new Object[] { Boolean.valueOf(true) });
