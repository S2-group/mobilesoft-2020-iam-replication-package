...
public final class efe
{
  ...
  private efe()
  {
    ...
    //   12: putfield 28	cfl/efe:a	Ljava/util/Map;
    //   15: aload_0
    ...
    //   23: putfield 33	cfl/efe:b	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    //   26: aload_0
    //   27: getfield 33	cfl/efe:b	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    //   62: invokestatic 64	cfl/ecl:i	()Landroid/content/Context;
    //   65: new 6	cfl/efe$1
    //   68: dup
    //   69: aload_0
    //   70: invokespecial 67	cfl/efe$1:<init>	(Lcfl/efe;)V
    //   73: aload_1
    ...
    //   77: pop
    //   78: invokestatic 64	cfl/ecl:i	()Landroid/content/Context;
    ...
    //   88: dup
    //   89: invokestatic 84	cfl/efm:a	()Ljava/util/List;
    ...
    //   129: aload 4
    //   131: aload_1
    //   132: invokestatic 114	cfl/efe:a	(Landroid/content/pm/ApplicationInfo;Landroid/content/pm/PackageManager;)Z
    //   135: ifeq -26 -> 109
    //   138: aload_0
    //   139: getfield 28	cfl/efe:a	Ljava/util/Map;
    //   142: aload 4
    //   144: getfield 118	android/content/pm/ApplicationInfo:packageName	Ljava/lang/String;
    //   147: new 10	cfl/efe$a
    //   150: dup
    //   151: aload 4
    //   153: aload_1
    //   154: aload_2
    //   155: aload 4
    //   157: getfield 118	android/content/pm/ApplicationInfo:packageName	Ljava/lang/String;
    //   160: invokeinterface 124 2 0
    //   165: iconst_0
    //   166: invokespecial 127	cfl/efe$a:<init>	(Landroid/content/pm/ApplicationInfo;Landroid/content/pm/PackageManager;ZB)V
    //   169: invokeinterface 133 3 0
    //   174: pop
    //   175: goto -66 -> 109
    //   178: astore_1
    //   179: aload_1
    //   180: invokestatic 138	cfl/dpi:a	(Ljava/lang/Throwable;)V
    //   183: aload_0
    //   184: getfield 33	cfl/efe:b	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    //   190: invokevirtual 141	java/util/concurrent/locks/ReentrantReadWriteLock$WriteLock:unlock	()V
    //   193: return
    //   194: new 143	java/lang/StringBuilder
    //   197: dup
    //   198: ldc -111
    //   200: invokespecial 147	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   203: aload_0
    //   204: getfield 28	cfl/efe:a	Ljava/util/Map;
    //   207: invokeinterface 151 1 0
    //   212: invokevirtual 155	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   215: pop
    //   216: aload_0
    //   217: getfield 33	cfl/efe:b	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    //   223: invokevirtual 141	java/util/concurrent/locks/ReentrantReadWriteLock$WriteLock:unlock	()V
    //   226: return
    //   227: astore_1
    //   228: aload_0
    //   229: getfield 33	cfl/efe:b	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    ...
    //   235: invokevirtual 141	java/util/concurrent/locks/ReentrantReadWriteLock$WriteLock:unlock	()V
    //   238: aload_1
    //   239: athrow
  ...
  public final <T extends HSAppInfo> T a(Class<T> paramClass, String paramString)
  {
  ...
  public final <T extends HSAppInfo> ArrayList<T> a(Class<T> paramClass, HSAppFilter paramHSAppFilter)
  {
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      if (localHSAppFilter.apply((HSAppFilter.a)localObject2))
      {
  ...
  /* Error */
  public final boolean a(String paramString, HSAppFilter paramHSAppFilter)
  {
    // Byte code:
    //   0: aload_2
    //   1: astore 4
    //   3: aload_2
    //   4: ifnonnull +12 -> 16
    //   7: new 193	com/ihs/device/common/HSAppFilter
    //   10: dup
    //   11: invokespecial 194	com/ihs/device/common/HSAppFilter:<init>	()V
    //   14: astore 4
    //   16: aload_1
    //   17: invokestatic 181	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   20: ifeq +5 -> 25
    //   23: iconst_0
    //   24: ireturn
    //   25: aload_0
    //   26: getfield 33	cfl/efe:b	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    //   29: invokevirtual 162	java/util/concurrent/locks/ReentrantReadWriteLock:readLock	()Ljava/util/concurrent/locks/ReentrantReadWriteLock$ReadLock;
    //   32: invokevirtual 165	java/util/concurrent/locks/ReentrantReadWriteLock$ReadLock:lock	()V
    //   35: aload_0
    //   36: getfield 28	cfl/efe:a	Ljava/util/Map;
    //   39: aload_1
    //   40: invokeinterface 186 2 0
    //   45: checkcast 10	cfl/efe$a
    //   48: astore_1
    //   49: aload_1
    //   50: ifnull +28 -> 78
    //   53: aload 4
    //   55: aload_1
    //   56: invokevirtual 200	com/ihs/device/common/HSAppFilter:apply	(Lcom/ihs/device/common/HSAppFilter$a;)Z
    //   59: istore_3
    //   60: iload_3
    //   61: ifeq +17 -> 78
    //   64: iconst_1
    //   65: istore_3
    //   66: aload_0
    //   67: getfield 33	cfl/efe:b	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    //   70: invokevirtual 162	java/util/concurrent/locks/ReentrantReadWriteLock:readLock	()Ljava/util/concurrent/locks/ReentrantReadWriteLock$ReadLock;
    //   73: invokevirtual 173	java/util/concurrent/locks/ReentrantReadWriteLock$ReadLock:unlock	()V
    //   76: iload_3
    //   77: ireturn
    //   78: iconst_0
    //   79: istore_3
    ...
    //   83: astore_1
    //   84: aload_0
    //   85: getfield 33	cfl/efe:b	Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    //   88: invokevirtual 162	java/util/concurrent/locks/ReentrantReadWriteLock:readLock	()Ljava/util/concurrent/locks/ReentrantReadWriteLock$ReadLock;
    //   91: invokevirtual 173	java/util/concurrent/locks/ReentrantReadWriteLock$ReadLock:unlock	()V
    //   94: aload_1
    //   95: athrow
    // Local variable table:
    //   start	length	slot	name	signature
    ...
    implements HSAppFilter.a
  {
    ...
    {
      this(paramApplicationInfo, paramPackageManager, efm.a().contains(str));
    }
    ...
    private a(ApplicationInfo paramApplicationInfo, PackageManager paramPackageManager, boolean paramBoolean)
    {
      ...
      if (paramPackageManager == null)
      {
        ...
        this.e = efm.b(paramApplicationInfo.packageName);
        this.f = efm.a(paramApplicationInfo);
        this.g = efm.c(paramApplicationInfo.packageName);
        this.h = paramBoolean;
  ...
  {
    private static final efe a = new efe((byte)0);
  }
}
