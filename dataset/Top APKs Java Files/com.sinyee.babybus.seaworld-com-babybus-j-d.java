...
public class d
{
  ...
  public static void jdMethod_do(String paramString1, String paramString2)
  {
    if (App.goto)
    {
      ...
      com.babybus.g.a.jdMethod_do().jdMethod_if(paramString1, paramString2);
      return;
    }
    com.babybus.g.a.jdMethod_do().jdMethod_for(paramString1, paramString2);
  }
  ...
  public static void jdMethod_do(String paramString, boolean paramBoolean)
  {
    ...
    {
      x.jdMethod_new("launchApp error");
    }
  }
  ...
  public static boolean jdMethod_do()
  {
    ...
    do
    {
      ...
      {
        x.jdMethod_if("com.android.providers.downloads is no found");
        return false;
      }
      return false;
    } while ((i != 2) && (i != 3));
  ...
  {
    return Math.abs(paramLong - App.jdMethod_do().volatile) < do;
  }
  ...
  {
    return ("A004".equals(App.jdMethod_do().jdField_else)) && (!"zh".equals(av.jdMethod_if()));
  }
  
  public static boolean jdMethod_else(String paramString)
  {
    paramString = b.v.case + "/" + paramString + ".apk";
    return (f.jdMethod_case(paramString)) && (jdMethod_goto(paramString));
  }
  ...
  {
    return ("A023".equals(App.jdMethod_do().jdField_else)) && (!"zh".equals(av.jdMethod_if()));
  }
  ...
  public static void jdMethod_if(String paramString, boolean paramBoolean)
  {
    ...
    if ("com.sinyee.babybus.wonderland".equals(App.jdMethod_do().getPackageName())) {
      v.jdMethod_do().jdMethod_for("wonderland", paramString);
    }
    App.jdMethod_do().startActivity(localIntent);
    if (paramBoolean) {
      App.jdMethod_do().jdMethod_goto();
  ...
  public static String jdMethod_long(String paramString)
  {
    ...
    if ("com.sinyee.babybus.wonderland".equals(App.jdMethod_do().getPackageName()))
    {
      localObject = b.v.else + "/" + paramString + ".apk";
    ...
    for (;;)
    {
      ...
      {
        paramString = b.v.else + "/" + paramString + ".apk";
  ...
  public static void jdMethod_new()
  {
    ...
    aq.jdMethod_do("INSTALL_APP_INFO", localGson.toJson(localArrayList));
  }
