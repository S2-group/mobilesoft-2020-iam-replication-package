    ...
    for (;;)
    {
      if ((paramString != null) && (!paramString.equals("")))
      {
          ...
          if (i >= 0)
          {
            ...
            if (j >= i)
            {
              ...
              if (k >= j + 1)
              {
                ...
                if (m >= k)
                {
                  localObject = (paramString.substring(0, i) + "''};" + paramString.substring(m)).replace("\"", "'");
                  paramString = "{\"html_wrapper\":\"" + (String)localObject + "\"," + paramString.substring(j + 1, k);
                }
              }
            }
          }
        ...
        try
        {
          ...
          {
            Tracer.d("parse json");
            ru.mail.android.mytarget.core.parsers.rb.c.a((JSONObject)localObject, paramB, paramA.d(), a(paramContext), paramContext, paramC);
            if (paramA.e()) {
              paramB.h();
            }
        ...
        catch (Exception paramA)
        {
          ...
          ru.mail.android.mytarget.core.async.a.a("Convert to JSON error", b.class.getName(), "JSON Exception: Convert to JSON error", paramString, paramB.b(), paramContext);
          return;
        }
