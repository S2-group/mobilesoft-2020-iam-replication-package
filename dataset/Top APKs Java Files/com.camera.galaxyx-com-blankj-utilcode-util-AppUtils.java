...
public final class AppUtils
{
  ...
  public static boolean installAppSilent(File paramFile, String paramString, boolean paramBoolean)
  {
    ...
    new StringBuilder("installAppSilent successMsg: ").append(paramFile.successMsg).append(", errorMsg: ").append(paramFile.errorMsg);
    return false;
  }
  ...
  public static boolean isAppRoot()
  {
    ...
    if (localCommandResult.errorMsg != null) {
      new StringBuilder("isAppRoot() called").append(localCommandResult.errorMsg);
    }
    return false;
  }
  ...
  public static void registerAppStatusChangedListener(Object paramObject, Utils.OnAppStatusChangedListener paramOnAppStatusChangedListener)
  {
    if (paramObject == null) {
  ...
  public static boolean uninstallAppSilent(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    new StringBuilder("uninstallAppSilent successMsg: ").append(paramString.successMsg).append(", errorMsg: ").append(paramString.errorMsg);
    return false;
  }
  
  public static void unregisterAppStatusChangedListener(Object paramObject)
  {
    if (paramObject == null) {
