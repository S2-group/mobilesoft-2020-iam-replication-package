package com.readmanga.kamanga.source;
...
import com.readmanga.kamanga.source.online.HttpSource;
import com.readmanga.kamanga.source.online.YamlHttpSource;
import com.readmanga.kamanga.source.online.english.Kissmanga;
import com.readmanga.kamanga.source.online.english.MangaPark;
import com.readmanga.kamanga.source.online.english.Mangaeden;
import com.readmanga.kamanga.source.online.english.Mangafox;
import com.readmanga.kamanga.source.online.english.Mangafree;
import com.readmanga.kamanga.source.online.english.Mangahasu;
import com.readmanga.kamanga.source.online.english.Mangahere;
import com.readmanga.kamanga.source.online.english.Mangakakalot;
import com.readmanga.kamanga.source.online.english.Mangasee;
import com.readmanga.kamanga.source.online.english.Mangastream;
import com.readmanga.kamanga.source.online.english.Readmangatoday;
import com.readmanga.kamanga.source.online.russian.Mangachan;
import com.readmanga.kamanga.source.online.russian.Mintmanga;
import com.readmanga.kamanga.source.online.russian.Readmanga;
import com.readmanga.kamanga.util.ContextExtensionsKt;
...
public class SourceManager
{
  ...
  {
    return CollectionsKt.listOf(new CatalogueSource[] { (CatalogueSource)new LocalSource(this.context), (CatalogueSource)new Mangahere(), (CatalogueSource)new Mangafox(), (CatalogueSource)new Readmanga(), (CatalogueSource)new Mintmanga(), (CatalogueSource)new Mangachan(), (CatalogueSource)new Readmangatoday(), (CatalogueSource)new Mangasee(), (CatalogueSource)new Kissmanga(), (CatalogueSource)new Mangaeden(), (CatalogueSource)new MangaPark(), (CatalogueSource)new Mangafree(), (CatalogueSource)new Mangahasu(), (CatalogueSource)new Mangakakalot(), (CatalogueSource)new Mangastream() });
  }
