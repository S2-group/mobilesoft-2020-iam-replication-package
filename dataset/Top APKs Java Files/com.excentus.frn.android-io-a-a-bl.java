...
class bl
{
  ...
  public String a(String paramString)
  {
    ...
    //   11: astore_2
    //   12: aload_0
    //   13: invokespecial 51	io/a/a/bl:m	()Z
    //   16: ifne +112 -> 128
    //   19: aload_0
    //   20: getfield 15	io/a/a/bl:a	Landroid/content/Context;
    ...
    //   85: new 94	io/a/a/c
    //   88: dup
    //   89: invokespecial 95	io/a/a/c:<init>	()V
    //   92: aload 5
    //   94: invokevirtual 98	io/a/a/c:a	([B)Ljava/lang/String;
    //   97: astore 5
    //   99: aload 5
    //   101: astore_3
    //   102: aload_2
  ...
  {
    Object localObject = an.a(this.a);
    String str = d();
    if ("bnc_no_value".equals(((an)localObject).e()))
    {
      if (paramBoolean) {
        ((an)localObject).a(str);
      }
      ...
      else
      {
        try
        {
          ...
          for (localObject = null;; localObject = ((CharSequence)localObject).toString())
          {
            ...
            if (localObject != null)
            {
              localJSONObject.put(ai.I.a(), localObject);
              localObject = a((String)localObject);
              if (!((String)localObject).equals("bnc_no_value")) {
                localJSONObject.put(ai.H.a(), localObject);
              }
            }
