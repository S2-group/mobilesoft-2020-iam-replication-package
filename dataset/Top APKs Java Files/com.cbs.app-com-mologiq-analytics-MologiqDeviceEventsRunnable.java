  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      ...
      for (Context localContext = (Context)this.contextReference.get(); localContext != null; localContext = null)
      {
        ...
        label982:
        label984:
        for (Object localObject1 = ((LocationManager)localObject2).getLastKnownLocation("gps");; localObject1 = null)
        {
          double d1;
          double d2;
          ...
          for (;;)
          {
            ...
            for (localObject1 = ((LocationManager)localObject2).getLastKnownLocation("network");; localObject1 = null)
            {
              if (localObject1 == null) {
                break label982;
              }
