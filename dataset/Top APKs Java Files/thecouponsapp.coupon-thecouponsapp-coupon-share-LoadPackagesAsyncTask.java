package thecouponsapp.coupon.share;
  ...
  extends AsyncTask<List<String[]>, Void, List<String[]>>
{
  ...
  protected void onPostExecute(List<String[]> paramList)
  {
    ...
    //   35: dup
    //   36: aload_0
    //   37: getfield 38	thecouponsapp/coupon/share/LoadPackagesAsyncTask:activity	Lthecouponsapp/coupon/share/AppPickerActivity;
    //   40: ldc -128
    //   42: aload_2
    //   43: invokespecial 131	android/widget/ArrayAdapter:<init>	(Landroid/content/Context;ILjava/util/List;)V
    //   46: astore_1
    //   47: aload_0
    //   48: getfield 38	thecouponsapp/coupon/share/LoadPackagesAsyncTask:activity	Lthecouponsapp/coupon/share/AppPickerActivity;
    //   51: aload_1
    //   52: invokevirtual 135	thecouponsapp/coupon/share/AppPickerActivity:setListAdapter	(Landroid/widget/ListAdapter;)V
    //   55: aload_0
    //   56: monitorexit
    //   57: return
    //   58: aload_2
