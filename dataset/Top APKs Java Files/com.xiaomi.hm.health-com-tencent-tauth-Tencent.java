...
public class Tencent
{
  ...
  public int login(n paramN, String paramString, IUiListener paramIUiListener)
  {
    com.tencent.open.a.f.c("openSDK_LOG.Tencent", "login() with fragment, scope is " + paramString);
    return this.a.a(paramN, paramString, paramIUiListener, "");
  }
  
  public int login(n paramN, String paramString, IUiListener paramIUiListener, boolean paramBoolean)
  {
    com.tencent.open.a.f.c("openSDK_LOG.Tencent", "login() with fragment, scope is " + paramString);
    return this.a.a(paramN, paramString, paramIUiListener, "", paramBoolean);
  }
  ...
  public int loginServerSide(n paramN, String paramString, IUiListener paramIUiListener)
  {
    com.tencent.open.a.f.c("openSDK_LOG.Tencent", "loginServerSide() with fragment, scope = " + paramString + ",server_side");
    return this.a.a(paramN, paramString + ",server_side", paramIUiListener, "");
  }
