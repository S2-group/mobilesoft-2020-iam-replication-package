...
class bp
{
  ...
  public String a(String paramString)
  {
    ...
    //   11: astore_2
    //   12: aload_0
    //   13: invokespecial 51	io/a/a/bp:m	()Z
    //   16: ifne +112 -> 128
    //   19: aload_0
    //   20: getfield 15	io/a/a/bp:a	Landroid/content/Context;
  ...
  {
    Object localObject = ar.a(this.a);
    String str = d();
    if ("bnc_no_value".equals(((ar)localObject).e()))
    {
      if (paramBoolean) {
      ...
      else
      {
        try
        {
          ...
          for (localObject = null;; localObject = ((CharSequence)localObject).toString())
          {
            ...
            if (localObject != null)
            {
              localJSONObject.put(am.J.a(), localObject);
              localObject = a((String)localObject);
              if (!((String)localObject).equals("bnc_no_value")) {
                localJSONObject.put(am.I.a(), localObject);
              }
            }
