  ...
  private ArrayList<String> a(Context paramContext)
  {
    try
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        C2Y.a(a, "get Local Package: " + localApplicationInfo.packageName);
      }
      return paramContext;
    }
    catch (Exception paramContext)
    {
      C2Y.e(a, "Using fallback package getter");
      paramContext.printStackTrace();
      return a();
    }
  }
  
  public void a(Context paramContext, HU paramHU)
  {
    ClientConfig localClientConfig = KH.a(paramContext).g();
    ...
    A4R localA4R = localClientConfig.Y();
    if (localA4R == null) {
      localA4R = new A4R();
    }
    for (;;)
    {
      ...
      Iterator localIterator1 = paramHU.b().iterator();
      label83:
      label515:
      for (;;)
      {
        ...
        if (localIterator1.hasNext())
        {
          ...
          } while (!((String)localIterator2.next()).equalsIgnoreCase(localZFP.a()));
        }
        for (int i = 1;; i = 0)
        {
          if ((i != 0) || (localZFP.a().equals(paramContext.getPackageName()))) {
            break label515;
          }
          localArrayList.add(localZFP.a());
          break label83;
          i = 1;
          if (l1 == 0L) {
            i = 0;
          ...
          while (i != 0)
          {
            ...
            paramHU = paramHU.b().iterator();
            while (paramHU.hasNext())
            {
              localObject = (ZFP)paramHU.next();
              if ((!((ZFP)localObject).a().equals(paramContext.getPackageName())) && (((ZFP)localObject).d() != 0L) && (l3 - ((ZFP)localObject).d() > l1))
              {
                localArrayList.add(((ZFP)localObject).a());
                C2Y.e(a, "Client timeout -  pack.getName()" + ((ZFP)localObject).a() + ", currentTime " + l3 + ", pack.getTimeStamp(): " + ((ZFP)localObject).d() + ", MAX_TIMEOUT: " + l1);
              }
            }
            if (l3 - l2 > l1)
            {
              C2Y.a(a, "over maxtimeout, cant determine dead clients");
              localClientConfig.b(l3);
              if ((paramHU != null) && (paramHU.b() != null))
              {
                localObject = paramHU.b().iterator();
                while (((Iterator)localObject).hasNext()) {
                  ((ZFP)((Iterator)localObject).next()).a(l3);
                }
                localClientConfig.a(paramHU);
              }
              i = 0;
            }
          }
          i = 0;
          if (localArrayList.size() != localA4R.a().size()) {
            i = 1;
          }
          while (i != 0)
          {
            localA4R.a(localArrayList);
            localA4R.a(localA4R.b() + 1);
            localClientConfig.a(localA4R);
            return;
            paramContext = new ArrayList(localArrayList);
            paramContext.removeAll(localA4R.a());
