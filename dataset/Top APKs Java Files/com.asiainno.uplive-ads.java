...
public final class ads
{
  ...
  private static ads.a B(Context paramContext, String paramString)
  {
    for (;;)
    {
      try
      {
        ...
        if (b(localPackageInfo3)) {}
      }
      catch (Throwable localThrowable)
      {
        PackageInfo localPackageInfo3;
        PackageInfo localPackageInfo1;
        abm.a("auth", "GetPackageInfoEx", localThrowable);
        if (b(null)) {
          break label147;
        }
        try
        {
          localPackageInfo2 = D(paramContext, paramString);
        }
        catch (Throwable paramContext)
        {
          abm.a("auth", "GetInstalledPackagesEx", paramContext);
      ...
      finally
      {
        ...
        paramContext = new ads.a();
        paramContext.aWi = localObject1.signatures;
        paramContext.b = localObject1.versionCode;
        return paramContext;
      }
      try
      {
        localPackageInfo1 = D(paramContext, paramString);
        if (!b(localPackageInfo1)) {
          return null;
        }
      }
      catch (Throwable paramContext)
  ...
  public static WebView a(Activity paramActivity, String paramString1, String paramString2)
  {
    ...
    paramActivity.setDownloadListener(new adt(localContext));
  ...
  public static String a(byte[] paramArrayOfByte)
  {
    ...
    {
      abm.a("auth", "GetPublicKeyFromSignEx", paramArrayOfByte);
    }
    return null;
  }
    ...
    if (paramString.startsWith("sdklite://h5quit?result=")) {
      for (;;)
      {
        try
        {
          ...
          paramString = i.a(i);
          abl.a = abl.c(paramString.h, paramString.i, paramWebView);
        }
        catch (Exception paramWebView)
        {
          paramWebView = i.a(i.e.h);
          abl.a = abl.c(paramWebView.h, paramWebView.i, "");
          continue;
        }
        paramActivity.runOnUiThread(new adu(paramActivity));
        return true;
  ...
  public static Map<String, String> aH(String paramString)
  {
  ...
  private static boolean b(PackageInfo paramPackageInfo)
  {
    ...
    {
      if (!bool) {
        abm.a("auth", "NotIncludeSignatures", paramPackageInfo);
      }
      return bool;
  ...
  public static ads.a ba(Context paramContext)
  {
    return B(paramContext, a());
  }
  
  private static DisplayMetrics bb(Context paramContext)
  {
  ...
  private static ads.a c(PackageInfo paramPackageInfo)
  {
    if (paramPackageInfo == null) {
      return null;
    }
    ads.a localA = new ads.a();
    localA.aWi = paramPackageInfo.signatures;
  ...
  public static boolean c(Context paramContext)
  {
    ...
    {
      abm.a("biz", "CheckClientExistEx", paramContext);
    }
    return false;
  }
  ...
  private static boolean d(PackageInfo paramPackageInfo)
  {
  ...
  public static String i(Context paramContext)
  {
    for (;;)
    {
      ...
      {
        abm.a("biz", "GetInstalledAppEx", paramContext);
        return "";
      }
  ...
  public static final class a
  {
    ...
    public final boolean a()
    {
      ...
      for (;;)
      {
        ...
        {
          String str = ads.a(this.aWi[i].toByteArray());
          ...
          {
            abm.a("biz", "PublicKeyUnmatch", str);
            return true;
          }
          i += 1;
        }
