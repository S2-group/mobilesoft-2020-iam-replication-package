...
public final class MAMPackageManagement
{
  ...
  private static PackageManagementBehavior getBehavior()
  {
    ...
    try
    {
      if (sCachedBehavior != null)
      {
        PackageManagementBehavior localPackageManagementBehavior1 = sCachedBehavior;
        return localPackageManagementBehavior1;
      }
    }
    finally {}
    sCachedBehavior = (PackageManagementBehavior)MAMComponents.get(PackageManagementBehavior.class);
    PackageManagementBehavior localPackageManagementBehavior2 = sCachedBehavior;
    return localPackageManagementBehavior2;
  }
