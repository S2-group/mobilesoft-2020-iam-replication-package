...
public class TJAdUnitJSBridge
{
  ...
  public void alert(JSONObject paramJSONObject, final String paramString)
  {
    ...
    //   137: aload_1
    //   138: invokevirtual 239	java/lang/Exception:printStackTrace	()V
    //   141: aconst_null
    //   142: astore_1
    //   143: goto -87 -> 56
    //   146: new 241	java/util/ArrayList
    //   149: dup
    //   150: invokespecial 242	java/util/ArrayList:<init>	()V
    //   153: astore 6
    //   155: iconst_0
    //   156: istore 4
    //   158: iload 4
    ...
    //   196: aload_1
    //   197: iload 4
    //   199: invokevirtual 245	org/json/JSONArray:getString	(I)Ljava/lang/String;
    //   202: invokevirtual 249	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   205: pop
    //   206: aload 5
    //   208: iload_3
    //   209: aload 6
    //   211: iload 4
    //   213: invokevirtual 253	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   216: checkcast 255	java/lang/CharSequence
    //   219: new 20	com/tapjoy/TJAdUnitJSBridge$5
    //   222: dup
    //   223: aload_0
    //   224: aload_2
    //   225: invokespecial 258	com/tapjoy/TJAdUnitJSBridge$5:<init>	(Lcom/tapjoy/TJAdUnitJSBridge;Ljava/lang/String;)V
    //   228: invokevirtual 264	android/app/AlertDialog:setButton	(ILjava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)V
    //   231: iload 4
    //   233: iconst_1
    //   234: iadd
    //   235: istore 4
    ...
    //   252: astore 7
    //   254: aload 7
    //   256: invokevirtual 239	java/lang/Exception:printStackTrace	()V
    //   259: goto -53 -> 206
    //   262: aload 5
    //   264: iconst_0
    //   265: invokevirtual 268	android/app/AlertDialog:setCancelable	(Z)V
    //   268: aload 5
    //   270: iconst_0
    //   271: invokevirtual 271	android/app/AlertDialog:setCanceledOnTouchOutside	(Z)V
    //   274: aload 5
    //   276: invokevirtual 274	android/app/AlertDialog:show	()V
    //   279: return
    //   280: astore_1
    //   281: goto -159 -> 122
  ...
  public void initMoatVideoTracker(JSONObject paramJSONObject, String paramString)
  {
    ...
    try
    {
      ...
      if (this.l == null)
      {
        ...
        this.l = new HashMap();
        this.l.put("firstQuartile", b.AD_EVT_FIRST_QUARTILE);
        this.l.put("midpoint", b.AD_EVT_MID_POINT);
        this.l.put("thirdQuartile", b.AD_EVT_THIRD_QUARTILE);
        this.l.put("complete", b.AD_EVT_COMPLETE);
        this.l.put("paused", b.AD_EVT_PAUSED);
        this.l.put("playing", b.AD_EVT_PLAYING);
        this.l.put("start", b.AD_EVT_START);
        this.l.put("stopped", b.AD_EVT_STOPPED);
        this.l.put("skipped", b.AD_EVT_SKIPPED);
        this.l.put("volumeChanged", b.AD_EVT_VOLUME_CHANGE);
        this.l.put("enterFullScreen", b.AD_EVT_ENTER_FULLSCREEN);
        this.l.put("exitFullScreen", b.AD_EVT_EXIT_FULLSCREEN);
      }
  ...
  public void present(JSONObject paramJSONObject, String paramString)
  {
    ...
    //   58: invokespecial 821	com/tapjoy/TJAdUnitJSBridge$a:<init>	(Lcom/tapjoy/TJAdUnitJSBridge;Landroid/webkit/WebView;)V
    //   61: iconst_2
    ...
    //   72: aload_3
    //   73: aastore
    //   74: invokevirtual 825	com/tapjoy/TJAdUnitJSBridge$a:execute	([Ljava/lang/Object;)Landroid/os/AsyncTask;
    //   77: pop
    //   78: aload_0
    //   79: aload_2
    //   80: iconst_1
    ...
    //   110: aload_1
    //   111: invokevirtual 239	java/lang/Exception:printStackTrace	()V
    //   114: return
    //   115: astore_1
    //   116: goto -67 -> 49
    //   119: astore 4
  ...
  public void triggerMoatVideoEvent(final JSONObject paramJSONObject, String paramString)
  {
    try
    {
      ...
      paramJSONObject = new a(paramJSONObject, Integer.valueOf(n));
      this.m.post(new Runnable()
      {
        public final void run()
        {
