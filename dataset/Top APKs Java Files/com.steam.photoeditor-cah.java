...
public class cah
{
  ...
  public static Intent a(Context paramContext, Intent paramIntent, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          str1 = paramString;
          if ("com.jb.zcamera.filterstore.activity.FilterStoreActivity".equals(paramString)) {
            str1 = "com.jb.zcamera.store.activity.StoreActivity";
          }
        ...
        if ("com.jb.zcamera.filterstore.activity.FilterStoreActivity".equals(str1))
        {
  ...
  public static void a(Activity paramActivity, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          localObject1 = bmc.a("wecloud_push_main");
          bmc.a("wecloud_push_main", "");
        ...
        {
          localObject1 = bmc.a("wecloud_push_filter_store");
          bmc.a("wecloud_push_filter_store", "");
          continue;
        }
      ...
      localObject1 = bmc.a("wecloud_push_gallery");
      bmc.a("wecloud_push_gallery", "");
    }
    Object localObject2 = bmc.a("wecloud_push_message_id");
    aqi.d((String)localObject2 + "wc_d_show_mid");
    ...
    ((AlertDialog.Builder)localObject1).setNegativeButton((CharSequence)localObject3, new cah.2());
    ((AlertDialog.Builder)localObject1).setPositiveButton(str, new cah.3((String)localObject2, paramString, paramActivity));
    if (!TextUtils.isEmpty(paramString.getBanner()))
    {
      localObject3 = LayoutInflater.from(paramActivity).inflate(anm.h.wecloud_push_message_dialog, null, false);
      ((AlertDialog.Builder)localObject1).setView((View)localObject3);
      paramActivity = (TextView)((View)localObject3).findViewById(anm.g.wecloud_push_title);
      localObject2 = (KPNetworkImageView)((View)localObject3).findViewById(anm.g.wecloud_push_item);
      localObject3 = (TextView)((View)localObject3).findViewById(anm.g.wecloud_push_content);
      paramActivity.setText(paramString.getTitle());
      ((TextView)localObject3).setText(paramString.getContent());
      ((KPNetworkImageView)localObject2).setDefaultImageResId(anm.f.filter_store_details_default);
      ((KPNetworkImageView)localObject2).setErrorImageResId(anm.f.filter_store_details_default);
  ...
  public static void a(Context paramContext, MessageBO paramMessageBO)
  {
    ...
    {
      ark.e(paramMessageBO.getSaleStartDate());
      ark.f(paramMessageBO.getSaleEndDate());
    }
    SVipActivity.startSVipActivity(paramContext, 11);
  }
  
  public static void a(MessageBO paramMessageBO, cag paramCag)
  {
    if ((paramMessageBO == null) || (paramCag == null)) {
      return;
    }
    a.submit(new cah.1(paramMessageBO, paramCag));
  }
