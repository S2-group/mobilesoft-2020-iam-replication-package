...
public final class t
{
    ...
    throws JSONException, UnsupportedEncodingException
  {
    ...
    Iterator localIterator = bk.a(paramContext, new String(Base64.decode("YW5kcm9pZC5pbnRlbnQuYWN0aW9uLk1BSU4=", 0), "UTF-8"), new String(Base64.decode("YW5kcm9pZC5pbnRlbnQuY2F0ZWdvcnkuTEFVTkNIRVI=", 0), "UTF-8")).iterator();
    while (localIterator.hasNext())
    {
      ...
      if (((HashSet)localObject).add(localApplicationInfo.packageName))
      {
        ...
        label326:
        if (bk.c(paramContext, localApplicationInfo.packageName) == null) {
          localJSONArray5.put(0);
        } else {
          localJSONArray5.put(bk.c(paramContext, localApplicationInfo.packageName).firstInstallTime / 1000L);
        }
      }
    }
    return this;
  ...
  public String d()
  {
    return Base64.encodeToString(new b().a(bi.c(this.a.toString())), 0);
  }
