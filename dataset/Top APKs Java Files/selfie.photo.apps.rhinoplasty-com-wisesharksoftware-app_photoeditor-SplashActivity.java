  ...
  extends BillingActivity
{
  ...
  {
    paramContext = paramContext.getResources().getString(2131558569);
  ...
  public boolean IsAdsHidden()
  {
    ...
    if (!getResources().getBoolean(2130968589)) {
      return true;
    }
    bool1 = bool2;
    if (!isFullVersion())
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    if (i != 0)
    {
      ...
      ((ImageView)findViewById(2131230988)).startAnimation(paramBundle);
    }
  ...
  {
    super.onStart();
    FlurryAgent.onStartSession(getApplicationContext(), getString(2131558561));
