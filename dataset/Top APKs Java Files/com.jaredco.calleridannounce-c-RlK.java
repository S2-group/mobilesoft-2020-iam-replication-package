...
public class RlK
{
  private static final String ˊ = RlK.class.getSimpleName();
  private final Context ˋ;
  private final com.p3group.insight.b ˎ;
  private boolean ˏ;
  private boolean ᐝ = false;
  
  public RlK(Context paramContext)
  {
    this.ˋ = paramContext;
  ...
  public void ˊ()
  {
    ...
    do
    {
      ...
      l = com.p3group.insight.g.b.a(this.ˋ);
    } while (l - this.ˎ.c() <= localB.b());
    this.ˏ = true;
    new RRR((byte)0).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new Long[] { Long.valueOf(l) });
  }
    ...
    extends AsyncTask
  {
    ...
    private InstalledAppsResult ˊ(Long... paramVarArgs)
    {
      ...
      localInstalledAppsResult.DeviceInfo = DeviceController.getDeviceInfo(RlK.ˊ(RlK.this));
      localInstalledAppsResult.TimestampSnapshot = c.a(paramVarArgs[0].longValue());
      ArrayList localArrayList1 = new ArrayList();
      PackageManager localPackageManager = RlK.ˊ(RlK.this).getPackageManager();
      int i;
      Object localObject1;
      ...
      try
      {
        paramVarArgs = localPackageManager.getClass().getMethod("getPackageSizeInfo", new Class[] { String.class, RRR.class });
        if (RlK.ˊ(RlK.this).checkCallingOrSelfPermission("android.permission.GET_PACKAGE_SIZE") == 0)
        {
          i = 1;
      ...
      catch (NoSuchMethodException paramVarArgs)
      {
        ...
        for (;;)
        {
          Log.e(RlK.ˋ(), "IA: " + paramVarArgs.getMessage());
          paramVarArgs = null;
          continue;
          i = 0;
          continue;
      ...
      for (;;)
      {
        ...
        catch (PackageManager.NameNotFoundException localNameNotFoundException)
        {
          try
          {
            paramVarArgs.invoke(localPackageManager, new Object[] { localInstalledApp.PackageName, new RRR.RRR()
            {
