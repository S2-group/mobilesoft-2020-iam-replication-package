...
public final class OpenDictionaryAPI
{
    ...
    for (;;)
    {
      if (localIterator.hasNext())
      {
        ...
        try
        {
          ...
          if ((localObject2 != null) && (((ApplicationInfo)localObject2).metaData != null) && (((ApplicationInfo)localObject2).metaData.containsKey("open.dictionary.api.minVersionCode")) && (5 >= ((ApplicationInfo)localObject2).metaData.getInt("open.dictionary.api.minVersionCode")) && (((ApplicationInfo)localObject2).metaData.getInt("open.dictionary.api.versionCode") >= 1))
          {
            ...
            localObject3 = new Dictionary[i];
            int i = 0;
            localObject3[0] = localObject1;
            if (((Dictionary)localObject1).hasPairDictionary()) {
              localObject3[1] = ((Dictionary)localObject1).getPairDictionary();
            }
            ...
            while (i < j)
            {
              ...
              {
                localObject4 = ((Dictionary)localObject4).getMorphology();
                localObject2 = (HashSet)this.morphosMap.get(((Morphology)localObject4).getLanguage());
                localObject1 = localObject2;
                if (localObject2 == null)
                {
                  localObject2 = this.morphosMap;
        ...
        catch (Exception localException)
        {
          ...
          ((StringBuilder)localObject3).append(this.ctx.getPackageName());
          ((StringBuilder)localObject3).append("] ");
          ((StringBuilder)localObject3).append("Can't get application info of \"");
          ((StringBuilder)localObject3).append(((PackageInfo)localObject1).packageName);
          ((StringBuilder)localObject3).append("\"");
          Log.e("Open Dictionary API", ((StringBuilder)localObject3).toString(), localException);
        }
      }
    }
  }
  ...
  public boolean hasDictionary(Direction paramDirection)
  {
    ...
    return getDictionaries(paramDirection).isEmpty() ^ true;
  }
