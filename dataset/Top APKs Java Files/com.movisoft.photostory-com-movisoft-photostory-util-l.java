package com.movisoft.photostory.util;
...
import com.movisoft.photostory.j.a;
import com.movisoft.photostory.n.c;
import com.movisoft.photostory.tool.j;
import com.movisoft.photostory.tool.k;
...
public class l
{
  ...
  {
    return v.a(paramLong * 1.0D / 1048576.0D, 2, 4);
  }
  ...
  {
    if (paramLong2 == 1024L) {
      return v.a(paramLong1 * 1.0D / 1024.0D, 2, 4) + "KB";
    }
    if (paramLong2 == 1048576L)
    {
      if (paramLong1 >= 1048576L) {
        return v.a(paramLong1 * 1.0D / 1048576.0D, 2, 4) + "MB";
      }
      return v.a(paramLong1 * 1.0D / 1024.0D, 2, 4) + "KB";
    }
    if (paramLong2 == 1073741824L)
    {
      if (paramLong1 >= 1073741824L) {
        return v.a(paramLong1 * 1.0D / 1.073741824E9D, 2, 4) + "GB";
      }
      if (paramLong1 >= 1048576L) {
        return v.a(paramLong1 * 1.0D / 1048576.0D, 2, 4) + "MB";
      }
    ...
    if (paramLong2 == 1099511627776L)
    {
      if (paramLong1 >= 1099511627776L) {
        return v.a(paramLong1 * 1.0D / 1.099511627776E12D, 2, 4) + "TB";
      }
      if (paramLong1 >= 1073741824L) {
        return v.a(paramLong1 * 1.0D / 1.073741824E9D, 2, 4) + "GB";
      }
  ...
  public static String a(Context paramContext, Uri paramUri, String paramString, String[] paramArrayOfString)
  {
    ...
    //   18: aload_3
    //   19: aconst_null
    //   20: invokevirtual 220	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   23: astore_1
    //   24: aload_1
    //   25: ifnull +39 -> 64
    //   28: aload_1
    //   29: invokeinterface 229 1 0
    //   34: ifeq +30 -> 64
    //   37: aload_1
    //   38: aload_1
    //   39: ldc 39
    //   41: invokeinterface 267 2 0
    //   46: invokeinterface 233 2 0
    //   51: astore_0
    //   52: aload_1
    //   53: ifnull +9 -> 62
    //   56: aload_1
    //   57: invokeinterface 239 1 0
    //   62: aload_0
    //   63: areturn
    //   64: aload_1
    //   65: ifnull +9 -> 74
  ...
  public static boolean a(Context paramContext, String paramString, boolean paramBoolean)
  {
    if (e(paramString) >= 2147483648L)
    {
      ...
      if (paramBoolean)
      {
        j.b("cxs", "NOT_SUPPORTED_2G_EDITOR_CHOOSE");
        return true;
      }
      j.b("cxs", "NOT_SUPPORTED_2G_OUT_ACTIVITY");
      return true;
    }
    return false;
  }
  ...
  public static boolean a(Bitmap paramBitmap, String paramString, int paramInt)
  {
    ...
    try
    {
      j.b("saveBitmapToSdCardJPG", "filePath:" + paramString);
      bool1 = bool2;
      ...
      bool1 = bool2;
      j.b("saveBitmapToSdCardJPG", "saveRet:" + bool2);
      return bool2;
    }
  ...
  public static boolean a(String paramString1, String paramString2, android.os.Handler paramHandler)
  {
    ...
    //   35: lconst_0
    //   36: lstore 5
    //   38: new 451	java/io/FileInputStream
    //   41: dup
    //   42: aload 9
    //   44: invokespecial 452	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   47: astore 7
    //   49: new 276	java/io/FileOutputStream
    //   52: dup
    //   53: aload_1
    //   54: invokespecial 277	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   57: astore_1
    //   58: ldc_w 292
    //   61: newarray byte
    //   63: astore_0
    ...
    //   66: aload 7
    //   68: aload_0
    //   69: invokevirtual 455	java/io/InputStream:read	([B)I
    //   72: istore 4
    //   74: iload 4
    //   76: iconst_m1
    ...
    //   109: invokestatic 398	com/movisoft/photostory/tool/j:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   112: aload_1
    //   113: aload_0
    //   114: iconst_0
    //   115: iload 4
    //   117: invokevirtual 456	java/io/FileOutputStream:write	([BII)V
    //   120: ldc2_w 457
    //   123: lload 5
    //   125: lmul
    //   126: aload 9
    //   128: invokevirtual 327	java/io/File:length	()J
    //   131: ldiv
    //   132: l2i
    //   133: istore 4
    //   135: iload_3
    ...
    //   144: aload_2
    //   145: ifnull +67 -> 212
    //   148: new 460	android/os/Message
    //   151: dup
    //   152: invokespecial 461	android/os/Message:<init>	()V
    //   155: astore 8
    //   157: new 463	android/os/Bundle
    //   160: dup
    //   161: invokespecial 464	android/os/Bundle:<init>	()V
    //   164: astore 10
    //   166: aload 10
    //   168: ldc_w 466
    //   171: lload 5
    //   173: invokevirtual 470	android/os/Bundle:putLong	(Ljava/lang/String;J)V
    //   176: aload 10
    //   178: ldc_w 472
    //   181: aload 9
    //   183: invokevirtual 327	java/io/File:length	()J
    //   186: invokevirtual 470	android/os/Bundle:putLong	(Ljava/lang/String;J)V
    //   189: aload 8
    //   191: iconst_0
    //   192: putfield 475	android/os/Message:what	I
    //   195: aload 8
    //   197: aload 10
    //   199: invokevirtual 479	android/os/Message:setData	(Landroid/os/Bundle;)V
    //   202: aload_2
    //   203: aload 8
    //   205: invokevirtual 485	android/os/Handler:sendMessage	(Landroid/os/Message;)Z
    //   208: pop
    //   209: iload 4
    //   211: istore_3
    //   212: goto -146 -> 66
    ...
    //   217: ifnull +8 -> 225
    //   220: aload 7
    //   222: invokevirtual 486	java/io/InputStream:close	()V
    //   225: aload_1
    //   226: ifnull +11 -> 237
    //   229: aload_1
    //   230: invokevirtual 487	java/io/FileOutputStream:flush	()V
    //   233: aload_1
    //   234: invokevirtual 416	java/io/FileOutputStream:close	()V
    //   237: iconst_1
    //   238: ireturn
    //   239: astore_0
    //   240: aload_0
    //   241: invokevirtual 258	java/lang/Exception:printStackTrace	()V
    //   244: goto -19 -> 225
    //   247: astore_0
    //   248: aload_0
    //   249: invokevirtual 258	java/lang/Exception:printStackTrace	()V
    //   252: goto -15 -> 237
    //   255: astore_2
    //   256: aload 8
    //   258: astore_1
    //   259: aconst_null
    //   260: ldc_w 489
    //   263: invokestatic 398	com/movisoft/photostory/tool/j:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   266: aload_2
    //   267: invokevirtual 258	java/lang/Exception:printStackTrace	()V
    //   270: aload_0
    //   271: ifnull +7 -> 278
    //   274: aload_0
    //   275: invokevirtual 486	java/io/InputStream:close	()V
    //   278: aload_1
    //   279: ifnull -271 -> 8
    //   282: aload_1
    //   283: invokevirtual 487	java/io/FileOutputStream:flush	()V
    //   286: aload_1
    //   287: invokevirtual 416	java/io/FileOutputStream:close	()V
    //   290: iconst_0
    //   291: ireturn
    //   292: astore_0
    //   293: aload_0
    //   294: invokevirtual 258	java/lang/Exception:printStackTrace	()V
    //   297: iconst_0
    //   298: ireturn
    //   299: astore_0
    //   300: aload_0
    //   301: invokevirtual 258	java/lang/Exception:printStackTrace	()V
    //   304: goto -26 -> 278
    //   307: astore_0
    //   308: aconst_null
    //   309: astore 7
    ...
    //   315: ifnull +8 -> 323
    //   318: aload 7
    //   320: invokevirtual 486	java/io/InputStream:close	()V
    //   323: aload_1
    //   324: ifnull +11 -> 335
    //   327: aload_1
    //   328: invokevirtual 487	java/io/FileOutputStream:flush	()V
    //   331: aload_1
    //   332: invokevirtual 416	java/io/FileOutputStream:close	()V
    //   335: aload_0
    //   336: athrow
    //   337: astore_2
    //   338: aload_2
    //   339: invokevirtual 258	java/lang/Exception:printStackTrace	()V
    //   342: goto -19 -> 323
    //   345: astore_1
    //   346: aload_1
    //   347: invokevirtual 258	java/lang/Exception:printStackTrace	()V
    //   350: goto -15 -> 335
    //   353: astore_0
    //   354: aconst_null
    //   355: astore_1
    ...
    //   164	34	10	localBundle	android.os.Bundle
    // Exception table:
    //   from	to	target	type
  ...
  public static boolean b(Bitmap paramBitmap, String paramString, int paramInt)
  {
    ...
    try
    {
      j.b("saveBitmapToSdCardPNG", "filePath:" + paramString);
      bool1 = bool2;
      paramString = new FileOutputStream(paramString);
      bool1 = bool2;
      ...
      bool1 = bool2;
      j.b("saveBitmapToSdCardPNG", "saveRet:" + bool2);
      return bool2;
    }
    catch (Exception paramBitmap)
    {
  ...
  public static boolean b(String paramString1, String paramString2)
  {
    ...
    //   29: ifeq -15 -> 14
    //   32: new 451	java/io/FileInputStream
    //   35: dup
    //   36: aload_0
    //   37: invokespecial 452	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   40: astore 4
    //   42: new 55	java/io/File
    //   45: dup
    //   46: aload_1
    //   47: invokespecial 58	java/io/File:<init>	(Ljava/lang/String;)V
    //   50: invokevirtual 526	java/io/File:getParentFile	()Ljava/io/File;
    //   53: astore_0
    //   54: aload_0
    //   55: invokevirtual 62	java/io/File:exists	()Z
    //   58: ifne +8 -> 66
    //   61: aload_0
    //   62: invokevirtual 507	java/io/File:mkdirs	()Z
    //   65: pop
    //   66: new 276	java/io/FileOutputStream
    //   69: dup
    //   70: aload_1
    //   71: invokespecial 277	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   74: astore_0
    //   75: ldc_w 292
    //   78: newarray byte
    //   80: astore_1
    ...
    //   83: aload 4
    //   85: aload_1
    //   86: invokevirtual 455	java/io/InputStream:read	([B)I
    //   89: istore_3
    //   90: iload_3
    //   91: iconst_m1
    //   92: if_icmpeq +92 -> 184
    ...
    //   107: iload_2
    //   108: invokevirtual 447	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   111: ldc -69
    ...
    //   119: invokestatic 398	com/movisoft/photostory/tool/j:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   122: aload_0
    //   123: aload_1
    //   124: iconst_0
    //   125: iload_3
    //   126: invokevirtual 456	java/io/FileOutputStream:write	([BII)V
    //   129: goto -46 -> 83
    //   132: astore 5
    //   134: aload_0
    //   135: astore_1
    ...
    //   143: aconst_null
    //   144: ldc_w 489
    //   147: invokestatic 398	com/movisoft/photostory/tool/j:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   150: aload 4
    //   152: invokevirtual 258	java/lang/Exception:printStackTrace	()V
    //   155: aload_0
    //   156: ifnull +7 -> 163
    //   159: aload_0
    //   160: invokevirtual 486	java/io/InputStream:close	()V
    //   163: aload_1
    //   164: ifnull -150 -> 14
    //   167: aload_1
    //   168: invokevirtual 487	java/io/FileOutputStream:flush	()V
    //   171: aload_1
    //   172: invokevirtual 416	java/io/FileOutputStream:close	()V
    //   175: iconst_0
    //   176: ireturn
    //   177: astore_0
    //   178: aload_0
    //   179: invokevirtual 258	java/lang/Exception:printStackTrace	()V
    //   182: iconst_0
    //   183: ireturn
    //   184: aload 4
    //   186: ifnull +8 -> 194
    //   189: aload 4
    //   191: invokevirtual 486	java/io/InputStream:close	()V
    //   194: aload_0
    //   195: ifnull +11 -> 206
    //   198: aload_0
    //   199: invokevirtual 487	java/io/FileOutputStream:flush	()V
    //   202: aload_0
    //   203: invokevirtual 416	java/io/FileOutputStream:close	()V
    //   206: iconst_1
    //   207: ireturn
    //   208: astore_1
    //   209: aload_1
    //   210: invokevirtual 258	java/lang/Exception:printStackTrace	()V
    //   213: goto -19 -> 194
    //   216: astore_0
    //   217: aload_0
    //   218: invokevirtual 258	java/lang/Exception:printStackTrace	()V
    //   221: goto -15 -> 206
    //   224: astore_0
    //   225: aload_0
    //   226: invokevirtual 258	java/lang/Exception:printStackTrace	()V
    //   229: goto -66 -> 163
    //   232: astore_0
    //   233: aconst_null
    //   234: astore 4
    ...
    //   241: ifnull +8 -> 249
    //   244: aload 4
    //   246: invokevirtual 486	java/io/InputStream:close	()V
    //   249: aload_1
    //   250: ifnull +11 -> 261
    //   253: aload_1
    //   254: invokevirtual 487	java/io/FileOutputStream:flush	()V
    //   257: aload_1
    //   258: invokevirtual 416	java/io/FileOutputStream:close	()V
    //   261: aload_0
    //   262: athrow
    //   263: astore 4
    //   265: aload 4
    ...
    //   273: astore_1
    //   274: aload_1
    //   275: invokevirtual 258	java/lang/Exception:printStackTrace	()V
    //   278: goto -17 -> 261
    //   281: astore_0
    //   282: aload 6
    //   284: astore_1
  ...
  public static String d(Context paramContext, Uri paramUri)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 622	android/content/Context:getPackageManager	()Landroid/content/pm/PackageManager;
    //   4: bipush 8
    //   6: invokevirtual 628	android/content/pm/PackageManager:getInstalledPackages	(I)Ljava/util/List;
    //   9: astore 5
    //   11: aload 5
    //   13: ifnull +258 -> 271
    //   16: ldc_w 630
    //   19: invokevirtual 633	java/lang/Class:getName	()Ljava/lang/String;
    //   22: astore 4
    //   24: aload 5
    //   26: invokeinterface 637 1 0
    //   31: astore 5
    //   33: aload 5
    //   35: invokeinterface 642 1 0
    //   40: ifeq +231 -> 271
    //   43: aload 5
    //   45: invokeinterface 645 1 0
    //   50: checkcast 647	android/content/pm/PackageInfo
    //   53: getfield 651	android/content/pm/PackageInfo:providers	[Landroid/content/pm/ProviderInfo;
    //   56: astore 6
    //   58: aload 6
    //   60: ifnull -27 -> 33
    //   63: aload 6
    ...
    //   78: astore 7
    //   80: aload_1
    //   81: invokevirtual 433	android/net/Uri:getAuthority	()Ljava/lang/String;
    //   84: aload 7
    //   86: getfield 656	android/content/pm/ProviderInfo:authority	Ljava/lang/String;
    //   89: invokevirtual 436	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   92: ifeq +211 -> 303
    //   95: aload 7
    //   97: getfield 659	android/content/pm/ProviderInfo:name	Ljava/lang/String;
    //   100: aload 4
    //   102: invokevirtual 535	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   105: ifeq -72 -> 33
    //   108: ldc_w 630
    //   111: ldc_w 661
    //   114: iconst_2
    //   115: anewarray 632	java/lang/Class
    //   118: dup
    //   119: iconst_0
    //   120: ldc 77
    //   122: aastore
    ...
    //   125: ldc 37
    //   127: aastore
    //   128: invokevirtual 665	java/lang/Class:getDeclaredMethod	(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
    //   131: astore 6
    //   133: aload 6
    //   135: iconst_1
    //   136: invokevirtual 671	java/lang/reflect/Method:setAccessible	(Z)V
    //   139: aload 6
    //   141: aconst_null
    //   142: iconst_2
    ...
    //   151: iconst_1
    //   152: aload_1
    //   153: invokevirtual 433	android/net/Uri:getAuthority	()Ljava/lang/String;
    //   156: aastore
    //   157: invokevirtual 675	java/lang/reflect/Method:invoke	(Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;
    //   160: astore 6
    //   162: aload 6
    //   164: ifnull -131 -> 33
    ...
    //   174: ldc_w 630
    //   177: invokevirtual 633	java/lang/Class:getName	()Ljava/lang/String;
    ...
    //   192: invokestatic 681	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   195: ldc_w 683
    //   198: iconst_1
    //   199: anewarray 632	java/lang/Class
    //   202: dup
    //   203: iconst_0
    //   204: ldc -61
    //   206: aastore
    //   207: invokevirtual 665	java/lang/Class:getDeclaredMethod	(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
    //   210: astore 7
    //   212: aload 7
    //   214: iconst_1
    //   215: invokevirtual 671	java/lang/reflect/Method:setAccessible	(Z)V
    //   218: aload 7
    //   220: aload 6
    //   222: iconst_1
    ...
    //   228: aload_1
    //   229: aastore
    //   230: invokevirtual 675	java/lang/reflect/Method:invoke	(Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;
    //   233: astore 6
    //   235: aload 6
    //   237: instanceof 55
    //   240: ifeq -207 -> 33
    ...
    //   248: invokevirtual 357	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   251: astore 6
    //   253: aload 6
    //   255: areturn
    //   256: astore 6
    //   258: aload 6
    //   260: invokevirtual 684	java/lang/NoSuchMethodException:printStackTrace	()V
    //   263: goto -230 -> 33
    //   266: astore_0
    //   267: aload_0
    //   268: invokevirtual 258	java/lang/Exception:printStackTrace	()V
    //   271: aconst_null
    //   272: areturn
    //   273: astore 6
    //   275: aload 6
    //   277: invokevirtual 685	java/lang/reflect/InvocationTargetException:printStackTrace	()V
    //   280: goto -247 -> 33
    //   283: astore 6
    //   285: aload 6
    //   287: invokevirtual 686	java/lang/IllegalAccessException:printStackTrace	()V
    //   290: goto -257 -> 33
    //   293: astore 6
    //   295: aload 6
    //   297: invokevirtual 687	java/lang/ClassNotFoundException:printStackTrace	()V
    //   300: goto -267 -> 33
    //   303: iload_2
    //   304: iconst_1
    //   305: iadd
  ...
  public static boolean e(String paramString1, String paramString2)
  {
    ...
    do
    {
      do
      {
        ...
        paramString2 = paramString2 + File.separator + str;
    ...
    if (localFile.isFile()) {
      bool1 = d(localFile.getAbsolutePath(), paramString2);
    }
    for (;;)
    {
      bool2 = bool1;
      ...
      if (localFile.isDirectory()) {
        bool1 = e(localFile.getAbsolutePath(), paramString2);
      }
    }
  }
  ...
  public static boolean l(String paramString)
  {
    ...
    do
    {
      ...
      if (paramString.isDirectory()) {
        return m(paramString.getAbsolutePath());
      }
  ...
  public static boolean m(String paramString)
  {
    ...
    for (;;)
    {
      ...
      while (!bool)
      {
        ...
        label66:
        if (localFile.isDirectory()) {
          bool = m(localFile.getAbsolutePath());
        }
      }
      i += 1;
    }
