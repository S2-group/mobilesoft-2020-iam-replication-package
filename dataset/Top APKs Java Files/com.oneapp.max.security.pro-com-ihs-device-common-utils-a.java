...
public final class a
{
  public static <T extends HSAppRunningInfo> List<T> a(Class<T> paramClass, HSAppFilter paramHSAppFilter)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject2 = ((HSAppRunningInfo)paramHSAppFilter.next()).a();
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      j = localHSAppRunningInfo.a().length;
  ...
  private static <T extends HSAppRunningInfo> List<T> b(Class<T> paramClass, HSAppFilter paramHSAppFilter)
  {
    ...
    paramClass = AppInfoProvider.a(paramClass, new HSAppFilter().g());
    Object localObject1 = com.ihs.app.framework.a.a().getPackageManager().getInstalledPackages(128);
    Object localObject2 = paramClass.iterator();
    while (((Iterator)localObject2).hasNext())
    {
      HSAppRunningInfo localHSAppRunningInfo = (HSAppRunningInfo)((Iterator)localObject2).next();
    ...
    try
    {
      localObject2 = c.a(Uri.parse("content://" + com.ihs.app.framework.a.a().getPackageName() + ".recent_app/"), "METHOD_GET_RECENT_APP_LIST", null, null).getStringArrayList("EXTRA_RECENT_APP_LIST");
    ...
    while (paramClass.hasNext())
    {
      ...
      ((HSAppRunningInfo)localObject2).a(new int[0]);
      ((HSAppRunningInfo)localObject2).setIsMusicPlayer(b.a((HSAppRunningInfo)localObject2));
      ((HSAppRunningInfo)localObject2).setIsRecentApp(((Set)localObject1).contains(((HSAppRunningInfo)localObject2).getPackageName()));
      if (paramHSAppFilter.a((HSAppFilter.a)localObject2)) {
  ...
  {
    ArrayList localArrayList = new ArrayList();
    Object localObject1 = (ActivityManager)com.ihs.app.framework.a.a().getSystemService("activity");
    ...
    try
    {
      localObject3 = c.a(Uri.parse("content://" + com.ihs.app.framework.a.a().getPackageName() + ".recent_app/"), "METHOD_GET_RECENT_APP_LIST", null, null).getStringArrayList("EXTRA_RECENT_APP_LIST");
        ...
        if (localObject5 != null)
        {
          ...
          while (((Iterator)localObject6).hasNext())
          {
            ...
            if (localRunningAppProcessInfo.processName.equalsIgnoreCase((String)localObject4)) {
              ((HSAppRunningInfo)localObject5).a(localRunningAppProcessInfo.pid);
            }
            localSparseIntArray.put(localRunningAppProcessInfo.pid, localRunningAppProcessInfo.pid);
            ((HSAppRunningInfo)localObject5).b.add(localRunningAppProcessInfo.importanceReasonComponent);
          }
          ((HSAppRunningInfo)localObject5).a(e.a(localSparseIntArray));
    ...
    Object localObject3 = AppInfoProvider.a(paramClass, new HSAppFilter().g());
  ...
  private static <T extends HSAppRunningInfo> List<T> d(Class<T> paramClass, HSAppFilter paramHSAppFilter)
  {
    ...
    for (;;)
    {
      ...
      if (((Iterator)localObject4).hasNext())
      {
        ...
        if ((localHSAppRunningInfo == null) || (b.a(localHSAppRunningInfo, localArrayList))) {
          continue;
        }
      ...
      try
      {
        if (paramClass.process.equalsIgnoreCase((String)localObject5)) {
          localHSAppRunningInfo.a(paramClass.pid);
        }
        localSparseIntArray.put(paramClass.pid, paramClass.pid);
        localHSAppRunningInfo.b.add(paramClass.service);
      }
      catch (Exception paramClass)
      {
        paramClass.printStackTrace();
        break label405;
        localHSAppRunningInfo.a(e.a(localSparseIntArray));
        localHSAppRunningInfo.setIsMusicPlayer(b.a(localHSAppRunningInfo));
        localHSAppRunningInfo.setIsRecentApp(((Set)localObject2).contains(localHSAppRunningInfo.getPackageName()));
        if (!paramHSAppFilter.a(localHSAppRunningInfo)) {
          continue;
        }
        ...
        {
          paramClass = com.ihs.device.common.utils.processes.a.a().iterator();
          while (paramClass.hasNext())
          {
            localObject1 = (AndroidAppProcess)paramClass.next();
            localObject4 = (HSAppRunningInfo)localException.get(((AndroidAppProcess)localObject1).a());
            if (localObject4 != null)
            {
              if (((AndroidAppProcess)localObject1).c.equalsIgnoreCase(((HSAppRunningInfo)localObject4).getPackageName())) {
                ((HSAppRunningInfo)localObject4).a(((AndroidAppProcess)localObject1).d);
              }
              localObject5 = e.a(((HSAppRunningInfo)localObject4).a());
              ((SparseIntArray)localObject5).put(((AndroidAppProcess)localObject1).d, ((AndroidAppProcess)localObject1).d);
              ((HSAppRunningInfo)localObject4).a(e.a((SparseIntArray)localObject5));
              ((HSAppRunningInfo)localObject4).setIsMusicPlayer(b.a((HSAppRunningInfo)localObject4));
              ((HSAppRunningInfo)localObject4).setIsRecentApp(((Set)localObject2).contains(((HSAppRunningInfo)localObject4).getPackageName()));
              if (paramHSAppFilter.a((HSAppFilter.a)localObject4))
              {
