      ...
      public void run()
      {
        ...
        if (!BBUtilsConst.isShowingExitDialog)
        {
          ...
          if ((SystemBo.this != null) && (!"".equals(SystemBo.this)))
          {
            ...
            Log.e("com.sinyee.babybus", "http://au.apk.umeng.com/uploads/apps/5590f83a67e58eb624001826/A014_%40_174_%40_0ab7b5e5467332a3640553e5bed5c0b2.apk");
            PlatformSystem.sendEventUMeng("6e3276c197f5ec992db1f8b7c1686c29", "http://au.apk.umeng.com/uploads/apps/5590f83a67e58eb624001826/A014_%40_174_%40_0ab7b5e5467332a3640553e5bed5c0b2.apk");
          }
        ...
        for (;;)
        {
          ...
          ((Button)localObject1).setOnClickListener(new View.OnClickListener()
          {
            public void onClick(View paramAnonymous2View)
            {
              ...
              if ((this.val$url != null) && (!"".equals(this.val$url))) {
                ...
                {
                  Log.e("com.sinyee.babybus", "http://au.apk.umeng.com/uploads/apps/5590f83a67e58eb624001826/A014_%40_174_%40_0ab7b5e5467332a3640553e5bed5c0b2.apk");
                  PlatformSystem.sendEventUMeng("e7ab289f66577f39dacaefa5190e703f", "http://au.apk.umeng.com/uploads/apps/5590f83a67e58eb624001826/A014_%40_174_%40_0ab7b5e5467332a3640553e5bed5c0b2.apk");
                }
              }
              for (;;)
              {
                ...
                return;
                Log.e("com.sinyee.babybus", "http://au.apk.umeng.com/uploads/apps/5590f83a67e58eb624001826/A014_%40_174_%40_0ab7b5e5467332a3640553e5bed5c0b2.apk(offline)");
                PlatformSystem.sendEventUMeng("e7ab289f66577f39dacaefa5190e703f", "http://au.apk.umeng.com/uploads/apps/5590f83a67e58eb624001826/A014_%40_174_%40_0ab7b5e5467332a3640553e5bed5c0b2.apk(offline)");
                continue;
                if (BBNetUtil.getInstance().isNetActive(SystemBo.activity))
                {
                  Log.e("com.sinyee.babybus", this.val$key);
                  PlatformSystem.sendEventUMeng("e7ab289f66577f39dacaefa5190e703f", this.val$key);
                }
                else
                {
                  paramAnonymous2View = this.val$key + "(offline)";
                  Log.e("com.sinyee.babybus", paramAnonymous2View);
                  PlatformSystem.sendEventUMeng("e7ab289f66577f39dacaefa5190e703f", paramAnonymous2View);
                }
              }
            }
          });
          ...
          label376:
          Log.e("com.sinyee.babybus", "http://au.apk.umeng.com/uploads/apps/5590f83a67e58eb624001826/A014_%40_174_%40_0ab7b5e5467332a3640553e5bed5c0b2.apk(offline)");
          PlatformSystem.sendEventUMeng("6e3276c197f5ec992db1f8b7c1686c29", "http://au.apk.umeng.com/uploads/apps/5590f83a67e58eb624001826/A014_%40_174_%40_0ab7b5e5467332a3640553e5bed5c0b2.apk(offline)");
          break;
          label394:
          if (BBNetUtil.getInstance().isNetActive(SystemBo.activity))
          {
            Log.e("com.sinyee.babybus", paramString3);
            PlatformSystem.sendEventUMeng("6e3276c197f5ec992db1f8b7c1686c29", paramString3);
            break;
          }
          localObject2 = paramString3 + "(offline)";
          Log.e("com.sinyee.babybus", (String)localObject2);
          PlatformSystem.sendEventUMeng("6e3276c197f5ec992db1f8b7c1686c29", (String)localObject2);
          break;
          label467:
