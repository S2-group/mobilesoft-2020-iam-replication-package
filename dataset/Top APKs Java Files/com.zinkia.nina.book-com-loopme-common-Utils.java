...
public class Utils
{
  ...
  private static SimpleDateFormat sFormatter = new SimpleDateFormat("dd/MM/yy HH:mm:ss.s");
  ...
  public static List<String> getPackageInstalled(List<String> paramList)
  {
  ...
  public static String getPackageInstalledAsString(List<String> paramList)
  {
    paramList = getPackageInstalled(paramList);
    ...
    while (i < j)
    {
      ((StringBuilder)localObject).append(paramList[i]);
    ...
    Log.i(LOG_TAG, paramList);
    return paramList;
  }
  
  public static ViewGroup.LayoutParams getParamsSafety(LoopMeBannerGeneral paramLoopMeBannerGeneral)
  {
    try
    {
      paramLoopMeBannerGeneral = paramLoopMeBannerGeneral.getBannerView().getLayoutParams();
      return paramLoopMeBannerGeneral;
    }
    catch (NullPointerException paramLoopMeBannerGeneral)
    {
  ...
  public static float getSystemVolume()
  {
    if (sAudioManager != null) {
      return Math.round(sAudioManager.getStreamVolume(3) * 100 / sAudioManager.getStreamMaxVolume(3)) / 100.0F;
    }
    return 1.0F;
  }
  ...
  public static String makeChromeShortCut(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      if (paramString.contains("Chrome")) {
        str = paramString.replace("Chrome", "Chrm");
      }
    }
    return str;
  }
  
  public static void setAdIdOrAppKey(Intent paramIntent, BaseAd paramBaseAd)
  {
    if ((paramIntent == null) || (paramBaseAd == null)) {
      return;
    }
    paramIntent.putExtra("adid", paramBaseAd.getAdId());
  }
  
  public static void setCacheDirectory(Context paramContext)
  {
    if (TextUtils.isEmpty(StaticParams.sCacheDirectory)) {
      StaticParams.sCacheDirectory = paramContext.getFilesDir().getAbsolutePath();
    }
  }
}
