...
public class a
{
  ...
  private a()
  {
    ...
    try
    {
      ...
      localObject = com.ihs.app.framework.a.a().getPackageManager();
      Iterator localIterator = ((PackageManager)localObject).getInstalledApplications(128).iterator();
      while (localIterator.hasNext())
      {
        ApplicationInfo localApplicationInfo = (ApplicationInfo)localIterator.next();
        if (a(localApplicationInfo, (PackageManager)localObject)) {
          this.a.add(new a(localApplicationInfo, (PackageManager)localObject));
        }
      }
