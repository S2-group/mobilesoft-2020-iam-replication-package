...
import com.cyou.elegant.ˆ;
import com.cyou.elegant.ˎ;
import java.io.File;
  ...
  extends IntentService
{
  ...
  private void ʻ()
  {
    ...
    Object localObject1 = ˆ.ʼ(this, true);
    ...
    for (localObject1 = new File(localThemeInfoModel.ˊ);; localObject1 = null)
    {
      ...
      {
        localObject2 = ˆ.ʻ(this, localThemeInfoModel.ᴵ, localThemeInfoModel.ˊ);
      }
  ...
  {
    String str = com.cyou.elegant.util.ˈ.ʾ(this);
    ArrayList localArrayList = new ArrayList();
    ...
    ʼ.ʻ(this, ˎ.ʻ().ʻ(this, false, 291), (ContentValues[])localArrayList.toArray(new ContentValues[0]));
  }
  ...
  protected void onHandleIntent(Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      paramIntent = new File(ˆ.ʻ(this, ".ThemeResources"), "theme.bp");
      ʻ();
      ʼ();
      ˆ.ʻ(ʼ.ʻ(this, null, null), paramIntent);
