...
public class TapjoyConnectCore
{
  ...
  private void checkAdvertisingID()
  {
    // Byte code:
    //   0: ldc_w 356
    //   3: invokestatic 362	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   6: astore_1
    //   7: ldc 14
    ...
    //   41: invokevirtual 367	android/content/Context:getPackageName	()Ljava/lang/String;
    //   44: sipush 128
    //   47: invokevirtual 373	android/content/pm/PackageManager:getApplicationInfo	(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    //   50: getfield 379	android/content/pm/ApplicationInfo:metaData	Landroid/os/Bundle;
    //   53: ldc_w 381
    //   56: invokevirtual 387	android/os/Bundle:getInt	(Ljava/lang/String;)I
    //   59: pop
    //   60: return
    //   61: astore_1
    ...
    //   65: dup
    //   66: ldc_w 389
    //   69: invokespecial 392	com/tapjoy/TapjoyIntegrationException:<init>	(Ljava/lang/String;)V
    //   72: athrow
    //   73: astore_1
    //   74: new 224	com/tapjoy/TapjoyIntegrationException
    //   77: dup
    //   78: ldc_w 394
    //   81: invokespecial 392	com/tapjoy/TapjoyIntegrationException:<init>	(Ljava/lang/String;)V
    //   84: athrow
  ...
  public String getSerial()
  {
    ...
    //   3: invokestatic 362	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   6: ldc_w 1496
    //   9: invokevirtual 1500	java/lang/Class:getDeclaredField	(Ljava/lang/String;)Ljava/lang/reflect/Field;
    //   12: astore_1
    //   13: aload_1
    //   14: invokevirtual 1505	java/lang/reflect/Field:isAccessible	()Z
    //   17: ifne +8 -> 25
    //   20: aload_1
    //   21: iconst_1
    //   22: invokevirtual 1508	java/lang/reflect/Field:setAccessible	(Z)V
    //   25: aload_1
    //   26: ldc_w 1102
    //   29: invokevirtual 1509	java/lang/reflect/Field:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   32: invokevirtual 610	java/lang/Object:toString	()Ljava/lang/String;
    //   35: astore_1
    //   36: ldc 14
    ...
    //   66: ldc 14
    //   68: aload_2
    //   69: invokevirtual 478	java/lang/Exception:toString	()Ljava/lang/String;
    //   72: invokestatic 480	com/tapjoy/TapjoyLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   75: aload_1
    //   76: areturn
    //   77: astore_2
    //   78: goto -12 -> 66
