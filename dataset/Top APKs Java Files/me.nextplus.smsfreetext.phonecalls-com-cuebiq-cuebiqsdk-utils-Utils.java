...
public class Utils
{
  ...
  public static List<com.cuebiq.cuebiqsdk.model.wrapper.BluetoothDevice> getPairedDevices()
  {
    ...
    try
    {
      ...
      if (localObject != null)
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          android.bluetooth.BluetoothDevice localBluetoothDevice = (android.bluetooth.BluetoothDevice)((Iterator)localObject).next();
          ...
          if (localBluetoothDevice.getName() != null)
          {
            if (localBluetoothDevice.getBluetoothClass() != null)
            {
              ...
              localBluetoothDevice1.setAddress(localBluetoothDevice.getAddress());
