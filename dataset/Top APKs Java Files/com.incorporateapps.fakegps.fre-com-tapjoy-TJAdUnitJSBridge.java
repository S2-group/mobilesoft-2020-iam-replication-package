  ...
  implements TJWebViewJSInterfaceListener
{
  ...
  public void alert(JSONObject paramJSONObject, String paramString)
  {
    ...
    //   11: aload_1
    //   12: invokevirtual 159	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   15: invokevirtual 163	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   18: invokestatic 165	com/tapjoy/TapjoyLog:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   21: ldc -89
    //   23: astore 6
    //   25: aload_1
    //   26: ldc -87
    ...
    //   37: aload_1
    //   38: ldc -79
    //   40: invokevirtual 175	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   43: astore 7
    //   45: aload 7
    //   47: astore 6
    //   49: aload_1
    //   50: ldc -77
    //   52: invokevirtual 183	org/json/JSONObject:getJSONArray	(Ljava/lang/String;)Lorg/json/JSONArray;
    //   55: astore_1
    //   56: aload_0
    //   57: getfield 141	com/tapjoy/TJAdUnitJSBridge:e	Lcom/tapjoy/TJAdUnitActivity;
    //   60: astore 7
    //   62: aload 7
    //   64: ifnull +224 -> 288
    //   67: new 185	android/app/AlertDialog$Builder
    //   70: dup
    //   71: aload 7
    //   73: invokespecial 188	android/app/AlertDialog$Builder:<init>	(Landroid/content/Context;)V
    //   76: aload 5
    //   78: invokevirtual 192	android/app/AlertDialog$Builder:setTitle	(Ljava/lang/CharSequence;)Landroid/app/AlertDialog$Builder;
    //   81: aload 6
    //   83: invokevirtual 195	android/app/AlertDialog$Builder:setMessage	(Ljava/lang/CharSequence;)Landroid/app/AlertDialog$Builder;
    //   86: invokevirtual 199	android/app/AlertDialog$Builder:create	()Landroid/app/AlertDialog;
    //   89: astore 5
    //   91: aload_1
    //   92: ifnull +10 -> 102
    //   95: aload_1
    //   96: invokevirtual 205	org/json/JSONArray:length	()I
    //   99: ifne +56 -> 155
    //   102: aload_0
    //   103: aload_2
    //   104: iconst_1
    ...
    //   108: dup
    //   109: iconst_0
    //   110: getstatic 211	java/lang/Boolean:FALSE	Ljava/lang/Boolean;
    //   113: aastore
    //   114: invokevirtual 215	com/tapjoy/TJAdUnitJSBridge:invokeJSCallback	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   117: return
    //   118: astore_1
    //   119: ldc -89
    //   121: astore 7
    ...
    //   137: dup
    //   138: iconst_0
    //   139: getstatic 211	java/lang/Boolean:FALSE	Ljava/lang/Boolean;
    //   142: aastore
    //   143: invokevirtual 215	com/tapjoy/TJAdUnitJSBridge:invokeJSCallback	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   146: aload_1
    //   147: invokevirtual 218	java/lang/Exception:printStackTrace	()V
    //   150: aconst_null
    //   151: astore_1
    //   152: goto -96 -> 56
    //   155: new 220	java/util/ArrayList
    //   158: dup
    //   159: invokespecial 221	java/util/ArrayList:<init>	()V
    //   162: astore 6
    //   164: iconst_0
    //   165: istore 4
    //   167: iload 4
    //   169: aload_1
    //   170: invokevirtual 205	org/json/JSONArray:length	()I
    ...
    //   204: aload_1
    //   205: iload 4
    //   207: invokevirtual 224	org/json/JSONArray:getString	(I)Ljava/lang/String;
    //   210: invokevirtual 228	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   213: pop
    //   214: aload 5
    //   216: iload_3
    //   217: aload 6
    //   219: iload 4
    //   221: invokevirtual 232	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   224: checkcast 234	java/lang/CharSequence
    //   227: new 236	com/tapjoy/TJAdUnitJSBridge$1
    //   230: dup
    //   231: aload_0
    //   232: aload_2
    //   233: invokespecial 239	com/tapjoy/TJAdUnitJSBridge$1:<init>	(Lcom/tapjoy/TJAdUnitJSBridge;Ljava/lang/String;)V
    //   236: invokevirtual 245	android/app/AlertDialog:setButton	(ILjava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)V
    //   239: iload 4
    //   241: iconst_1
    //   242: iadd
    //   243: istore 4
    ...
    //   260: astore 7
    //   262: aload 7
    //   264: invokevirtual 218	java/lang/Exception:printStackTrace	()V
    //   267: goto -53 -> 214
    //   270: aload 5
    //   272: iconst_0
    //   273: invokevirtual 248	android/app/AlertDialog:setCancelable	(Z)V
    //   276: aload 5
    //   278: iconst_0
    //   279: invokevirtual 251	android/app/AlertDialog:setCanceledOnTouchOutside	(Z)V
    //   282: aload 5
    //   284: invokevirtual 254	android/app/AlertDialog:show	()V
    //   287: return
    //   288: ldc 70
    //   290: ldc_w 256
    //   293: invokestatic 165	com/tapjoy/TapjoyLog:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   296: return
    //   297: astore_1
    //   298: goto -167 -> 131
  ...
  {
    if (this.f != null) {
      this.f.clearVideo(new TJAdUnitJSBridge.13(this, paramString));
    }
  }
  ...
  public void dismissSplitView(JSONObject paramJSONObject, String paramString)
  {
    TapjoyUtil.runOnMainThread(new TJAdUnitJSBridge.6(this, paramString));
  }
    ...
    catch (Exception localException1)
    {
      ...
      catch (Exception localException2)
      {
        do
        {
          ...
          if (bool)
          {
            ((Activity)this.d).runOnUiThread(new TJAdUnitJSBridge.8(this, paramJSONObject));
            return;
          }
  ...
  public void displayURL(JSONObject paramJSONObject, String paramString)
  {
    try
    {
      ...
      JSONObject localJSONObject = paramJSONObject.optJSONObject("splitViewLayout");
      paramJSONObject = paramJSONObject.optJSONArray("splitViewExitHosts");
      if ("split".equals(str1))
      {
        TapjoyUtil.runOnMainThread(new TJAdUnitJSBridge.9(this, localJSONObject, paramJSONObject, paramString, str2));
        return;
      }
  ...
  public void displayVideo(JSONObject paramJSONObject, String paramString)
  {
    try
    {
      ...
      {
        this.f.loadVideoUrl(paramJSONObject, new TJAdUnitJSBridge.12(this, paramString));
        return;
      }
      invokeJSCallback(paramString, new Object[] { Boolean.FALSE });
      return;
  ...
  public void getSplitViewURL(JSONObject paramJSONObject, String paramString)
  {
    TapjoyUtil.runOnMainThread(new TJAdUnitJSBridge.7(this, paramString));
  }
  ...
  public void hasSplitView(JSONObject paramJSONObject, String paramString)
  {
    TapjoyUtil.runOnMainThread(new TJAdUnitJSBridge.5(this, paramString));
  }
  ...
  {
    TapjoyUtil.runOnMainThread(new TJAdUnitJSBridge.14(this, paramJSONObject, paramString));
  }
  ...
  public void present(JSONObject paramJSONObject, String paramString)
  {
    // Byte code:
    //   0: iconst_0
    //   1: invokestatic 276	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   4: astore_3
    //   5: aload_1
    //   6: ldc_w 873
    //   9: invokevirtual 175	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   12: invokestatic 876	java/lang/Boolean:valueOf	(Ljava/lang/String;)Ljava/lang/Boolean;
    //   15: astore 5
    //   17: aload_1
    //   18: ldc_w 878
    //   21: invokevirtual 175	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   24: invokestatic 876	java/lang/Boolean:valueOf	(Ljava/lang/String;)Ljava/lang/Boolean;
    //   27: astore 4
    //   29: aload 4
    //   31: astore_3
    //   32: aload_0
    //   33: aload_1
    //   34: ldc_w 879
    //   37: invokevirtual 175	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   40: invokestatic 876	java/lang/Boolean:valueOf	(Ljava/lang/String;)Ljava/lang/Boolean;
    //   43: invokevirtual 882	java/lang/Boolean:booleanValue	()Z
    //   46: putfield 59	com/tapjoy/TJAdUnitJSBridge:customClose	Z
    //   49: new 884	com/tapjoy/TJAdUnitJSBridge$a
    //   52: dup
    //   53: aload_0
    //   54: aload_0
    //   55: getfield 81	com/tapjoy/TJAdUnitJSBridge:g	Landroid/webkit/WebView;
    //   58: invokespecial 887	com/tapjoy/TJAdUnitJSBridge$a:<init>	(Lcom/tapjoy/TJAdUnitJSBridge;Landroid/webkit/WebView;)V
    //   61: iconst_2
    //   62: anewarray 207	java/lang/Boolean
    //   65: dup
    //   66: iconst_0
    //   67: aload 5
    //   69: aastore
    ...
    //   72: aload_3
    //   73: aastore
    //   74: invokevirtual 891	com/tapjoy/TJAdUnitJSBridge$a:execute	([Ljava/lang/Object;)Landroid/os/AsyncTask;
    //   77: pop
    //   78: aload_0
    //   79: aload_2
    //   80: iconst_1
    ...
    //   89: aastore
    //   90: invokevirtual 215	com/tapjoy/TJAdUnitJSBridge:invokeJSCallback	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   93: return
    //   94: astore_1
    //   95: aload_0
    //   96: aload_2
    ...
    //   101: dup
    //   102: iconst_0
    //   103: getstatic 211	java/lang/Boolean:FALSE	Ljava/lang/Boolean;
    //   106: aastore
    //   107: invokevirtual 215	com/tapjoy/TJAdUnitJSBridge:invokeJSCallback	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   110: aload_1
    //   111: invokevirtual 218	java/lang/Exception:printStackTrace	()V
    //   114: return
    //   115: astore_1
    //   116: goto -67 -> 49
    //   119: astore 4
  ...
  public void setBackgroundColor(JSONObject paramJSONObject, String paramString)
  {
    try
    {
      ...
      if (this.f != null)
      {
        this.f.setBackgroundColor(paramJSONObject, new TJAdUnitJSBridge.10(this, paramString));
        return;
      }
    }
    catch (Exception paramJSONObject)
  ...
  public void setBackgroundWebViewContent(JSONObject paramJSONObject, String paramString)
  {
    ...
    try
    {
      ...
      if (this.f != null)
      {
        this.f.setBackgroundContent(paramJSONObject, new TJAdUnitJSBridge.11(this, paramString));
        return;
      }
    }
    catch (Exception paramJSONObject)
  ...
  public void setCloseButtonVisible(JSONObject paramJSONObject, String paramString)
  {
    try
    {
      TapjoyUtil.runOnMainThread(new TJAdUnitJSBridge.15(this, paramJSONObject.getBoolean("visible")));
      invokeJSCallback(paramString, new Object[] { Boolean.valueOf(true) });
      return;
    }
    catch (Exception paramJSONObject)
  ...
  public void startMoatVideoTracker(JSONObject paramJSONObject, String paramString)
  {
    try
    {
      ...
      this.n.post(new TJAdUnitJSBridge.3(this, localHashMap, Integer.valueOf(i1), paramString));
    }
    catch (Exception paramJSONObject)
    {
  ...
  public void triggerMoatVideoEvent(JSONObject paramJSONObject, String paramString)
  {
    try
    {
      ...
      this.n.post(new TJAdUnitJSBridge.4(this, paramJSONObject));
      invokeJSCallback(paramString, new Object[] { Boolean.valueOf(true) });
      return;
    }
    catch (Exception paramJSONObject)
