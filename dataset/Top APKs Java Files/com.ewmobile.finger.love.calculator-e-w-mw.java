...
public class mw
{
  public static int a()
  {
    try
    {
      int i = jz.a.getPackageManager().getPackageInfo(jz.a.getPackageName(), 0).versionCode;
      return i;
    }
    catch (Exception localException)
    {
      lx.a("Get Version Code Error!!!", localException);
    }
    return -1;
  }
  ...
  {
    paramString = jg.a().f(paramString);
  ...
  public static boolean b()
  {
    ...
    if (jz.a.checkCallingOrSelfPermission("android.permission.ACCESS_NETWORK_STATE") == 0)
    {
      localNetworkInfo = ((ConnectivityManager)jz.a.getSystemService("connectivity")).getActiveNetworkInfo();
  ...
  public static boolean b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramString = jz.a.getPackageManager().getPackageInfo(paramString, 0);
        if (paramString == null) {
          continue;
        }
        return true;
  ...
  public static int c(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        lx.a("Get Meta_Data Info error:", paramString);
      }
    }
    return -1;
  }
  ...
  public static String c()
  {
    ...
    switch (((TelephonyManager)jz.a.getSystemService("phone")).getNetworkType())
    {
    case 13: 
    default: 
      return "4g";
  ...
  {
    return (jz.a.getResources().getConfiguration().screenLayout & 0xF) >= 3;
  }
  
  private static int e()
  {
    Object localObject = (ConnectivityManager)jz.a.getSystemService("connectivity");
    if (localObject == null) {
      return -1;
    }
