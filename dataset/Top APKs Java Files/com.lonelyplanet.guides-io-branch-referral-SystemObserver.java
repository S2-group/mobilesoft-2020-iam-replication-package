...
class SystemObserver
{
  ...
  public String a(String paramString)
  {
    ...
    //   17: astore_2
    //   18: aload_0
    //   19: invokespecial 53	io/branch/referral/SystemObserver:s	()Z
    //   22: ifne +125 -> 147
    //   25: aload_0
    //   26: getfield 15	io/branch/referral/SystemObserver:a	Landroid/content/Context;
    ...
    //   101: aload_2
    //   102: astore 4
    //   104: new 96	io/branch/referral/ApkParser
    //   107: dup
    //   108: invokespecial 97	io/branch/referral/ApkParser:<init>	()V
    //   111: aload 6
    //   113: invokevirtual 100	io/branch/referral/ApkParser:a	([B)Ljava/lang/String;
    //   116: astore 6
    //   118: aload 6
    //   120: astore_3
    //   121: aload_2
  ...
  {
    Object localObject = PrefHelper.a(this.a);
    String str = d();
    if ("bnc_no_value".equals(((PrefHelper)localObject).e()))
    {
      if (paramBoolean) {
        ((PrefHelper)localObject).a(str);
      }
      ...
      else
      {
        try
        {
          ...
          for (localObject = null;; localObject = ((CharSequence)localObject).toString())
          {
            ...
            if (localObject != null)
            {
              localJSONObject.put(Defines.Jsonkey.I.a(), localObject);
              localObject = a((String)localObject);
              if (!((String)localObject).equals("bnc_no_value")) {
                localJSONObject.put(Defines.Jsonkey.H.a(), localObject);
              }
            }
            ...
            localJSONObject.put(Defines.Jsonkey.A.a(), l());
