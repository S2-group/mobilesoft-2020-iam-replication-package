...
public class ConfigurationLogic
  extends BaseLogic
{
  private static ConfigurationLogic D;
  ...
  private HashMap<String, MetaData> E;
  private ConfigurationLogic.OnConfigurationFileSetListener F;
  ...
  public void checkAppTurbo(Activity paramActivity, boolean paramBoolean)
  {
    try
    {
      ...
      if ((bool2) && (bool1) && (!bool3) && (a(paramActivity)))
      {
        ...
        localBuilder.setMessage(paramActivity.getString(2131165730));
        localBuilder.setCancelable(false);
        localBuilder.setPositiveButton(paramActivity.getString(2131165517), new d(this, paramBoolean, paramActivity));
        localBuilder.show();
      }
      return;
    }
  ...
  {
    if (this.E == null) {
      this.E = ((HashMap)FilesUtils.loadConfigurationMetaDataMapFromFile());
    }
    if ((this.E != null) && (this.E.containsKey(paramString))) {
      return (MetaData)this.E.get(paramString);
    }
    return null;
  }
  ...
  {
    this.F = paramOnConfigurationFileSetListener;
  }
  ...
  public void setMetadata(MetaData[] paramArrayOfMetaData)
  {
    ...
    while (i1 < i2)
    {
      ...
      this.E.put(localMetaData.getPackageName(), localMetaData);
      i1 += 1;
    }
    FilesUtils.saveConfigurationMetaDataMapToFile(this.E);
  }
  ...
  public boolean showLoginInWelcome(Context paramContext)
  {
    MetaData localMetaData = getAppMetaData(paramContext.getPackageName());
    if (localMetaData != null) {
      return localMetaData.getShowLoginInWelcome().booleanValue();
    }
    return !PackageLogic.getInstance().isDialerApp(paramContext.getPackageName());
  }
  
  public boolean showMissedCallNotificationAlways()
  {
    return FilesUtils.getBooleanFromPreferences("show_missed_call_notif_always", false);
  }
  
  public boolean showPriceOnProButton()
  {
    return FilesUtils.getBooleanFromPreferences("show_price_on_pro_button", true);
  }
}
