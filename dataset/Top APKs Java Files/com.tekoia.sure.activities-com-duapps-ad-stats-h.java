...
public class h
{
  ...
  public com.duapps.ad.base.h a(String paramString)
  {
    ...
    //   119: putfield 79	com/duapps/ad/base/h:a	Ljava/lang/String;
    //   122: aload_1
    //   123: astore 4
    //   125: aload 6
    //   127: aload_1
    ...
    //   134: putfield 111	com/duapps/ad/base/h:b	Ljava/lang/String;
    //   137: aload_1
    //   138: astore 4
    //   140: aload 6
    //   142: aload_1
    ...
    //   149: putfield 113	com/duapps/ad/base/h:d	Ljava/lang/String;
    //   152: aload_1
    //   153: astore 4
    //   155: aload 6
    //   157: aload_1
    ...
    //   164: putfield 83	com/duapps/ad/base/h:c	I
    //   167: goto +8 -> 175
    //   170: astore 5
    //   172: goto +30 -> 202
    //   175: aload_1
    ...
    //   207: ldc 122
    //   209: aload 5
    //   211: invokestatic 72	com/duapps/ad/base/LogHelper:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   214: aload_1
    //   215: ifnull +18 -> 233
    //   218: aload_1
    ...
    //   7	227	6	localH	com.duapps.ad.base.h
    // Exception table:
    //   from	to	target	type
  ...
  public void a(e paramE)
  {
    ...
    ((ContentValues)localObject).put("pkg", com.duapps.ad.internal.utils.e.a(paramE.b()));
  ...
  /* Error */
  public java.util.List<com.duapps.ad.entity.d> b()
  {
    // Byte code:
    //   0: ldc -23
    //   2: iconst_2
    ...
    //   61: lstore_3
    //   62: new 207	java/lang/StringBuilder
    //   65: dup
    //   66: invokespecial 208	java/lang/StringBuilder:<init>	()V
    //   69: astore 8
    //   71: aload 8
    //   73: aload 7
    //   75: invokevirtual 214	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   78: pop
    //   79: aload 8
    //   81: ldc -9
    //   83: invokevirtual 214	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   86: pop
    //   87: aload 8
    //   89: invokevirtual 220	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   92: astore 8
    ...
    //   246: astore 6
    //   248: aload 5
    //   250: invokeinterface 259 1 0
    //   255: pop
    //   256: aload 5
    //   258: astore 6
    //   260: aload 7
    //   262: new 261	com/duapps/ad/entity/d
    //   265: dup
    //   266: aload 5
    //   268: iconst_0
    ...
    //   290: invokespecial 264	com/duapps/ad/entity/d:<init>	(Ljava/lang/String;II)V
    //   293: invokeinterface 270 2 0
    //   298: pop
    //   299: iload_2
    //   300: iconst_1
    //   301: iadd
    ...
    //   373: aload 5
    //   375: astore 6
    //   377: new 207	java/lang/StringBuilder
    //   380: dup
    //   381: invokespecial 208	java/lang/StringBuilder:<init>	()V
    //   384: astore 8
    //   386: aload 5
    //   388: astore 6
    //   390: aload 8
    ...
    //   403: aload 8
    //   405: aload 7
    //   407: invokevirtual 227	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   410: pop
    //   411: aload 5
    //   413: astore 6
    //   415: ldc 65
    ...
    //   422: invokestatic 222	com/duapps/ad/base/LogHelper:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   425: aload 5
    //   427: ifnull +16 -> 443
    //   430: aload 5
  ...
  public void b(Context paramContext)
  {
    ...
    //   3: dup
    //   4: invokespecial 250	java/util/ArrayList:<init>	()V
    //   7: astore 6
    //   9: iconst_0
    //   10: istore_2
    //   11: aload_0
    ...
    //   72: astore 4
    //   74: aload 5
    //   76: invokestatic 280	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   79: ifne +24 -> 103
    //   82: aload_3
    //   83: astore 4
    //   85: aload 6
    //   87: aload 5
    //   89: invokeinterface 270 2 0
    //   94: pop
    //   95: goto +8 -> 103
    //   98: astore 5
    //   100: goto +30 -> 130
    ...
    //   161: aload 6
    //   163: invokeinterface 283 1 0
    //   168: ifle +335 -> 503
    //   171: new 249	java/util/ArrayList
    //   174: dup
    //   175: invokespecial 250	java/util/ArrayList:<init>	()V
    //   178: astore_3
    //   179: aload_1
    //   180: invokevirtual 287	android/content/Context:getPackageManager	()Landroid/content/pm/PackageManager;
    //   183: astore_1
    //   184: aload_1
    //   185: ifnull +102 -> 287
    //   188: aload_1
    //   189: sipush 256
    //   192: invokevirtual 293	android/content/pm/PackageManager:getInstalledPackages	(I)Ljava/util/List;
    //   195: astore_1
    //   196: aload 6
    //   198: invokeinterface 297 1 0
    //   203: astore 4
    //   205: aload 4
    //   207: invokeinterface 302 1 0
    //   212: ifeq +75 -> 287
    //   215: aload 4
    //   217: invokeinterface 306 1 0
    //   222: checkcast 51	java/lang/String
    //   225: astore 5
    //   227: aload_1
    //   228: invokeinterface 297 1 0
    //   233: astore 6
    //   235: aload 6
    ...
    //   252: checkcast 308	android/content/pm/PackageInfo
    //   255: astore 7
    //   257: aload 7
    //   259: ifnull -24 -> 235
    //   262: aload 7
    //   264: getfield 311	android/content/pm/PackageInfo:packageName	Ljava/lang/String;
    //   267: aload 5
    //   269: invokevirtual 314	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   272: ifeq -37 -> 235
    //   275: aload_3
    //   276: aload 5
    //   278: invokeinterface 270 2 0
    //   283: pop
    //   284: goto -49 -> 235
    //   287: aload_3
    //   288: invokeinterface 283 1 0
    //   293: ifle +210 -> 503
    //   296: ldc_w 316
    //   299: astore_1
    //   300: iload_2
    //   301: aload_3
    //   302: invokeinterface 283 1 0
    //   307: if_icmpge +125 -> 432
    //   310: aload_3
    //   311: iload_2
    //   312: invokeinterface 320 2 0
    //   317: checkcast 51	java/lang/String
    //   320: astore 4
    //   322: iload_2
    //   323: ifne +54 -> 377
    //   326: new 207	java/lang/StringBuilder
    //   329: dup
    //   330: invokespecial 208	java/lang/StringBuilder:<init>	()V
    //   333: astore 5
    //   335: aload 5
    //   337: aload_1
    //   338: invokevirtual 214	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   341: pop
    //   342: aload 5
    //   344: ldc_w 322
    //   347: invokevirtual 214	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   350: pop
    //   351: aload 5
    //   353: aload 4
    ...
    //   367: pop
    //   368: aload 5
    //   370: invokevirtual 220	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   373: astore_1
    //   374: goto +51 -> 425
    //   377: new 207	java/lang/StringBuilder
    //   380: dup
    ...
    //   386: aload 5
    //   388: aload_1
    //   389: invokevirtual 214	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   392: pop
    //   393: aload 5
    //   395: ldc_w 324
    //   398: invokevirtual 214	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   401: pop
    //   402: aload 5
    //   404: aload 4
    //   406: invokevirtual 214	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   409: pop
    //   410: aload 5
    //   412: ldc_w 322
    //   415: invokevirtual 214	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   418: pop
    //   419: aload 5
    //   421: invokevirtual 220	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   424: astore_1
    //   425: iload_2
    //   426: iconst_1
    //   427: iadd
    //   428: istore_2
    //   429: goto -129 -> 300
    //   432: new 207	java/lang/StringBuilder
    //   435: dup
    //   436: invokespecial 208	java/lang/StringBuilder:<init>	()V
    //   439: astore_3
    //   440: aload_3
    //   441: aload_1
    //   442: invokevirtual 214	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   445: pop
    //   446: aload_3
    //   447: ldc_w 326
    //   450: invokevirtual 214	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   453: pop
    //   454: aload_3
    //   455: invokevirtual 220	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   458: astore_1
    //   459: aload_0
  ...
  public int c(String paramString)
  {
    ...
    //   4: invokestatic 130	com/duapps/ad/base/k:I	(Landroid/content/Context;)J
    //   7: lstore 5
    //   9: iconst_0
    //   10: istore 4
    //   12: iconst_0
  ...
  public com.duapps.ad.base.h d(String paramString)
  {
    ...
    //   25: invokestatic 130	com/duapps/ad/base/k:I	(Landroid/content/Context;)J
    //   28: lstore_2
    ...
    //   129: putfield 79	com/duapps/ad/base/h:a	Ljava/lang/String;
    //   132: aload_1
    //   133: astore 6
    //   135: aload 8
    //   137: aload_1
    ...
    //   144: putfield 111	com/duapps/ad/base/h:b	Ljava/lang/String;
    //   147: aload_1
    //   148: astore 6
    //   150: aload 8
    //   152: aload_1
    ...
    //   159: putfield 113	com/duapps/ad/base/h:d	Ljava/lang/String;
    //   162: aload_1
    //   163: astore 6
    //   165: aload 8
    //   167: aload_1
    ...
    //   174: putfield 83	com/duapps/ad/base/h:c	I
    //   177: goto +8 -> 185
    //   180: astore 7
    //   182: goto +30 -> 212
    //   185: aload_1
    ...
    //   217: ldc 122
    //   219: aload 7
    //   221: invokestatic 72	com/duapps/ad/base/LogHelper:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   224: aload_1
    //   225: ifnull +18 -> 243
    //   228: aload_1
    ...
    //   7	237	8	localH	com.duapps.ad.base.h
    // Exception table:
    //   from	to	target	type
