...
{
  @TargetApi(18)
  public static com.forter.mobile.fortersdk.e.l a(Context paramContext, long paramLong, int paramInt)
  {
    if (l.j() < 18) {
      paramContext = new com.forter.mobile.fortersdk.e.l();
    }
  ...
  public static String a(Context paramContext)
  {
    ...
    //   2: monitorenter
    //   3: aload_0
    //   4: invokestatic 172	android/preference/PreferenceManager:getDefaultSharedPreferences	(Landroid/content/Context;)Landroid/content/SharedPreferences;
    //   7: astore_2
    //   8: new 174	java/lang/StringBuilder
    //   11: dup
    //   12: invokespecial 175	java/lang/StringBuilder:<init>	()V
    //   15: astore_1
    //   16: aload_1
    //   17: aload_0
    //   18: invokestatic 178	com/forter/mobile/fortersdk/utils/m:f	(Landroid/content/Context;)Ljava/lang/String;
    //   21: invokevirtual 182	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   24: pop
    //   25: aload_1
    //   26: ldc -72
    //   28: invokevirtual 182	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   31: pop
    //   32: aload_1
    //   33: invokevirtual 185	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   36: astore_3
    //   37: aload_0
    //   38: invokestatic 187	com/forter/mobile/fortersdk/utils/m:b	(Landroid/content/Context;)Ljava/lang/String;
    //   41: astore_1
    //   42: aload_1
    //   43: astore_0
    //   44: aload_1
    //   45: ifnonnull +32 -> 77
    //   48: invokestatic 163	java/util/UUID:randomUUID	()Ljava/util/UUID;
    //   51: invokevirtual 165	java/util/UUID:toString	()Ljava/lang/String;
    //   54: astore_0
    //   55: aload_2
    ...
    //   63: aload_3
    //   64: aload_0
    //   65: invokeinterface 199 3 0
    //   70: pop
    //   71: aload_1
    //   72: invokeinterface 202 1 0
    //   77: ldc 2
    //   79: monitorexit
    //   80: aload_0
    //   81: areturn
  ...
  public static String a(String paramString, JSONObject paramJSONObject)
  {
    ...
    {
      a.a("Utils", "Failed to parse JSON as querystring ", paramJSONObject);
    }
    return paramString;
  }
  ...
  public static String c(String paramString)
  {
    ...
    {
      a.a("Utils", "Sha1Base64 failure", paramString);
    }
    return null;
  }
