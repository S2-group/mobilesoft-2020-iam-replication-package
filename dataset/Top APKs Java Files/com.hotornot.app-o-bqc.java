...
public class bqc
{
  ...
  {
    return ZG.o(paramContext).equals("com.sec.android.app.launcher");
  }
  
  public static void b(Context paramContext)
  {
    Object localObject = (Zy)AppServicesProvider.d(BadooAppServices.z);
    if ((((Zy)localObject).e("app_shortcut_creation_triggered", false)) || (!a(paramContext))) {
      return;
    }
    ((Zy)localObject).a("app_shortcut_creation_triggered", true);
    localObject = paramContext.getResources().getString(2131822806);
    if (!e(paramContext, (String)localObject))
    {
      ...
      localIntent2.putExtra("android.intent.extra.shortcut.ICON_RESOURCE", Intent.ShortcutIconResource.fromContext(paramContext, 2131623936));
  ...
  private static String e(Context paramContext)
  {
    ...
    if ((localObject1 != null) && (((ResolveInfo)localObject1).activityInfo != null) && (!bsK.d(((ResolveInfo)localObject1).activityInfo.packageName)))
    {
  ...
  private static boolean e(Context paramContext, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        paramContext = paramContext.getContentResolver().query(Uri.parse("content://" + e(paramContext) + "/favorites?notify=false"), new String[] { "title" }, "title=?", new String[] { paramString }, null);
        if (paramContext != null)
        {
          bool2 = bool3;
