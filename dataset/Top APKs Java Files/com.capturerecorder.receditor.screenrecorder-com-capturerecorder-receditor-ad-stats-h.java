package com.capturerecorder.receditor.ad.stats;

import android.content.ContentResolver;
import android.content.ContentValues;
import android.content.Context;
import com.capturerecorder.receditor.ad.base.LogHelper;
import com.capturerecorder.receditor.ad.base.k;
...
public class h
{
  ...
  /* Error */
  public com.capturerecorder.receditor.ad.base.h a(String paramString)
  {
    // Byte code:
    //   0: new 75	com/capturerecorder/receditor/ad/base/h
    //   3: dup
    //   4: invokespecial 76	com/capturerecorder/receditor/ad/base/h:<init>	()V
    //   7: astore 6
    //   9: aload 6
    //   11: aload_1
    //   12: putfield 79	com/capturerecorder/receditor/ad/base/h:a	Ljava/lang/String;
    //   15: aload 6
    //   17: iconst_0
    //   18: putfield 83	com/capturerecorder/receditor/ad/base/h:c	I
    //   21: invokestatic 38	java/lang/System:currentTimeMillis	()J
    //   24: lstore_2
    //   25: aload_0
    //   26: getfield 15	com/capturerecorder/receditor/ad/stats/h:a	Landroid/content/Context;
    //   29: invokevirtual 42	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   32: aload_0
    //   33: getfield 15	com/capturerecorder/receditor/ad/stats/h:a	Landroid/content/Context;
    //   36: iconst_1
    //   37: invokestatic 47	com/capturerecorder/receditor/ad/stats/DuAdCacheProvider:a	(Landroid/content/Context;I)Landroid/net/Uri;
    //   40: iconst_4
    ...
    //   119: putfield 79	com/capturerecorder/receditor/ad/base/h:a	Ljava/lang/String;
    //   122: aload_1
    //   123: astore 4
    //   125: aload 6
    //   127: aload_1
    ...
    //   134: putfield 111	com/capturerecorder/receditor/ad/base/h:b	Ljava/lang/String;
    //   137: aload_1
    //   138: astore 4
    //   140: aload 6
    //   142: aload_1
    ...
    //   149: putfield 113	com/capturerecorder/receditor/ad/base/h:d	Ljava/lang/String;
    //   152: aload_1
    //   153: astore 4
    //   155: aload 6
    //   157: aload_1
    ...
    //   164: putfield 83	com/capturerecorder/receditor/ad/base/h:c	I
    //   167: goto +8 -> 175
    //   170: astore 5
    //   172: goto +30 -> 202
    //   175: aload_1
    ...
    //   207: ldc 122
    //   209: aload 5
    //   211: invokestatic 72	com/capturerecorder/receditor/ad/base/LogHelper:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   214: aload_1
    //   215: ifnull +18 -> 233
    //   218: aload_1
    ...
    //   7	227	6	localH	com.capturerecorder.receditor.ad.base.h
    // Exception table:
    //   from	to	target	type
  ...
  public void a(com.capturerecorder.receditor.ad.base.h paramH)
  {
  ...
  public void a(e paramE)
  {
    ...
    ((ContentValues)localObject).put("pkg", com.capturerecorder.receditor.ad.internal.utils.e.a(paramE.a()));
  ...
  public int b(String paramString)
  {
    ...
    //   14: astore 7
    //   16: aload_0
    //   17: getfield 15	com/capturerecorder/receditor/ad/stats/h:a	Landroid/content/Context;
    //   20: invokevirtual 42	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   23: aload_0
    //   24: getfield 15	com/capturerecorder/receditor/ad/stats/h:a	Landroid/content/Context;
    //   27: iconst_1
    //   28: invokestatic 47	com/capturerecorder/receditor/ad/stats/DuAdCacheProvider:a	(Landroid/content/Context;I)Landroid/net/Uri;
    //   31: iconst_1
    ...
    //   159: ldc -25
    //   161: aload 8
    //   163: invokestatic 72	com/capturerecorder/receditor/ad/base/LogHelper:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   166: iload 4
    //   168: istore_3
    //   169: aload_1
    //   170: ifnull +24 -> 194
  ...
  /* Error */
  public java.util.List<com.capturerecorder.receditor.ad.entity.b> b()
  {
    // Byte code:
    //   0: ldc -22
    //   2: iconst_2
    ...
    //   101: astore 7
    //   103: aload_0
    //   104: getfield 15	com/capturerecorder/receditor/ad/stats/h:a	Landroid/content/Context;
    //   107: invokevirtual 42	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   110: aload_0
    //   111: getfield 15	com/capturerecorder/receditor/ad/stats/h:a	Landroid/content/Context;
    //   114: bipush 8
    //   116: invokestatic 47	com/capturerecorder/receditor/ad/stats/DuAdCacheProvider:a	(Landroid/content/Context;I)Landroid/net/Uri;
    //   119: iconst_3
    ...
    //   258: astore 6
    //   260: aload 7
    //   262: new 262	com/capturerecorder/receditor/ad/entity/b
    //   265: dup
    //   266: aload 5
    //   268: iconst_0
    ...
    //   290: invokespecial 265	com/capturerecorder/receditor/ad/entity/b:<init>	(Ljava/lang/String;II)V
    ...
    //   422: invokestatic 223	com/capturerecorder/receditor/ad/base/LogHelper:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   425: aload 5
    //   427: ifnull +16 -> 443
    //   430: aload 5
  ...
  public void b(Context paramContext)
  {
    ...
    //   10: istore_2
    //   11: aload_0
    //   12: getfield 15	com/capturerecorder/receditor/ad/stats/h:a	Landroid/content/Context;
    //   15: invokevirtual 42	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   18: aload_0
    //   19: getfield 15	com/capturerecorder/receditor/ad/stats/h:a	Landroid/content/Context;
    //   22: bipush 7
    //   24: invokestatic 47	com/capturerecorder/receditor/ad/stats/DuAdCacheProvider:a	(Landroid/content/Context;I)Landroid/net/Uri;
    //   27: iconst_1
    ...
    //   135: ldc 122
    //   137: aload 5
    //   139: invokestatic 72	com/capturerecorder/receditor/ad/base/LogHelper:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   142: aload_3
    //   143: ifnull +18 -> 161
    //   146: aload_3
    ...
    //   458: astore_1
    //   459: aload_0
    //   460: getfield 15	com/capturerecorder/receditor/ad/stats/h:a	Landroid/content/Context;
    //   463: invokevirtual 42	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   466: aload_0
    //   467: getfield 15	com/capturerecorder/receditor/ad/stats/h:a	Landroid/content/Context;
    //   470: bipush 7
    //   472: invokestatic 47	com/capturerecorder/receditor/ad/stats/DuAdCacheProvider:a	(Landroid/content/Context;I)Landroid/net/Uri;
    //   475: aload_1
    //   476: aconst_null
    ...
    //   485: ldc_w 329
    //   488: aload_1
    //   489: invokestatic 72	com/capturerecorder/receditor/ad/base/LogHelper:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   492: return
    //   493: astore_1
    //   494: ldc 65
    //   496: ldc_w 331
    //   499: aload_1
    //   500: invokestatic 72	com/capturerecorder/receditor/ad/base/LogHelper:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   503: return
    //   504: astore_1
    //   505: aload 4
    //   507: ifnull +20 -> 527
  ...
  public void b(com.capturerecorder.receditor.ad.base.h paramH)
  {
    ContentValues localContentValues = new ContentValues();
    localContentValues.put("_url", paramH.a);
    localContentValues.put("pkg", paramH.b);
  ...
  public int c(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 15	com/capturerecorder/receditor/ad/stats/h:a	Landroid/content/Context;
    //   4: invokestatic 131	com/capturerecorder/receditor/ad/base/k:H	(Landroid/content/Context;)J
    //   7: lstore 5
    //   9: iconst_0
    //   10: istore 4
    //   12: iconst_0
    ...
    //   33: getfield 15	com/capturerecorder/receditor/ad/stats/h:a	Landroid/content/Context;
    //   36: bipush 7
    //   38: invokestatic 47	com/capturerecorder/receditor/ad/stats/DuAdCacheProvider:a	(Landroid/content/Context;I)Landroid/net/Uri;
    //   41: iconst_1
    ...
    //   169: ldc -25
    //   171: aload 10
    //   173: invokestatic 72	com/capturerecorder/receditor/ad/base/LogHelper:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   176: iload 4
    //   178: istore_3
    //   179: aload_1
    //   180: ifnull +24 -> 204
  ...
  /* Error */
  public com.capturerecorder.receditor.ad.base.h d(String paramString)
  {
    // Byte code:
    //   0: new 75	com/capturerecorder/receditor/ad/base/h
    //   3: dup
    ...
    //   9: aload 8
    //   11: aload_1
    //   12: putfield 111	com/capturerecorder/receditor/ad/base/h:b	Ljava/lang/String;
    //   15: aload 8
    //   17: iconst_0
    //   18: putfield 83	com/capturerecorder/receditor/ad/base/h:c	I
    //   21: aload_0
    //   22: getfield 15	com/capturerecorder/receditor/ad/stats/h:a	Landroid/content/Context;
    //   25: invokestatic 131	com/capturerecorder/receditor/ad/base/k:H	(Landroid/content/Context;)J
    //   28: lstore_2
    //   29: invokestatic 38	java/lang/System:currentTimeMillis	()J
    //   32: lstore 4
    //   34: aload_0
    //   35: getfield 15	com/capturerecorder/receditor/ad/stats/h:a	Landroid/content/Context;
    //   38: invokevirtual 42	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   41: aload_0
    //   42: getfield 15	com/capturerecorder/receditor/ad/stats/h:a	Landroid/content/Context;
    //   45: bipush 7
    //   47: invokestatic 47	com/capturerecorder/receditor/ad/stats/DuAdCacheProvider:a	(Landroid/content/Context;I)Landroid/net/Uri;
    //   50: iconst_4
    ...
    //   129: putfield 79	com/capturerecorder/receditor/ad/base/h:a	Ljava/lang/String;
    //   132: aload_1
    //   133: astore 6
    //   135: aload 8
    //   137: aload_1
    ...
    //   144: putfield 111	com/capturerecorder/receditor/ad/base/h:b	Ljava/lang/String;
    //   147: aload_1
    //   148: astore 6
    //   150: aload 8
    //   152: aload_1
    ...
    //   159: putfield 113	com/capturerecorder/receditor/ad/base/h:d	Ljava/lang/String;
    //   162: aload_1
    //   163: astore 6
    //   165: aload 8
    //   167: aload_1
    ...
    //   174: putfield 83	com/capturerecorder/receditor/ad/base/h:c	I
    //   177: goto +8 -> 185
    //   180: astore 7
    //   182: goto +30 -> 212
    //   185: aload_1
    ...
    //   217: ldc 122
    //   219: aload 7
    //   221: invokestatic 72	com/capturerecorder/receditor/ad/base/LogHelper:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   224: aload_1
    //   225: ifnull +18 -> 243
    //   228: aload_1
    ...
    //   7	237	8	localH	com.capturerecorder.receditor.ad.base.h
    // Exception table:
    //   from	to	target	type
