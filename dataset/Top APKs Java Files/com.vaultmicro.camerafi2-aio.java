...
public class aio
{
  ...
  private aio(Context paramContext)
  {
    this.a = paramContext;
  }
  
  public static aio a(Context paramContext)
  {
    try
    {
      if (b == null) {
        b = new aio(paramContext.getApplicationContext());
      }
      paramContext = b;
      return paramContext;
    }
  ...
  private void b()
  {
    ...
    {
      afm.b("ToolboxCacheMgr", "dumpTimeOutDatas() exception: ", localException);
    }
  }
  
  /* Error */
  public afo a(String paramString)
  {
    // Byte code:
    //   0: new 72	afo
    //   3: dup
    //   4: invokespecial 73	afo:<init>	()V
    //   7: astore 6
    //   9: aload 6
    //   11: aload_1
    //   12: putfield 76	afo:a	Ljava/lang/String;
    //   15: aload 6
    //   17: iconst_0
    //   18: putfield 80	afo:c	I
    //   21: invokestatic 35	java/lang/System:currentTimeMillis	()J
    //   24: lstore_2
    //   25: aload_0
    //   26: getfield 15	aio:a	Landroid/content/Context;
    //   29: invokevirtual 39	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   32: aload_0
    //   33: getfield 15	aio:a	Landroid/content/Context;
    //   36: iconst_1
    ...
    //   123: putfield 76	afo:a	Ljava/lang/String;
    //   126: aload 4
    //   128: astore_1
    //   129: aload 6
    //   131: aload 4
    ...
    //   139: putfield 108	afo:b	Ljava/lang/String;
    //   142: aload 4
    //   144: astore_1
    //   145: aload 6
    //   147: aload 4
    ...
    //   155: putfield 111	afo:d	Ljava/lang/String;
    //   158: aload 4
    //   160: astore_1
    //   161: aload 6
    //   163: aload 4
    ...
    //   209: ldc 123
    //   211: aload 5
    //   213: invokestatic 69	afm:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   216: aload 4
    //   218: ifnull -22 -> 196
    //   221: aload 4
  ...
  public void a()
  {
    ...
    {
      afm.b("ToolboxCacheMgr", "removePreparseCacheTimeOutDatas exception: ", localException);
      return;
    }
    catch (Throwable localThrowable)
    {
      afm.b("ToolboxCacheMgr", "removePreparseCacheTimeOutDatas del exception: ", localThrowable);
    }
  }
  
  public void a(afo paramAfo)
  {
    ContentValues localContentValues = new ContentValues();
    localContentValues.put("_url", paramAfo.a);
    localContentValues.put("pkg", paramAfo.b);
    localContentValues.put("p_url", paramAfo.d);
    localContentValues.put("type", Integer.valueOf(paramAfo.c));
    localContentValues.put("ts", Long.valueOf(paramAfo.e));
    paramAfo = paramAfo.a;
    try
    {
      if (this.a.getContentResolver().update(DuAdCacheProvider.a(this.a, 1), localContentValues, "_url = ?", new String[] { paramAfo }) < 1) {
        this.a.getContentResolver().insert(DuAdCacheProvider.a(this.a, 1), localContentValues);
      }
      b();
      return;
    }
    catch (Exception paramAfo)
    {
      afm.b("ToolboxCacheMgr", "saveParseResult() exception: ", paramAfo);
    }
  }
  ...
  public int b(String paramString)
  {
    ...
    //   120: ldc -74
    //   122: aload 6
    //   124: invokestatic 69	afm:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   127: aload 5
    //   129: ifnull +58 -> 187
    //   132: aload 5
  ...
  public void b(afo paramAfo)
  {
    ...
    try
    {
      if (this.a.getContentResolver().update(DuAdCacheProvider.a(this.a, 7), localContentValues, "_url = ?", new String[] { paramAfo }) < 1) {
  ...
  public void b(Context paramContext)
  {
    ...
    //   255: ldc 123
    //   257: aload 5
    //   259: invokestatic 69	afm:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   262: aload 4
    //   264: ifnull -145 -> 119
    //   267: aload 4
    ...
    //   467: ldc_w 257
    //   470: aload_1
    //   471: invokestatic 69	afm:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   474: return
    //   475: astore_1
    //   476: ldc 62
    //   478: ldc_w 259
    //   481: aload_1
    //   482: invokestatic 69	afm:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   485: return
    //   486: astore_1
    //   487: goto -197 -> 290
    //   490: astore 5
  ...
  public int c(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 15	aio:a	Landroid/content/Context;
    //   4: invokestatic 131	afr:k	(Landroid/content/Context;)J
    //   7: lstore_3
    //   8: invokestatic 35	java/lang/System:currentTimeMillis	()J
    //   11: lstore 5
    //   13: aload_0
    //   14: getfield 15	aio:a	Landroid/content/Context;
    //   17: invokevirtual 39	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   20: aload_0
    //   21: getfield 15	aio:a	Landroid/content/Context;
    //   24: bipush 7
    ...
    //   130: ldc -74
    //   132: aload 8
    //   134: invokestatic 69	afm:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   137: aload 7
    //   139: ifnull +58 -> 197
    //   142: aload 7
  ...
  /* Error */
  public afo d(String paramString)
  {
    // Byte code:
    //   0: new 72	afo
    //   3: dup
    ...
    //   9: aload 8
    //   11: aload_1
    //   12: putfield 108	afo:b	Ljava/lang/String;
    //   15: aload 8
    //   17: iconst_0
    //   18: putfield 80	afo:c	I
    //   21: aload_0
    //   22: getfield 15	aio:a	Landroid/content/Context;
    //   25: invokestatic 131	afr:k	(Landroid/content/Context;)J
    //   28: lstore_2
    //   29: invokestatic 35	java/lang/System:currentTimeMillis	()J
    //   32: lstore 4
    //   34: aload_0
    //   35: getfield 15	aio:a	Landroid/content/Context;
    //   38: invokevirtual 39	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   41: aload_0
    //   42: getfield 15	aio:a	Landroid/content/Context;
    //   45: bipush 7
    ...
    //   133: putfield 76	afo:a	Ljava/lang/String;
    //   136: aload 6
    //   138: astore_1
    //   139: aload 8
    //   141: aload 6
    ...
    //   149: putfield 108	afo:b	Ljava/lang/String;
    //   152: aload 6
    //   154: astore_1
    //   155: aload 8
    //   157: aload 6
    ...
    //   165: putfield 111	afo:d	Ljava/lang/String;
    //   168: aload 6
    //   170: astore_1
    //   171: aload 8
    //   173: aload 6
    ...
    //   219: ldc 123
    //   221: aload 7
    //   223: invokestatic 69	afm:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   226: aload 6
    //   228: ifnull -22 -> 206
    //   231: aload 6
