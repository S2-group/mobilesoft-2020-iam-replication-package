...
class br
{
  ...
  public String a(String paramString)
  {
    ...
    //   11: astore_2
    //   12: aload_0
    //   13: invokespecial 80	a/a/a/br:l	()Z
    //   16: ifne +112 -> 128
    //   19: aload_0
    //   20: getfield 23	a/a/a/br:c	Landroid/content/Context;
    ...
    //   85: new 122	a/a/a/c
    //   88: dup
    //   89: invokespecial 123	a/a/a/c:<init>	()V
    //   92: aload 5
    //   94: invokevirtual 126	a/a/a/c:a	([B)Ljava/lang/String;
    //   97: astore 5
    //   99: aload 5
    //   101: astore_3
    //   102: aload_2
  ...
  public boolean a(bs paramBs)
  {
    ...
    {
      new bt(this, paramBs).a(new Void[0]);
      return true;
    }
    return false;
  }
  ...
  {
    Object localObject = at.a(this.c);
    String str = d();
    if ("bnc_no_value".equals(((at)localObject).e()))
    {
      if (paramBoolean) {
        ((at)localObject).a(str);
      }
      ...
      else
      {
        try
        {
          ...
          for (localObject = null;; localObject = ((CharSequence)localObject).toString())
          {
            ...
            if (localObject != null)
            {
              localJSONObject.put(an.M.a(), localObject);
              localObject = a((String)localObject);
              if (!((String)localObject).equals("bnc_no_value")) {
                localJSONObject.put(an.L.a(), localObject);
              }
            }
