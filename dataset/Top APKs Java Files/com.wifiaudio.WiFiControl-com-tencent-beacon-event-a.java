...
public final class a
{
  ...
  private List<String> c(boolean paramBoolean)
  {
    ...
    //   13: invokevirtual 289	android/content/Context:getPackageManager	()Landroid/content/pm/PackageManager;
    //   16: astore_3
    //   17: aload_3
    //   18: ifnull -11 -> 7
    //   21: aload_3
    //   22: iconst_0
    //   23: invokevirtual 295	android/content/pm/PackageManager:getInstalledPackages	(I)Ljava/util/List;
    //   26: astore 4
    //   28: aload 4
    //   30: ifnull -23 -> 7
    //   33: aload 4
    ...
    //   40: ifle -33 -> 7
    //   43: new 207	java/util/ArrayList
    //   46: dup
    //   47: invokespecial 208	java/util/ArrayList:<init>	()V
    //   50: astore_3
    //   51: aload 4
    ...
    //   77: checkcast 297	android/content/pm/PackageInfo
    //   80: astore 5
    //   82: aload 5
    //   84: getfield 301	android/content/pm/PackageInfo:applicationInfo	Landroid/content/pm/ApplicationInfo;
    //   87: getfield 306	android/content/pm/ApplicationInfo:flags	I
    //   90: iconst_1
    //   91: iand
    //   92: ifne +202 -> 294
    //   95: iconst_1
    ...
    //   103: dup
    //   104: invokespecial 163	java/lang/StringBuilder:<init>	()V
    //   107: astore 6
    //   109: aload 6
    //   111: ldc_w 265
    ...
    //   118: aload 6
    //   120: aload 5
    //   122: getfield 309	android/content/pm/PackageInfo:packageName	Ljava/lang/String;
    ...
    //   135: aload 6
    //   137: aload 5
    //   139: getfield 312	android/content/pm/PackageInfo:versionName	Ljava/lang/String;
    ...
    //   152: aload 6
    //   154: aload 5
    //   156: getfield 315	android/content/pm/PackageInfo:versionCode	I
    //   159: invokevirtual 268	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   162: ldc_w 265
    //   165: invokevirtual 109	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   168: pop
    //   169: getstatic 320	android/os/Build$VERSION:SDK	Ljava/lang/String;
    //   172: invokestatic 326	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   175: bipush 9
    ...
    //   225: aload 6
    //   227: aload 5
    //   229: getfield 330	android/content/pm/PackageInfo:firstInstallTime	J
    //   232: invokevirtual 333	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   235: ldc_w 265
    //   238: invokevirtual 109	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   241: pop
    //   242: aload 6
    //   244: aload 5
    //   246: getfield 336	android/content/pm/PackageInfo:lastUpdateTime	J
    //   249: invokevirtual 333	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   252: ldc_w 265
