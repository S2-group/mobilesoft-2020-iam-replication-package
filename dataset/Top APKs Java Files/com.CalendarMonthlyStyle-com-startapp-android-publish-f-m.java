...
public class m
{
  ...
  {
    g.a("SimpleToken", 3, "createSimpleToken entered");
    paramContext = new a().a(b(paramContext));
    g.a("SimpleToken", 3, "simpleToken : [" + paramContext + "]");
    return paramContext;
  }
  ...
  {
    g.a("SimpleToken", 3, "getPackageList entered");
  ...
  {
    g.a("SimpleToken", 3, "getPackages entered");
    ...
    for (;;)
    {
      try
      {
        ...
        if (!localPackageInfo.packageName.equals(b.c)) {
          continue;
        }
      }
      catch (RuntimeException localRuntimeException)
      {
        g.a("SimpleToken", 6, "Could not complete getInstalledPackages", localRuntimeException);
        return paramContext;
      }
      a = true;
    }
