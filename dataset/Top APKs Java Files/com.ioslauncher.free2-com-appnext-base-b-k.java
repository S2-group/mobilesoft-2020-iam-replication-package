...
public final class k
{
  ...
  {
    Object localObject = com.appnext.base.a.a.aN().aR().ad(paramString);
    ...
    catch (Throwable localThrowable)
    {
      ...
      try
      {
        paramString = g.a("http://apis.appnxt.net:443/data", localHashMap, false, 15000, d.a.HashMap);
        if (paramString != null) {
