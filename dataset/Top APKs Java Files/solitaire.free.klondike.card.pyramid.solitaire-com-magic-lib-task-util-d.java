package com.magic.lib.task.util;
...
import com.magic.lib.R.color;
import com.magic.lib.R.drawable;
import com.magic.lib.R.string;
import com.magic.lib.R.style;
import com.magic.lib.a.l;
import com.magic.lib.a.q;
import com.magic.lib.a.y;
import com.magic.lib.task.c.h;
import com.magic.lib.task.util.processutil.AndroidAppProcess;
import java.io.File;
...
public class d
{
  ...
  public static int a(com.magic.lib.task.b.a paramA, int paramInt)
  {
    if (paramInt <= 0) {
      return 0;
    }
  ...
  public static int a(com.magic.lib.task.b.a paramA, com.magic.lib.task.b.b paramB, com.magic.lib.task.b.d paramD)
  {
  ...
  public static long a(long paramLong)
  {
    ...
    {
      com.magic.lib.a.e.a(localNumberFormatException);
    }
    return 0L;
  }
  ...
  public static long a(b.a paramA)
  {
    ...
    catch (Exception paramA)
    {
      ...
      com.magic.lib.a.e.c(((StringBuilder)localObject).toString());
    }
    return 0L;
  }
  ...
  public static TextView a(Activity paramActivity, int paramInt)
  {
    ...
    if (paramInt == 1) {
      paramInt = R.drawable.magic_task_two_adlabel_bg;
    } else {
      paramInt = R.drawable.magic_task_adlabel_bg;
    }
    TextView localTextView = new TextView(paramActivity);
    localTextView.setGravity(17);
    localTextView.setText(R.string.magic_task_adLabel);
    int i = com.magic.lib.a.f.a(paramActivity, 18);
    FrameLayout.LayoutParams localLayoutParams = new FrameLayout.LayoutParams(i, i);
    localLayoutParams.gravity = 80;
    localTextView.setLayoutParams(localLayoutParams);
    localTextView.setTextSize(10.0F);
    localTextView.setTextColor(paramActivity.getResources().getColor(R.color.magic_task_adlabel));
    localTextView.setBackgroundResource(paramInt);
    return localTextView;
  }
  
  public static com.magic.lib.task.b.b a(com.magic.lib.task.b.a paramA)
  {
    if (paramA == null) {
      return null;
    }
    ...
    paramA = ((com.magic.lib.task.b.c)localObject).getCurrentTaskBranchIndex();
    localObject = ((com.magic.lib.task.b.c)localObject).getTaskBranch().iterator();
    while (((Iterator)localObject).hasNext())
    {
      com.magic.lib.task.b.b localB = (com.magic.lib.task.b.b)((Iterator)localObject).next();
      if (localB != null)
      {
  ...
  public static com.magic.lib.task.b.b a(com.magic.lib.task.b.a paramA, a paramA1)
  {
    if (paramA == null) {
      return null;
    }
    ...
    if (paramA != null)
    {
      ...
      {
        com.magic.lib.task.b.b localB = (com.magic.lib.task.b.b)paramA.next();
  ...
  public static String a(Context paramContext, com.magic.lib.task.b.c paramC, String paramString, boolean paramBoolean)
  {
  ...
  public static String a(com.magic.lib.task.b.a paramA, String[] paramArrayOfString)
  {
    if (paramA != null)
    {
      paramA = paramA.getTaskContent();
  ...
  public static ArrayList<com.magic.lib.task.b.a> a(ArrayList<com.magic.lib.task.b.a> paramArrayList)
  {
  ...
  public static void a(Activity paramActivity, String paramString)
  {
    ...
    if (com.magic.lib.a.e.a())
    {
      ...
      com.magic.lib.a.e.b(localStringBuilder.toString());
    }
    try
    {
  ...
  public static void a(com.magic.lib.task.b.a paramA, JSONObject paramJSONObject)
  {
    if (paramA != null)
    {
      if (paramJSONObject == null) {
  ...
  {
    long l = com.magic.lib.task.d.a.a().b("markNowDateKey");
    boolean bool = false;
    if (l <= 0L) {
      return false;
    }
  ...
  public static boolean a(com.magic.lib.task.b.c paramC, String paramString)
  {
    if (paramC == null) {
      return false;
    }
  ...
  public static boolean a(ArrayList<com.magic.lib.task.b.a> paramArrayList, com.magic.lib.task.b.a paramA)
  {
    if ((paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      {
        String str = ((com.magic.lib.task.b.a)paramArrayList.next()).getId();
  ...
  public static long b(String paramString)
  {
    ...
    localStringBuilder.append(paramString);
    com.magic.lib.a.e.c(localStringBuilder.toString());
    return 0L;
  }
  ...
  public static String b()
  {
    ...
    try
    {
      ...
      try
      {
        ...
        String str3 = com.magic.lib.a.f.a().toLowerCase();
        str1 = str2;
  ...
  public static ArrayList<com.magic.lib.task.b.a> b(ArrayList<com.magic.lib.task.b.a> paramArrayList)
  {
    if ((paramArrayList != null) && (paramArrayList.size() > 0)) {
  ...
  public static boolean b(com.magic.lib.task.b.a paramA)
  {
    boolean bool = false;
    if (paramA == null) {
      return false;
  ...
  public static com.magic.lib.task.b.b c(com.magic.lib.task.b.a paramA)
  {
  ...
  public static HashMap<String, com.magic.lib.task.b.a> c(ArrayList<com.magic.lib.task.b.a> paramArrayList)
  {
    ...
    while (paramArrayList.hasNext())
    {
      com.magic.lib.task.b.a localA = (com.magic.lib.task.b.a)paramArrayList.next();
  ...
  public static void c(String paramString)
  {
    ...
    {
      com.magic.lib.a.e.a(paramString);
    }
  }
  ...
  private static boolean c(Context paramContext, String paramString)
  {
    try
    {
      paramContext = com.magic.lib.task.util.processutil.f.a(paramContext);
      if (paramContext != null)
      {
  ...
  public static com.magic.lib.task.b.a d(ArrayList<com.magic.lib.task.b.a> paramArrayList)
  {
    if (paramArrayList != null)
    {
      ...
      int i = 0;
      while (((Iterator)localObject1).hasNext()) {
        i += ((com.magic.lib.task.b.a)((Iterator)localObject1).next()).getWeight().intValue();
      }
      ...
      {
        com.magic.lib.task.b.a localA = (com.magic.lib.task.b.a)((Iterator)localObject2).next();
      ...
      while (i < ((ArrayList)localObject1).size())
      {
        ...
        if (m < j)
        {
          if (com.magic.lib.a.e.a())
          {
            ...
            com.magic.lib.a.e.b(((StringBuilder)localObject2).toString());
            ...
            paramArrayList.append(((com.magic.lib.task.b.a)localArrayList.get(i)).getId());
            paramArrayList.append(" weight:");
            paramArrayList.append(((com.magic.lib.task.b.a)localArrayList.get(i)).getWeight());
            com.magic.lib.a.e.b(paramArrayList.toString());
          }
          return (com.magic.lib.task.b.a)localArrayList.get(i);
        }
        i += 1;
      }
      return null;
  ...
  public static void d(Activity paramActivity)
  {
    try
    {
      ...
      if (i == 2)
      {
        ...
        if (com.magic.lib.a.e.a()) {
          com.magic.lib.a.e.b("TaskTools set is-----SCREEN_ORIENTATION_PORTRAIT");
        }
      }
      else if (i == 1)
      {
  ...
  public static String e(com.magic.lib.task.b.a paramA)
  {
    if ((paramA != null) && (paramA.getTaskContent() != null)) {
  ...
  public static HashMap<String, Double> e(String paramString)
  {
    ...
    if (localObject1 != null)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        com.magic.lib.a.e.c("TaskTools splitData NumberFormatException");
      }
      return paramString;
    }
    return null;
  ...
  public static String f(String paramString)
  {
    for (;;)
    {
      ...
      try
      {
        if ((!TextUtils.isEmpty(paramString)) && (com.magic.lib.task.d.c.a().c().b(paramString)))
        {
  ...
  public static boolean f(com.magic.lib.task.b.a paramA)
  {
    return a(g(paramA));
  }
  
  public static String g(com.magic.lib.task.b.a paramA)
  {
    if (paramA != null)
    {
      paramA = paramA.getTaskContent();
  ...
  public static boolean h(com.magic.lib.task.b.a paramA)
  {
    if (paramA != null)
    {
      paramA = paramA.getTaskContent();
  ...
  public static boolean i(com.magic.lib.task.b.a paramA)
  {
    if (paramA == null) {
      return false;
    }
    ArrayList localArrayList = com.magic.lib.task.d.b.a().d();
    return b(com.magic.lib.task.d.b.a().a(localArrayList, paramA.getId()));
  }
  ...
  public static boolean j(com.magic.lib.task.b.a paramA)
  {
    paramA = a(paramA);
  ...
  public static boolean k(com.magic.lib.task.b.a paramA)
  {
    if (paramA != null)
    {
      ...
      if ((localObject != null) && (((List)localObject).size() > 0))
      {
        ...
        if ((com.magic.lib.a.e.a()) && (bool))
        {
          ...
          com.magic.lib.a.e.b(((StringBuilder)localObject).toString());
        }
        return bool;
      }
    }
  ...
  public static String l(String paramString)
  {
    ...
    if (com.magic.lib.task.d.c.a().c().b(paramString))
    {
      int i = paramString.lastIndexOf("/");
      if (i == -1) {
        i = 0;
  ...
  public static boolean l(com.magic.lib.task.b.a paramA)
  {
    return a(paramA.getCloseTaskTime()) == a(b.a.DATE);
  }
  
  public static boolean m(com.magic.lib.task.b.a paramA)
  {
    boolean bool = false;
    if (paramA == null) {
      return false;
  ...
  public static boolean n(com.magic.lib.task.b.a paramA)
  {
    return "follow".equals(paramA.getTaskContent().getTaskType());
  }
  
  private static boolean o(com.magic.lib.task.b.a paramA)
  {
