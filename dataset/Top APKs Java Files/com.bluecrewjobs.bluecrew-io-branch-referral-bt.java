...
class bt
{
  ...
  public String a(String paramString)
  {
    ...
    //   11: astore_2
    //   12: aload_0
    //   13: invokespecial 80	io/branch/referral/bt:l	()Z
    //   16: ifne +112 -> 128
    //   19: aload_0
    //   20: getfield 23	io/branch/referral/bt:c	Landroid/content/Context;
  ...
  public boolean a(bu paramBu)
  {
    ...
    {
      new bv(this, paramBu).a(new Void[0]);
      return true;
    }
    return false;
  }
  ...
  {
    Object localObject = av.a(this.c);
    String str = d();
    if ("bnc_no_value".equals(((av)localObject).e()))
    {
      if (paramBoolean) {
        ((av)localObject).a(str);
      }
      ...
      else
      {
        try
        {
          ...
          for (localObject = null;; localObject = ((CharSequence)localObject).toString())
          {
            ...
            if (localObject != null)
            {
              localJSONObject.put(aq.M.a(), localObject);
              localObject = a((String)localObject);
              if (!((String)localObject).equals("bnc_no_value")) {
                localJSONObject.put(aq.L.a(), localObject);
              }
            }
