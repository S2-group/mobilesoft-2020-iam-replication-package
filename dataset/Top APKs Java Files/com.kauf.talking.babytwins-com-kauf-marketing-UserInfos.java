...
public class UserInfos
{
  ...
  public static StringBuilder UserParams(Activity paramActivity)
  {
    ...
    try
    {
      localStringBuilder.append("&gps_adid=" + URLEncoder.encode(MyApplication.googlePlayServicesAdId, Charset.defaultCharset().name()));
      localStringBuilder.append("&gps_adlt=" + MyApplication.googlePlayServicesAdLimitTracking);
      try
      {
                                              ...
                                              try
                                              {
                                                ...
                                                try
                                                {
                                                  ...
                                                  try
                                                  {
                                                    ...
                                                    localStringBuilder.append("&isTablet=" + Device.isTablet(paramActivity));
                                                    localStringBuilder.append("&isTV=" + Device.isTV(paramActivity));
                                                    localStringBuilder.append("&user_age=" + User.AGE);
                                                    localStringBuilder.append("&user_gender=" + User.GENDER);
  ...
  public static int numberOwnAppsInstalled(Context paramContext)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        j = i;
        boolean bool = ((ApplicationInfo)paramContext.next()).packageName.startsWith("com.kauf.");
        if (bool) {
          i += 1;
        }
      }
