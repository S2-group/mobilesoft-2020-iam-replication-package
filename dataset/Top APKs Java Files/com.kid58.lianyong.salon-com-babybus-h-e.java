...
public class e
{
  ...
  public static List<String> jdMethod_class()
  {
    ...
    {
      File[] arrayOfFile = new File(b.x.else).listFiles();
  ...
  public static void jdMethod_do(String paramString1, String paramString2)
  {
    if (al.jdMethod_do("android.permission.WRITE_EXTERNAL_STORAGE"))
    {
      ...
      com.babybus.e.a.jdMethod_do().jdMethod_if(paramString1, paramString2);
      return;
    }
    com.babybus.e.a.jdMethod_do().jdMethod_for(paramString1, paramString2);
  }
  ...
  {
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append(b.x.else);
    localStringBuilder.append("/");
    localStringBuilder.append(paramString);
  ...
  public static String jdMethod_this(String paramString)
  {
    ...
    {
      localObject = new StringBuilder();
      ((StringBuilder)localObject).append(b.x.long);
      ((StringBuilder)localObject).append("/");
      ((StringBuilder)localObject).append(paramString);
      ((StringBuilder)localObject).append(".apk");
      localObject = ((StringBuilder)localObject).toString();
      com.babybus.h.b.g.jdMethod_do().jdMethod_do((String)localObject, new com.babybus.h.b.e(paramString));
      paramString = (String)localObject;
    }
    else
    {
      localObject = new com.babybus.h.b.e(paramString);
      if (!App.goto)
      {
        paramString = new StringBuilder();
        paramString.append(App.jdMethod_do().getExternalFilesDir("apks"));
        paramString.append("/");
        paramString.append(((com.babybus.h.b.e)localObject).jdMethod_do());
        paramString.append(".apk");
        paramString = paramString.toString();
        com.babybus.h.b.g.jdMethod_do().jdMethod_if((com.babybus.h.b.e)localObject);
      }
      else
      {
        StringBuilder localStringBuilder = new StringBuilder();
        localStringBuilder.append(b.x.long);
        localStringBuilder.append("/");
        localStringBuilder.append(paramString);
        localStringBuilder.append(".apk");
        paramString = localStringBuilder.toString();
        com.babybus.h.b.g.jdMethod_do().jdMethod_do((com.babybus.h.b.e)localObject);
      }
    }
