...
public final class n
{
  ...
  private static boolean A(Context paramContext)
  {
    try
    {
      ...
      com.baidu.frontia.base.a.a.b.c("Utility", "provider name  = " + (String)localObject2 + "  export  = " + ((ProviderInfo)localObject1).exported, paramContext.getApplicationContext());
  ...
  public static ComponentName a(Context paramContext, Intent paramIntent, String paramString)
  {
    ...
    for (localObject = (PublicMsg)localObject;; localObject = null)
    {
      ...
      paramIntent.putExtra("advertisestyle", String.valueOf(((PublicMsg)localObject).mAdvertiseStyle));
  ...
  {
    localObject1 = o(paramContext.getApplicationContext());
    if (((List)localObject1).size() <= 1) {
      return paramString;
    }
    ...
    {
      String str1 = ((ResolveInfo)localIterator.next()).activityInfo.packageName;
      for (;;)
      {
        try
        {
          paramString = paramContext.createPackageContext(str1, 2);
        }
        catch (Exception localException1)
        {
          try
          {
            SharedPreferences localSharedPreferences = paramString.getSharedPreferences(str1 + ".push_sync", 5);
      ...
      label217:
      l2 = localObject2.getLong("priority2", 0L);
      if (l2 > l1)
      {
      ...
      for (;;)
      {
        ...
        paramString = (String)localObject1;
        continue;
        if ((l2 != l1) || (!str1.equals(str2)) || (!h(paramString, str1))) {
          break label417;
        }
        paramString = str1;
        l1 = l2;
    ...
    com.baidu.frontia.base.a.a.a.c("Utility", "Current highest priority Push PackageName: " + (String)localObject1);
    return localObject1;
  }
  ...
  public static String p(Context paramContext, String paramString)
  {
    try
    {
      ...
      paramContext = com.baidu.frontia.base.d.e.a(paramContext.getPackageInfo(paramString, 64).signatures[0].toByteArray(), false);
      return paramContext;
    }
  ...
  public static long w(Context paramContext)
  {
    ...
    for (;;)
    {
      if (localIterator.hasNext())
      {
        str1 = ((ResolveInfo)localIterator.next()).activityInfo.packageName;
        localObject2 = null;
        try
        {
          Context localContext = paramContext.createPackageContext(str1, 2);
          localObject2 = localContext;
          localSharedPreferences = localContext.getSharedPreferences(str1 + ".push_sync", 5);
        ...
        catch (Exception localException)
        {
          for (;;)
          {
            com.baidu.frontia.base.a.a.a.d("Utility", "create packagecontext exception: " + localException.getMessage());
    ...
    for (;;)
    {
      ...
      continue;
      label369:
      if ((l2 == l1) && (str1.equals(str2)) && (h(localObject3, str1)))
      {
        localObject1 = str1;
        l1 = l2;
        continue;
