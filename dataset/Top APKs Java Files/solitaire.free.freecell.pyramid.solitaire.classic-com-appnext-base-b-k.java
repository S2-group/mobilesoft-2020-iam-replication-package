...
public class k
{
  ...
  {
    return c(paramInt1, paramInt2) + (kz.nextInt(paramInt3 + paramInt4) - paramInt3) * 1000L;
  }
  ...
  {
    return i.cE().getLong(paramString + "_lastupdate", 0L);
  }
  ...
  {
    Object localObject = e.cy().av(paramString);
    ...
    if (TextUtils.isEmpty(str1)) {
      localObject = i.cE().getString("google_ads_id", "");
    }
