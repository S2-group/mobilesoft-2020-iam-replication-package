...
public class QQAuth
{
  ...
  private int a(Activity paramActivity, Fragment paramFragment, String paramString1, IUiListener paramIUiListener, String paramString2)
  {
    ...
    Object localObject = paramActivity.getPackageManager().getInstalledApplications(128).iterator();
    ...
    if (paramString2 != null) {
      try
      {
        ...
        {
          f.b("openSDK_LOG", "-->login channelId: ".concat(String.valueOf(paramString2)));
      ...
      {
        localObject = new StringBuilder("-->login get channel id exception.");
        ((StringBuilder)localObject).append(paramString2.getMessage());
        f.b("openSDK_LOG", ((StringBuilder)localObject).toString());
  ...
  public boolean isSessionValid()
  {
    ...
    f.a("openSDK_LOG", localStringBuilder.toString());
  ...
  {
    f.c("openSDK_LOG", "-->login activity: ".concat(String.valueOf(paramActivity)));
  ...
  public int login(Fragment paramFragment, String paramString1, IUiListener paramIUiListener, String paramString2)
  {
    ...
    f.c("openSDK_LOG", "-->login activity: ".concat(String.valueOf(localFragmentActivity)));
  ...
  {
    f.c("openSDK_LOG", "onActivityResult() ,resultCode = ".concat(String.valueOf(paramInt2)));
    return true;
  }
  ...
  {
    f.a("openSDK_LOG", "setAccessToken(), validTimeInSecond = ".concat(String.valueOf(paramString2)));
