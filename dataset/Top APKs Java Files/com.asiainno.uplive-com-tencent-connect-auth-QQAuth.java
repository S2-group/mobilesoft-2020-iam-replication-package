...
public class QQAuth
{
  ...
  public static QQAuth createInstance(String paramString, Context paramContext)
  {
    ...
    catch (PackageManager.NameNotFoundException paramString)
    {
      ...
      paramString = Toast.makeText(paramContext.getApplicationContext(), "请参照文档在Androidmanifest.xml加上AuthActivity和AssitActivity的定义 ", 1);
  ...
  {
    hu localHu = paramFragment.getActivity();
    f.c("openSDK_LOG.QQAuth", "-->login activity: " + localHu);
    return a(localHu, paramFragment, paramString1, paramIUiListener, paramString2);
  }
