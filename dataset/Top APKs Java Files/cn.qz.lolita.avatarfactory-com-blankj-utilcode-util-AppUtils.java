...
public final class AppUtils
{
  ...
  public static boolean installAppSilent(String paramString)
  {
    ...
    paramString = ShellUtils.execCmd(localStringBuilder.toString(), isSystemApp() ^ true, true);
    bool1 = bool2;
  ...
  public static boolean uninstallAppSilent(String paramString, boolean paramBoolean)
  {
    ...
    localStringBuilder.append(paramString);
    paramString = ShellUtils.execCmd(localStringBuilder.toString(), isSystemApp() ^ true, true);
    return (paramString.successMsg != null) && (paramString.successMsg.toLowerCase().contains("success"));
  }
