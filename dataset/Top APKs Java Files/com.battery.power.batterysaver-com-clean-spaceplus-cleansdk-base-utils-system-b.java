...
public class b
{
    ...
    implements MonitorManager.a
  {
    ...
    private void c(String paramString)
    {
      ...
      //   12: ifnull +22 -> 34
      //   15: aload_0
      //   16: getfield 56	com/clean/spaceplus/cleansdk/base/utils/system/b$a:b	Landroid/content/pm/PackageManager;
      //   19: aload_1
      //   20: iconst_0
      ...
      //   29: aload_0
      //   30: aload_1
      //   31: invokespecial 64	com/clean/spaceplus/cleansdk/base/utils/system/b$a:a	(Landroid/content/pm/PackageInfo;)V
      //   34: aload_0
      //   35: monitorexit
      //   36: return
      //   37: astore_1
    ...
    public List<PackageInfo> a()
    {
      try
      {
        ...
        if (this.h != null) {
          com.hawkclean.framework.a.b.a(b.d(), "PMCacheableWrapper getInstalledPackagesNoThrow mPkgList size = " + this.h.size(), new Object[0]);
        }
        this.g = this.f;
