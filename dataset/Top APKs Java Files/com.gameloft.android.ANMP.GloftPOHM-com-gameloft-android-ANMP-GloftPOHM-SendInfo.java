...
public class SendInfo
{
  ...
  public static String getLocaleCountry()
  {
    if (a != null)
    {
      try
      {
        str1 = ((TelephonyManager)a.getSystemService("phone")).getSimCountryIso();
        if ((str1 == null) || (str1.equals(""))) {
          break label64;
        }
        Log.v("tdtanvn", "getLocaleCountry 2 /" + str1 + "/");
      }
      catch (Exception localException)
      {
        String str2;
        do
        {
          ...
          Log.v("tdtanvn", "getLocaleCountry 3 /" + str2 + "/");
          Object localObject = str2;
        } while (!str2.equals("ZZ"));
        return "US";
      }
      return str1;
    }
  ...
  public static String getLocaleLanguage()
  {
    if (a != null) {
      try
      {
        ...
        ((Locale)localObject).getISO3Language();
        localObject = ((Locale)localObject).getISO3Country();
        if (((str.equals("pt")) && (!((String)localObject).equals("BRA"))) || ((str.equals("zh")) && (!((String)localObject).equals("CHN")))) {
          break label85;
        }
