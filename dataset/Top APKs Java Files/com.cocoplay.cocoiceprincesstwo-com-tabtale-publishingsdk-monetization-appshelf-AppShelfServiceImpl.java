  ...
  implements AppShelfService, LocationInternalDelegate, Language, ConfigurationFetcherDelegate
{
  ...
  protected AppShelfServiceImpl(AppLifeCycleMgr paramAppLifeCycleMgr, String paramString1, Map<String, Object> paramMap, String paramString2, String paramString3, PublishingSDKAppInfo paramPublishingSDKAppInfo, LocationInternalDelegate paramLocationInternalDelegate, AppshelfDelegate paramAppshelfDelegate)
  {
    super(paramPublishingSDKAppInfo);
    ...
    this.mConfigurationFetcher = new ConfigurationFetcherHelper(paramMap, "appShelf", this);
  ...
  private void loadConfiguration(boolean paramBoolean)
  {
    this.mOpenOnNewActivity = this.mConfigurationFetcher.getBool("openOnNewActivity", false);
    String str = this.mConfigurationFetcher.getString("serverDomain");
    if (str != null)
    {
      this.mServerDomain = str;
      str = this.mConfigurationFetcher.getString("fallbackDomain");
    ...
    for (;;)
    {
      this.mFallbackAppShelfDomain = str;
      if (!paramBoolean) {
        break label90;
      }
      enable(this.mConfigurationFetcher.getBool("enabled", true));
      return;
      str = "appshelf.ttpsdk.info";
      break;
      label84:
      str = "http://s3.ttpsdk.info";
    }
    label90:
    this.mEnabled = this.mConfigurationFetcher.getBool("enabled", true);
  }
  ...
  {
    if (paramBoolean != this.mLocationMgrEnabled)
    {
      this.mLocationMgrEnabled = paramBoolean;
      Iterator localIterator = this.mLocations.entrySet().iterator();
      while (localIterator.hasNext())
      {
        Map.Entry localEntry = (Map.Entry)localIterator.next();
  ...
  public void initLocations()
  {
    ...
    try
    {
      JSONArray localJSONArray = this.mConfigurationFetcher.getJSONArray("locations");
      if (localJSONArray != null)
      {
        ...
        while (i < localJSONArray.length())
        {
          ...
          if ((((JSONObject)localObject).has("loc")) && (((JSONObject)localObject).has("id")))
          {
            String str = ((JSONObject)localObject).getString("loc");
            localObject = Integer.valueOf(((JSONObject)localObject).getInt("id")).toString();
            this.mLocations.put(str, localObject);
            if (this.mStorage.hasKey((String)localObject)) {
              mReadyLocations.add(localObject);
            }
          }
          i += 1;
        }
    ...
    {
      Log.e(TAG, "failed to parse appshelf locations, exception: " + localJSONException.getMessage());
  ...
  public boolean isLocationReady(String paramString)
  {
    ...
    } while ((str == null) || ((!this.mDefaultAppShelfExist) && (!mReadyLocations.contains(str))));
    return true;
  }
  
  public void onClicked(String paramString, Object paramObject)
  {
  ...
  public void onResume(AppLifeCycleResumeState paramAppLifeCycleResumeState)
  {
    ...
    } while (paramAppLifeCycleResumeState != AppLifeCycleResumeState.ALCRS_RESUME);
    ((OnResumeAsyncTask)localObject).execute(new Boolean[] { Boolean.valueOf(false), null });
    return;
    if ((paramAppLifeCycleResumeState == AppLifeCycleResumeState.ALCRS_RESUME) && (this.mPendingUpdate == null)) {
  ...
  public void onShowFailed(String paramString, Object paramObject)
  {
  ...
  public boolean show(String paramString)
  {
    ...
    do
    {
      ...
      str2 = (String)this.mLocations.get(paramString);
    } while (str2 == null);
