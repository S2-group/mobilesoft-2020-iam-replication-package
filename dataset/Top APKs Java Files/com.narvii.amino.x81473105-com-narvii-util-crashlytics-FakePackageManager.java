  ...
  extends PackageManager
{
  ...
  {
    return this.orig.getChangedPackages(paramInt);
  }
  ...
  public PackageInfo getPackageInfo(VersionedPackage paramVersionedPackage, int paramInt)
    throws PackageManager.NameNotFoundException
  {
    return this.orig.getPackageInfo(paramVersionedPackage, paramInt);
  }
  ...
  {
    return this.orig.getSharedLibraries(paramInt);
  }
  ...
  {
    return this.orig.isInstantApp(paramString);
  }
  ...
  {
    this.orig.setApplicationCategoryHint(paramString, paramInt);
  }
  ...
  {
    this.orig.updateInstantAppCookie(paramArrayOfByte);
  }
