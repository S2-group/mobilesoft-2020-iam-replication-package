  ...
  extends BillingActivity
{
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    if (i != 0)
    {
      ...
      ((ImageView)findViewById(2131230945)).startAnimation(paramBundle);
    }
    if (getApplicationContext().getExternalFilesDir(null) == null) {
      FlurryAgent.logEvent("ExternalFilesDirNotExist");
    }
    UnityMonetization.initialize(this, getString(2131492899), null, false);
    ...
    extends AsyncTask<Void, Integer, Void>
  {
    ...
    {
      paramVoid = new Intent(SplashActivity.this, SplashActivity.getHomeScreenClass(SplashActivity.this.getApplicationContext()));
      SplashActivity.this.startActivity(paramVoid);
