...
class SystemObserver
{
  ...
  public String getURIScheme(String paramString)
  {
    ...
    //   4: astore_2
    //   5: aload_0
    //   6: invokespecial 294	io/branch/referral/SystemObserver:isLowOnMemory	()Z
    //   9: ifne +152 -> 161
    //   12: aload_0
    //   13: getfield 42	io/branch/referral/SystemObserver:context_	Landroid/content/Context;
    //   16: invokevirtual 111	android/content/Context:getPackageManager	()Landroid/content/pm/PackageManager;
    //   19: astore 4
    //   21: aload_3
    //   22: astore_2
    //   23: aload 4
    //   25: aload_1
    //   26: iconst_0
    //   27: invokevirtual 298	android/content/pm/PackageManager:getApplicationInfo	(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    //   30: getfield 206	android/content/pm/ApplicationInfo:publicSourceDir	Ljava/lang/String;
    //   33: astore 4
    //   35: aconst_null
    //   36: astore 6
    //   38: aconst_null
    ...
    //   48: aconst_null
    //   49: astore 5
    //   51: new 300	java/util/jar/JarFile
    //   54: dup
    //   55: aload 4
    //   57: invokespecial 303	java/util/jar/JarFile:<init>	(Ljava/lang/String;)V
    //   60: astore 4
    //   62: aload 8
    //   64: astore_1
    //   65: aload 7
    ...
    //   70: aload 4
    //   72: ldc_w 305
    //   75: invokevirtual 309	java/util/jar/JarFile:getEntry	(Ljava/lang/String;)Ljava/util/zip/ZipEntry;
    //   78: invokevirtual 313	java/util/jar/JarFile:getInputStream	(Ljava/util/zip/ZipEntry;)Ljava/io/InputStream;
    //   81: astore 5
    //   83: aload 5
    //   85: astore_1
    //   86: aload 5
    //   88: astore_2
    //   89: aload 5
    //   91: invokevirtual 318	java/io/InputStream:available	()I
    //   94: newarray byte
    //   96: astore 6
    //   98: aload 5
    //   100: astore_1
    ...
    //   104: aload 5
    //   106: aload 6
    //   108: invokevirtual 322	java/io/InputStream:read	([B)I
    //   111: pop
    //   112: aload 5
    //   114: astore_1
    //   115: aload 5
    //   117: astore_2
    //   118: new 324	io/branch/referral/ApkParser
    //   121: dup
    //   122: invokespecial 325	io/branch/referral/ApkParser:<init>	()V
    //   125: aload 6
    //   127: invokevirtual 329	io/branch/referral/ApkParser:decompressXML	([B)Ljava/lang/String;
    //   130: astore 6
    //   132: aload 6
    //   134: astore_1
    //   135: aload 5
    ...
    //   141: astore_2
    //   142: aload 5
    //   144: invokevirtual 332	java/io/InputStream:close	()V
    //   147: aload 4
    //   149: ifnull +10 -> 159
    //   152: aload_1
    //   153: astore_2
    //   154: aload 4
    //   156: invokevirtual 333	java/util/jar/JarFile:close	()V
    //   159: aload_1
    //   160: astore_2
    //   161: aload_2
    //   162: areturn
    ...
    //   177: astore_2
    //   178: aload 4
    //   180: invokevirtual 332	java/io/InputStream:close	()V
    //   183: aload_3
    //   184: astore_2
    //   185: aload_1
    //   186: ifnull -25 -> 161
    ...
    //   190: astore_2
    //   191: aload_1
    //   192: invokevirtual 333	java/util/jar/JarFile:close	()V
    //   195: ldc 16
    //   197: areturn
    //   198: astore_1
    //   199: ldc 16
    ...
    //   216: astore_2
    //   217: aload 4
    //   219: invokevirtual 332	java/io/InputStream:close	()V
    //   222: aload 5
    //   224: ifnull +10 -> 234
    //   227: aload_3
    //   228: astore_2
    //   229: aload 5
    //   231: invokevirtual 333	java/util/jar/JarFile:close	()V
    //   234: aload_3
    //   235: astore_2
    //   236: aload_1
    //   237: athrow
