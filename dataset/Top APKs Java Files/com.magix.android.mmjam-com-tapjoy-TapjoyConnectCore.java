...
public class TapjoyConnectCore
{
  ...
  {
    TJConnectListener localTJConnectListener = aT;
    if (localTJConnectListener != null) {
      localTJConnectListener.onConnectFailure();
    }
  }
  ...
  private static Map f()
  {
    ...
    int i1 = a;
    if (i1 != 0) {
      TapjoyUtil.safePut((Map)localObject1, "packaged_gps_version", Integer.toString(i1), true);
    }
    i1 = b;
    if (i1 != 0) {
      TapjoyUtil.safePut((Map)localObject1, "device_gps_version", Integer.toString(i1), true);
    }
    localObject2 = o;
    if ((localObject2 != null) && (((String)localObject2).length() != 0) && (System.currentTimeMillis() - Z <= 1800000L)) {
  ...
  private static void k()
  {
    for (;;)
    {
      try
      {
        localObject1 = Arrays.asList(ac.getPackageInfo(g.getPackageName(), 1).activities);
  ...
  public static void setAdTrackingEnabled()
  {
    if (gi.a() != null)
    {
      localObject = gi.a();
      boolean bool;
      if (((gi)localObject).c == null) {
        bool = false;
      } else {
        bool = ((gi)localObject).c.booleanValue();
      }
      if (bool)
      {
        d = false;
    ...
    if (localObject != null) {
      d = ((TapjoyGpsHelper)localObject).isAdTrackingEnabled();
    }
  }
