...
public class CWPackagesUtil
{
  ...
  public static String getActivatedIMEPackageName(Context paramContext)
  {
    try
    {
  ...
  public static String getActivatedTheme(Context paramContext)
  {
  ...
  public static CWPackagesInstalled getInstalledThemePackages(Context paramContext)
  {
    ...
    try
    {
      paramContext = (CWPackagesInstalled)LoganSquare.parse(paramContext, CWPackagesInstalled.class);
      return paramContext;
    }
    catch (r paramContext)
    {
      return null;
    }
  ...
  public static List<PackageInfo> queryInstalledPackages(Context paramContext)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 129	android/content/Context:getPackageManager	()Landroid/content/pm/PackageManager;
    //   4: astore_2
    //   5: aload_2
    //   6: iconst_0
    //   7: invokevirtual 152	android/content/pm/PackageManager:getInstalledPackages	(I)Ljava/util/List;
    //   10: astore_0
    //   11: aload_0
    //   12: areturn
    //   13: astore_0
    //   14: aload_0
    //   15: invokevirtual 73	java/lang/Exception:printStackTrace	()V
    //   18: new 154	java/util/ArrayList
    //   21: dup
    //   22: invokespecial 155	java/util/ArrayList:<init>	()V
    //   25: astore_3
    //   26: aconst_null
    //   27: astore_0
    //   28: invokestatic 161	java/lang/Runtime:getRuntime	()Ljava/lang/Runtime;
    //   31: ldc -93
    //   33: invokevirtual 167	java/lang/Runtime:exec	(Ljava/lang/String;)Ljava/lang/Process;
    //   36: astore 4
    //   38: new 169	java/io/BufferedReader
    //   41: dup
    //   42: new 171	java/io/InputStreamReader
    //   45: dup
    //   46: aload 4
    //   48: invokevirtual 177	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   51: invokespecial 180	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   54: invokespecial 183	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   57: astore_1
    //   58: aload_1
    //   59: astore_0
    //   60: aload_1
    //   61: invokevirtual 186	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   64: astore 5
    //   66: aload 5
    //   68: ifnull +60 -> 128
    //   71: aload_1
    ...
    //   77: aload 5
    //   79: bipush 58
    //   81: invokevirtual 190	java/lang/String:indexOf	(I)I
    //   84: iconst_1
    //   85: iadd
    //   86: invokevirtual 194	java/lang/String:substring	(I)Ljava/lang/String;
    //   89: iconst_1
    //   90: invokevirtual 134	android/content/pm/PackageManager:getPackageInfo	(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    //   112: ifnull -101 -> 11
    //   115: aload_1
    //   116: invokevirtual 200	java/io/BufferedReader:close	()V
    //   119: aload_3
    //   120: areturn
    //   121: astore_0
    //   122: aload_0
    //   123: invokevirtual 73	java/lang/Exception:printStackTrace	()V
    //   126: aload_3
    //   127: areturn
    //   128: aload_1
    //   129: astore_0
    //   130: aload 4
    //   132: invokevirtual 203	java/lang/Process:waitFor	()I
    //   135: pop
    //   136: aload_3
    //   137: astore_0
    //   138: aload_1
    //   139: ifnull -128 -> 11
    //   142: aload_1
    //   143: invokevirtual 200	java/io/BufferedReader:close	()V
    //   146: aload_3
    //   147: areturn
    //   148: astore_0
    //   149: aload_0
    //   150: invokevirtual 73	java/lang/Exception:printStackTrace	()V
    //   153: aload_3
    //   154: areturn
    //   155: astore_2
    //   156: aload_0
    ...
    //   161: ifnull +7 -> 168
    //   164: aload_1
    //   165: invokevirtual 200	java/io/BufferedReader:close	()V
    //   168: aload_0
    //   169: athrow
    //   170: astore_1
    //   171: aload_1
    //   172: invokevirtual 73	java/lang/Exception:printStackTrace	()V
    //   175: goto -7 -> 168
    //   178: astore_2
    //   179: aload_0
    //   180: astore_1
  ...
  public static void saveInstalledTheme(Context paramContext, CWPackagesInstalled paramCWPackagesInstalled)
  {
    ...
    try
    {
      paramCWPackagesInstalled = LoganSquare.serialize(paramCWPackagesInstalled);
