  ...
  implements TJWebViewJSInterfaceListener
{
  ...
  public void alert(JSONObject paramJSONObject, final String paramString)
  {
    ...
    //   122: aload 7
    //   124: ifnull +189 -> 313
    //   127: new 243	android/app/AlertDialog$Builder
    //   130: dup
    //   131: aload 7
    //   133: invokespecial 246	android/app/AlertDialog$Builder:<init>	(Landroid/content/Context;)V
    //   136: aload 5
    //   138: invokevirtual 250	android/app/AlertDialog$Builder:setTitle	(Ljava/lang/CharSequence;)Landroid/app/AlertDialog$Builder;
    //   141: aload_1
    //   142: invokevirtual 253	android/app/AlertDialog$Builder:setMessage	(Ljava/lang/CharSequence;)Landroid/app/AlertDialog$Builder;
    //   145: invokevirtual 257	android/app/AlertDialog$Builder:create	()Landroid/app/AlertDialog;
    //   148: astore_1
    //   149: aload 6
    //   151: ifnull +146 -> 297
    //   154: aload 6
    //   156: invokevirtual 263	org/json/JSONArray:length	()I
    //   159: ifne +6 -> 165
    //   162: goto +135 -> 297
    //   165: new 265	java/util/ArrayList
    //   168: dup
    //   169: invokespecial 266	java/util/ArrayList:<init>	()V
    //   172: astore 5
    //   174: iconst_0
    //   175: istore 4
    //   177: iload 4
    //   179: aload 6
    //   181: invokevirtual 263	org/json/JSONArray:length	()I
    ...
    //   228: aload 6
    //   230: iload 4
    //   232: invokevirtual 269	org/json/JSONArray:getString	(I)Ljava/lang/String;
    //   235: invokevirtual 273	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   238: pop
    //   239: goto +10 -> 249
    //   242: astore 7
    //   244: aload 7
    //   246: invokevirtual 241	java/lang/Exception:printStackTrace	()V
    //   249: aload_1
    //   250: iload_3
    //   251: aload 5
    //   253: iload 4
    //   255: invokevirtual 277	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   258: checkcast 279	java/lang/CharSequence
    //   261: new 8	com/tapjoy/TJAdUnitJSBridge$1
    //   264: dup
    //   265: aload_0
    //   266: aload_2
    //   267: invokespecial 282	com/tapjoy/TJAdUnitJSBridge$1:<init>	(Lcom/tapjoy/TJAdUnitJSBridge;Ljava/lang/String;)V
    //   270: invokevirtual 288	android/app/AlertDialog:setButton	(ILjava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)V
    //   273: iload 4
    //   275: iconst_1
    //   276: iadd
    //   277: istore 4
    ...
    //   282: aload_1
    //   283: iconst_0
    //   284: invokevirtual 291	android/app/AlertDialog:setCancelable	(Z)V
    //   287: aload_1
    //   288: iconst_0
    //   289: invokevirtual 294	android/app/AlertDialog:setCanceledOnTouchOutside	(Z)V
    //   292: aload_1
    //   293: invokevirtual 297	android/app/AlertDialog:show	()V
    //   296: return
    //   297: aload_0
    //   298: aload_2
    //   299: iconst_1
    ...
    //   303: dup
    //   304: iconst_0
    //   305: getstatic 234	java/lang/Boolean:FALSE	Ljava/lang/Boolean;
    //   308: aastore
    //   309: invokevirtual 238	com/tapjoy/TJAdUnitJSBridge:invokeJSCallback	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   312: return
    //   313: ldc 116
    //   315: ldc_w 299
    //   318: invokestatic 210	com/tapjoy/TapjoyLog:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   321: return
