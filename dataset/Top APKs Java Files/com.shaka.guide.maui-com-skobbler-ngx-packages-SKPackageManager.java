...
public final class SKPackageManager
{
  ...
  public final SKPackageURLInfo getURLInfoForPackageWithCode(String paramString)
  {
    if (SKMaps.getInstance().isSKMapsInitialized())
    {
      Object localObject = SKMaps.getInstance().getMapInitSettings();
      if (paramString != null)
      {
        ...
        for (String str1 = ((SKMapsInitSettings)localObject).getMapDetailLevel();; str1 = "full/")
        {
          String str3 = ((SKMapsInitSettings)localObject).getAppName();
          localObject = ((SKMapsInitSettings)localObject).getAppVersion();
          String str4 = Uri.encode(Build.VERSION.RELEASE);
          localObject = "?appName=" + Uri.encode(str3) + "&appVer=" + (String)localObject + "&osName=android&osVersion=" + str4 + "&uid=" + SKMaps.getInstance().getUserId();
          str1 = "http://" + str2 + "." + "http://cache.sko.fm/ngxmaps/versioned/".replaceAll("http://", "") + str1 + "v1/" + i + "/package/";
          localSKPackageURLInfo.setTexturesURL(str1 + "textures/" + paramString + ".txg" + (String)localObject);
          localSKPackageURLInfo.setNameBrowserFilesURL(str1 + "nb_files/" + paramString + ".zip" + (String)localObject);
          localSKPackageURLInfo.setMapURL(str1 + paramString + ".skm" + (String)localObject);
          localSKPackageURLInfo.setNgiDatFileURL(str1 + "nb_files/" + paramString + ".ngi.dat" + (String)localObject);
          localSKPackageURLInfo.setNgiFileURL(str1 + "nb_files/" + paramString + ".ngi" + (String)localObject);
