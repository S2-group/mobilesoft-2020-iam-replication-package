...
public class PackageUtils
{
  ...
  {
    Object localObject = this.context.getPackageManager().getInstalledApplications(128);
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      {
        int i = getCommunityIdFromPackageName(localApplicationInfo.packageName);
    ...
    return (AminoPackage[])localArrayList.toArray(new AminoPackage[localArrayList.size()]);
  }
