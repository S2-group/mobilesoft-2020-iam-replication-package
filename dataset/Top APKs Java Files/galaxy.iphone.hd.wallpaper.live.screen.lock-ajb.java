...
public class ajb
{
  ...
  {
    return (getAppIconBitmap(paramString) != null) && (!TextUtils.isEmpty(getNameByPackage(ajg.getInstance().getGlobalContext(), paramString)));
  }
  ...
  public static ArrayList<String> getAllRunningListSwipe(Context paramContext)
  {
    ...
    //   19: astore 6
    //   21: invokestatic 73	akg:needHideInRecent	()Z
    //   24: istore 4
    //   26: aload_0
    //   27: invokestatic 79	ajq:getPackageName	(Landroid/content/Context;)Ljava/lang/String;
    //   30: astore_0
    //   31: iconst_0
    //   32: istore_3
    //   33: iload_3
  ...
  public static Bitmap getAppIconBitmap(String paramString)
  {
    ...
    try
    {
      paramString = ajr.getInstance().loadImage(paramString, ajg.getInstance().getGlobalContext());
      return paramString;
    }
  ...
  public static ArrayList<String> getRecentAppList()
  {
    ...
    ArrayList localArrayList = getAllRunningListSwipe(ajg.getInstance().getGlobalContext());
