package com.pixelapp.tattoodesigns.at;
...
public class k
{
  ...
  public static String a(Activity paramActivity, ImageData paramImageData)
  {
    for (;;)
    {
      try
      {
        ...
        paramActivity.append("Tattoo on MyPic_");
        ...
        paramImageData = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES), "Pixel Apps");
        ...
        if (!bool3)
        {
          ...
          g.b("savePicture", paramActivity.toString());
          paramImageData = new File(str2, "Pixel Apps");
          paramActivity = paramImageData;
          bool1 = bool2;
  ...
  {
    g.b(a, "canReadWritePermission");
    String str = Environment.getExternalStorageDirectory().getAbsolutePath();
    Object localObject3 = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES), "Pixel Apps");
    ...
    if (!((File)localObject3).exists())
    {
      ...
      if (!bool)
      {
        ...
        g.b("savePicture", ((StringBuilder)localObject1).toString());
        localObject3 = new File(str, "Pixel Apps");
    ...
    if (bool)
    {
      ...
      g.b((String)localObject1, ((StringBuilder)localObject3).toString());
    ...
    if (paramBoolean)
    {
      try
      {
        com.pixelapp.tattoodesigns.as.a.a(paramActivity, "Google Play Store", "Sd Card Scanner", paramActivity.getString(2131624009));
      }
      catch (Exception localException)
      {
        g.a(localException);
      ...
      try
      {
        ...
        ((AlertDialog.Builder)localObject2).setMessage(2131624132);
        ((AlertDialog.Builder)localObject2).setCancelable(true);
        ((AlertDialog.Builder)localObject2).setPositiveButton(2131624009, new DialogInterface.OnClickListener()
        {
        ...
        ((AlertDialog.Builder)localObject2).setNegativeButton(2131623980, new DialogInterface.OnClickListener()
        {
          public void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
          {
            if (paramAnonymousDialogInterface != null) {
        ...
        ((AlertDialog)localObject2).getButton(-1).setTextColor(paramActivity.getResources().getColor(2131099683));
        ((AlertDialog)localObject2).getButton(-2).setTextColor(paramActivity.getResources().getColor(2131099787));
        return "";
      }
      catch (Exception paramActivity)
      {
  ...
  {
    String str = Environment.getExternalStorageDirectory().getAbsolutePath();
    Object localObject2 = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES), "Pixel Apps");
    ...
    if (!bool3)
    {
      ...
      if (!bool1)
      {
        ...
        ((StringBuilder)localObject1).append(" not success");
        g.b("savePicture", ((StringBuilder)localObject1).toString());
        localObject2 = new File(str, "Pixel Apps");
    ...
    if (bool1)
    {
      ...
      g.b("savePicture", ((StringBuilder)localObject2).toString());
      localObject2 = new StringBuilder();
      ...
      try
      {
        ...
        try
        {
          ...
          g.b("savePicture", paramBitmap.toString());
          paramBitmap = paramString1.getAbsolutePath();
          return paramBitmap;
        }
        catch (Exception paramBitmap)
        {
          g.b("savePicture", "cannot save picture");
    ...
    g.b("savePicture", paramContext.toString());
    return null;
  }
  ...
  public static ArrayList<String> a()
  {
    ...
    String str = Environment.getExternalStorageDirectory().getAbsolutePath();
    File localFile = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES), "Pixel Apps");
    ...
    if (!bool3)
    {
      ...
      if (!bool1)
      {
        ...
        g.b("savePicture", ((StringBuilder)localObject).toString());
        localFile = new File(str, "Pixel Apps");
    ...
    if ((bool1) && (((File)localObject).isDirectory()))
    {
      ...
      {
        if ((localObject[i].getAbsolutePath().contains("Tattoo on MyPic")) && (localObject[i].getName().startsWith("Tattoo on MyPic"))) {
  ...
  public static void a(Activity paramActivity, com.pixelapp.tattoodesigns.ct.a paramA, boolean paramBoolean)
  {
    try
    {
      com.pixelapp.tattoodesigns.ap.a localA = new com.pixelapp.tattoodesigns.ap.a();
      paramA.a(b(paramActivity, "USER_AGENT", ""));
      paramA.a(60000);
      paramA.a(true);
      if ((paramBoolean) && (b(paramActivity, "token", "").length() > 0)) {
        paramA.a(localA.l(), b(paramActivity, "token", ""));
      }
      paramA.a(localA.n(), localA.o());
      paramA.a(localA.k(), paramActivity.getPackageName());
      paramA.a(localA.p(), c(paramActivity));
      paramA.a(localA.m(), "1");
      return;
    }
    catch (Exception paramActivity)
  ...
  public static void a(Context paramContext, Intent paramIntent, String paramString)
  {
    ...
    while (paramContext.hasNext())
    {
      ...
      g.b("packageName:", localStringBuilder.toString());
  ...
  public static void a(Context paramContext, File paramFile)
  {
    try
    {
      if (paramFile.exists())
      {
        g.b("removeFromDownload", "exists");
        if (paramFile.delete()) {
          g.b("removeFromDownload", " deleted from download folder");
        }
      }
      else
      {
        g.b("removeFromDownload", " file not exist to delete from download folder");
      }
  ...
  public static boolean b(Activity paramActivity, ImageData paramImageData)
  {
    ...
    {
      StringBuilder localStringBuilder = new StringBuilder();
      localStringBuilder.append("Tattoo on MyPic_");
  ...
  public static File f()
  {
    for (;;)
    {
      ...
      try
      {
        ...
        String str2 = Environment.getExternalStorageDirectory().getAbsolutePath();
        localFile = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES), "Pixel Apps");
        boolean bool3 = localFile.exists();
        boolean bool2 = true;
        ...
        if (!bool3)
        {
          ...
          ((StringBuilder)localObject1).append(" not success");
          g.b("savePicture", ((StringBuilder)localObject1).toString());
          localFile = new File(str2, "Pixel Apps");
          localObject1 = localFile;
          bool1 = bool2;
          if (!localFile.exists())
          {
