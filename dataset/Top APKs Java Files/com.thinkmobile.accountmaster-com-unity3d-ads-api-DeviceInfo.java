...
public class DeviceInfo
{
  ...
  public static void getDeviceMaxVolume(Integer paramInteger, WebViewCallback paramWebViewCallback)
  {
    ...
    default: 
      ...
      return;
    case -1: 
      localDeviceError = DeviceError.APPLICATION_CONTEXT_NULL;
      paramInteger = new Object[1];
      paramInteger[0] = Integer.valueOf(i);
      break;
    case -2: 
      localDeviceError = DeviceError.AUDIOMANAGER_NULL;
      paramInteger = new Object[1];
      paramInteger[0] = Integer.valueOf(i);
    }
    paramWebViewCallback.error(localDeviceError, paramInteger);
  }
  ...
  {
    switch (DeviceInfo.2.$SwitchMap$com$unity3d$ads$api$DeviceInfo$StorageType[paramStorageType.ordinal()])
    {
    default: 
  ...
  public static void getPackageInfo(String paramString, WebViewCallback paramWebViewCallback)
  {
    ...
    try
    {
      ...
      try
      {
        localJSONObject.put("installer", ((PackageManager)localObject).getInstallerPackageName(paramString));
      ...
      {
        paramString = DeviceError.JSON_ERROR;
        localObject = new Object[1];
        localObject[0] = localJSONException.getMessage();
      }
    }
    ...
    localDeviceError = DeviceError.APPLICATION_INFO_NOT_AVAILABLE;
    Object localObject = new Object[1];
    localObject[0] = paramString;
    paramString = localDeviceError;
    paramWebViewCallback.error(paramString, (Object[])localObject);
    return;
  ...
  public static void getRingerMode(WebViewCallback paramWebViewCallback)
  {
    ...
    paramWebViewCallback.error(localDeviceError, arrayOfObject);
  }
