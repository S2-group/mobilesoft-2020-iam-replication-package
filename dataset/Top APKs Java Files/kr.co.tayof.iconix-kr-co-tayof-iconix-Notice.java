  ...
  extends Activity
{
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.webnotice = ((WebView)findViewById(2131361879));
    this.exit = ((ImageView)findViewById(2131361881));
    this.check = ((CheckBox)findViewById(2131361880));
  ...
  public void onStop()
  {
    ...
    if (this.check.isChecked())
    {
      ...
      localEditor.putString("nowday", TayoIntro.nowday());
      localEditor.commit();
    }
