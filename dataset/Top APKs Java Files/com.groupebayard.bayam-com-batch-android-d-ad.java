...
public final class ad
{
  ...
  public static String a(String paramString, Context paramContext)
  {
    do
    {
      ...
      return a();
      return aj.a(new Date(c(paramContext).longValue()));
      return aj.a(new Date(d(paramContext).longValue()));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        for (;;)
        {
          ...
          if (("com.google".equals(paramContext.name)) && (localPattern.matcher(paramContext.name).matches())) {
