  ...
  implements View.OnClickListener
{
  ...
  private static final String INTENT_ACTION = "com.kauf.intent.action.applist";
  private static final String PATH_LOCAL = "marketing/applist/";
  private static final String PATH_SERVER = "http://applist.android.maxpedia.org/android/ad/applist/";
  ...
  private String getParams()
  {
    ...
    localStringBuilder.append("app_name~§~" + getString(2131230763).replace(" ", "") + "~§§~");
    localStringBuilder.append("app_id~§~" + getPackageName() + "~§§~");
    localStringBuilder.append("app_la~§~" + Locale.getDefault().getLanguage() + "~§§~");
    localStringBuilder.append("app_ver~§~" + getString(2131230764) + "~§§~");
  ...
  private boolean isIntentAvailable(Intent paramIntent)
  {
  ...
  private void pushData(final String paramString)
  {
    new Thread()
    {
      public void run()
      {
        try
        {
          URLConnection localURLConnection = new URL("http://applist.android.maxpedia.org/android/ad/applist/statistic.pl?" + paramString).openConnection();
    ...
    for (;;)
    {
      if (!((Iterator)localObject1).hasNext())
      {
        ...
        if (this.appsInstalled.containsKey(((ArrayList)this.itemID.get(paramInt)).get(i)))
        {
          ...
          ((ImageView)localObject4).setImageResource(2130837979);
          ((LinearLayout)localObject3).addView((View)localObject4);
          ((FrameLayout)localObject2).addView((View)localObject3);
        }
  ...
  private void setImage(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    new DownloadIconAsync(null).execute(new String[] { "http://applist.android.maxpedia.org/android/ad/applist/", str, String.valueOf(paramInt3) });
  }
  ...
  {
    if (paramView.getId() == 2131492866) {
      finish();
    }
    do
    {
      return;
      paramView = paramView.getTag().toString().split("~§~");
    } while (paramView.length != 2);
    int i = Integer.valueOf(paramView[0]).intValue();
    int j = Integer.valueOf(paramView[1]).intValue();
    paramView = (String)((ArrayList)this.itemID.get(i)).get(j);
    Object localObject3;
    Object localObject1;
    if (!paramView.equals(getPackageName()))
    {
      if (!this.appsInstalled.containsKey(paramView)) {
        break label740;
      }
      ...
      if (isIntentAvailable((Intent)this.appsInstalled.get(paramView)))
      {
        localObject1 = new StringBuilder();
        ((StringBuilder)localObject1).append("target=app");
        ((StringBuilder)localObject1).append("&click=" + URLEncoder.encode(paramView));
        ((StringBuilder)localObject1).append("&category=default");
        ...
        pushData(((StringBuilder)localObject1).toString());
        startActivity((Intent)this.appsInstalled.get(paramView));
      }
    }
    label248:
    label315:
    ...
    do
    {
      do
      {
        ...
        if (localObject3.length == 2) {
          ((StringBuilder)localObject1).append("&" + localObject3[0] + "=" + URLEncoder.encode(localObject3[1]));
        }
        i += 1;
        break;
        localObject1 = new Intent("com.kauf.intent.action.applist." + (String)localObject3);
        ((Intent)localObject1).addCategory("android.intent.category.DEFAULT");
        ((Intent)localObject1).setFlags(268435456);
        ((Intent)localObject1).addFlags(67108864);
        if (isIntentAvailable((Intent)localObject1))
        {
          localObject2 = new StringBuilder();
          ((StringBuilder)localObject2).append("target=app");
          ((StringBuilder)localObject2).append("&click=" + URLEncoder.encode(paramView));
          ((StringBuilder)localObject2).append("&category=" + URLEncoder.encode((String)localObject3));
          paramView = this.params.split("~§§~");
          j = paramView.length;
          i = 0;
          for (;;)
          {
            if (i >= j)
            {
              pushData(((StringBuilder)localObject2).toString());
              startActivity((Intent)localObject1);
              break;
            }
            localObject3 = paramView[i].split("~§~");
            if (localObject3.length == 2) {
              ((StringBuilder)localObject2).append("&" + localObject3[0] + "=" + URLEncoder.encode(localObject3[1]));
            }
            i += 1;
          }
        }
      } while (!isIntentAvailable((Intent)this.appsInstalled.get(paramView)));
      localObject1 = new StringBuilder();
      ((StringBuilder)localObject1).append("target=app");
      ((StringBuilder)localObject1).append("&click=" + URLEncoder.encode(paramView));
      ((StringBuilder)localObject1).append("&category=default");
      ...
      localObject1 = new Intent("android.intent.action.VIEW", Uri.parse("market://details?id=" + paramView));
      ((Intent)localObject1).setFlags(524288);
    } while (!isIntentAvailable((Intent)localObject1));
    Object localObject2 = new StringBuilder();
    ((StringBuilder)localObject2).append("target=market");
    ((StringBuilder)localObject2).append("&click=" + URLEncoder.encode(paramView));
    paramView = this.params.split("~§§~");
    j = paramView.length;
    i = 0;
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.frameLayout = ((FrameLayout)findViewById(2131492864));
    this.linearLayout = ((LinearLayout)findViewById(2131492865));
    findViewById(2131492866).setOnClickListener(this);
    ...
    for (paramBundle = "unknown";; paramBundle = getIntent().getStringExtra("CallBy"))
    {
      ...
      new DownloadFileAsync(null).execute(new String[] { "http://applist.android.maxpedia.org/android/ad/applist/applist.pl", this.params });
      return;
    }
  }
