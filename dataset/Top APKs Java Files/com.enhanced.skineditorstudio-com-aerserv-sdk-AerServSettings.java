...
{
  private static final String ADVERTISING_ID_KEY;
  private static final String APPS_KEYS;
  ...
  private static final String GET_DEVICE_INFO_KEY;
  private static final String HTTP_TIMEOUT_KEY;
  ...
  private static final String UNINSTALLED_KEY;
  private static final String UPDATE_SERVER_URL;
  private static final String VPAID_KEY;
  ...
  static
  {
    ...
    GET_DEVICE_INFO_KEY = "update";
    UPDATE_SERVER_URL = "https://dmp.aerserv.com/update";
    UNINSTALLED_KEY = "uninstalled";
    ADVERTISING_ID_KEY = "adId";
    BUNDLE_ID_KEY = "bundleId";
    HTTP_TIMEOUT_KEY = "requestTimeout";
    VPAID_KEY = "vpaid";
    LOG_TAG = AerServSettings.class.getSimpleName();
    configJson = null;
