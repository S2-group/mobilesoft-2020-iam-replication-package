...
public class NoOne
{
  ...
  public static void iapTrack(Context paramContext)
  {
    ...
    try
    {
      localObject = decrypt("sdkbox", "881E2A41A6B8D19E0C9C48172026561BF5604BE3579BAEFEA9A57236A2EC9D3288D179401B2F60FEDBF1C00114508DE9B2839126F5A0E4098A1AEB141533682B");
      str = decrypt("sdkbox", "881E2A41A6B8D19E0C9C48172026561BCAB2FE496BF519C0216CF975CBEAE9FD");
    ...
    new Thread(new Runnable()
    {
      public void run()
      {
        ...
        for (;;)
        {
          try
          {
            localObject1 = NoOne.getGetPurchasesMethod(NoOne.iabService.getClass());
            if (localObject1 == null) {
              return;
            }
            ((Method)localObject1).setAccessible(true);
            localObject3 = (Bundle)((Method)localObject1).invoke(NoOne.iabService, new Object[] { Integer.valueOf(3), this.val$ctx.getPackageName(), "inapp", null });
        ...
        if (((Bundle)localObject1).getInt("RESPONSE_CODE") == 0)
        {
          ...
          ((JSON)localObject2).put("boughtItems", JSON.initializeFromObject(localObject1));
  ...
  public static String showAccountInfoRefacotr(Context paramContext)
  {
    ...
    try
    {
      ...
      Object localObject5 = decrypt("sdkbox", "58B41A14C6E43D755572D84DC22BC799BB656AA5B05E448974C7A162023EBC63");
      localObject1 = localObject2;
      Object localObject4 = decrypt("sdkbox", "58B41A14C6E43D755572D84DC22BC79963A872D0728ADC86AD4E037B47B1C793");
      localObject1 = localObject2;
      String str2 = decrypt("sdkbox", "4F717A0C25378C2A39E08F8BAE93F1D2");
      localObject1 = localObject2;
      ...
      localObject1 = localObject2;
      localObject5 = Class.forName((String)localObject5);
      int i = 0;
      localObject1 = localObject2;
      paramContext = ((Class)localObject5).getMethod(str2, new Class[] { Context.class }).invoke(null, new Object[] { paramContext });
      localObject1 = localObject2;
