...
public final class j
{
      ...
      if (((((DownloadData)localObject4).d() != 0) || (i != 0)) && (i != 1) && (i != 3))
      {
          ...
          if (localObject3 != null)
          {
            ...
            while (i < ((List)localObject4).size())
            {
              ...
              if (!((PackageInfo)localObject6).applicationInfo.sourceDir.startsWith("/system/app"))
              {
                ...
                {
                  new j.a(paramActivity).a(2131560278).b(paramActivity.getString(2131559920, new Object[] { paramString })).a(2131558696, new l(paramActivity, (String)localObject1)).b(2131558566, new k()).b();
                  i = j;
                  break label609;
                }
              }
        ...
        else
        {
          if ((!ApplicationInit.l) && (!paramBoolean2))
          {
            ...
            ((TextView)localObject1).setTextColor(ApplicationInit.h.getResources().getColor(2131034246));
            ...
            if ((paramB.g() != null) && (paramB.g().equals("autoupgrade"))) {
              ((TextView)localObject1).setText(2131560399);
            } else {
            ...
            paramB = new g(paramActivity, 2131559102, paramString, 2131558566, 2131559448);
  ...
  public static String b(String paramString, int paramInt)
  {
    ...
    {
      paramString = ApplicationInit.h.getString(2131560021, new Object[] { paramString });
    }
    else
    {
    ...
    if ((paramInt != 13) && (paramInt != 9)) {
      return ApplicationInit.h.getString(2131558751, new Object[] { paramString, DownloadData.d(paramInt) });
    }
    return ApplicationInit.h.getString(2131560066, new Object[] { paramString });
  }
