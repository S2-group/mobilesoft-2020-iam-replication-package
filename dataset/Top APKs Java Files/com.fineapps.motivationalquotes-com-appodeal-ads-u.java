...
public class u
{
  ...
  JSONObject b(SharedPreferences paramSharedPreferences)
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 748	com/appodeal/ads/u:o	Lorg/json/JSONObject;
    //   6: ifnonnull +634 -> 640
    //   9: new 201	org/json/JSONObject
    //   12: dup
    //   13: invokespecial 749	org/json/JSONObject:<init>	()V
    //   16: putstatic 748	com/appodeal/ads/u:o	Lorg/json/JSONObject;
    //   19: aload_0
    //   20: getfield 64	com/appodeal/ads/u:b	Landroid/content/Context;
    //   23: invokevirtual 558	android/content/Context:getPackageManager	()Landroid/content/pm/PackageManager;
    //   26: astore 7
    //   28: aload_1
    //   29: ldc_w 751
    //   32: aconst_null
    //   33: invokeinterface 448 3 0
    //   38: astore 8
    //   40: aload 8
    //   42: ifnonnull +8 -> 50
    //   45: ldc 2
    ...
    //   51: ldc_w 753
    //   54: aconst_null
    //   55: invokeinterface 448 3 0
    //   60: astore 6
    //   62: aload_1
    //   63: ldc_w 755
    //   66: aconst_null
    //   67: invokeinterface 448 3 0
    //   72: astore_3
    //   73: aload_3
    //   74: astore 5
    //   76: aload 6
    ...
    //   111: astore 4
    //   113: ldc_w 757
    //   116: invokestatic 763	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   119: pop
    //   120: aload_3
    //   121: astore 5
    //   123: aload 6
    ...
    //   130: ldc_w 767
    //   133: iconst_1
    //   134: anewarray 759	java/lang/Class
    //   137: dup
    //   138: iconst_0
    //   139: ldc_w 554
    //   142: aastore
    //   143: invokevirtual 771	java/lang/Class:getDeclaredMethod	(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
    //   146: pop
    //   147: aload_3
    //   148: astore 5
    //   150: aload 6
    ...
    //   158: invokestatic 774	com/google/android/gms/ads/identifier/AdvertisingIdClient:getAdvertisingIdInfo	(Landroid/content/Context;)Lcom/google/android/gms/ads/identifier/AdvertisingIdClient$Info;
    //   161: astore 9
    //   163: aload_3
    //   164: astore 5
    //   166: aload 6
    //   168: astore 4
    //   170: aload 9
    //   172: invokevirtual 779	com/google/android/gms/ads/identifier/AdvertisingIdClient$Info:getId	()Ljava/lang/String;
    //   175: astore 6
    //   177: aload_3
    //   178: astore 5
    //   180: aload 6
    //   182: astore 4
    //   184: aload 9
    //   186: invokevirtual 782	com/google/android/gms/ads/identifier/AdvertisingIdClient$Info:isLimitAdTrackingEnabled	()Z
    //   189: ifeq +510 -> 699
    //   192: ldc_w 784
    //   195: astore_3
    //   196: aload_3
    ...
    //   276: aload 6
    //   278: aastore
    //   279: invokestatic 743	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   282: invokestatic 677	com/appodeal/ads/Appodeal:a	(Ljava/lang/String;)V
    //   285: aload 6
    //   287: astore_1
    //   288: aload_1
    ...
    //   296: invokestatic 792	com/appodeal/ads/ao:l	(Landroid/content/Context;)Ljava/lang/String;
    //   299: astore_1
    //   300: getstatic 748	com/appodeal/ads/u:o	Lorg/json/JSONObject;
    //   303: ldc_w 794
    //   306: aload 8
    //   308: invokevirtual 290	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   311: pop
    //   312: getstatic 748	com/appodeal/ads/u:o	Lorg/json/JSONObject;
    //   315: ldc_w 589
    //   318: getstatic 797	android/os/Build$VERSION:RELEASE	Ljava/lang/String;
    //   321: invokevirtual 290	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   324: pop
    //   325: getstatic 748	com/appodeal/ads/u:o	Lorg/json/JSONObject;
    //   328: ldc_w 799
    //   331: getstatic 699	android/os/Build$VERSION:SDK_INT	I
    //   334: invokevirtual 653	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   337: pop
    //   338: getstatic 748	com/appodeal/ads/u:o	Lorg/json/JSONObject;
    //   341: ldc_w 801
    //   344: ldc_w 803
    //   347: invokevirtual 290	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   350: pop
    //   351: aload_0
    //   352: getfield 64	com/appodeal/ads/u:b	Landroid/content/Context;
    //   355: invokevirtual 806	android/content/Context:getPackageName	()Ljava/lang/String;
    //   358: astore 4
    //   360: getstatic 748	com/appodeal/ads/u:o	Lorg/json/JSONObject;
    //   363: ldc_w 808
    //   366: aload 4
    //   368: invokevirtual 290	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   371: pop
    //   372: aload 7
    //   374: aload 4
    //   376: iconst_0
    //   377: invokevirtual 812	android/content/pm/PackageManager:getPackageInfo	(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    //   380: astore 5
    //   382: getstatic 748	com/appodeal/ads/u:o	Lorg/json/JSONObject;
    //   385: ldc_w 814
    //   388: aload 5
    //   390: getfield 819	android/content/pm/PackageInfo:versionName	Ljava/lang/String;
    //   393: invokevirtual 290	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   396: pop
    //   397: getstatic 748	com/appodeal/ads/u:o	Lorg/json/JSONObject;
    //   400: ldc_w 821
    //   403: aload 5
    //   405: getfield 824	android/content/pm/PackageInfo:versionCode	I
    //   408: invokevirtual 653	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   411: pop
    //   412: aload 7
    //   414: aload 4
    //   416: sipush 128
    //   419: invokevirtual 828	android/content/pm/PackageManager:getApplicationInfo	(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    //   422: astore 5
    //   424: getstatic 748	com/appodeal/ads/u:o	Lorg/json/JSONObject;
    //   427: ldc_w 830
    //   430: aload 5
    //   432: getfield 834	android/content/pm/ApplicationInfo:metaData	Landroid/os/Bundle;
    //   435: ldc_w 836
    //   438: invokevirtual 840	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   441: invokevirtual 290	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   444: pop
    //   445: getstatic 748	com/appodeal/ads/u:o	Lorg/json/JSONObject;
    //   448: ldc_w 842
    //   451: aload_1
    //   452: invokevirtual 290	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   455: pop
    //   456: getstatic 748	com/appodeal/ads/u:o	Lorg/json/JSONObject;
    //   459: ldc_w 844
    //   462: aload_3
    //   463: invokevirtual 290	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   466: pop
    //   467: aload_0
    //   468: getfield 64	com/appodeal/ads/u:b	Landroid/content/Context;
    //   471: invokestatic 846	com/appodeal/ads/ao:f	(Landroid/content/Context;)Landroid/util/Pair;
    //   474: astore_1
    //   475: getstatic 748	com/appodeal/ads/u:o	Lorg/json/JSONObject;
    //   478: ldc_w 848
    //   481: aload_1
    //   482: getfield 320	android/util/Pair:first	Ljava/lang/Object;
    //   485: invokevirtual 290	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   488: pop
    //   489: getstatic 748	com/appodeal/ads/u:o	Lorg/json/JSONObject;
    //   492: ldc_w 850
    //   495: aload_1
    //   496: getfield 325	android/util/Pair:second	Ljava/lang/Object;
    //   499: invokevirtual 290	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   502: pop
    //   503: aload_0
    //   504: getfield 64	com/appodeal/ads/u:b	Landroid/content/Context;
    //   507: invokestatic 853	com/appodeal/ads/ao:n	(Landroid/content/Context;)Z
    //   510: ifeq +224 -> 734
    //   513: getstatic 748	com/appodeal/ads/u:o	Lorg/json/JSONObject;
    //   516: ldc_w 855
    //   519: ldc_w 857
    //   522: invokevirtual 290	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   525: pop
    //   526: getstatic 862	android/os/Build:MANUFACTURER	Ljava/lang/String;
    //   529: ldc_w 864
    //   532: invokevirtual 133	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   535: ifeq +240 -> 775
    //   538: ldc_w 866
    //   541: astore_1
    //   542: getstatic 748	com/appodeal/ads/u:o	Lorg/json/JSONObject;
    //   545: ldc_w 868
    //   548: aload_1
    //   549: invokevirtual 290	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   552: pop
    //   553: aload 7
    //   555: aload 4
    //   557: invokevirtual 871	android/content/pm/PackageManager:getInstallerPackageName	(Ljava/lang/String;)Ljava/lang/String;
    //   560: astore_3
    //   561: aload_3
    //   562: astore_1
    //   563: aload_3
    ...
    //   567: ldc_w 873
    //   570: astore_1
    //   571: getstatic 748	com/appodeal/ads/u:o	Lorg/json/JSONObject;
    //   574: ldc_w 875
    //   577: aload_1
    //   578: invokevirtual 290	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   581: pop
    //   582: getstatic 748	com/appodeal/ads/u:o	Lorg/json/JSONObject;
    //   585: ldc_w 877
    //   588: getstatic 862	android/os/Build:MANUFACTURER	Ljava/lang/String;
    //   591: invokevirtual 290	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   594: pop
    //   595: getstatic 748	com/appodeal/ads/u:o	Lorg/json/JSONObject;
    //   598: ldc_w 879
    //   601: ldc_w 881
    //   604: iconst_2
    ...
    //   608: dup
    //   609: iconst_0
    //   610: getstatic 862	android/os/Build:MANUFACTURER	Ljava/lang/String;
    //   613: aastore
    //   614: dup
    //   615: iconst_1
    //   616: getstatic 884	android/os/Build:MODEL	Ljava/lang/String;
    //   619: aastore
    //   620: invokestatic 743	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   623: invokevirtual 290	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   626: pop
    //   627: getstatic 748	com/appodeal/ads/u:o	Lorg/json/JSONObject;
    //   630: ldc_w 886
    //   633: invokestatic 888	com/appodeal/ads/ao:a	()Z
    //   636: invokevirtual 307	org/json/JSONObject:put	(Ljava/lang/String;Z)Lorg/json/JSONObject;
    //   639: pop
    //   640: new 201	org/json/JSONObject
    //   643: dup
    //   644: invokespecial 749	org/json/JSONObject:<init>	()V
    //   647: astore_1
    //   648: getstatic 748	com/appodeal/ads/u:o	Lorg/json/JSONObject;
    //   651: invokevirtual 891	org/json/JSONObject:keys	()Ljava/util/Iterator;
    //   654: astore_3
    //   655: aload_3
    //   656: invokeinterface 469 1 0
    //   661: ifeq +97 -> 758
    //   664: aload_3
    //   665: invokeinterface 473 1 0
    //   670: checkcast 129	java/lang/String
    //   673: astore 4
    //   675: aload_1
    //   676: aload 4
    //   678: getstatic 748	com/appodeal/ads/u:o	Lorg/json/JSONObject;
    //   681: aload 4
    //   683: invokevirtual 894	org/json/JSONObject:get	(Ljava/lang/String;)Ljava/lang/Object;
    //   686: invokevirtual 290	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   689: pop
    //   690: goto -35 -> 655
    //   693: astore_1
    //   694: ldc 2
    ...
    //   731: goto -286 -> 445
    //   734: getstatic 748	com/appodeal/ads/u:o	Lorg/json/JSONObject;
    //   737: ldc_w 855
    //   740: ldc_w 898
    //   743: invokevirtual 290	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   746: pop
    //   747: goto -221 -> 526
    //   750: astore_1
    //   751: aload_1
