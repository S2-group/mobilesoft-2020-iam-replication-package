...
public class k
{
  ...
  {
    return c(paramInt1, paramInt2) + (kq.nextInt(paramInt4 + paramInt3) - paramInt3) * 1000L;
  }
  ...
  {
    Object localObject1 = e.cv().au(paramString);
    if (localObject1 != null)
    {
      if ("off".equalsIgnoreCase(((com.appnext.base.a.b.c)localObject1).aZ())) {
        return true;
      }
      if (paramMap.isEmpty()) {
        return true;
      ...
      ((StringBuilder)localObject1).append(c.cs());
      ...
      if (TextUtils.isEmpty((CharSequence)localObject3)) {
        localObject1 = i.cC().getString("google_ads_id", "");
      }
