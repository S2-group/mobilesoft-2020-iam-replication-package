...
public class NetStatusUtil
{
  ...
  private static Intent a(Context paramContext, String paramString)
  {
    ...
    //   6: aload 5
    //   8: iconst_0
    //   9: invokevirtual 56	android/content/pm/PackageManager:getInstalledPackages	(I)Ljava/util/List;
    //   12: astore 6
    //   14: aload 6
    //   16: ifnull +319 -> 335
    //   19: aload 6
    ...
    //   49: invokevirtual 73	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   52: pop
    //   53: ldc 75
    //   55: aload 7
    //   57: invokevirtual 79	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   60: invokestatic 85	com/tencent/mm/sdk/platformtools/Log:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   63: iconst_0
    //   64: istore_2
    //   65: aload 6
    ...
    //   91: aload 6
    //   93: iload_2
    //   94: invokeinterface 91 2 0
    //   99: checkcast 93	android/content/pm/PackageInfo
    //   102: getfield 97	android/content/pm/PackageInfo:packageName	Ljava/lang/String;
    //   105: invokevirtual 100	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   108: pop
    //   109: ldc 75
    //   111: aload 7
    //   113: invokevirtual 79	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   116: invokestatic 85	com/tencent/mm/sdk/platformtools/Log:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   119: new 102	android/content/Intent
    //   122: dup
    //   123: invokespecial 103	android/content/Intent:<init>	()V
    //   126: astore 7
    //   128: aload 7
    //   130: aload 6
    //   132: iload_2
    //   133: invokeinterface 91 2 0
    //   138: checkcast 93	android/content/pm/PackageInfo
    //   141: getfield 97	android/content/pm/PackageInfo:packageName	Ljava/lang/String;
    //   144: invokevirtual 107	android/content/Intent:setPackage	(Ljava/lang/String;)Landroid/content/Intent;
    //   147: pop
    //   148: aload 5
    //   150: aload 7
    //   152: iconst_0
    //   153: invokevirtual 111	android/content/pm/PackageManager:queryIntentActivities	(Landroid/content/Intent;I)Ljava/util/List;
    //   156: astore 7
    //   158: aload 7
    //   160: ifnull +14 -> 174
    //   163: aload 7
    ...
    //   183: dup
    //   184: ldc 113
    //   186: invokespecial 69	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   189: astore 8
    //   191: aload 8
    //   193: iload_3
    //   194: invokevirtual 73	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   197: pop
    //   198: ldc 75
    //   200: aload 8
    //   202: invokevirtual 79	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   205: invokestatic 85	com/tencent/mm/sdk/platformtools/Log:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   208: iconst_0
    //   209: istore 4
    //   211: iload 4
    //   213: iload_3
    ...
    //   217: aload 7
    //   219: iload 4
    //   221: invokeinterface 91 2 0
    //   226: checkcast 115	android/content/pm/ResolveInfo
    //   229: getfield 119	android/content/pm/ResolveInfo:activityInfo	Landroid/content/pm/ActivityInfo;
    //   232: astore 8
    //   234: aload 8
    //   236: getfield 124	android/content/pm/ActivityInfo:name	Ljava/lang/String;
    //   239: aload_1
    //   240: invokevirtual 130	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   243: ifeq +54 -> 297
    //   246: new 102	android/content/Intent
    //   249: dup
    //   250: ldc -124
    //   252: invokespecial 133	android/content/Intent:<init>	(Ljava/lang/String;)V
    //   255: astore 7
    //   257: aload 7
    //   259: new 135	android/content/ComponentName
    //   262: dup
    //   263: aload 8
    //   265: getfield 136	android/content/pm/ActivityInfo:packageName	Ljava/lang/String;
    //   268: aload 8
    //   270: getfield 124	android/content/pm/ActivityInfo:name	Ljava/lang/String;
    //   273: invokespecial 138	android/content/ComponentName:<init>	(Ljava/lang/String;Ljava/lang/String;)V
    //   276: invokevirtual 142	android/content/Intent:setComponent	(Landroid/content/ComponentName;)Landroid/content/Intent;
    //   279: pop
    //   280: aload 7
    //   282: ldc -112
    //   284: invokevirtual 147	android/content/Intent:setAction	(Ljava/lang/String;)Landroid/content/Intent;
    //   287: pop
    //   288: aload_0
    //   289: aload 7
    //   291: invokevirtual 151	android/content/Context:startActivity	(Landroid/content/Intent;)V
    //   294: aload 7
    //   296: areturn
    //   297: iload 4
    //   299: iconst_1
    ...
    //   306: astore 7
    //   308: aload 7
    //   310: invokevirtual 154	java/lang/Exception:printStackTrace	()V
    //   313: goto +10 -> 323
    //   316: astore 7
    //   318: aload 7
    //   320: invokevirtual 154	java/lang/Exception:printStackTrace	()V
    //   323: iload_2
    //   324: iconst_1
    //   325: iadd
    //   326: istore_2
    ...
    //   330: astore_0
    //   331: aload_0
    //   332: invokevirtual 154	java/lang/Exception:printStackTrace	()V
    //   335: aconst_null
    //   336: areturn
  ...
  public static int getNetType(Context paramContext)
  {
    ...
    StringBuilder localStringBuilder = new StringBuilder("activeNetInfo.getExtraInfo()  ");
    localStringBuilder.append(paramContext.getExtraInfo());
    Log.d("MicroMsg.NetStatusUtil", localStringBuilder.toString());
    localStringBuilder = new StringBuilder("activeNetInfo.getType()  ");
  ...
  {
    // Byte code:
    //   0: invokestatic 443	java/lang/Runtime:getRuntime	()Ljava/lang/Runtime;
    //   3: ldc_w 445
    //   6: invokevirtual 449	java/lang/Runtime:exec	(Ljava/lang/String;)Ljava/lang/Process;
    //   9: astore_0
    //   10: new 451	java/io/DataOutputStream
    //   13: dup
    //   14: aload_0
    //   15: invokevirtual 457	java/lang/Process:getOutputStream	()Ljava/io/OutputStream;
    //   18: invokespecial 460	java/io/DataOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   21: astore 5
    //   23: aload_0
    //   24: astore_1
    //   25: aload 5
    ...
    //   29: aload 5
    //   31: ldc_w 462
    //   34: invokevirtual 465	java/io/DataOutputStream:writeBytes	(Ljava/lang/String;)V
    //   37: aload_0
    //   38: astore_1
    //   39: aload 5
    //   41: astore 4
    //   43: aload 5
    //   45: invokevirtual 468	java/io/DataOutputStream:flush	()V
    //   48: aload_0
    //   49: astore_1
    //   50: aload 5
    //   52: astore 4
    //   54: aload_0
    //   55: invokevirtual 471	java/lang/Process:waitFor	()I
    //   58: pop
    //   59: aload 5
    //   61: invokevirtual 474	java/io/DataOutputStream:close	()V
    //   64: aload_0
    //   65: ifnull +15 -> 80
    //   68: aload_0
    //   69: invokevirtual 477	java/lang/Process:destroy	()V
    //   72: goto +8 -> 80
    //   75: astore_0
    //   76: aload_0
    //   77: invokevirtual 154	java/lang/Exception:printStackTrace	()V
    //   80: iconst_1
    //   81: ireturn
    //   82: astore_2
    //   83: aload_0
    ...
    //   145: aload 5
    //   147: aload_2
    //   148: invokevirtual 482	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   167: invokestatic 334	com/tencent/mm/sdk/platformtools/Log:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   170: aload_0
    //   171: ifnull +10 -> 181
    //   174: aload_0
    //   175: invokevirtual 474	java/io/DataOutputStream:close	()V
    //   178: goto +3 -> 181
    //   181: aload_3
    //   182: ifnull +14 -> 196
    //   185: aload_3
    //   186: invokevirtual 477	java/lang/Process:destroy	()V
    //   189: goto +7 -> 196
    //   192: aload_0
    //   193: invokevirtual 154	java/lang/Exception:printStackTrace	()V
    //   196: iconst_0
    //   197: ireturn
    //   198: astore_2
    //   199: aload_1
    ...
    //   205: ifnull +11 -> 216
    //   208: aload 4
    //   210: invokevirtual 474	java/io/DataOutputStream:close	()V
    //   213: goto +3 -> 216
    //   216: aload_0
    //   217: ifnull +14 -> 231
    //   220: aload_0
    //   221: invokevirtual 477	java/lang/Process:destroy	()V
    //   224: goto +7 -> 231
    //   227: aload_0
    //   228: invokevirtual 154	java/lang/Exception:printStackTrace	()V
    //   231: aload_1
    //   232: athrow
    //   233: astore_0
    //   234: goto -42 -> 192
