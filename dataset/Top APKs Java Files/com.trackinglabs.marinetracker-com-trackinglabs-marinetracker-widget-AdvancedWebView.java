package com.trackinglabs.marinetracker.widget;
  ...
  extends WebView
{
  ...
  protected void init(Context paramContext)
  {
    ...
    super.setWebViewClient(new WebViewClient()
    {
      ...
      public boolean shouldOverrideUrlLoading(WebView paramAnonymousWebView, String paramAnonymousString)
      {
        ...
        {
          if (AdvancedWebView.this.mCustomWebViewClient != null) {
            return AdvancedWebView.this.mCustomWebViewClient.shouldOverrideUrlLoading(paramAnonymousWebView, paramAnonymousString);
          }
          return false;
        }
        if (AdvancedWebView.this.mListener != null) {
    ...
    super.setWebChromeClient(new WebChromeClient()
    {
      ...
      {
        AdvancedWebView.this.openFileInput(null, paramAnonymousValueCallback);
        return true;
      }
      ...
      {
        AdvancedWebView.this.openFileInput(paramAnonymousValueCallback, null);
      }
    });
  ...
  public void onPause()
  {
    if (getResources().getString(2131230770).length() == 0) {
      pauseTimers();
    }
    if (Build.VERSION.SDK_INT >= 11) {
      super.onPause();
  ...
  protected void onScrollChanged(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (this.mScrollInterface != null) {
      this.mScrollInterface.onScrollChanged(this.mToolbarWebView, paramInt1, paramInt2, paramInt3, paramInt4);
    }
  }
  
  @SuppressLint({"NewApi"})
  protected void openFileInput(ValueCallback<Uri> paramValueCallback, ValueCallback<Uri[]> paramValueCallback1)
  {
    if (this.mFileUploadCallbackFirst != null) {
      this.mFileUploadCallbackFirst.onReceiveValue(null);
    }
  ...
  protected void setGeolocationDatabasePath()
  {
    ...
    for (Object localObject = ((Fragment)this.mFragment.get()).getActivity();; localObject = (Activity)this.mActivity.get())
    {
  ...
  public void setOnScrollChangeListener(AdvancedWebView paramAdvancedWebView, ScrollInterface paramScrollInterface)
  {
    this.mScrollInterface = paramScrollInterface;
    this.mToolbarWebView = paramAdvancedWebView;
  }
  ...
  public static abstract interface ScrollInterface
  {
    public abstract void onScrollChanged(AdvancedWebView paramAdvancedWebView, int paramInt1, int paramInt2, int paramInt3, int paramInt4);
  }
}
