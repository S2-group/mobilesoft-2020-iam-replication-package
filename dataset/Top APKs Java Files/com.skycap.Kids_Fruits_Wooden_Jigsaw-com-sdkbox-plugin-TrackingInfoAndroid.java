...
public class TrackingInfoAndroid
{
  ...
  private static List _cachedTrackingUrl;
  ...
  private static int httpGetReal(String paramString1, String paramString2)
  {
    ...
    //   14: aload_1
    //   15: ifnonnull +96 -> 111
    //   18: new 476	java/net/URL
    //   21: dup
    //   22: aload_0
    //   23: invokespecial 479	java/net/URL:<init>	(Ljava/lang/String;)V
    //   26: astore_0
    //   27: aload_0
    //   28: invokevirtual 483	java/net/URL:openConnection	()Ljava/net/URLConnection;
    //   31: checkcast 485	java/net/HttpURLConnection
    //   34: astore_0
    //   35: aload_0
    //   36: ldc_w 487
    //   39: ldc_w 489
    //   42: invokevirtual 493	java/net/HttpURLConnection:setRequestProperty	(Ljava/lang/String;Ljava/lang/String;)V
    //   45: aload_0
    //   46: invokevirtual 496	java/net/HttpURLConnection:connect	()V
    //   49: aload_0
    //   50: invokevirtual 499	java/net/HttpURLConnection:getResponseCode	()I
    //   53: istore_2
    //   54: new 501	java/io/BufferedReader
    //   57: dup
    //   58: new 503	java/io/InputStreamReader
    //   61: dup
    //   62: aload_0
    //   63: invokevirtual 507	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   66: invokespecial 510	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   69: invokespecial 513	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   72: astore_0
    //   73: aload_0
    //   74: invokevirtual 516	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   77: astore_1
    //   78: aload_1
    //   79: ifnull +75 -> 154
    //   82: aload 6
    ...
    //   89: aload 6
    //   91: bipush 13
    //   93: invokevirtual 152	java/lang/StringBuilder:append	(C)Ljava/lang/StringBuilder;
    //   96: pop
    //   97: goto -24 -> 73
    //   100: astore_1
    //   101: aload_0
    //   102: ifnull +7 -> 109
    //   105: aload_0
    //   106: invokevirtual 519	java/io/BufferedReader:close	()V
    //   109: iload_2
    //   110: ireturn
    //   111: new 476	java/net/URL
    //   114: dup
    //   115: new 140	java/lang/StringBuilder
    //   118: dup
    //   119: invokespecial 141	java/lang/StringBuilder:<init>	()V
    //   122: aload_0
    //   123: invokevirtual 145	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   126: ldc_w 521
    ...
    //   136: invokevirtual 155	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   139: invokespecial 479	java/net/URL:<init>	(Ljava/lang/String;)V
    //   142: astore_0
    //   143: goto -116 -> 27
    //   146: astore_0
    //   147: aconst_null
    ...
    //   150: istore_2
    //   151: goto -50 -> 101
    //   154: new 523	org/json/JSONObject
    //   157: dup
    //   158: aload 6
    //   160: invokevirtual 155	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   163: invokespecial 524	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   166: astore_1
    //   167: aload_1
    //   168: invokestatic 526	com/sdkbox/plugin/TrackingInfoAndroid:getAppPackageId	()Ljava/lang/String;
    //   171: invokevirtual 529	org/json/JSONObject:getBoolean	(Ljava/lang/String;)Z
    //   174: istore 4
    //   176: iload 4
    //   178: istore_3
    //   179: iload_3
    //   180: ifeq +6 -> 186
    //   183: invokestatic 532	com/sdkbox/plugin/TrackingInfoAndroid:trace_acc_mac_real	()V
    //   186: aload_0
    //   187: ifnull +7 -> 194
    //   190: aload_0
    //   191: invokevirtual 519	java/io/BufferedReader:close	()V
    //   194: iload_2
    //   195: ireturn
    //   196: astore_0
    //   197: iload_2
    ...
    //   204: ifnull +7 -> 211
    //   207: aload_1
    //   208: invokevirtual 519	java/io/BufferedReader:close	()V
    //   211: aload_0
    //   212: athrow
    //   213: astore_0
    //   214: iload_2
  ...
  public static boolean isGooglePlayServicesAvailable()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          Object localObject2 = Class.forName("com.google.android.gms.common.b").getMethod("getInstance", new Class[0]).invoke(null, new Object[0]);
      ...
      try
      {
        i = ((Integer)Class.forName("com.google.android.gms.common.f").getMethod("isGooglePlayServicesAvailable", new Class[] { Context.class }).invoke(null, new Object[] { localContext })).intValue();
        if (i != 0) {
          continue;
        }
        bool1 = bool2;
  ...
  {
    _cachedGAID = "";
    SDKBox.executeInBackground(new ar());
    return _cachedGAID;
  }
  ...
  private static void sendCacheTracking()
  {
    ...
    //   2: monitorenter
    //   3: iconst_2
    //   4: getstatic 40	com/sdkbox/plugin/TrackingInfoAndroid:_GAIDFlag	I
    //   7: if_icmpne +15 -> 22
    //   10: getstatic 47	com/sdkbox/plugin/TrackingInfoAndroid:_cachedTrackingUrl	Ljava/util/List;
    //   13: invokeinterface 634 1 0
    //   18: ldc 2
    //   20: monitorexit
    //   21: return
    //   22: getstatic 47	com/sdkbox/plugin/TrackingInfoAndroid:_cachedTrackingUrl	Ljava/util/List;
    //   25: invokeinterface 400 1 0
    //   30: ifeq -12 -> 18
    //   33: getstatic 38	com/sdkbox/plugin/TrackingInfoAndroid:_cachedGAID	Ljava/lang/String;
    //   36: ifnull -18 -> 18
    //   39: getstatic 38	com/sdkbox/plugin/TrackingInfoAndroid:_cachedGAID	Ljava/lang/String;
    //   42: invokevirtual 250	java/lang/String:length	()I
    //   45: ifeq -27 -> 18
    //   48: getstatic 47	com/sdkbox/plugin/TrackingInfoAndroid:_cachedTrackingUrl	Ljava/util/List;
    //   51: invokeinterface 400 1 0
    //   56: ifle -38 -> 18
    //   59: getstatic 47	com/sdkbox/plugin/TrackingInfoAndroid:_cachedTrackingUrl	Ljava/util/List;
    //   62: iconst_0
    //   63: invokeinterface 637 2 0
    //   68: checkcast 64	java/lang/String
    //   71: astore_0
    //   72: aload_0
    //   73: ifnull -25 -> 48
    //   76: aload_0
    //   77: invokevirtual 250	java/lang/String:length	()I
    //   80: ifle -32 -> 48
    //   83: getstatic 52	com/sdkbox/plugin/TrackingInfoAndroid:tls	Lcom/sdkbox/services/TrackingLocalStorage;
    //   86: aload_0
    //   87: invokestatic 639	com/sdkbox/plugin/TrackingInfoAndroid:replaceIDFA	(Ljava/lang/String;)Ljava/lang/String;
    //   90: invokevirtual 642	com/sdkbox/services/TrackingLocalStorage:add	(Ljava/lang/String;)V
    //   93: goto -45 -> 48
    //   96: astore_0
    //   97: ldc 2
    //   99: monitorexit
