...
public class e
{
  ...
  private String a(String paramString, Intent paramIntent)
  {
    ...
    //   118	133	7	localPackageInfo	PackageInfo
    // Exception table:
    //   from	to	target	type
    //   33	39	198	finally
    //   44	58	198	finally
  ...
  public final String a(String paramString)
  {
    try
    {
      localObject1 = this.b.getPackageManager().getInstalledPackages(64).iterator();
      do
      {
      ...
      ((i.a)localObject1).a = localObject3.signatures[0].toByteArray();
      ((i.a)localObject1).b = ((PackageInfo)localObject3).versionCode;
    }
    ...
    {
      localObject3 = i.a(((i.a)localObject1).a);
      ...
      {
        a.a("biz", "ClientSignError", (String)localObject3);
        return "failed";
      }
    }
    i = ((i.a)localObject1).b;
    if (i > 78) {}
    try
    {
