...
public class k
{
  ...
  {
    return paramContext.getResources().getString(2131689932, new Object[] { paramContext.getString(2131689521) });
  }
  ...
  public void a(Context paramContext, int paramInt)
  {
    try
    {
      ...
      localIntent.putExtra("android.intent.extra.TEXT", paramContext.getString(paramInt) + "https://goo.gl/VP8fHE");
  ...
  public void a(Context paramContext, String paramString)
  {
    try
    {
      ...
      localIntent.setType("text/plain");
      localIntent.putExtra("android.intent.extra.SUBJECT", c(paramContext));
      localIntent.putExtra("android.intent.extra.TEXT", paramString + "https://goo.gl/VP8fHE");
      paramContext.startActivity(localIntent);
      return;
    }
    catch (ActivityNotFoundException paramContext)
