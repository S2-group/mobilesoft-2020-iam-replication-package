...
public final class s
{
  ...
  {
    if (paramContext.getPackageManager().getInstallerPackageName(paramContext.getPackageName()) == null) {
      return false;
    }
    return paramContext.getPackageManager().getInstallerPackageName(paramContext.getPackageName()).toLowerCase().startsWith("com.amazon");
  }
