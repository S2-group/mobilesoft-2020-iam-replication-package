...
public class g
{
  ...
  private static String a()
  {
    ...
    //   0: aconst_null
    //   1: astore_3
    //   2: new 51	java/io/BufferedReader
    //   5: dup
    //   6: new 53	java/io/InputStreamReader
    //   9: dup
    //   10: new 55	java/io/FileInputStream
    //   13: dup
    //   14: new 57	java/lang/StringBuilder
    //   17: dup
    ...
    //   26: invokestatic 70	android/os/Process:myPid	()I
    //   29: invokevirtual 73	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   32: ldc 75
    ...
    //   40: invokespecial 81	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   43: ldc 83
    //   45: invokespecial 86	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;Ljava/lang/String;)V
    //   48: invokespecial 89	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   51: astore_1
    ...
    //   59: astore_2
    //   60: aload_1
    //   61: invokevirtual 92	java/io/BufferedReader:read	()I
    //   64: istore_0
    //   65: iload_0
    //   66: ifle +28 -> 94
    //   69: aload_2
    //   70: iload_0
    //   71: i2c
    //   72: invokevirtual 95	java/lang/StringBuilder:append	(C)Ljava/lang/StringBuilder;
    //   75: pop
    //   76: goto -16 -> 60
    //   79: astore_2
    //   80: aload_3
    ...
    //   92: aload_2
    //   93: areturn
    //   94: invokestatic 104	com/bytedance/common/utility/Logger:debug	()Z
    //   97: ifeq +30 -> 127
    //   100: ldc 106
    //   102: new 57	java/lang/StringBuilder
    //   105: dup
    //   106: invokespecial 58	java/lang/StringBuilder:<init>	()V
    //   109: ldc 108
    ...
    //   124: invokestatic 112	com/bytedance/common/utility/Logger:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   127: aload_2
    ...
    //   137: ifnull -45 -> 92
    //   140: aload_1
    //   141: invokevirtual 98	java/io/BufferedReader:close	()V
    //   144: aload_3
    //   145: areturn
    //   146: astore_1
    //   147: aload_3
    ...
    //   153: ifnull +7 -> 160
    //   156: aload_2
    //   157: invokevirtual 98	java/io/BufferedReader:close	()V
    //   160: aload_1
    //   161: athrow
    //   162: astore_1
    //   163: aconst_null
  ...
  private static String a(String paramString)
  {
    ...
    //   0: aconst_null
    //   1: astore_1
    //   2: getstatic 32	com/ss/android/common/util/g:a	Ljava/lang/String;
    //   5: invokestatic 177	com/bytedance/common/utility/StringUtils:isEmpty	(Ljava/lang/String;)Z
    //   8: ifne +9 -> 17
    //   11: getstatic 32	com/ss/android/common/util/g:a	Ljava/lang/String;
    //   14: astore_0
    //   15: aload_0
    //   16: areturn
    //   17: new 51	java/io/BufferedReader
    //   20: dup
    //   21: new 53	java/io/InputStreamReader
    //   24: dup
    //   25: invokestatic 183	java/lang/Runtime:getRuntime	()Ljava/lang/Runtime;
    ...
    //   47: invokevirtual 189	java/lang/Runtime:exec	(Ljava/lang/String;)Ljava/lang/Process;
    //   50: invokevirtual 195	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   53: invokespecial 198	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   56: sipush 1024
    //   59: invokespecial 201	java/io/BufferedReader:<init>	(Ljava/io/Reader;I)V
    //   62: astore_3
    //   63: aload_3
    //   64: astore_2
    //   65: aload_3
    //   66: invokevirtual 204	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   69: astore_1
    //   70: aload_3
    //   71: astore_2
    //   72: aload_3
    //   73: invokevirtual 98	java/io/BufferedReader:close	()V
    //   76: aload_3
    //   77: astore_2
    //   78: aload_1
    //   79: putstatic 32	com/ss/android/common/util/g:a	Ljava/lang/String;
    //   82: aload_1
    //   83: astore_0
    //   84: aload_3
    //   85: ifnull -70 -> 15
    //   88: aload_3
    //   89: invokevirtual 98	java/io/BufferedReader:close	()V
    //   92: aload_1
    //   93: areturn
    //   94: astore_0
    //   95: ldc -50
    //   97: ldc -48
    //   99: aload_0
    //   100: invokestatic 212	com/bytedance/common/utility/Logger:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   103: aload_1
    //   104: areturn
    //   105: astore 4
    //   107: aconst_null
    ...
    //   112: astore_2
    //   113: ldc -50
    //   115: new 57	java/lang/StringBuilder
    //   118: dup
    //   119: invokespecial 58	java/lang/StringBuilder:<init>	()V
    //   122: ldc -42
    ...
    //   134: aload 4
    //   136: invokestatic 212	com/bytedance/common/utility/Logger:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   139: aload_1
    //   140: astore_0
    //   141: aload_3
    //   142: ifnull -127 -> 15
    //   145: aload_3
    //   146: invokevirtual 98	java/io/BufferedReader:close	()V
    //   149: aload_1
    //   150: areturn
    //   151: astore_0
    //   152: ldc -50
    //   154: ldc -48
    //   156: aload_0
    //   157: invokestatic 212	com/bytedance/common/utility/Logger:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   160: aload_1
    //   161: areturn
    //   162: astore_0
    //   163: aload_1
    //   164: ifnull +7 -> 171
    //   167: aload_1
    //   168: invokevirtual 98	java/io/BufferedReader:close	()V
    //   171: aload_0
    //   172: athrow
    //   173: astore_1
    //   174: ldc -50
    //   176: ldc -48
    //   178: aload_1
    //   179: invokestatic 212	com/bytedance/common/utility/Logger:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   182: goto -11 -> 171
    //   185: astore_0
    //   186: aload_2
    //   187: astore_1
  ...
  public static int areNotificationsEnabled(Context paramContext)
  {
    ...
    try
    {
      ...
      localObject = Reflect.on(localObject);
      int j = ((Integer)((Reflect)localObject).field("OP_POST_NOTIFICATION", new Class[] { Integer.TYPE }).get()).intValue();
      i = ((Integer)((Reflect)localObject).call("checkOpNoThrow", new Class[] { Integer.TYPE, Integer.TYPE, String.class }, new Object[] { Integer.valueOf(j), Integer.valueOf(i), paramContext }).get()).intValue();
      if (i == 0) {
        return 1;
      }
      return 0;
  ...
  public static String getDefaultBrowserString(Context paramContext)
  {
    try
    {
      ...
      ((Intent)localObject).setDataAndType(Uri.parse("http://"), null);
  ...
  public static String handleZipEntryGetNameLeak(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject = paramString;
        String str = paramString.replaceAll(".." + File.separator, "");
        paramString = str;
        localObject = str;
        if (Logger.debug())
        {
