...
class bs
{
  ...
  public String a(String paramString)
  {
    ...
    //   11: astore_2
    //   12: aload_0
    //   13: invokespecial 128	io/branch/referral/bs:q	()Z
    //   16: ifne +112 -> 128
    //   19: aload_0
    //   20: getfield 23	io/branch/referral/bs:c	Landroid/content/Context;
    //   23: invokevirtual 132	android/content/Context:getPackageManager	()Landroid/content/pm/PackageManager;
    //   26: astore_2
    //   27: aload 4
    //   29: astore 5
    //   31: aload_2
    //   32: aload_1
    //   33: iconst_0
    //   34: invokevirtual 138	android/content/pm/PackageManager:getApplicationInfo	(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    //   37: getfield 143	android/content/pm/ApplicationInfo:publicSourceDir	Ljava/lang/String;
    //   40: astore_1
    //   41: new 145	java/util/jar/JarFile
    //   44: dup
    //   45: aload_1
    //   46: invokespecial 148	java/util/jar/JarFile:<init>	(Ljava/lang/String;)V
    //   49: astore_1
    //   50: aload 6
    //   52: astore_3
    //   53: aload_1
    //   54: aload_1
    //   55: ldc -106
    //   57: invokevirtual 154	java/util/jar/JarFile:getEntry	(Ljava/lang/String;)Ljava/util/zip/ZipEntry;
    //   60: invokevirtual 158	java/util/jar/JarFile:getInputStream	(Ljava/util/zip/ZipEntry;)Ljava/io/InputStream;
    //   63: astore_2
    //   64: aload_2
    //   65: astore_3
    //   66: aload_2
    //   67: invokevirtual 164	java/io/InputStream:available	()I
    //   70: newarray byte
    //   72: astore 5
    //   74: aload_2
    //   75: astore_3
    //   76: aload_2
    //   77: aload 5
    //   79: invokevirtual 168	java/io/InputStream:read	([B)I
    //   82: pop
    //   83: aload_2
    //   84: astore_3
    //   85: new 170	io/branch/referral/c
    //   88: dup
    //   89: invokespecial 171	io/branch/referral/c:<init>	()V
    //   92: aload 5
    //   94: invokevirtual 174	io/branch/referral/c:a	([B)Ljava/lang/String;
    //   97: astore 5
    //   99: aload 5
    //   101: astore_3
    //   102: aload_2
    ...
    //   107: astore 5
    //   109: aload_2
    //   110: invokevirtual 177	java/io/InputStream:close	()V
    //   113: aload_3
    //   114: astore_2
    //   115: aload_1
    //   116: ifnull +12 -> 128
    ...
    //   120: astore 5
    //   122: aload_1
    //   123: invokevirtual 178	java/util/jar/JarFile:close	()V
    //   126: aload_3
    //   127: astore_2
    //   128: aload_2
    //   129: areturn
    ...
    //   154: astore 5
    //   156: aload_1
    //   157: invokevirtual 178	java/util/jar/JarFile:close	()V
    //   160: ldc 126
    //   162: areturn
    //   163: astore_1
    //   164: ldc 126
    ...
    //   178: astore 5
    //   180: aload_2
    //   181: invokevirtual 177	java/io/InputStream:close	()V
    //   184: aload_3
    //   185: ifnull +11 -> 196
    //   188: aload 4
    //   190: astore 5
    //   192: aload_3
    //   193: invokevirtual 178	java/util/jar/JarFile:close	()V
    //   196: aload 4
    //   198: astore 5
    //   200: aload_1
    //   201: athrow
  ...
  public boolean a(bt paramBt)
  {
    ...
    {
      new bu(this, paramBt).a(new Void[0]);
      return true;
    }
    return false;
  }
      ...
      else
      {
        try
        {
          ...
          for (localObject = null;; localObject = ((CharSequence)localObject).toString())
          {
            ...
            if (localObject != null)
            {
              localJSONObject.put(as.U.a(), localObject);
              localObject = a((String)localObject);
              if (!((String)localObject).equals("bnc_no_value")) {
                localJSONObject.put(as.T.a(), localObject);
              }
            }
  ...
  public int l()
  {
    Object localObject = az.a(this.c);
    String str = e();
    if ("bnc_no_value".equals(((az)localObject).e())) {
