...
class bk
{
  ...
  public String a(String paramString)
  {
    ...
    //   11: astore_2
    //   12: aload_0
    //   13: invokespecial 80	io/branch/referral/bk:l	()Z
    //   16: ifne +112 -> 128
    //   19: aload_0
    //   20: getfield 23	io/branch/referral/bk:c	Landroid/content/Context;
  ...
  public boolean a(bl paramBl)
  {
    ...
    {
      new bm(this, paramBl).a(new Void[0]);
      return true;
    }
    return false;
  }
  ...
  {
    Object localObject = aq.a(this.c);
    String str = d();
    if ("bnc_no_value".equals(((aq)localObject).e()))
    {
      if (paramBoolean) {
        ((aq)localObject).a(str);
      }
      ...
      else
      {
        try
        {
          ...
          for (localObject = null;; localObject = ((CharSequence)localObject).toString())
          {
            ...
            if (localObject != null)
            {
              localJSONObject.put(al.AppIdentifier.getKey(), localObject);
              localObject = a((String)localObject);
              if (!((String)localObject).equals("bnc_no_value")) {
                localJSONObject.put(al.URIScheme.getKey(), localObject);
              }
            }
            ...
            localJSONObject.put(al.OS.getKey(), g());
