...
final class l
{
  ...
  {
    if (!com.batch.android.a.l.a("android.permission.BLUETOOTH", paramContext)) {
      return null;
    }
    try
    {
  ...
  {
    if (!com.batch.android.a.l.a("android.permission.ACCESS_NETWORK_STATE", paramContext)) {
      return null;
    }
    try
    {
  ...
  protected static List H(Context paramContext)
  {
    try
    {
  ...
  {
    if (!com.batch.android.a.l.a("android.permission.ACCESS_WIFI_STATE", paramContext)) {
      return null;
    }
  ...
  protected static String a(String paramString, Context paramContext)
  {
    ...
    return a();
    return ad.a(new Date(c(paramContext).longValue()));
    return ad.a(new Date(d(paramContext).longValue()));
  ...
  protected static List e(Context paramContext)
  {
    if (!com.batch.android.a.l.a("android.permission.GET_ACCOUNTS", paramContext)) {
      paramContext = null;
    }
    for (;;)
    {
  ...
  protected static List f(Context paramContext)
  {
    if (!com.batch.android.a.l.a("android.permission.GET_ACCOUNTS", paramContext)) {
      return null;
    }
  ...
  {
    if (!com.batch.android.a.l.a("android.permission.READ_PHONE_STATE", paramContext)) {}
    for (;;)
    {
      return null;
      try
