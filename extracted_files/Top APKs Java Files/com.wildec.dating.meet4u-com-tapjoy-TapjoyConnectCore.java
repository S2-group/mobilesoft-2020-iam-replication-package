...
public class TapjoyConnectCore
{
  ...
  protected static String adIdCheckDisabled;
  ...
  protected static int deviceGooglePlayServicesVersion;
  ...
  protected static int packagedGoogleServicesVersion;
  private static String paidAppActionID;
  protected static String persistentIdsDisabled;
  ...
  static
  {
    ...
    lastTimeStamp = 0L;
    packagedGoogleServicesVersion = 0;
    deviceGooglePlayServicesVersion = 0;
    advertisingID = "";
    adIdCheckDisabled = "";
    persistentIdsDisabled = "";
  ...
  private static Map<String, String> getParamsWithoutAppID()
  {
    ...
    TapjoyUtil.safePut(localHashMap, "ad_id_check_disabled", adIdCheckDisabled, true);
    ...
    TapjoyUtil.safePut(localHashMap, "persistent_ids_disabled", persistentIdsDisabled, true);
    if (packagedGoogleServicesVersion != 0) {
      TapjoyUtil.safePut(localHashMap, "packaged_gps_version", Integer.toString(packagedGoogleServicesVersion), true);
    }
    if (deviceGooglePlayServicesVersion != 0) {
      TapjoyUtil.safePut(localHashMap, "device_gps_version", Integer.toString(deviceGooglePlayServicesVersion), true);
    }
    ...
    TapjoyUtil.safePut(localHashMap, "library_revision", "d445d7c", true);
  ...
  private boolean init()
  {
    ...
    try
    {
      ...
      if ((getConnectFlagValue("disable_persistent_ids") != null) && (getConnectFlagValue("disable_persistent_ids").length() > 0)) {
        persistentIdsDisabled = getConnectFlagValue("disable_persistent_ids");
      }
      if ((getConnectFlagValue("disable_advertising_id_check") != null) && (getConnectFlagValue("disable_advertising_id_check").length() > 0)) {
        adIdCheckDisabled = getConnectFlagValue("disable_advertising_id_check");
      }
      ...
      StringBuilder localStringBuilder = new StringBuilder().append("deviceID: ").append(deviceID);
      if ((getConnectFlagValue("debug_device_id") != null) && (getConnectFlagValue("debug_device_id").length() > 0))
      {
        String str1 = " *debug_device_id*";
        TapjoyLog.i("TapjoyConnect", str1);
  ...
  public void completeConnectCall()
  {
    ...
    localObject1 = tapjoyURLConnection.getResponseFromURL((String)localObject1 + "connect?", getURLParams());
    if ((localObject1 != null) && (((TapjoyHttpURLResponse)localObject1).statusCode == 200)) {
      if (handleConnectResponse(((TapjoyHttpURLResponse)localObject1).response))
      {
    ...
    while (connectNotifier == null)
    {
      ...
      for (;;)
      {
        if (matchingPackageNames.length() > 0)
        {
          ...
          TapjoyUtil.safePut((Map)localObject1, "package_names", matchingPackageNames, true);
          long l = System.currentTimeMillis() / 1000L;
          localObject2 = getPackageNamesVerifier(l, matchingPackageNames);
          TapjoyUtil.safePut((Map)localObject1, "timestamp", String.valueOf(l), true);
    ...
    try
    {
      this.profile.login(new r()
      {
        ...
        public void complete()
        {
          // Byte code:
          //   0: aload_0
          //   1: getfield 17	com/tapjoy/TapjoyConnectCore$1:this$0	Lcom/tapjoy/TapjoyConnectCore;
          //   4: invokestatic 27	com/tapjoy/TapjoyConnectCore:access$000	(Lcom/tapjoy/TapjoyConnectCore;)Lcom/threatmetrix/TrustDefenderMobile/ad;
          //   7: invokevirtual 33	com/threatmetrix/TrustDefenderMobile/ad:registration	()Lcom/threatmetrix/TrustDefenderMobile/ae;
          //   10: getstatic 39	com/threatmetrix/TrustDefenderMobile/ae:userId	Lcom/threatmetrix/TrustDefenderMobile/ae;
          //   13: if_acmpne +28 -> 41
          //   16: aload_0
          //   17: getfield 17	com/tapjoy/TapjoyConnectCore$1:this$0	Lcom/tapjoy/TapjoyConnectCore;
          //   20: invokestatic 27	com/tapjoy/TapjoyConnectCore:access$000	(Lcom/tapjoy/TapjoyConnectCore;)Lcom/threatmetrix/TrustDefenderMobile/ad;
          //   23: invokevirtual 43	com/threatmetrix/TrustDefenderMobile/ad:login	()Ljava/lang/String;
          //   26: invokestatic 47	com/tapjoy/TapjoyConnectCore:access$102	(Ljava/lang/String;)Ljava/lang/String;
          //   29: pop
          //   30: aload_0
          //   31: getfield 17	com/tapjoy/TapjoyConnectCore$1:this$0	Lcom/tapjoy/TapjoyConnectCore;
          //   34: invokestatic 27	com/tapjoy/TapjoyConnectCore:access$000	(Lcom/tapjoy/TapjoyConnectCore;)Lcom/threatmetrix/TrustDefenderMobile/ad;
          //   37: invokevirtual 50	com/threatmetrix/TrustDefenderMobile/ad:contactId	()V
          //   40: return
          //   41: ldc 52
          //   43: ldc 54
          //   45: invokestatic 60	com/tapjoy/TapjoyLog:w	(Ljava/lang/String;Ljava/lang/String;)V
          //   48: goto -18 -> 30
          //   51: astore_1
          //   52: ldc 52
          ...
          //   66: aload_1
          //   67: invokevirtual 72	java/lang/Exception:toString	()Ljava/lang/String;
          ...
          //   76: invokestatic 60	com/tapjoy/TapjoyLog:w	(Ljava/lang/String;Ljava/lang/String;)V
          //   79: aload_0
          //   80: getfield 17	com/tapjoy/TapjoyConnectCore$1:this$0	Lcom/tapjoy/TapjoyConnectCore;
          //   83: invokestatic 27	com/tapjoy/TapjoyConnectCore:access$000	(Lcom/tapjoy/TapjoyConnectCore;)Lcom/threatmetrix/TrustDefenderMobile/ad;
          //   86: invokevirtual 50	com/threatmetrix/TrustDefenderMobile/ad:contactId	()V
          //   89: return
          //   90: astore_1
          //   91: aload_0
          //   92: getfield 17	com/tapjoy/TapjoyConnectCore$1:this$0	Lcom/tapjoy/TapjoyConnectCore;
          //   95: invokestatic 27	com/tapjoy/TapjoyConnectCore:access$000	(Lcom/tapjoy/TapjoyConnectCore;)Lcom/threatmetrix/TrustDefenderMobile/ad;
          //   98: invokevirtual 50	com/threatmetrix/TrustDefenderMobile/ad:contactId	()V
          //   101: aload_1
          //   102: athrow
          // Local variable table:
          //   start	length	slot	name	signature
          //   0	103	0	this	1
          //   51	16	1	localException	Exception
          //   90	12	1	localObject	Object
          // Exception table:
          //   from	to	target	type
      ...
      this.profile.login(10);
      this.profile.login(context, "rrx68giz", "h.online-metrix.net", "http://content-js.tapjoy.com", 3097);
      return;
    }
  ...
  public String getSerial()
  {
    // Byte code:
    //   0: ldc_w 1538
    //   3: invokestatic 406	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   6: ldc_w 1540
    //   9: invokevirtual 1544	java/lang/Class:getDeclaredField	(Ljava/lang/String;)Ljava/lang/reflect/Field;
    //   12: astore_1
    //   13: aload_1
    //   14: invokevirtual 1549	java/lang/reflect/Field:isAccessible	()Z
    //   17: ifne +8 -> 25
    //   20: aload_1
    //   21: iconst_1
    //   22: invokevirtual 1552	java/lang/reflect/Field:setAccessible	(Z)V
    //   25: aload_1
    //   26: ldc_w 1141
    //   29: invokevirtual 1553	java/lang/reflect/Field:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   32: invokevirtual 628	java/lang/Object:toString	()Ljava/lang/String;
    //   35: astore_1
    //   36: ldc 22
    //   38: new 286	java/lang/StringBuilder
    //   41: dup
    //   42: invokespecial 287	java/lang/StringBuilder:<init>	()V
    //   45: ldc_w 1555
    //   48: invokevirtual 293	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   51: aload_1
    //   52: invokevirtual 293	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   55: invokevirtual 300	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   58: invokestatic 488	com/tapjoy/TapjoyLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   61: aload_1
    //   62: areturn
    //   63: astore_2
    //   64: aconst_null
    ...
    //   66: ldc 22
    //   68: aload_2
    //   69: invokevirtual 497	java/lang/Exception:toString	()Ljava/lang/String;
    //   72: invokestatic 499	com/tapjoy/TapjoyLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   75: aload_1
    //   76: areturn
    //   77: astore_2
    //   78: goto -12 -> 66
