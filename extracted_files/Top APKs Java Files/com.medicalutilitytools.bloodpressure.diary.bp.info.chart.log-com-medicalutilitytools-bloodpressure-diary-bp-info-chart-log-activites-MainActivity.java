package com.medicalutilitytools.bloodpressure.diary.bp.info.chart.log.activites;
...
import com.medicalutilitytools.bloodpressure.diary.bp.info.chart.log.fragment.DataFragment;
import com.medicalutilitytools.bloodpressure.diary.bp.info.chart.log.fragment.HistoryFragment;
import com.medicalutilitytools.bloodpressure.diary.bp.info.chart.log.utils.c;
...
{
  public static ArrayList<com.medicalutilitytools.bloodpressure.diary.bp.info.chart.log.model.a> p;
  static String q = "http://aaaaaaaa.com/pf2.xml";
  public static Animation s;
  private HistoryFragment A;
  private FragmentTransaction B;
  private String C;
  com.medicalutilitytools.bloodpressure.diary.bp.info.chart.log.utils.a n;
  boolean o;
  ...
  public void exit()
  {
    ...
    if ((p != null) && (p.size() >= 4))
    {
      localTextView1.setText(((com.medicalutilitytools.bloodpressure.diary.bp.info.chart.log.model.a)p.get(0)).getAppName());
      localTextView2.setText(((com.medicalutilitytools.bloodpressure.diary.bp.info.chart.log.model.a)p.get(1)).getAppName());
      localTextView3.setText(((com.medicalutilitytools.bloodpressure.diary.bp.info.chart.log.model.a)p.get(2)).getAppName());
      localTextView4.setText(((com.medicalutilitytools.bloodpressure.diary.bp.info.chart.log.model.a)p.get(3)).getAppName());
    }
    if ((p != null) && (p.size() >= 4))
    {
      e.with(getApplicationContext()).load(((com.medicalutilitytools.bloodpressure.diary.bp.info.chart.log.model.a)p.get(0)).getImgUrl().toString()).placeholder(2131165290).error(2131165290).into((ImageView)localObject1);
      e.with(getApplicationContext()).load(((com.medicalutilitytools.bloodpressure.diary.bp.info.chart.log.model.a)p.get(1)).getImgUrl().toString()).placeholder(2131165290).error(2131165290).into((ImageView)localObject2);
      e.with(getApplicationContext()).load(((com.medicalutilitytools.bloodpressure.diary.bp.info.chart.log.model.a)p.get(2)).getImgUrl().toString()).placeholder(2131165290).error(2131165290).into(localImageView1);
      e.with(getApplicationContext()).load(((com.medicalutilitytools.bloodpressure.diary.bp.info.chart.log.model.a)p.get(3)).getImgUrl().toString()).placeholder(2131165290).error(2131165290).into(localImageView2);
      ((ImageView)localObject1).startAnimation(s);
      ((ImageView)localObject2).startAnimation(s);
      localImageView1.startAnimation(s);
      localImageView2.startAnimation(s);
      ...
      ((ImageView)localObject1).setOnClickListener(new View.OnClickListener()
      {
        public void onClick(View paramAnonymousView)
        {
          if ((MainActivity.p != null) && (MainActivity.p.size() >= 1)) {
            MainActivity.this.startActivity(new Intent("android.intent.action.VIEW", Uri.parse(((com.medicalutilitytools.bloodpressure.diary.bp.info.chart.log.model.a)MainActivity.p.get(0)).getAppUrl())));
          }
        }
      });
      ((ImageView)localObject2).setOnClickListener(new View.OnClickListener()
      {
        public void onClick(View paramAnonymousView)
        {
          if ((MainActivity.p != null) && (MainActivity.p.size() >= 2)) {
            MainActivity.this.startActivity(new Intent("android.intent.action.VIEW", Uri.parse(((com.medicalutilitytools.bloodpressure.diary.bp.info.chart.log.model.a)MainActivity.p.get(1)).getAppUrl())));
          }
        }
      });
      localImageView1.setOnClickListener(new View.OnClickListener()
      {
        public void onClick(View paramAnonymousView)
        {
          if ((MainActivity.p != null) && (MainActivity.p.size() >= 3)) {
            MainActivity.this.startActivity(new Intent("android.intent.action.VIEW", Uri.parse(((com.medicalutilitytools.bloodpressure.diary.bp.info.chart.log.model.a)MainActivity.p.get(2)).getAppUrl())));
          }
        }
      });
      localImageView2.setOnClickListener(new View.OnClickListener()
      {
        public void onClick(View paramAnonymousView)
        {
          if ((MainActivity.p != null) && (MainActivity.p.size() >= 4)) {
            MainActivity.this.startActivity(new Intent("android.intent.action.VIEW", Uri.parse(((com.medicalutilitytools.bloodpressure.diary.bp.info.chart.log.model.a)MainActivity.p.get(3)).getAppUrl())));
          }
        }
      });
    }
  ...
  public ArrayList<com.medicalutilitytools.bloodpressure.diary.bp.info.chart.log.model.a> loadUndowloadedApp(ArrayList<com.medicalutilitytools.bloodpressure.diary.bp.info.chart.log.model.a> paramArrayList)
  {
    ArrayList localArrayList = new ArrayList();
    if (paramArrayList.size() > 0)
    {
      ...
      {
        String str = ((com.medicalutilitytools.bloodpressure.diary.bp.info.chart.log.model.a)paramArrayList.get(i)).getAppUrl().split("=")[1];
        StringBuilder localStringBuilder = new StringBuilder();
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.n = new com.medicalutilitytools.bloodpressure.diary.bp.info.chart.log.utils.a(this);
      ...
      public void onResponse(String paramAnonymousString)
      {
        try
        {
          ...
          while (i < paramAnonymousString.getLength())
          {
            ...
            com.medicalutilitytools.bloodpressure.diary.bp.info.chart.log.model.a localA = new com.medicalutilitytools.bloodpressure.diary.bp.info.chart.log.model.a();
