...
{
  private static final Comparator<PackageUtils.AminoPackage> AMINO_PACKAGE_COMP = new PackageUtils.1();
  private Context context;
  private PackageUtils.AminoPackage[] listPackageCache;
  ...
  public String getKeychainAuthorities(PackageUtils.AminoPackage paramAminoPackage)
  {
  ...
  public PackageUtils.AminoPackage[] listAminoPackages()
  {
    try
    {
      PackageManager localPackageManager = this.context.getPackageManager();
      ...
      int i;
      label260:
      return new PackageUtils.AminoPackage[0];
    }
    catch (Throwable localThrowable)
    {
      ...
      if (i > 0)
      {
        return new PackageUtils.AminoPackage[] { new PackageUtils.AminoPackage(i, getAppIdFromPackageName((String)localObject1), (String)localObject1) };
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          if (i > 0) {
            ((ArrayList)localObject1).add(new PackageUtils.AminoPackage(i, getAppIdFromPackageName((String)localObject3), (String)localObject3));
          } else if ((i == 0) && (((String)localObject3).equals(getMasterPackageName()))) {
            ((ArrayList)localObject1).add(new PackageUtils.AminoPackage(i, 0, (String)localObject3));
          }
        }
        Collections.sort((List)localObject1, AMINO_PACKAGE_COMP);
        localObject1 = (PackageUtils.AminoPackage[])((ArrayList)localObject1).toArray(new PackageUtils.AminoPackage[((ArrayList)localObject1).size()]);
        return localObject1;
      }
      if ((i == 0) && (((String)localObject1).equals(getMasterPackageName()))) {
        return new PackageUtils.AminoPackage[] { new PackageUtils.AminoPackage(i, 0, (String)localObject1) };
      }
    }
  }
