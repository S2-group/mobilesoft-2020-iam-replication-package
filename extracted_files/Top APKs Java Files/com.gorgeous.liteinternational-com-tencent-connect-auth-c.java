...
public class c
{
  ...
  {
    o localO = paramN.iK();
    f.c("openSDK_LOG.QQAuth", "-->login activity: " + localO);
    return a(localO, paramN, paramString1, paramIUiListener, paramString2);
  }
  ...
  public int a(n paramN, String paramString1, IUiListener paramIUiListener, String paramString2, boolean paramBoolean)
  {
    o localO = paramN.iK();
    f.c("openSDK_LOG.QQAuth", "-->login activity: " + localO);
    return a(localO, paramN, paramString1, paramIUiListener, paramString2, paramBoolean);
  }
