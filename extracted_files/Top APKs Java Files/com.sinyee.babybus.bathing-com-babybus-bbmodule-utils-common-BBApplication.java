...
public class BBApplication
{
  ...
  public static final int DEFAULT_CHANNEL_AD_TYPE = 2;
  ...
  public String getBabybusAdControl()
  {
    try
    {
      String str = (String)ReflectUtil.invokeStaticMethod("com.babybus.bbmodule.system.jni.PlatformSystem", "getBabybusAdControl", new Object[0]);
      return str;
    }
    catch (Exception localException)
    {
  ...
  public String getDsn(Activity paramActivity)
  {
    getInstance();
    String str = getIMEI(paramActivity);
    getInstance();
    paramActivity = getAndroidID(paramActivity);
  ...
  public String getThirdAdControl()
  {
    try
    {
      String str = (String)ReflectUtil.invokeStaticMethod("com.babybus.bbmodule.system.jni.PlatformSystem", "getThirdAdControl", new Object[0]);
      return str;
    }
    catch (Exception localException)
    {
  ...
  public String getURL4BabybusAd()
  {
    if (this.debug) {
      return "http://test.ad.babybus.org/";
    }
    return "http://ad.babybus.org/";
  }
  
  public String getURL4BabybusAdaptation()
  {
    if (this.debug) {
      return "http://test.ad.babybus.org/";
    }
  ...
  public String getURL4BabybusData()
  {
    if (this.debug) {
      return "http://10.1.5.90/";
    }
    return "http://dc.babybus.org/";
  }
  
  public String getURL4BabybusManager()
  {
    if (this.debug) {
      return "http://temp.appzh.babybus.org/";
    }
    return "http://app-zh.babybus.org/";
  }
  ...
  public void openPublisherMarket(Context paramContext, String paramString1, String paramString2, int paramInt)
  {
    Activity localActivity = (Activity)paramContext;
    Uri localUri = Uri.parse("market://search?q=pub:" + paramString1);
    if ((paramString1 == null) || ("".equals(paramString1))) {
      localUri = Uri.parse("https://play.google.com/store/apps/dev?id=" + paramString2);
    }
    if (getInstance().hasAnyMarketInstalled(paramContext))
    {
      localActivity.startActivityForResult(new Intent("android.intent.action.VIEW", localUri), paramInt);
      return;
    }
    try
    {
      ...
      paramString1.setData(localUri);
      paramContext.startActivity(paramString1);
      localActivity.startActivityForResult(paramString1, paramInt);
      return;
    }
