...
public final class AppUtils
{
  ...
  public static AppInfo getApkInfo(File paramFile)
  {
    if ((paramFile != null) && (paramFile.isFile()) && (paramFile.exists())) {
      return getApkInfo(paramFile.getAbsolutePath());
    }
    return null;
  }
  
  public static AppInfo getApkInfo(String paramString)
  {
    ...
    return getBean(localPackageManager, localPackageInfo);
  }
  ...
  private static Intent getInstallAppIntent(File paramFile, boolean paramBoolean)
  {
    ...
    else
    {
      ...
      paramFile = b.getUriForFile(Utils.getApp(), (String)localObject, paramFile);
      localIntent.setFlags(1);
    }
    Utils.getApp().grantUriPermission(Utils.getApp().getPackageName(), paramFile, 1);
  ...
  private static boolean isDeviceRooted()
  {
    ...
    arrayOfString[8] = "/system/sbin/";
    arrayOfString[9] = "/usr/bin/";
