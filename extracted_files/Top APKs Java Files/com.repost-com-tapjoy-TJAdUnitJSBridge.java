...
public class TJAdUnitJSBridge
{
  ...
  public void share(JSONObject paramJSONObject, String paramString)
  {
    ...
    //   32: dup
    //   33: ldc_w 650
    //   36: invokespecial 651	android/content/Intent:<init>	(Ljava/lang/String;)V
    //   39: astore 11
    //   41: aload_1
    //   42: ldc_w 653
    ...
    //   71: aload_0
    //   72: aload 5
    //   74: invokespecial 657	com/tapjoy/TJAdUnitJSBridge:downloadFileFromURL	(Ljava/lang/String;)Ljava/io/File;
    //   77: astore 9
    //   79: aload 7
    //   81: astore 6
    //   83: aload 9
    ...
    //   101: aload 9
    //   103: invokevirtual 662	java/io/File:getAbsolutePath	()Ljava/lang/String;
    ...
    //   181: aload 11
    //   183: ldc_w 670
    //   186: invokevirtual 673	android/content/Intent:setType	(Ljava/lang/String;)Landroid/content/Intent;
    //   189: pop
    //   190: aload 11
    //   192: ldc_w 675
    //   195: aload 6
    //   197: invokestatic 423	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   200: invokevirtual 678	android/content/Intent:putExtra	(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;
    //   203: pop
    //   204: aload_0
    ...
    //   211: aload 11
    //   213: iconst_0
    //   214: invokevirtual 682	android/content/pm/PackageManager:queryIntentActivities	(Landroid/content/Intent;I)Ljava/util/List;
    ...
    //   241: checkcast 684	android/content/pm/ResolveInfo
    //   244: astore 5
    //   246: aload 5
    //   248: getfield 688	android/content/pm/ResolveInfo:activityInfo	Landroid/content/pm/ActivityInfo;
    //   251: getfield 691	android/content/pm/ActivityInfo:packageName	Ljava/lang/String;
    //   254: getstatic 697	java/util/Locale:ENGLISH	Ljava/util/Locale;
    //   257: invokevirtual 701	java/lang/String:toLowerCase	(Ljava/util/Locale;)Ljava/lang/String;
    //   260: aload 10
    //   262: invokevirtual 705	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   265: ifne +25 -> 290
    //   268: aload 5
    //   270: getfield 688	android/content/pm/ResolveInfo:activityInfo	Landroid/content/pm/ActivityInfo;
    //   273: getfield 708	android/content/pm/ActivityInfo:name	Ljava/lang/String;
    //   276: getstatic 697	java/util/Locale:ENGLISH	Ljava/util/Locale;
    //   279: invokevirtual 701	java/lang/String:toLowerCase	(Ljava/util/Locale;)Ljava/lang/String;
    //   282: aload 10
    //   284: invokevirtual 705	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   287: ifeq -64 -> 223
    //   290: aload 11
    //   292: aload 5
    //   294: getfield 688	android/content/pm/ResolveInfo:activityInfo	Landroid/content/pm/ActivityInfo;
    //   297: getfield 691	android/content/pm/ActivityInfo:packageName	Ljava/lang/String;
    //   300: invokevirtual 711	android/content/Intent:setPackage	(Ljava/lang/String;)Landroid/content/Intent;
    //   303: pop
    //   304: iconst_1
    //   305: istore_3
    //   306: iload_3
    ...
    //   375: aload 11
    //   377: ldc_w 717
    //   380: invokevirtual 673	android/content/Intent:setType	(Ljava/lang/String;)Landroid/content/Intent;
    //   383: pop
    //   384: goto -180 -> 204
    //   387: aload 10
    //   389: ldc_w 719
    ...
    //   398: aload 11
    //   400: ldc_w 721
    //   403: invokevirtual 673	android/content/Intent:setType	(Ljava/lang/String;)Landroid/content/Intent;
    //   406: pop
    //   407: aload 5
    //   409: ifnull -205 -> 204
    //   412: aload 6
    ...
    //   427: invokevirtual 678	android/content/Intent:putExtra	(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;
    //   430: pop
    //   431: goto -227 -> 204
    //   434: aload_0
    //   435: iconst_1
    ...
    //   444: aload 11
    //   446: ldc_w 723
    //   449: invokestatic 727	android/content/Intent:createChooser	(Landroid/content/Intent;Ljava/lang/CharSequence;)Landroid/content/Intent;
    //   452: astore_1
    //   453: aload_0
