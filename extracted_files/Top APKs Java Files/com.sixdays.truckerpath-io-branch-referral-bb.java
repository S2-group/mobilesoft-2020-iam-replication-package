...
class bb
{
  ...
  public String a(String paramString)
  {
    ...
    //   17: astore_2
    //   18: aload_0
    //   19: invokespecial 53	io/branch/referral/bb:s	()Z
    //   22: ifne +125 -> 147
    //   25: aload_0
    //   26: getfield 15	io/branch/referral/bb:a	Landroid/content/Context;
    ...
    //   101: aload_2
    //   102: astore 4
    //   104: new 96	io/branch/referral/b
    //   107: dup
    //   108: invokespecial 97	io/branch/referral/b:<init>	()V
    //   111: aload 6
    //   113: invokevirtual 100	io/branch/referral/b:a	([B)Ljava/lang/String;
    //   116: astore 6
    //   118: aload 6
    //   120: astore_3
    //   121: aload_2
  ...
  {
    Object localObject = ad.a(this.a);
    String str = d();
    if ("bnc_no_value".equals(((ad)localObject).e()))
    {
      if (paramBoolean) {
        ((ad)localObject).a(str);
      }
      ...
      else
      {
        try
        {
          ...
          for (localObject = null;; localObject = ((CharSequence)localObject).toString())
          {
            ...
            if (localObject != null)
            {
              localJSONObject.put(z.AppIdentifier.a(), localObject);
              localObject = a((String)localObject);
              if (!((String)localObject).equals("bnc_no_value")) {
                localJSONObject.put(z.URIScheme.a(), localObject);
              }
            }
