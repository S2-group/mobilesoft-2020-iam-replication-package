...
import com.mavl.cleaner.d.c.c;
import com.mavl.cleaner.entity.AppProcessInfo;
import java.io.File;
...
public class e
{
  ...
  private d b;
  private com.mavl.cleaner.d.c c;
  private c d;
  private com.common.utils.junk.c.a e;
  private com.common.utils.junk.g.b f;
  private a g;
  ...
  public void a(List<com.common.utils.junk.h.a> paramList)
  {
    new Thread(new g(paramList)).start();
  }
  
  public void a(List<com.mavl.cleaner.entity.a> paramList, f paramF)
  {
    ...
    {
      com.mavl.cleaner.entity.a localA = (com.mavl.cleaner.entity.a)paramList.next();
      if ((localA instanceof com.common.utils.junk.h.a)) {
        paramF.add((com.common.utils.junk.h.a)localA);
      } else if ((localA instanceof com.common.utils.junk.f.a)) {
        localArrayList1.add((com.common.utils.junk.f.a)localA);
      } else if ((localA instanceof com.common.utils.junk.i.a)) {
        localArrayList2.add((com.common.utils.junk.i.a)localA);
        ...
        localArrayList4.add((com.common.utils.junk.e.a)localA);
      } else if ((localA instanceof com.common.utils.junk.g.a.a)) {
        localArrayList5.add((com.common.utils.junk.g.a.a)localA);
  ...
  public void b(List<com.common.utils.junk.f.a> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      com.common.utils.junk.f.a localA = (com.common.utils.junk.f.a)paramList.next();
      AppProcessInfo localAppProcessInfo = new AppProcessInfo();
      localAppProcessInfo.a = localA.d();
      localAppProcessInfo.b = localA.a();
      localAppProcessInfo.f = localA.c();
  ...
  public void c()
  {
    ...
    this.c = new com.mavl.cleaner.d.c(localContext, new e(null));
    this.c.a();
  }
  
  public void c(List<com.common.utils.junk.i.a> paramList)
  {
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      paramList = paramList.iterator();
      while (paramList.hasNext())
      {
        Object localObject = (com.common.utils.junk.i.a)paramList.next();
        try
        {
          localObject = new File(((com.common.utils.junk.i.a)localObject).a());
          if (!((File)localObject).isFile()) {
            break label74;
          }
          com.common.utils.f.e((File)localObject);
        }
        ...
        continue;
        label74:
        com.common.utils.f.d(localException);
      }
    }
  }
  ...
  public void d(List<com.common.utils.junk.b.a> paramList)
  {
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ...
      while (paramList.hasNext())
      {
        ...
        try
        {
          localObject = new File(((com.common.utils.junk.b.a)localObject).a());
          if (!((File)localObject).isFile()) {
            break label74;
          }
          com.common.utils.f.e((File)localObject);
  ...
  public void e(List<com.common.utils.junk.e.a> paramList)
  {
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      paramList = paramList.iterator();
      while (paramList.hasNext())
      {
        Object localObject = (com.common.utils.junk.e.a)paramList.next();
        try
        {
          localObject = new File(((com.common.utils.junk.e.a)localObject).a());
          if (!((File)localObject).isFile()) {
            break label74;
          }
          com.common.utils.f.e((File)localObject);
  ...
  public void f(List<com.common.utils.junk.g.a.a> paramList)
  {
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      paramList = paramList.iterator();
      while (paramList.hasNext())
      {
        Object localObject1 = ((com.common.utils.junk.g.a.a)paramList.next()).b();
        if ((localObject1 != null) && (!((List)localObject1).isEmpty()))
        {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            try
            {
              ...
              com.common.utils.f.e((File)localObject2);
            }
            catch (Exception localException)
            {
              localException.printStackTrace();
  ...
  public void g(List<com.common.utils.junk.a.a.a> paramList)
  {
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ...
      while (paramList.hasNext())
      {
        ...
        try
        {
          localObject = new File(Environment.getExternalStorageDirectory(), ((com.common.utils.junk.a.a.a)localObject).a());
          if (!((File)localObject).isFile()) {
            break label77;
          }
          com.common.utils.f.e((File)localObject);
  ...
  public void h()
  {
    this.f = new com.common.utils.junk.g.b((Context)this.a.get(), new f(null));
    this.f.a();
  }
  ...
  public void h(List<com.common.utils.junk.c.a.a> paramList)
  {
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ...
      while (paramList.hasNext())
      {
        Iterator localIterator = ((com.common.utils.junk.c.a.a)paramList.next()).b().iterator();
    ...
    implements c.b
  {
    ...
    public void a(com.common.utils.junk.e.a paramA)
    {
      e.b(e.this).sendMessage(e.b(e.this).obtainMessage(16, paramA));
    }
    
    public void a(com.common.utils.junk.i.a paramA)
    {
      e.b(e.this).sendMessage(e.b(e.this).obtainMessage(14, paramA));
    }
    
    public void a(List<com.common.utils.junk.b.a> paramList, List<com.common.utils.junk.i.a> paramList1, List<com.common.utils.junk.e.a> paramList2)
    {
      ArrayList localArrayList = new ArrayList();
      localArrayList.addAll(paramList);
  ...
  private class d
    implements com.mavl.cleaner.d.c.b
  {
    private d() {}
  }
    ...
    public void a(Context paramContext, List<AppProcessInfo> paramList)
    {
      if (paramList != null)
      {
        ...
        while (paramList.hasNext())
        {
          ...
          com.common.utils.junk.f.a localA = new com.common.utils.junk.f.a();
          localA.d(localAppProcessInfo.a);
          localA.b(localAppProcessInfo.f);
          localA.a(com.common.utils.a.c(paramContext, localAppProcessInfo.b));
          localA.a(localAppProcessInfo.b);
          localArrayList.add(localA);
        }
        e.b(e.this).sendMessage(e.b(e.this).obtainMessage(9, localArrayList));
      }
    }
  }
  
  private class f
    implements com.common.utils.junk.g.b.a
  {
    private f() {}
    ...
    public void a(com.common.utils.junk.g.a.a paramA)
    {
      e.b(e.this).sendMessage(e.b(e.this).obtainMessage(21, paramA));
    }
    
    public void a(List<com.common.utils.junk.g.a.a> paramList)
    {
  ...
  private class g
    implements Runnable
  {
    private List<com.common.utils.junk.h.a> b;
    ...
    public void run()
    {
      ...
      while (localIterator.hasNext())
      {
        com.common.utils.junk.h.a localA = (com.common.utils.junk.h.a)localIterator.next();
        com.common.utils.junk.h.b.a(localContext).a(localA);
      }
      long l = com.common.utils.junk.h.b.a(localContext).a();
      ...
      try
      {
        ...
        for (;;)
        {
          if (localIterator.hasNext())
          {
            ...
            if (!com.common.utils.b.f.a(localContext, localApplicationInfo.packageName))
            {
              com.common.utils.junk.h.b.a(localContext).a(localApplicationInfo.packageName, new com.common.utils.junk.h.b.a()
              {
                public void a(com.common.utils.junk.h.a arg1)
                {
                  synchronized (localArrayList)
                  {
                    e.b(e.this).sendMessage(e.b(e.this).obtainMessage(1, e.h.a(e.h.this), localList.size()));
                    if ((???.c() > 0L) && (!com.common.utils.b.f.a(localApplicationInfo.packageName)))
                    {
                      e.b(e.this).sendMessage(e.b(e.this).obtainMessage(2, Long.valueOf(???.c())));
                      localArrayList.add(???);
                    }
