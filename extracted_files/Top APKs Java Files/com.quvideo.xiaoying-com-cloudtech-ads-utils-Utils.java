...
public class Utils
{
  ...
  private static ArrayList<String> a(String[] paramArrayOfString)
  {
    ...
    //   8: ldc 88
    //   10: ldc 90
    //   12: invokestatic 96	com/cloudtech/ads/utils/YeLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   15: invokestatic 102	java/lang/Runtime:getRuntime	()Ljava/lang/Runtime;
    //   18: aload_0
    //   19: invokevirtual 106	java/lang/Runtime:exec	([Ljava/lang/String;)Ljava/lang/Process;
    //   22: astore_0
    //   23: new 108	java/io/BufferedWriter
    //   26: dup
    //   27: new 110	java/io/OutputStreamWriter
    //   30: dup
    //   31: aload_0
    //   32: invokevirtual 116	java/lang/Process:getOutputStream	()Ljava/io/OutputStream;
    //   35: invokespecial 119	java/io/OutputStreamWriter:<init>	(Ljava/io/OutputStream;)V
    //   38: invokespecial 122	java/io/BufferedWriter:<init>	(Ljava/io/Writer;)V
    //   41: pop
    //   42: new 124	java/io/BufferedReader
    //   45: dup
    //   46: new 126	java/io/InputStreamReader
    //   49: dup
    //   50: aload_0
    //   51: invokevirtual 130	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   54: invokespecial 133	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   57: invokespecial 136	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   60: astore_0
    //   61: aload_0
    //   62: invokevirtual 140	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   65: astore_2
    //   66: aload_2
    //   67: ifnull +42 -> 109
    //   70: new 142	java/lang/StringBuilder
    //   73: dup
    //   74: ldc -112
    //   76: invokespecial 147	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   79: astore_3
    //   80: aload_3
    //   81: aload_2
    ...
    //   86: ldc 88
    //   88: aload_3
    //   89: invokevirtual 154	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   92: invokestatic 96	com/cloudtech/ads/utils/YeLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   95: aload_1
    //   96: aload_2
    //   97: invokevirtual 158	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   100: pop
    //   101: goto -40 -> 61
    //   104: astore_0
    //   105: aload_0
    //   106: invokestatic 163	com/google/a/a/a/a/a/a:h	(Ljava/lang/Throwable;)V
    //   109: new 142	java/lang/StringBuilder
    //   112: dup
    //   113: ldc -91
    //   115: invokespecial 147	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   118: astore_0
    //   119: aload_0
    //   120: aload_1
    //   121: invokevirtual 168	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   124: pop
    //   125: ldc 88
    //   127: aload_0
    //   128: invokevirtual 154	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   131: invokestatic 96	com/cloudtech/ads/utils/YeLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   134: aload_1
    //   135: areturn
    //   136: aconst_null
    //   137: areturn
  ...
  {
    // Byte code:
    //   0: getstatic 626	com/cloudtech/ads/utils/Utils:h	Ljava/lang/String;
    //   3: invokestatic 441	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   6: ifeq +86 -> 92
    //   9: aconst_null
    //   10: astore_3
    //   11: aconst_null
    //   12: astore_1
    //   13: new 628	android/webkit/WebView
    //   16: dup
    //   17: aload_0
    //   18: invokespecial 630	android/webkit/WebView:<init>	(Landroid/content/Context;)V
    //   21: astore_0
    //   22: aload_0
    //   23: invokevirtual 634	android/webkit/WebView:getSettings	()Landroid/webkit/WebSettings;
    //   26: invokevirtual 639	android/webkit/WebSettings:getUserAgentString	()Ljava/lang/String;
    //   29: invokevirtual 643	java/lang/String:getBytes	()[B
    //   32: iconst_0
    //   33: invokestatic 647	android/util/Base64:encodeToString	([BI)Ljava/lang/String;
    //   36: putstatic 626	com/cloudtech/ads/utils/Utils:h	Ljava/lang/String;
    //   39: aload_0
    //   40: invokevirtual 650	android/webkit/WebView:destroy	()V
    //   43: goto +49 -> 92
    //   46: astore_1
    //   47: goto +35 -> 82
    //   50: astore_2
    ...
    //   66: astore_1
    //   67: aload_2
    //   68: invokestatic 163	com/google/a/a/a/a/a/a:h	(Ljava/lang/Throwable;)V
    //   71: aload_0
    //   72: ifnull +20 -> 92
    //   75: aload_0
    //   76: invokevirtual 650	android/webkit/WebView:destroy	()V
    //   79: goto +13 -> 92
    //   82: aload_0
    //   83: ifnull +7 -> 90
    //   86: aload_0
    //   87: invokevirtual 650	android/webkit/WebView:destroy	()V
    //   90: aload_1
    //   91: athrow
    //   92: getstatic 626	com/cloudtech/ads/utils/Utils:h	Ljava/lang/String;
    //   95: areturn
    // Local variable table:
    //   start	length	slot	name	signature
