  ...
  private void init(Context paramContext)
  {
    ...
    super.setWebViewClient(new WebViewClient()
    {
      ...
      public void onReceivedSslError(WebView paramAnonymousWebView, SslErrorHandler paramAnonymousSslErrorHandler, SslError paramAnonymousSslError)
      {
        ...
        paramAnonymousSslError = PayCitationWebView.this.getResources().getString(2131559201);
        String str = PayCitationWebView.this.getResources().getString(2131559200);
        paramAnonymousSslErrorHandler.getClass();
        ViewUtils.alertOkCancel(paramAnonymousWebView, paramAnonymousSslError, str, PayCitationWebView.1..Lambda.0.get$Lambda(paramAnonymousSslErrorHandler), new PayCitationWebView.1..Lambda.1(paramAnonymousSslErrorHandler));
      }
      ...
      public boolean shouldOverrideUrlLoading(WebView paramAnonymousWebView, String paramAnonymousString)
      {
        if (PayCitationWebView.this.isHostnameAllowed(paramAnonymousString)) {
          return (PayCitationWebView.this.mCustomWebViewClient != null) && (PayCitationWebView.this.mCustomWebViewClient.shouldOverrideUrlLoading(paramAnonymousWebView, paramAnonymousString));
        }
        if (PayCitationWebView.this.mListener != null) {
    ...
    setDownloadListener(new PayCitationWebView..Lambda.0(this));
  }
