...
public class bjJ
{
  ...
  {
    Object localObject = (Sn)AppServicesProvider.e(LX.a);
    if ((((Sn)localObject).b("app_shortcut_creation_triggered", false)) || (!d(paramContext))) {
      return;
    }
    ((Sn)localObject).a("app_shortcut_creation_triggered", true);
    localObject = paramContext.getResources().getString(2131889547);
  ...
  private static String c(Context paramContext)
  {
    ...
    if ((localObject1 != null) && (((ResolveInfo)localObject1).activityInfo != null) && (!blR.c(((ResolveInfo)localObject1).activityInfo.packageName)))
    {
  ...
  {
    return Sy.n(paramContext).equals("com.sec.android.app.launcher");
  }
  ...
  private static boolean e(Context paramContext, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        paramContext = paramContext.getContentResolver().query(Uri.parse("content://" + c(paramContext) + "/favorites?notify=false"), new String[] { "title" }, "title=?", new String[] { paramString }, null);
        if (paramContext != null)
        {
          bool2 = bool3;
