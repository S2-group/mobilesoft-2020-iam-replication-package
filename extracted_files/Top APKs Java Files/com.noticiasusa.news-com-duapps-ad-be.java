...
public class be
{
  private static be jdField_do_of_type_ComDuappsAdBe;
  private static final String jdField_do_of_type_JavaLangString = be.class.getSimpleName();
  private long jdField_do_of_type_Long;
  public Context jdField_do;
  public az jdField_do;
  private bc jdField_do_of_type_ComDuappsAdBc = new do((byte)0);
  private bf jdField_do_of_type_ComDuappsAdBf;
  private Object jdField_do_of_type_JavaLangObject = new Object();
  private LinkedList<aa> jdField_do_of_type_JavaUtilLinkedList = new LinkedList();
  
  private be(Context paramContext)
  {
    this.jdField_do_of_type_AndroidContentContext = paramContext;
    this.jdField_do_of_type_ComDuappsAdAz = new az(paramContext);
    this.jdField_do_of_type_ComDuappsAdBf = new bf(paramContext);
  }
  
  public static be jdMethod_do(Context paramContext)
  {
    try
    {
      if (jdField_do_of_type_ComDuappsAdBe == null) {
        jdField_do_of_type_ComDuappsAdBe = new be(paramContext.getApplicationContext());
      }
      return jdField_do_of_type_ComDuappsAdBe;
    }
    finally {}
  }
  
  public static <T extends aa> void jdMethod_do(Context paramContext, List<T> paramList)
  {
    paramContext = cd.jdMethod_do(paramContext);
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      aa localAa = (aa)paramList.next();
      if ((aa.jdMethod_if(localAa)) && (paramContext.jdMethod_if(localAa.jdField_if) == 2)) {
        paramList.remove();
      }
    }
  }
  ...
  public final void jdMethod_do()
  {
    ...
    //   1: astore 7
    //   3: aload_0
    //   4: getfield 44	com/duapps/ad/be:jdField_do_of_type_JavaLangObject	Ljava/lang/Object;
    //   7: astore 9
    //   9: aload 9
    //   11: monitorenter
    ...
    //   15: lstore_2
    //   16: aload_0
    //   17: getfield 121	com/duapps/ad/be:jdField_do_of_type_Long	J
    //   20: ldc2_w 122
    //   23: ladd
    //   24: lload_2
    //   25: lcmp
    //   26: ifge +553 -> 579
    //   29: aload_0
    //   30: getfield 46	com/duapps/ad/be:jdField_do_of_type_AndroidContentContext	Landroid/content/Context;
    //   33: invokestatic 77	com/duapps/ad/cd:do	(Landroid/content/Context;)Lcom/duapps/ad/cd;
    //   36: astore 6
    //   38: aload 6
    //   40: getfield 124	com/duapps/ad/cd:jdField_do_of_type_AndroidContentContext	Landroid/content/Context;
    //   43: invokestatic 130	com/duapps/ad/m:g	(Landroid/content/Context;)J
    //   46: lstore_2
    //   47: invokestatic 119	java/lang/System:currentTimeMillis	()J
    //   50: lstore 4
    //   52: aload 6
    //   54: getfield 124	com/duapps/ad/cd:jdField_do_of_type_AndroidContentContext	Landroid/content/Context;
    //   57: invokevirtual 134	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   60: aload 6
    //   62: getfield 124	com/duapps/ad/cd:jdField_do_of_type_AndroidContentContext	Landroid/content/Context;
    //   65: bipush 7
    ...
    //   89: pop
    //   90: aload_0
    //   91: getfield 46	com/duapps/ad/be:jdField_do_of_type_AndroidContentContext	Landroid/content/Context;
    //   94: invokestatic 77	com/duapps/ad/cd:do	(Landroid/content/Context;)Lcom/duapps/ad/cd;
    //   97: astore 8
    //   99: aload_0
    //   100: getfield 46	com/duapps/ad/be:jdField_do_of_type_AndroidContentContext	Landroid/content/Context;
    //   103: astore 11
    ...
    //   112: astore 10
    //   114: aload 8
    //   116: getfield 124	com/duapps/ad/cd:jdField_do_of_type_AndroidContentContext	Landroid/content/Context;
    //   119: invokevirtual 134	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   122: aload 8
    //   124: getfield 124	com/duapps/ad/cd:jdField_do_of_type_AndroidContentContext	Landroid/content/Context;
    //   127: bipush 7
    ...
    //   545: astore 6
    //   547: aload 8
    //   549: getfield 124	com/duapps/ad/cd:jdField_do_of_type_AndroidContentContext	Landroid/content/Context;
    //   552: invokevirtual 134	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   555: aload 8
    //   557: getfield 124	com/duapps/ad/cd:jdField_do_of_type_AndroidContentContext	Landroid/content/Context;
    //   560: bipush 7
    ...
    //   576: putfield 121	com/duapps/ad/be:jdField_do_of_type_Long	J
    //   579: aload 9
    //   581: monitorexit
    //   582: return
    //   583: astore 6
  ...
  public final void jdMethod_do(aa paramAa)
  {
    for (;;)
    {
      synchronized (this.jdField_do_of_type_JavaLangObject)
      {
        boolean bool1 = bq.jdMethod_do(this.jdField_do_of_type_AndroidContentContext, paramAa.jdField_if);
        if (cd.jdMethod_do(this.jdField_do_of_type_AndroidContentContext).jdMethod_if(paramAa.jdField_if) == 1)
        {
          i = 1;
          boolean bool2 = bz.jdMethod_do(paramAa.d);
          if ((paramAa != null) && (!TextUtils.isEmpty(paramAa.jdField_if)) && (!bool1) && (aa.jdMethod_if(paramAa)) && (i == 0) && (!bool2))
          {
            if (paramAa.jdField_do == 0) {
              this.jdField_do_of_type_ComDuappsAdAz.jdMethod_do(paramAa, paramAa.d, this.jdField_do_of_type_ComDuappsAdBc);
            }
          }
          else {
            return;
          }
          if (paramAa.jdField_do != 1) {
            continue;
          }
          synchronized (this.jdField_do_of_type_JavaUtilLinkedList)
          {
            if (this.jdField_do_of_type_JavaUtilLinkedList.isEmpty()) {
              this.jdField_do_of_type_ComDuappsAdBf.jdMethod_do(paramAa, paramAa.d, this.jdField_do_of_type_ComDuappsAdBc);
            }
            this.jdField_do_of_type_JavaUtilLinkedList.add(paramAa);
          }
        }
      }
      int i = 0;
  ...
  public final void jdMethod_do(List<aa> paramList)
  {
    paramList = paramList.iterator();
    while (paramList.hasNext()) {
      jdMethod_do((aa)paramList.next());
    }
  }
    ...
    implements bc
  {
    ...
    public final void a(aa paramAa, bb paramBb)
    {
      if ((paramAa == null) || (paramBb == null)) {
        return;
      }
      Intent localIntent = new Intent("action_notify_preparse_cache_result");
      localIntent.putExtra("ad_id", paramAa.jdField_do_of_type_Long);
      localIntent.putExtra("ad_pkgname", paramAa.jdField_if_of_type_JavaLangString);
      localIntent.putExtra("parse_result_type", paramBb.jdField_do_of_type_Int);
      LocalBroadcastManager.getInstance(be.jdMethod_do(be.this)).sendBroadcast(localIntent);
    }
    
    public final void jdMethod_do(aa paramAa, bb paramBb)
    {
      Context localContext = be.jdMethod_do(be.this);
      int i = paramBb.jdField_do_of_type_Int;
      int j = paramBb.jdField_if_of_type_Int;
      long l = paramBb.jdField_do_of_type_Long;
      if (1 <= m.jdMethod_do(localContext)) {}
      try
      {
        ToolStatsCore.getInstance(localContext).reportEvent("native", new JSONStringer().object().key("key").value("tts").key("id").value(paramAa.jdField_do_of_type_Long).key("logid").value(paramAa.k).key("sid").value(paramAa.i).key("ptype").value(i).key("loop").value(j).key("tsi").value(l).key("ts").value(System.currentTimeMillis()).key("tts_t").value(paramAa.jdField_if_of_type_Int).endObject().toString(), 1);
        return;
      }
      catch (JSONException paramAa) {}
    }
    
    public final void jdMethod_if(aa paramAa, bb arg2)
    {
      cd localCd = cd.jdMethod_do(be.jdMethod_do(be.this));
      ...
      try
      {
        if (localCd.jdField_do.getContentResolver().update(DuAdCacheProvider.jdMethod_do(localCd.jdField_do, 7), localContentValues, "_url = ?", new String[] { ??? }) <= 0) {
          localCd.jdField_do.getContentResolver().insert(DuAdCacheProvider.jdMethod_do(localCd.jdField_do, 7), localContentValues);
        }
        synchronized (be.jdMethod_do(be.this))
        {
          if (!be.jdMethod_do(be.this).isEmpty())
          {
            be.jdMethod_do(be.this).remove(paramAa);
            if (!be.jdMethod_do(be.this).isEmpty())
            {
              paramAa = (aa)be.jdMethod_do(be.this).peek();
              if (paramAa.jdField_do_of_type_Int == 1) {
                be.jdMethod_do(be.this).jdMethod_do(paramAa, paramAa.d, be.jdMethod_do(be.this));
              }
            }
          }
          return;
