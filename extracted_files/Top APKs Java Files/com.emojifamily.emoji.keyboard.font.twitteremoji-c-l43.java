...
public class l43
{
  private static final String a = l43.class.getSimpleName();
  ...
  private static ArrayList<String> a(Context paramContext)
  {
    try
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        llk.a(a, "get Local Package: " + localApplicationInfo.packageName);
      }
      return paramContext;
    }
    catch (Exception paramContext)
    {
      llk.e(a, "Using fallback package getter");
      paramContext.printStackTrace();
      return a();
    }
  }
  
  public static void a(Context paramContext, lEh paramLEh)
  {
    ClientConfig localClientConfig = llL.a(paramContext).e;
    long l1 = localClientConfig.ad;
    long l2 = localClientConfig.ae;
    long l3 = System.currentTimeMillis();
    Object localObject = a(paramContext);
    if (((ArrayList)localObject).size() == 0) {
      return;
    }
    lEL localLEL = localClientConfig.k();
    if (localLEL == null) {
      localLEL = new lEL();
    }
    for (;;)
    {
      ...
      Iterator localIterator1 = paramLEh.a().iterator();
      label81:
      label509:
      for (;;)
      {
        ...
        {
          localLEw = (lEw)localIterator1.next();
          ...
          } while (!((String)localIterator2.next()).equalsIgnoreCase(localLEw.a));
        }
        for (int i = 1;; i = 0)
        {
          if ((i != 0) || (localLEw.a.equals(paramContext.getPackageName()))) {
            break label509;
          }
          localArrayList.add(localLEw.a);
          break label81;
          i = 1;
          if (l1 == 0L) {
            i = 0;
          ...
          while (i != 0)
          {
            localClientConfig.a(l3);
            paramLEh = paramLEh.a().iterator();
            while (paramLEh.hasNext())
            {
              localObject = (lEw)paramLEh.next();
              if ((!((lEw)localObject).a.equals(paramContext.getPackageName())) && (((lEw)localObject).e != 0L) && (l3 - ((lEw)localObject).e > l1))
              {
                localArrayList.add(((lEw)localObject).a);
                llk.e(a, "Client timeout -  pack.getName()" + ((lEw)localObject).a + ", currentTime " + l3 + ", pack.getTimeStamp(): " + ((lEw)localObject).e + ", MAX_TIMEOUT: " + l1);
              }
            }
            if (l3 - l2 > l1)
            {
              llk.a(a, "over maxtimeout, cant determine dead clients");
              localClientConfig.a(l3);
              if ((paramLEh != null) && (paramLEh.a() != null))
              {
                localObject = paramLEh.a().iterator();
                while (((Iterator)localObject).hasNext()) {
                  ((lEw)((Iterator)localObject).next()).e = l3;
                }
                localClientConfig.a(paramLEh);
              }
              i = 0;
            }
          }
          i = 0;
          if (localArrayList.size() != localLEL.a.size()) {
            i = 1;
          }
          while (i != 0)
          {
            localLEL.a = localArrayList;
            localLEL.b += 1;
            localClientConfig.a(localLEL);
            return;
            paramContext = new ArrayList(localArrayList);
            paramContext.removeAll(localLEL.a);
