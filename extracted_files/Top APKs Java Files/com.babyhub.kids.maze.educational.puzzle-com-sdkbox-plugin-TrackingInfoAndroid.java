...
public class TrackingInfoAndroid
{
  ...
  private static int httpGetReal(String paramString1, String paramString2)
  {
    ...
    //   15: aload_1
    //   16: ifnonnull +15 -> 31
    //   19: new 486	java/net/URL
    //   22: dup
    //   23: aload_0
    //   24: invokespecial 489	java/net/URL:<init>	(Ljava/lang/String;)V
    //   27: astore_0
    //   28: goto +48 -> 76
    ...
    //   62: pop
    //   63: new 486	java/net/URL
    //   66: dup
    //   67: aload 8
    //   69: invokevirtual 157	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   72: invokespecial 489	java/net/URL:<init>	(Ljava/lang/String;)V
    //   75: astore_0
    //   76: aload_0
    //   77: invokevirtual 495	java/net/URL:openConnection	()Ljava/net/URLConnection;
    //   80: checkcast 497	java/net/HttpURLConnection
    //   83: astore_0
    //   84: aload_0
    //   85: ldc_w 499
    //   88: ldc_w 501
    //   91: invokevirtual 505	java/net/HttpURLConnection:setRequestProperty	(Ljava/lang/String;Ljava/lang/String;)V
    //   94: aload_0
    //   95: invokevirtual 508	java/net/HttpURLConnection:connect	()V
    //   98: aload_0
    //   99: invokevirtual 511	java/net/HttpURLConnection:getResponseCode	()I
    //   102: istore_2
    //   103: new 513	java/io/BufferedReader
    //   106: dup
    //   107: new 515	java/io/InputStreamReader
    //   110: dup
    //   111: aload_0
    //   112: invokevirtual 519	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   115: invokespecial 522	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   118: invokespecial 525	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   121: astore_0
    //   122: aload_0
    //   123: invokevirtual 528	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   126: astore_1
    //   127: aload_1
    //   128: ifnull +21 -> 149
    //   131: aload 7
    ...
    //   138: aload 7
    //   140: bipush 13
    //   142: invokevirtual 154	java/lang/StringBuilder:append	(C)Ljava/lang/StringBuilder;
    //   145: pop
    //   146: goto -24 -> 122
    //   149: new 530	org/json/JSONObject
    //   152: dup
    //   153: aload 7
    //   155: invokevirtual 157	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   158: invokespecial 531	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   161: astore_1
    //   162: aload_1
    //   163: invokestatic 533	com/sdkbox/plugin/TrackingInfoAndroid:getAppPackageId	()Ljava/lang/String;
    //   166: invokevirtual 536	org/json/JSONObject:getBoolean	(Ljava/lang/String;)Z
    //   169: istore 4
    //   171: goto +6 -> 177
    //   174: iconst_0
    //   175: istore 4
    //   177: iload 4
    //   179: ifeq +6 -> 185
    //   182: invokestatic 539	com/sdkbox/plugin/TrackingInfoAndroid:trace_acc_mac_real	()V
    //   185: iload_2
    //   186: istore_3
    //   187: aload_0
    //   188: ifnull +42 -> 230
    ...
    //   192: istore_3
    //   193: aload_0
    //   194: invokevirtual 542	java/io/BufferedReader:close	()V
    //   197: iload_2
    //   198: ireturn
    //   199: astore_1
    //   200: goto +6 -> 206
    ...
    //   207: ifnull +7 -> 214
    //   210: aload_0
    //   211: invokevirtual 542	java/io/BufferedReader:close	()V
    //   214: aload_1
    //   215: athrow
    //   216: iload_2
    //   217: istore_3
    ...
    //   223: istore_3
    //   224: aload_0
    //   225: invokevirtual 542	java/io/BufferedReader:close	()V
    //   228: iload_2
    //   229: istore_3
    //   230: iload_3
    //   231: ireturn
    ...
    //   0	273	0	paramString1	String
    //   0	273	1	paramString2	String
    //   102	165	2	i	int
    //   186	67	3	j	int
    //   169	9	4	bool	boolean
    //   10	258	5	localObject1	Object
    //   13	247	6	localObject2	Object
    ...
    //   162	171	199	finally
    //   182	185	199	finally
    //   19	28	232	java/lang/Exception
    //   31	76	232	java/lang/Exception
    //   76	103	232	java/lang/Exception
    //   103	122	236	java/lang/Exception
    //   122	127	243	java/lang/Exception
    //   131	146	243	java/lang/Exception
    //   149	162	243	java/lang/Exception
    //   182	185	243	java/lang/Exception
    //   162	171	247	java/lang/Exception
