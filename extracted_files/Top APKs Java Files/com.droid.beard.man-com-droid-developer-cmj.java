...
{
  private static cma ˇ;
  private static String ˇˇ = "";
  
  static cma ˇ(Context paramContext)
  {
    if (ˇ != null) {
      return ˇ;
    }
    String str2 = cmg.ˇ(paramContext);
    String str1;
    if (str2 != null)
    {
      str1 = str2;
    ...
    {
      str1 = ˇˇ(paramContext);
    }
    try
    {
      ˇ = (cma)new aom().ˇ(str1, cma.class);
      return ˇ;
    }
  ...
  private static String ˇ()
  {
    Object localObject1 = clz.ˇ();
    try
    {
  ...
  private static String ˇ(String paramString1, String paramString2)
  {
    ...
    {
      paramString1[j] = ((char)(paramString1[j] ^ paramString2[i]));
      int k = i + 1;
      i = k;
  ...
  static void ˇ(String paramString)
  {
    ˇˇ = paramString;
  }
  
  static boolean ˇ(Context paramContext, String paramString)
  {
  ...
  static String ˇˇ(Context paramContext)
  {
    Object localObject = ˇˇˇˇ(paramContext);
  ...
  static boolean ˇˇˇ(Context paramContext)
  {
    if (paramContext != null)
    {
  ...
  /* Error */
  private static String ˇˇˇˇ(Context paramContext)
  {
    // Byte code:
    //   0: new 170	java/io/ByteArrayOutputStream
    //   3: dup
    //   4: invokespecial 171	java/io/ByteArrayOutputStream:<init>	()V
    //   7: astore 4
    //   9: sipush 1024
    //   12: newarray byte
    //   14: astore 5
    ...
    //   24: getstatic 106	com/droid/developer/cmj:ˇˇ	Ljava/lang/String;
    //   27: invokevirtual 181	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   30: astore_0
    //   31: aload_0
    //   32: aload 5
    //   34: invokevirtual 187	java/io/InputStream:read	([B)I
    //   37: istore_1
    //   38: iload_1
    //   39: iconst_m1
    //   40: if_icmpeq +15 -> 55
    ...
    //   47: iconst_0
    //   48: iload_1
    //   49: invokevirtual 191	java/io/ByteArrayOutputStream:write	([BII)V
    //   52: goto -21 -> 31
    //   55: aload 4
    //   57: ldc 60
    //   59: invokevirtual 194	java/io/ByteArrayOutputStream:toString	(Ljava/lang/String;)Ljava/lang/String;
    //   62: astore_2
    //   63: aload 4
    //   65: invokevirtual 197	java/io/ByteArrayOutputStream:close	()V
    //   68: aload_0
    //   69: ifnull +14 -> 83
    //   72: aload_0
    //   73: invokevirtual 198	java/io/InputStream:close	()V
    //   76: aload_2
    //   77: areturn
    //   78: astore_0
    //   79: aload_0
    //   80: invokevirtual 201	java/io/IOException:printStackTrace	()V
    //   83: aload_2
    //   84: areturn
    //   85: astore_2
    //   86: goto +50 -> 136
    ...
    //   107: astore_2
    //   108: aload_3
    //   109: invokevirtual 201	java/io/IOException:printStackTrace	()V
    //   112: aload 4
    //   114: invokevirtual 197	java/io/ByteArrayOutputStream:close	()V
    //   117: aload_0
    //   118: ifnull +15 -> 133
    //   121: aload_0
    //   122: invokevirtual 198	java/io/InputStream:close	()V
    //   125: goto +8 -> 133
    //   128: astore_0
    //   129: aload_0
    //   130: invokevirtual 201	java/io/IOException:printStackTrace	()V
    //   133: ldc 10
    //   135: areturn
    //   136: aload 4
    //   138: invokevirtual 197	java/io/ByteArrayOutputStream:close	()V
    //   141: aload_0
    //   142: ifnull +15 -> 157
    //   145: aload_0
    //   146: invokevirtual 198	java/io/InputStream:close	()V
    //   149: goto +8 -> 157
    //   152: astore_0
    //   153: aload_0
    //   154: invokevirtual 201	java/io/IOException:printStackTrace	()V
    //   157: aload_2
    //   158: athrow
