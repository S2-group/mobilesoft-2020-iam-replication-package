package com.geekslab.qrbarcodescanner.share;
  ...
  extends AsyncTask<Object, Object, List<AppInfo>>
{
  ...
  {
    paramList = new ArrayAdapter(this.activity, 2130903041, 2131427347, paramList)
    {
      public View getView(int paramAnonymousInt, View paramAnonymousView, ViewGroup paramAnonymousViewGroup)
      {
        ...
        if (paramAnonymousViewGroup != null) {
          ((ImageView)paramAnonymousView.findViewById(2131427346)).setImageDrawable(paramAnonymousViewGroup);
        }
