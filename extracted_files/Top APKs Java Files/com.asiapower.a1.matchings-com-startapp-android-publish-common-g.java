...
public class g
{
  ...
  {
    String str = new String(new byte[] { 103, 101, 116, 73, 110, 115, 116, 97, 108, 108, 101, 100, 80, 97, 99, 107, 97, 103, 101, 115 });
    return (List)paramPackageManager.getClass().getMethod(str, new Class[] { Integer.TYPE }).invoke(paramPackageManager, new Object[] { Integer.valueOf(8192) });
  }
  ...
  public static int e(Context paramContext)
  {
    ...
    try
    {
      paramContext = a(paramContext.getPackageManager()).iterator();
      int m;
      for (;;)
      {
        k = j;
  ...
  private static void j(Context paramContext)
  {
    ...
    for (;;)
    {
      synchronized (a)
      {
        ...
        try
        {
          Object localObject1 = a(localPackageManager);
          if (Build.VERSION.SDK_INT >= 9)
          {
            l = Long.MAX_VALUE;
            f = l;
