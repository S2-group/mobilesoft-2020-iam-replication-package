...
public class bk
{
  ...
  public final void jdMethod_do()
  {
    ...
    //   204: ifnull +66 -> 270
    //   207: aload 6
    //   209: invokeinterface 178 1 0
    //   214: ifne +56 -> 270
    //   217: aload 6
    //   219: invokeinterface 181 1 0
    //   224: goto +46 -> 270
    //   227: aload 6
    //   229: ifnull +20 -> 249
    //   232: aload 6
    //   234: invokeinterface 178 1 0
    //   239: ifne +10 -> 249
    //   242: aload 6
    ...
    //   277: ifle +328 -> 605
    //   280: new 149	java/util/ArrayList
    //   283: dup
    //   284: invokespecial 150	java/util/ArrayList:<init>	()V
    //   287: astore 7
    //   289: aload 11
    //   291: invokevirtual 189	android/content/Context:getPackageManager	()Landroid/content/pm/PackageManager;
    //   294: astore 6
    //   296: aload 6
    //   298: ifnull +106 -> 404
    //   301: aload 6
    //   303: sipush 256
    //   306: invokevirtual 195	android/content/pm/PackageManager:getInstalledPackages	(I)Ljava/util/List;
    //   309: astore 6
    //   311: aload 10
    //   313: invokeinterface 77 1 0
    //   318: astore 10
    //   320: aload 10
    //   322: invokeinterface 83 1 0
    //   327: ifeq +77 -> 404
    //   330: aload 10
    //   332: invokeinterface 87 1 0
    //   337: checkcast 137	java/lang/String
    //   340: astore 11
    //   342: aload 6
    //   344: invokeinterface 77 1 0
    //   349: astore 12
    //   351: aload 12
    //   353: invokeinterface 83 1 0
    //   358: ifeq -38 -> 320
    //   361: aload 12
    //   363: invokeinterface 87 1 0
    //   368: checkcast 197	android/content/pm/PackageInfo
    //   371: astore 13
    //   373: aload 13
    //   375: ifnull -24 -> 351
    //   378: aload 13
    //   380: getfield 200	android/content/pm/PackageInfo:packageName	Ljava/lang/String;
    //   383: aload 11
    //   385: invokevirtual 203	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   388: ifeq -37 -> 351
    //   391: aload 7
    //   393: aload 11
    //   395: invokeinterface 175 2 0
    //   400: pop
    //   401: goto -50 -> 351
    //   404: aload 7
    //   406: invokeinterface 185 1 0
    //   411: ifle +194 -> 605
    //   414: ldc -51
    //   416: astore 6
    //   418: iload_1
    ...
    //   426: if_icmpge +122 -> 548
    //   429: aload 7
    //   431: iload_1
    //   432: invokeinterface 209 2 0
    //   437: checkcast 137	java/lang/String
    //   440: astore 10
    //   442: iload_1
    //   443: ifne +54 -> 497
    //   446: new 211	java/lang/StringBuilder
    //   449: dup
    //   450: invokespecial 212	java/lang/StringBuilder:<init>	()V
    //   453: astore 11
    //   455: aload 11
    //   457: aload 6
    //   459: invokevirtual 216	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   462: pop
    //   463: aload 11
    //   465: ldc -38
    ...
    //   486: pop
    //   487: aload 11
    //   489: invokevirtual 222	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   492: astore 6
    //   494: goto +169 -> 663
    //   497: new 211	java/lang/StringBuilder
    //   500: dup
    //   501: invokespecial 212	java/lang/StringBuilder:<init>	()V
    //   504: astore 11
    //   506: aload 11
    //   508: aload 6
    //   510: invokevirtual 216	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   513: pop
    //   514: aload 11
    //   516: ldc -32
    ...
    //   537: pop
    //   538: aload 11
    //   540: invokevirtual 222	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   543: astore 6
    //   545: goto +118 -> 663
    //   548: new 211	java/lang/StringBuilder
    //   551: dup
    //   552: invokespecial 212	java/lang/StringBuilder:<init>	()V
    //   555: astore 7
    //   557: aload 7
    //   559: aload 6
    ...
    //   572: pop
    //   573: aload 7
    //   575: invokevirtual 222	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   578: astore 6
    //   580: aload 8
    //   582: getfield 118	com/duapps/ad/eg:jdField_do_of_type_AndroidContentContext	Landroid/content/Context;
    //   585: invokevirtual 128	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   588: aload 8
    //   590: getfield 118	com/duapps/ad/eg:jdField_do_of_type_AndroidContentContext	Landroid/content/Context;
    //   593: bipush 7
    //   595: invokestatic 133	com/duapps/ad/stats/DuAdCacheProvider:do	(Landroid/content/Context;I)Landroid/net/Uri;
    //   598: aload 6
    //   600: aconst_null
    //   601: invokevirtual 147	android/content/ContentResolver:delete	(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    //   604: pop
    //   605: aload_0
    //   606: invokestatic 113	java/lang/System:currentTimeMillis	()J
    //   609: putfield 115	com/duapps/ad/bk:jdField_do_of_type_Long	J
    //   612: aload 9
    //   614: monitorexit
    //   615: return
    //   616: astore 6
    ...
    //   12	68	2	l1	long
    //   47	31	4	l2	long
    //   33	566	6	localObject1	Object
    //   616	6	6	localObject2	Object
    //   624	1	6	localException1	Exception
    //   629	1	6	localException2	Exception
    //   639	1	6	localException3	Exception
    //   648	11	6	localObject3	Object
    //   114	73	7	str	String
    //   197	53	7	localObject4	Object
    //   287	287	7	localObject5	Object
    //   634	13	7	localException4	Exception
    //   652	1	7	localObject6	Object
    //   96	493	8	localEg	eg
    //   644	7	8	localObject7	Object
    //   4	615	9	localObject8	Object
    //   111	414	10	localObject9	Object
    //   102	437	11	localObject10	Object
    //   349	13	12	localIterator	Iterator
    //   371	8	13	localPackageInfo	android.content.pm.PackageInfo
    // Exception table:
    //   from	to	target	type
    //   156	194	197	finally
    //   9	49	616	finally
    ...
    //   612	615	616	finally
    //   618	621	616	finally
    //   51	89	624	java/lang/Exception
    //   51	89	624	java/lang/Throwable
    //   116	151	629	java/lang/Exception
    //   156	194	634	java/lang/Exception
    //   580	605	639	java/lang/Exception
    //   580	605	639	java/lang/Throwable
    //   116	151	644	finally
  }
    ...
    implements bi
  {
    ...
    public final void a(ag paramAg, bh paramBh)
    {
      if (paramAg != null)
      {
        ...
        d.a(bk.jdMethod_do(bk.this)).a(localIntent);
        return;
      }
    }
