...
public class O1_
{
  private static final String a = O1_.class.getSimpleName();
  private final Context b;
  private final com.p3group.insight.b c;
  private boolean d;
  private boolean e = false;
  
  public O1_(Context paramContext)
  {
    this.b = paramContext;
  ...
  public void a()
  {
    ...
    this.d = true;
    new SIR((byte)0).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new Long[] { Long.valueOf(l) });
  }
    ...
    extends AsyncTask
  {
    ...
    private InstalledAppsResult a(Long... paramVarArgs)
    {
      ...
      localInstalledAppsResult.DeviceInfo = DeviceController.getDeviceInfo(O1_.a(O1_.this));
      localInstalledAppsResult.TimestampSnapshot = c.a(paramVarArgs[0].longValue());
      localInstalledAppsResult.HostAppPackageName = O1_.a(O1_.this).getPackageName();
      ArrayList localArrayList1 = new ArrayList();
      PackageManager localPackageManager = O1_.a(O1_.this).getPackageManager();
      int i;
      label199:
      Object localObject1;
      ...
      try
      {
        paramVarArgs = localPackageManager.getClass().getMethod("getPackageSizeInfo", new Class[] { String.class, SIR.class });
        if (O1_.a(O1_.this).checkCallingOrSelfPermission("android.permission.GET_PACKAGE_SIZE") == 0)
        {
          i = 1;
          HashMap localHashMap = new HashMap();
          if ((Build.VERSION.SDK_INT < 23) || (((AppOpsManager)O1_.a(O1_.this).getSystemService("appops")).checkOpNoThrow("android:get_usage_stats", Process.myUid(), O1_.a(O1_.this).getPackageName()) != 0)) {
            break label890;
          }
          localHashMap = a();
      ...
      catch (NoSuchMethodException paramVarArgs)
      {
        ...
        for (;;)
        {
          Log.e(O1_.b(), "IA: " + paramVarArgs.getMessage());
          paramVarArgs = null;
          continue;
          i = 0;
          continue;
      ...
      for (;;)
      {
        ...
        catch (PackageManager.NameNotFoundException localNameNotFoundException)
        {
          try
          {
            paramVarArgs.invoke(localPackageManager, new Object[] { localInstalledApp.PackageName, new SIR.SIR()
            {
              public void a(PackageStats paramAnonymousPackageStats)
              {
    ...
    private HashMap a()
    {
      ...
      Object localObject1 = (NetworkStatsManager)O1_.a(O1_.this).getSystemService(NetworkStatsManager.class);
      Object localObject2;
      label238:
      do
      {
        for (;;)
        {
          ...
          {
            Log.d(O1_.b(), "getUidBytesForAndroidM: " + localException.getMessage());
            return localHashMap;
          }
        ...
        localObject1 = ((NetworkStatsManager)localObject1).querySummary(0, ((TelephonyManager)O1_.a(O1_.this).getSystemService("phone")).getSubscriberId(), l, System.currentTimeMillis());
