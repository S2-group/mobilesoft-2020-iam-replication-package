...
public class DeviceInfo
{
  ...
  public static void getDeviceMaxVolume(Integer paramInteger, WebViewCallback paramWebViewCallback)
  {
    ...
    {
    default: 
      DeviceLog.error("Unhandled deviceMaxVolume error: ".concat(String.valueOf(i)));
      return;
    case -1: 
  ...
  public static void getDeviceVolume(Integer paramInteger, WebViewCallback paramWebViewCallback)
  {
    ...
    {
    default: 
      DeviceLog.error("Unhandled deviceVolume error: ".concat(String.valueOf(i)));
      return;
    case -1: 
      paramWebViewCallback.error(DeviceError.APPLICATION_CONTEXT_NULL, new Object[] { Integer.valueOf(i) });
      return;
  ...
  {
    switch (2.$SwitchMap$com$unity3d$services$core$api$DeviceInfo$StorageType[paramStorageType.ordinal()])
    {
    default: 
      DeviceLog.error("Unhandled storagetype: ".concat(String.valueOf(paramStorageType)));
      return null;
    case 2: 
  ...
  public static void getRingerMode(WebViewCallback paramWebViewCallback)
  {
    ...
    {
    default: 
      DeviceLog.error("Unhandled ringerMode error: ".concat(String.valueOf(i)));
      return;
    case -1: 
      paramWebViewCallback.error(DeviceError.APPLICATION_CONTEXT_NULL, new Object[] { Integer.valueOf(i) });
      return;
  ...
  public static void getScreenBrightness(WebViewCallback paramWebViewCallback)
  {
    ...
    if (i != -1)
    {
      DeviceLog.error("Unhandled screenBrightness error: ".concat(String.valueOf(i)));
      return;
    }
    paramWebViewCallback.error(DeviceError.APPLICATION_CONTEXT_NULL, new Object[] { Integer.valueOf(i) });
  }
  ...
  private static StorageType getStorageTypeFromString(String paramString)
  {
    ...
    {
      DeviceLog.exception("Illegal argument: ".concat(String.valueOf(paramString)), localIllegalArgumentException);
    }
    return null;
  }
  ...
  public static void registerVolumeChangeListener(Integer paramInteger, WebViewCallback paramWebViewCallback)
  {
    ...
    if (_volumeChangeListeners.get(paramInteger.intValue()) == null)
    {
      IVolumeChangeListener local1 = new IVolumeChangeListener()
      {
        ...
        public final void onVolumeChanged(int paramAnonymousInt)
        {
