  ...
  extends BillingActivity
{
  ...
  public static boolean checkAppOfTheDayUnlocked(Context paramContext)
  {
    ...
    if (paramContext.getResources().getBoolean(2131492878))
    {
  ...
  {
    paramContext = paramContext.getResources().getString(2131230777);
  ...
  public boolean IsAdsHidden()
  {
    ...
    while ((!getResources().getBoolean(2131492871)) || (isFullVersion()) || (ChooseProcessingActivity.isItemPurchased(this, "remove_ads")) || (MarketingHelper.isTrialPeriod(this)) || (Build.VERSION.SDK_INT < 11) || (isPromoAppInstalled()) || (isFacebookPosted()) || (getProductIds().size() > 0) || (anyPackPurchased)) {
      return true;
    }
    return false;
  }
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    if (i != 0)
    {
      ...
      ((ImageView)findViewById(2131689676)).startAnimation(paramBundle);
    }
  ...
  {
    super.onStart();
    FlurryAgent.onStartSession(getApplicationContext(), getString(2131230797));
