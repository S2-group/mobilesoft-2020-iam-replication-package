...
public class AndroidNCompat
{
  ...
  {
    // Byte code:
    //   0: invokestatic 165	com/google/vr/cardboard/AndroidNCompat:isAtLeastN	()Z
    //   3: ifne +4 -> 7
    //   6: return
    //   7: ldc_w 273
    //   10: ldc_w 274
    ...
    //   17: dup
    //   18: iconst_0
    //   19: getstatic 280	java/lang/Integer:TYPE	Ljava/lang/Class;
    //   22: aastore
    //   23: invokevirtual 284	java/lang/Class:getMethod	(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
    //   26: astore_1
    //   27: aload_1
    //   28: aconst_null
    //   29: iconst_1
    ...
    //   34: iconst_0
    //   35: iload_0
    //   36: invokestatic 287	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   39: aastore
    //   40: invokevirtual 293	java/lang/reflect/Method:invoke	(Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;
    //   43: pop
    //   44: return
    //   45: astore_1
    ...
    //   49: astore_2
    //   50: aload_1
    //   51: invokestatic 232	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   54: astore_1
    //   55: aload_2
    //   56: new 234	java/lang/StringBuilder
    //   59: dup
    //   60: aload_1
    //   61: invokestatic 232	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   64: invokevirtual 238	java/lang/String:length	()I
    //   67: bipush 30
    //   69: iadd
    //   70: invokespecial 240	java/lang/StringBuilder:<init>	(I)V
    //   73: ldc_w 295
    //   76: invokevirtual 246	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   79: aload_1
    //   80: invokevirtual 246	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   83: invokevirtual 249	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   86: invokestatic 208	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;)I
    //   89: pop
    //   90: return
    //   91: astore_1
    //   92: invokestatic 297	com/google/vr/cardboard/AndroidNCompat:isAtLeastNMR1	()Z
    //   95: ifeq +48 -> 143
    //   98: getstatic 50	com/google/vr/cardboard/AndroidNCompat:TAG	Ljava/lang/String;
    //   101: astore_2
    //   102: aload_1
    //   103: invokestatic 232	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   106: astore_1
    //   107: aload_2
    //   108: new 234	java/lang/StringBuilder
    //   111: dup
    //   112: aload_1
    //   113: invokestatic 232	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   116: invokevirtual 238	java/lang/String:length	()I
    //   119: bipush 38
    //   121: iadd
    //   122: invokespecial 240	java/lang/StringBuilder:<init>	(I)V
    //   125: ldc_w 299
    ...
    //   138: invokestatic 208	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;)I
    //   141: pop
    //   142: return
    //   143: getstatic 50	com/google/vr/cardboard/AndroidNCompat:TAG	Ljava/lang/String;
    //   146: astore_2
    //   147: aload_1
    //   148: invokestatic 232	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   151: astore_1
    //   152: aload_2
    //   153: new 234	java/lang/StringBuilder
    //   156: dup
    //   157: aload_1
    //   158: invokestatic 232	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   161: invokevirtual 238	java/lang/String:length	()I
    //   164: bipush 38
    //   166: iadd
    //   167: invokespecial 240	java/lang/StringBuilder:<init>	(I)V
    //   170: ldc_w 299
    ...
    //   180: invokevirtual 249	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   183: invokestatic 252	android/util/Log:w	(Ljava/lang/String;Ljava/lang/String;)I
    //   186: pop
    //   187: return
    //   188: astore_1
    //   189: goto -143 -> 46
