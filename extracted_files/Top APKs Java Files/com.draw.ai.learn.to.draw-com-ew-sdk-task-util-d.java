...
public class d
{
  ...
  public static long a(b.a paramA)
  {
    ...
    catch (Exception paramA)
    {
      ...
      com.ew.sdk.a.f.c(((StringBuilder)localObject).toString());
    }
    return 0L;
  }
  ...
  private static Map<String, Integer> a(Map<String, Integer> paramMap, String paramString1, String paramString2)
  {
    ...
    {
      com.ew.sdk.a.f.b(paramMap.getMessage());
  ...
  public static long b(String paramString)
  {
    ...
    com.ew.sdk.a.f.c("TaskTools NumberFormatException,parseLong");
    return 0L;
  }
  ...
  private static Map<String, Integer> b(Map<String, Integer> paramMap, String paramString)
  {
    ...
    {
      com.ew.sdk.a.f.b(paramString.getMessage());
      paramString.printStackTrace();
    }
    return paramMap;
  }
  ...
  public static boolean b(Context paramContext)
  {
    ...
    catch (NullPointerException paramContext)
    {
      ...
      com.ew.sdk.a.f.c(localStringBuilder.toString());
    }
    return true;
  }
  ...
  public static Map<String, Integer> c(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      {
        com.ew.sdk.a.f.b(paramContext.getMessage());
        paramContext.printStackTrace();
  ...
  public static boolean c(com.ew.sdk.task.b.a paramA)
  {
    ...
    com.ew.sdk.a.f.b(localStringBuilder.toString());
  ...
  public static void d(Activity paramActivity)
  {
    try
    {
      ...
      if (i == 2)
      {
        ...
        com.ew.sdk.a.f.b("TaskTools set is-----SCREEN_ORIENTATION_PORTRAIT");
        return;
      }
      if (i == 1)
      {
    ...
    for (;;)
    {
      ...
      try
      {
        if ((!TextUtils.isEmpty(paramString)) && (com.ew.sdk.task.d.c.a().c().b(paramString)))
        {
          ...
          localStringBuilder.append(r.a(paramString));
