...
public class h
{
  ...
  public static void b(Context paramContext)
  {
    ...
    i(paramContext);
    b = new Pair("token", new com.startapp.android.publish.b.a.b.a().a(a(paramContext, d)));
    c = new Pair("token2", new com.startapp.android.publish.b.a.b.a().a(a(paramContext, e)));
    i.a("SimpleToken", 3, "simpleToken : [" + b + "]");
    i.a("SimpleToken", 3, "simpleToken2 : [" + c + "]");
  }
  ...
  public static Pair<String, String> c(Context paramContext)
  {
    ...
    {
      i.a("SimpleToken", 6, "failed to get simpleToken ", paramContext);
    }
    return localPair;
  }
  ...
  {
    i.a("SimpleToken", 3, "getPackageList entered");
    int j = 0;
    int i = 0;
    for (;;)
    {
      ...
      {
        i.a("SimpleToken", 6, "Could not complete getPackagesList", paramContext);
        k = j;
      }
    }
  }
  ...
  {
    g.b(paramContext, "shared_prefs_simple_token", (String)b.second);
    f = "token2";
    g = false;
  ...
  {
    g.b(paramContext, "shared_prefs_simple_token2", (String)c.second);
    f = "token";
    h = false;
  ...
  private static boolean g(Context paramContext)
  {
    if (com.startapp.android.publish.adsCommon.adinformation.a.b().a().g().b(paramContext))
    {
      ...
      while (!new Pair("token", g.a(paramContext, "shared_prefs_simple_token", "")).equals(b)) {
        return true;
      }
      return false;
    }
  ...
  private static boolean h(Context paramContext)
  {
    if (MetaData.getInstance().isSimpleToken2())
    {
      ...
      while (!new Pair("token2", g.a(paramContext, "shared_prefs_simple_token2", "")).equals(c)) {
        return true;
      }
      return false;
    }
