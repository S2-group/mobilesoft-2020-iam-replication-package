  ...
  extends WebView
{
  ...
  protected void init(Context paramContext)
  {
    ...
    super.setWebViewClient(new WebViewClient()
    {
      ...
      {
        if (!AdvancedWebView.this.isPermittedUrl(paramAnonymousString)) {
          if (AdvancedWebView.this.mListener != null) {
  ...
  {
    return isPermittedUrl(paramString);
  }
  
  public boolean isPermittedUrl(String paramString)
  {
    ...
    if ((localObject != null) && (!((String)localObject).matches("^[a-zA-Z0-9._!~*')(;:&=+$,%-]*$"))) {
      return false;
    }
    localObject = this.mPermittedHostnames.iterator();
    String str;
    do
    {
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          this.mFileUploadCallbackSecond.onReceiveValue(localObject1);
