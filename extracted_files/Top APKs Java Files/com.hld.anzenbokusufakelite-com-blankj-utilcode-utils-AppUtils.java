...
public class AppUtils
{
  ...
  public static boolean cleanAppData(Context paramContext, File... paramVarArgs)
  {
    boolean bool1 = CleanUtils.cleanInternalCache(paramContext);
    boolean bool2 = CleanUtils.cleanInternalDbs(paramContext);
    boolean bool3 = CleanUtils.cleanInternalSP(paramContext);
    boolean bool4 = CleanUtils.cleanInternalFiles(paramContext);
    bool1 = CleanUtils.cleanExternalCache(paramContext) & bool1 & bool2 & bool3 & bool4;
  ...
  public static boolean cleanAppData(Context paramContext, String... paramVarArgs)
  {
    ...
    return cleanAppData(paramContext, arrayOfFile);
  }
  ...
  public static boolean installAppSilent(Context paramContext, String paramString)
  {
  ...
  {
    return (!StringUtils.isSpace(paramString)) && (paramString.equals(ProcessUtils.getForegroundProcessName(paramContext)));
  }
  ...
  {
    return (!StringUtils.isSpace(paramString)) && (IntentUtils.getLaunchAppIntent(paramContext, paramString) != null);
  }
  ...
  public static void launchApp(Activity paramActivity, String paramString, int paramInt)
  {
    ...
    paramActivity.startActivityForResult(IntentUtils.getLaunchAppIntent(paramActivity, paramString), paramInt);
  }
  ...
  public static void launchApp(Context paramContext, String paramString)
  {
    ...
    paramContext.startActivity(IntentUtils.getLaunchAppIntent(paramContext, paramString));
  }
