  ...
  extends BBThirdNoFrameworkActivity
{
  ...
  private void addWebPage()
  {
    ...
    this.mWebView.setWebViewClient(new WebViewClient()
    {
      ...
      {
        if ((!paramAnonymousSslError.hasError(4)) && (!paramAnonymousSslError.hasError(1)) && (!paramAnonymousSslError.hasError(2)) && (!paramAnonymousSslError.hasError(5)) && (!paramAnonymousSslError.hasError(0)) && (!paramAnonymousSslError.hasError(3)))
        {
