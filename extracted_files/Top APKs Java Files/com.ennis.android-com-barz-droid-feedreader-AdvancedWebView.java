package com.barz.droid.feedreader;
  ...
  extends WebView
{
  ...
  @SuppressLint({"NewApi"})
  private Intent createCaptureIntent(WebChromeClient.FileChooserParams paramFileChooserParams)
  {
    String str = "*/*";
    String[] arrayOfString = null;
    if (Build.VERSION.SDK_INT >= 21) {
      arrayOfString = paramFileChooserParams.getAcceptTypes();
    }
    paramFileChooserParams = str;
    if (arrayOfString != null)
    {
      paramFileChooserParams = str;
      if (arrayOfString.length > 0) {
        paramFileChooserParams = arrayOfString[0];
      }
    }
    if (paramFileChooserParams.equals("image/*")) {
      return ImagePicker.getPickImageIntent((Context)this.mActivity.get());
    }
    if (paramFileChooserParams.equals("video/*")) {
      return ImagePicker.getPickVideoIntent((Context)this.mActivity.get());
    }
    if (paramFileChooserParams.equals("audio/*")) {
  ...
  protected void init(Context paramContext)
  {
    ...
    super.setWebViewClient(new WebViewClient()
    {
      ...
      public void onUnhandledInputEvent(WebView paramAnonymousWebView, InputEvent paramAnonymousInputEvent)
      {
        ...
        {
          if (AdvancedWebView.this.mCustomWebViewClient != null) {
            AdvancedWebView.this.mCustomWebViewClient.onUnhandledInputEvent(paramAnonymousWebView, paramAnonymousInputEvent);
          }
        }
        else {
          return;
        }
        super.onUnhandledInputEvent(paramAnonymousWebView, paramAnonymousInputEvent);
      }
      ...
      public boolean shouldOverrideUrlLoading(WebView paramAnonymousWebView, String paramAnonymousString)
      {
        ...
        while ((AdvancedWebView.this.mCustomWebViewClient != null) && (AdvancedWebView.this.mCustomWebViewClient.shouldOverrideUrlLoading(paramAnonymousWebView, paramAnonymousString))) {
          return true;
        }
    ...
    super.setWebChromeClient(new WebChromeClient()
    {
      ...
      {
        AdvancedWebView.this.openFileInput(null, paramAnonymousValueCallback, paramAnonymousFileChooserParams);
        return true;
      }
      ...
      {
        AdvancedWebView.this.openFileInput(paramAnonymousValueCallback, null, null);
      }
    });
    setDownloadListener(new DownloadListener()
    {
      ...
      {
        if (AdvancedWebView.this.mListener != null) {
          AdvancedWebView.this.mListener.onDownloadRequested(paramAnonymousString1, paramAnonymousString2, paramAnonymousString3, paramAnonymousString4, paramAnonymousLong);
        }
      }
    });
  }
  ...
  public void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    do
    {
      do
      {
        ...
        return;
        Object localObject = ImagePicker.getImageUriFromResult((Context)this.mActivity.get(), paramInt2, paramIntent);
        if ((localObject != null) && (this.mFileUploadCallbackSecond != null)) {}
        try
        {
  ...
  @SuppressLint({"NewApi"})
  protected void openFileInput(ValueCallback<Uri> paramValueCallback, ValueCallback<Uri[]> paramValueCallback1, WebChromeClient.FileChooserParams paramFileChooserParams)
  {
    if (this.mFileUploadCallbackFirst != null) {
      this.mFileUploadCallbackFirst.onReceiveValue(null);
    }
    ...
    {
      paramValueCallback = createCaptureIntent(paramFileChooserParams);
  ...
  public void setDesktopMode(boolean paramBoolean)
  {
    WebSettings localWebSettings = getSettings();
    if (paramBoolean) {}
    for (String str = localWebSettings.getUserAgentString().replace("Mobile", "eliboM").replace("Android", "diordnA");; str = localWebSettings.getUserAgentString().replace("eliboM", "Mobile").replace("diordnA", "Android"))
    {
