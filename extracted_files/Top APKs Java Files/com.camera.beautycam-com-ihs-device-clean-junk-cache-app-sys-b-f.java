  ...
  extends com.ihs.device.common.a.a<Void, h, List<HSAppSysCache>>
{
  ...
  protected List<HSAppSysCache> a(Void... paramVarArgs)
  {
    ...
    //   358: astore 5
    //   360: aload 6
    //   362: invokevirtual 139	java/lang/Exception:printStackTrace	()V
    //   365: aconst_null
    //   366: astore 6
    //   368: goto -59 -> 309
    //   371: aload_1
    ...
    //   374: aload 7
    //   376: aload 6
    //   378: invokeinterface 143 2 0
    //   383: ifeq -69 -> 314
    //   386: aload_1
    //   387: astore 5
    //   389: aload 7
    //   391: aload 6
    //   393: invokeinterface 147 2 0
    //   398: checkcast 149	com/ihs/device/clean/junk/cache/app/sys/HSAppSysCache
    //   401: astore 6
    //   403: aload_1
    //   404: astore 5
    //   406: aload 6
    //   408: aload 6
    //   410: invokevirtual 153	com/ihs/device/clean/junk/cache/app/sys/HSAppSysCache:c	()J
    //   413: aload_1
    //   414: iload_3
    //   415: invokeinterface 157 2 0
    //   420: ladd
    //   421: invokevirtual 160	com/ihs/device/clean/junk/cache/app/sys/HSAppSysCache:c	(J)V
    //   424: goto -110 -> 314
    //   427: astore 6
    //   429: aload_1
    //   430: astore 5
    //   432: aload 6
    //   434: invokevirtual 139	java/lang/Exception:printStackTrace	()V
    //   437: aload_1
    //   438: ifnull -98 -> 340
    //   441: aload_1
