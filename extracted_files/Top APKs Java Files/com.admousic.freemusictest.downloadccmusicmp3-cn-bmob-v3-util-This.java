...
public final class This
{
  ...
  private static String Code(String paramString)
  {
    ...
    //   8: astore_1
    //   9: new 152	java/io/FileInputStream
    //   12: dup
    //   13: aload_1
    //   14: invokespecial 155	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   17: astore_0
    //   18: aload_0
    //   19: invokevirtual 159	java/io/FileInputStream:getChannel	()Ljava/nio/channels/FileChannel;
    //   22: getstatic 165	java/nio/channels/FileChannel$MapMode:READ_ONLY	Ljava/nio/channels/FileChannel$MapMode;
    //   25: lconst_0
    //   26: aload_1
    //   27: invokevirtual 169	java/io/File:length	()J
    //   30: invokevirtual 175	java/nio/channels/FileChannel:map	(Ljava/nio/channels/FileChannel$MapMode;JJ)Ljava/nio/MappedByteBuffer;
    //   33: astore_1
    //   34: getstatic 36	cn/bmob/v3/util/This:V	Ljava/security/MessageDigest;
    //   37: aload_1
    //   38: invokevirtual 179	java/security/MessageDigest:update	(Ljava/nio/ByteBuffer;)V
    //   41: aload_0
    //   42: invokevirtual 182	java/io/FileInputStream:close	()V
    //   45: getstatic 36	cn/bmob/v3/util/This:V	Ljava/security/MessageDigest;
    //   48: invokevirtual 186	java/security/MessageDigest:digest	()[B
    //   51: invokestatic 189	cn/bmob/v3/util/This:Code	([B)Ljava/lang/String;
    //   54: areturn
    //   55: astore_1
    //   56: goto +6 -> 62
    //   59: astore_1
    ...
    //   63: ifnull +7 -> 70
    //   66: aload_0
    //   67: invokevirtual 182	java/io/FileInputStream:close	()V
    //   70: aload_1
    //   71: athrow
  ...
  private static final JSONObject Code(Context paramContext, TelephonyManager paramTelephonyManager)
  {
    ...
    try
    {
      if ((a.b(paramContext, "android.permission.ACCESS_FINE_LOCATION") != 0) || (a.b(paramContext, "android.permission.ACCESS_COARSE_LOCATION") != 0))
      {
  ...
  public static void Code(Context paramContext)
  {
    ...
    cn.bmob.v3.http.This.I().Code(str, paramContext).a(new j()
    {
      ...
      public final void onSubscribe(b paramAnonymousB) {}
    });
    paramContext = new JSONObject();
    str = darkness.Code().B();
    JSONObject localJSONObject2 = new JSONObject();
  ...
  private static final JSONObject S(Context paramContext)
  {
    ...
    try
    {
      ...
      if ((str != null) && ((a.b(paramContext, "android.permission.ACCESS_FINE_LOCATION") == 0) || (a.b(paramContext, "android.permission.ACCESS_COARSE_LOCATION") == 0)))
      {
  ...
  private static JSONObject V(Context paramContext)
  {
    ...
    //   8: aload_2
    //   9: ldc_w 467
    //   12: getstatic 472	android/os/Build$VERSION:SDK_INT	I
    //   15: invokevirtual 114	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   18: pop
    //   19: aload_2
    //   20: ldc_w 474
    //   23: aload_0
    //   24: invokestatic 476	cn/bmob/v3/util/This:C	(Landroid/content/Context;)Ljava/lang/String;
    //   27: invokevirtual 106	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   30: pop
    //   31: aload_2
    //   32: ldc_w 478
    //   35: invokestatic 480	cn/bmob/v3/util/This:V	()Lorg/json/JSONObject;
    //   38: invokevirtual 106	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   41: pop
    //   42: aload_2
    //   43: ldc_w 381
    //   46: aload_0
    //   47: invokestatic 482	cn/bmob/v3/util/This:S	(Landroid/content/Context;)Lorg/json/JSONObject;
    //   50: invokevirtual 106	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   53: pop
    //   54: new 147	java/io/File
    //   57: dup
    //   58: ldc_w 484
    //   61: invokespecial 150	java/io/File:<init>	(Ljava/lang/String;)V
    //   64: invokevirtual 487	java/io/File:isFile	()Z
    //   67: ifne +233 -> 300
    //   70: new 147	java/io/File
    //   73: dup
    //   74: ldc_w 489
    //   77: invokespecial 150	java/io/File:<init>	(Ljava/lang/String;)V
    //   80: invokevirtual 487	java/io/File:isFile	()Z
    //   83: ifeq +212 -> 295
    //   86: goto +214 -> 300
    //   89: aload_2
    //   90: ldc_w 491
    //   93: iload_1
    //   94: invokevirtual 494	org/json/JSONObject:put	(Ljava/lang/String;Z)Lorg/json/JSONObject;
    //   97: pop
    //   98: aload_0
    //   99: ldc_w 496
    //   102: invokevirtual 362	android/content/Context:getSystemService	(Ljava/lang/String;)Ljava/lang/Object;
    //   105: checkcast 263	android/telephony/TelephonyManager
    //   108: astore_3
    //   109: aload_3
    //   110: ifnull +89 -> 199
    //   113: aload_2
    ...
    //   117: aload_0
    //   118: aload_3
    //   119: invokestatic 500	cn/bmob/v3/util/This:Code	(Landroid/content/Context;Landroid/telephony/TelephonyManager;)Lorg/json/JSONObject;
    //   122: invokevirtual 106	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   125: pop
    //   126: aload_2
    //   127: ldc_w 502
    //   130: aload_3
    //   131: invokevirtual 505	android/telephony/TelephonyManager:getNetworkOperator	()Ljava/lang/String;
    //   134: invokevirtual 106	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   137: pop
    //   138: aload_0
    //   139: ldc_w 507
    //   142: invokestatic 259	androidx/core/app/a:b	(Landroid/content/Context;Ljava/lang/String;)I
    //   145: ifne +22 -> 167
    //   148: aload_2
    //   149: ldc_w 509
    //   152: aload_3
    //   153: invokevirtual 512	android/telephony/TelephonyManager:getDeviceId	()Ljava/lang/String;
    //   156: invokevirtual 106	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   159: pop
    //   160: aload_3
    //   161: invokevirtual 512	android/telephony/TelephonyManager:getDeviceId	()Ljava/lang/String;
    //   164: invokestatic 514	cn/bmob/v3/util/thing:Code	(Ljava/lang/String;)V
    //   167: aload_2
    //   168: ldc_w 516
    //   171: aload_3
    //   172: invokevirtual 519	android/telephony/TelephonyManager:getSubscriberId	()Ljava/lang/String;
    //   175: invokevirtual 106	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   178: pop
    //   179: aload_2
    //   180: ldc_w 395
    //   183: aload_3
    //   184: invokevirtual 522	android/telephony/TelephonyManager:getNetworkType	()I
    ...
    //   200: ldc_w 524
    //   203: aload_0
    //   204: invokestatic 526	cn/bmob/v3/util/This:B	(Landroid/content/Context;)Lorg/json/JSONArray;
    //   207: invokevirtual 106	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   210: pop
    //   211: aload_2
    //   212: ldc_w 528
    //   215: aload_0
    //   216: invokestatic 531	cn/bmob/v3/util/This:Z	(Landroid/content/Context;)Lorg/json/JSONArray;
    //   219: invokevirtual 106	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   222: pop
    //   223: aload_2
    //   224: ldc_w 533
    //   227: invokestatic 535	cn/bmob/v3/util/This:Code	()Lorg/json/JSONObject;
    //   230: invokevirtual 106	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   233: pop
    //   234: aload_2
    //   235: ldc_w 358
    //   238: aload_0
    //   239: invokestatic 537	cn/bmob/v3/util/This:I	(Landroid/content/Context;)Lorg/json/JSONArray;
    //   242: invokevirtual 106	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   245: pop
    //   246: aload_2
    //   247: ldc_w 539
    //   250: new 245	java/lang/String
    //   253: dup
    //   254: ldc_w 541
    //   257: invokestatic 215	cn/bmob/v3/util/This:V	(Ljava/lang/String;)[B
    //   260: invokespecial 543	java/lang/String:<init>	([B)V
    //   263: invokevirtual 106	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   266: pop
    //   267: aload_2
    //   268: ldc_w 545
    //   271: aload_0
    //   272: invokestatic 549	cn/bmob/v3/util/V:Code	(Landroid/content/Context;)Ljava/lang/String;
  ...
  private static byte[] V(String paramString)
  {
    ...
    //   2: aconst_null
    //   3: astore_1
    //   4: new 152	java/io/FileInputStream
    //   7: dup
    //   8: aload_0
    //   9: invokespecial 550	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   12: astore_0
    //   13: aload_0
    //   14: invokevirtual 555	java/io/InputStream:available	()I
    //   17: newarray byte
    //   19: astore_2
    //   20: aload_0
    //   21: aload_2
    //   22: invokevirtual 559	java/io/InputStream:read	([B)I
    //   25: pop
    //   26: aload_2
    //   27: astore_1
    //   28: aload_0
    //   29: invokevirtual 560	java/io/InputStream:close	()V
    //   32: aload_2
    //   33: areturn
    //   34: astore_2
    //   35: aload_0
    ...
    //   60: astore_1
    //   61: aload_0
    //   62: invokevirtual 560	java/io/InputStream:close	()V
    //   65: aload_2
    //   66: areturn
    //   67: aload_1
    //   68: ifnull +7 -> 75
    //   71: aload_1
    //   72: invokevirtual 560	java/io/InputStream:close	()V
    //   75: aload_0
    //   76: athrow
    //   77: astore_0
    //   78: aload_2
