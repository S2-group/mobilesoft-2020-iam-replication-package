  ...
  extends BaseBo
{
  ...
  public static void copyAssets(String paramString1, String paramString2, String paramString3)
  {
    ...
    //   8: astore 7
    //   10: aload 7
    //   12: invokevirtual 95	java/io/File:exists	()Z
    //   15: ifne +19 -> 34
    //   18: aload 7
    //   20: invokevirtual 98	java/io/File:mkdirs	()Z
    //   23: ifne +11 -> 34
    //   26: ldc 100
    //   28: ldc 102
    //   30: invokestatic 108	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;)I
    //   33: pop
    //   34: aconst_null
    //   35: astore_1
    //   36: aconst_null
    ...
    //   45: aload 6
    //   47: astore_3
    //   48: getstatic 112	com/babybus/bbmodule/system/jni/plugin/manager/SystemBo:activity	Landroid/app/Activity;
    //   51: invokevirtual 118	android/app/Activity:getResources	()Landroid/content/res/Resources;
    //   54: invokevirtual 124	android/content/res/Resources:getAssets	()Landroid/content/res/AssetManager;
    //   57: aload_0
    //   58: invokevirtual 130	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   61: astore_0
    //   62: aload_0
    //   63: astore 4
    //   65: aload_0
    ...
    //   67: aload 6
    //   69: astore_3
    //   70: new 132	java/io/FileOutputStream
    //   73: dup
    //   74: new 88	java/io/File
    //   77: dup
    //   78: aload 7
    //   80: aload_2
    //   81: invokespecial 135	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   84: invokespecial 138	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   87: astore_2
    //   88: aload_0
    //   89: aload_2
    //   90: invokestatic 144	org/apache/commons/io/IOUtils:copy	(Ljava/io/InputStream;Ljava/io/OutputStream;)I
    //   93: pop
    //   94: aload_0
    //   95: invokevirtual 149	java/io/InputStream:close	()V
    //   98: aload_2
    //   99: invokevirtual 152	java/io/OutputStream:close	()V
    //   102: aload_0
    //   103: ifnull +7 -> 110
    //   106: aload_0
    //   107: invokevirtual 149	java/io/InputStream:close	()V
    //   110: aload_2
    //   111: ifnull +102 -> 213
    //   114: aload_2
    //   115: invokevirtual 152	java/io/OutputStream:close	()V
    //   118: return
    //   119: astore_2
    //   120: aload 5
    //   122: astore_0
    ...
    //   127: astore_3
    //   128: aload_2
    //   129: invokevirtual 155	java/io/IOException:printStackTrace	()V
    //   132: aload 4
    //   134: ifnull +8 -> 142
    //   137: aload 4
    //   139: invokevirtual 149	java/io/InputStream:close	()V
    //   142: aload_0
    //   143: ifnull -25 -> 118
    //   146: aload_0
    //   147: invokevirtual 152	java/io/OutputStream:close	()V
    //   150: return
    //   151: astore_0
    //   152: aload_0
    //   153: invokevirtual 155	java/io/IOException:printStackTrace	()V
    //   156: return
    //   157: astore_1
    //   158: aload_1
    //   159: invokevirtual 155	java/io/IOException:printStackTrace	()V
    //   162: goto -20 -> 142
    //   165: astore_0
    //   166: aload_1
    //   167: ifnull +7 -> 174
    //   170: aload_1
    //   171: invokevirtual 149	java/io/InputStream:close	()V
    //   174: aload_3
    //   175: ifnull +7 -> 182
    //   178: aload_3
    //   179: invokevirtual 152	java/io/OutputStream:close	()V
    //   182: aload_0
    //   183: athrow
    //   184: astore_1
    //   185: aload_1
    ...
    //   192: astore_1
    //   193: aload_1
    //   194: invokevirtual 155	java/io/IOException:printStackTrace	()V
    //   197: goto -15 -> 182
    //   200: astore_0
    //   201: aload_0
    //   202: invokevirtual 155	java/io/IOException:printStackTrace	()V
    //   205: goto -95 -> 110
    //   208: astore_0
    //   209: aload_0
    //   210: invokevirtual 155	java/io/IOException:printStackTrace	()V
    //   213: return
    //   214: astore 4
    //   216: aload_0
    //   217: astore_1
  ...
  public static String getLanguage()
  {
    ...
    for (;;)
    {
      if (i != 0)
      {
        ...
        if (((String)localObject1).equals("vi")) {
          return "vi";
        }
        if (((String)localObject1).equals("hi")) {
          return "hi";
        }
        if (((String)localObject1).equals("in")) {
          return "id";
        }
        if (((String)localObject1).equals("th")) {
          return "th";
        }
        return "en";
      }
  ...
  public static float getScreenSizeOfDevice()
  {
    ...
    activity.getWindowManager().getDefaultDisplay().getSize(localPoint);
    DisplayMetrics localDisplayMetrics = activity.getResources().getDisplayMetrics();
    return (float)Math.sqrt(Math.pow(localPoint.x / localDisplayMetrics.xdpi, 2.0D) + Math.pow(localPoint.y / localDisplayMetrics.ydpi, 2.0D));
  }
  ...
  public static void launchApp(String paramString1, String paramString2, boolean paramBoolean)
  {
    BBApplication.getInstance().launchApp(activity, paramString1, paramString2, false);
  }
  
  public static void launchApp(String paramString, boolean paramBoolean)
  {
    BBApplication.getInstance().launchApp(activity, paramString, false);
  }
  ...
  public static void launchMarket(String paramString)
  {
    // Byte code:
    //   0: ldc_w 728
    //   3: getstatic 281	android/os/Build:BRAND	Ljava/lang/String;
    //   6: invokevirtual 466	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   9: ifeq +8 -> 17
    //   12: aload_0
    //   13: invokestatic 731	com/babybus/bbmodule/system/jni/plugin/manager/SystemBo:launchMarketLenovo	(Ljava/lang/String;)V
    //   16: return
    //   17: invokestatic 733	com/babybus/bbmodule/system/jni/plugin/manager/SystemBo:isMarketInstalledAmazon	()Z
    //   20: ifeq +45 -> 65
    //   23: new 735	android/content/Intent
    //   26: dup
    //   27: ldc_w 737
    //   30: new 166	java/lang/StringBuilder
    //   33: dup
    //   34: ldc_w 739
    //   37: invokespecial 167	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   40: aload_0
    //   41: invokevirtual 742	java/lang/String:trim	()Ljava/lang/String;
    //   44: invokevirtual 171	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   47: invokevirtual 175	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   50: invokestatic 748	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   53: invokespecial 751	android/content/Intent:<init>	(Ljava/lang/String;Landroid/net/Uri;)V
    //   56: astore_1
    //   57: getstatic 112	com/babybus/bbmodule/system/jni/plugin/manager/SystemBo:activity	Landroid/app/Activity;
    //   60: aload_1
    //   61: invokevirtual 755	android/app/Activity:startActivity	(Landroid/content/Intent;)V
    //   64: return
    //   65: aload_0
    //   66: invokestatic 758	com/babybus/bbmodule/system/jni/plugin/manager/SystemBo:launchMarketDefault	(Ljava/lang/String;)V
    //   69: return
    //   70: astore_1
    //   71: aload_0
    //   72: invokestatic 758	com/babybus/bbmodule/system/jni/plugin/manager/SystemBo:launchMarketDefault	(Ljava/lang/String;)V
    //   75: return
    //   76: astore_1
    //   77: goto -6 -> 71
    // Local variable table:
  ...
  public static void showCustomDialogQuitConfirm(String paramString1, final String paramString2, final String paramString3, final String paramString4, final String paramString5, final int paramInt1, final int paramInt2)
  {
    ...
    activity.runOnUiThread(new Runnable()
    {
      public void run()
      {
        ...
        {
          BBUtilsConst.isShowingExitDialog = true;
          localObject = (LinearLayout)LayoutInflater.from(SystemBo.activity).inflate(BBResources.getIdentifier(SystemBo.activity, "bb_custom_dialog_exit", "layout"), null);
          ...
          localObject = (Button)localAlertDialog.findViewById(BBResources.getIdentifier(SystemBo.activity, "bb_custom_dialog_exit_image_button", "id"));
          if ((SystemBo.this != null) && (!"".equals(SystemBo.this)))
          {
            if (!BBNetUtil.getInstance().isNetActive(SystemBo.activity)) {
              break label353;
            }
        ...
        for (;;)
        {
          ...
          ((Button)localObject).setWidth(BBApplication.dip2px(SystemBo.activity, 320.0F));
          ((Button)localObject).setHeight(BBApplication.dip2px(SystemBo.activity, 90.0F));
          Button localButton1 = (Button)localAlertDialog.findViewById(BBResources.getIdentifier(SystemBo.activity, "bb_custom_dialog_exit_btn_exit", "id"));
          localButton1.setText(SystemBo.activity.getString(BBResources.getIdentifier(SystemBo.activity, "bb_exit", "string")));
          Button localButton2 = (Button)localAlertDialog.findViewById(BBResources.getIdentifier(SystemBo.activity, "bb_custom_dialog_exit_btn_cancel", "id"));
          localButton2.setText(SystemBo.activity.getString(BBResources.getIdentifier(SystemBo.activity, "bb_resume", "string")));
          ((Button)localObject).setOnClickListener(new View.OnClickListener()
          {
            public void onClick(View paramAnonymous2View)
            {
              ...
              if (BBNetUtil.getInstance().isNetActive(SystemBo.activity)) {
                PlatformSystem.sendEventUMeng("e7ab289f66577f39dacaefa5190e703f", this.val$adid);
              }
              for (;;)
              {
                WebViewBo.openLink(this.val$url, this.val$key, this.val$name, this.val$umkey, this.val$opentype);
                return;
                PlatformSystem.sendEventUMeng("e7ab289f66577f39dacaefa5190e703f", this.val$adid + "(offline)");
              }
            }
          });
  ...
  {
    final String str = BBApplication.appkey;
    activity.runOnUiThread(new Runnable()
    {
      public void run()
      {
        new AlertDialog.Builder(SystemBo.activity).setMessage(SystemBo.this).setPositiveButton(paramString2, new DialogInterface.OnClickListener()
        {
          public void onClick(DialogInterface paramAnonymous2DialogInterface, int paramAnonymous2Int)
          {
            Log.e("showDialog4giveMePraise", "giveMePraise");
            PlatformSystem.giveMePraise(this.val$appKey);
          }
        }).setNeutralButton(paramString3, new DialogInterface.OnClickListener()
        {
          public void onClick(DialogInterface paramAnonymous2DialogInterface, int paramAnonymous2Int)
          {
            Log.e("showDialog4giveMePraise", "feedback");
            PlatformSystem.feedback();
          }
        }).show();
      }
    });
