...
public class a
{
  ...
  public static int jdMethod_break(String paramString)
  {
    paramString = jdMethod_this(paramString);
    try
    {
  ...
  public static void jdMethod_byte(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(goto))
    {
      ...
      com.babybus.g.a.jdMethod_do().jdMethod_do("73710E6383909444E1212D14505493E7", paramString[1], paramString[3]);
      com.babybus.g.a.jdMethod_do().jdMethod_do("6DF74A629FBBC344AB25D3E690E054F5", paramString[2]);
      return;
    }
  }
  ...
  {
    return (ag.jdMethod_do()) || (("2".equals(at.jdMethod_if("thirdad_network_state", "1"))) && (ag.jdMethod_int()));
  }
  
  public static String jdMethod_case(String paramString)
  {
  ...
  {
    return (h.jdMethod_do().jdMethod_do("VideoOl")) && (jdMethod_boolean("mv_re_state"));
  }
  
  public static boolean jdMethod_catch(String paramString)
  {
    return "thirdad".equals(paramString);
  }
  
  public static String jdMethod_char(String paramString)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      paramString = jdMethod_long(paramString.trim());
  ...
  public static boolean jdMethod_class(String paramString)
  {
  ...
  public static FrameLayout.LayoutParams jdMethod_do(Integer paramInteger)
  {
    ...
    if (paramInteger.intValue() == char)
    {
      paramInteger = new FrameLayout.LayoutParams(-2, -2);
      paramInteger.gravity = 51;
      paramInteger.topMargin = ax.jdMethod_try((int)(App.jdMethod_do().jdField_catch * 0.6F));
      return paramInteger;
    }
  ...
  public static void jdMethod_do(int paramInt)
  {
    ...
    com.babybus.g.a.jdMethod_do().jdMethod_do("7801865ED51C26915AD95DBF252DE4D0", jdMethod_for(paramInt));
  }
  ...
  public static void jdMethod_do(int paramInt, String paramString)
  {
    ...
    com.babybus.g.a.jdMethod_do().jdMethod_do("792C32929B70085C8C82D9C6183B7120", jdMethod_for(paramInt), paramString);
  }
  ...
  private static void jdMethod_do(int paramInt, String paramString1, String paramString2)
  {
    ...
    String str3 = native(paramString2);
    if (TextUtils.isEmpty(paramString1)) {
      com.babybus.g.a.jdMethod_do().jdMethod_do(str1, paramString2, str3, "");
    } else {
      com.babybus.g.a.jdMethod_do().jdMethod_do(str1, paramString1, paramString2, str3);
    }
    if (paramInt != 0) {
      com.babybus.g.a.jdMethod_do().jdMethod_if(str2, str3, "");
    }
  }
  ...
  public static void jdMethod_do(ADMediaBean paramADMediaBean, String paramString)
  {
    if ((paramADMediaBean != null) && (!TextUtils.isEmpty(paramADMediaBean.getBlockInfo())))
    {
      ...
      com.babybus.g.a.jdMethod_do().jdMethod_if("2415A004-712F-D8D5-3BB2-0C1F40F3F3E3", paramADMediaBean, paramString);
      return;
    }
  }
  ...
  public static void jdMethod_do(String paramString, ADMediaBean paramADMediaBean)
  {
    if (paramADMediaBean != null)
    {
      ...
      com.babybus.g.a localA = com.babybus.g.a.jdMethod_do();
      StringBuilder localStringBuilder = new StringBuilder();
      localStringBuilder.append(paramADMediaBean.getBlockInfo());
      localStringBuilder.append("_");
      localStringBuilder.append(paramADMediaBean.getPosition());
  ...
  public static void jdMethod_do(String paramString1, ADMediaBean paramADMediaBean, String paramString2)
  {
    if ((paramADMediaBean != null) && (!TextUtils.isEmpty(paramADMediaBean.getBlockInfo())))
    {
      ...
      com.babybus.g.a.jdMethod_do().jdMethod_do(paramString1, paramADMediaBean.getBlockInfo(), paramADMediaBean.getAppKey(), paramString2);
      return;
    }
  }
  ...
  public static void jdMethod_do(String paramString1, String paramString2, String paramString3)
  {
    ...
    com.babybus.g.a.jdMethod_do().jdMethod_do(paramString1, str, paramString3);
  }
  ...
  {
    return "default".equals(paramString);
  }
  ...
  {
    return "通龄".equals(jdMethod_char(paramString));
  }
  ...
  {
    return jdMethod_default("thirdad_banner_state");
  }
  ...
  public static int jdMethod_for(String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {
      return 0;
    }
  ...
  public static String jdMethod_for(int paramInt)
  {
    if (paramInt != 14)
    {
      switch (paramInt)
  ...
  public static void jdMethod_for(String paramString1, String paramString2)
  {
    try
    {
      if (!TextUtils.isEmpty(paramString2))
      {
        ...
        if ("2".equals(str))
        {
          com.babybus.g.a.jdMethod_do().jdMethod_do(paramString1, "退屏", paramString2);
          return;
        }
        if ("3".equals(str))
        {
          com.babybus.g.a.jdMethod_do().jdMethod_do(paramString1, "插屏", paramString2);
          return;
        }
      }
    }
  ...
  {
    return "默认图".equals(jdMethod_char(paramString));
  }
  ...
  public static void jdMethod_if(int paramInt)
  {
    ...
    com.babybus.g.a.jdMethod_do().jdMethod_do("966B60711E1BBFBE56CCA8C2D814EE3A", jdMethod_for(paramInt));
  }
  
  public static void jdMethod_if(String paramString1, String paramString2)
  {
    paramString2 = jdMethod_int(paramString2);
    com.babybus.g.a.jdMethod_do().jdMethod_do("9E7F27AA000DFCA27D886F652232293D", paramString1, paramString2);
  }
  ...
  public static boolean jdMethod_if(String paramString)
  {
    if (paramString.indexOf("|") > 0)
    {
      ...
      while (i < j)
      {
        if (TextUtils.equals("ad", paramString[i])) {
          return true;
        }
        i += 1;
      }
  ...
  public static String jdMethod_import(String paramString)
  {
    switch (paramString.hashCode())
    {
    default: 
  ...
  public static void jdMethod_int(String paramString1, String paramString2)
  {
    try
    {
      if ((TextUtils.isEmpty(paramString2)) || (jdMethod_return(paramString2))) {
        return;
      }
      ...
      try
      {
        ...
        {
          com.babybus.g.a.jdMethod_do().jdMethod_do(paramString1, paramString2);
          return;
        }
        if ((String.valueOf(8).equals(str3)) && ("大全".equals(str1)))
        {
          com.babybus.g.a.jdMethod_do().jdMethod_do(paramString1);
          return;
        }
        if (TextUtils.isEmpty(paramString2))
        {
          com.babybus.g.a.jdMethod_do().jdMethod_do(paramString1, str1);
          return;
        }
        if ("福利".equals(str1))
        {
        ...
        com.babybus.g.a.jdMethod_do().jdMethod_do(paramString1, str1, paramString2);
        return;
      }
  ...
  {
    switch (jdMethod_for(paramString))
    {
    default: 
      break;
    case 31: 
      jdMethod_try(paramString);
      break;
    case 30: 
  ...
  public static void jdMethod_new(String paramString1, String paramString2)
  {
    ...
    try
    {
      if ((TextUtils.isEmpty(paramString1)) || (jdMethod_return(paramString1))) {
        return;
      }
      ...
      try
      {
        ...
        int i = jdMethod_for((String)localObject);
        if (paramString1.length == 3)
        {
          if (jdMethod_class(paramString1[1])) {
            return;
          }
        ...
        {
          if (jdMethod_class(paramString1[2])) {
            return;
          }
  ...
  public static boolean jdMethod_public(String paramString)
  {
    return "1".equals(paramString);
  }
  ...
  {
    return (jdMethod_float()) || (jdMethod_final()) || (jdMethod_class());
  }
  ...
  public static void jdMethod_static(String paramString)
  {
    String str;
    if (ad.jdMethod_do()) {
    ...
    com.babybus.g.a.jdMethod_do().jdMethod_do(str, paramString);
  }
  ...
  public static void jdMethod_switch(String paramString)
  {
    ...
    com.babybus.g.a.jdMethod_do().jdMethod_do("5512C49E64752F0BC98DB17C014EB623", str, paramString);
  }
  ...
  public static String[] throws(String paramString)
  {
    String[] arrayOfString1;
    if ((!TextUtils.isEmpty(paramString)) && (!jdMethod_return(paramString))) {
      arrayOfString1 = paramString.split(goto);
    } else {
      arrayOfString1 = null;
    }
  ...
  public static void jdMethod_try(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(goto))
    {
      ...
      paramString = paramString.split(goto);
      com.babybus.g.a.jdMethod_do().jdMethod_do("FB92BCE53C8C91F11B1F12FE511D4766", paramString[1], paramString[3]);
      com.babybus.g.a.jdMethod_do().jdMethod_do("C605B8D0B7AF03E42976957DFEC6A07E", paramString[2]);
      return;
    }
  }
  ...
  {
    return (jdMethod_extends("thirdad_startup_state")) && (jdMethod_byte());
  }
  
  public static long jdMethod_void(String paramString)
  {
    paramString = jdMethod_this(paramString);
    try
    {
