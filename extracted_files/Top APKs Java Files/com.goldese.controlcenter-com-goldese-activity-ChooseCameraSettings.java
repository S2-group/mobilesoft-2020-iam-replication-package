...
public class ChooseCameraSettings
  ...
  implements bci.b
{
  private String n = "ChooseCameraSettings";
  private Context o;
  ...
  {
    int i = 0;
    String str = this.s.getString("camera_application", "");
    if (!"".equals(str)) {
      try
      {
  ...
  private ArrayList<bec.a> g()
  {
    ...
    catch (Throwable localThrowable)
    {
      runOnUiThread(new Runnable()
      {
        ...
        {
          Toast.makeText(ChooseCameraSettings.a(ChooseCameraSettings.this), 2131230744, 1).show();
        }
      });
      return null;
    }
  ...
  public final void a_(int paramInt)
  {
    try
    {
      ...
      this.s.edit().putString("camera_application", localA.c).apply();
      return;
    }
    catch (Throwable localThrowable)
    {
    ...
    extends AsyncTask<Void, Void, ArrayList<bec.a>>
  {
    ...
    {
      super.onPreExecute();
      this.b = new bcx(ChooseCameraSettings.this);
