  ...
  extends BaseBo
{
  ...
  public static void copyAssets(String paramString1, String paramString2, String paramString3)
  {
    ...
    //   8: astore 7
    //   10: aload 7
    //   12: invokevirtual 96	java/io/File:exists	()Z
    //   15: ifne +11 -> 26
    //   18: aload 7
    //   20: invokevirtual 99	java/io/File:mkdirs	()Z
    //   23: ifne +3 -> 26
    //   26: aconst_null
    //   27: astore_1
    //   28: aconst_null
    ...
    //   37: aload 6
    //   39: astore_3
    //   40: invokestatic 105	com/babybus/utils/UIUtil:getResources	()Landroid/content/res/Resources;
    //   43: invokevirtual 111	android/content/res/Resources:getAssets	()Landroid/content/res/AssetManager;
    //   46: aload_0
    //   47: invokevirtual 117	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   50: astore_0
    //   51: aload_0
    //   52: astore 4
    //   54: aload_0
    ...
    //   56: aload 6
    //   58: astore_3
    //   59: new 119	java/io/FileOutputStream
    //   62: dup
    //   63: new 89	java/io/File
    //   66: dup
    //   67: aload 7
    //   69: aload_2
    //   70: invokespecial 122	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   73: invokespecial 125	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   76: astore_2
    //   77: aload_0
    //   78: aload_2
    //   79: invokestatic 131	com/babybus/utils/IOUtil:copy	(Ljava/io/InputStream;Ljava/io/OutputStream;)I
    //   82: pop
    //   83: aload_0
    //   84: invokevirtual 136	java/io/InputStream:close	()V
    //   87: aload_2
    //   88: invokevirtual 139	java/io/OutputStream:close	()V
    //   91: aload_0
    //   92: ifnull +7 -> 99
    //   95: aload_0
    //   96: invokevirtual 136	java/io/InputStream:close	()V
    //   99: aload_2
    //   100: ifnull +128 -> 228
    //   103: aload_2
    //   104: invokevirtual 139	java/io/OutputStream:close	()V
    //   107: return
    //   108: astore_0
    //   109: aload_0
    //   110: invokevirtual 142	java/io/IOException:printStackTrace	()V
    //   113: goto -14 -> 99
    //   116: astore_0
    //   117: aload_0
    //   118: invokevirtual 142	java/io/IOException:printStackTrace	()V
    //   121: return
    //   122: astore_2
    //   123: aload 5
    //   125: astore_0
    ...
    //   130: astore_3
    //   131: aload_2
    //   132: invokevirtual 142	java/io/IOException:printStackTrace	()V
    //   135: aload 4
    //   137: ifnull +8 -> 145
    //   140: aload 4
    //   142: invokevirtual 136	java/io/InputStream:close	()V
    //   145: aload_0
    //   146: ifnull -39 -> 107
    //   149: aload_0
    //   150: invokevirtual 139	java/io/OutputStream:close	()V
    //   153: return
    //   154: astore_0
    //   155: aload_0
    //   156: invokevirtual 142	java/io/IOException:printStackTrace	()V
    //   159: return
    //   160: astore_1
    //   161: aload_1
    //   162: invokevirtual 142	java/io/IOException:printStackTrace	()V
    //   165: goto -20 -> 145
    //   168: astore_0
    //   169: aload_1
    //   170: ifnull +7 -> 177
    //   173: aload_1
    //   174: invokevirtual 136	java/io/InputStream:close	()V
    //   177: aload_3
    //   178: ifnull +7 -> 185
    //   181: aload_3
    //   182: invokevirtual 139	java/io/OutputStream:close	()V
    //   185: aload_0
    //   186: athrow
    //   187: astore_1
    //   188: aload_1
    //   189: invokevirtual 142	java/io/IOException:printStackTrace	()V
    //   192: goto -15 -> 177
    //   195: astore_1
    //   196: aload_1
    //   197: invokevirtual 142	java/io/IOException:printStackTrace	()V
    //   200: goto -15 -> 185
    //   203: astore 4
    //   205: aload_0
    //   206: astore_1
  ...
  public static boolean joinQQGroup()
  {
    ...
    localIntent.setData(Uri.parse("mqqopensdkapi://bizAgent/qm/qr?url=http%3A%2F%2Fqm.qq.com%2Fcgi-bin%2Fqm%2Fqr%3Ffrom%3Dapp%26p%3Dandroid%26k%3D" + "cYU23XmwgZo22S3oJOsTjU7yLPjSPWM4"));
    try
    {
  ...
  public static void launchMarket(String paramString)
  {
    // Byte code:
    //   0: ldc_w 586
    //   3: getstatic 315	android/os/Build:BRAND	Ljava/lang/String;
    //   6: invokevirtual 589	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   9: ifeq +4 -> 13
    //   12: return
    //   13: invokestatic 591	com/babybus/bbmodule/system/jni/manager/SystemBo:isMarketInstalledAmazon	()Z
    //   16: ifeq +56 -> 72
    //   19: new 564	android/content/Intent
    //   22: dup
    //   23: ldc_w 593
    //   26: new 154	java/lang/StringBuilder
    //   29: dup
    //   30: invokespecial 155	java/lang/StringBuilder:<init>	()V
    //   33: ldc_w 595
    //   36: invokevirtual 159	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   39: aload_0
    //   40: invokevirtual 598	java/lang/String:trim	()Ljava/lang/String;
    ...
    //   49: invokestatic 575	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   52: invokespecial 601	android/content/Intent:<init>	(Ljava/lang/String;Landroid/net/Uri;)V
    //   55: astore_1
    //   56: aload_1
    //   57: ldc_w 602
    //   60: invokevirtual 606	android/content/Intent:setFlags	(I)Landroid/content/Intent;
    //   63: pop
    //   64: invokestatic 185	com/babybus/app/App:get	()Lcom/babybus/app/App;
    //   67: aload_1
    //   68: invokevirtual 607	com/babybus/app/App:startActivity	(Landroid/content/Intent;)V
    //   71: return
    //   72: aload_0
    //   73: invokestatic 610	com/babybus/bbmodule/system/jni/manager/SystemBo:launchMarketDefault	(Ljava/lang/String;)V
    //   76: return
    //   77: astore_1
    //   78: aload_0
    //   79: invokestatic 610	com/babybus/bbmodule/system/jni/manager/SystemBo:launchMarketDefault	(Ljava/lang/String;)V
    //   82: return
    //   83: astore_1
    //   84: goto -6 -> 78
    // Local variable table:
  ...
  @SuppressLint({"NewApi"})
  public static void showCustomDialogQuitConfirm(String paramString1, final String paramString2, final String paramString3, final String paramString4, String paramString5, final int paramInt1, int paramInt2)
  {
        ...
        for (;;)
        {
          ...
          ((Button)localObject).setOnClickListener(new View.OnClickListener()
          {
            public void onClick(View paramAnonymous2View)
            {
              ...
              {
                BBUmengAnalytics.get().sendEvent("a987a02a4d1f484d822ce6ddd59b39f9");
                WebViewBo.openLink(SystemBo.6.this.val$url, SystemBo.6.this.val$key, SystemBo.6.this.val$name, "2_selfad", SystemBo.6.this.val$opentype);
                localAlertDialog.dismiss();
                return;
              }
