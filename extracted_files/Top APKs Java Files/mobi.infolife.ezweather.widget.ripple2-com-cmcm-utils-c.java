...
public class c
{
  ...
  private List<PackageInfo> a(int paramInt)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 42	com/cmcm/utils/c:e	Ljava/lang/Object;
    //   4: astore_2
    //   5: aload_2
    //   6: monitorenter
    //   7: aload_0
    //   8: getfield 48	com/cmcm/utils/c:d	Ljava/util/List;
    //   11: ifnonnull +15 -> 26
    //   14: aload_0
    //   15: aload_0
    //   16: getfield 40	com/cmcm/utils/c:c	Landroid/content/pm/PackageManager;
    //   19: iload_1
    //   20: invokevirtual 53	android/content/pm/PackageManager:getInstalledPackages	(I)Ljava/util/List;
    //   23: putfield 48	com/cmcm/utils/c:d	Ljava/util/List;
    //   26: aload_2
    //   27: monitorexit
    //   28: aload_0
    //   29: getfield 48	com/cmcm/utils/c:d	Ljava/util/List;
    //   32: areturn
    //   33: astore_3
    //   34: aload_2
    //   35: monitorexit
