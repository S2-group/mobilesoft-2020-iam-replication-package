...
import com.sagepre.case.ChoiBounge;
import com.sagepre.finder.model.App;
import com.sagepre.finder.model.CollectionFinderResult;
    ...
    try
    {
      ...
      while (i < localList.size())
      {
        ...
        if ((localPackageInfo != null) && (localPackageInfo.packageName != null) && (localPackageInfo.applicationInfo != null))
        {
          ...
          {
            ChoiBounge.a("finder", localRuntimeException.getMessage(), localRuntimeException);
          }
          if (localObject != null)
          {
