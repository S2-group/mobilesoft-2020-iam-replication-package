  ...
  implements Runnable
{
  ...
  private void scan(UserState paramUserState, Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      if (paramUserState.getAndroidid() == null) {
      ...
      try
      {
        ...
        localObject2 = ((AdvertisingId)localObject1).getGoogleAdvertisingId(paramContext);
        if ((localObject2 != null) && (!((String)localObject2).equals("VALUE_NOT_DEFINED")))
        {
          paramUserState.setAndroidadvertisingid((String)localObject2);
          paramUserState.setAndroidadvertisingidoptout(Boolean.valueOf(((AdvertisingId)localObject1).getUserOptOutPreference(paramContext)));
        }
      }
      ...
      if (Utils.isPermissionGranted(paramContext, "android.permission.ACCESS_WIFI_STATE"))
      {
        if (paramUserState.getMacaddress() == null)
        {
          localObject1 = ((WifiManager)paramContext.getSystemService("wifi")).getConnectionInfo();
          if (localObject1 != null) {
            paramUserState.setMacaddress(((WifiInfo)localObject1).getMacAddress());
          }
        }
        if (localUserSettings.isEnableNetworkInfo())
        {
      ...
      if ((Utils.isPermissionGranted(paramContext, "android.permission.READ_PHONE_STATE")) && (paramUserState.getDeviceid() == null)) {
        paramUserState.setDeviceid(((TelephonyManager)paramContext.getSystemService("phone")).getDeviceId());
      }
  ...
  public void run()
  {
    ...
    do
    {
      ...
      localDeviceEventsAndroidPostData.setV("1.2.5");
      localDeviceEventsAndroidPostData.setD("2014-03-30");
