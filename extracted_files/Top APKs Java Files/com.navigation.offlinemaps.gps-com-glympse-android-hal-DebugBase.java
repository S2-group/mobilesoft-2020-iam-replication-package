...
public class DebugBase
{
  ...
  public static void deleteFile(Context paramContext, String paramString)
  {
    ...
    {
      e(paramString);
      t.a(paramContext).deleteFile(paramString);
      return;
    }
    catch (Throwable paramContext) {}
  }
  ...
  {
    paramContext = v.b(paramContext) + "/" + paramString;
    e(paramContext);
  ...
  public static int httpUpload(Context paramContext, String paramString1, String paramString2)
  {
    ...
    try
    {
      paramContext = v.b(paramContext) + "/" + paramString2;
      i = j;
      e(paramContext);
      i = j;
      ...
      i = j;
      ad.a(paramString2, paramString1);
      i = j;
  ...
  {
    if (t.b(paramContext, "android.permission.ACCESS_NETWORK_STATE")) {
  ...
  {
    Object localObject2 = t.a(paramContext);
  ...
  public static void runInBackground(long paramLong, Runnable paramRunnable)
  {
    try
    {
      new u(paramLong, paramRunnable, null).start();
      return;
    }
