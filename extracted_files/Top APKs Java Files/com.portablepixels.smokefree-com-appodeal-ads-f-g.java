...
public class g
{
  ...
  static void c()
  {
    Object localObject = Appodeal.d;
    if (localObject != null)
    {
      g localG = new g((Context)localObject, k, l, m);
      localObject = null;
      try
      {
        if (c != null) {
          localObject = localG.a(c);
        }
        if ((localObject != null) && (((f)localObject).c() != a.c()))
        {
          ((f)localObject).a();
          a((f)localObject);
          h();
  ...
  private Double r()
  {
    ...
    double d1 = com.appodeal.ads.utils.e.b(localSharedPreferences);
    double d2 = l1;
    Double.isNaN(d1);
    Double.isNaN(d2);
  ...
  public boolean b(@NonNull JSONArray paramJSONArray)
  {
    ...
    if (!localJSONArray.toString().equals(paramJSONArray.toString()))
    {
      c = paramJSONArray;
      return true;
    }
