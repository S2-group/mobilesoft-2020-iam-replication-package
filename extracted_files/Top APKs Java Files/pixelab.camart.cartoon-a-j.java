  ...
  public static List a(Context paramContext, long paramLong)
  {
    ...
    else
    {
      ...
      paramContext = new Runnable()
      {
        ...
        {
          // Byte code:
          //   0: invokestatic 28	a/j:a	()Z
          //   3: istore_1
          //   4: iload_1
          //   5: ifne +15 -> 20
          //   8: invokestatic 31	a/j:c	()Z
          //   11: pop
          //   12: aload_0
          //   13: getfield 18	a/j$1:b	Ljava/util/concurrent/CountDownLatch;
          ...
          //   23: lstore_2
          //   24: aload_0
          //   25: getfield 16	a/j$1:a	Landroid/content/Context;
          ...
          //   48: ifeq +12 -> 60
          //   51: invokestatic 62	a/j:b	()Ljava/util/concurrent/atomic/AtomicReference;
          //   54: invokevirtual 68	java/util/concurrent/atomic/AtomicReference:get	()Ljava/lang/Object;
          //   57: ifnonnull +37 -> 94
          //   60: new 70	a/j$a
          //   63: dup
          //   64: iconst_0
          //   65: invokespecial 73	a/j$a:<init>	(B)V
          //   68: astore 5
          //   70: aload 5
          //   72: aload 4
          //   74: invokestatic 79	java/util/Collections:unmodifiableList	(Ljava/util/List;)Ljava/util/List;
          //   77: putfield 82	a/j$a:a	Ljava/util/List;
          //   80: aload 5
          //   82: lload_2
          //   83: putfield 85	a/j$a:b	J
          //   86: invokestatic 62	a/j:b	()Ljava/util/concurrent/atomic/AtomicReference;
          //   89: aload 5
          //   91: invokevirtual 89	java/util/concurrent/atomic/AtomicReference:set	(Ljava/lang/Object;)V
          //   94: invokestatic 31	a/j:c	()Z
          //   97: pop
          //   98: aload_0
          //   99: getfield 18	a/j$1:b	Ljava/util/concurrent/CountDownLatch;
          ...
          //   118: goto -77 -> 41
          //   121: astore 4
          //   123: invokestatic 31	a/j:c	()Z
          //   126: pop
          //   127: aload_0
          //   128: getfield 18	a/j$1:b	Ljava/util/concurrent/CountDownLatch;
