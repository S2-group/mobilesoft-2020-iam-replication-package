...
public class gf
{
  ...
  {
    paramS = new l(paramS, paramS.a("@file:" + paramString1 + paramString2, new gg(paramString1, paramInt1, paramInt2)), paramBoolean1, paramBoolean2);
    if (!paramBoolean3) {
      paramS.e();
    }
    return paramS;
  ...
  public static void a(Context paramContext)
  {
    ...
    if ((bc.b) && ((localConfiguration.screenLayout & 0xF) < 4)) {
