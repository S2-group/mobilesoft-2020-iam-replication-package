...
import com.cosmo.lib.plugin.BaseApplication;
import com.cosmo.lib.plugin.g;
import com.cosmo.lib.plugin.o;
import com.cosmo.lib.plugin.s;
...
public class y
{
  ...
  public static boolean a(Context paramContext, String paramString)
  {
    ...
    {
      if (e.a()) {
        e.b(paramString + " - permission: " + bool);
      }
      return bool;
    }
  }
