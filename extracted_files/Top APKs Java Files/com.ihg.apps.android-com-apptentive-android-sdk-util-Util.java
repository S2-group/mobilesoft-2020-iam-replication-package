...
public class Util
{
  ...
  public static Date parseIso8601Date(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 269	java/lang/String:trim	()Ljava/lang/String;
    //   4: ldc_w 271
    //   7: ldc_w 273
    //   10: invokevirtual 277	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   13: ldc_w 279
    //   16: ldc_w 281
    //   19: invokevirtual 277	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   22: astore 4
    //   24: aload 4
    //   26: astore_3
    //   27: aload 4
    ...
    //   34: iconst_3
    //   35: isub
    //   36: invokevirtual 285	java/lang/String:charAt	(I)C
    //   39: bipush 58
    //   41: if_icmpne +44 -> 85
    //   44: aload 4
    //   46: ldc_w 287
    //   49: invokevirtual 291	java/lang/String:lastIndexOf	(Ljava/lang/String;)I
    //   52: istore_1
    ...
    //   59: iconst_0
    //   60: iload_1
    //   61: invokevirtual 297	java/lang/String:substring	(II)Ljava/lang/String;
    //   64: invokestatic 301	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   67: invokespecial 302	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   70: aload 4
    //   72: iload_1
    //   73: iconst_1
    //   74: iadd
    //   75: invokevirtual 305	java/lang/String:substring	(I)Ljava/lang/String;
    //   78: invokevirtual 309	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   81: invokevirtual 312	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   84: astore_3
    //   85: aload_3
    //   86: bipush 46
    //   88: invokevirtual 315	java/lang/String:lastIndexOf	(I)I
    //   91: istore_2
    //   92: aload_3
    //   93: bipush 43
    //   95: invokevirtual 315	java/lang/String:lastIndexOf	(I)I
    //   98: iconst_m1
    //   99: if_icmpeq +124 -> 223
    //   102: aload_3
    //   103: bipush 43
    //   105: invokevirtual 315	java/lang/String:lastIndexOf	(I)I
    //   108: istore_1
    //   109: aload_3
    //   110: astore 4
    //   112: iload_2
    ...
    //   120: iconst_1
    //   121: iadd
    //   122: invokevirtual 297	java/lang/String:substring	(II)Ljava/lang/String;
    //   125: astore 4
    //   127: aload_3
    //   128: iload_2
    //   129: iconst_1
    //   130: iadd
    //   131: iload_1
    //   132: invokevirtual 297	java/lang/String:substring	(II)Ljava/lang/String;
    //   135: astore 5
    //   137: aload_3
    //   138: iload_1
    //   139: invokevirtual 305	java/lang/String:substring	(I)Ljava/lang/String;
    //   142: astore_3
    //   143: ldc_w 317
    //   146: iconst_1
    ...
    //   152: aload 5
    //   154: aastore
    //   155: invokestatic 320	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   158: ldc_w 281
    //   161: ldc_w 322
    //   164: invokevirtual 277	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   167: astore 5
    //   169: new 293	java/lang/StringBuilder
    //   172: dup
    //   173: aload 4
    //   175: invokestatic 301	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   178: invokespecial 302	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   181: aload 5
    //   183: invokevirtual 309	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   186: aload_3
    //   187: invokevirtual 309	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   190: invokevirtual 312	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   193: astore 4
    //   195: aload 4
    //   197: ldc_w 324
    //   200: invokevirtual 328	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   203: ifeq +64 -> 267
    ...
    //   215: aload 4
    //   217: invokevirtual 331	java/text/SimpleDateFormat:parse	(Ljava/lang/String;)Ljava/util/Date;
    //   220: astore_0
    //   221: aload_0
    //   222: areturn
    //   223: aload_3
    //   224: bipush 45
    //   226: invokevirtual 315	java/lang/String:lastIndexOf	(I)I
    //   229: istore_1
    //   230: goto -121 -> 109
    //   233: astore_3
    //   234: new 293	java/lang/StringBuilder
    //   237: dup
    //   238: ldc_w 333
    //   241: invokespecial 302	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   244: aload_0
    //   245: invokevirtual 309	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   248: invokevirtual 312	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   251: aload_3
    //   252: iconst_0
    //   253: anewarray 4	java/lang/Object
    //   256: invokestatic 339	com/apptentive/android/sdk/Log:e	(Ljava/lang/String;Ljava/lang/Throwable;[Ljava/lang/Object;)V
    //   259: new 25	java/util/Date
    //   262: dup
    //   263: invokespecial 340	java/util/Date:<init>	()V
    //   266: areturn
    ...
    //   276: aload 4
    //   278: invokevirtual 331	java/text/SimpleDateFormat:parse	(Ljava/lang/String;)Ljava/util/Date;
    //   281: astore_0
    //   282: aload_0
    //   283: areturn
    //   284: astore_0
    ...
    //   288: dup
    //   289: ldc_w 342
    //   292: invokespecial 302	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   295: aload 4
    //   297: invokevirtual 309	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   300: invokevirtual 312	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   303: aload_0
    //   304: iconst_0
    //   305: anewarray 4	java/lang/Object
    //   308: invokestatic 339	com/apptentive/android/sdk/Log:e	(Ljava/lang/String;Ljava/lang/Throwable;[Ljava/lang/Object;)V
    //   311: aconst_null
    //   312: areturn
