  ...
  extends BillingActivity
{
  ...
  {
    if (getAppOfTheDayUnlocked(paramContext)) {
      return true;
    }
    ...
    if (paramContext.getResources().getBoolean(2131492875))
    {
  ...
  {
    boolean bool = paramContext.getSharedPreferences("appoftheday", 0).getBoolean("appoftheday_result", false);
    Log.d("SSS", "getAppOfTheDayUnlocked = " + bool);
    return bool;
  }
  
  public static Class getHomeScreenClass(Context paramContext)
  {
    paramContext = paramContext.getResources().getString(2131230930);
  ...
  public boolean IsAdsHidden()
  {
    ...
    while ((!getResources().getBoolean(2131492872)) || (isFullVersion()) || (ChooseProcessingActivity.isItemPurchased(this, "remove_ads")) || (MarketingHelper.isTrialPeriod(this)) || (Build.VERSION.SDK_INT < 11) || (isPromoAppInstalled()) || (isFacebookPosted()) || (getProductIds().size() > 0) || (anyPackPurchased)) {
      return true;
    }
    return false;
  }
  ...
  {
    boolean bool = paramContext.getSharedPreferences("appoftheday", 0).getBoolean("appoftheday_splash", false);
    Log.d("SSS", "getAppOfTheDaySplashAllowed = " + bool);
    return bool;
  }
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    if (!getString(2131230954).equals(""))
    {
      AppsFlyerLib.setAppsFlyerKey(getString(2131230954));
    ...
    if (i != 0)
    {
      ...
      ((ImageView)findViewById(2131624155)).startAnimation(paramBundle);
    }
  ...
  {
    super.onStart();
    FlurryAgent.onStartSession(getApplicationContext(), getString(2131230780));
