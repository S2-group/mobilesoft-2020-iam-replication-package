...
public final class l
{
  ...
  public static long a(java.io.File paramFile)
  {
    ...
    //   57: ldc -101
    //   59: ldc -99
    //   61: invokestatic 159	com/mintegral/msdk/base/utils/h:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   64: aload 8
    //   66: astore_0
    //   67: lload_2
    //   68: lstore 4
  ...
  public static String a(JSONArray paramJSONArray)
  {
    ...
    int j = ((com.mintegral.msdk.b.a)localObject).Z();
  ...
  public static void a(List<CampaignEx> paramList)
  {
    if (paramList != null)
    {
      ...
      while (i < j)
      {
        ...
        if ((!a(com.mintegral.msdk.base.controller.a.d().i(), localCampaignEx.getPackageName())) && (localCampaignEx != null) && (localCampaignEx.getOfferType() == 99)) {
          localArrayList.add(localCampaignEx);
        }
        i += 1;
      }
      s.a(i.a(com.mintegral.msdk.base.controller.a.d().i())).a(localArrayList);
      return;
    }
  }
  ...
  public static List<com.mintegral.msdk.base.entity.l> d()
  {
    ...
    //   0: ldc 46
    //   2: ldc_w 442
    //   5: invokestatic 55	com/mintegral/msdk/base/utils/h:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   8: new 254	java/util/ArrayList
    //   11: dup
    //   12: invokespecial 255	java/util/ArrayList:<init>	()V
    //   15: astore 5
    ...
    //   176: invokestatic 159	com/mintegral/msdk/base/utils/h:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   179: goto -132 -> 47
    //   182: aload_3
    ...
    //   230: astore_2
    //   231: goto -41 -> 190
    //   234: new 254	java/util/ArrayList
    //   237: dup
    //   238: invokespecial 255	java/util/ArrayList:<init>	()V
    //   241: astore_2
    //   242: invokestatic 176	com/mintegral/msdk/base/controller/a:d	()Lcom/mintegral/msdk/base/controller/a;
    //   245: invokevirtual 262	com/mintegral/msdk/base/controller/a:i	()Landroid/content/Context;
    //   248: invokevirtual 324	android/content/Context:getPackageManager	()Landroid/content/pm/PackageManager;
    //   251: astore_3
    //   252: iconst_0
    //   253: istore_1
    //   254: aload_3
    //   255: iconst_0
    //   256: invokevirtual 332	android/content/pm/PackageManager:getInstalledPackages	(I)Ljava/util/List;
    //   259: astore_3
    //   260: invokestatic 176	com/mintegral/msdk/base/controller/a:d	()Lcom/mintegral/msdk/base/controller/a;
    //   263: invokevirtual 335	com/mintegral/msdk/base/controller/a:b	()Ljava/util/List;
    //   266: astore 4
    //   268: iconst_0
    //   269: istore_0
    //   270: iload_0
    //   271: aload_3
    //   272: invokeinterface 252 1 0
    //   277: if_icmpge +88 -> 365
    //   280: aload_3
    //   281: iload_0
    //   282: invokeinterface 256 2 0
    //   287: checkcast 337	android/content/pm/PackageInfo
    //   290: astore 6
    //   292: aload 6
    //   294: getfield 341	android/content/pm/PackageInfo:applicationInfo	Landroid/content/pm/ApplicationInfo;
    //   297: getfield 346	android/content/pm/ApplicationInfo:flags	I
    //   300: iconst_1
    //   301: iand
    //   302: ifgt +18 -> 320
    //   305: aload_2
    //   306: aload 6
    //   308: getfield 349	android/content/pm/PackageInfo:packageName	Ljava/lang/String;
    //   311: invokeinterface 275 2 0
    //   316: pop
    //   317: goto +199 -> 516
    //   320: aload 4
    //   322: ifnull +194 -> 516
    //   325: aload 4
    //   327: invokeinterface 252 1 0
    //   332: ifle +184 -> 516
    //   335: aload 4
    //   337: aload 6
    //   339: getfield 349	android/content/pm/PackageInfo:packageName	Ljava/lang/String;
    //   342: invokeinterface 352 2 0
    //   347: ifeq +169 -> 516
    //   350: aload_2
    //   351: aload 6
    //   353: getfield 349	android/content/pm/PackageInfo:packageName	Ljava/lang/String;
    //   356: invokeinterface 275 2 0
    //   361: pop
    //   362: goto +154 -> 516
    //   365: new 254	java/util/ArrayList
    //   368: dup
    //   369: invokespecial 255	java/util/ArrayList:<init>	()V
    //   372: astore_3
    //   373: iload_1
    //   374: istore_0
    //   375: iload_0
    //   376: aload 5
    //   378: invokeinterface 252 1 0
    //   383: if_icmpge +85 -> 468
    //   386: aload 5
    //   388: iload_0
    //   389: invokeinterface 256 2 0
    //   394: checkcast 122	java/lang/String
    //   397: astore 4
    //   399: aload_2
    //   400: aload 4
    //   402: invokeinterface 352 2 0
    //   407: ifeq +116 -> 523
    ...
    //   437: invokestatic 55	com/mintegral/msdk/base/utils/h:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   440: new 493	com/mintegral/msdk/base/entity/l
    //   443: dup
    //   444: invokespecial 494	com/mintegral/msdk/base/entity/l:<init>	()V
    //   447: astore 6
    //   449: aload 6
    //   451: aload 4
    //   453: putfield 496	com/mintegral/msdk/base/entity/l:a	Ljava/lang/String;
    //   456: aload_3
    //   457: aload 6
    //   459: invokeinterface 275 2 0
    //   464: pop
    //   465: goto +58 -> 523
    //   468: ldc 46
    //   470: ldc_w 498
    //   473: invokestatic 55	com/mintegral/msdk/base/utils/h:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   476: aload_3
    //   477: areturn
    //   478: astore 4
    //   480: aload_2
    ...
    //   486: ifnull +15 -> 501
    //   489: aload_3
    //   490: invokevirtual 489	java/io/BufferedReader:close	()V
    //   493: goto +8 -> 501
    //   496: astore_3
    //   497: aload_3
    ...
    //   504: ldc 46
    //   506: aload_2
    //   507: invokevirtual 131	java/lang/Throwable:getMessage	()Ljava/lang/String;
    //   510: aload_2
    //   511: invokestatic 134	com/mintegral/msdk/base/utils/h:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   514: aconst_null
    //   515: areturn
    //   516: iload_0
    //   517: iconst_1
