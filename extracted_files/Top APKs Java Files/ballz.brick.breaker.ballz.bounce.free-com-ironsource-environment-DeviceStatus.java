...
public class DeviceStatus
{
  ...
  public static String getOrGenerateOnceUniqueIdentifier(Context paramContext)
  {
    ...
    //   6: invokestatic 356	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   9: ifne +12 -> 21
    ...
    //   22: ldc 26
    //   24: iconst_0
    //   25: invokevirtual 360	android/content/Context:getSharedPreferences	(Ljava/lang/String;I)Landroid/content/SharedPreferences;
    //   28: astore_0
    //   29: aload_0
    //   30: ldc 29
    //   32: iconst_1
    //   33: invokeinterface 366 3 0
    //   38: ifeq +55 -> 93
    //   41: aload_0
    //   42: ldc 8
    //   44: ldc 127
    //   46: invokeinterface 370 3 0
    //   51: astore_1
    //   52: aload_1
    //   53: invokestatic 356	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   56: ifeq +44 -> 100
    //   59: invokestatic 376	java/util/UUID:randomUUID	()Ljava/util/UUID;
    //   62: invokevirtual 377	java/util/UUID:toString	()Ljava/lang/String;
    ...
    //   107: astore_0
    //   108: aload_0
    //   109: invokevirtual 205	java/lang/Exception:printStackTrace	()V
    //   112: goto -19 -> 93
    //   115: astore_0
    //   116: ldc 2
    //   118: monitorexit
