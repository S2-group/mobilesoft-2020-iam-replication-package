...
public final class e
{
  ...
  public static void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    try
    {
      q = new JSONArray(localSharedPreferences.getString("sessions", "[]"));
      JSONObject localJSONObject = new JSONObject();
      localJSONObject.put("date", (int)(m / 1000.0D));
      q = a(q, localJSONObject);
      q = a(paramInt1, q);
      if (n <= 0) {}
    }
    catch (JSONException localJSONException2)
    {
      for (;;)
      {
        try
        {
          r = new JSONArray(localSharedPreferences.getString("history", "[]"));
          r = a(n, r);
          return;
        }
  ...
  public static void a(String paramString, double paramDouble)
  {
    ...
    for (;;)
    {
      if (i1 < f.length()) {
        try
        {
          localJSONObject = f.getJSONObject(i1);
        }
        catch (JSONException localJSONException1)
        {
          try
          {
            for (;;)
            {
              ...
              {
                a(f, i1);
                localJSONObject.put("creative", paramDouble);
                f.put(i1, localJSONObject);
              }
              i1 += 1;
              break;
  ...
  public static void a(String paramString1, String paramString2)
  {
    ...
    //   4: aload_0
    //   5: ldc_w 339
    //   8: invokevirtual 160	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   11: ifne +474 -> 485
    //   14: aload_1
    //   15: ldc_w 339
    //   18: invokevirtual 160	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   21: ifne +464 -> 485
    //   24: getstatic 43	com/revmob/android/e:p	I
    //   27: iconst_1
    //   28: iadd
    //   29: putstatic 43	com/revmob/android/e:p	I
    //   32: getstatic 143	com/revmob/android/e:r	Lorg/json/JSONArray;
    //   35: ifnull +104 -> 139
    //   38: iconst_0
    //   39: istore_2
    //   40: aconst_null
    ...
    //   45: astore 5
    //   47: iload_2
    //   48: getstatic 143	com/revmob/android/e:r	Lorg/json/JSONArray;
    //   51: invokevirtual 86	org/json/JSONArray:length	()I
    //   54: if_icmpge +40 -> 94
    //   57: getstatic 143	com/revmob/android/e:r	Lorg/json/JSONArray;
    //   60: iload_2
    //   61: invokevirtual 150	org/json/JSONArray:getJSONObject	(I)Lorg/json/JSONObject;
    //   64: astore 5
    //   66: aload 5
    //   68: invokevirtual 343	org/json/JSONObject:names	()Lorg/json/JSONArray;
    //   71: iconst_0
    //   72: invokevirtual 346	org/json/JSONArray:getString	(I)Ljava/lang/String;
    //   75: aload_0
    //   76: invokevirtual 160	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   79: istore_3
    //   80: iload_3
    //   81: ifeq +249 -> 330
    //   84: getstatic 143	com/revmob/android/e:r	Lorg/json/JSONArray;
    //   87: iload_2
    //   88: invokestatic 162	com/revmob/android/e:a	(Lorg/json/JSONArray;I)Lorg/json/JSONArray;
    //   91: putstatic 143	com/revmob/android/e:r	Lorg/json/JSONArray;
    //   94: aload 5
    //   96: ifnonnull +241 -> 337
    //   99: new 70	org/json/JSONObject
    //   102: dup
    //   103: invokespecial 126	org/json/JSONObject:<init>	()V
    //   106: astore 5
    //   108: aload 5
    //   110: aload_0
    //   111: iconst_1
    //   112: invokevirtual 135	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   115: pop
    //   116: getstatic 143	com/revmob/android/e:r	Lorg/json/JSONArray;
    //   119: aload 5
    //   121: invokestatic 137	com/revmob/android/e:a	(Lorg/json/JSONArray;Ljava/lang/Object;)Lorg/json/JSONArray;
    //   124: putstatic 143	com/revmob/android/e:r	Lorg/json/JSONArray;
    //   127: getstatic 102	com/revmob/android/e:n	I
    //   130: getstatic 143	com/revmob/android/e:r	Lorg/json/JSONArray;
    //   133: invokestatic 139	com/revmob/android/e:a	(ILorg/json/JSONArray;)Lorg/json/JSONArray;
    //   136: putstatic 143	com/revmob/android/e:r	Lorg/json/JSONArray;
    //   139: getstatic 125	com/revmob/android/e:q	Lorg/json/JSONArray;
    //   142: ifnull +103 -> 245
    //   145: getstatic 125	com/revmob/android/e:q	Lorg/json/JSONArray;
    //   148: iconst_0
    //   149: invokevirtual 150	org/json/JSONArray:getJSONObject	(I)Lorg/json/JSONObject;
    //   152: aload_1
    //   153: invokevirtual 349	org/json/JSONObject:getJSONObject	(Ljava/lang/String;)Lorg/json/JSONObject;
    //   156: astore 4
    //   158: aload 4
    //   160: ifnonnull +364 -> 524
    //   163: new 70	org/json/JSONObject
    //   166: dup
    //   167: invokespecial 126	org/json/JSONObject:<init>	()V
    //   170: astore 4
    //   172: getstatic 125	com/revmob/android/e:q	Lorg/json/JSONArray;
    //   175: iconst_0
    //   176: invokevirtual 150	org/json/JSONArray:getJSONObject	(I)Lorg/json/JSONObject;
    //   179: aload_1
    //   180: aload 4
    //   182: invokevirtual 352	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   185: pop
    //   186: aload 4
    //   188: astore_1
    //   189: aload_1
    //   190: aload_0
    //   191: invokevirtual 355	org/json/JSONObject:get	(Ljava/lang/String;)Ljava/lang/Object;
    //   194: astore 4
    //   196: aload 4
    //   198: ifnonnull +203 -> 401
    //   201: getstatic 104	com/revmob/android/e:o	I
    //   204: ifeq +183 -> 387
    //   207: aload_1
    //   208: aload_0
    //   209: new 81	org/json/JSONArray
    //   212: dup
    //   213: new 177	java/lang/StringBuilder
    //   216: dup
    //   217: ldc_w 357
    //   220: invokespecial 180	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   223: getstatic 43	com/revmob/android/e:p	I
    //   226: invokevirtual 240	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   229: ldc_w 359
    //   232: invokevirtual 186	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   235: invokevirtual 195	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   238: invokespecial 123	org/json/JSONArray:<init>	(Ljava/lang/String;)V
    //   241: invokevirtual 352	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   244: pop
    //   245: getstatic 47	com/revmob/android/e:a	Landroid/content/Context;
    //   248: invokestatic 110	android/preference/PreferenceManager:getDefaultSharedPreferences	(Landroid/content/Context;)Landroid/content/SharedPreferences;
    //   251: invokeinterface 363 1 0
    //   256: astore_0
    //   257: getstatic 143	com/revmob/android/e:r	Lorg/json/JSONArray;
    //   260: ifnull +18 -> 278
    //   263: aload_0
    //   264: ldc -115
    //   266: getstatic 143	com/revmob/android/e:r	Lorg/json/JSONArray;
    //   269: invokevirtual 364	org/json/JSONArray:toString	()Ljava/lang/String;
    //   272: invokeinterface 370 3 0
    //   277: pop
    //   278: getstatic 125	com/revmob/android/e:q	Lorg/json/JSONArray;
    //   281: ifnull +18 -> 299
    //   284: aload_0
    //   285: ldc 112
    //   287: getstatic 125	com/revmob/android/e:q	Lorg/json/JSONArray;
    //   290: invokevirtual 364	org/json/JSONArray:toString	()Ljava/lang/String;
    //   293: invokeinterface 370 3 0
    //   298: pop
    //   299: aload_0
    //   300: invokeinterface 374 1 0
    //   305: pop
    //   306: return
    //   307: astore 5
    //   309: aconst_null
    ...
    //   323: astore 5
    //   325: aload 5
    //   327: invokevirtual 97	org/json/JSONException:printStackTrace	()V
    //   330: iload_2
    //   331: iconst_1
    //   332: iadd
    //   333: istore_2
    ...
    //   340: aload 5
    //   342: aload_0
    //   343: invokevirtual 378	org/json/JSONObject:getInt	(Ljava/lang/String;)I
    //   346: iconst_1
    //   347: iadd
    //   348: invokevirtual 135	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   351: pop
    //   352: goto -236 -> 116
    //   355: astore 4
    //   357: goto -241 -> 116
    ...
    //   368: astore_1
    //   369: aload_1
    //   370: invokevirtual 97	org/json/JSONException:printStackTrace	()V
    //   373: aload 4
    //   375: astore_1
    //   376: goto -187 -> 189
    //   379: astore 4
    ...
    //   388: aload_0
    //   389: iconst_1
    //   390: invokevirtual 135	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   393: pop
    //   394: goto -149 -> 245
    //   397: astore_0
    //   398: goto -153 -> 245
    ...
    //   406: ifeq +56 -> 462
    //   409: aload 4
    //   411: checkcast 81	org/json/JSONArray
    //   414: getstatic 43	com/revmob/android/e:p	I
    //   417: invokevirtual 381	org/json/JSONArray:put	(I)Lorg/json/JSONArray;
    //   420: pop
    //   421: aload 4
    //   423: checkcast 81	org/json/JSONArray
    //   426: invokevirtual 86	org/json/JSONArray:length	()I
    //   429: getstatic 104	com/revmob/android/e:o	I
    //   432: if_icmple -187 -> 245
    //   435: aload_1
    //   436: aload_0
    //   437: invokevirtual 384	org/json/JSONObject:remove	(Ljava/lang/String;)Ljava/lang/Object;
    //   440: pop
    //   441: aload_1
    //   442: aload_0
    //   443: aload 4
    //   445: checkcast 81	org/json/JSONArray
    //   448: invokevirtual 86	org/json/JSONArray:length	()I
    //   451: invokevirtual 135	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   454: pop
    //   455: goto -210 -> 245
    //   458: astore_0
    //   459: goto -214 -> 245
    ...
    //   463: aload_0
    //   464: aload 4
    //   466: checkcast 386	java/lang/Integer
    //   469: invokevirtual 389	java/lang/Integer:intValue	()I
    //   472: iconst_1
    //   473: iadd
    //   474: invokevirtual 135	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   477: pop
    //   478: goto -233 -> 245
    //   481: astore_0
    //   482: goto -237 -> 245
    ...
    //   488: dup
    //   489: ldc_w 391
    //   492: invokespecial 180	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   495: aload_1
    //   496: invokevirtual 186	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   499: aload_0
    //   500: invokevirtual 186	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   503: invokevirtual 195	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   506: invokestatic 393	com/revmob/internal/RMLog:d	(Ljava/lang/String;)V
    //   509: return
    //   510: astore 4
    //   512: goto -396 -> 116
    //   515: astore_0
  ...
  public static void a(String paramString, boolean paramBoolean, double paramDouble1, double paramDouble2)
  {
    int i1 = 0;
    for (;;)
    {
      ...
      for (;;)
      {
        try
        {
          localObject2 = f.getJSONObject(i1);
        ...
        try
        {
          if (localObject1.getString("id").equals(paramString))
          {
            a(f, i1);
            if (!paramBoolean) {
              continue;
            }
            localObject2 = "fetchClick";
            localObject1.put((String)localObject2, paramDouble1);
            localObject1.put("redirects", paramDouble2);
            f.put(i1, localObject1);
          }
        }
        catch (JSONException localJSONException1)
        {
  ...
  private static JSONObject e()
  {
    ...
    for (;;)
    {
      ...
      {
        if (r != null) {
          localJSONObject1.put("campaigns", r);
        }
        if (q != null) {
          localJSONObject1.put("sessions", q);
        }
        localObject = new JSONObject();
        ((JSONObject)localObject).put("date", (int)(m / 1000.0D));
        ((JSONObject)localObject).put("duration", (System.currentTimeMillis() - m) / 1000.0D);
        ((JSONObject)localObject).put("ads", f);
