  ...
  extends AsyncTask<Object, Object, List<AppInfo>>
{
  ...
  {
    paramList = new ArrayAdapter(this.activity, R.layout.zxing_app_picker_list_item, R.id.zxing_app_picker_list_item_label, paramList)
    {
      public View getView(int paramAnonymousInt, View paramAnonymousView, ViewGroup paramAnonymousViewGroup)
      {
        ...
        if (paramAnonymousViewGroup != null) {
          ((ImageView)paramAnonymousView.findViewById(R.id.zxing_app_picker_list_item_icon)).setImageDrawable(paramAnonymousViewGroup);
        }
