...
public final class ajd
{
  ...
  private ajd(Context paramContext)
  {
  ...
  private CellLocation A()
  {
    ...
    try
    {
      CellLocation localCellLocation = b((List)aja.a(this.g, "getAllCellInfo", new Object[0]));
  ...
  protected static ajd a(Context paramContext)
  {
  ...
  private static void a(WifiManager paramWifiManager)
  {
    ...
    try
    {
      aja.a(paramWifiManager, "startScanActive", new Object[0]);
      return;
    }
    catch (Exception localException)
    {
  ...
  private boolean a(CellLocation paramCellLocation)
  {
    ...
    for (;;)
    {
      ...
      if (paramCellLocation.getCid() >= 268435455)
      {
        ...
        try
        {
          if ((aja.b(paramCellLocation, "getSystemId", new Object[0]) <= 0) || (aja.b(paramCellLocation, "getNetworkId", new Object[0]) < 0)) {
            break;
          }
          int i1 = aja.b(paramCellLocation, "getBaseStationId", new Object[0]);
          if (i1 < 0) {
            return false;
          }
        }
  ...
  private static CellLocation b(List paramList)
  {
      ...
      if (localObject5 != null)
      {
        for (;;)
        {
          ...
          try
          {
            ...
            localObject5 = aja.a(localObject4, "getCellIdentity", new Object[0]);
            if (localObject5 != null) {
              continue;
            }
          }
    ...
    for (;;)
    {
      ...
      try
      {
        i3 = aja.b(localObject5, "getSystemId", new Object[0]);
        i4 = aja.b(localObject5, "getNetworkId", new Object[0]);
        int i5 = aja.b(localObject5, "getBasestationId", new Object[0]);
        int i6 = aja.b(localObject5, "getLongitude", new Object[0]);
        ((CdmaCellLocation)localObject4).setCellLocationData(i5, aja.b(localObject5, "getLatitude", new Object[0]), i6, i3, i4);
      ...
      if (i1 == 3)
      {
        i3 = aja.b(localObject5, "getTac", new Object[0]);
        i4 = aja.b(localObject5, "getCi", new Object[0]);
      ...
      i3 = aja.b(localObject5, "getLac", new Object[0]);
      i4 = aja.b(localObject5, "getCid", new Object[0]);
      localObject4 = new GsmCellLocation();
      localObject1 = localObject4;
      ((GsmCellLocation)localObject4).setLacAndCid(i3, i4);
      paramList = localObject2;
  ...
  protected final void b()
  {
    synchronized (this.d)
    {
      ...
      if (this.A != null)
      {
        localObject2 = this.A;
        if (this.g != null) {
          this.g.listen((PhoneStateListener)localObject2, 0);
        }
        this.A = null;
      }
      if (this.B != null)
      ...
      this.h.removeNmeaListener((GpsStatus.NmeaListener)localObject2);
    }
  }
