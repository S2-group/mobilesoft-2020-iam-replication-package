...
public class na
{
  public static int a()
  {
    try
    {
      int i = kd.a.getPackageManager().getPackageInfo(kd.a.getPackageName(), 0).versionCode;
      return i;
    }
    catch (Exception localException)
    {
      mb.a("Get Version Code Error!!!", localException);
    }
    return -1;
  }
  ...
  {
    paramString = jk.a().f(paramString);
  ...
  public static boolean b()
  {
    ...
    if (kd.a.checkCallingOrSelfPermission("android.permission.ACCESS_NETWORK_STATE") == 0)
    {
      localNetworkInfo = ((ConnectivityManager)kd.a.getSystemService("connectivity")).getActiveNetworkInfo();
  ...
  public static boolean b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramString = kd.a.getPackageManager().getPackageInfo(paramString, 0);
        if (paramString == null) {
          continue;
        }
        return true;
  ...
  public static int c(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        mb.a("Get Meta_Data Info error:", paramString);
      }
    }
    return -1;
  }
  ...
  public static String c()
  {
    ...
    switch (((TelephonyManager)kd.a.getSystemService("phone")).getNetworkType())
    {
    case 13: 
    default: 
      return "4g";
  ...
  {
    return (kd.a.getResources().getConfiguration().screenLayout & 0xF) >= 3;
  }
  
  private static int e()
  {
    Object localObject = (ConnectivityManager)kd.a.getSystemService("connectivity");
    if (localObject == null) {
      return -1;
    }
