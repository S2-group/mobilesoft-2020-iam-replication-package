...
public class TJAdUnitJSBridge
{
  ...
  public void initMoatVideoTracker(JSONObject paramJSONObject, String paramString)
  {
    ...
    try
    {
      ...
      this.k = ((d)c.q((TJAdUnitActivity)this.c).a(new e(paramJSONObject)));
      if (this.l == null)
      {
        TapjoyLog.d("TJAdUnitJSBridge", "Initializing MOAT tracking events map");
        this.l = new HashMap();
        this.l.put("firstQuartile", b.bvk);
        this.l.put("midpoint", b.bvl);
        this.l.put("thirdQuartile", b.bvm);
        this.l.put("complete", b.bvn);
        this.l.put("paused", b.bvo);
        this.l.put("playing", b.bvp);
        this.l.put("start", b.bvq);
        this.l.put("stopped", b.bvr);
        this.l.put("skipped", b.bvs);
        this.l.put("volumeChanged", b.bvt);
        this.l.put("enterFullScreen", b.bvu);
        this.l.put("exitFullScreen", b.bvv);
      }
