...
public class a
{
  ...
  public static void e()
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: invokestatic 207	com/mobvista/msdk/base/b/a:d	()Lcom/mobvista/msdk/base/b/a;
    //   6: invokevirtual 209	com/mobvista/msdk/base/b/a:k	()Ljava/lang/String;
    //   9: invokestatic 145	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   12: ifne +105 -> 117
    //   15: invokestatic 214	com/mobvista/msdk/b/b:a	()Lcom/mobvista/msdk/b/b;
    //   18: pop
    //   19: invokestatic 207	com/mobvista/msdk/base/b/a:d	()Lcom/mobvista/msdk/base/b/a;
    //   22: invokevirtual 209	com/mobvista/msdk/base/b/a:k	()Ljava/lang/String;
    //   25: invokestatic 217	com/mobvista/msdk/b/b:b	(Ljava/lang/String;)Lcom/mobvista/msdk/b/a;
    //   28: astore_1
    //   29: aload_1
    //   30: ifnull +87 -> 117
    //   33: aload_1
    //   34: invokevirtual 222	com/mobvista/msdk/b/a:ap	()Ljava/lang/String;
    //   37: astore_1
    //   38: aload_1
    //   39: invokestatic 145	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   42: ifne +75 -> 117
    //   45: aload_1
    //   46: invokestatic 226	com/mobvista/msdk/base/utils/a:c	(Ljava/lang/String;)Ljava/lang/String;
    //   49: astore_1
    //   50: aload_1
    ...
    //   106: istore_0
    //   107: goto -24 -> 83
    //   110: invokestatic 207	com/mobvista/msdk/base/b/a:d	()Lcom/mobvista/msdk/base/b/a;
    //   113: aload_2
    //   114: putfield 55	com/mobvista/msdk/base/b/a:i	Ljava/util/List;
    //   117: ldc 2
    //   119: monitorexit
    //   120: return
    //   121: astore_1
  ...
  public final void b(a.b paramB)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 58	com/mobvista/msdk/base/b/a:d	Landroid/content/Context;
    //   6: invokestatic 296	com/mobvista/msdk/base/utils/m:a	(Landroid/content/Context;)Lcom/mobvista/msdk/base/utils/m;
    //   9: aload_0
    //   10: getfield 101	com/mobvista/msdk/base/b/a:f	Ljava/lang/String;
    //   13: invokevirtual 299	com/mobvista/msdk/base/utils/m:a	(Ljava/lang/String;)Ljava/util/concurrent/CopyOnWriteArraySet;
    //   16: astore 4
    //   18: aload 4
    //   20: putstatic 49	com/mobvista/msdk/base/b/a:j	Ljava/util/concurrent/CopyOnWriteArraySet;
    //   23: aload 4
    ...
    //   51: astore 4
    //   53: getstatic 49	com/mobvista/msdk/base/b/a:j	Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    //   85: checkcast 244	com/mobvista/msdk/base/entity/e
    //   88: astore 6
    //   90: getstatic 44	com/mobvista/msdk/base/b/a:b	Ljava/util/List;
    //   93: ifnull -27 -> 66
    //   96: getstatic 44	com/mobvista/msdk/base/b/a:b	Ljava/util/List;
    ...
    //   113: istore_2
    //   114: iload_2
    //   115: getstatic 44	com/mobvista/msdk/base/b/a:b	Ljava/util/List;
    //   118: invokeinterface 117 1 0
    //   123: if_icmpge -57 -> 66
    //   126: getstatic 44	com/mobvista/msdk/base/b/a:b	Ljava/util/List;
    //   129: iload_2
    //   130: invokeinterface 307 2 0
    //   135: checkcast 139	java/lang/String
    //   138: astore 7
    //   140: aload 6
    //   142: invokevirtual 309	com/mobvista/msdk/base/entity/e:b	()Ljava/lang/String;
    //   145: astore 8
    //   147: aload 7
    ...
    //   173: aload 4
    //   175: aload 6
    //   177: invokevirtual 310	java/util/concurrent/CopyOnWriteArraySet:add	(Ljava/lang/Object;)Z
    //   180: pop
    //   181: iload_2
    //   182: iconst_1
    //   183: iadd
    ...
    //   195: getstatic 37	com/mobvista/msdk/base/b/a:a	Ljava/lang/String;
    //   198: ldc_w 312
    //   201: invokestatic 314	com/mobvista/msdk/base/utils/h:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   204: goto -138 -> 66
    //   207: getstatic 49	com/mobvista/msdk/base/b/a:j	Ljava/util/concurrent/CopyOnWriteArraySet;
    //   210: ifnull +9 -> 219
    //   213: getstatic 49	com/mobvista/msdk/base/b/a:j	Ljava/util/concurrent/CopyOnWriteArraySet;
    //   216: invokevirtual 317	java/util/concurrent/CopyOnWriteArraySet:clear	()V
    //   219: aload 4
    //   221: invokevirtual 241	java/util/concurrent/CopyOnWriteArraySet:size	()I
    //   224: ifle +12 -> 236
    //   227: getstatic 49	com/mobvista/msdk/base/b/a:j	Ljava/util/concurrent/CopyOnWriteArraySet;
    //   230: aload 4
    //   232: invokevirtual 321	java/util/concurrent/CopyOnWriteArraySet:addAll	(Ljava/util/Collection;)Z
    //   235: pop
    //   236: aload_0
    //   237: getfield 58	com/mobvista/msdk/base/b/a:d	Landroid/content/Context;
    //   240: invokestatic 296	com/mobvista/msdk/base/utils/m:a	(Landroid/content/Context;)Lcom/mobvista/msdk/base/utils/m;
    //   243: getstatic 49	com/mobvista/msdk/base/b/a:j	Ljava/util/concurrent/CopyOnWriteArraySet;
    //   246: invokevirtual 324	com/mobvista/msdk/base/utils/m:a	(Ljava/util/Set;)V
    //   249: aload_1
    //   250: ifnull -209 -> 41
    //   253: aload_1
    //   254: invokeinterface 303 1 0
    //   259: goto -218 -> 41
    //   262: astore_1
    //   263: aload_0
    //   264: monitorexit
