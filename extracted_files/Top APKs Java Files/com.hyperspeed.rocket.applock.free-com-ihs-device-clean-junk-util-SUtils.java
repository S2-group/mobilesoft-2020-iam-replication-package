...
import com.hyperspeed.rocket.applock.free.bdr;
import com.hyperspeed.rocket.applock.free.bfe;
import com.hyperspeed.rocket.applock.free.bh;
...
public class SUtils
{
  ...
  public static byte[] b(Context paramContext, String paramString)
  {
    ...
    //   20: aload_1
    //   21: aload_0
    //   22: invokevirtual 110	java/io/InputStream:read	([B)I
    //   25: istore_2
    //   26: iload_2
    //   27: iconst_m1
    //   28: if_icmpne -10 -> 18
    ...
    //   34: ifnull +9 -> 43
    //   37: aload_1
    //   38: invokevirtual 113	java/io/InputStream:close	()V
    //   41: aload_0
    //   42: astore_3
    //   43: aload_3
    //   44: areturn
    //   45: astore_1
    //   46: aload_1
    //   47: invokevirtual 86	java/lang/Exception:printStackTrace	()V
    //   50: aload_0
    //   51: areturn
    //   52: astore 4
    //   54: aconst_null
    ...
    //   59: astore_3
    //   60: aload 4
    //   62: invokevirtual 86	java/lang/Exception:printStackTrace	()V
    //   65: aload_0
    //   66: astore_3
    //   67: aload_1
    //   68: ifnull -25 -> 43
    //   71: aload_1
    //   72: invokevirtual 113	java/io/InputStream:close	()V
    //   75: aload_0
    //   76: areturn
    //   77: astore_1
    //   78: aload_1
    //   79: invokevirtual 86	java/lang/Exception:printStackTrace	()V
    //   82: aload_0
    //   83: areturn
    //   84: astore_0
    //   85: aconst_null
  ...
  public static HashSet<String> c()
  {
    ...
    try
    {
      localObject2 = bdr.as().getPackageManager().getInstalledPackages(128);
  ...
  {
    return bh.as(paramContext, "android.permission.WRITE_EXTERNAL_STORAGE") == 0;
  }
}
