...
public class ab
{
  ...
  private ab(c paramC)
  {
    ...
    if ((k.a) && ((this.a == null) || ((this.a instanceof com.appodeal.ads.utils.ae))) && ((this.d.equals("init")) || (this.d.equals("stats")) || (this.d.equals("show")) || (this.d.equals("click")) || (this.d.equals("finish")) || (this.d.equals("install")))) {
      return;
    }
      ...
      try
      {
        ...
        if ((r == null) || (r.length() == 0))
        {
          ...
          if (Build.MANUFACTURER.equals("Amazon"))
          {
            ...
            r.put("rooted", bf.a());
            r.put("webview_version", bf.t(this.b));
            r.put("multidex", bf.b(new String[] { "android.support.multidex.MultiDex" }));
          }
        }
        else
        {
  ...
  private SSLSocketFactory d()
  {
    try
    {
      if (E == null)
      {
        ...
        E = localSSLContext.getSocketFactory();
      }
  ...
  URL b()
  {
    if (this.A)
    {
      ...
      return new URL(i.a("get"));
    }
    return new URL(i.a(this.d));
  }
  ...
  JSONObject b(SharedPreferences paramSharedPreferences)
  {
    ...
    if ((!k.l) && (k.k) && (this.z) && (((Calendar)localObject2).getTimeInMillis() < System.currentTimeMillis()))
    {
      k.l = true;
      try
      {
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      ...
      //   151: getfield 96	com/appodeal/ads/ab:A	Z
      //   154: ifeq +48 -> 202
      //   157: aload 4
      //   159: astore_3
      //   160: aload 10
      ...
      //   631: getfield 96	com/appodeal/ads/ab:A	Z
      //   634: ifeq +71 -> 705
      //   637: aload 10
      //   639: aload_0
      ...
      //   724: getfield 96	com/appodeal/ads/ab:A	Z
      //   727: ifeq +22 -> 749
      //   730: aload_0
      ...
      //   762: getfield 96	com/appodeal/ads/ab:A	Z
      //   765: ifeq +13 -> 778
      //   768: aload_2
      ...
      //   786: getfield 96	com/appodeal/ads/ab:A	Z
      //   789: ifeq +116 -> 905
      //   792: aload_0
      ...
      //   883: getstatic 288	com/appodeal/ads/Appodeal:i	Lcom/appodeal/ads/utils/u;
      //   886: ifnull +19 -> 905
      //   889: getstatic 288	com/appodeal/ads/Appodeal:i	Lcom/appodeal/ads/utils/u;
