...
public final class m
{
  ...
  private CellLocation B()
  {
    ...
    try
    {
      CellLocation localCellLocation = b((List)j.a(this.b, "getAllCellInfo", new Object[0]));
  ...
  protected static m a(Context paramContext)
  {
  ...
  private boolean a(CellLocation paramCellLocation)
  {
    ...
    for (;;)
    {
      ...
      if (paramCellLocation.getCid() >= 268435455)
      {
        ...
        try
        {
          if ((j.b(paramCellLocation, "getSystemId", new Object[0]) <= 0) || (j.b(paramCellLocation, "getNetworkId", new Object[0]) < 0)) {
            break;
          }
          int i1 = j.b(paramCellLocation, "getBaseStationId", new Object[0]);
          if (i1 < 0) {
            return false;
          }
        }
  ...
  private static CellLocation b(List paramList)
  {
      ...
      if (localObject5 != null)
      {
        for (;;)
        {
          ...
          try
          {
            ...
            localObject5 = j.a(localObject4, "getCellIdentity", new Object[0]);
            if (localObject5 != null) {
              continue;
            }
          }
    ...
    for (;;)
    {
      ...
      try
      {
        i3 = j.b(localObject5, "getSystemId", new Object[0]);
        i4 = j.b(localObject5, "getNetworkId", new Object[0]);
        int i5 = j.b(localObject5, "getBasestationId", new Object[0]);
        int i6 = j.b(localObject5, "getLongitude", new Object[0]);
        ((CdmaCellLocation)localObject4).setCellLocationData(i5, j.b(localObject5, "getLatitude", new Object[0]), i6, i3, i4);
      ...
      if (i1 == 3)
      {
        i3 = j.b(localObject5, "getTac", new Object[0]);
        i4 = j.b(localObject5, "getCi", new Object[0]);
      ...
      i3 = j.b(localObject5, "getLac", new Object[0]);
      i4 = j.b(localObject5, "getCid", new Object[0]);
      localObject4 = new GsmCellLocation();
      localObject1 = localObject4;
      ((GsmCellLocation)localObject4).setLacAndCid(i3, i4);
      paramList = localObject2;
  ...
  private static boolean c(Context paramContext)
  {
    ...
    try
    {
      ...
      int i1 = 0;
      while (i1 < af.b.length)
      {
        if (!af.a(paramContext, af.b[i1])) {
          return false;
        }
        i1 += 1;
      }
