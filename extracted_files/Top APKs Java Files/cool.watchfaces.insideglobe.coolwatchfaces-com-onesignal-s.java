...
public class s
{
  ...
  private static void A()
  {
    ...
    new Thread(new Runnable()
    {
      public void run()
      {
        ...
        localC.a("app_id", s.a);
        localC.a("identifier", s.k());
        Object localObject2 = s.l().a(s.c);
        ...
        try
        {
          ...
          localC.a("net_type", s.o().b());
          localC.a("carrier", s.o().c());
          localC.a("rooted", Boolean.valueOf(aa.a()));
          localC.a("lat", s.p());
          localC.a("long", s.q());
          localC.a("loc_acc", s.r());
          localC.a("loc_type", s.s());
          v.a(localC);
          return;
        }
  ...
  {
    a(d.e, "Deprecated! onPaused is now tracked automatically, please remove calls to OneSignal.onPaused() and OneSignal.onResume().");
  }
  ...
  {
    // Byte code:
    //   0: getstatic 278	com/onesignal/s:g	Lcom/onesignal/s$a;
    //   3: ifnonnull +14 -> 17
    //   6: new 24	com/onesignal/s$a
    //   9: dup
    //   10: aconst_null
    //   11: invokespecial 281	com/onesignal/s$a:<init>	(Lcom/onesignal/s$1;)V
    //   14: putstatic 278	com/onesignal/s:g	Lcom/onesignal/s$a;
    //   17: new 283	com/onesignal/r
    //   20: dup
    //   21: invokespecial 284	com/onesignal/r:<init>	()V
    //   24: putstatic 286	com/onesignal/s:v	Lcom/onesignal/r;
    //   27: getstatic 286	com/onesignal/s:v	Lcom/onesignal/r;
    //   30: invokevirtual 289	com/onesignal/r:a	()I
    //   33: putstatic 291	com/onesignal/s:u	I
    //   36: aload_2
    //   37: invokestatic 297	java/util/UUID:fromString	(Ljava/lang/String;)Ljava/util/UUID;
    //   40: pop
    //   41: ldc_w 299
    //   44: aload_2
    //   45: invokevirtual 305	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   48: ifne +13 -> 61
    //   51: ldc_w 307
    //   54: aload_2
    //   55: invokevirtual 305	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   58: ifeq +12 -> 70
    //   61: getstatic 91	com/onesignal/s$d:d	Lcom/onesignal/s$d;
    //   64: ldc_w 309
    //   67: invokestatic 148	com/onesignal/s:a	(Lcom/onesignal/s$d;Ljava/lang/String;)V
    //   70: getstatic 291	com/onesignal/s:u	I
    //   73: iconst_1
    //   74: if_icmpne +69 -> 143
    //   77: aload_1
    //   78: invokestatic 315	java/lang/Double:parseDouble	(Ljava/lang/String;)D
    //   81: pop2
    //   82: aload_1
    //   83: invokevirtual 318	java/lang/String:length	()I
    //   86: bipush 8
    //   88: if_icmplt +12 -> 100
    //   91: aload_1
    //   92: invokevirtual 318	java/lang/String:length	()I
    //   95: bipush 16
    //   97: if_icmple +32 -> 129
    //   100: new 320	java/lang/IllegalArgumentException
    //   103: dup
    //   104: ldc_w 322
    //   107: invokespecial 323	java/lang/IllegalArgumentException:<init>	(Ljava/lang/String;)V
    //   110: athrow
    //   111: astore 5
    //   113: getstatic 325	com/onesignal/s$d:b	Lcom/onesignal/s$d;
    //   116: ldc_w 327
    //   119: aload 5
    //   121: invokestatic 226	com/onesignal/s:a	(Lcom/onesignal/s$d;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   124: bipush -6
    //   126: putstatic 97	com/onesignal/s:d	I
    //   129: ldc_w 329
    //   132: invokestatic 335	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   135: pop
    //   136: ldc_w 337
    //   139: invokestatic 335	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   142: pop
    //   143: aload_1
    //   144: putstatic 339	com/onesignal/s:b	Ljava/lang/String;
    //   147: ldc_w 341
    //   150: invokestatic 335	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   153: pop
    //   154: ldc_w 343
    //   157: invokestatic 335	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   160: pop
    //   161: ldc_w 345
    //   164: invokestatic 335	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   167: pop
    //   168: getstatic 347	com/onesignal/s:e	Z
    //   171: ifeq +124 -> 295
    //   174: aload_0
    //   175: ifnull +10 -> 185
    //   178: aload_0
    //   179: invokevirtual 353	android/content/Context:getApplicationContext	()Landroid/content/Context;
    //   182: putstatic 355	com/onesignal/s:c	Landroid/content/Context;
    //   185: aload_3
    //   186: ifnull +7 -> 193
    //   189: aload_3
    //   190: putstatic 357	com/onesignal/s:m	Lcom/onesignal/s$e;
    //   193: getstatic 357	com/onesignal/s:m	Lcom/onesignal/s$e;
    //   196: ifnull +6 -> 202
    //   199: invokestatic 359	com/onesignal/s:x	()V
    //   202: return
    //   203: astore_0
    //   204: getstatic 325	com/onesignal/s$d:b	Lcom/onesignal/s$d;
    //   207: ldc_w 361
    //   210: aload_0
    //   211: invokestatic 226	com/onesignal/s:a	(Lcom/onesignal/s$d;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   214: return
    //   215: astore 5
    //   217: getstatic 325	com/onesignal/s$d:b	Lcom/onesignal/s$d;
    //   220: ldc_w 363
    //   223: aload 5
    //   225: invokestatic 226	com/onesignal/s:a	(Lcom/onesignal/s$d;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   228: bipush -4
    //   230: putstatic 97	com/onesignal/s:d	I
    //   233: goto -97 -> 136
    //   236: astore 5
    //   238: getstatic 325	com/onesignal/s$d:b	Lcom/onesignal/s$d;
    //   241: ldc_w 365
    //   244: aload 5
    //   246: invokestatic 226	com/onesignal/s:a	(Lcom/onesignal/s$d;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   249: bipush -4
    //   251: putstatic 97	com/onesignal/s:d	I
    //   254: goto -111 -> 143
    //   257: astore_1
    //   258: getstatic 325	com/onesignal/s$d:b	Lcom/onesignal/s$d;
    //   261: ldc_w 367
    //   264: aload_1
    //   265: invokestatic 226	com/onesignal/s:a	(Lcom/onesignal/s$d;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   268: bipush -5
    //   270: putstatic 97	com/onesignal/s:d	I
    //   273: goto -105 -> 168
    //   276: astore_1
    //   277: getstatic 325	com/onesignal/s$d:b	Lcom/onesignal/s$d;
    //   280: ldc_w 369
    //   283: aload_1
    //   284: invokestatic 226	com/onesignal/s:a	(Lcom/onesignal/s$d;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   287: bipush -3
    ...
    //   299: istore 4
    //   301: iload 4
    //   303: putstatic 373	com/onesignal/s:n	Z
    //   306: aload_2
    //   307: putstatic 241	com/onesignal/s:a	Ljava/lang/String;
    //   310: aload_0
    //   311: invokevirtual 353	android/content/Context:getApplicationContext	()Landroid/content/Context;
    //   314: putstatic 355	com/onesignal/s:c	Landroid/content/Context;
    //   317: iload 4
    //   319: ifeq +183 -> 502
    //   322: aload_0
    //   323: checkcast 371	android/app/Activity
    //   326: putstatic 378	com/onesignal/a:b	Landroid/app/Activity;
    //   329: getstatic 355	com/onesignal/s:c	Landroid/content/Context;
    //   332: invokestatic 383	com/onesignal/q:a	(Landroid/content/Context;)V
    //   335: aload_3
    //   336: putstatic 357	com/onesignal/s:m	Lcom/onesignal/s$e;
    //   339: invokestatic 389	android/os/SystemClock:elapsedRealtime	()J
    //   342: putstatic 99	com/onesignal/s:p	J
    //   345: getstatic 355	com/onesignal/s:c	Landroid/content/Context;
    //   348: invokestatic 390	com/onesignal/v:a	(Landroid/content/Context;)V
    //   351: getstatic 355	com/onesignal/s:c	Landroid/content/Context;
    //   354: new 392	android/content/Intent
    //   357: dup
    //   358: getstatic 355	com/onesignal/s:c	Landroid/content/Context;
    //   361: ldc_w 394
    //   364: invokespecial 397	android/content/Intent:<init>	(Landroid/content/Context;Ljava/lang/Class;)V
    //   367: invokevirtual 401	android/content/Context:startService	(Landroid/content/Intent;)Landroid/content/ComponentName;
    //   370: pop
    //   371: getstatic 406	android/os/Build$VERSION:SDK_INT	I
    //   374: bipush 13
    //   376: if_icmple +133 -> 509
    //   379: getstatic 355	com/onesignal/s:c	Landroid/content/Context;
    //   382: checkcast 408	android/app/Application
    //   385: new 410	com/onesignal/b
    //   388: dup
    //   389: invokespecial 411	com/onesignal/b:<init>	()V
    //   392: invokevirtual 415	android/app/Application:registerActivityLifecycleCallbacks	(Landroid/app/Application$ActivityLifecycleCallbacks;)V
    //   395: ldc_w 417
    //   398: invokestatic 335	java/lang/Class:forName	(Ljava/lang/String;)Ljava/lang/Class;
    //   401: pop
    //   402: new 419	com/onesignal/ab
    //   405: dup
    //   406: getstatic 355	com/onesignal/s:c	Landroid/content/Context;
    //   409: invokespecial 421	com/onesignal/ab:<init>	(Landroid/content/Context;)V
    //   412: putstatic 423	com/onesignal/s:s	Lcom/onesignal/ab;
    //   415: invokestatic 425	com/onesignal/s:f	()Ljava/lang/String;
    //   418: astore_0
    //   419: aload_0
    //   420: ifnull +95 -> 515
    //   423: aload_0
    //   424: getstatic 241	com/onesignal/s:a	Ljava/lang/String;
    //   427: invokevirtual 305	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   430: ifne +21 -> 451
    //   433: getstatic 123	com/onesignal/s$d:f	Lcom/onesignal/s$d;
    //   436: ldc_w 427
    //   439: invokestatic 148	com/onesignal/s:a	(Lcom/onesignal/s$d;Ljava/lang/String;)V
    //   442: getstatic 241	com/onesignal/s:a	Ljava/lang/String;
    //   445: invokestatic 429	com/onesignal/s:d	(Ljava/lang/String;)V
    //   448: invokestatic 431	com/onesignal/v:e	()V
    //   451: getstatic 373	com/onesignal/s:n	Z
    //   454: ifne +9 -> 463
    //   457: invokestatic 172	com/onesignal/s:g	()Ljava/lang/String;
    //   460: ifnonnull +6 -> 466
    //   463: invokestatic 433	com/onesignal/s:w	()V
    //   466: getstatic 357	com/onesignal/s:m	Lcom/onesignal/s$e;
    //   469: ifnull +6 -> 475
    //   472: invokestatic 359	com/onesignal/s:x	()V
    //   475: getstatic 355	com/onesignal/s:c	Landroid/content/Context;
    //   478: invokestatic 438	com/onesignal/ac:a	(Landroid/content/Context;)Z
    //   481: ifeq +16 -> 497
    //   484: new 435	com/onesignal/ac
    //   487: dup
    //   488: getstatic 355	com/onesignal/s:c	Landroid/content/Context;
    //   491: invokespecial 439	com/onesignal/ac:<init>	(Landroid/content/Context;)V
    //   494: putstatic 441	com/onesignal/s:r	Lcom/onesignal/ac;
    //   497: iconst_1
    //   498: putstatic 347	com/onesignal/s:e	Z
    //   501: return
    //   502: iconst_1
    //   503: putstatic 443	com/onesignal/a:a	Z
    //   506: goto -171 -> 335
    //   509: invokestatic 447	com/onesignal/c:a	()V
    //   512: goto -117 -> 395
    //   515: iconst_0
    //   516: getstatic 355	com/onesignal/s:c	Landroid/content/Context;
    //   519: invokestatic 452	com/onesignal/i:a	(ILandroid/content/Context;)V
    //   522: getstatic 241	com/onesignal/s:a	Ljava/lang/String;
    //   525: invokestatic 429	com/onesignal/s:d	(Ljava/lang/String;)V
    //   528: goto -77 -> 451
    //   531: astore_0
    //   532: goto -117 -> 415
  ...
  private static void a(String paramString, final JSONObject paramJSONObject, final boolean paramBoolean)
  {
    ...
    a(new Runnable()
    {
      public void run()
      {
        s.v().a(this.a, paramJSONObject, paramBoolean);
      }
    });
  }
  ...
  static void a(JSONArray paramJSONArray, boolean paramBoolean, u.a paramA)
  {
    ...
    try
    {
      ...
      u.b("players/" + g() + "/on_purchase", localJSONObject, paramA);
      return;
    }
  ...
  {
    a(d.e, "Deprecated! onResumed is now tracked automatically, please remove calls to OneSignal.onPaused() and OneSignal.onResume().");
  }
