...
public class P7
{
    ...
    extends AsyncTask
  {
    ...
    private InstalledAppsResult a(Long... paramVarArgs)
    {
      ...
      localInstalledAppsResult.DeviceInfo = DeviceController.getDeviceInfo(P7.a(P7.this));
      localInstalledAppsResult.TimestampSnapshot = c.a(paramVarArgs[0].longValue());
      localInstalledAppsResult.HostAppPackageName = P7.a(P7.this).getPackageName();
      ArrayList localArrayList1 = new ArrayList();
      PackageManager localPackageManager = P7.a(P7.this).getPackageManager();
      int i;
      label199:
      Object localObject1;
      ...
      try
      {
        ...
        if (P7.a(P7.this).checkCallingOrSelfPermission("android.permission.GET_PACKAGE_SIZE") == 0)
        {
          i = 1;
          HashMap localHashMap = new HashMap();
          if ((Build.VERSION.SDK_INT < 23) || (((AppOpsManager)P7.a(P7.this).getSystemService("appops")).checkOpNoThrow("android:get_usage_stats", Process.myUid(), P7.a(P7.this).getPackageName()) != 0)) {
            break label890;
          }
          localHashMap = a();
      ...
      catch (NoSuchMethodException paramVarArgs)
      {
        ...
        for (;;)
        {
          Log.e(P7.b(), "IA: " + paramVarArgs.getMessage());
          paramVarArgs = null;
          continue;
          i = 0;
          continue;
    ...
    private HashMap a()
    {
      ...
      Object localObject1 = (NetworkStatsManager)P7.a(P7.this).getSystemService(NetworkStatsManager.class);
      Object localObject2;
      label238:
      do
      {
        for (;;)
        {
          ...
          {
            Log.d(P7.b(), "getUidBytesForAndroidM: " + localException.getMessage());
            return localHashMap;
          }
        ...
        localObject1 = ((NetworkStatsManager)localObject1).querySummary(0, ((TelephonyManager)P7.a(P7.this).getSystemService("phone")).getSubscriberId(), l, System.currentTimeMillis());
