...
public final class l
{
  ...
  private static a a(Context paramContext, String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 252	android/content/Context:getPackageManager	()Landroid/content/pm/PackageManager;
    //   4: aload_1
    //   5: sipush 192
    //   8: invokevirtual 258	android/content/pm/PackageManager:getPackageInfo	(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    //   11: astore_2
    //   12: aload_2
    //   13: invokestatic 261	com/alipay/sdk/util/l:a	(Landroid/content/pm/PackageInfo;)Z
    //   16: ifne +23 -> 39
    //   19: aload_0
    //   20: aload_1
    //   21: invokestatic 264	com/alipay/sdk/util/l:c	(Landroid/content/Context;Ljava/lang/String;)Landroid/content/pm/PackageInfo;
    //   24: astore_0
    //   25: goto +63 -> 88
    //   28: astore_0
    //   29: ldc_w 266
    //   32: ldc_w 268
    //   35: aload_0
    //   36: invokestatic 273	com/alipay/sdk/app/statistic/a:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   39: aload_2
    //   40: astore_0
    //   41: goto +47 -> 88
    //   44: astore_2
    ...
    //   52: ldc_w 275
    //   55: aload_2
    //   56: invokestatic 273	com/alipay/sdk/app/statistic/a:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   59: aconst_null
    //   60: invokestatic 261	com/alipay/sdk/util/l:a	(Landroid/content/pm/PackageInfo;)Z
    //   63: ifne +23 -> 86
    //   66: aload_0
    //   67: aload_1
    //   68: invokestatic 264	com/alipay/sdk/util/l:c	(Landroid/content/Context;Ljava/lang/String;)Landroid/content/pm/PackageInfo;
    //   71: astore_0
    //   72: goto +16 -> 88
    //   75: astore_0
    //   76: ldc_w 266
    //   79: ldc_w 268
    //   82: aload_0
    //   83: invokestatic 273	com/alipay/sdk/app/statistic/a:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   86: aconst_null
    //   87: astore_0
    //   88: aload_0
    //   89: invokestatic 261	com/alipay/sdk/util/l:a	(Landroid/content/pm/PackageInfo;)Z
    //   92: ifne +5 -> 97
    //   95: aconst_null
    //   96: areturn
    //   97: aload_0
    ...
    //   106: dup
    //   107: invokespecial 276	com/alipay/sdk/util/l$a:<init>	()V
    //   110: astore_1
    //   111: aload_1
    //   112: aload_0
    //   113: getfield 282	android/content/pm/PackageInfo:signatures	[Landroid/content/pm/Signature;
    //   116: putfield 284	com/alipay/sdk/util/l$a:a	[Landroid/content/pm/Signature;
    //   119: aload_1
    //   120: aload_0
    //   121: getfield 287	android/content/pm/PackageInfo:versionCode	I
    //   124: putfield 289	com/alipay/sdk/util/l$a:b	I
    //   127: aload_1
    //   128: areturn
    //   129: aconst_null
    //   130: invokestatic 261	com/alipay/sdk/util/l:a	(Landroid/content/pm/PackageInfo;)Z
    //   133: ifne +23 -> 156
    //   136: aload_0
    //   137: aload_1
    //   138: invokestatic 264	com/alipay/sdk/util/l:c	(Landroid/content/Context;Ljava/lang/String;)Landroid/content/pm/PackageInfo;
    //   141: pop
    //   142: goto +14 -> 156
    //   145: astore_0
    //   146: ldc_w 266
    //   149: ldc_w 268
    //   152: aload_0
    //   153: invokestatic 273	com/alipay/sdk/app/statistic/a:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   156: aload_2
    //   157: athrow
  ...
  private static DisplayMetrics l(Context paramContext)
  {
    DisplayMetrics localDisplayMetrics = new DisplayMetrics();
    ((WindowManager)paramContext.getApplicationContext().getSystemService("window")).getDefaultDisplay().getMetrics(localDisplayMetrics);
