...
import com.ew.sdk.base.plugin.BaseApplication;
...
public class sw
{
  public static int a()
  {
    try
    {
      int i = rm.a.getPackageManager().getPackageInfo(rm.a.getPackageName(), 0).versionCode;
      return i;
    }
    catch (Exception localException)
    {
      sb.a("Get Version Code Error!!!", localException);
    }
    return -1;
  }
  ...
  public static boolean a(Context paramContext, String paramString)
  {
    ...
    {
      sb.b(paramString + " - permission: " + bool);
      return bool;
    }
  }
  ...
  public static boolean b()
  {
    ...
    if (rm.a.checkCallingOrSelfPermission("android.permission.ACCESS_NETWORK_STATE") == 0)
    {
      localNetworkInfo = ((ConnectivityManager)rm.a.getSystemService("connectivity")).getActiveNetworkInfo();
  ...
  {
    paramString = (rw)ru.b.get(paramString);
    return (paramString != null) && (c(paramString.b));
  }
  
  public static String c()
  {
    switch (a(rm.a.getApplicationContext()))
    {
    default: 
      return "";
    case 1: 
  ...
  public static boolean c(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramString = rm.a.getPackageManager().getPackageInfo(paramString, 0);
        if (paramString == null) {
          continue;
        }
        return true;
  ...
  public static int d(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        sb.a("Get Meta_Data Info error:", paramString);
      }
    }
    return -1;
  }
  ...
  {
    return (rm.a.getResources().getConfiguration().screenLayout & 0xF) >= 3;
  }
