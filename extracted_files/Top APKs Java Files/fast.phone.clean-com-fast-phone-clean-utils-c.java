...
import com.fast.phone.clean.entity.AppInfo;
import com.fast.phone.clean.module.appmgr.a.b;
        ...
        if (localObject1 != null)
        {
          ...
          ((Method)localObject1).invoke(paramContext.getPackageManager(), new Object[] { paramAppInfo.b(), new IPackageStatsObserver.Stub()
          {
            ...
            public void onGetStatsCompleted(android.content.pm.PackageStats arg1, boolean paramAnonymousBoolean)
            {
              // Byte code:
              //   0: aload_0
              //   1: getfield 16	com/fast/phone/clean/utils/c$1:a	Lcom/fast/phone/clean/entity/AppInfo;
              //   4: astore 19
              //   6: aload 19
              //   8: monitorenter
              //   9: iload_2
              ...
              //   58: lstore 17
              //   60: aload_0
              //   61: getfield 16	com/fast/phone/clean/utils/c$1:a	Lcom/fast/phone/clean/entity/AppInfo;
              //   64: lload_3
              //   65: lload 5
              //   67: ladd
              //   68: lload 7
              ...
              //   83: lload 17
              //   85: ladd
              //   86: invokevirtual 56	com/fast/phone/clean/entity/AppInfo:a	(J)V
              //   89: aload 19
              //   91: monitorexit
              //   92: aload_0
              //   93: getfield 18	com/fast/phone/clean/utils/c$1:b	Ljava/util/concurrent/CountDownLatch;
              //   96: astore_1
              //   97: aload_1
              //   98: monitorenter
              //   99: aload_0
              //   100: getfield 18	com/fast/phone/clean/utils/c$1:b	Ljava/util/concurrent/CountDownLatch;
