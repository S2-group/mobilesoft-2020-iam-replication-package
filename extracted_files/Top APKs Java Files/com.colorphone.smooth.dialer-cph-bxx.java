...
{
  private static bxx d = new bxx();
  public PackageManager a = cdq.i().getPackageManager();
  private ArrayList<bxj> b = new ArrayList();
  ...
  private List<bxj> c()
  {
    ...
    try
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        a(localPackageInfo);
        bwq.a(localPackageInfo.packageName);
      }
  ...
  public final void a(PackageInfo paramPackageInfo)
  {
    if ((paramPackageInfo.applicationInfo != null) && (!this.c.contains(paramPackageInfo.packageName)))
    {
      ...
      {
        bxj localBxj = new bxj(paramPackageInfo);
        localBxj.d = localActivityInfo.name;
        try
        {
          this.b.add(localBxj);
  ...
  public final void a(String paramString)
  {
    try
    {
      ...
      while (localIterator.hasNext()) {
        if (TextUtils.equals(((bxj)localIterator.next()).c, paramString)) {
  ...
  /* Error */
  public final bxj b(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 31	cph/bxx:b	Ljava/util/ArrayList;
    ...
    //   28: checkcast 156	cph/bxj
    //   31: astore_3
    //   32: aload_1
    //   33: aload_3
    //   34: getfield 171	cph/bxj:c	Ljava/lang/String;
