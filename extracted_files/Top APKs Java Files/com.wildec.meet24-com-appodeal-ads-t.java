...
public class t
{
  ...
  private void a(org.a.c paramC)
  {
    a localA = paramC.optJSONArray("segments");
    if ((localA == null) || (localA.login() == 0)) {}
    for (;;)
    {
      return;
      paramC = new com.appodeal.ads.f.g(this.b, paramC);
      if (!paramC.b(localA)) {
        continue;
      }
  ...
  org.a.c a(SharedPreferences paramSharedPreferences)
  {
    org.a.c localC = b(paramSharedPreferences);
    if (localC == null) {
      return null;
    }
    Object localObject3;
    ...
    {
      if (this.q) {
        localC.put("type", "banner");
      }
      if (this.r)
      {
        localC.put("type", "banner_320");
        float f1 = an.g(this.b);
        float f2 = an.h(this.b);
        if ((g.t) && (f1 >= 728.0F) && (f2 > 720.0F)) {
          localC.put("large_banners", true);
        }
      }
      if (this.s) {
        localC.put("type", "banner_mrec");
      }
      if ((this.t) || (this.u)) {
        localC.put("type", "video");
      }
      if (this.u) {
        localC.put("rewarded_video", true);
      }
      if (this.v) {
        localC.put("type", "native");
      }
      if (this.w) {
        localC.put("debug", true);
      }
      if (AppodealSettings.a) {
        localC.put("test", true);
      }
      Object localObject1 = an.d(this.b);
      localC.put("lt", ((Pair)localObject1).first);
      localC.put("lat", ((Pair)((Pair)localObject1).second).first);
      localC.put("lon", ((Pair)((Pair)localObject1).second).second);
      localObject1 = an.b(this.b);
      localC.put("connection", ((an.a)localObject1).a);
      localC.put("battery", an.k(this.b));
      localC.put("connection_subtype", ((an.a)localObject1).b);
      localC.put("connection_fast", ((an.a)localObject1).c);
      localC.put("crr", an.c(this.b));
      localC.put("locale", Locale.getDefault().toString());
      localObject1 = Calendar.getInstance(TimeZone.getTimeZone("GMT"), Locale.ENGLISH);
      localC.put("timezone", new SimpleDateFormat("Z", Locale.ENGLISH).format(((Calendar)localObject1).getTime()));
      localC.put("local_time", System.currentTimeMillis() / 1000L);
      localC.put("user_agent", System.getProperty("http.agent"));
      d.c(this.b);
      localC.put("session_id", d.a(paramSharedPreferences));
      localC.put("session_uptime", d.b());
      localC.put("app_uptime", d.b(paramSharedPreferences));
      localObject1 = paramSharedPreferences.getString("inapps", null);
      if (localObject1 != null) {
        localC.put("inapps", new org.a.c((String)localObject1));
      }
      if (this.x)
      {
        localObject1 = new a();
        if (this.q)
        {
          ...
          while (((Iterator)localObject3).hasNext())
          {
            ...
            {
              ((a)localObject1).login(((o)localObject4).a());
              continue;
    ...
    for (;;)
    {
      ...
      catch (Exception localException2)
      {
        try
        {
          for (;;)
          {
            localC.put("user_settings", Appodeal.getUserSettings(this.b).a());
            ...
            if (this.h != null)
            {
              ...
              localC.put("id", this.h.a().toString());
            }
            return localC;
            if (this.t)
            {
              ...
              while (((Iterator)localObject3).hasNext())
              {
                ...
                if (((ap)localObject4).g() != null) {
                  localException1.login(((ap)localObject4).a());
                }
              }
            }
            if (this.u)
            ...
            if (this.r)
            {
              ...
              while (((Iterator)localObject3).hasNext())
              {
                ...
                if (((h)localObject4).f() != null) {
                  localException1.login(((h)localObject4).a());
                }
              }
            }
            if (this.s)
            {
              ...
              while (((Iterator)localObject3).hasNext())
              {
                ...
                if (((w)localObject4).f() != null) {
                  localException1.login(((w)localObject4).a());
                }
              }
            }
            if (this.v)
            {
              ...
              while (((Iterator)localObject3).hasNext())
              {
                ...
                if (localObject4 != null) {
                  localException1.login(((ac)localObject4).a());
                }
              }
            }
            localC.put("show_array", localException1);
            if (this.g != null) {
              localC.put("loaded_offer", this.g);
            }
            if ((this.l != null) && (this.l.longValue() != -1L)) {
              localC.put("segment_id", this.l);
            }
            if (this.j != 0L) {
              localC.put("show_timestamp", this.j);
            }
            if (this.d.equals("click")) {
              localC.put("click_timestamp", System.currentTimeMillis() / 1000L);
            }
            if (this.d.equals("finish")) {
              localC.put("finish_timestamp", System.currentTimeMillis() / 1000L);
            }
            if (this.m > 1) {
              localC.put("capacity", this.m);
            }
            if (this.n > 0.0D) {
              localC.put("price_floor", this.n);
            }
            localC.put("id", this.e);
            localC.put("main_id", this.f);
            if ((this.x) || (this.k != null)) {
              localC.put("ad_stats", c());
            }
            if (this.i == null) {
              break;
            }
            localC.put("placement_id", this.i.a());
            break;
        ...
        catch (Exception localException3)
        {
          for (;;)
          {
            ...
            continue;
            label1612:
            localC.put("apps", localException3);
            continue;
            label1626:
            if (this.d.equals("show"))
            {
              if (this.h.f())
              {
                ...
                localC.put("rtb_check", this.h.c());
                localC.put("bidder_id", this.h.e());
              }
            }
            else if (((this.d.equals("click")) || (this.d.equals("finish"))) && (this.h.f())) {
              localC.put("id", this.h.e());
            }
          }
        }
      }
  ...
  /* Error */
  org.a.c b(SharedPreferences paramSharedPreferences)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 746	com/appodeal/ads/t:o	Lorg/a/c;
    //   6: ifnonnull +634 -> 640
    //   9: new 201	org/a/c
    //   12: dup
    //   13: invokespecial 747	org/a/c:<init>	()V
    //   16: putstatic 746	com/appodeal/ads/t:o	Lorg/a/c;
    //   19: aload_0
    //   20: getfield 64	com/appodeal/ads/t:b	Landroid/content/Context;
    ...
    //   85: aload_0
    //   86: getfield 74	com/appodeal/ads/t:d	Ljava/lang/String;
    //   89: ldc -115
    ...
    //   152: astore 4
    //   154: aload_0
    //   155: getfield 64	com/appodeal/ads/t:b	Landroid/content/Context;
    ...
    //   292: aload_0
    //   293: getfield 64	com/appodeal/ads/t:b	Landroid/content/Context;
    //   296: invokestatic 790	com/appodeal/ads/an:l	(Landroid/content/Context;)Ljava/lang/String;
    //   299: astore_1
    //   300: getstatic 746	com/appodeal/ads/t:o	Lorg/a/c;
    //   303: ldc_w 792
    //   306: aload 8
    //   308: invokevirtual 289	org/a/c:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/a/c;
    //   311: pop
    //   312: getstatic 746	com/appodeal/ads/t:o	Lorg/a/c;
    //   315: ldc_w 588
    //   318: getstatic 795	android/os/Build$VERSION:RELEASE	Ljava/lang/String;
    //   321: invokevirtual 289	org/a/c:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/a/c;
    //   324: pop
    //   325: getstatic 746	com/appodeal/ads/t:o	Lorg/a/c;
    //   328: ldc_w 797
    //   331: getstatic 697	android/os/Build$VERSION:SDK_INT	I
    //   334: invokevirtual 652	org/a/c:put	(Ljava/lang/String;I)Lorg/a/c;
    //   337: pop
    //   338: getstatic 746	com/appodeal/ads/t:o	Lorg/a/c;
    //   341: ldc_w 799
    //   344: ldc_w 801
    //   347: invokevirtual 289	org/a/c:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/a/c;
    //   350: pop
    //   351: aload_0
    //   352: getfield 64	com/appodeal/ads/t:b	Landroid/content/Context;
    //   355: invokevirtual 804	android/content/Context:getPackageName	()Ljava/lang/String;
    //   358: astore 4
    //   360: getstatic 746	com/appodeal/ads/t:o	Lorg/a/c;
    //   363: ldc_w 806
    //   366: aload 4
    //   368: invokevirtual 289	org/a/c:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/a/c;
    //   371: pop
    //   372: aload 7
    //   374: aload 4
    //   376: iconst_0
    ...
    //   380: astore 5
    //   382: getstatic 746	com/appodeal/ads/t:o	Lorg/a/c;
    //   385: ldc_w 812
    //   388: aload 5
    //   390: getfield 817	android/content/pm/PackageInfo:versionName	Ljava/lang/String;
    //   393: invokevirtual 289	org/a/c:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/a/c;
    //   396: pop
    //   397: getstatic 746	com/appodeal/ads/t:o	Lorg/a/c;
    //   400: ldc_w 819
    //   403: aload 5
    //   405: getfield 822	android/content/pm/PackageInfo:versionCode	I
    //   408: invokevirtual 652	org/a/c:put	(Ljava/lang/String;I)Lorg/a/c;
    //   411: pop
    //   412: aload 7
    //   414: aload 4
    //   416: sipush 128
    ...
    //   422: astore 5
    //   424: getstatic 746	com/appodeal/ads/t:o	Lorg/a/c;
    //   427: ldc_w 828
    //   430: aload 5
    ...
    //   441: invokevirtual 289	org/a/c:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/a/c;
    //   444: pop
    //   445: getstatic 746	com/appodeal/ads/t:o	Lorg/a/c;
    //   448: ldc_w 840
    //   451: aload_1
    //   452: invokevirtual 289	org/a/c:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/a/c;
    //   455: pop
    //   456: getstatic 746	com/appodeal/ads/t:o	Lorg/a/c;
    //   459: ldc_w 842
    //   462: aload_3
    //   463: invokevirtual 289	org/a/c:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/a/c;
    //   466: pop
    //   467: aload_0
    //   468: getfield 64	com/appodeal/ads/t:b	Landroid/content/Context;
    //   471: invokestatic 844	com/appodeal/ads/an:f	(Landroid/content/Context;)Landroid/util/Pair;
    //   474: astore_1
    //   475: getstatic 746	com/appodeal/ads/t:o	Lorg/a/c;
    //   478: ldc_w 846
    //   481: aload_1
    //   482: getfield 319	android/util/Pair:first	Ljava/lang/Object;
    //   485: invokevirtual 289	org/a/c:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/a/c;
    //   488: pop
    //   489: getstatic 746	com/appodeal/ads/t:o	Lorg/a/c;
    //   492: ldc_w 848
    //   495: aload_1
    //   496: getfield 324	android/util/Pair:second	Ljava/lang/Object;
    //   499: invokevirtual 289	org/a/c:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/a/c;
    //   502: pop
    //   503: aload_0
    //   504: getfield 64	com/appodeal/ads/t:b	Landroid/content/Context;
    //   507: invokestatic 851	com/appodeal/ads/an:n	(Landroid/content/Context;)Z
    //   510: ifeq +224 -> 734
    //   513: getstatic 746	com/appodeal/ads/t:o	Lorg/a/c;
    //   516: ldc_w 853
    //   519: ldc_w 855
    //   522: invokevirtual 289	org/a/c:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/a/c;
    //   525: pop
    ...
    //   538: ldc_w 864
    //   541: astore_1
    //   542: getstatic 746	com/appodeal/ads/t:o	Lorg/a/c;
    //   545: ldc_w 866
    //   548: aload_1
    //   549: invokevirtual 289	org/a/c:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/a/c;
    //   552: pop
    //   553: aload 7
    //   555: aload 4
    ...
    //   567: ldc_w 871
    //   570: astore_1
    //   571: getstatic 746	com/appodeal/ads/t:o	Lorg/a/c;
    //   574: ldc_w 873
    //   577: aload_1
    //   578: invokevirtual 289	org/a/c:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/a/c;
    //   581: pop
    //   582: getstatic 746	com/appodeal/ads/t:o	Lorg/a/c;
    //   585: ldc_w 875
    //   588: getstatic 860	android/os/Build:MANUFACTURER	Ljava/lang/String;
    //   591: invokevirtual 289	org/a/c:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/a/c;
    //   594: pop
    //   595: getstatic 746	com/appodeal/ads/t:o	Lorg/a/c;
    //   598: ldc_w 877
    //   601: ldc_w 879
    //   604: iconst_2
    ...
    //   623: invokevirtual 289	org/a/c:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/a/c;
    //   626: pop
    //   627: getstatic 746	com/appodeal/ads/t:o	Lorg/a/c;
    //   630: ldc_w 884
    //   633: invokestatic 886	com/appodeal/ads/an:a	()Z
    //   636: invokevirtual 306	org/a/c:put	(Ljava/lang/String;Z)Lorg/a/c;
    //   639: pop
    //   640: new 201	org/a/c
    //   643: dup
    //   644: invokespecial 747	org/a/c:<init>	()V
    //   647: astore_1
    //   648: getstatic 746	com/appodeal/ads/t:o	Lorg/a/c;
    //   651: invokevirtual 889	org/a/c:keys	()Ljava/util/Iterator;
    //   654: astore_3
    //   655: aload_3
    ...
    //   675: aload_1
    //   676: aload 4
    //   678: getstatic 746	com/appodeal/ads/t:o	Lorg/a/c;
    //   681: aload 4
    //   683: invokevirtual 892	org/a/c:get	(Ljava/lang/String;)Ljava/lang/Object;
    //   686: invokevirtual 289	org/a/c:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/a/c;
    //   689: pop
    //   690: goto -35 -> 655
    //   693: astore_1
    //   694: ldc 2
    ...
    //   706: astore_1
    //   707: aload_1
    //   708: invokestatic 240	com/appodeal/ads/Appodeal:a	(Ljava/lang/Throwable;)V
    //   711: goto +55 -> 766
    //   714: astore 5
    //   716: aload 5
    //   718: invokestatic 240	com/appodeal/ads/Appodeal:a	(Ljava/lang/Throwable;)V
    //   721: goto -309 -> 412
    //   724: astore 5
    //   726: aload 5
    //   728: invokestatic 240	com/appodeal/ads/Appodeal:a	(Ljava/lang/Throwable;)V
    //   731: goto -286 -> 445
    //   734: getstatic 746	com/appodeal/ads/t:o	Lorg/a/c;
    //   737: ldc_w 853
    //   740: ldc_w 896
    //   743: invokevirtual 289	org/a/c:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/a/c;
    //   746: pop
    //   747: goto -221 -> 526
    //   750: astore_1
    //   751: aload_1
    //   752: invokestatic 240	com/appodeal/ads/Appodeal:a	(Ljava/lang/Throwable;)V
    //   755: goto -173 -> 582
    //   758: ldc 2
    //   760: monitorexit
    //   761: aload_1
  ...
  org.a.c c()
  {
    ...
    try
    {
      localC.put("show", i1 + i2 + i3 + i4 + i5 + i6);
      localC.put("click", i7 + i8 + i9 + i10 + i11 + i12);
      if ((this.t) || (this.u) || ((this.k != null) && ((this.k.equals("video")) || (this.k.equals("rewarded_video"))))) {
        localC.put("finish", i13 + i14);
      }
      if ((this.q) || ((this.k != null) && (this.k.equals("banner"))))
      {
        localC.put(String.format("%s_%s", new Object[] { "banner", "show" }), n.q);
        localC.put(String.format("%s_%s", new Object[] { "banner", "click" }), n.r);
      }
      if ((this.t) || ((this.k != null) && (this.k.equals("video"))))
      {
        localC.put(String.format("%s_%s", new Object[] { "video", "show" }), ah.n);
        localC.put(String.format("%s_%s", new Object[] { "video", "click" }), ah.p);
        localC.put(String.format("%s_%s", new Object[] { "video", "finish" }), ah.o);
      }
      if ((this.u) || ((this.k != null) && (this.k.equals("rewarded_video"))))
      {
        localC.put(String.format("%s_%s", new Object[] { "rewarded_video", "show" }), ak.n);
        localC.put(String.format("%s_%s", new Object[] { "rewarded_video", "click" }), ak.p);
        localC.put(String.format("%s_%s", new Object[] { "rewarded_video", "finish" }), ak.o);
      }
      if ((this.r) || ((this.k != null) && (this.k.equals("banner_320"))))
      {
        localC.put(String.format("%s_%s", new Object[] { "banner_320", "show" }), g.y);
        localC.put(String.format("%s_%s", new Object[] { "banner_320", "click" }), g.z);
      }
      if ((this.s) || ((this.k != null) && (this.k.equals("banner_mrec"))))
      {
        localC.put(String.format("%s_%s", new Object[] { "banner_mrec", "show" }), v.u);
        localC.put(String.format("%s_%s", new Object[] { "banner_mrec", "click" }), v.v);
      }
      if ((this.v) || ((this.k != null) && (this.k.equals("native"))))
      {
        localC.put(String.format("%s_%s", new Object[] { "native", "show" }), Native.p);
        localC.put(String.format("%s_%s", new Object[] { "native", "click" }), Native.q);
      }
      return localC;
    }
  ...
  public static abstract interface a
  {
    ...
    public abstract void a(org.a.c paramC, int paramInt, String paramString);
  }
  
  private class b
    extends AsyncTask<Void, Void, org.a.c>
  {
    private b() {}
    
    /* Error */
    protected org.a.c a(Void... paramVarArgs)
    {
      // Byte code:
      //   0: aload_0
      ...
      //   18: aload_1
      //   19: invokevirtual 42	com/appodeal/ads/t:a	(Landroid/content/SharedPreferences;)Lorg/a/c;
      //   22: astore_1
      //   23: aload_1
      //   24: ifnonnull +5 -> 29
      //   27: aconst_null
      ...
      //   177: aload 6
      //   179: aload_1
      //   180: invokevirtual 122	org/a/c:toString	()Ljava/lang/String;
      //   183: ldc 124
      ...
      //   350: dup
      //   351: aload_1
      //   352: invokespecial 191	org/a/c:<init>	(Ljava/lang/String;)V
      //   355: astore_3
      //   356: aload_0
      ...
      //   373: aload_3
      //   374: ldc -54
      //   376: invokevirtual 206	org/a/c:optJSONObject	(Ljava/lang/String;)Lorg/a/c;
      //   379: putstatic 212	com/appodeal/ads/UserSettings:userData	Lorg/a/c;
      //   382: aload_0
      //   383: getfield 14	com/appodeal/ads/t$b:a	Lcom/appodeal/ads/t;
      //   386: aload_3
      //   387: invokestatic 215	com/appodeal/ads/t:a	(Lcom/appodeal/ads/t;Lorg/a/c;)V
      //   390: aload_3
      //   391: areturn
      //   392: astore_1
      //   393: aload_1
    ...
    protected void a(org.a.c paramC)
    {
      try
      {
        if (t.this.a != null)
        {
          ...
          t.this.a.a(paramC, t.this.c, t.this.d);
          return;
        }
      }
  ...
  public static class c
  {
    ...
    public c a(com.appodeal.ads.f.c paramC)
    {
      this.i = paramC;
      return this;
    }
