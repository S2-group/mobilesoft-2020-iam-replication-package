...
public class h
{
  ...
  public int b(String paramString)
  {
    ...
    //   20: invokevirtual 41	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   23: aload_0
    //   24: getfield 15	com/duapps/ad/stats/h:a	Landroid/content/Context;
    //   27: iconst_1
    //   28: invokestatic 46	com/duapps/ad/stats/DuAdCacheProvider:a	(Landroid/content/Context;I)Landroid/net/Uri;
    //   31: iconst_1
    //   32: anewarray 50	java/lang/String
    //   35: dup
    //   36: iconst_0
    //   37: ldc 91
    //   39: aastore
    ...
    //   54: ldc2_w 51
    //   57: lsub
    //   58: invokestatic 56	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   61: aastore
    //   62: ldc 95
  ...
  public void b(Context paramContext)
  {
    ...
    //   15: invokevirtual 41	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   18: aload_0
    //   19: getfield 15	com/duapps/ad/stats/h:a	Landroid/content/Context;
    //   22: bipush 7
    //   24: invokestatic 46	com/duapps/ad/stats/DuAdCacheProvider:a	(Landroid/content/Context;I)Landroid/net/Uri;
    //   27: iconst_1
    //   28: anewarray 50	java/lang/String
    //   31: dup
    //   32: iconst_0
    //   33: ldc 87
    //   35: aastore
    ...
    //   222: checkcast 50	java/lang/String
    //   225: astore 5
    //   227: aload_1
    ...
    //   316: checkcast 50	java/lang/String
    //   319: astore 4
    //   321: iload_2
    //   322: ifne +52 -> 374
    ...
    //   457: invokevirtual 41	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   460: aload_0
    //   461: getfield 15	com/duapps/ad/stats/h:a	Landroid/content/Context;
    //   464: bipush 7
    //   466: invokestatic 46	com/duapps/ad/stats/DuAdCacheProvider:a	(Landroid/content/Context;I)Landroid/net/Uri;
    //   469: aload_1
    //   470: aconst_null
    //   471: invokevirtual 62	android/content/ContentResolver:delete	(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    //   474: pop
    //   475: return
    //   476: astore_1
    //   477: ldc 64
    //   479: ldc_w 257
    //   482: aload_1
    //   483: invokestatic 72	com/duapps/ad/base/LogHelper:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   486: return
    //   487: astore_1
    //   488: ldc 64
    //   490: ldc_w 259
    //   493: aload_1
    //   494: invokestatic 72	com/duapps/ad/base/LogHelper:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   497: return
    //   498: astore_1
    //   499: aload 4
    //   501: ifnull +20 -> 521
    //   504: aload 4
    //   506: invokeinterface 120 1 0
    //   511: ifne +10 -> 521
    //   514: aload 4
    //   516: invokeinterface 125 1 0
    //   521: aload_1
    //   522: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public int c(String paramString)
  {
    ...
    //   33: getfield 15	com/duapps/ad/stats/h:a	Landroid/content/Context;
    //   36: bipush 7
    //   38: invokestatic 46	com/duapps/ad/stats/DuAdCacheProvider:a	(Landroid/content/Context;I)Landroid/net/Uri;
    //   41: iconst_1
    ...
    //   50: ldc_w 261
    //   53: iconst_2
    //   54: anewarray 50	java/lang/String
    //   57: dup
    //   58: iconst_0
    //   59: aload_1
    //   60: aastore
    ...
    //   65: lload 5
    //   67: lsub
    //   68: invokestatic 56	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   71: aastore
    //   72: ldc 95
  ...
  public com.duapps.ad.base.h d(String paramString)
  {
    ...
    //   44: invokevirtual 41	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   47: aload_0
    //   48: getfield 15	com/duapps/ad/stats/h:a	Landroid/content/Context;
    //   51: bipush 7
    //   53: invokestatic 46	com/duapps/ad/stats/DuAdCacheProvider:a	(Landroid/content/Context;I)Landroid/net/Uri;
    //   56: iconst_4
    //   57: anewarray 50	java/lang/String
    //   60: dup
    //   61: iconst_0
    //   62: ldc 85
    //   64: aastore
    ...
    //   80: ldc_w 261
    //   83: iconst_2
    //   84: anewarray 50	java/lang/String
    //   87: dup
    //   88: iconst_0
    //   89: aload_1
    //   90: aastore
    ...
    //   95: lload_2
    //   96: lsub
    //   97: invokestatic 56	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   100: aastore
    //   101: ldc 95
