...
public class a
{
  ...
  private static String jdMethod_boolean(String paramString)
  {
  ...
  {
    return (g.jdMethod_do().jdMethod_do("VideoOl")) && (jdMethod_switch("mv_re_state"));
  }
  ...
  {
    return jdMethod_switch("shutdown_state");
  }
  
  public static void jdMethod_case(String paramString)
  {
    x.jdMethod_for("sendUM4Uninstall = " + paramString);
    if ((TextUtils.isEmpty(goto)) || (paramString.split(goto).length != 4)) {
      return;
    }
    paramString = paramString.split(goto);
    com.babybus.i.a.jdMethod_do().jdMethod_do("FB92BCE53C8C91F11B1F12FE511D4766", paramString[1], paramString[3]);
    com.babybus.i.a.jdMethod_do().jdMethod_do("C605B8D0B7AF03E42976957DFEC6A07E", paramString[2]);
  }
  
  public static boolean jdMethod_case()
  {
    return jdMethod_switch("infix_state");
  }
  
  public static boolean jdMethod_catch()
  {
    return throws("banner");
  }
  ...
  {
    x.jdMethod_for("sendUM4UninstallComplete = " + paramString);
    if ((TextUtils.isEmpty(goto)) || (paramString.split(goto).length != 4)) {
      return;
    }
    paramString = paramString.split(goto);
    com.babybus.i.a.jdMethod_do().jdMethod_do("73710E6383909444E1212D14505493E7", paramString[1], paramString[3]);
    com.babybus.i.a.jdMethod_do().jdMethod_do("6DF74A629FBBC344AB25D3E690E054F5", paramString[2]);
  }
  
  public static boolean jdMethod_char()
  {
    return jdMethod_switch("ad_infix_state");
  }
  
  public static String jdMethod_class(String paramString)
  {
    if (App.goto) {
      return v.jdMethod_do().jdMethod_do(paramString);
    }
    return aq.jdMethod_if(paramString, "");
  }
  
  public static boolean jdMethod_class()
  {
    return jdMethod_switch("ad_wall_state");
  }
  ...
  public static FrameLayout.LayoutParams jdMethod_do(Integer paramInteger)
  {
    ...
    do
    {
      ...
      if (paramInteger.intValue() == char)
      {
        ...
        paramInteger.topMargin = av.jdMethod_try((int)(App.jdMethod_do().jdField_catch * 0.6F));
        return paramInteger;
      }
  ...
  public static void jdMethod_do(int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      if ((!TextUtils.isEmpty(str2)) && (!TextUtils.isEmpty(str1))) {
        com.babybus.i.a.jdMethod_do().jdMethod_do(str2, str1);
      }
      return;
      if (2 == paramInt)
      {
  ...
  private static void jdMethod_do(int paramInt, String paramString1, String paramString2)
  {
    ...
    str2 = jdMethod_boolean(paramString2);
    if (TextUtils.isEmpty(paramString1))
    {
      com.babybus.i.a.jdMethod_do().jdMethod_do(str1, paramString2, str2, "");
      return;
    }
    com.babybus.i.a.jdMethod_do().jdMethod_do(str1, paramString1, paramString2, str2);
  }
  ...
  public static void jdMethod_do(String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      com.babybus.i.a.jdMethod_do().jdMethod_do(paramString1, str, paramString3);
      return;
  ...
  public static boolean jdMethod_do(String paramString)
  {
    ...
    x.jdMethod_for("startTime = " + paramString);
    x.jdMethod_for("currentTime = " + l);
    if (l < Long.parseLong(paramString)) {}
    for (boolean bool = true;; bool = false)
    {
      x.jdMethod_for("notStarted = " + bool);
      return bool;
    }
  }
  ...
  {
    return jdMethod_switch("ad_unlock_state");
  }
  ...
  {
    paramString = av.jdMethod_try() + "_" + paramString;
    com.babybus.i.a.jdMethod_do().jdMethod_do("907490f773b446078dd6825811be5dfd", paramString);
  }
  
  public static boolean jdMethod_else()
  {
    return (jdMethod_case()) || (jdMethod_char());
  }
  ...
  {
    return throws("third_banner_state");
  }
  
  public static boolean jdMethod_float()
  {
    return (jdMethod_final()) || (const()) || (jdMethod_catch());
  }
  ...
  public static void jdMethod_for(String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        localObject = str2;
        com.babybus.i.a.jdMethod_do().jdMethod_do(paramString1, paramString2);
        return;
        localObject = str2;
      ...
      if (String.valueOf(8).equals(str3))
      {
        ...
        {
          localObject = str2;
          com.babybus.i.a.jdMethod_do().jdMethod_do(paramString1);
          return;
        }
      }
    }
    ...
    {
      paramString1.printStackTrace();
      x.jdMethod_new("adInfo error = " + (String)localObject);
      return;
    }
    localObject = str2;
    if (TextUtils.isEmpty(paramString2))
    {
      localObject = str2;
      com.babybus.i.a.jdMethod_do().jdMethod_do(paramString1, str1);
      return;
    }
    localObject = str2;
    if ("福利".equals(str1))
    ...
    localObject = str2;
    com.babybus.i.a.jdMethod_do().jdMethod_do(paramString1, str1, paramString2);
  }
  ...
  {
    paramString = av.jdMethod_try() + "_" + paramString;
    com.babybus.i.a.jdMethod_do().jdMethod_do("c0a2c8ff8cd84dd38a0f0edb7f3fc08a", paramString);
  }
  
  public static boolean jdMethod_goto()
  {
    return jdMethod_switch("welcome_re_state");
  }
  ...
  public static void jdMethod_if(String paramString1, String paramString2)
  {
    try
    {
      if (!TextUtils.isEmpty(paramString2))
      {
        ...
        if ("2".equals(str))
        {
          com.babybus.i.a.jdMethod_do().jdMethod_do(paramString1, "退屏", paramString2);
          return;
        }
        if ("3".equals(str))
        {
          com.babybus.i.a.jdMethod_do().jdMethod_do(paramString1, "插屏", paramString2);
          return;
        }
      }
    }
  ...
  {
    x.jdMethod_for("adInfo == " + paramString2);
    try
    {
      if ((!TextUtils.isEmpty(paramString1)) && (!TextUtils.isEmpty(paramString2)))
      {
        ...
        if (paramString2.length == 4)
        {
          ...
          com.babybus.i.a.jdMethod_do().jdMethod_do(paramString1, str, paramString2, paramString3);
        }
      }
      return;
    }
  ...
  {
    return jdMethod_switch("ad_custom_state");
  }
  ...
  {
    x.jdMethod_for("AioloInfo == " + paramString2);
    try
    {
      if ((!TextUtils.isEmpty(paramString1)) && (!TextUtils.isEmpty(paramString2)))
      {
        ...
        if (paramString2.length == 3)
        {
          ...
          com.babybus.i.a.jdMethod_do().jdMethod_if(paramString1, str, paramString2);
          return;
        }
        if (paramString2.length == 4)
        {
  ...
  {
    return jdMethod_switch("startup_state");
  }
  ...
  {
    return (jdMethod_switch("welcome_re_state")) && ("1".equals(aq.jdMethod_if("welcome_re_state", "")));
  }
  ...
  public static boolean native(String paramString)
  {
  ...
  {
    x.jdMethod_for("aiolos adInfo == " + paramString1);
    ...
    {
      paramString1.printStackTrace();
      x.jdMethod_new("adInfo error = " + str);
      return;
    }
    str = paramString1;
    if (arrayOfString.length == 4)
  ...
  {
    return jdMethod_switch("ad_startup_state");
  }
  ...
  public static String jdMethod_return(String paramString)
  {
    int i = -1;
    switch (paramString.hashCode())
    {
  ...
  {
    return "1".equals(aq.jdMethod_if("pay4ad_state", "0"));
  }
  ...
  {
    return jdMethod_switch("ad_parent_banner_state");
  }
  ...
  private static boolean jdMethod_switch(String paramString)
  {
    return !"0".equals(aq.jdMethod_if(paramString, App.jdMethod_do().transient));
  }
  ...
  {
    return (jdMethod_switch("welcome_re_state")) && ("2".equals(aq.jdMethod_if("welcome_re_state", "")));
  }
  
  public static boolean jdMethod_throw()
  {
    return jdMethod_switch("ad_paster_state");
  }
  ...
  private static boolean throws(String paramString)
  {
    return !"0".equals(aq.jdMethod_if(paramString, App.jdMethod_do().jdField_implements));
  }
  ...
  {
    return jdMethod_switch("push_state");
  }
  ...
  {
    return jdMethod_switch("ad_rest_state");
  }
