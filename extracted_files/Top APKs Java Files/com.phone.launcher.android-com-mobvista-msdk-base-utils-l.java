...
import com.mobvista.msdk.base.c.q;
...
public final class l
{
  ...
  {
    Object localObject = com.mobvista.msdk.base.b.a.d().k();
    b.a();
  ...
  public static void a(List<CampaignEx> paramList)
  {
    ...
    while (i < j)
    {
      ...
      if ((!a(com.mobvista.msdk.base.b.a.d().i(), localCampaignEx.getPackageName())) && (localCampaignEx != null) && (localCampaignEx.getOfferType() == 99)) {
        localArrayList.add(localCampaignEx);
      }
      i += 1;
    }
    q.a(com.mobvista.msdk.base.c.h.a(com.mobvista.msdk.base.b.a.d().i())).a(localArrayList);
  }
  ...
  public static boolean a(Context paramContext, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if ((com.mobvista.msdk.base.b.a.b == null) || (com.mobvista.msdk.base.b.a.b.size() == 0))
        {
          com.mobvista.msdk.base.b.a.b = new ArrayList();
          paramContext = paramContext.getInstalledPackages(0);
          List localList = com.mobvista.msdk.base.b.a.d().b();
          i = 0;
          if (i < paramContext.size())
          {
            PackageInfo localPackageInfo = (PackageInfo)paramContext.get(i);
            if ((localPackageInfo.applicationInfo.flags & 0x1) <= 0) {
              com.mobvista.msdk.base.b.a.b.add(localPackageInfo.packageName);
      ...
      int i = 0;
      while (i < com.mobvista.msdk.base.b.a.b.size())
      {
        paramContext = (String)com.mobvista.msdk.base.b.a.b.get(i);
        a.add(paramContext);
        i += 1;
      }
  ...
  public static List<com.mobvista.msdk.base.entity.j> d()
  {
    ...
    //   10: new 260	java/util/ArrayList
    //   13: dup
    //   14: invokespecial 261	java/util/ArrayList:<init>	()V
    //   17: astore 5
    //   19: new 446	java/io/BufferedReader
    //   22: dup
    //   23: new 448	java/io/InputStreamReader
    //   26: dup
    //   27: invokestatic 454	java/lang/Runtime:getRuntime	()Ljava/lang/Runtime;
    //   30: ldc_w 456
    //   33: invokevirtual 460	java/lang/Runtime:exec	(Ljava/lang/String;)Ljava/lang/Process;
    //   36: invokevirtual 466	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   39: invokespecial 469	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   42: sipush 1024
    //   45: invokespecial 472	java/io/BufferedReader:<init>	(Ljava/io/Reader;I)V
    //   48: astore_3
    //   49: aload_3
    //   50: astore_2
    //   51: aload_3
    //   52: invokevirtual 475	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   55: astore 4
    //   57: aload 4
    //   59: ifnull +207 -> 266
    //   62: aload_3
    ...
    //   64: aload 4
    //   66: ldc_w 477
    //   69: invokevirtual 480	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   72: ifeq -23 -> 49
    //   75: aload_3
    //   76: astore_2
    //   77: aload 4
    //   79: ldc_w 482
    //   82: invokevirtual 486	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   85: astore 6
    //   87: aload 6
    //   89: ifnull -40 -> 49
    //   92: aload_3
    ...
    //   173: ifnull +7 -> 180
    //   176: aload_3
    //   177: invokevirtual 491	java/io/BufferedReader:close	()V
    //   180: new 260	java/util/ArrayList
    //   183: dup
    //   184: invokespecial 261	java/util/ArrayList:<init>	()V
    //   187: astore_2
    //   188: invokestatic 182	com/mobvista/msdk/base/b/a:d	()Lcom/mobvista/msdk/base/b/a;
    //   191: invokevirtual 268	com/mobvista/msdk/base/b/a:i	()Landroid/content/Context;
    ...
    //   201: astore_3
    //   202: invokestatic 182	com/mobvista/msdk/base/b/a:d	()Lcom/mobvista/msdk/base/b/a;
    //   205: invokevirtual 339	com/mobvista/msdk/base/b/a:b	()Ljava/util/List;
    //   208: astore 4
    //   210: iconst_0
    //   211: istore_0
    //   212: iload_0
    //   213: aload_3
    //   214: invokeinterface 258 1 0
    //   219: if_icmpge +149 -> 368
    //   222: aload_3
    //   223: iload_0
    //   224: invokeinterface 262 2 0
    ...
    //   263: goto -51 -> 212
    //   266: aload_3
    //   267: invokevirtual 491	java/io/BufferedReader:close	()V
    //   270: goto -90 -> 180
    //   273: astore_2
    //   274: aload_2
    ...
    //   306: ifnull +7 -> 313
    //   309: aload_2
    //   310: invokevirtual 491	java/io/BufferedReader:close	()V
    //   313: aload_3
    //   314: athrow
    //   315: astore_2
    //   316: aload_2
    ...
    //   364: pop
    //   365: goto -106 -> 259
    //   368: new 260	java/util/ArrayList
    //   371: dup
    //   372: invokespecial 261	java/util/ArrayList:<init>	()V
    //   375: astore_3
    //   376: iload_1
    //   377: istore_0
    //   378: iload_0
    //   379: aload 5
    //   381: invokeinterface 258 1 0
    //   386: if_icmpge +78 -> 464
    //   389: aload 5
    //   391: iload_0
    //   392: invokeinterface 262 2 0
    ...
    //   436: new 495	com/mobvista/msdk/base/entity/j
    //   439: dup
    //   440: invokespecial 496	com/mobvista/msdk/base/entity/j:<init>	()V
    //   443: astore 6
    //   445: aload 6
    //   447: aload 4
    //   449: putfield 498	com/mobvista/msdk/base/entity/j:a	Ljava/lang/String;
    //   452: aload_3
    //   453: aload 6
