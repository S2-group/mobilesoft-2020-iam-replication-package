...
public class Shermie
{
  ...
  public static android.graphics.Bitmap a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    //   230: aload 6
    //   232: invokestatic 101	io/presage/long/IoriYagami:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   235: pop
    //   236: aload 4
    //   238: ifnull +8 -> 246
    //   241: aload 4
  ...
  public static String b(Context paramContext)
  {
    ...
    {
      IoriYagami.b("generateFakeAAID", "mac", localException);
      try
      {
        ...
        try
        {
          ...
          return UUID.nameUUIDFromBytes(String.valueOf(l).getBytes()).toString();
        }
        catch (Exception paramContext)
        {
          IoriYagami.b("generateFakeAAID", "firstInstallTime", paramContext);
          return "00000000-0000-0000-0000-000000000000";
        }
        return "00000000-0000-0000-0000-000000000000";
      }
      ...
      {
        IoriYagami.b("generateFakeAAID", "firstSystemApp", paramContext);
      }
    }
  }
  ...
  private static ApplicationInfo c(Context paramContext)
  {
    ...
    {
      public final int a(ApplicationInfo paramAnonymousApplicationInfo1, ApplicationInfo paramAnonymousApplicationInfo2)
      {
