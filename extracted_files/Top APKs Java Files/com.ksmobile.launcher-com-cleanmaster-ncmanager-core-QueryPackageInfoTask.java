...
public class QueryPackageInfoTask
{
  ...
  public List<AppInfo> getPackageInfo()
  {
    ...
    QueryPackageInfoTask.NameSortComparator localNameSortComparator = new QueryPackageInfoTask.NameSortComparator();
    ...
    Collections.sort(localArrayList2, localNameSortComparator);
    Collections.sort(localArrayList3, localNameSortComparator);
  ...
  {
    new Thread(new QueryPackageInfoTask.MyQueryPackageInfoTask(this, paramINotificationJobListener), "nc_query_task").start();
  }
}
