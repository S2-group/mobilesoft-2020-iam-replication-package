...
public class DBMappingXmlParser
{
  ...
  private InputStreamReader getDefaultDBMappingFile()
  {
    ...
    catch (IOException localIOException2)
    {
      ...
      this.mLog.a(TAG, "Default DBmapping issue Got Exception...File name is " + (String)localObject1, new Object[0]);
      try
      {
  ...
  private String htc_manufacturer_workaround()
  {
    ...
    while (localIterator.hasNext()) {
      if (((ApplicationInfo)localIterator.next()).packageName.toLowerCase().startsWith("com.htc.sense")) {
        return "htc";
      }
    }
  ...
  {
    // Byte code:
    //   0: invokestatic 338	android/util/Xml:newPullParser	()Lorg/xmlpull/v1/XmlPullParser;
    //   3: astore_3
    //   4: aload_3
    //   5: ldc_w 340
    //   8: iconst_0
    //   9: invokeinterface 344 3 0
    //   14: aload_0
    //   15: invokespecial 346	com/newbay/syncdrive/android/model/nab/util/DBMappingXmlParser:getDefaultDBMappingFile	()Ljava/io/InputStreamReader;
    //   18: astore_2
    //   19: aload_2
    //   20: astore_1
    //   21: aload_3
    ...
    //   39: aload_0
    //   40: aload_3
    //   41: invokespecial 352	com/newbay/syncdrive/android/model/nab/util/DBMappingXmlParser:readMapping	(Lorg/xmlpull/v1/XmlPullParser;)Ljava/util/Map;
    //   44: astore_3
    //   45: aload_2
    //   46: invokestatic 357	org/apache/commons/io/IOUtils:closeQuietly	(Ljava/io/Reader;)V
    //   49: aload_3
    //   50: areturn
    //   51: astore_3
    //   52: aconst_null
    ...
    //   55: astore_1
    //   56: aload_0
    //   57: getfield 81	com/newbay/syncdrive/android/model/nab/util/DBMappingXmlParser:mLog	Lcom/synchronoss/util/Log;
    //   60: getstatic 41	com/newbay/syncdrive/android/model/nab/util/DBMappingXmlParser:TAG	Ljava/lang/String;
    //   63: ldc_w 359
    //   66: aload_3
    //   67: iconst_0
    //   68: anewarray 4	java/lang/Object
    //   71: invokeinterface 362 5 0
    //   76: pop
    //   77: aload_2
    //   78: invokestatic 357	org/apache/commons/io/IOUtils:closeQuietly	(Ljava/io/Reader;)V
    //   81: aconst_null
    //   82: areturn
    //   83: astore_3
    //   84: aconst_null
    ...
    //   87: astore_1
    //   88: aload_0
    //   89: getfield 81	com/newbay/syncdrive/android/model/nab/util/DBMappingXmlParser:mLog	Lcom/synchronoss/util/Log;
    //   92: getstatic 41	com/newbay/syncdrive/android/model/nab/util/DBMappingXmlParser:TAG	Ljava/lang/String;
    //   95: ldc_w 364
    //   98: aload_3
    //   99: iconst_0
    //   100: anewarray 4	java/lang/Object
    //   103: invokeinterface 362 5 0
    //   108: pop
    //   109: aload_2
    //   110: invokestatic 357	org/apache/commons/io/IOUtils:closeQuietly	(Ljava/io/Reader;)V
    //   113: aconst_null
    //   114: areturn
    //   115: astore_1
    //   116: aconst_null
    ...
    //   119: astore_2
    //   120: aload_3
    //   121: invokestatic 357	org/apache/commons/io/IOUtils:closeQuietly	(Ljava/io/Reader;)V
    //   124: aload_2
    //   125: athrow
    //   126: astore_2
    //   127: aload_1
