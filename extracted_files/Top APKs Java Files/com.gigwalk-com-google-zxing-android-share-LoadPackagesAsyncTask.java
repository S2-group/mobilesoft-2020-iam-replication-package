  ...
  extends AsyncTask<Void, Void, List<AppInfo>>
{
  ...
  {
    paramList = new ArrayAdapter(this.activity, 2130903076, 2131624164, paramList)
    {
      public View getView(int paramAnonymousInt, View paramAnonymousView, ViewGroup paramAnonymousViewGroup)
      {
        ...
        if (paramAnonymousViewGroup != null) {
          ((ImageView)paramAnonymousView.findViewById(2131624163)).setImageDrawable(paramAnonymousViewGroup);
        }
