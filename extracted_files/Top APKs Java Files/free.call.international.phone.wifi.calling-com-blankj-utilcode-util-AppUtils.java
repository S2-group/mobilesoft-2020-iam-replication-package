...
public final class AppUtils
{
  ...
  public static AppUtils.AppInfo getAppInfo(String paramString)
  {
    try
    {
      PackageManager localPackageManager = Utils.getApp().getPackageManager();
  ...
  public static List<AppUtils.AppInfo> getAppsInfo()
  {
    ...
    {
      AppUtils.AppInfo localAppInfo = getBean(localPackageManager, (PackageInfo)localIterator.next());
  ...
  private static AppUtils.AppInfo getBean(PackageManager paramPackageManager, PackageInfo paramPackageInfo)
  {
    if ((paramPackageManager != null) && (paramPackageInfo != null))
    {
      ...
      return new AppUtils.AppInfo(str1, str2, paramPackageManager, str3, str4, i, bool);
    }
    return null;
  }
  ...
  public static boolean installAppSilent(File paramFile, String paramString, boolean paramBoolean)
  {
    ...
    paramString = new StringBuilder("installAppSilent successMsg: ");
  ...
  public static boolean isAppInstalled(String paramString1, String paramString2)
  {
    ...
    return Utils.getApp().getPackageManager().resolveActivity(paramString1, 0) != null;
  }
  ...
  public static boolean isAppRoot()
  {
    ...
    {
      StringBuilder localStringBuilder = new StringBuilder("isAppRoot() called");
  ...
  private static boolean isDeviceRooted()
  {
    ...
    while (i < 8)
    {
      String str = new String[] { "/system/bin/", "/system/xbin/", "/sbin/", "/system/sd/xbin/", "/system/bin/failsafe/", "/data/local/xbin/", "/data/local/bin/", "/data/local/" }[i];
  ...
  public static boolean uninstallAppSilent(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    StringBuilder localStringBuilder = new StringBuilder("LD_LIBRARY_PATH=/vendor/lib*:/system/lib* pm uninstall ");
    if (paramBoolean1) {
      localObject = "-k ";
    } else {
      localObject = "";
    ...
    Object localObject = new StringBuilder("uninstallAppSilent successMsg: ");
