  ...
  implements ConfigurationFetcherDelegate
{
  ...
  public BannersConfiguration(Map<String, Object> paramMap, PublishingSDKAppInfo paramPublishingSDKAppInfo, String paramString1, String paramString2, String paramString3, BannersConfigurationDelegate paramBannersConfigurationDelegate)
  {
  ...
  private void downloadHouseAdsFolderContents(String[] paramArrayOfString, String paramString1, String paramString2, AssetManager paramAssetManager, InputStream paramInputStream)
  {
    int i;
    try
    {
      ...
      {
        paramArrayOfString = paramAssetManager.open(paramString1);
        paramString1 = new FileOutputStream(paramString2);
        paramString2 = new byte['က'];
        for (;;)
        {
          i = paramArrayOfString.read(paramString2);
          if (i == -1) {
            break;
          }
    ...
    {
      Log.e(this.TAG, "BannersConfiguration prepareDefaultHouseAds faild to copy from resources to houseAds directory, exception: " + paramArrayOfString.getMessage());
    }
    for (;;)
    {
      paramString1.close();
      return;
      this.mFileUtils.makeDir(paramString2);
      ...
      while (i < j)
      {
        ...
        downloadHouseAdsFolderContents(paramAssetManager.list(str1), str1, str2, paramAssetManager, paramInputStream);
        i += 1;
      }
    }
  }
  ...
  private boolean loadHouseAdsConfigurationFromServer()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localSet = getInstalledPackages();
        i = 0;
        if (i >= ((JSONArray)localObject5).length()) {
          continue;
        }
        localJSONObject1 = ((JSONArray)localObject5).getJSONObject(i);
        str1 = localJSONObject1.getString("thumbnail");
        if (!getThumbnail((HttpConnector)localObject2, str1, localJSONObject1, (String)localObject1)) {
          continue;
        }
        localJSONObject2 = new JSONObject();
        str2 = localJSONObject1.getString("bundleId");
  ...
  private void prepareDefaultHouseAds()
  {
    ...
    catch (IOException localIOException)
    {
      for (;;)
      {
        Log.e(this.TAG, "BannersConfiguration prepareDefaultHouseAds faild to get AssetManager, exception: " + localIOException.getMessage());
      }
      this.mFileUtils.makeDir(str);
      downloadHouseAdsFolderContents(localObject, "houseAds", str, localAssetManager, null);
    }
  ...
  {
    return this.mConfigurationFetcher.get(paramString);
  }
  
  public boolean getBool(String paramString, boolean paramBoolean)
  {
    return this.mConfigurationFetcher.getBool(paramString, paramBoolean);
  }
  
  public int getInt(String paramString, int paramInt)
  {
    return this.mConfigurationFetcher.getInt(paramString, paramInt);
  }
  
  public JSONArray getJSONArray(String paramString)
  {
    return this.mConfigurationFetcher.getJSONArray(paramString);
  }
  ...
  public JSONObject getJsonData()
  {
    ...
    do
    {
      ...
      localJSONObject = createJsonObject((String)localObject);
