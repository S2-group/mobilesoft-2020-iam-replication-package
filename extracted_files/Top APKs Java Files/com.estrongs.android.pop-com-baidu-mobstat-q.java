...
class q
{
  ...
  private void a(boolean paramBoolean, PackageInfo paramPackageInfo, JSONArray paramJSONArray)
  {
    ...
    try
    {
      ...
      localJSONObject.put("f", paramPackageInfo.firstInstallTime);
      localJSONObject.put("l", paramPackageInfo.lastUpdateTime);
  ...
  private void b(Context paramContext, boolean paramBoolean)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      try
      {
        ...
        String str = ck.a(((JSONObject)localObject3).toString().getBytes());
        paramContext = str;
      }
