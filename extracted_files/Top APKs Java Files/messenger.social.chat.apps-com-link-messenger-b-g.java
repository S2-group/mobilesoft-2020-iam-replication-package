...
import com.link.messenger.modules.entity.AddAppInfo;
import com.link.messenger.modules.receiver.NotificationReceiver;
...
public class g
{
  ...
  {
    Dialog localDialog = new Dialog(paramContext, 2131689952);
  ...
  {
    paramResources = new com.link.messenger.external.views.a(paramResources);
    paramResources.a(1);
  ...
  public static void a(NotificationManager paramNotificationManager, x.c paramC, Context paramContext)
  {
    if ((paramNotificationManager != null) && (paramC != null) && (paramContext != null) && (Build.VERSION.SDK_INT >= 26))
    {
      paramNotificationManager.createNotificationChannel(new NotificationChannel("default channel", paramContext.getResources().getString(2131623985), 3));
      paramC.b("default channel");
    }
  }
  ...
  public static void a(SpannableString paramSpannableString, String paramString1, String paramString2)
  {
    int i = paramString1.indexOf(paramString2);
    int j = paramString2.length();
    paramSpannableString.setSpan(new UnderlineSpan(), i, j + i, 33);
  }
  ...
  public static void d(Context paramContext)
  {
    ...
    {
      localA = new b.a(paramContext);
      localA.a(paramContext.getString(2131624160, new Object[] { localObject1.versionName })).b((CharSequence)localObject2).a(true).a(paramContext.getResources().getString(2131624002), new DialogInterface.OnClickListener()
      {
  ...
  public static void d(Context paramContext, String paramString)
  {
    ...
    {
      Toast.makeText(paramContext, paramContext.getResources().getString(2131624109), 1).show();
    }
  }
  
  public static Dialog e(Context paramContext, String paramString)
  {
    View localView = LayoutInflater.from(paramContext).inflate(2131427464, null);
    RelativeLayout localRelativeLayout = (RelativeLayout)localView.findViewById(2131296617);
    ImageView localImageView = (ImageView)localView.findViewById(2131296616);
    if (!TextUtils.isEmpty(paramString)) {
      ((TextView)localView.findViewById(2131296618)).setText(paramString);
    }
    localImageView.startAnimation(AnimationUtils.loadAnimation(paramContext, 2130771989));
    paramContext = new Dialog(paramContext, 2131689953);
  ...
  {
    // Byte code:
    //   0: new 525	java/io/InputStreamReader
    //   3: dup
    //   4: aload_0
    //   5: invokevirtual 15	android/content/Context:getResources	()Landroid/content/res/Resources;
    //   8: invokevirtual 529	android/content/res/Resources:getAssets	()Landroid/content/res/AssetManager;
    //   11: aload_1
    //   12: invokevirtual 535	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   15: invokespecial 538	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   18: astore_2
    //   19: new 540	java/io/BufferedReader
    //   22: dup
    //   23: aload_2
    //   24: invokespecial 543	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   27: astore_1
    //   28: ldc_w 334
    //   31: astore_0
    //   32: aload_1
    ...
    //   36: astore_3
    //   37: aload_1
    //   38: invokevirtual 546	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   41: astore 5
    //   43: aload 5
    //   45: ifnull +41 -> 86
    //   48: aload_1
    ...
    //   56: dup
    //   57: invokespecial 332	java/lang/StringBuilder:<init>	()V
    //   60: aload_0
    //   61: invokevirtual 338	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   64: aload 5
    ...
    //   75: invokevirtual 346	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   78: astore 5
    //   80: aload 5
    //   82: astore_0
    //   83: goto -51 -> 32
    ...
    //   87: ifnull +7 -> 94
    //   90: aload_1
    //   91: invokevirtual 551	java/io/BufferedReader:close	()V
    //   94: aload_0
    //   95: astore_1
    //   96: aload_2
    //   97: ifnull +9 -> 106
    //   100: aload_2
    //   101: invokevirtual 552	java/io/InputStreamReader:close	()V
    //   104: aload_0
    //   105: astore_1
    //   106: aload_1
    //   107: areturn
    //   108: astore_1
    //   109: aload_1
    //   110: invokevirtual 553	java/io/IOException:printStackTrace	()V
    //   113: aload_0
    //   114: areturn
    //   115: astore 5
    //   117: aconst_null
    ...
    //   129: astore_3
    //   130: aload 5
    //   132: invokevirtual 357	java/lang/Exception:printStackTrace	()V
    //   135: aload_1
    //   136: ifnull +7 -> 143
    //   139: aload_1
    //   140: invokevirtual 551	java/io/BufferedReader:close	()V
    //   143: aload_0
    //   144: astore_1
    //   145: aload_2
    //   146: ifnull -40 -> 106
    //   149: aload_2
    //   150: invokevirtual 552	java/io/InputStreamReader:close	()V
    //   153: aload_0
    //   154: areturn
    //   155: astore_1
    //   156: aload_1
    //   157: invokevirtual 553	java/io/IOException:printStackTrace	()V
    //   160: aload_0
    //   161: areturn
    //   162: astore_0
    //   163: aconst_null
    ...
    //   170: ifnull +8 -> 178
    //   173: aload 4
    //   175: invokevirtual 551	java/io/BufferedReader:close	()V
    //   178: aload_2
    //   179: ifnull +7 -> 186
    //   182: aload_2
    //   183: invokevirtual 552	java/io/InputStreamReader:close	()V
    //   186: aload_0
    //   187: athrow
    //   188: astore_1
    //   189: aload_1
    //   190: invokevirtual 553	java/io/IOException:printStackTrace	()V
    //   193: goto -7 -> 186
    //   196: astore_0
    //   197: aconst_null
    //   198: astore 4
  ...
  public static Notification g(Context paramContext)
  {
    ...
    x.c localC = new x.c(paramContext);
    Object localObject = new Intent();
    ((Intent)localObject).setClass(paramContext, NotificationReceiver.class);
    ((Intent)localObject).setAction("messenger.social.chat.apps.CLICK_ACTIVE_APP_NOTIFI");
    localObject = PendingIntent.getBroadcast(paramContext, 1, (Intent)localObject, 268435456);
    Bitmap localBitmap = a(paramContext.getResources().getDrawable(2131558401));
    localC.b(paramContext.getResources().getString(2131624104)).a(paramContext.getResources().getString(2131624105)).a(2131230996).a(localBitmap).a((PendingIntent)localObject).b(1).a(true);
    a(localNotificationManager, localC, paramContext);
  ...
  public static void l(Context paramContext)
  {
    ...
    String[] arrayOfString = com.link.messenger.modules.a.a.a;
    ...
    while (i < j)
    {
      ...
      if (g(paramContext, str)) {
        localHashSet.add((String)com.link.messenger.modules.a.a.b.get(str));
      }
      i += 1;
    }
