...
{
  public static final int a = com.ihs.app.framework.a.a().getResources().getColor(2131099996);
  public static final int b = ac.a();
  public static final int c = com.ihs.app.framework.a.a().getResources().getColor(2131099995);
    ...
    if ((localObject2 != null) && (localObject1 != null))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        try
        {
          ...
          localObject3 = u.a(str1);
          str2 = com.optimizer.test.c.a.a.b(str1);
  ...
  public static void a(Context paramContext, Intent paramIntent, Bitmap paramBitmap, String paramString)
  {
    ...
    {
      y.a(paramContext, "game_boost_shortcut", Icon.createWithBitmap(paramBitmap), paramString, paramIntent);
      return;
    }
