...
import com.crazybuzz.lib.a.l;
import com.crazybuzz.lib.a.q;
import com.crazybuzz.lib.a.y;
import com.crazybuzz.lib.task.c.h;
...
public class d
{
  ...
  public static int a(com.crazybuzz.lib.task.b.a paramA, com.crazybuzz.lib.task.b.b paramB, com.crazybuzz.lib.task.b.d paramD)
  {
    int j;
  ...
  public static long a(long paramLong)
  {
    ...
    {
      com.crazybuzz.lib.a.e.a(localNumberFormatException);
    }
    return 0L;
  }
  ...
  public static long a(b.a paramA)
  {
    ...
    for (;;)
    {
      ...
      {
        com.crazybuzz.lib.a.e.c("TaskTools getNowTime is error:" + paramA.getMessage());
      }
      paramA = "yyyyMMdd";
      continue;
      paramA = "yyyyMMddHH";
  ...
  public static String a(com.crazybuzz.lib.task.b.a paramA, String[] paramArrayOfString)
  {
  ...
  public static ArrayList<com.crazybuzz.lib.task.b.a> a(ArrayList<com.crazybuzz.lib.task.b.a> paramArrayList)
  {
  ...
  public static void a(Activity paramActivity, String paramString)
  {
    ...
    {
      return;
      if (com.crazybuzz.lib.a.e.a()) {
        com.crazybuzz.lib.a.e.b("TaskTools  task copy content:" + paramString);
      }
      try
      {
  ...
  public static void a(com.crazybuzz.lib.task.b.a paramA, JSONObject paramJSONObject)
  {
  ...
  {
    long l = com.crazybuzz.lib.task.d.a.a().b("markNowDateKey");
    if (l <= 0L) {}
    while (a(b.a.DATE) == l) {
      return false;
    }
  ...
  public static boolean a(ArrayList<com.crazybuzz.lib.task.b.a> paramArrayList, com.crazybuzz.lib.task.b.a paramA)
  {
    if ((paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      {
        String str = ((com.crazybuzz.lib.task.b.a)paramArrayList.next()).getId();
  ...
  public static long b(String paramString)
  {
    ...
    {
      com.crazybuzz.lib.a.e.c("TaskTools NumberFormatException,parseLong：" + paramString);
    }
    return 0L;
  }
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        try
        {
          ...
          {
            str = com.crazybuzz.lib.a.f.a().toLowerCase();
            if (!str.equals("tw"))
            {
              localObject1 = localObject2;
              if (!str.equals("hk")) {}
  ...
  public static ArrayList<com.crazybuzz.lib.task.b.a> b(ArrayList<com.crazybuzz.lib.task.b.a> paramArrayList)
  {
    if ((paramArrayList != null) && (paramArrayList.size() > 0)) {
  ...
  public static boolean b(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      {
        com.crazybuzz.lib.a.e.c("TaskTools isPortrait NullPointerException:" + paramContext.getMessage());
      }
    }
    return true;
  }
  ...
  public static boolean b(com.crazybuzz.lib.task.b.a paramA)
  {
    boolean bool1 = false;
    boolean bool2 = false;
    if (paramA == null) {}
    ...
    do
    {
      do
      {
        ...
        bool2 = bool1;
      } while (!com.crazybuzz.lib.a.e.a());
      bool2 = bool1;
    } while (!bool1);
    com.crazybuzz.lib.a.e.b("TaskTools task state:" + localC + " taskId:" + paramA.getId());
    return bool1;
  }
  ...
  public static HashMap<String, com.crazybuzz.lib.task.b.a> c(ArrayList<com.crazybuzz.lib.task.b.a> paramArrayList)
  {
    ...
    while (paramArrayList.hasNext())
    {
      com.crazybuzz.lib.task.b.a localA = (com.crazybuzz.lib.task.b.a)paramArrayList.next();
  ...
  public static void c(String paramString)
  {
    ...
    {
      com.crazybuzz.lib.a.e.a(paramString);
    }
  }
  ...
  public static com.crazybuzz.lib.task.b.a d(ArrayList<com.crazybuzz.lib.task.b.a> paramArrayList)
  {
    int j = 0;
    if ((paramArrayList == null) || (paramArrayList.size() <= 0)) {
      return null;
    ...
    for (int i = 0; ((Iterator)localObject1).hasNext(); i = ((com.crazybuzz.lib.task.b.a)((Iterator)localObject1).next()).getWeight().intValue() + i) {}
    ...
    {
      com.crazybuzz.lib.task.b.a localA = (com.crazybuzz.lib.task.b.a)((Iterator)localObject2).next();
    ...
    for (;;)
    {
      ...
      while (i < ((ArrayList)localObject1).size())
      {
        ...
        if (m < j)
        {
          if (com.crazybuzz.lib.a.e.a())
          {
            com.crazybuzz.lib.a.e.b("task follow calculateTaskNumerator msg,size:" + ((ArrayList)localObject1).size() + "," + paramArrayList);
            com.crazybuzz.lib.a.e.b("task follow calculateTaskNumerator Random number:" + m + " percent:" + ((ArrayList)localObject1).get(i) + " block:" + (j - ((Integer)((ArrayList)localObject1).get(i)).intValue()) + "~" + j + " taskId:" + ((com.crazybuzz.lib.task.b.a)localArrayList.get(i)).getId() + " weight:" + ((com.crazybuzz.lib.task.b.a)localArrayList.get(i)).getWeight());
          }
          return (com.crazybuzz.lib.task.b.a)localArrayList.get(i);
        }
        i += 1;
      }
      return null;
  ...
  public static void d(Activity paramActivity)
  {
    try
    {
      ...
      if (i == 2)
      {
        ...
        if (com.crazybuzz.lib.a.e.a()) {
          com.crazybuzz.lib.a.e.b("TaskTools set is-----SCREEN_ORIENTATION_PORTRAIT");
        }
      }
      else if (i == 1)
      {
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      if ((!TextUtils.isEmpty((CharSequence)localObject2)) && (((String)localObject2).contains(":")))
      {
        ...
        if (localObject2.length == 2) {
          ...
          {
            com.crazybuzz.lib.a.e.c("TaskTools splitData NumberFormatException");
          }
        }
      }
    }
  ...
  public static boolean i(com.crazybuzz.lib.task.b.a paramA)
  {
    ...
    {
      return false;
      localArrayList = com.crazybuzz.lib.task.d.b.a().d();
    } while (!b(com.crazybuzz.lib.task.d.b.a().a(localArrayList, paramA.getId())));
    return true;
  }
  ...
  public static boolean k(com.crazybuzz.lib.task.b.a paramA)
  {
    if (paramA != null)
    {
      ...
      if ((localArrayList != null) && (localArrayList.size() > 0))
      {
        ...
        if ((com.crazybuzz.lib.a.e.a()) && (bool)) {
          com.crazybuzz.lib.a.e.b("task isFilterNoneTask filterNone,taskId:" + paramA.getId());
        }
        return bool;
      }
    }
  ...
  {
    if (TextUtils.isEmpty(paramString)) {}
    while (!com.crazybuzz.lib.task.d.c.a().c().b(paramString)) {
      return null;
    }
    int i = paramString.lastIndexOf("/");
    if (i == -1) {
  ...
  public static boolean l(com.crazybuzz.lib.task.b.a paramA)
  {
    return a(paramA.getCloseTaskTime()) == a(b.a.DATE);
  }
  
  public static boolean m(com.crazybuzz.lib.task.b.a paramA)
  {
    boolean bool = true;
    if (paramA == null) {}
    int i;
    ...
    {
      if (com.crazybuzz.lib.a.e.a()) {
        com.crazybuzz.lib.a.e.b("task show_frequency task percent:" + i + " taskId:" + paramA.getId());
      }
      return true;
    }
    int j = new Random().nextInt(100);
    if (com.crazybuzz.lib.a.e.a()) {
      com.crazybuzz.lib.a.e.b("task show_frequency Random number:" + j + " task percent:" + i + " taskId:" + paramA.getId());
    }
    if (j < i) {}
    for (;;)
    {
  ...
  public static boolean n(com.crazybuzz.lib.task.b.a paramA)
  {
    return "follow".equals(paramA.getTaskContent().getTaskType());
  }
  
  private static boolean o(com.crazybuzz.lib.task.b.a paramA)
  {
