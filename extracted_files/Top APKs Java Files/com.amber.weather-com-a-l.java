...
public final class l
{
  ...
  private CellLocation B()
  {
    ...
    try
    {
      CellLocation localCellLocation = b((List)i.a(this.b, "getAllCellInfo", new Object[0]));
  ...
  protected static l a(Context paramContext)
  {
  ...
  private boolean a(CellLocation paramCellLocation)
  {
    ...
    for (;;)
    {
      ...
      if (paramCellLocation.getCid() >= 268435455)
      {
        ...
        try
        {
          if ((i.b(paramCellLocation, "getSystemId", new Object[0]) <= 0) || (i.b(paramCellLocation, "getNetworkId", new Object[0]) < 0)) {
            break;
          }
          int i1 = i.b(paramCellLocation, "getBaseStationId", new Object[0]);
          if (i1 < 0) {
            return false;
          }
        }
