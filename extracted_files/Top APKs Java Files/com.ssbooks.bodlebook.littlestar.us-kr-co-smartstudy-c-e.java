...
import kr.co.smartstudy.sspatcher.ar;
...
public class e
{
  ...
  public static String a(String paramString1, String paramString2)
  {
    ...
    if ((!bool) && (!n.b(paramString2)))
    {
      paramString1 = new Intent("android.intent.action.VIEW", Uri.parse(paramString2));
      paramString1 = n.a().getPackageManager().queryIntentActivities(paramString1, 0);
  ...
  public static HashSet<String> a()
  {
    ...
    List localList = n.a().getPackageManager().getInstalledPackages(0);
    int i = 0;
  ...
  private static boolean a(int paramInt, final String paramString)
  {
    ...
    paramString = new Runnable()
    {
      public void run()
      {
        ar.a(n.a(), this.a, paramString, false, true);
      }
    };
    if (a) {
      paramString.run();
  ...
  public static boolean a(String paramString)
  {
    ...
    try
    {
      ...
      if (!n.a().getPackageManager().queryIntentActivities(paramString, 0).isEmpty())
      {
        paramString.addFlags(872415232);
        n.a().startActivity(paramString);
        bool = true;
      }
      return bool;
    }
  ...
  public static boolean b(String paramString)
  {
    try
    {
      paramString = n.a().getPackageManager().getLaunchIntentForPackage(paramString);
  ...
  public static boolean c(String paramString1, String paramString2)
  {
    ...
    return a(ar.a(paramString1.toLowerCase().trim()), paramString2);
  }
