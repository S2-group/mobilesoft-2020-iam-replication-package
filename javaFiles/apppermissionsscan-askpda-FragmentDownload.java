...
import kr.pe.devsunset.aps.AppInfo.AppFilter;
...
/**
 * <PRE>
 * AppPermissionScan FragmentDownload
 * </PRE>
 * 
 * @author devsunset
 * @version 1.0
...
public class FragmentDownload extends Fragment {
	...
	public static final String TAG = "FragmentDownload";
	...
	private class IAAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				...
				convertView = inflater.inflate(R.layout.app_download_list_item, null);
		...
		public void rebuild(){
			try{
				...
				AppFilter filter = AppInfo.THIRD_PARTY_FILTER;
				if (filter != null) {
					filter.init();
				}
	...
	public static void messageBox(Context context, String msgTitle, String msgText) {
		...
		((TextView) layout.findViewById(R.id.commonListDialogContentsTextView)).setText(Html.fromHtml(PermissionUtil.makePermissionStringToHtml(msgText)));
